...
public class clsFirstFree {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            strSql = "SELECT * FROM D_COM_FIRSTFREE WHERE COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID) + " ORDER BY MODULE_ID";
    ...
    public boolean Insert() {
        try {
            ...
            rsResultSet.updateLong("FIRSTFREE_NO", data.getMaxID(SDMLERPGLOBAL.gCompanyID, "D_COM_FIRSTFREE", "FIRSTFREE_NO"));
    ...
    public boolean Delete() {
        try {
            ...
            String stmt = "DELETE FROM D_COM_FIRSTFREE WHERE COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID) + " And FIRSTFREE_NO=" + FirstFree;
            data.Execute(stmt);
            return true;
        } catch (Exception e) {
            LastError = e.getMessage();
    ...
    public static String getNextFreeNo(int pCompanyID, int pModuleID, String pPrefix, String pSuffix, boolean UpdateLastNo) {
        ...
        try {
            ...
            if (rsTmp.getRow() > 0) {
                ...
                strNewNo = SDMLERPGLOBAL.Padding(Integer.toString(lnNewNo), rsTmp.getInt("NO_LENGTH"), rsTmp.getString("PADDING_BY"));
