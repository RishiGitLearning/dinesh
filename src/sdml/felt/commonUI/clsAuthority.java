...
public class clsAuthority {
    ...
    public boolean Insert() {
        ...
        try {
            ...
            int EntryNo = (int) data.getMaxID(SDMLERPGLOBAL.gCompanyID, "D_COM_AUTHORITY", "SR_NO");
            setAttribute("SR_NO", EntryNo + 1);

            tmpConn = data.getConn();
            stTmp = tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            rsTmp = stTmp.executeQuery("SELECT * FROM D_COM_AUTHORITY WHERE COMPANY_ID=" + SDMLERPGLOBAL.gCompanyID);
            rsTmp.first();
