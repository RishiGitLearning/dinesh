...
public class clsSection {
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("SECTION_SYS_ID", data.getMaxID(SDMLERPGLOBAL.gCompanyID, "D_COM_SECTION_MASTER", "SECTION_SYS_ID"));
            //-------------------------------------------------

            //----------- Save Header Record ----------------
            rsResultSet.moveToInsertRow();
            rsResultSet.updateLong("COMPANY_ID", SDMLERPGLOBAL.gCompanyID);
            ...
            rsHistory.updateLong("COMPANY_ID", SDMLERPGLOBAL.gCompanyID);
    ...
    public boolean Update() {
        ...
        try {
            ...
            //========= Inserting Into History =================//
            //Get the Maximum Revision No.
            int RevNo = SDMLERPGLOBAL.GetQueryResult("SELECT MAX(REVISION_NO) FROM D_COM_SECTION_MASTER_H WHERE COMPANY_ID=" + SDMLERPGLOBAL.gCompanyID + " AND SECTION_SYS_ID='" + (int) getAttribute("SECTION_SYS_ID").getVal() + "'");
            RevNo++;
    ...
    public static HashMap getHistoryList(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM D_COM_SECTION_MASTER_H WHERE COMPANY_ID=" + SDMLERPGLOBAL.gCompanyID + " AND SECTION_ID='" + pDocNo + "' ORDER BY REVISION_NO");
