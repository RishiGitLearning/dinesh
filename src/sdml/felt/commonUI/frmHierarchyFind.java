...
public class frmHierarchyFind extends javax.swing.JApplet {
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
          strQuery=strQuery+" AND MODULE_ID="+SDMLERPGLOBAL.getComboCode(cmbModule) +" "; 
       }
       
       if(cmbUser.getSelectedIndex()!=-1)
       {
         strQuery=strQuery+" AND HIERARCHY_ID IN (SELECT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS WHERE COMPANY_ID="+SDMLERPGLOBAL.gCompanyID+" AND USER_ID="+SDMLERPGLOBAL.getComboCode(cmbUser)+" AND APPROVAL_SEQUENCE=1)";
       }
   ...
   String strCondition="";
        ...
        strCondition=" WHERE COMPANY_ID="+Long.toString(SDMLERPGLOBAL.gCompanyID) + " ORDER BY MODULE_DESC";
        ...
        List=ObjUser.getList(" WHERE COMPANY_ID="+Long.toString(SDMLERPGLOBAL.gCompanyID));
        for(int i=1;i<=List.size();i++) {
