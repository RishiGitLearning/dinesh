...
public class clsDepartment {
    ...
    public clsDepartment() {
        ...
        props.put("DEPT_DESC",new Variant(""));
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            strSql = "SELECT * FROM D_COM_DEPT_MASTER WHERE COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID)+" ORDER BY DEPT_DESC";
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("DEPT_ID",data.getMaxID(SDMLERPGLOBAL.gCompanyID,"D_COM_DEPT_MASTER","DEPT_ID"));
            ...
            for(int i=1;i<=colUsers.size();i++) {
                ...
                rsUsers.updateInt("COMPANY_ID",SDMLERPGLOBAL.gCompanyID);
                ...
                rsUsers.updateString("CHANGED_DATE",SDMLERPGLOBAL.getCurrentDateDB());
                rsUsers.insertRow();
            }
            //===========Updation Completed====================//
            ...
            for(int i=1;i<=colApprovers.size();i++) {
                ...
                rsApprovers.updateInt("COMPANY_ID",SDMLERPGLOBAL.gCompanyID);
                ...
                rsApprovers.updateString("CHANGED_DATE",SDMLERPGLOBAL.getCurrentDateDB());
    ...
    public boolean Update() {
        ...
        try {
            ...
            //Remove Old Records
            data.Execute("DELETE FROM D_COM_DEPT_USERS WHERE COMPANY_ID="+SDMLERPGLOBAL.gCompanyID+" AND DEPT_ID="+DeptID);
            data.Execute("DELETE FROM D_COM_DOC_APPROVERS WHERE COMPANY_ID="+SDMLERPGLOBAL.gCompanyID+" AND DEPT_ID="+DeptID);
    ...
    public boolean Delete() {
        try {
            ...
            String stmt = "DELETE FROM D_COM_DEPT_MASTER WHERE COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID) + " And DEPT_ID="+DeptID;
            data.Execute(stmt);
    ...
    public static HashMap getList(String pCondition) {
        ...
        try {
            ...
            while(!rsTmp.isAfterLast()) {
                ...
                ObjDept.setAttribute("DEPT_DESC",rsTmp.getString("DEPT_DESC"));
    ...
    public static HashMap getDeptList(int pCompanyID,int pUserID) {
        ...
        try {
            ...
            while(!rsTmp.isAfterLast()) {
                ...
                String DeptName=clsDepartment.getDeptName(pCompanyID,rsTmp.getInt("DEPT_ID"));
    ...
    public static HashMap getApproverList(int pCompanyID,int pModuleID,int pDeptID) {
        ...
        try {
            ...
            while(!rsTmp.isAfterLast()) {
                ...
                String UserName=clsUser.getUserName(SDMLERPGLOBAL.gCompanyID,UserID);
    ...
    public boolean setData() {
        ...
        try {
            ...
            rsTmp=stTmp.executeQuery("SELECT * FROM D_COM_DEPT_USERS WHERE COMPANY_ID="+SDMLERPGLOBAL.gCompanyID+" AND DEPT_ID="+(int)getAttribute("DEPT_ID").getVal());
            rsTmp.first();
            ...
            //Now Fetch Department Users
            stTmp=Conn.createStatement();
            rsTmp=stTmp.executeQuery("SELECT * FROM D_COM_DOC_APPROVERS WHERE COMPANY_ID="+SDMLERPGLOBAL.gCompanyID+" AND DEPT_ID="+(int)getAttribute("DEPT_ID").getVal());
            rsTmp.first();
    ...
    public boolean Find(String pCondition) {
        Ready=false;
        try {
            String strSql = "SELECT * FROM D_COM_DEPT_MASTER WHERE COMPANY_ID="+Integer.toString(SDMLERPGLOBAL.gCompanyID);
            Conn=data.getConn();
            Stmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
