...
public class clsParameter {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            strSql = "Select * From D_COM_PARAMETER_MAST WHERE COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID);
    ...
    public boolean Insert() {
        try {
            ...
            String rsTmp1 = "SELECT MAX(PARA_CODE) AS PARACODE FROM D_COM_PARAMETER_MAST WHERE PARA_ID='" + paraid.trim() + "' AND COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID);
    ...
    public boolean Delete() {
        try {
            String strQry = "DELETE FROM D_COM_PARAMETER_MAST WHERE COMPANY_ID=" + Integer.toString(SDMLERPGLOBAL.gCompanyID);
            data.Execute(strQry);
            return true;
        } catch (Exception e) {
            LastError = e.getMessage();
