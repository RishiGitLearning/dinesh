...
import sdml.felt.commonUI.ComboData;
...
public class clsFeltRateMaster {    
    ...
    public boolean Insert() {
        ...
        try {            
            ...
            ObjFeltProductionApprovalFlow.DocDate=SDMLERPGLOBAL.getCurrentDateDB();
    ...
    public void UpdateRateDetail() {
        ...
        try {
            ...
            rsDetail.updateString("RATE_FRMDT", SDMLERPGLOBAL.getCurrentDateDB());
            rsDetail.updateString("RATE_TODT", "");
            rsDetail.updateFloat("CHARGES", (float)getAttribute("CHARGES").getVal());
            rsDetail.updateString("CHARGES_FRMDT", SDMLERPGLOBAL.getCurrentDateDB());
            ...
            rsDetailHistory.updateString("RATE_FRMDT", SDMLERPGLOBAL.getCurrentDateDB());
            rsDetailHistory.updateString("RATE_TODT", "");
            rsDetailHistory.updateFloat("CHARGES", (float)getAttribute("CHARGES").getVal());
            rsDetailHistory.updateString("CHARGES_FRMDT", SDMLERPGLOBAL.getCurrentDateDB());
