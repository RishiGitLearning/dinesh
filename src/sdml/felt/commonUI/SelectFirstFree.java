...
public class SelectFirstFree extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(12, 12, 246, 14);
        ...
        cmdCancel.setBounds(316, 88, 78, 23);
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if (Table.getRowCount() <= 0) {
                ...
                DocNo = clsFirstFree.getNextFreeNo(SDMLERPGLOBAL.gCompanyID, ModuleID, Prefix, Suffix, false);
            }
            aDialog.dispose();
        }
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOKActionPerformed
        ...
        if (Table.getRowCount() <= 0) {
            ...
            DocNo = clsFirstFree.getNextFreeNo(SDMLERPGLOBAL.gCompanyID, ModuleID, FirstFreeNo, false);
        }
        aDialog.dispose();
    ...
    private void GenerateTable() {
        ...
        try {
            ...
            rsTmp = stmt.executeQuery("SELECT PREFIX_CHARS,LAST_USED_NO,SUFFIX_CHARS,FIRSTFREE_NO FROM D_COM_FIRSTFREE WHERE COMPANY_ID=" + SDMLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + ModuleID + " AND BLOCKED='N'");
            rsTmp.first();
