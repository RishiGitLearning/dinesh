...
public class FrmFirstFree extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        cmbModuleID.setBounds(140, 90, 260, 20);
    ...
    private void ChkBlockedItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkBlockedItemStateChanged
        ...
        if (ChkBlocked.isSelected()) {
            ...
            txtBlockedDate.setText((String) SDMLERPGLOBAL.getCurrentDateDB());
        } else {
            txtBlockedDate.setEnabled(false);
        }
    ...
    private void DisplayData() {
        try {
            ClearFields();
            SDMLERPGLOBAL.setComboIndex(cmbModuleID, (int) ObjFirstFree.getAttribute("MODULE_ID").getVal());
            ...
            if (Block.equals("Y")) {
                ...
                txtBlockedDate.setText(SDMLERPGLOBAL.formatDate((String) ObjFirstFree.getAttribute("BLOCKED_DATE").getObj()));
            } else {
    ...
    private void SetData() {
        ...
        ObjFirstFree.setAttribute("COMPANY_ID", SDMLERPGLOBAL.gCompanyID);
        ObjFirstFree.setAttribute("MODULE_ID", SDMLERPGLOBAL.getComboCode(cmbModuleID));
        ...
        if (SDMLERPGLOBAL.IsNumber(txtTotalLength.getText())) {
        ...
        if (EditMode == SDMLERPGLOBAL.ADD) {
            ObjFirstFree.setAttribute("CREATED_BY", SDMLERPGLOBAL.gUserID);
            ObjFirstFree.setAttribute("CREATED_DATE", SDMLERPGLOBAL.getCurrentDateDB());
        } else {
            ObjFirstFree.setAttribute("MODIFIED_BY", SDMLERPGLOBAL.gUserID);
            ObjFirstFree.setAttribute("MODIFIED_DATE", SDMLERPGLOBAL.getCurrentDateDB());
        }
    ...
    private void Find() {
        ...
        Loader ObjLoader = new Loader(this, "RS.frmFirstFreeFind", true);
    ...
    private void Save() {
        ...
        if (!SDMLERPGLOBAL.IsNumber(txtLastUsedNo.getText())) {
        ...
        ObjFirstFree.setAttribute("MODULE_ID", SDMLERPGLOBAL.getComboCode(cmbModuleID));
        ObjFirstFree.setAttribute("BLOCKED_DATE", SDMLERPGLOBAL.formatDateDB(txtBlockedDate.getText()));
        if (EditMode == SDMLERPGLOBAL.ADD) {
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(SDMLERPGLOBAL.gCompanyID, SDMLERPGLOBAL.gUserID, 0, 231)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(SDMLERPGLOBAL.gCompanyID, SDMLERPGLOBAL.gUserID, 0, 232)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(SDMLERPGLOBAL.gCompanyID, SDMLERPGLOBAL.gUserID, 0, 233)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(SDMLERPGLOBAL.gCompanyID, SDMLERPGLOBAL.gUserID, 0, 234)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
