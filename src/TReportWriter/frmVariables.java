...
public class frmVariables extends javax.swing.JApplet {
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        ...
        try
        {
            HashMap colBackup=(HashMap)colVariables.clone();
            ...
            {
              TVariable objVar=(TVariable)colBackup.get(Integer.toString(i));
              
              if(!objVar.VariableName.equals(selVar))
              {
                colVariables.put(Integer.toString(colVariables.size()+1),objVar);  
              }
            }
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOKActionPerformed
        ...
        try
        {
           ...
           objTReport.colVariables=colVariables;
    ...
    private void cmdEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdEditActionPerformed
        ...
        try {
            if(GroupList.getSelectedIndex()>=0) {
                ...
                TVariable objVar=(TVariable)colVariables.get(Integer.toString(TGLOBAL.getComboCode(GroupList)));
                
                if(objVar.BuiltInVariable)
                {
                  JOptionPane.showMessageDialog(null,"You can not edit built in variables");
                  return;
                }
                
                frmVariable objVariable=new frmVariable();
                objVariable.objReport=objTReport;
                objVariable.objVar=objVar;
                objVariable.ShowDialog();
                
                if(!objVariable.cancelled) {
                    colVariables.remove(Integer.toString(TGLOBAL.getComboCode(GroupList)));
                    colVariables.put(Integer.toString(TGLOBAL.getComboCode(GroupList)),objVariable.objVar);
                }
    ...
    private void cmdNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNewActionPerformed
        ...
        TVariable objNewVar=new TVariable();
        
        objNewVar.BuiltInVariable=false;
        
        
        frmVariable objVariable=new frmVariable();
        objVariable.objReport=objTReport;
        objVariable.objVar=objNewVar;
        
        objVariable.ShowDialog();
        
        if(!objVariable.cancelled) {
            colVariables.put(Integer.toString(colVariables.size()+1),objVariable.objVar);
            GenerateList();
        }
    ...
    private void GenerateList() {
        try {
            ...
            for(int i=1;i<=colVariables.size();i++) {
                ...
                objComboData.Text=objVar.VariableName;
                objComboData.Code=i;
