 ...
 *
 */
public class FrmEmployeeMasterAmend extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private int ModuleId = 814;
    private String AMEND_NO = "";
    private clsEmployeeMasterAmend EMP;
    private EITLComboModel cmbSendToModel;
    private TReportEngine objEngine = new TReportEngine();
    private frmFindEmployeeAmend ObjFindEmployee;
    ...
    public void init() {
        ...
        EMP = new clsEmployeeMasterAmend();
...
//        txtWeekOff.setText("");
    ...
    private void DisplayData() {
        ...
        clearFields();
        try {
            txtAmendNo.setText(EMP.getAttribute("AMEND_NO").getString());
            txtEmpNo.setText(EMP.getAttribute("EMP_NO").getString());
            lblTitle.setText("SDML EMPLOYEE MASTER AMEND - " + EMP.getAttribute("AMEND_NO").getString());
...
//            txtWeekOff.setText(EMP.getAttribute("EMP_WEEKOFF").getString());
            ...
            String DocNo = EMP.getAttribute("AMEND_NO").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsEmployeeMasterAmend ObjHistory = (clsEmployeeMasterAmend) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10022, 100221)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10022, 100222)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10022, 100223)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10022, 100225)) {
    ...
    private void GenerateCombos() {
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (EITLERPGLOBAL.gNewUserID == SDMLATTPAY.ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, ModuleId, AMEND_NO + "")) {
                List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (ModuleId));
            } else {
                List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + ModuleId);
            }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = SDMLATTPAY.ApprovalFlow.getRemainingUsers(EITLERPGLOBAL.gCompanyID, ModuleId, AMEND_NO + "");
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
...
//        tcm.getColumn(5).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        lblPayEmpNo = new javax.swing.JLabel();
        txtPayEmpNo = new javax.swing.JTextField();
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(510, 10, 90, 30);

        jLabel3.setText("Emp No");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(320, 10, 80, 30);

        txtAmendNo.setBackground(new java.awt.Color(254, 242, 230));
        txtAmendNo.setText("S00000001");
        jPanel1.add(txtAmendNo);
        txtAmendNo.setBounds(150, 10, 120, 30);

        txtDocDate.setEditable(false);
        jPanel1.add(txtDocDate);
        txtDocDate.setBounds(610, 10, 190, 30);

        lblRevNo.setText("...");
        jPanel1.add(lblRevNo);
        lblRevNo.setBounds(270, 0, 30, 30);
        ...
        jLabel10.setBounds(10, 260, 160, 15);

        jLabel12.setText("Corres Address");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(10, 100, 140, 15);

        jLabel13.setText("Permenent Address");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(10, 140, 150, 15);
        ...
        jLabel16.setBounds(570, 180, 80, 15);
        ...
        jLabel18.setBounds(10, 220, 90, 15);
        ...
        jLabel23.setBounds(570, 260, 110, 15);
        ...
        jLabel26.setBounds(820, 290, 100, 30);

        jLabel27.setText("Category");
        jPanel1.add(jLabel27);
        jLabel27.setBounds(330, 290, 100, 30);

        jLabel30.setText("Shift");
        jPanel1.add(jLabel30);
        jLabel30.setBounds(570, 290, 70, 30);

        jLabel37.setText("Main Category");
        jPanel1.add(jLabel37);
        jLabel37.setBounds(10, 290, 120, 30);
        ...
        txtDivision.setBounds(910, 290, 190, 30);
        jPanel1.add(txtCompany);
        txtCompany.setBounds(150, 330, 160, 30);

        lblPayEmpNo.setText("Pay EMP No");
        jPanel1.add(lblPayEmpNo);
        lblPayEmpNo.setBounds(820, 10, 130, 30);

        txtPayEmpNo.setEditable(false);
        jPanel1.add(txtPayEmpNo);
        txtPayEmpNo.setBounds(920, 10, 190, 30);
        ...
        cmbMainCategory.setBounds(150, 287, 160, 30);

        cmbCategory.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(cmbCategory);
        cmbCategory.setBounds(400, 287, 160, 30);

        cmbShift.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(cmbShift);
        cmbShift.setBounds(620, 287, 180, 30);

        jLabel28.setText("Amend No");
        jPanel1.add(jLabel28);
        jLabel28.setBounds(10, 10, 130, 30);
        ...
        txtEmpNo.setBounds(390, 10, 110, 30);

        jLabel29.setText("Week Off Day");
        jPanel1.add(jLabel29);
        jLabel29.setBounds(330, 340, 110, 20);
        ...
        cmb_EMP_WEEKOFF_DAY.setBounds(430, 330, 130, 30);
        ...
        lblTitle.setText("SDML EMPLOYEE MASTER AMEND");
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            ...
            if (SDMLATTPAY.ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID, ModuleId, AMEND_NO + "")) {
                cmbSendTo.setEnabled(true);
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                ...
                if (OpgApprove.isSelected()) {
                    IncludeUser = SDMLATTPAY.ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, ModuleId, AMEND_NO + "", ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }
                ...
                if (OpgReject.isSelected()) {
                    ...
                    IncludeUser = SDMLATTPAY.ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, ModuleId, AMEND_NO + "", ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = SDMLATTPAY.ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, ModuleId, AMEND_NO + "");
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        String DocNo = txtAmendNo.getText();
    ...
    private void txtEmpNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEmpNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) {
            try {
                ...
                aList.SQL = "SELECT EMP_NO,EMP_NAME FROM SDMLATTPAY.ATTPAY_EMPMST where APPROVED=1";
                aList.ReturnCol = 1;
                ...
                if (aList.ShowLOV()) {
                    ...
                    ResultSet rs = data.getResult("SELECT * FROM SDMLATTPAY.ATTPAY_EMPMST where APPROVED=1 AND EMP_NO='"+aList.ReturnVal+"'");
                    
                    rs.first();
                    
                    txtEmpName.setText(rs.getString("EMP_NAME"));
                    
                    txtPayEmpNo.setText(rs.getString("PAY_EMP_NO"));
                    txtEmpName.setText(rs.getString("EMP_NAME"));
                    //cmbDesignation.setText("");        

                    txtBirthDate.setText(EITLERPGLOBAL.formatDate(rs.getString("EMP_BIRTH_DATE")));
                    txtJoinDate.setText(EITLERPGLOBAL.formatDate(rs.getString("EMP_JOIN_DATE")));
                    txtConfirmDate.setText(EITLERPGLOBAL.formatDate(rs.getString("EMP_CONFIRM_DATE")));
                    txtLeftDate.setText(EITLERPGLOBAL.formatDate(rs.getString("EMP_LEFT_DATE")));
                    txtQualification.setText(rs.getString("EMP_QUALIFICATION"));
//                    txtWeekOff.setText(rs.getString("EMP_WEEKOFF"));

                    txtCorresAddress.setText(rs.getString("EMP_CORRES_ADDRESS"));
                    txtPermenantAddress.setText(rs.getString("EMP_PERM_ADDRESS"));

                    txtCity.setText(rs.getString("EMP_CITY"));
                    txtDistrict.setText(rs.getString("EMP_DISTRICT"));
                    txtState.setText(rs.getString("EMP_STATE"));

                    txtCountry.setText(rs.getString("EMP_COUNTRY"));
                    txtPincode.setText(rs.getString("EMP_PINCODE"));
                    txtPhone.setText(rs.getString("EMP_PHONE"));
                    txtEmailId.setText(rs.getString("EMP_EMAIL"));
                    txtBloodGroup.setText(rs.getString("EMP_BLOODGROUP"));
                    txtMaritalStatus.setText(rs.getString("EMP_MARITAL_STATUS"));
                    txtGender.setText(rs.getString("EMP_SEX"));
                    txtCompany.setText(rs.getString("EMP_COMPANY"));
                    txtDivision.setText(rs.getString("EMP_DIVISION"));

                    EITLERPGLOBAL.setComboIndex(cmbDept, rs.getInt("EMP_DEPARTMENT"));
                    EITLERPGLOBAL.setComboIndex(cmbCategory, rs.getInt("EMP_CATEGORY"));
                    EITLERPGLOBAL.setComboIndex(cmbDesignation, rs.getInt("EMP_DESIGNATION"));
                    EITLERPGLOBAL.setComboIndex(cmbMainCategory, rs.getInt("EMP_MAIN_CATEGORY"));
                    EITLERPGLOBAL.setComboIndex(cmbShift, rs.getInt("EMP_SHIFT_ID"));
                }
            }catch(Exception w)
            {
                w.printStackTrace();
    ...
    private void txtEmpNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtEmpNoFocusLost
        ...
        try{
                    ResultSet rs = data.getResult("SELECT * FROM SDMLATTPAY.ATTPAY_EMPMST where APPROVED=1 AND EMP_NO='"+txtEmpNo.getText()+"'");
...
//                    txtWeekOff.setText(rs.getString("EMP_WEEKOFF"));
    ...
    private void Add() {
        ...
        aList.ModuleID = 814;
        aList.FirstFreeNo = 319;

        txtDocDate.setText(EITLERPGLOBAL.getCurrentDate());
       
        FFNo = aList.FirstFreeNo;
        txtAmendNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, ModuleId, FFNo, false));
        lblTitle.setText("SDML EMPLOYEE MASTER AMEND - " + txtAmendNo.getText());
        cmb_EMP_WEEKOFF_DAY.setSelectedIndex(0);
        txtEmpNo.setText("");
    }

    private void Find() {
        Loader ObjLoader = new Loader(this, "SDMLATTPAY.EmployeeAmend.frmFindEmployeeAmend", true);
        frmFindEmployeeAmend ObjFindEmployee = (frmFindEmployeeAmend) ObjLoader.getObj();

        if (ObjFindEmployee.Cancelled == false) {
            if (!EMP.Filter(ObjFindEmployee.stringFindQuery)) {
                JOptionPane.showMessageDialog(this, "No records found.", "Find Employee Master Amend", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (EMP.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                    ...
                    data.Execute("UPDATE SDMLATTPAY.ATTPAY_EMPMST " +
                                "SET " +
                                "PAY_EMP_NO = '"+txtPayEmpNo.getText()+"', " +
                                "EMP_NAME = '"+txtEmpName.getText()+"', " +
                                "EMP_DESIGNATION = "+EITLERPGLOBAL.getComboCode(cmbDesignation)+", " +
                                "EMP_DEPARTMENT = "+EITLERPGLOBAL.getComboCode(cmbDept)+", " +
                                "EMP_BIRTH_DATE = '"+EITLERPGLOBAL.formatDateDB(txtBirthDate.getText())+"', " +
                                "EMP_JOIN_DATE = '"+EITLERPGLOBAL.formatDateDB(txtJoinDate.getText())+"', " +
                                "EMP_CONFIRM_DATE = '"+EITLERPGLOBAL.formatDateDB(txtConfirmDate.getText())+"', " +
                                "EMP_LEFT_DATE = '"+EITLERPGLOBAL.formatDateDB(txtLeftDate.getText())+"', " +
                                "EMP_QUALIFICATION = '"+txtQualification.getText()+"', " +
//                                "EMP_WEEKOFF = '"+txtWeekOff.getText()+"', " +
                                "EMP_CORRES_ADDRESS = '"+txtCorresAddress.getText()+"', " +
                                "EMP_PERM_ADDRESS = '"+txtPermenantAddress.getText()+"', " +
                                "EMP_CITY = '"+txtCity.getText()+"'," +
                                "EMP_DISTRICT = '"+txtDistrict.getText()+"'," +
                                "EMP_STATE = '"+txtState.getText()+"'," +
                                "EMP_COUNTRY = '"+txtCountry.getText()+"'," +
                                "EMP_PINCODE = '"+txtPincode.getText()+"'," +
                                "EMP_PHONE = '"+txtPhone.getText()+"'," +
                                "EMP_EMAIL = '"+txtEmailId.getText()+"'," +
                                "EMP_BLOODGROUP = '"+txtBloodGroup.getText()+"'," +
                                "EMP_MARITAL_STATUS = '"+txtMaritalStatus.getText()+"'," +
                                "EMP_SEX = '"+txtGender.getText()+"'," +
                                "EMP_COMPANY = '"+txtCompany.getText()+"'," +
                                "EMP_DIVISION = '"+txtDivision.getText()+"'," +
                                "EMP_CATEGORY = "+EITLERPGLOBAL.getComboCode(cmbCategory)+"," +
                                "EMP_SHIFT_ID = '"+EITLERPGLOBAL.getComboCode(cmbShift)+"'," +
                                "EMP_MAIN_CATEGORY = "+EITLERPGLOBAL.getComboCode(cmbMainCategory)+"," +
                                "EMP_WEEKOFF_DAY = '"+cmb_EMP_WEEKOFF_DAY.getSelectedItem()+"' "+
                                "WHERE EMP_NO = '"+txtEmpNo.getText()+"'");
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (EMP.Update()) {
                ...
                if (OpgFinal.isSelected()) {
                    ...
                    //AMEND_NO = txtAmendNo.getText();
                    String str= "UPDATE SDMLATTPAY.ATTPAY_EMPMST " +
                                "SET " +
                                "PAY_EMP_NO = '"+txtPayEmpNo.getText()+"', " +
                                "EMP_NAME = '"+txtEmpName.getText()+"', " +
                                "EMP_DESIGNATION = "+EITLERPGLOBAL.getComboCode(cmbDesignation)+", " +
...
//                                "EMP_WEEKOFF = '"+txtWeekOff.getText()+"', " +
                                ...
                                "EMP_DIVISION = '"+txtDivision.getText()+"'," +
                                "EMP_CATEGORY = "+EITLERPGLOBAL.getComboCode(cmbCategory)+"," +
                                "EMP_SHIFT_ID = '"+EITLERPGLOBAL.getCombostrCode(cmbShift)+"'," +
                                "EMP_MAIN_CATEGORY = "+EITLERPGLOBAL.getComboCode(cmbMainCategory)+"," +
                                "EMP_WEEKOFF_DAY = '"+cmb_EMP_WEEKOFF_DAY.getSelectedItem()+"' "+
                                "WHERE EMP_NO = '"+txtEmpNo.getText()+"'";
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) EMP.getAttribute("AMEND_NO").getObj();
        if (EMP.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (SDMLATTPAY.ApprovalFlow.IsCreator(814, productionDocumentNo)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Delete() {
        if (EMP.CanDelete(txtAmendNo.getText() + "", txtDocDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            DisplayData();
        } else {
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = SDMLATTPAY.ApprovalFlow.getRemainingUsers(EITLERPGLOBAL.gCompanyID, ModuleId, txtAmendNo.getText() + "");
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
...
//        txtWeekOff.setEnabled(pStat);
    ...
    private void SetData() {
        ...
        EMP.setAttribute("AMEND_NO", txtAmendNo.getText());
        EMP.setAttribute("DOC_DATE", txtDocDate.getText());
        
        AMEND_NO = txtAmendNo.getText();
        EMP.setAttribute("EMP_NO", txtEmpNo.getText());
        EMP.setAttribute("DOC_DATE", EITLERPGLOBAL.formatDateDB(txtDocDate.getText()));
        
        EMP.setAttribute("PAY_EMP_NO", txtPayEmpNo.getText());
...
//        EMP.setAttribute("EMP_WEEKOFF", txtWeekOff.getText());
        ...
        EMP.setAttribute("EMP_COMPANY", txtCompany.getText());
        EMP.setAttribute("EMP_DIVISION", txtDivision.getText());
...
//        {}
    ...
    private javax.swing.JLabel lblPayEmpNo;
    ...
    private javax.swing.JTextField txtPayEmpNo;
