 ...
 *
 */
public class FrmSpecialSanctionEntry extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private int ModuleId = 819;
    private String DOC_NO = "";
    private clsSpecialSanctionEntry specialentry;
    ...
    public void init() {
        ...
        specialentry = new clsSpecialSanctionEntry();
        //boolean load = specialentry.LoadData(EITLERPGLOBAL.gCompanyID);
        boolean load = specialentry.LoadData();
        if (load) {
            DisplayData();
            MoveLast();
        } else {
            JOptionPane.showMessageDialog(this, "Error occured while Loading Data. Error is " + specialentry.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        SetFields(false);
    ...
    private void DisplayData() {
        ...
        try {
            ...
            if ("1".equals(specialentry.getAttribute("APPROVED").getString())) {
                lblTitle.setBackground(Color.BLUE);
                lblTitle.setForeground(Color.WHITE);
            }

            if ("0".equals(specialentry.getAttribute("APPROVED").getString())) {
                lblTitle.setBackground(Color.GRAY);
                lblTitle.setForeground(Color.BLACK);
            }

            if ("1".equals(specialentry.getAttribute("CANCELED").getString())) {
...
/*
        try {
            if (EditMode == 0) {
                if (specialentry.getAttribute("APPROVED").getInt() == 1) {
                    lblTitle.setBackground(Color.BLUE);
                }
                ...
                if (specialentry.getAttribute("CANCELLED").getInt() == 1) {
                    lblTitle.setBackground(Color.RED);
                }
            }
        } catch (Exception c) {
...
*/
        ...
        try {
            ...
            DOC_NO = specialentry.getAttribute("SPECIAL_SANCTION_DOC_NO").getString();
            correctionType = specialentry.getAttribute("CORRECTION_TYPE").getString();
            lblTitle.setText("SPECIAL SANCTION ENTRY  - " + DOC_NO);
            lbldoc.setText(DOC_NO);
            docdate.setText(EITLERPGLOBAL.formatDate(specialentry.getAttribute("SPECIAL_SANCTION_DOC_DATE").getString()));
            lblCorrectionType.setText(specialentry.getAttribute("CORRECTION_TYPE").getString());
            ...
            FormatGrid();
            //Now Generate Table
            for (int i = 1; i <= specialentry.hmTimeCorrectionDetails.size(); i++) {
                clsTimeCorrectionDetails objTimeCorrectionDetails = (clsTimeCorrectionDetails) specialentry.hmTimeCorrectionDetails.get(Integer.toString(i));
                ...
                String empmaincat=data.getStringValueFromDB("SELECT MCATNAME FROM SDMLATTPAY.EMP_CATEGORY WHERE PAY_EMP_NO='"+objTimeCorrectionDetails.getAttribute("EMP_CODE").getString()+"'");                
                String empcat=data.getStringValueFromDB("SELECT DEPARTMENT FROM SDMLATTPAY.EMP_CATEGORY WHERE PAY_EMP_NO='"+objTimeCorrectionDetails.getAttribute("EMP_CODE").getString()+"'");                
                rowData[2] = EITLERPGLOBAL.formatDate(objTimeCorrectionDetails.getAttribute("A_DATE").getString());
                rowData[3] = objTimeCorrectionDetails.getAttribute("FIRST_HALF").getString();
                rowData[4] = objTimeCorrectionDetails.getAttribute("SECOND_HALF").getString();
                rowData[5] = objTimeCorrectionDetails.getAttribute("LC_TIME").getString();                
                rowData[6] = objTimeCorrectionDetails.getAttribute("SANCTION_REMARKS").getString();                
                rowData[7]=empname;
                rowData[8]=empdept;                                    
                rowData[9]=empmaincat;
                rowData[10]=empcat;                                    
                
                
                String allpunches="",allogppunches="",allpgppunches="";
            ...
            allogppunches=data.getStringValueFromDB("SELECT ALL_PERSONAL_GATEPASS_PUNCHES FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='"+empcode+"' AND PUNCHDATE='"+attendancedate+"'");            
            allpgppunches=data.getStringValueFromDB("SELECT ALL_OFFICIAL_GATEPASS_PUNCHES FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='"+empcode+"' AND PUNCHDATE='"+attendancedate+"'");            
                 rowData[11]=allpunches;
                 rowData[12]=allogppunches;
                 rowData[13]=allpgppunches;
        ...
        try {
            ...
            String DocNo = specialentry.getAttribute("SPECIAL_SANCTION_DOC_NO").getString();
            ...
            FormatGridHS();
            //HashMap History = specialentry.getHistoryList(EITLERPGLOBAL.gCompanyID + "", DocNo);
            HashMap History = clsSpecialSanctionEntry.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsSpecialSanctionEntry ObjHistory = (clsSpecialSanctionEntry) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10036, 100361)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10036, 100362)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10036, 100363)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10036, 100364)) {
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = SDMLATTPAY.ApprovalFlow.getFromID(EITLERPGLOBAL.gCompanyID, ModuleId, specialentry.getAttribute("SPECIAL_SANCTION_DOC_NO").getString());
            //lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = SDMLATTPAY.ApprovalFlow.getFromRemarks(EITLERPGLOBAL.gCompanyID, ModuleId, FromUserID, specialentry.getAttribute("SPECIAL_SANCTION_DOC_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (SDMLATTPAY.ApprovalFlow.IsCreator(ModuleId, specialentry.getAttribute("SPECIAL_SANCTION_DOC_NO").getString() + "")) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void initComponents() {
        ...
        mnuitemUpdate.setText("UPDATION");
        ...
        lblStatus1.setBounds(10, 360, 1000, 30);
        ...
        jPanel1.add(jPanel5);
        jPanel5.setBounds(0, 40, 1110, 10);
        ...
        jScrollPane1.setBounds(11, 90, 1090, 260);
        ...
        ToolBar.setBounds(0, 0, 1130, 40);

        lblTitle.setBackground(new java.awt.Color(0, 102, 153));
        lblTitle.setText("SPECIAL SANCTION OF TIME");
        lblTitle.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        lblTitle.setOpaque(true);
        getContentPane().add(lblTitle);
        lblTitle.setBounds(0, 40, 1130, 30);
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        ...
        //specialentry.ShowHistory(DocNo);
        MoveLast();
    }//GEN-LAST:event_cmdViewHistoryActionPerformed

    private void cmdNormalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNormalViewActionPerformed
        //specialentry.HistoryView = false;
        //specialentry.LoadData();
        MoveLast();
...
if(EditMode==EITLERPGLOBAL.ADD || EditMode==EITLERPGLOBAL.EDIT){
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            if (Table.getSelectedColumn() == 1) {
                ...
                //setText(aList.ReturnVal);                               
                    ...
                    String maincat=data.getStringValueFromDB("SELECT MCATNAME FROM SDMLATTPAY.EMP_CATEGORY WHERE PAY_EMP_NO='"+aList.ReturnVal+"'");
                    String cat=data.getStringValueFromDB("SELECT CATNAME FROM SDMLATTPAY.EMP_CATEGORY WHERE PAY_EMP_NO='"+aList.ReturnVal+"'");    
                    
                    Table.getModel().setValueAt(empname, Table.getSelectedRow(), 7);
                    Table.getModel().setValueAt(empdept, Table.getSelectedRow(), 8);
                    Table.getModel().setValueAt(maincat, Table.getSelectedRow(), 9);
                    Table.getModel().setValueAt(cat, Table.getSelectedRow(), 10);
                }
            }
            if (Table.getSelectedColumn() == 4) {
                LOV aList = new LOV();
            //aList.SQL = "SELECT EMP_CODE,LC_TIME FROM SDMLATTPAY.ATT_DATA WHERE EMP_CODE='"+txtempcd.getText().substring(3)+"'";
                //aList.SQL = "SELECT EMP_CODE,LC_TIME FROM SDMLATTPAY.ATT_DATA WHERE EMP_CODE='"+txtempcd.getText()+"' AND A_DATE='"+EITLERPGLOBAL.formatDateDB(txtGatepassdate.getText())+"' ";
    ...
    private void TableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyReleased
        ...
        if(Table.getSelectedColumn()==3){
            ...
            officialcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_SANCTION WHERE EMP_CODE='"+empcode+"' " +
"AND GATEPASS_TYPE='OFFICIAL' AND date_format(A_DATE,'%m')='"+attendancemonth+"' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 
            personalcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_SANCTION WHERE EMP_CODE='"+empcode+"' " +
"AND GATEPASS_TYPE='PERSONAL' AND date_format(A_DATE,'%m')='"+attendancemonth+"' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 
            yearlyofficialcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_SANCTION WHERE EMP_CODE='"+empcode+"' " +
"AND GATEPASS_TYPE='OFFICIAL' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 
            yearlypersonalcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_SANCTION WHERE EMP_CODE='"+empcode+"' " +
"AND GATEPASS_TYPE='PERSONAL' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 

            if(correctionType.equals("MIS-PUNCH")){
            Table.setValueAt(officialcounter, Table.getSelectedRow(), 7);
            Table.setValueAt(personalcounter, Table.getSelectedRow(), 8);            
            Table.setValueAt(yearlyofficialcounter, Table.getSelectedRow(), 9);
            Table.setValueAt(yearlypersonalcounter, Table.getSelectedRow(), 10);
            }
...
/*
         ...
         if (Table.getSelectedColumn() == 3) {
            try{
            String dt = "", dtbefore = "", dtafter = "",allpunches="",allpgppunches="",allogppunches="";
            empcode = Table.getModel().getValueAt(Table.getSelectedRow(), 1).toString();
            ...
            allpunches=data.getStringValueFromDB("SELECT ALL_PUNCHES FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='"+empcode+"' AND PUNCHDATE='"+attendancedate+"'");
            allogppunches=data.getStringValueFromDB("SELECT ALL_OFFICIAL_GATEPASS_PUNCHES FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='"+empcode+"' AND PUNCHDATE='"+attendancedate+"'");
            allpgppunches=data.getStringValueFromDB("SELECT ALL_PESONAL_GATEPASS_PUNCHES FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='"+empcode+"' AND PUNCHDATE='"+attendancedate+"'");
             
             Table.setValueAt(allpunches, Table.getSelectedRow(), 11); 
             Table.setValueAt(allogppunches, Table.getSelectedRow(), 12); 
             Table.setValueAt(allpgppunches, Table.getSelectedRow(), 13); 
...
//        }
    ...
    private void MoveFirst() {
        specialentry.MoveFirst();
        DisplayData();
    }

    private void MovePrevious() {
        specialentry.MovePrevious();
        DisplayData();
    }

    private void MoveNext() {
        specialentry.MoveNext();
        DisplayData();
    }

    private void MoveLast() {
        specialentry.MoveLast();
        DisplayData();
    }
    ...
    Loader ObjLoader=new Loader(this,"SDMLATTPAY.gatepass.FrmTimeCorrectionEntryFind",true);
        ...
        if(ObjTimeCorrectionFind.Cancelled==false) {
            if(!specialentry.Filter(ObjTimeCorrectionFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(FrmSpecialSanctionEntry.this," No records found.","Find Time Correction Details",JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        specialentry.Filter(" SPECIAL_SANCTION_DOC_NO IN (SELECT DISTINCT SDMLATTPAY.ATT_SPECIAL_SANCTION.SPECIAL_SANCTION_DOC_NO FROM SDMLATTPAY.ATT_SPECIAL_SANCTION, SDMLATTPAY.D_COM_DOC_DATA WHERE SDMLATTPAY.ATT_SPECIAL_SANCTION.SPECIAL_SANCTION_DOC_NO=SDMLATTPAY.D_COM_DOC_DATA.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
    ...
    private void Add() {
        ...
        correctionType = "SPECIAL SANCTION";
        ...
        EITLERP.FeltSales.common.SelectFirstFree aList = new EITLERP.FeltSales.common.SelectFirstFree();
        aList.ModuleID = ModuleId;
        aList.FirstFreeNo = 324;
        FFNo = aList.FirstFreeNo;
        lbldoc.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, ModuleId, FFNo, false));
        lblTitle.setText("SPECIAL SANCTION ENTRY - " + lbldoc.getText());
    ...
    private void FormatGrid() {
        ...
        if(correctionType.equals("MIS-PUNCH")){
         JComboBox cmbDayType = new JComboBox();
            ...
            //Table.getColumnModel().getColumn(6).setCellEditor(new DefaultCellEditor(cmbDayType));
        }
    }
    ...
    private void Save() {
        ...
        //specialentry.LoadData();
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (specialentry.Insert()) {
                clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, ModuleId, FFNo, true);

                DisplayData();
            } else {
                JOptionPane.showMessageDialog(this, "Error occured while saving. Error is " + specialentry.LastError, " SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }

        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (specialentry.Update()) {
                DisplayData();
            } else {
                JOptionPane.showMessageDialog(this, "Error occured while saving editing. Error is " + specialentry.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Edit() {
        ...
        //String DocumentNo = specialentry.getAttribute("ATT_TIME_CORRRECTION_DOC_NO").getString();
        //String DocumentNo = lbldoc.getText();
        String DocumentNo = DOC_NO;

        //if (specialentry.IsEditable(EITLERPGLOBAL.gCompanyID, DocumentNo, EITLERPGLOBAL.gNewUserID)) {
        if (specialentry.IsEditable(DocumentNo, EITLERPGLOBAL.gNewUserID)) {
...
// find rate update by doc no
    public void Find(String docNo) {
        specialentry.Filter(" DOC_NO='" + docNo + "'");
        SetMenuForRights();
        DisplayData();
    }

    public void FindEx(int pCompanyID, String docno) {
        specialentry.Filter(" SPECIAL_SANCTION_DOC_NO='" + docno + "'");
        specialentry.MoveFirst();
        DisplayData();
    }
...
//      
        specialentry.setAttribute("SPECIAL_SANCTION_DOC_NO", lbldoc.getText());
        DOC_NO = lbldoc.getText();
        //specialentry.setAttribute("SPECIAL_SANCTION_DOC_NO", DOC_NO);
        specialentry.setAttribute("SPECIAL_SANCTION_DOC_DATE", docdate.getText());
        specialentry.setAttribute("CORRECTION_TYPE", lblCorrectionType.getText());

        specialentry.setAttribute("MODULE_ID", ModuleId);
        specialentry.setAttribute("USER_ID", EITLERPGLOBAL.gNewUserID);

        specialentry.setAttribute("REJECTED_REMARKS", txtToRemarks.getText());
        specialentry.setAttribute("REMARKS", "");
        specialentry.setAttribute("APPROVAL_STATUS", "");
        specialentry.setAttribute("APPROVER_REMARKS", txtFromRemarks.getText());
        specialentry.setAttribute("ENTRY_DATE", EITLERPGLOBAL.getCurrentDateDB());

        //----- Update Approval Specific Fields -----------//
        specialentry.setAttribute("HIERARCHY_ID", EITLERPGLOBAL.getComboCode(cmbHierarchy));
        specialentry.setAttribute("FROM", EITLERPGLOBAL.gNewUserID);
        specialentry.setAttribute("TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        specialentry.setAttribute("FROM_REMARKS", txtToRemarks.getText());

        if (OpgApprove.isSelected()) {
            specialentry.setAttribute("APPROVAL_STATUS", "A");
        }

        if (OpgFinal.isSelected()) {
            specialentry.setAttribute("APPROVAL_STATUS", "F");
        }

        if (OpgReject.isSelected()) {
            specialentry.setAttribute("APPROVAL_STATUS", "R");
            specialentry.setAttribute("SEND_DOC_TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        }

        if (OpgHold.isSelected()) {
            specialentry.setAttribute("APPROVAL_STATUS", "H");
        }
        //-------------------------------------------------//

        if (EditMode == EITLERPGLOBAL.ADD) {
            specialentry.setAttribute("CREATED_BY", EITLERPGLOBAL.gNewUserID);
            specialentry.setAttribute("CREATED_DATE", EITLERPGLOBAL.getCurrentDateDB());
        } else {
            specialentry.setAttribute("MODIFIED_BY", EITLERPGLOBAL.gNewUserID);
            specialentry.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.getCurrentDateDB());
            specialentry.setAttribute("UPDATED_BY", EITLERPGLOBAL.gNewUserID);
            specialentry.setAttribute("UPDATED_DATE", EITLERPGLOBAL.getCurrentDateDB());
        }
        int i = 0;
        String empcode = "", attendancedate = "", lctime = "", firsthalf = "", secondhalf = "", gatepasstype = "",sanctionremarks="";
        specialentry.hmTimeCorrectionDetails.clear();
        ...
        for (i = 0; i <= Table.getRowCount() - 1; i++) {
            ...
            firsthalf = ((String) Table.getValueAt(i, 3)).trim().toUpperCase();
            secondhalf = ((String) Table.getValueAt(i, 4)).trim().toUpperCase();
            lctime = ((String) Table.getValueAt(i, 5)).trim().toUpperCase();
//            if(correctionType.equals("MIS-PUNCH")){
//                gatepasstype = ((String) Table.getValueAt(i, 6)).trim().toUpperCase();
//            }else{
//                gatepasstype = "";
//            }
            sanctionremarks = ((String) Table.getValueAt(i, 6)).trim().toUpperCase();
            ...
            correctiondetails.setAttribute("FIRST_HALF", firsthalf);
            correctiondetails.setAttribute("SECOND_HALF", secondhalf);
            correctiondetails.setAttribute("LC_TIME", lctime);
            correctiondetails.setAttribute("SANCTION_REMARKS", sanctionremarks);
                        
            //correctiondetails.setAttribute("GATEPASS_TYPE", gatepasstype);

            specialentry.hmTimeCorrectionDetails.put(Integer.toString(specialentry.hmTimeCorrectionDetails.size() + 1), correctiondetails);
    ...
    private boolean Validate() {
        ...
        for(int i=0;i<=Table.getRowCount()-1;i++) {            
            String mispunchtype=Table.getModel().getValueAt(i,4).toString();
            String empcode=Table.getModel().getValueAt(i,1).toString();
            String attdancedate=Table.getModel().getValueAt(i,2).toString();
