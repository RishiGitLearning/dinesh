 ...
 *
 */
public class FrmSpecialDeductionEntry extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private int ModuleId = 823;
    private String DOC_NO = "";
    private clsSpecialDeductionEntry specialentry;
    ...
    public void init() {
        ...
        specialentry = new clsSpecialDeductionEntry();
...
*/
        ...
        try {
            ...
            DOC_NO = specialentry.getAttribute("SPECIAL_DEDUCTION_DOC_NO").getString();
            lblTitle.setText("SPECIAL DEDUCTION ENTRY - " + DOC_NO);
            lbldoc.setText(DOC_NO);
            docdate.setText(EITLERPGLOBAL.formatDate(specialentry.getAttribute("SPECIAL_DEDUCTION_DOC_DATE").getString()));
        ...
        try {
            ...
            String DocNo = specialentry.getAttribute("SPECIAL_DEDUCTION_DOC_NO").getString();
            ...
            HashMap History = clsSpecialDeductionEntry.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsSpecialDeductionEntry ObjHistory = (clsSpecialDeductionEntry) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10038, 100381)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10038, 100382)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10038, 100383)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10038, 100384)) {
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = SDMLATTPAY.ApprovalFlow.getFromID(EITLERPGLOBAL.gCompanyID, ModuleId, specialentry.getAttribute("SPECIAL_DEDUCTION_DOC_NO").getString());
            //lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = SDMLATTPAY.ApprovalFlow.getFromRemarks(EITLERPGLOBAL.gCompanyID, ModuleId, FromUserID, specialentry.getAttribute("SPECIAL_DEDUCTION_DOC_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (SDMLATTPAY.ApprovalFlow.IsCreator(ModuleId, specialentry.getAttribute("SPECIAL_DEDUCTION_DOC_NO").getString() + "")) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void initComponents() {
        ...
        btnRemove.setBounds(210, 60, 70, 28);
        ...
        lblTitle.setText("SPECIAL DEDUCTION ENTRY - ");
...
//            officialcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_DEDUCTION WHERE EMP_CODE='"+empcode+"' " +
//"AND GATEPASS_TYPE='OFFICIAL' AND date_format(A_DATE,'%m')='"+attendancemonth+"' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 
//            personalcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_DEDUCTION WHERE EMP_CODE='"+empcode+"' " +
//"AND GATEPASS_TYPE='PERSONAL' AND date_format(A_DATE,'%m')='"+attendancemonth+"' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 
//            yearlyofficialcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_DEDUCTION WHERE EMP_CODE='"+empcode+"' " +
//"AND GATEPASS_TYPE='OFFICIAL' AND date_format(A_DATE,'%Y')='"+attendanceyear+"'"); 
//            yearlypersonalcounter=data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.ATT_SPECIAL_DEDUCTION WHERE EMP_CODE='"+empcode+"' " +
...
//        }
    ...
    Loader ObjLoader=new Loader(this,"SDMLATTPAY.gatepass.FrmTimeCorrectionEntryFind",true);
        ...
        if(ObjTimeCorrectionFind.Cancelled==false) {
            if(!specialentry.Filter(ObjTimeCorrectionFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(FrmSpecialDeductionEntry.this," No records found.","Find Time Correction Details",JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        specialentry.Filter(" SPECIAL_DEDUCTION_DOC_NO IN (SELECT DISTINCT SDMLATTPAY.ATT_SPECIAL_DEDUCTION.SPECIAL_DEDUCTION_DOC_NO FROM SDMLATTPAY.ATT_SPECIAL_DEDUCTION, SDMLATTPAY.D_COM_DOC_DATA WHERE SDMLATTPAY.ATT_SPECIAL_DEDUCTION.SPECIAL_DEDUCTION_DOC_NO=SDMLATTPAY.D_COM_DOC_DATA.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Deduction LC Time");        
...
// find rate update by doc no
    ...
    public void FindEx(int pCompanyID, String docno) {
        specialentry.Filter(" SPECIAL_DEDUCTION_DOC_NO='" + docno + "'");
        specialentry.MoveFirst();
        DisplayData();
    }
...
//      
        specialentry.setAttribute("SPECIAL_DEDUCTION_DOC_NO", lbldoc.getText());
        DOC_NO = lbldoc.getText();
        //specialentry.setAttribute("SPECIAL_DEDUCTION_DOC_NO", DOC_NO);
        specialentry.setAttribute("SPECIAL_DEDUCTION_DOC_DATE", docdate.getText());
        specialentry.setAttribute("CORRECTION_TYPE", "SPECIAL DEDUCTION");
        ...
        int i = 0;
        String empcode = "", attendancedate = "", lctime = "", firsthalf = "", secondhalf = "", gatepasstype = "", deductionRemark="";
        ...
        for (i = 0; i <= Table.getRowCount() - 1; i++) {
            ...
            deductionRemark = ((String) Table.getValueAt(i, 6)).trim().toUpperCase();
//            if(correctionType.equals("MIS-PUNCH")){
...
//            }
            ...
            correctiondetails.setAttribute("SANCTION_REMARKS", deductionRemark);
    ...
    private boolean Validate() {
        ...
        for(int i=0;i<=Table.getRowCount()-1;i++) {            
            String deductionTime=Table.getModel().getValueAt(i,5).toString();
            String deductionRemark=Table.getModel().getValueAt(i,6).toString();
            String empcode=Table.getModel().getValueAt(i,1).toString();
            String attdancedate=Table.getModel().getValueAt(i,2).toString();
            if(deductionTime.equals("")) {
                JOptionPane.showMessageDialog(this,"Please enter Time.");
                return false;
            }
            if(deductionRemark.equals("")) {
                JOptionPane.showMessageDialog(this,"Please enter Deduction Remark.");
                return false;
            }
            if(empcode.equals("")) {
