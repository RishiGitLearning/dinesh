 ...
 *
 */
public class FrmTravelEntryAmend extends javax.swing.JApplet {
    ...
    private EITLTableModel DataModel, DataModelPT, DataModelParty, DataModelExpense;
    ...
    private int FFNo = 0;
    private int ModuleId = 859;
    private String DOC_NO = "";
    private SDMLATTPAY.TravelAdvance.clsTravelEntryAmend TravellingEntry;
...
//        lbltot.setVisible(false);
        ...
        TravellingEntry = new SDMLATTPAY.TravelAdvance.clsTravelEntryAmend();
...
//        CalcExpen();
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle1.setText("Revised Travelling Sanction  - " + DOC_NO);
            ...
            txtreason.setText(TravellingEntry.getAttribute("TSD_REASON").getString());
            ...
            for (int i = 1; i <= TravellingEntry.colMRItems.size(); i++) {
                ...
                if (ObjItem.getAttribute("TSD_INFO").getString().equalsIgnoreCase("PARTY")) {
                ...
                } else if (ObjItem.getAttribute("TSD_INFO").getString().equalsIgnoreCase("EXPENSE")) {
                    rowData[0] = (String) ObjItem.getAttribute("TSD_SR_NO").getObj();
                    rowData[1] = EITLERPGLOBAL.formatDate((String) ObjItem.getAttribute("TSD_START_DATE").getObj());
                    if (rowData[1].toString().equalsIgnoreCase("")) {
                        rowData[1] = (String) ObjItem.getAttribute("TSD_START_DATE").getObj();
                    ...
                    if (ObjItem.getAttribute("TSD_INFO").getString().equalsIgnoreCase("PREVIOUS")) {
                        DataModelPT.addRow(rowData);
                    }
                }
            }
            if (Table.getRowCount() <= 0) {
                cantour.setSelected(true);
            } else {
                cantour.setSelected(false);
            }

            final TableColumnModel columnModelPT = TablePT.getColumnModel();
            for (int column = 0; column < TablePT.getColumnCount(); column++) {
                int width = 60; // Min width
                for (int row = 0; row < TablePT.getRowCount(); row++) {
                    TableCellRenderer renderer = TablePT.getCellRenderer(row, column);
                    Component comp = TablePT.prepareRenderer(renderer, row, column);
                    width = Math.max(comp.getPreferredSize().width + 1, width);
                }
                if (width > 300) {
                    width = 300;
                }
                columnModelPT.getColumn(column).setPreferredWidth(width);
            }
        ...
        try {
            ...
            HashMap History = clsTravelEntryAmend.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsTravelEntryAmend ObjHistory = (clsTravelEntryAmend) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10093, 100931)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10093, 100932)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10093, 100933)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10093, 100934)) {
    ...
    private void initComponents() {
        ...
        cantour = new javax.swing.JCheckBox();
        ...
        cmdShowRemarks3 = new javax.swing.JButton();
        ...
        lblStatus1.setBounds(0, 590, 920, 30);
        ...
        cmdNextToTab2.setBounds(780, 540, 120, 30);

        jLabel5.setText("Doc Date");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(230, 14, 60, 20);

        docdate.setText("DD/MM/YYYY");
        jPanel1.add(docdate);
        docdate.setBounds(300, 4, 100, 40);
        ...
        jScrollPane1.setBounds(0, 300, 1050, 100);

        docdate1.setText("DD/MM/YYYY");
        jPanel1.add(docdate1);
        docdate1.setBounds(300, 4, 100, 40);
        ...
        jPanel1.add(cmdAdd);
        cmdAdd.setBounds(840, 270, 90, 23);
        ...
        cmdRemove.setBounds(950, 270, 90, 23);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 270, 700, 20);

        dept.setText("Dept");
        jPanel1.add(dept);
        dept.setBounds(530, 40, 130, 20);
        ...
        txtEmpName.setBounds(210, 40, 230, 20);

        jLabel3.setText("Emp Code");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 40, 70, 20);

        jLabel4.setText("Reason for Revise");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 70, 110, 20);

        jLabel6.setText("Designation");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(680, 40, 70, 20);

        designation.setText("Designation");
        jPanel1.add(designation);
        designation.setBounds(760, 40, 140, 20);

        jLabel8.setText("Level");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(920, 40, 70, 20);

        level.setText("L3");
        jPanel1.add(level);
        level.setBounds(1000, 40, 60, 20);

        jLabel10.setText("Dept");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(450, 40, 70, 20);
        ...
        jScrollPane3.setBounds(130, 110, 740, 40);

        jLabel12.setText("Remark from  Internal Audit");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(10, 150, 180, 30);
        ...
        jScrollPane4.setBounds(170, 150, 700, 40);

        travel.add(gujod);
        gujod.setText("Within Gujarat [One Day Trip]");
        gujod.setEnabled(false);
        jPanel1.add(gujod);
        gujod.setBounds(520, 10, 230, 30);
        ...
        TablePT.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TablePTKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TablePTKeyReleased(evt);
            }
        });
        jScrollPane5.setViewportView(TablePT);

        jPanel1.add(jScrollPane5);
        jScrollPane5.setBounds(10, 190, 1050, 80);

        cantour.setText("Cancelled");
        cantour.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cantourActionPerformed(evt);
            }
        });
        jPanel1.add(cantour);
        cantour.setBounds(750, 270, 71, 23);

        jLabel7.setText("Purpose of Visit");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(10, 120, 110, 20);
        ...
        jScrollPane7.setBounds(130, 70, 740, 40);
        ...
        cmdAddParty.setBounds(0, 400, 90, 23);
        ...
        cmdRemoveParty.setBounds(110, 400, 90, 23);
        ...
        jScrollPane8.setViewportView(TableParty);

        jPanel1.add(jScrollPane8);
        jScrollPane8.setBounds(0, 430, 520, 110);
        ...
        cmdShowRemarks2.setBounds(880, 150, 110, 30);
        ...
        cmdShowRemarks1.setBounds(880, 110, 110, 30);

        cmdShowRemarks3.setText("Show");
        cmdShowRemarks3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdShowRemarks3ActionPerformed(evt);
            }
        });
        jPanel1.add(cmdShowRemarks3);
        cmdShowRemarks3.setBounds(880, 70, 110, 30);
        jPanel1.add(fare);
        fare.setBounds(150, 540, 120, 20);

        jLabel13.setText("For Fare Rs.");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(10, 540, 100, 20);

        jLabel16.setText("For Expen. Rs.");
        jPanel1.add(jLabel16);
        jLabel16.setBounds(10, 570, 110, 20);
        jPanel1.add(expen);
        expen.setBounds(150, 570, 120, 20);

        jLabel15.setText("Total");
        jPanel1.add(jLabel15);
        jLabel15.setBounds(10, 600, 110, 30);

        lbltot.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lbltot.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(lbltot);
        lbltot.setBounds(150, 600, 120, 30);
        ...
        jScrollPane9.setBounds(550, 430, 500, 110);
        ...
        cmdAddExpense.setBounds(850, 400, 90, 23);
        ...
        cmdRemoveExpense.setBounds(960, 400, 90, 23);

        jLabel2.setText("Expense Detail");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(550, 400, 100, 20);

        jLabel9.setText("Party Detail");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(414, 404, 100, 20);
        jPanel1.add(expense);
        expense.setBounds(270, 570, 120, 20);

        Tab.addTab("Revised Travelling Sanction", jPanel1);
        ...
        lblTitle1.setText("Revised Travelling Sanction");
...
//                System.out.println(Table.getSelectedRow()+" x:"+r.getX()+ " Y:"+r.getY());
                 ...
                 */
                //Added on 13/05/2022
                if (data.IsRecordExist("SELECT * FROM SDMLATTPAY.TRAVEL_SANCTION_AMEND_EXCEPTION WHERE EXCP_DOC_NO='" + lbldoc.getText().trim().substring(0, 12) + "' AND EXCP_TILL_VALID>=CURDATE() ")) {
                    String sDt = data.getStringValueFromDB("SELECT EXCP_FROM_DATE FROM SDMLATTPAY.TRAVEL_SANCTION_AMEND_EXCEPTION WHERE EXCP_DOC_NO='" + lbldoc.getText().trim().substring(0, 12) + "' AND EXCP_TILL_VALID>=CURDATE() ");
                    String eDt = data.getStringValueFromDB("SELECT EXCP_TO_DATE FROM SDMLATTPAY.TRAVEL_SANCTION_AMEND_EXCEPTION WHERE EXCP_DOC_NO='" + lbldoc.getText().trim().substring(0, 12) + "' AND EXCP_TILL_VALID>=CURDATE() ");
                    if (EITLERPGLOBAL.getMonth(eDt) == EITLERPGLOBAL.getCurrentMonth()) {
                        eDt = (EITLERPGLOBAL.getCurrentFinYear() + 2) + "-03-31";
                    } else {
                        eDt = eDt;
                    }
                    new DatePickerTable(null, Table.getSelectedRow(), 2, Table, p.x, p.y, sDt, eDt);
                    try {
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                        Date date1 = sdf.parse(sDt);
                        Date date3 = sdf.parse(eDt);
                        Date date2 = sdf.parse(EITLERPGLOBAL.formatDateDB(Table.getValueAt(Table.getSelectedRow(), 2).toString()));
                        if (date2.compareTo(date1) >= 0 && date3.compareTo(date2) >= 0) {
                        } else {
                            Table.setValueAt("", Table.getSelectedRow(), 2);
...
//                System.out.println(Table.getSelectedRow()+" x:"+r.getX()+ " Y:"+r.getY());
                ...
                */
                ...
                if (data.IsRecordExist("SELECT * FROM SDMLATTPAY.TRAVEL_SANCTION_AMEND_EXCEPTION WHERE EXCP_DOC_NO='" + lbldoc.getText().trim().substring(0, 12) + "' AND EXCP_TILL_VALID>=CURDATE() ")) {
                    ...
                    new DatePickerTable(null, Table.getSelectedRow(), 8, Table, p.x, p.y, sDt, eDt);
                    try {
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                        Date date1 = sdf.parse(sDt);
                        Date date3 = sdf.parse(eDt);
    ...
    private void TablePTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TablePTKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TablePTKeyPressed

    private void TablePTKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TablePTKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_TablePTKeyReleased

    private void cantourActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cantourActionPerformed
        // TODO add your handling code here:
        if (cantour.isSelected()) {
            if (Table.getRowCount() > 0) {
                int mrowdele = Table.getRowCount();
                for (int i = 0; i < mrowdele; i++) {
                    DataModel.removeRow(0);
                }
            }
            if (TableParty.getRowCount() > 0) {
                int mrowdele = TableParty.getRowCount();
                for (int i = 0; i < mrowdele; i++) {
                    DataModelParty.removeRow(0);
                }
            }
            CalcExpen();
        }
    }//GEN-LAST:event_cantourActionPerformed
...
//                        (EITLERPGLOBAL.getCurrentFinYear() + 2) + "-03-31");
                ...
                if (data.IsRecordExist("SELECT * FROM SDMLATTPAY.TRAVEL_SANCTION_AMEND_EXCEPTION WHERE EXCP_DOC_NO='" + lbldoc.getText().trim().substring(0, 12) + "' AND EXCP_TILL_VALID>=CURDATE() ")) {
                    ...
                    new DatePickerTable(null, TableParty.getSelectedRow(), 1, TableParty, p.x, p.y, sDt, eDt);
                } else {
                    new DatePickerTable(null, TableParty.getSelectedRow(), 1, TableParty, p.x, p.y,
                        data.getStringValueFromDB("SELECT DATE_ADD(STAFF_APL_DATE,INTERVAL 1 DAY) FROM SDMLATTPAY.ATT_PROCESS_LOCK_DATE"),
                        (EITLERPGLOBAL.getCurrentFinYear() + 2) + "-03-31");
    ...
    private void cmdShowRemarks3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarks3ActionPerformed
        // TODO add your handling code here:
        JTextField BigEdittxtRemark = new JTextField();
        BigEdittxtRemark.setText(txtreason.getText());
        BigEdit bigEdit = new BigEdit();
        bigEdit.theText = BigEdittxtRemark;
        bigEdit.ShowEdit();
    }//GEN-LAST:event_cmdShowRemarks3ActionPerformed
...
//                        (EITLERPGLOBAL.getCurrentFinYear() + 2) + "-03-31");
                ...
                if (data.IsRecordExist("SELECT * FROM SDMLATTPAY.TRAVEL_SANCTION_AMEND_EXCEPTION WHERE EXCP_DOC_NO='" + lbldoc.getText().trim().substring(0, 12) + "' AND EXCP_TILL_VALID>=CURDATE() ")) {
                    ...
                    new DatePickerTable(null, TableExpense.getSelectedRow(), 1, TableExpense, p.x, p.y, sDt, eDt);
                } else {
                    new DatePickerTable(null, TableExpense.getSelectedRow(), 1, TableExpense, p.x, p.y,
                        data.getStringValueFromDB("SELECT DATE_ADD(STAFF_APL_DATE,INTERVAL 1 DAY) FROM SDMLATTPAY.ATT_PROCESS_LOCK_DATE"),
                        (EITLERPGLOBAL.getCurrentFinYear() + 2) + "-03-31");
    ...
    private void Find() {
        ...
        if (ObjTimeCorrectionFind.Cancelled == false) {
            if (!TravellingEntry.Filter(ObjTimeCorrectionFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(FrmTravelEntryAmend.this, " No records found.", "Find Travelling Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        TravellingEntry.Filter(" TSD_DOC_NO IN (SELECT DISTINCT SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND.TSD_DOC_NO FROM SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND, SDMLATTPAY.D_COM_DOC_DATA WHERE SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND.TSD_DOC_NO=SDMLATTPAY.D_COM_DOC_DATA.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
    ...
    private void Add() {
        ...
        aList.SQL = "SELECT DISTINCT TSD_DOC_NO,RIGHT(TSD_DOC_NO,10) AS DOC_NO,DATE_FORMAT(TSD_DOC_DATE,'%d/%m/%Y') AS DOC_DATE,TSD_PAY_EMP_NO AS EMP_NO,"
                ...
                + "AND LEFT(TSD_DOC_NO,12) NOT IN (SELECT LEFT(TSD_DOC_NO,12) FROM SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND WHERE COALESCE(CANCELED,0)=0) "
        ...
        if (aList.ShowLOV()) {
            ...
            if (IsAmendmentUnderProcess(mDocNo)) {
                JOptionPane.showMessageDialog(null, "One amendment of this Travelling Entry is already under process. Cannot make another amendment");
                EditMode = 0;
                return;
            }
    ...
    private void FormatGrid() {
        ...
        DataModelPT = new EITLTableModel();
        TablePT.removeAll();

        TablePT.setModel(DataModelPT);
        TablePT.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        //Add Columns to it
        DataModelPT.addColumn("Sr.No.");   //0
        DataModelPT.addColumn("Starting Place");   //1        
        DataModelPT.addColumn("Start Date");   //2
        DataModelPT.addColumn("Start Time");   //3
        DataModelPT.addColumn("Mode of Travel");   //4
        DataModelPT.addColumn("Fare Rs.");   //5        
        DataModelPT.addColumn("Place to Visit");   //6        
        DataModelPT.addColumn("Mill/Party Visit");   //7
        DataModelPT.addColumn("Arrival Date");   //8
        DataModelPT.addColumn("Arrival Time");   //9
        DataModelPT.addColumn("Seminar");   //10
        DataModelPT.addColumn("Days");   //11
        DataModelPT.addColumn("Rate");   //12
        DataModelPT.addColumn("Amount");   //13
        DataModelPT.addColumn("Remark");   //14

        for (int a = 0; a < 14; a++) {
            DataModelPT.SetReadOnly(a);
        }
    ...
    private void Save() {
        ...
        if (Table.getRowCount() <= 0 && !cantour.isSelected()) {
...
//      
        ...
        TravellingEntry.setAttribute("TSD_REASON", txtreason.getText());
        ...
        for (int i = 0; i < TablePT.getRowCount(); i++) {
            SDMLATTPAY.TravelAdvance.clsTravelEntryItem ObjItem = new SDMLATTPAY.TravelAdvance.clsTravelEntryItem();
            ObjItem.setAttribute("TSD_SR_NO", TablePT.getValueAt(i, 0).toString());
            ObjItem.setAttribute("TSD_START_PLACE", TablePT.getValueAt(i, 1).toString());
            ObjItem.setAttribute("TSD_START_DATE", TablePT.getValueAt(i, 2).toString());
            ObjItem.setAttribute("TSD_START_TIME", TablePT.getValueAt(i, 3).toString());
            ObjItem.setAttribute("TSD_TRAVEL_MODE", TablePT.getValueAt(i, 4).toString());
            ObjItem.setAttribute("TSD_FARE", TablePT.getValueAt(i, 5).toString());
            ObjItem.setAttribute("TSD_VISIT_PLACE", TablePT.getValueAt(i, 6).toString());
            ObjItem.setAttribute("TSD_IS_VISIT_PLACE", TablePT.getValueAt(i, 7).toString());
            ObjItem.setAttribute("TSD_ARRIVAL_DATE", TablePT.getValueAt(i, 8).toString());
            ObjItem.setAttribute("TSD_ARRIVAL_TIME", TablePT.getValueAt(i, 9).toString());
            ObjItem.setAttribute("TSD_SEMINAR", TablePT.getValueAt(i, 10).toString());
            ObjItem.setAttribute("TSD_DAYS", TablePT.getValueAt(i, 11).toString());
            ObjItem.setAttribute("TSD_RATE", TablePT.getValueAt(i, 12).toString());
            ObjItem.setAttribute("TSD_AMOUNT", TablePT.getValueAt(i, 13).toString());
            ObjItem.setAttribute("TSD_INFO", "PREVIOUS");
            ObjItem.setAttribute("TSD_REMARK", TablePT.getValueAt(i, 14).toString());
    ...
    private javax.swing.JCheckBox cantour;
    ...
    private javax.swing.JButton cmdShowRemarks3;
...
//                                alwnc = rt;
    ...
    private void PreviewReport() {
        try {
            ...
            String strSQL = "SELECT DISTINCT D.*,"
                    + "CASE WHEN D.TSD_INFO='PREVIOUS' THEN 'Sanctioned Schedule of Tour:' "
                    + "WHEN D.TSD_INFO='CURRENT' THEN 'Sanction of revised Schedule of Tour required.' END AS TSDINFO,"
                    + "CONCAT(S.TSD_DOC_NO,' ',DATE_FORMAT(S.TSD_DOC_DATE,'%d/%m/%Y')) AS OLDDOC "
                    + "FROM SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND D "
                    + "LEFT JOIN SDMLATTPAY.TRAVEL_SANCTION_DETAIL S "
                    + "ON LEFT(D.TSD_DOC_NO,12)=LEFT(S.TSD_DOC_NO,12) "
                    + "WHERE D.TSD_INFO IN ('CURRENT','PREVIOUS') AND D.TSD_DOC_NO='" + lbldoc.getText() + "'   AND COALESCE(D.APPROVED,0)=1 "
                    + "ORDER BY TSD_INFO DESC,TSD_SR_NO";
            System.out.println("sql" + strSQL);
            rpt.setReportName("/SDMLATTPAY/TravelAdvance/TravellingAmend.jrxml", 1, strSQL); //productlist is the name of my jasper file.
            rpt.callReport();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private boolean IsAmendmentUnderProcess(String DocNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM  SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND WHERE TSD_DOC_NO LIKE '" + DocNo + "%' AND COALESCE(APPROVED,0)=0 AND COALESCE(CANCELED,0)=0");
            rsTmp.first();
    ...
    private void DisplayDataTD(String pDocNo) {
        ...
        try {
            ...
            int MaxNo = data.getIntValueFromDB("SELECT COALESCE(MAX(SUBSTR(TSD_DOC_NO,locate('/',TSD_DOC_NO)+1)*1),0) FROM SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND WHERE SUBSTR(TSD_DOC_NO,1,locate('/',TSD_DOC_NO)-1)='" + rsPT.getString("TSD_DOC_NO") + "'") + 1;
            lbldoc.setText(pDocNo + "/" + MaxNo);
            ...
            expen.setText(rsPT.getString("TSD_TOTAL_EXPENSE"));
            lbltot.setText(rsPT.getString("TSD_TOTAL"));
            ...
            while (!rsPT.isAfterLast()) {
                ...
                if (rsPT.getString("TSD_INFO").equalsIgnoreCase("CURRENT")) {
                    ...
                    rowData[5] = rsPT.getString("TSD_FARE");
                    rowData[6] = rsPT.getString("TSD_VISIT_PLACE");
                    rowData[7] = rsPT.getString("TSD_IS_VISIT_PLACE");
                    rowData[8] = EITLERPGLOBAL.formatDate(rsPT.getString("TSD_ARRIVAL_DATE"));
                    rowData[9] = rsPT.getString("TSD_ARRIVAL_TIME");
                    rowData[10] = rsPT.getString("TSD_SEMINAR");
                    rowData[11] = rsPT.getString("TSD_DAYS");
                    rowData[12] = rsPT.getString("TSD_RATE");
                    rowData[13] = rsPT.getString("TSD_AMOUNT");
                    DataModelPT.addRow(rowData);
                }
            ...
            final TableColumnModel columnModel = TablePT.getColumnModel();
            for (int column = 0; column < TablePT.getColumnCount(); column++) {
                int width = 60; // Min width
                for (int row = 0; row < TablePT.getRowCount(); row++) {
                    TableCellRenderer renderer = TablePT.getCellRenderer(row, column);
    ...
    private void Mail() {
        ...
        pSubject = "Notification : Revised Travelling Sanction [Pink Form] Final approved  :" + lbldoc.getText() + " ";
        ...
        try {
            ...
            rsdata.first();
            if (rsdata.getRow() > 0) {
                pBody = pBody + "\n Mr. " + rsdata.getString("TSD_NAME") + ", your revised travelling sanction [Pink Form] has been final approved "
                ...
                sql1 = "SELECT TSD_NAME,TSD_DOC_NO AS DOC,MAX(TSD_ADVANCE) AS ADVANCE, "
                        + "GROUP_CONCAT(DISTINCT CASE WHEN TSD_IS_VISIT_PLACE='YES' THEN TSD_VISIT_PLACE END) AS VISITPLACE,"
                        + "DATE_FORMAT(MIN(CONCAT(TSD_START_DATE,' ',TSD_START_TIME)),'%d/%m/%Y %r') AS DEPDATE,"
                        + "DATE_FORMAT(MAX(CONCAT(TSD_ARRIVAL_DATE,' ',TSD_ARRIVAL_TIME)),'%d/%m/%Y %r') AS ARRIVAL "
                        + "FROM SDMLATTPAY.TRAVEL_SANCTION_DETAIL_AMEND "
                        + "WHERE TSD_DOC_NO='" + lbldoc.getText() + "' AND TSD_INFO='PREVIOUS'";

                rsdata = data.getResult(sql1);
                rsdata.first();
                if (rsdata.getRow() > 0) {
                    pBody = pBody + "\n Mr. " + rsdata.getString("TSD_NAME") + ", your revised travelling sanction [Pink Form] has been final approved "
                            + "From " + rsdata.getString("DEPDATE") + " To " + rsdata.getString("ARRIVAL") + " With Visited Places :" + rsdata.getString("VISITPLACE")
                            + " has been cancelled \n And Outstation Duty [OD] has been revised.";
                }
            }
