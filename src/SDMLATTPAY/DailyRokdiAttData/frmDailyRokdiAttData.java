...
public class frmDailyRokdiAttData extends javax.swing.JApplet {
    ...
    private clsDailyRokdiAttData ObjDailyAttData;
    ...
    public void init() {
        ...
        ObjDailyAttData = new clsDailyRokdiAttData();
        lblTitle.setForeground(Color.WHITE);
...
//        GenerateDeptCombo();
        ...
        if (ObjDailyAttData.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Error occured while Loading Data. Error is " + ObjDailyAttData.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Daily Rokdi Attandance Form (Regular) - ");
        ...
        jScrollPane4.setBounds(10, 90, 970, 290);
        ...
        Tab1.add(lblDeptCmb);
        lblDeptCmb.setBounds(530, 40, 70, 20);
        ...
        Tab1.add(cmbShift);
        cmbShift.setBounds(600, 40, 110, 20);
        ...
        Tab1.add(cmdRemove);
        cmdRemove.setBounds(350, 390, 80, 20);
...
//        EITLERPGLOBAL.PAGE_BREAK = true;
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select a row from Document Update History");
        }
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (SDMLATTPAY.ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID, 868, txtDocNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmDailyRokdiAttData.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
...
//         TODO add your handling code here:
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        if (evt.getClickCount() == 2 && Table.getSelectedColumn() == 1) {
            ...
            String pMonth = txtAttDate.getText().substring(3, 5);
            String pYear = txtAttDate.getText().substring(6, 10);
...
//            ComboData 
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 868)) {
        ...
        try {
            ...
            String attDate = EITLERPGLOBAL.formatDate(ObjDailyAttData.getAttribute("ROKDI_ATT_DATE").getString());
            String attDept = ObjDailyAttData.getAttribute("ROKDI_ATT_DEPT").getString();
            String attShift = ObjDailyAttData.getAttribute("ROKDI_ATT_SHIFT").getString();

            lblTitle.setText("Daily Rokdi Attandance Form (Regular) - " + docNo);
...
//            EITLERPGLOBAL.setComboIndex(cmbDept, Integer.parseInt(attDept));
            ...
            for (int i = 1; i <= ObjDailyAttData.hmDailyAttDataDetails.size(); i++) {
                clsDailyRokdiAttDataDetails ObjDailyAttDataDetails = (clsDailyRokdiAttDataDetails) ObjDailyAttData.hmDailyAttDataDetails.get(Integer.toString(i));
                ...
                rowData[3] = ObjDailyAttDataDetails.getAttribute("ROKDI_PUNCH_TIME").getString();
                rowData[4] = ObjDailyAttDataDetails.getAttribute("EMP_REMARK").getString();

                if (ObjDailyAttDataDetails.getAttribute("ROKDI_CONSIDER").getString().equalsIgnoreCase("1")) {
                    rowData[5] = true;
                } else {
                    rowData[5] = false;
                }
...
//                }
                ...
                if (ObjDailyAttDataDetails.getAttribute("DEPT_ROKDI_HOURS").getString().equals("00:00:00")) {
                    rowData[6] = "";
                } else {
                    rowData[6] = ObjDailyAttDataDetails.getAttribute("DEPT_ROKDI_HOURS").getString().substring(0, 5);
                }
                rowData[7] = ObjDailyAttDataDetails.getAttribute("EMP_DEPT").getString();
                rowData[8] = ObjDailyAttDataDetails.getAttribute("EMP_MAIN_CATEGORY").getString();
                rowData[9] = ObjDailyAttDataDetails.getAttribute("EMP_SUB_CATEGORY").getString();
            ...
            hmList = SDMLATTPAY.ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 868, docNo);
            ...
            FormatGridUpdateHistory();
            HashMap hmApprovalHistory = clsDailyRokdiAttData.getHistoryList(txtDocNo.getText());
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsDailyRokdiAttData ObjDailyAttData = (clsDailyRokdiAttData) hmApprovalHistory.get(Integer.toString(i));
...
//            EITLTableCellRenderer RendererExcess = new EITLTableCellRenderer();
            ...
            DataModel.addColumn("Consideration");
...
//            Table.getColumnModel().getColumn(7).setCellEditor(new DefaultCellEditor(new JCheckBox()));
            ...
            DataModel.SetVariable(3, "ROKDI_PUNCH_TIME");
            DataModel.SetVariable(4, "EMP_REMARK");
            DataModel.SetVariable(5, "ROKDI_CONSIDER");
//            DataModel.SetVariable(6, "EMP_ABSENT");
//            DataModel.SetVariable(7, "EMP_EXCESS");
            DataModel.SetVariable(6, "DEPT_ROKDI_HOURS");
            DataModel.SetVariable(7, "EMP_DEPT");
            DataModel.SetVariable(8, "EMP_MAIN_CATEGORY");
            DataModel.SetVariable(9, "EMP_SUB_CATEGORY");
...
////            Table.getColumnModel().getColumn(9).setMaxWidth(100);
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=868 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=868 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = SDMLATTPAY.ApprovalFlow.getRemainingUsers(EITLERPGLOBAL.gCompanyID, 868, ObjDailyAttData.getAttribute("DOC_NO").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = SDMLATTPAY.ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 868, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = SDMLATTPAY.ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 868, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = SDMLATTPAY.ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 868, txtDocNo.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = SDMLATTPAY.ApprovalFlow.getFromID(EITLERPGLOBAL.gCompanyID, 868, ObjDailyAttData.getAttribute("DOC_NO").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = SDMLATTPAY.ApprovalFlow.getFromRemarks(EITLERPGLOBAL.gCompanyID, 868, FromUserID, ObjDailyAttData.getAttribute("DOC_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (SDMLATTPAY.ApprovalFlow.IsCreator(868, txtDocNo.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10095, 100951)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10095, 100952)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10095, 100953)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10095, 100955)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        txtDocNo.setText(clsDailyRokdiAttData.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 868, FFNo, false));
        txtDocDate.setText(EITLERPGLOBAL.getCurrentDate());

        lblTitle.setText("Daily Rokdi Attandance Form (Regular) - " + txtDocNo.getText());
        lblTitle.setBackground(Color.GRAY);
    ...
    private void Edit() {
        ...
        if (ObjDailyAttData.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (SDMLATTPAY.ApprovalFlow.IsCreator(868, productionDocumentNo)) {
                SetFields(true);
            } else {
                EnableApproval();
...
//            Table.setEnabled(false);
            ...
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjDailyAttData.CanDelete(txtDocNo.getText(), txtDocDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, ObjDailyAttData.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//        attDept = Integer.toString(cmbDept.getSelectedIndex());
        ...
        if (txtAttDate.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select the Rokdi Att Date.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (cmbDept.getSelectedItem().equals("Select Dept")) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select the Department.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (cmbShift.getSelectedItem().equals("Select Shift")) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select the Shift.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        //Check the no. of items in table
        if (Table.getRowCount() <= 0) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Enter Attendance Details Before Saving.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
...
//            }
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                ObjDailyAttDataDetails.setAttribute("ROKDI_PUNCH_TIME", DataModel.getValueByVariable("ROKDI_PUNCH_TIME", i));
...
//                if (DataModel.getValueByVariable("EMP_PRESENT", i).toLowerCase().equals("true")) {
                if (DataModel.getBoolValueByVariable("ROKDI_CONSIDER", i)) {
                    ObjDailyAttDataDetails.setAttribute("ROKDI_CONSIDER", "1");
                } else {
                    ObjDailyAttDataDetails.setAttribute("ROKDI_CONSIDER", "0");
                }
...
//                }
                ...
                ObjDailyAttDataDetails.setAttribute("DEPT_ROKDI_HOURS", DataModel.getValueByVariable("DEPT_ROKDI_HOURS", i));
            ...
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Enter Correct Details at Row " + (i + 1) + " and Column " + (j + 1) + ". Error is " + nfe.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
            j = 0;
            nfe.printStackTrace();
            return;
        }
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        ObjDailyAttData.setAttribute("ROKDI_ATT_DATE", attDate);
        ObjDailyAttData.setAttribute("ROKDI_ATT_DEPT", attDept);
        ObjDailyAttData.setAttribute("ROKDI_ATT_SHIFT", attShift);
        SetData();
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjDailyAttData.Insert()) {
                ...
                JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Error occured while saving. Error is " + ObjDailyAttData.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjDailyAttData.Update()) {
                ...
                JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, "Error occured while saving editing. Error is " + ObjDailyAttData.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "SDMLATTPAY.DailyRokdiAttData.frmFindDailyRokdiAttData", true);
        frmFindDailyRokdiAttData ObjFindDailyAttData = (frmFindDailyRokdiAttData) ObjLoader.getObj();

        if (ObjFindDailyAttData.Cancelled == false) {
            if (!ObjDailyAttData.Filter(ObjFindDailyAttData.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmDailyRokdiAttData.this, " No records found.", "Find Daily Rokdi Attendance Data Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        ObjDailyAttData.Filter(" AND DOC_NO IN (SELECT DISTINCT MA.DOC_NO FROM SDMLATTPAY.DAILY_ROKDI_ATT_DATA MA, SDMLATTPAY.D_COM_DOC_DATA D WHERE MA.DOC_NO=D.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=868 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
...
//        Table.setEnabled(false);
    ...
    private void GenerateEmpList() {
        if (data.IsRecordExist("SELECT * FROM SDMLATTPAY.DAILY_ROKDI_ATT_DATA WHERE ROKDI_ATT_DATE = '" + EITLERPGLOBAL.formatDateDB(txtAttDate.getText().trim()) + "' AND ROKDI_ATT_DEPT = '" + cmbDept.getSelectedItem().toString() + "' AND ROKDI_ATT_SHIFT = '" + cmbShift.getSelectedItem().toString() + "' AND APPROVED=0 AND DOC_NO != '" + txtDocNo.getText().trim() + "' ")) {
...
//                    + " ORDER BY EMPID ";
            String mch_no_cndtn = "";
            if (!cmbDept.getSelectedItem().equals("")) {
                mch_no_cndtn = " AND (COALESCE(OTREMARK,'') LIKE ('') OR COALESCE(OTREMARK,'') LIKE ('11%')) ";
            }

            if (data.IsRecordExist("SELECT * FROM SDMLATTPAY.DAILY_ROKDI_ATT_DATA WHERE ATT_DATE = '" + EITLERPGLOBAL.formatDateDB(txtAttDate.getText().trim()) + "' AND ATT_DEPT = '" + cmbDept.getSelectedItem().toString() + "' AND ATT_SHIFT = '" + cmbShift.getSelectedItem().toString() + "' AND APPROVED=1 AND DOC_NO != '" + txtDocNo.getText().trim() + "' ")) {
                strSQL = "SELECT * FROM ( ";

                strSQL += "SELECT EMPID,MM,YYYY,PUNCHDATE,PUNCHES_NOS, "
                        //                        + "ALL_OT_PUNCHES, "
                        + "CASE WHEN ALL_OT_PUNCHES!='' THEN ALL_OT_PUNCHES ELSE COALESCE(TIME1,'') END AS ALL_OT_PUNCHES, "
                        + "SHIFT,ALL_PUNCHES,DD,WORKING_DEPTID,"
                        + "WORKING_DEPT_DESC,USERID1,DATE1,TIME1,CATEGORY,MAIN_CATEGORY,OTREMARK FROM  ";
//                        + "( ";
//
...
////                    strSQL += "AND (ALL_OT_PUNCHES LIKE ('%06:%') OR ALL_OT_PUNCHES LIKE ('%07:%') OR ALL_OT_PUNCHES LIKE ('%08:%')) ";
////                }
////                if (cmbShift.getSelectedItem().toString().equals("2")) {
////                    strSQL += "AND (ALL_OT_PUNCHES LIKE ('%14:%') OR ALL_OT_PUNCHES LIKE ('%15:%') OR ALL_OT_PUNCHES LIKE ('%16:%')) ";
////                }
////                if (cmbShift.getSelectedItem().toString().equals("3")) {
////                    strSQL += "AND (ALL_OT_PUNCHES LIKE ('%22:%') OR ALL_OT_PUNCHES LIKE ('%23:%') OR ALL_OT_PUNCHES LIKE ('%00:%') OR ALL_OT_PUNCHES LIKE ('%01:%')) ";
////                }
////                if (cmbShift.getSelectedItem().toString().equals("4")) {
////                    strSQL += "AND (ALL_OT_PUNCHES LIKE ('%07:%') OR ALL_OT_PUNCHES LIKE ('%08:%') OR ALL_OT_PUNCHES LIKE ('%09:%') OR ALL_OT_PUNCHES LIKE ('%10:%')) ";
////                }
////                if (cmbShift.getSelectedItem().toString().equals("5")) {
////                    strSQL += "AND (ALL_OT_PUNCHES LIKE ('%08:%') OR ALL_OT_PUNCHES LIKE ('%09:%') OR ALL_OT_PUNCHES LIKE ('%10:%') OR ALL_OT_PUNCHES LIKE ('%11:%') OR ALL_OT_PUNCHES LIKE ('%12:%')) ";
////                }
...
////                    strSQL += "AND (ALL_OT_PUNCHES LIKE ('%18:%') OR ALL_OT_PUNCHES LIKE ('%19:%') OR ALL_OT_PUNCHES LIKE ('%20:%')) ";
////                }
//                
//                strSQL += "AND PUNCHDATE= '" + EITLERPGLOBAL.formatDateDB(txtAttDate.getText().trim()) + "' "
//                        + "AND TRIM(ALL_OT_PUNCHES) != '' ";
...
//                strSQL += " )  AS A "
//                        + "LEFT JOIN "
                strSQL += "(SELECT USERID1,DATE1,group_concat(TIME1) AS TIME1 FROM "
                ...
                strSQL += " ) AS DAS "
                        ...
                        + "AND EMPID NOT IN (SELECT EMP_ID FROM SDMLATTPAY.DAILY_ROKDI_ATT_DATA WHERE ATT_DATE = '" + EITLERPGLOBAL.formatDateDB(txtAttDate.getText().trim()) + "' AND ATT_DEPT = '" + cmbDept.getSelectedItem().toString() + "' AND ATT_SHIFT = '" + cmbShift.getSelectedItem().toString() + "' AND APPROVED=1 AND ROKDI_CONSIDER=1 ) ";
//                        + "AND ALL_OT_PUNCHES!='' "
...
//                }
            ...
            if (rsTmp.getRow() > 0) {
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    rowData[3] = rsTmp.getString("ALL_OT_PUNCHES");
                    rowData[4] = "";
//                    if (!rsTmp.getString("ALL_OT_PUNCHES").trim().equals("")) {
//                        rowData[5] = true;
//                        rowData[6] = false;
//                    } else {
//                        rowData[5] = false;
...
//                    rowData[7] = false;
                    rowData[5] = false;
                    rowData[6] = "";
                    rowData[7] = rsTmp.getString("DPTNAME");
