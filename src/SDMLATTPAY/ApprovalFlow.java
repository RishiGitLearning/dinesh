...
public class ApprovalFlow {
    ...
    public static void AppendUsers(HashMap pUsers) {
        ...
        try {
            ...
            rsDocData=stDocData.executeQuery("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE DOC_NO='1'");
            rsDocData.first();
            ...
            for(int i=1;i<=pUsers.size();i++) {
                ...
                strSQL="SELECT MAX(SR_NO) AS SRNO FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+CompanyID+" AND MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"'";
                ...
                rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+CompanyID+" AND MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+UserID);
                rsTmp.first();
    ...
    public static int getFromID(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            ...
            strSQL="SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' AND STATUS='W'";
    ...
    public static int getNextUser(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            ...
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' ORDER BY SR_NO";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            ...
            if(SrNo!=0) //We got Sr. No. of current user id. Get Next no.
            {
                //Get Next No.
                stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                strSQL="SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' AND SR_NO="+Integer.toString(SrNo+1);
                rsTmp=stTmp.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static int getCreator(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            ...
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' AND TYPE='C'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
    ...
    public static HashMap getDocumentList(int pCompanyID,int pModuleID,int pDeptID) {
        ...
        try {
            ...
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT DISTINCT(DOC_NO),DOC_DATE FROM SDMLATTPAY.D_COM_DOC_DATA,D_COM_USER_MASTER WHERE SDMLATTPAY.D_COM_DOC_DATA.USER_ID=D_COM_USER_MASTER.USER_ID AND SDMLATTPAY.D_COM_DOC_DATA.COMPANY_ID=D_COM_USER_MASTER.COMPANY_ID AND STATUS<>'F' AND SDMLATTPAY.D_COM_DOC_DATA.COMPANY_ID="+pCompanyID+" AND D_COM_USER_MASTER.DEPT_ID="+pDeptID+" AND SDMLATTPAY.D_COM_DOC_DATA.MODULE_ID="+pModuleID+" AND SDMLATTPAY.D_COM_DOC_DATA.TYPE='C' ";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
    ...
    public static HashMap getRemainingUsers(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT SR_NO FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' AND STATUS='W'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                SrNo=rsTmp.getInt("SR_NO");
                ...
                stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                strSQL="SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' AND SR_NO>"+Integer.toString(SrNo)+" ORDER BY SR_NO";
                rsTmp=stTmp.executeQuery(strSQL);
                rsTmp.first();
                if(rsTmp.getRow()>0){
                    while(!rsTmp.isAfterLast()) {
    ...
    public static HashMap getUserList(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            ...
            strSQL="SELECT USER_ID FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
    ...
    public static int getFinalApprover(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            ...
            strSQL="SELECT USER_ID FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='F'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                UserID=rsTmp.getInt("USER_ID");
    ...
    public static String getCreatorStatus(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT STATUS FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"' AND TYPE='C'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
    ...
    public static boolean IsCreator(int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT STATUS FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND TYPE='C' AND USER_ID="+EITLERPGLOBAL.gUserID;
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                Creator=true;
    ...
    public static int getRecordCount(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT COUNT(*) AS RECCOUNT FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
    ...
    public static void RemoveRecords(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            data.Execute("DELETE FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID="+Integer.toString(pModuleID)+" AND DOC_NO='"+pDocNo+"'");
        }
        catch(Exception e) {
        }
    }
    ...
    public static boolean IsOnceRejectedDoc(int pCompanyID,int pModuleID,String pDocNo) {
        ...
        try {
            ...
            rsTmp=data.getResult("SELECT REJECTED FROM SDMLATTPAY."+TableName+" WHERE  "+FieldName+"='"+pDocNo+"'");
    ...
    public static boolean IsOnceRejectedDoc(int pCompanyID,int pModuleID,String pDocNo,String pURL) {
        ...
        try {
            ...
            //rsTmp=data.getResult("SELECT REJECTED FROM SDMLATTPAY."+TableName+" WHERE  "+FieldName+"='"+pDocNo+"'",pURL);
    ...
    public static boolean IncludeUserInApproval(int pCompanyID,int pModuleID,String pDocNo,int pUserID,int pFromUserID) {
        ...
        try {
            ...
            ResultSet rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND USER_ID="+pFromUserID);
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                FromSrNo=rsTmp.getInt("SR_NO");
                
                rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND USER_ID="+pUserID);
                rsTmp.first();
                ...
                if(IsOnceRejectedDoc(pCompanyID,pModuleID,pDocNo,FinanceGlobal.FinURL)) {
                    rsTmp=data.getResult("SELECT MAX(SR_NO) AS MAX_SR_NO FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='V'");
                    rsTmp.first();
    ...
    public static boolean IncludeUserInApproval(int pCompanyID,int pModuleID,String pDocNo,int pUserID,int pFromUserID,String dbURL) {
        ...
        try {
            ...
            ResultSet rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND USER_ID="+pFromUserID,dbURL);
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                FromSrNo=rsTmp.getInt("SR_NO");
                
                rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND USER_ID="+pUserID,dbURL);
                rsTmp.first();
                ...
                if(IsOnceRejectedDoc(pCompanyID,pModuleID,pDocNo,dbURL)) {
                    rsTmp=data.getResult("SELECT MAX(SR_NO) AS MAX_SR_NO FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='V'", dbURL);
                    rsTmp.first();
    ...
    public boolean UpdateFlow() {
        ...
        try {
            ...
            rsDocData=stDocData.executeQuery("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA LIMIT 1");
            rsDocData.first();
            
            //If User is creator of the document
            if(IsCreator&&rsHierarchy.getRow()>0) {
                //String str = "SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+CompanyID+" AND MODULE_ID="+ModuleID+" "+
                //" AND DOC_NO='"+DocNo+"' AND USER_ID="+rsHierarchy.getInt("USER_ID")+" AND SR_NO="+rsHierarchy.getInt("APPROVAL_SEQUENCE");
                String str = "SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID=2 AND MODULE_ID="+ModuleID+" "+
                " AND DOC_NO='"+DocNo+"' AND USER_ID="+rsHierarchy.getInt("USER_ID")+" AND SR_NO="+rsHierarchy.getInt("APPROVAL_SEQUENCE");
                if (!data.IsRecordExist(str)) {
                    //Insert Records into SDMLATTPAY.D_COM_DOC_DATA from the Hierarchy
            ...
            System.out.println("--SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' ORDER BY SR_NO ");
            rsDocData=stDocData.executeQuery("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' ORDER BY SR_NO ");
            ...
            if((HierarchyID == 837 && EITLERPGLOBAL.gCompanyID == 2) || (HierarchyID == 681 && EITLERPGLOBAL.gCompanyID == 3)) {
                ...
                while(!rsDocData.isAfterLast()) {
                    System.out.println(rsDocData.getInt("USER_ID"));
                    if(rsDocData.getInt("USER_ID")==From) {
                        FromSrNo=rsDocData.getInt("SR_NO");
                    }
            ...
            rsTmp=data.getResult("SELECT SR_NO FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID);
            rsTmp.first();
            ...
            if(Status.equals("A")) //Approve and Forward
            {
                ...
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='A',REMARKS='"+Remarks+"',ACTION_DATE=CURDATE(),CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND SR_NO="+Integer.toString(FromSrNo);
                data.Execute(strSQL);
                
                //Set the W Flag for To User ID
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='W',FROM_USER_ID="+Integer.toString(From)+",FROM_REMARKS='"+Remarks+"',RECEIVED_DATE=CURDATE(),CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND SR_NO="+ToSrNo;
                data.Execute(strSQL);
                
                //Set Completed for users between From and To
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='C',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND SR_NO>"+Integer.toString(FromSrNo)+" AND SR_NO<"+Integer.toString(ToSrNo);
                data.Execute(strSQL);
                
                //Set Pending for users greater than To
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='P',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND SR_NO>"+Integer.toString(ToSrNo);
                data.Execute(strSQL);
                
                //Now check whether document sent successfully to recipient. If not set it to current user only
                rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND STATUS='W'");
                rsTmp.first();
                ...
                if(rsTmp.getRow()>0) {
                    ...
                    data.Execute("UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='W' WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO="+CurrentUserSrNo);
                }
                //============== Check Completed =======================//
            ...
            {
                //Set the A Flag for From User ID
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='F',REMARKS='"+Remarks+"',ACTION_DATE=CURDATE(),CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID;
                data.Execute(strSQL);
                
                //Set Approved Flag in Table Specified
                strSQL="UPDATE "+TableName+" SET APPROVED=1,APPROVED_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"',CHANGED=1,CHANGED_DATE=CURDATE() WHERE  "+FieldName+"='"+DocNo+"' ";
                ...
                String reCheck="SELECT APPROVED FROM "+TableName+" WHERE  "+FieldName+"='"+DocNo+"' ";
            ...
            if(Status.equals("R")) //Rejected
            {
                ...
                if(ExplicitSendTo) {
                    rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND USER_ID="+To);
                    rsTmp.first();
                ...
                if(ExplicitSendTo) {
                    ...
                    System.out.println("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND USER_ID="+To);
                    rsTmp=data.getResult("SELECT * FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND USER_ID="+To);
                    rsTmp.first();
                ...
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='W',RECEIVED_DATE=CURDATE(),ACTION_DATE='0000-00-00',FROM_USER_ID="+Integer.toString(From)+",FROM_REMARKS='"+Remarks+" - Rejected Document"+"',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND SR_NO="+Integer.toString(CreatorSrNo);
                data.Execute(strSQL);
                
                //System.out.println(strSQL);
                
                //Set the P Flag for all other users
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='V',CHANGED=1,CHANGED_DATE=CURDATE(),REMARKS='',RECEIVED_DATE='',ACTION_DATE='' WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND SR_NO<>"+Integer.toString(CreatorSrNo)+" AND SR_NO<="+FromSrNo;
                data.Execute(strSQL);
                
                //Set Approved Flag in Table Specified
                strSQL="UPDATE "+TableName+" SET APPROVED=0,REJECTED=1,REJECTED_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"',CHANGED=1,CHANGED_DATE=CURDATE() WHERE  "+FieldName+"='"+DocNo+"' ";
    ...
    public boolean UpdateFlow(String dbURL) {
        ...
        try {
            ...
            rsTmp=data.getResult("SELECT SR_NO FROM SDMLATTPAY.D_COM_DOC_DATA WHERE COMPANY_ID="+CompanyID+" AND MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID);
            rsTmp.first();
            ...
            {
                //Set the A Flag for From User ID
                strSQL="UPDATE SDMLATTPAY.D_COM_DOC_DATA SET STATUS='F',REMARKS='"+Remarks+"',ACTION_DATE=CURDATE(),CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+Integer.toString(CompanyID)+" AND MODULE_ID="+Integer.toString(ModuleID)+" AND DOC_NO='"+DocNo+"' AND USER_ID="+From;
		if(UseSpecifiedURL) {
                    data.Execute(strSQL,SpecificURL);
                } else {
                    data.Execute(strSQL);
                ...
                if(UseSpecifiedURL) {
                    data.Execute(strSQL,SpecificURL);
                    strSQL="UPDATE "+TableName+"_H SET APPROVED=1,APPROVED_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"',CHANGED=1,CHANGED_DATE=CURDATE() WHERE  "+FieldName+"='"+DocNo+"' ";
                    data.Execute(strSQL,SpecificURL);
                } else {
                    data.Execute(strSQL);
                    strSQL="UPDATE "+TableName+"_H SET APPROVED=1,APPROVED_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"',CHANGED=1,CHANGED_DATE=CURDATE() WHERE  "+FieldName+"='"+DocNo+"' ";
