 ...
 *
 */
public class FrmRokdiCEntry extends javax.swing.JApplet {
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle1.setText("Contractor Rokdi Entry  - " + DOC_NO);
            ...
            for (int i = 1; i <= CoffEntry.colMRItems.size(); i++) {
                ...
                rowData[4] = EITLERPGLOBAL.formatDate((String) ObjItem.getAttribute("COFF_DATE").getObj());
                rowData[5] = (String) ObjItem.getAttribute("COFF_SHIFT").getObj();
                rowData[6] = (String) ObjItem.getAttribute("COFF_OT_SHIFT").getObj();
                rowData[7] = (String) ObjItem.getAttribute("COFF_TYPE").getObj();
                try{
                rowData[8] = ObjItem.getAttribute("COFF_FROM_TIME").getString().substring(0, 5);
                }catch(Exception e){}
                try{
                rowData[9] = ObjItem.getAttribute("COFF_TO_TIME").getString().substring(0, 5);
                }catch(Exception e){}
                rowData[10] = ObjItem.getAttribute("COFF_HRS").getString().substring(0, 5);
                rowData[11] = ObjItem.getAttribute("COFF_ROKDI_REMARK").getString();
                rowData[12] = (String) ObjItem.getAttribute("ROKDI_PUNCHES").getObj();
                rowData[13] = (String) ObjItem.getAttribute("ROKDI_PUNCHES_NEXT").getObj();
                rowData[14] = (String) ObjItem.getAttribute("COFF_PUNCHES").getObj();
                rowData[15] = (String) ObjItem.getAttribute("COFF_PUNCHES_NEXT").getObj();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 70, 1050, 250);
        ...
        lblDeptCmb1.setBounds(510, 14, 110, 20);
        ...
        jPanel1.add(cmbDept);
        cmbDept.setBounds(620, 14, 190, 20);

        Tab.addTab("Contractor Rokdi Entry", jPanel1);
        ...
        lblTitle1.setText("Contractor Rokdi Entry");
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            if (Table.getSelectedColumn() == 1) {
               ...
               aList.SQL = "SELECT PAY_EMP_NO AS 'Emp No',EMP_NAME AS 'Name',DPTNAME AS 'Dept Name',ERP_DEPT AS 'Dept Listed' FROM "
                        ...
                        + "AND (PAY_EMP_NO LIKE ('BRD00%')  )  ) AS EMP "
            ...
            if (Table.getSelectedColumn() == 7) {
                LOV aList = new LOV();
                aList.SQL = "SELECT 'E' AS TYPE,'EXTRA' AS DESCRIPTION FROM DUAL UNION ALL SELECT 'R','REPLACEMENT' FROM DUAL ";
                aList.ReturnCol = 1;
                aList.ShowReturnCol = true;
    ...
    private void TableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyReleased
        ...
        if (EditMode == EITLERPGLOBAL.ADD || EditMode == EITLERPGLOBAL.EDIT) {
            if (Table.getSelectedColumn() == 5) {
                String dt = Table.getValueAt(Table.getSelectedRow(), 4).toString();
                ...
                if (!dt.equalsIgnoreCase("") && !emp.equalsIgnoreCase("")) {
                    try {
                        ...
                        msql = "SELECT ALL_OT_PUNCHES AS PUNCHES "
                                ...
                                + " WHERE EMPID='" + emp + "' AND MONTH(PUNCHDATE)=MM AND YEAR(PUNCHDATE)=YYYY AND PUNCHDATE='" + EITLERPGLOBAL.formatDateDB(dt) + "'";
                        //System.out.println("sql"+msql);
                        mpunches = data.getStringValueFromDB(msql);
                        Table.setValueAt(mpunches, Table.getSelectedRow(), 12);
                        msql = "SELECT ALL_OT_PUNCHES AS PUNCHES "
                                + "FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY A "
                                + " WHERE EMPID='" + emp + "' AND MONTH(PUNCHDATE)=MM AND YEAR(PUNCHDATE)=YYYY AND PUNCHDATE=DATE_ADD('" + EITLERPGLOBAL.formatDateDB(dt) + "',INTERVAL 1 DAY)";
                        //System.out.println("sql"+msql);
                        mpunches = data.getStringValueFromDB(msql);
                        ...
                        //System.out.println("sql"+msql);
                        mpunches = data.getStringValueFromDB(msql);
                        Table.setValueAt(mpunches, Table.getSelectedRow(), 14);
                        msql = "SELECT ALL_PUNCHES AS PUNCHES "
                                + "FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY A "
                                + " WHERE EMPID='" + emp + "' AND MONTH(PUNCHDATE)=MM AND YEAR(PUNCHDATE)=YYYY AND PUNCHDATE=DATE_ADD('" + EITLERPGLOBAL.formatDateDB(dt) + "',INTERVAL 1 DAY)";
                        //System.out.println("sql"+msql);
                        mpunches = data.getStringValueFromDB(msql);
                        Table.setValueAt(mpunches, Table.getSelectedRow(), 15);
                        Table.setValueAt(data.getStringValueFromDB("SELECT SHIFT FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='" + emp + "' AND MONTH(PUNCHDATE)=MM AND YEAR(PUNCHDATE)=YYYY AND PUNCHDATE='" + EITLERPGLOBAL.formatDateDB(dt) + "'"), Table.getSelectedRow(), 5);
    ...
    private void Find() {
        ...
        if (ObjTimeCorrectionFind.Cancelled == false) {
            if (!CoffEntry.Filter(ObjTimeCorrectionFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(FrmRokdiCEntry.this, " No records found.", "Find Time Correction Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    private void Add() {
        ...
        lblTitle1.setText("Contractor Rokdi Entry - " + lbldoc.getText());
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Date");   //4
        DataModel.addColumn("Shift");   //5    
         DataModel.addColumn("OT Shift");   //6
        DataModel.addColumn("Type");   //7
        DataModel.addColumn("From Time");   //8
        DataModel.addColumn("To Time");   //9
        DataModel.addColumn("Hours");   //10
        DataModel.addColumn("Remark");   //11
        DataModel.addColumn("RokdiPunches");   //12
        DataModel.addColumn("RokdiPunches_NXT");   //13
        DataModel.addColumn("Punches");   //14
        DataModel.addColumn("Punches_NXT");   //15
    ...
    private void Save() {
        ...
        for (int k = 0; k <= Table.getRowCount() - 1; k++) {
            ...
            if (Table.getValueAt(k, 4).toString().equalsIgnoreCase("")) {
                JOptionPane.showMessageDialog(this, "Enter Date at Row " + (k + 1), "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
...
//            }
            ...
            if (Table.getValueAt(k, 7).toString().equalsIgnoreCase("")) {
                JOptionPane.showMessageDialog(this, "Enter Type at Row " + (k + 1), "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (Table.getValueAt(k, 10).toString().equalsIgnoreCase("")) {
...
//            if (Integer.parseInt(Table.getValueAt(k, 10).toString().substring(0,2))>10) {
...
//      
        ...
        for (int i = 0; i < Table.getRowCount(); i++) {
            dt = Table.getValueAt(i, 4).toString();
            ...
            ObjItem.setAttribute("COFF_DATE", Table.getValueAt(i, 4).toString());
            ObjItem.setAttribute("COFF_SHIFT", Table.getValueAt(i, 5).toString());
            ObjItem.setAttribute("COFF_OT_SHIFT", Table.getValueAt(i, 6).toString());
            ObjItem.setAttribute("COFF_PUNCHES", Table.getValueAt(i, 14).toString());
            ObjItem.setAttribute("COFF_PUNCHES_NEXT", Table.getValueAt(i, 15).toString());
            ObjItem.setAttribute("COFF_TYPE", Table.getValueAt(i, 7).toString());
            ObjItem.setAttribute("COFF_FROM_TIME", Table.getValueAt(i, 8).toString());
            ObjItem.setAttribute("COFF_TO_TIME", Table.getValueAt(i, 9).toString());
            ObjItem.setAttribute("COFF_HRS", Table.getValueAt(i, 10).toString());
            if (Table.getValueAt(i, 7).toString().equalsIgnoreCase("R")) {
                ObjItem.setAttribute("COFF_HRS_REPLACEMENT", Table.getValueAt(i, 10).toString());
            }
            if (Table.getValueAt(i, 7).toString().equalsIgnoreCase("E")) {
                ObjItem.setAttribute("COFF_HRS_EXTRA", Table.getValueAt(i, 10).toString());
            }
            ObjItem.setAttribute("ROKDI_PUNCHES", Table.getValueAt(i, 12).toString());
            ObjItem.setAttribute("ROKDI_PUNCHES_NEXT", Table.getValueAt(i, 13).toString());
            ObjItem.setAttribute("COFF_PUNCHES", Table.getValueAt(i, 14).toString());
            ObjItem.setAttribute("COFF_PUNCHES_NEXT", Table.getValueAt(i, 15).toString());
            ObjItem.setAttribute("COFF_ROKDI_REMARK", Table.getValueAt(i, 11).toString());
...
private void RearrangeSrNo() {
    ...
    private void CalcDiff() {
        String mf, mt, md, sql;
        for (int m = 0; m < Table.getRowCount(); m++) {
            mf = Table.getValueAt(m, 8).toString() + ":00";
            mt = Table.getValueAt(m, 9).toString() + ":00";
            ...
            if (md.equalsIgnoreCase("00:00:00")) {
                ...
                Table.setValueAt(md.substring(0, 5), m, 10);
            }
            sql = "SELECT COUNT(*) FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY "
                    + "WHERE COFF_EMPID='" + Table.getValueAt(m, 1).toString() + "' "
                    + "AND COFF_DATE='" + EITLERPGLOBAL.formatDateDB(Table.getValueAt(m, 4).toString()) + "' "
                    + "AND COFF_HRS='" + Table.getValueAt(m, 10).toString() + "' "
                    + "AND COFF_OT_SHIFT='" + Table.getValueAt(m, 6).toString() + "' "
