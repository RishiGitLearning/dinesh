...
public class clsRokdiCEntry {
    ...
    public static int ModuleID = 827; //72
    ...
    public clsRokdiCEntry() {
        ...
        //props.put("COFF_ROKDI_H_REMARK", new Variant(""));
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY WHERE COFF_DOC_NO LIKE 'HC%'   GROUP BY COFF_DOC_NO");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("COFF_DOC_NO", clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 827, (int) getAttribute("FFNO").getVal(), true));
            //-------------------------------------------------
            ...
            for (int i = 1; i <= colMRItems.size(); i++) {
                clsRokdiCEntryItem ObjMRItems = (clsRokdiCEntryItem) colMRItems.get(Integer.toString(i));
...
//                rsResultSet.updateString("COFF_ROKDI_H_REMARK", getAttribute("COFF_ROKDI_H_REMARK").getString());
...
//                rsHistory.updateString("COFF_ROKDI_H_REMARK", getAttribute("COFF_ROKDI_H_REMARK").getString());
            ...
            ObjFlow.ModuleID = clsRokdiCEntry.ModuleID;
...
//                    rsHistory.updateString("COFF_ROKDI_H_REMARK", getAttribute("COFF_ROKDI_H_REMARK").getString());
                ...
                //========= Inserting Into History =================//
                //Get the Maximum Revision No.
                clsRokdiCEntryItem ObjMRItems = (clsRokdiCEntryItem) colMRItems.get(Integer.toString(1));
                rsHistory.moveToInsertRow();
...
//                rsHistory.updateString("COFF_ROKDI_H_REMARK", getAttribute("COFF_ROKDI_H_REMARK").getString());
            ...
            if (IsRejected) {
                ...
                data.Execute("DELETE FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=" + clsRokdiCEntry.ModuleID + " AND DOC_NO='" + ObjFlow.DocNo + "'");
...
//            setAttribute("COFF_ROKDI_H_REMARK", rsResultSet.getString("COFF_ROKDI_H_REMARK"));
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                Counter = Counter + 1;
                clsRokdiCEntryItem ObjMRItems = new clsRokdiCEntryItem();
    ...
    public boolean IsEditable(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=827 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
        ...
        try {
            ...
            if (rsTmp.getRow() > 0) {
                while (!rsTmp.isAfterLast()) {
                    clsRokdiCEntry objParty = new clsRokdiCEntry();
    ...
    public boolean Filter(String Condition) {
        ...
        try {
            String strSQL = "";
            strSQL += "SELECT * FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY WHERE " + Condition + " AND COFF_DOC_NO LIKE 'HC%' GROUP BY COFF_DOC_NO";
            ...
            if (!rsResultSet.first()) {
                strSQL = "SELECT * FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY WHERE COFF_DOC_NO LIKE 'HC%' GROUP BY COFF_DOC_NO";
                rsResultSet = Stmt.executeQuery(strSQL);
                Ready = true;
                MoveLast();
                return false;
    ...
    public boolean CanDelete(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=827 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND TYPE='C' AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                Counter = Counter + 1;
                clsRokdiCEntry ObjItem = new clsRokdiCEntry();
