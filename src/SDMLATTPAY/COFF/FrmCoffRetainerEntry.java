 ...
 *
 */
public class FrmCoffRetainerEntry extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private int ModuleId = 856;
    private String DOC_NO = "";
    private clsCoffRetainerEntry CoffEntry;
    ...
    public void init() {
        ...
        CoffEntry = new clsCoffRetainerEntry();
    ...
    private void DisplayData() {
        ...
        try {
            ...
            HashMap History = clsCoffRetainerEntry.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsCoffRetainerEntry ObjHistory = (clsCoffRetainerEntry) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10075, 100751)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10075, 100752)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10075, 100753)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10075, 100754)) {
    ...
    private void TableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            if (Table.getSelectedColumn() == 1) {
                LOV aList = new LOV();
                aList.SQL = "SELECT PAY_EMP_NO AS EMP_CODE,EMP_NAME AS NAME,EMP_DEPARTMENT AS DEPARTMENT FROM SDMLATTPAY.ATTPAY_EMPMST WHERE EMP_CATEGORY IN (2,3,4,5) AND EMP_MAIN_CATEGORY IN (2,4)";
                aList.ReturnCol = 1;
    ...
    private void Find() {
        ...
        if (ObjTimeCorrectionFind.Cancelled == false) {
            if (!CoffEntry.Filter(ObjTimeCorrectionFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(FrmCoffRetainerEntry.this, " No records found.", "Find Time Correction Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
