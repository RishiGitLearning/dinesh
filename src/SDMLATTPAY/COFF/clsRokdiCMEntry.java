...
public class clsRokdiCMEntry {
    ...
    public boolean Insert() {
        ...
        try {
            ...
            ObjFlow.ModuleID = clsRokdiCMEntry.ModuleID;
    ...
    public boolean Update() {
        ...
        try {
            ...
            if (IsRejected) {
                ...
                data.Execute("DELETE FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=" + clsRokdiCMEntry.ModuleID + " AND DOC_NO='" + ObjFlow.DocNo + "'");
        ...
        try {
            ...
            if (rsTmp.getRow() > 0) {
                while (!rsTmp.isAfterLast()) {
                    clsRokdiCMEntry objParty = new clsRokdiCMEntry();
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                Counter = Counter + 1;
                clsRokdiCMEntry ObjItem = new clsRokdiCMEntry();
