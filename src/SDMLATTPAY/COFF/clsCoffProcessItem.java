 ...
 * @version
 */
public class clsCoffProcessItem {
    ...
    public clsCoffProcessItem() {
        ...
        props.put("PREVIOUS_GROSS", new Variant(0.0));
        props.put("PREVIOUS_PTAX", new Variant(0.0));
        props.put("DIFF_PTAX", new Variant(0.0));        
        props.put("REV_STAMP", new Variant(0.0));
        props.put("NET_PAY", new Variant(0.0));
        props.put("BANK_NAME", new Variant(""));
        props.put("BANK_ACCOUNT_NO", new Variant(""));
