 ...
 * @author
 */
public class clsCoffRetainerEntry {
    ...
    public static int ModuleID = 856; //72
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY WHERE COFF_DOC_NO LIKE 'X%' GROUP BY COFF_DOC_NO");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("COFF_DOC_NO", clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 856, (int) getAttribute("FFNO").getVal(), true));
            //-------------------------------------------------
            ...
            for (int i = 1; i <= colMRItems.size(); i++) {
                clsCoffEntryItem ObjMRItems = (clsCoffEntryItem) colMRItems.get(Integer.toString(i));
            ...
            ObjFlow.ModuleID = clsCoffRetainerEntry.ModuleID;
            ...
            if (ObjFlow.Status.equals("F")) {
                ...
                sql = "INSERT INTO SDMLATTPAY.ATT_LEAVE_TRN "
                        ...
                        + "LVT_SANCTION,LVT_ALLOWED,LVT_TIME1,LVT_TIME2,"
                        + "APPROVED,APPROVED_DATE,"
                        + "LVT_DOC_NO,LVT_DOC_DATE) "
                        + "SELECT COFF_YEAR,RIGHT(COFF_EMPID,6),COFF_EMPID,'CO',2,TIME_TO_SEC(COFF_HRS)/28800,COFF_DATE,COFF_DATE,'COFF EARN',NULL,NULL,"
                        + "COFF_FROM_TIME,COFF_TO_TIME,APPROVED,APPROVED_DATE,COFF_DOC_NO,COFF_DOC_DATE FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY "
                        + "WHERE COFF_DOC_NO='" + (String) getAttribute("COFF_DOC_NO").getObj() + "' ";
//                data.Execute(sql);
            }
            return true;
        } catch (Exception e) {
    ...
    public boolean Update() {
        ...
        try {
            ...
            if (ApprovalFlow.IsCreator(ModuleID, (String) getAttribute("COFF_DOC_NO").getObj())) {
                ...
                //========= Inserting Into History =================//
                //Get the Maximum Revision No.
                clsCoffEntryItem ObjMRItems = (clsCoffEntryItem) colMRItems.get(Integer.toString(1));
                rsHistory.moveToInsertRow();
            ...
            if (IsRejected) {
                ...
                data.Execute("DELETE FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=" + clsCoffRetainerEntry.ModuleID + " AND DOC_NO='" + ObjFlow.DocNo + "'");
...
//                data.Execute(sql);
    ...
    public boolean setData() {
        ...
        try {
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                Counter = Counter + 1;
                clsCoffEntryItem ObjMRItems = new clsCoffEntryItem();
    ...
    public boolean IsEditable(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=856 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
        ...
        try {
            ...
            if (rsTmp.getRow() > 0) {
                while (!rsTmp.isAfterLast()) {
                    clsCoffRetainerEntry objParty = new clsCoffRetainerEntry();
    ...
    public boolean Filter(String Condition) {
        ...
        try {
            String strSQL = "";
            strSQL += "SELECT * FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY WHERE " + Condition + " AND   COFF_DOC_NO LIKE 'X%' GROUP BY COFF_DOC_NO";
            ...
            if (!rsResultSet.first()) {
                strSQL = "SELECT * FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY  WHERE COFF_DOC_NO LIKE 'X%' GROUP BY COFF_DOC_NO";
                rsResultSet = Stmt.executeQuery(strSQL);
                Ready = true;
                MoveLast();
                return false;
    ...
    public boolean CanDelete(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM SDMLATTPAY.D_COM_DOC_DATA WHERE MODULE_ID=856 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND TYPE='C' AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                Counter = Counter + 1;
                clsCoffRetainerEntry ObjItem = new clsCoffRetainerEntry();
