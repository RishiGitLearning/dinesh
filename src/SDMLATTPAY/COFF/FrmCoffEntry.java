 ...
 *
 */
public class FrmCoffEntry extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private int ModuleId = 815;
    private String DOC_NO = "";
    private clsCoffEntry CoffEntry;
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle1.setText("Coff Entry  - " + DOC_NO);
            ...
            for (int i = 1; i <= CoffEntry.colMRItems.size(); i++) {
                ...
                clsCoffEntryItem ObjItem = (clsCoffEntryItem) CoffEntry.colMRItems.get(Integer.toString(i));
                ...
                rowData[6] = (String) ObjItem.getAttribute("COFF_TYPE").getObj();
                rowData[7] = ObjItem.getAttribute("COFF_FROM_TIME").getString().substring(0, 5);
                rowData[8] = ObjItem.getAttribute("COFF_TO_TIME").getString().substring(0, 5);
                rowData[9] = ObjItem.getAttribute("COFF_HRS").getString().substring(0, 5);
                rowData[10] = (String) ObjItem.getAttribute("COFF_PUNCHES").getObj();
                rowData[11] = (String) ObjItem.getAttribute("COFF_PUNCHES_NEXT").getObj();
        ...
        try {
            ...
            HashMap History = clsCoffEntry.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsCoffEntry ObjHistory = (clsCoffEntry) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10071, 100711)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10071, 100712)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10071, 100713)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10071, 100714)) {
    ...
    private void initComponents() {
        ...
        cmdRemove.setBounds(730, 40, 90, 25);
    ...
    private void TableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            if (Table.getSelectedColumn() == 1) {
                LOV aList = new LOV();
                aList.SQL = "SELECT PAY_EMP_NO AS EMP_CODE,EMP_NAME AS NAME,EMP_DEPARTMENT AS DEPARTMENT FROM SDMLATTPAY.ATTPAY_EMPMST WHERE EMP_CATEGORY IN (2,3,4,5)";
                aList.ReturnCol = 1;
            ...
            if (Table.getSelectedColumn() == 5) {
                ...
                if (!dt.equalsIgnoreCase("") && !emp.equalsIgnoreCase("")) {
                    try {
                        ...
                        Table.setValueAt(data.getStringValueFromDB("SELECT SHIFT FROM SDMLATTPAY.ATT_DATA_DAILY_SUMMARY WHERE EMPID='" + emp + "' AND PUNCHDATE='" + EITLERPGLOBAL.formatDateDB(dt) + "'"), Table.getSelectedRow(), 5);
    ...
    private void Find() {
        ...
        if (ObjTimeCorrectionFind.Cancelled == false) {
            if (!CoffEntry.Filter(ObjTimeCorrectionFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(FrmCoffEntry.this, " No records found.", "Find Time Correction Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Type");   //6
        DataModel.addColumn("From Time");   //7
        DataModel.addColumn("To Time");   //8
        DataModel.addColumn("Hours");   //9
        DataModel.addColumn("Punches");   //10
        DataModel.addColumn("Punches_NXT");   //11
...
//            }
            ...
            if (Integer.parseInt(Table.getValueAt(k, 9).toString().substring(0,2))>10) {
...
//      
        ...
        for (int i = 0; i < Table.getRowCount(); i++) {
            ...
            clsCoffEntryItem ObjItem = new clsCoffEntryItem();
            ...
            ObjItem.setAttribute("COFF_PUNCHES", Table.getValueAt(i, 10).toString());
            ObjItem.setAttribute("COFF_PUNCHES_NEXT", Table.getValueAt(i, 11).toString());
            ObjItem.setAttribute("COFF_TYPE", Table.getValueAt(i, 6).toString());
            ObjItem.setAttribute("COFF_FROM_TIME", Table.getValueAt(i, 7).toString());
            ObjItem.setAttribute("COFF_TO_TIME", Table.getValueAt(i, 8).toString());
            ObjItem.setAttribute("COFF_HRS", Table.getValueAt(i, 9).toString());
            if (Table.getValueAt(i, 6).toString().equalsIgnoreCase("R")) {
                ObjItem.setAttribute("COFF_HRS_REPLACEMENT", Table.getValueAt(i, 9).toString());
            }
            if (Table.getValueAt(i, 6).toString().equalsIgnoreCase("E")) {
                ObjItem.setAttribute("COFF_HRS_EXTRA", Table.getValueAt(i, 9).toString());
            }
...
private void RearrangeSrNo() {
    ...
    private void CalcDiff() {
        String mf, mt, md, sql;
        for (int m = 0; m < Table.getRowCount(); m++) {
            mf = Table.getValueAt(m, 7).toString() + ":00";
            mt = Table.getValueAt(m, 8).toString() + ":00";
            ...
            if (md.equalsIgnoreCase("00:00:00")) {
                ...
                sql = "SELECT COUNT(*) FROM SDMLATTPAY.ATT_COFF_ROKDI_ENTRY "
                        ...
                        + "AND COFF_FROM_TIME='" + Table.getValueAt(m, 7).toString() + "' "
                        + "AND COFF_TO_TIME='" + Table.getValueAt(m, 8).toString() + "' "
                ...
                if (data.getIntValueFromDB(sql) > 0) {
                    ...
                    Table.setValueAt(md.substring(0, 5), m, 9);
                }
            }
        }
    }
