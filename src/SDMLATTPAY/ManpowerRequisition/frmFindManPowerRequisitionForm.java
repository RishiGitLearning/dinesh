...
public class frmFindManPowerRequisitionForm extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Excess Manpower Requisition Details");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 7, 350, 15);
        ...
        jPanel1.add(cmbDept);
        cmbDept.setBounds(90, 70, 230, 20);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        String docNo = jTextFieldDocNo.getText().trim();       
        String attDate = txtAttDate.getText().trim();
...
//        }
        ...
        if(!attDate.equals("")) {
            stringFindQuery=stringFindQuery+" AND ATT_DATE ='"+ EITLERPGLOBAL.formatDateDB(attDate) +"' ";
        }
        
        if(!attDept.equals("")) {
            stringFindQuery=stringFindQuery+" AND ATT_DEPT ='"+ attDept +"' ";
        }
