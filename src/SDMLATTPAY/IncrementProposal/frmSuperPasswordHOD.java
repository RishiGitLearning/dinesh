 ...
 * @author nrpithva
 */
public class frmSuperPasswordHOD extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SUPER PASSWORD");
        ...
        jLabel3.setText("Enter Super password");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 90, 184, 14);
        ...
        cmdCancel.setBounds(120, 150, 78, 23);
        ...
        txtPassword.setBounds(10, 110, 220, 20);
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOKActionPerformed
        ...
        if (!Validate()) {
            ...
            //AppletFrame.startApplet("SDMLATTPAY.IncrementProposal.FrmIncrementManagementProposal", "SDML Employee Management Increment Proposal");
            AppletFrame aFrame = new AppletFrame("Increment Proposal");
            aFrame.startAppletEx("SDMLATTPAY.IncrementProposal.FrmIncrementProposal", "Increment Proposal");
            SDMLATTPAY.IncrementProposal.FrmIncrementProposal ObjDoc = (SDMLATTPAY.IncrementProposal.FrmIncrementProposal) aFrame.ObjApplet;            
            ObjDoc.Find(mDocNo);
    ...
    public boolean ShowDialog() {
        try {
            ...
            aDialog = new JDialog(f, "Super Password", true);
    ...
    private boolean Validate() {
        ...
        if (data.getIntValueFromDB("SELECT COUNT(*) FROM SDMLATTPAY.HOD H "
                + "LEFT JOIN DINESHMILLS.D_COM_USER_MASTER D ON HOD_USER_ID=USER_ID "
                + "WHERE USER_NAME='" + lblUser.getText() + "' AND HOD_PASSWORD='" + MBMencode.MBMen(txtPassword.getText().trim().getBytes()) + "'") > 0) {
            //Continue execution
