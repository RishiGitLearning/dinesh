...
public class FrmLeaveApplicationFind extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        txtLeaveDate.setBounds(210, 40, 100, 27);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!leaveDate.equals("") && !leaveNo.equals("")) {
            ...
            stringFindQuery=stringFindQuery+" LVT_EMPID ='"+txtEmpCode.getText()+"'";
        }       
