 ...
 *
 */
public class FrmLeaveUpdationEntry extends javax.swing.JApplet {
    ...
    private void DisplayData() {
        ...
        try {
            ...
            if ("1".equals(timecorrection.getAttribute("APPROVED").getString())) {
                lblTitle.setBackground(Color.BLUE);
                lblTitle.setForeground(Color.WHITE);
            }

            if ("0".equals(timecorrection.getAttribute("APPROVED").getString())) {
                lblTitle.setBackground(Color.GRAY);
                lblTitle.setForeground(Color.BLACK);
            }

            if ("1".equals(timecorrection.getAttribute("CANCELED").getString())) {
...
*/
        ...
        try {
            ...
            for (int i = 1; i <= timecorrection.hmTimeCorrectionDetails.size(); i++) {
                ...
                if(correctionType.equals("MIS-PUNCH")){
                    rowData[6] = objTimeCorrectionDetails.getAttribute("GATEPASS_TYPE").getString();
                }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10008, 100081)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10008, 100082)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10008, 100083)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10008, 100084)) {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(11, 90, 760, 260);
        ...
        lblTitle.setText("LEAVE UPDATION/DELETION ENTRY");
...
//        }
    ...
    public void FindWaiting() {
        timecorrection.Filter(" DOC_NO IN (SELECT DISTINCT SDMLATTPAY.ATT_LEAVE_UPDATION_ENTRY.LVT_DOC_NO FROM SDMLATTPAY.ATT_LEAVE_UPDATION_ENTRY, SDMLATTPAY.D_COM_DOC_DATA WHERE SDMLATTPAY.ATT_LEAVE_UPDATION_ENTRY.LVT_DOC_NO=SDMLATTPAY.D_COM_DOC_DATA.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
...
//      
        ...
        int i = 0;
        String empcode = "", attendancedate = "", punchtime = "", newtime = "", machine = "", gatepasstype = "";
