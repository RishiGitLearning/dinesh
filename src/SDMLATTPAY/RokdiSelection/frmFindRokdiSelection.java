...
public class frmFindRokdiSelection extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        txtRokdiDate = new javax.swing.JTextField();
        ...
        jLabel1.setText("Find Rokdi Selection Details");
        ...
        txtEmpNo.setBounds(110, 10, 120, 19);

        jLabel4.setText("Rokdi Date.");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 40, 100, 15);
        jPanel1.add(txtRokdiDate);
        txtRokdiDate.setBounds(110, 40, 120, 19);

        jLabel3.setDisplayedMnemonic('G');
        jLabel3.setLabelFor(txtEmpNo);
        jLabel3.setText("Rokadi Dept.");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 70, 100, 15);
        ...
        jPanel1.add(cmbDept);
        cmbDept.setBounds(110, 70, 200, 20);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        String docNo = txtEmpNo.getText().trim();       
        String rkdDate = txtRokdiDate.getText().trim();
//        String attDept = String.valueOf(cmbDept.getSelectedIndex());
        String rkdDept = cmbDept.getSelectedItem().toString();
        
        if(!docNo.equals("")) {
            stringFindQuery=stringFindQuery+" AND EMP_ID='"+ docNo +"' ";
        }
        
        if(!rkdDate.equals("")) {
            stringFindQuery=stringFindQuery+" AND ROKDI_DATE ='"+ EITLERPGLOBAL.formatDateDB(rkdDate) +"' ";
        }
        
        if(!rkdDept.equals("")) {
            stringFindQuery=stringFindQuery+" AND ROKDI_DEPT ='"+ rkdDept +"' ";
        }
    ...
    private javax.swing.JTextField txtRokdiDate;
