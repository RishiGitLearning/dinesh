 ...
 *
 */
public class FrmHoliday extends javax.swing.JApplet {

    private int EditMode = 0;
    private EITLComboModel cmbHierarchyModel;
    private EITLComboModel cmbToModel;
    private EITLComboModel cmbHolidayCategoryModel;
    private EITLTableModel DataModelApprovalStatus;
    private EITLTableModel DataModelUpdateHistory, DataModel2;    
    ...
    private int FFNo = 0;
    private int ModuleId = 808;
    private String DOC_NO = "";
    private clsHoliday holiday;
    ...
    public void init() {
        ...
        holiday = new clsHoliday();
        boolean load = holiday.LoadData(EITLERPGLOBAL.gCompanyID);
        if (load) {
            DisplayData();
            MoveLast();
        } else {
            JOptionPane.showMessageDialog(this, "Error occured while Loading Data. Error is " + holiday.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
        SetFields(false);
    ...
    private void clearFields() {
        ...
        GenerateCombos();
        opgHoliday.setSelected(false);
        opgWeekoff.setSelected(false); 
    ...
    private void DisplayData() {
        ...
        try {
            ...
            if ("1".equals(holiday.getAttribute("APPROVED").getString())) {
                lblTitle.setBackground(Color.BLUE);
                lblTitle.setForeground(Color.WHITE);
            }

            if ("0".equals(holiday.getAttribute("APPROVED").getString())) {
                lblTitle.setBackground(Color.GRAY);
                lblTitle.setForeground(Color.BLACK);
            }

            if ("1".equals(holiday.getAttribute("CANCELED").getString())) {
        ...
        try {
            if(EditMode==0) {
                if(holiday.getAttribute("APPROVED").getInt()==1) {
                    lblTitle.setBackground(Color.BLUE);
                }
                ...
                if(holiday.getAttribute("CANCELLED").getInt()==1) {
                    lblTitle.setBackground(Color.RED);
                }
            }
        }
        ...
        clearFields();
        try {
            DOC_NO = holiday.getAttribute("HW_DOC_NO").getString();
            lblTitle.setText("HOLIDAY ENTRY  - " + DOC_NO);
            lbldoc.setText(DOC_NO);
            docdate.setText(EITLERPGLOBAL.formatDate(holiday.getAttribute("HW_DOC_DATE").getString()));
            txtHolidaydate.setText(holiday.getAttribute("HL_DATE").getString());
            EITLERPGLOBAL.setComboIndex(cmbHolidayCategory,(String)holiday.getAttribute("HL_CATEGORY").getObj());

            txtname.setText(holiday.getAttribute("HL_NAME").getString());             
            
            if(holiday.getAttribute("HL_FLAG").getString().equals("WO")){
                opgWeekoff.setSelected(true);
            }
            if(holiday.getAttribute("HL_FLAG").getString().equals("HL")){
                opgHoliday.setSelected(true);                
            }
        ...
        try {
            ...
            String DocNo = holiday.getAttribute("HW_DOC_NO").getString();
            ...
            FormatGridHS();
            //HashMap History = holiday.getHistoryList(EITLERPGLOBAL.gCompanyID + "", DocNo);
            HashMap History = clsHoliday.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsHoliday ObjHistory = (clsHoliday) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10023, 100231)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10023, 100232)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10023, 100233)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 10023, 100234)) {
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = SDMLATTPAY.ApprovalFlow.getFromID(EITLERPGLOBAL.gCompanyID, ModuleId, holiday.getAttribute("DOC_NO").getString());
            //lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = SDMLATTPAY.ApprovalFlow.getFromRemarks(EITLERPGLOBAL.gCompanyID, ModuleId, FromUserID, holiday.getAttribute("DOC_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (SDMLATTPAY.ApprovalFlow.IsCreator(ModuleId, holiday.getAttribute("DOC_NO").getString() + "")) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void GenerateCombos() {
        ...
        //--- Generate Type Combo ------//
        cmbHolidayCategoryModel=new EITLComboModel();
        cmbHolidayCategory.removeAllItems();
        cmbHolidayCategory.setModel(cmbHolidayCategoryModel);
        
        ComboData aData=new ComboData();
        aData.strCode="ALL";
        aData.Text="ALL";
        cmbHolidayCategoryModel.addElement(aData);
        ...
        aData=new ComboData();
        aData.strCode="CON";
        aData.Text="CONTRACTOR";
        cmbHolidayCategoryModel.addElement(aData);
        
        aData=new ComboData();
        aData.strCode="BWRK";
        aData.Text="BADLI WORKER";
        cmbHolidayCategoryModel.addElement(aData);
        //===============================//
    }
    ...
    private void initComponents() {
        ...
        opgWeekoff = new javax.swing.JRadioButton();
        opgHoliday = new javax.swing.JRadioButton();
        jLabel7 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        txtHolidaydate = new javax.swing.JTextField();
        cmbHolidayCategory = new javax.swing.JComboBox();
        ...
        jLabel1.setText("Holiday Category");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 150, 120, 20);
        ...
        opgWeekoff.setFont(new java.awt.Font("DejaVu Sans", 1, 12)); // NOI18N
        opgWeekoff.setText("WEEK OFF");
        opgWeekoff.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opgWeekoffActionPerformed(evt);
            }
        });
        jPanel4.add(opgWeekoff);
        opgWeekoff.setBounds(0, 10, 100, 30);

        opgHoliday.setFont(new java.awt.Font("DejaVu Sans", 1, 12)); // NOI18N
        opgHoliday.setText("HOLIDAY");
        opgHoliday.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opgHolidayActionPerformed(evt);
            }
        });
        jPanel4.add(opgHoliday);
        opgHoliday.setBounds(120, 10, 130, 30);
        ...
        jPanel1.add(jPanel4);
        jPanel4.setBounds(130, 90, 290, 50);

        jLabel6.setText("Holiday Date");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(30, 50, 90, 20);

        txtHolidaydate.setText("DD/MM/YYYY");
        txtHolidaydate = new JTextFieldHint(new JTextField(),"DD/MM/YYYY");
        jPanel1.add(txtHolidaydate);
        txtHolidaydate.setBounds(130, 50, 90, 27);

        cmbHolidayCategory.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel1.add(cmbHolidayCategory);
        cmbHolidayCategory.setBounds(140, 150, 150, 25);
        jPanel1.add(txtname);
        txtname.setBounds(150, 210, 410, 27);

        Tab.addTab("Holiday", jPanel1);
        ...
        jScrollPane1.setBounds(10, 20, 890, 310);
        ...
        lblTitle.setText("HOLIDAY ENTRY");
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        String DocNo = lbldoc.getText();
        //holiday.ShowHistory(DocNo);
        MoveLast();
    }//GEN-LAST:event_cmdViewHistoryActionPerformed

    private void cmdNormalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNormalViewActionPerformed
        //holiday.HistoryView = false;
        //holiday.LoadData();
        MoveLast();
    ...
    private void opgWeekoffActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opgWeekoffActionPerformed
        if(opgWeekoff.isSelected())
            opgHoliday.setSelected(false); 
    }//GEN-LAST:event_opgWeekoffActionPerformed

    private void opgHolidayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opgHolidayActionPerformed
if(opgHoliday.isSelected())
    opgWeekoff.setSelected(false);
    }//GEN-LAST:event_opgHolidayActionPerformed
    ...
    public void Find(String docNo) {
        holiday.Filter(" HW_DOC_NO='" + docNo + "'");
        SetMenuForRights();
        DisplayData();
    }
...
private void Find() {
    ...
    public void FindWaiting() {
        holiday.Filter(" DOC_NO IN (SELECT DISTINCT SDMLATTPAY.ATT_HOLIDAY_WEEKOFF.HW_DOC_NO FROM SDMLATTPAY.ATT_HOLIDAY_WEEKOFF, SDMLATTPAY.D_COM_DOC_DATA WHERE SDMLATTPAY.ATT_HOLIDAY_WEEKOFF.HW_DOC_NO=SDMLATTPAY.D_COM_DOC_DATA.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
    ...
    private void FormatGrid() {
       ...
       tblHistory.removeAll();
        ...
        tblHistory.setModel(DataModel2);        
        tblHistory.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
              
        //Add Columns to it
        DataModel2.addColumn("Date");
        DataModel2.addColumn("Holiday Type");
        DataModel2.addColumn("Name");
        DataModel2.addColumn("Category");        
        
        tblHistory.getColumnModel().getColumn(2).setMinWidth(200);
            tblHistory.getColumnModel().getColumn(2).setMaxWidth(350);
    }
    ...
    private void Save() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (holiday.Insert()) {
                ...
                JOptionPane.showMessageDialog(this, "Error occured while saving. Error is " + holiday.LastError, " SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (holiday.Update()) {                
                ...
                JOptionPane.showMessageDialog(this, "Error occured while saving editing. Error is " + holiday.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
...
//        }
    ...
    private void Edit() {
        ...
        String DocumentNo = (String) holiday.getAttribute("HW_DOC_NO").getString();

        if (holiday.IsEditable(EITLERPGLOBAL.gCompanyID, DocumentNo, EITLERPGLOBAL.gNewUserID)) {
...
// find rate update by doc no
    ...
    private void SetFields(boolean pStat) {
        ...
        txtHolidaydate.setEnabled(pStat);        
        opgWeekoff.setEnabled(pStat);
        opgHoliday.setEnabled(pStat);
        cmbHolidayCategory.setEnabled(pStat); 
...
//      
        holiday.setAttribute("HW_DOC_NO", lbldoc.getText());

        DOC_NO = lbldoc.getText();

        holiday.setAttribute("HW_DOC_NO", DOC_NO);
        holiday.setAttribute("HW_DOC_DATE", docdate.getText());

        holiday.setAttribute("HL_DATE", txtHolidaydate.getText());        
        holiday.setAttribute("HL_NAME", txtname.getText());
        
        if (opgWeekoff.isSelected()) {
            holiday.setAttribute("HL_FLAG", "WO");
        }
        if(opgHoliday.isSelected()){
            holiday.setAttribute("HL_FLAG", "HL");
        }
                    

        holiday.setAttribute("MODULE_ID", ModuleId);
        holiday.setAttribute("USER_ID", EITLERPGLOBAL.gNewUserID);

        holiday.setAttribute("REJECTED_REMARKS", txtToRemarks.getText());
        holiday.setAttribute("REMARKS", "");
        holiday.setAttribute("APPROVAL_STATUS", "");
        holiday.setAttribute("APPROVER_REMARKS", txtFromRemarks.getText());
        holiday.setAttribute("ENTRY_DATE", EITLERPGLOBAL.getCurrentDateDB());
        holiday.setAttribute("HL_CATEGORY",EITLERPGLOBAL.getCombostrCode(cmbHolidayCategory));
        //----- Update Approval Specific Fields -----------//
        holiday.setAttribute("HIERARCHY_ID", EITLERPGLOBAL.getComboCode(cmbHierarchy));
        holiday.setAttribute("FROM", EITLERPGLOBAL.gNewUserID);
        holiday.setAttribute("TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        holiday.setAttribute("FROM_REMARKS", txtToRemarks.getText());

        if (OpgApprove.isSelected()) {
            holiday.setAttribute("APPROVAL_STATUS", "A");
        }

        if (OpgFinal.isSelected()) {
            holiday.setAttribute("APPROVAL_STATUS", "F");
        }

        if (OpgReject.isSelected()) {
            holiday.setAttribute("APPROVAL_STATUS", "R");
            holiday.setAttribute("SEND_DOC_TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        }

        if (OpgHold.isSelected()) {
            holiday.setAttribute("APPROVAL_STATUS", "H");
        }
        //-------------------------------------------------//

        if (EditMode == EITLERPGLOBAL.ADD) {
            holiday.setAttribute("CREATED_BY", EITLERPGLOBAL.gNewUserID);
            holiday.setAttribute("CREATED_DATE", EITLERPGLOBAL.getCurrentDateDB());
        } else {
            holiday.setAttribute("MODIFIED_BY", EITLERPGLOBAL.gNewUserID);
            holiday.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.getCurrentDateDB());
            holiday.setAttribute("UPDATED_BY", EITLERPGLOBAL.gNewUserID);
            holiday.setAttribute("UPDATED_DATE", EITLERPGLOBAL.getCurrentDateDB());
        }
    ...
    private javax.swing.JComboBox cmbHolidayCategory;
    ...
    private javax.swing.JRadioButton opgHoliday;
    private javax.swing.JRadioButton opgWeekoff;
    private javax.swing.JTable tblHistory;
    private javax.swing.JTextField txtAuditRemarks;
    private javax.swing.JTextField txtFrom;
    private javax.swing.JTextField txtFromRemarks;
    private javax.swing.JTextField txtHolidaydate;
    private javax.swing.JTextField txtToRemarks;
    private javax.swing.JTextField txtname;
    // End of variables declaration//GEN-END:variables

    private void HisDisplay() {
        try {
            ResultSet t;
            t = data.getResult("SELECT * FROM SDMLATTPAY.ATT_HOLIDAY_WEEKOFF WHERE APPROVED=1 ORDER BY YEAR(HL_DATE) DESC,MONTH(HL_DATE) DESC,DATE(HL_DATE) ASC");
            t.first();
            if (t.getRow() > 0) {
                while (!t.isAfterLast()) {
                    Object[] rowData = new Object[10];
                    rowData[0] = EITLERPGLOBAL.formatDate(t.getString("HL_DATE"));
                    if(t.getString("HL_FLAG").equals("WO")){
                        rowData[1] = "WEEKOFF";
                    }else if(t.getString("HL_FLAG").equals("HL")){
                        rowData[1] = "HOLIDAY";
                    }
                    rowData[2] = t.getString("HL_NAME");
                    rowData[3]=t.getString("HL_CATEGORY");                    
