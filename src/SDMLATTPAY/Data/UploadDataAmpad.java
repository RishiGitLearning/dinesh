...
public class UploadDataAmpad {
    ...
    public static void main(String[] args) {
        ...
        sql = "LOAD DATA LOCAL INFILE \"/database/sjdata/attdata/AMPADATD.txt\" IGNORE INTO TABLE SDMLATTPAY.TMP_ATT_DATA";
       ...
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002032' WHERE EMP_CODE = 'APD002032'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002033' WHERE EMP_CODE = 'APD002033'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002034' WHERE EMP_CODE ='APD002034'");        
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002035' WHERE EMP_CODE ='APD002035'");   
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002039' WHERE EMP_CODE ='APD002039'");        
