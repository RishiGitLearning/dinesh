...
public class UploadDataAnk {
    ...
    public static void main(String[] args) {
        ...
        data.Execute(sql);
        //sql = "LOAD DATA LOCAL INFILE \"E:/sdmlfpn.txt\" IGNORE INTO TABLE SDMLATTPAY.TMP_ATT_DATA";
        sql = "LOAD DATA LOCAL INFILE \"/database/sjdata/attdata/sdmlfpn.txt\" IGNORE INTO TABLE SDMLATTPAY.TMP_ATT_DATA";
        //sql = "LOAD DATA LOCAL INFILE \"E:/sdmlfpn.txt\" IGNORE INTO TABLE SDMLATTPAY.TMP_ATT_DATA";
        data.Execute(sql);
        ...
        //data.Execute(sql);
        sql="DELETE FROM SDMLATTPAY.TMP_ATT_DATA WHERE LENGTH(T1)<20";
        data.Execute(sql);
        ...
        sql = "UPDATE SDMLATTPAY.ATT_DATA "
                ...
                + "SET EMP_CODE=CONCAT('ANK',LEFT(T1,6)),P_DATE=SUBSTRING(T1,11,8),P_TIME=CONCAT(SUBSTRING(T1,7,2),':',SUBSTRING(T1,9,2)),MACHINE=SUBSTRING(T1,19,2) "
       ...
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD500131' WHERE EMP_CODE = 'ANK500131'");
       
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD102025' WHERE EMP_CODE = 'ANK102025'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD102026' WHERE EMP_CODE = 'ANK102026'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD102027' WHERE EMP_CODE = 'ANK102027'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD102028' WHERE EMP_CODE = 'ANK102028'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA  SET EMP_CODE = 'BRD102029' WHERE EMP_CODE ='ANK102029'");        
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA  SET EMP_CODE = 'BRD500129' WHERE EMP_CODE ='ANK500129'");
