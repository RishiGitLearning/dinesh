...
public class CopyTableFromSPP {
    ...
    public static void main(String[] args) {
        ...
        //stlocal = connlocal.createStatement();
            ...
            stlocal.execute("DELETE FROM SDMLATTPAY.PAYROLL_MTH_SUMMARY_FROM_SPP WHERE PAY_MONTH=6 AND PAY_YEAR=2020");

            strSQLRemote += "SELECT * FROM SDMLATTPAY.ATTPAY_EMPMST_FROM_SPP ";
            strSQLRemote1 += "SELECT * FROM SDMLATTPAY.PAYROLL_MTH_SUMMARY_FROM_SPP WHERE PAY_MONTH=6 AND PAY_YEAR=2020";
            ...
            while (!rsTmpRemote.isAfterLast()) {
                ...
                strSQLLocal += "\"" + rsTmpRemote.getString("PRESENT_ADDRESS").replaceAll("&", "and") + "\",";
