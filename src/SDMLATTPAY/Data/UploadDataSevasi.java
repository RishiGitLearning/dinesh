...
public class UploadDataSevasi {
    ...
    public static void main(String[] args) {
        ...
        sql = "LOAD DATA LOCAL INFILE \"/database/sjdata/attdata/SEVASIATD.txt\" IGNORE INTO TABLE SDMLATTPAY.TMP_ATT_DATA";
        ...
        sql = "UPDATE SDMLATTPAY.ATT_DATA "
                //+ "SET EMP_CODE=CONCAT('GDC',LEFT(T1,6)),P_DATE=SUBSTRING(T1,11,8),P_TIME=CONCAT(SUBSTRING(T1,7,2),':',SUBSTRING(T1,9,2)),MACHINE=SUBSTRING(T1,19,2) "
                + "SET EMP_CODE=CONCAT('SVS',LEFT(T1,6)),P_DATE=SUBSTRING(T1,11,8),P_TIME=CONCAT(SUBSTRING(T1,7,2),':',SUBSTRING(T1,9,2)),MACHINE=SUBSTRING(T1,19,2) "
                //+ "SET EMP_CODE=CONCAT('APD',LEFT(T1,6)),P_DATE=SUBSTRING(T1,11,8),P_TIME=CONCAT(SUBSTRING(T1,7,2),':',SUBSTRING(T1,9,2)),MACHINE=SUBSTRING(T1,19,2) "
       ...
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD500010' WHERE EMP_CODE = 'GDC000001'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD500029' WHERE EMP_CODE = 'GDC000003'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD500051' WHERE EMP_CODE = 'GDC000005'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD003719' WHERE EMP_CODE = 'GDC003719'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD500101' WHERE EMP_CODE = 'GDC500101'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD500118' WHERE EMP_CODE = 'GDC500118'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA  SET EMP_CODE = 'BRD100662' WHERE EMP_CODE ='SVS000001'");        
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA  SET EMP_CODE = 'BRD100662' WHERE EMP_CODE ='SVS100662'");        

       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002027' WHERE EMP_CODE = 'SVS002027'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002028' WHERE EMP_CODE = 'SVS002028'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002031' WHERE EMP_CODE = 'SVS002031'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002037' WHERE EMP_CODE = 'SVS002037'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002030' WHERE EMP_CODE = 'SVS002030'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002036' WHERE EMP_CODE = 'SVS002036'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002040' WHERE EMP_CODE = 'SVS002040'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD102041' WHERE EMP_CODE = 'SVS102041'");
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA SET EMP_CODE = 'BRD002042' WHERE EMP_CODE = 'SVS002042'");
