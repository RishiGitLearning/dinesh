...
public class UploadDataGidc {
    ...
    public static void main(String[] args) {
        ...
        sql = "LOAD DATA LOCAL INFILE \"/database/sjdata/attdata/GIDCATD.txt\" IGNORE INTO TABLE SDMLATTPAY.TMP_ATT_DATA";
       ...
       data.Execute("UPDATE SDMLATTPAY.ATT_DATA  SET EMP_CODE = 'BRD100662' WHERE EMP_CODE ='SVS100662'");        
        ...
        data.Execute("DELETE FROM SDMLATTPAY.EMP_PUNCH WHERE EP_DATE>=SUBDATE(CURDATE(),INTERVAL 130 DAY) AND EP_DATE<=ADDDATE(CURDATE(),INTERVAL 130 DAY)");
        sql = "INSERT INTO SDMLATTPAY.EMP_PUNCH (EP_EMP_CODE,EP_DATE,EP_TIME1,EP_TIME2,EP_TIME3,EP_TIME4,EP_TIME5"
                ...
                + "WHERE A_DATE>=SUBDATE(CURDATE(),INTERVAL 130 DAY) AND A_DATE<=ADDDATE(CURDATE(),INTERVAL 130 DAY) "
        ...
        sql = "UPDATE SDMLATTPAY.EMP_PUNCH "
                ...
                + "WHERE EP_DATE>=SUBDATE(CURDATE(),INTERVAL 130 DAY) AND EP_DATE<=ADDDATE(CURDATE(),INTERVAL 130 DAY) ";
        //System.out.println("update:" + sql);
        //     data.Execute(sql);
        sql = "UPDATE SDMLATTPAY.EMP_PUNCH P,SDMLATTPAY.ATTPAY_EMPMST M  "
                + "SET EP_EMP_CODE=M.PAY_EMP_NO "
                + "WHERE P.EP_EMP_CODE=M.EMP_NO AND EP_DATE>=SUBDATE(CURDATE(),INTERVAL 130 DAY) AND EP_DATE<=ADDDATE(CURDATE(),INTERVAL 130 DAY) ";
