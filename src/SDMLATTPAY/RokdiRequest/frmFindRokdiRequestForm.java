...
public class frmFindRokdiRequestForm extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        txtRkdDate = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        cmbRkd = new javax.swing.JComboBox();

        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setText("Find Rokdi Request Details");
        ...
        jTextFieldDocNo.setBounds(90, 10, 120, 19);

        jLabel4.setText("Rkd Date.");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 40, 80, 15);
        jPanel1.add(txtRkdDate);
        txtRkdDate.setBounds(90, 40, 120, 19);

        jLabel3.setDisplayedMnemonic('G');
        jLabel3.setLabelFor(jTextFieldDocNo);
        jLabel3.setText("Rkd Dept.");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 70, 80, 15);

        cmbRkd.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Dept", "WEAVING", "YARN STORE", "MENDING", "NEEDLING", "FINISHING", "CARDING", "WAREHOUSE", "ENGINEERING", "RMG", "SECURITY", "STORES", "PEONS" }));
        jPanel1.add(cmbRkd);
        cmbRkd.setBounds(90, 70, 230, 20);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        String rkdDate = txtRkdDate.getText();
//        String attDept = String.valueOf(cmbDept.getSelectedIndex());
        String rkdDept = cmbRkd.getSelectedItem().toString();
        
        if(!docNo.equals("")) {
            stringFindQuery=stringFindQuery+" AND DOC_NO='"+ docNo +"' ";
        }
        
        if(!rkdDate.equals("") && !rkdDept.equals("")) {
            stringFindQuery=stringFindQuery+" AND REQ_DATE ='"+ rkdDate +"' AND REQ_DEPT ='"+ rkdDept +"' ";
        }
    ...
    private javax.swing.JComboBox cmbRkd;
    ...
    private javax.swing.JTextField txtRkdDate;
