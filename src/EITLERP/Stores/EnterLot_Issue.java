...
public class EnterLot_Issue extends javax.swing.JApplet {
        ...
        for(int i=0;i<Table.getRowCount();i++) {
            if((Table.getValueAt(i,0)!=null)&&(Table.getValueAt(i,1)!=null)) {
                ...
                if(LotQty>0) {
                    ...
                    //Now check that Lot exist
                    if(clsItem.IsEntryExist(EITLERPGLOBAL.gCompanyID,ItemID,BOENo,LotNo,WareHouseID,LocationID)) {
                        ValidEntryCount++;
                    }
                }
            }
    ...
    private void GenerateGrid() {
        ...
        for(int i=1;i<=colLot.size();i++) {
            clsIssueRawItemDetail ObjLot=(clsIssueRawItemDetail)colLot.get(Integer.toString(i));
            Object[] rowData=new Object[3];
            
            rowData[0]=Integer.toString((int)ObjLot.getAttribute("SRNO").getVal());
    ...
    private void SetLot() {
        colLot.clear();
        for(int i=0;i<Table.getRowCount();i++) {
            clsIssueRawItemDetail ObjLot=new clsIssueRawItemDetail();
            
            String LotNo=(String)Table.getValueAt(i, 1);
            double LotQty=Double.parseDouble((String)Table.getValueAt(i, 2));
            
            ObjLot.setAttribute("COMPANY_ID",EITLERPGLOBAL.gCompanyID);
            ObjLot.setAttribute("ISSUE_NO",IssueNo);
            ObjLot.setAttribute("SR_NO",IssueSrNo);
            ObjLot.setAttribute("SRNO",i);
    ...
    public boolean ShowList() {
        try {
            ...
            aDialog=new JDialog(f,"Enter Issue Lot",true);
