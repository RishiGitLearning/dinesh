...
public class frmIssueGenFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtReqNo.setNextFocusableComponent(txtDateTo);
    ...
    private void cmdClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdClearActionPerformed
        // TODO add your handling code here:
        strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND ISSUE_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND ISSUE_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' AND FOR_STORE='G'";
        Cancelled=false;
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       String subQuery="";
       strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND FOR_STORE='G' ";
       
       if(!txtDocNo.getText().equals(""))
       {
         strQuery=strQuery+" AND ISSUE_NO='"+txtDocNo.getText()+"' ";
       }
       
       if(!txtDateFrom.getText().equals(""))
       {
         strQuery=strQuery+" AND ISSUE_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
       }

       if(!txtDateTo.getText().equals(""))
       {
         strQuery=strQuery+" AND ISSUE_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
       ...
       {
        subQuery=subQuery+" AND REQ_NO='"+txtReqNo.getText()+"' ";   
       }
       
       
       if(!subQuery.trim().equals(""))
       {
        subQuery=" AND ISSUE_NO IN (SELECT ISSUE_NO FROM D_INV_ISSUE_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" "+subQuery+")";
       }
