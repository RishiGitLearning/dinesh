...
/*<APPLET CODE=frmMIRFindGen.class HEIGHT=405 WIDTH=565></APPLET>*/
...
public class frmJobworkFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(231, 119, 45, 15);
        ...
        txtItemID.setBounds(104, 326, 121, 19);
        
        jLabel13.setText("Item");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(39, 326, 52, 15);
        
        txtItemName.setEditable(false);
        jPanel1.add(txtItemName);
        txtItemName.setBounds(105, 347, 309, 19);
        
        jLabel14.setText("RGP No.");
        jPanel1.add(jLabel14);
        jLabel14.setBounds(43, 386, 58, 15);
        
        jPanel1.add(txtRGPNo);
        txtRGPNo.setBounds(107, 383, 114, 19);
        
        jLabel19.setText("PO No.");
        jPanel1.add(jLabel19);
        jLabel19.setBounds(269, 384, 49, 15);
        
        jPanel1.add(txtPONo);
        txtPONo.setBounds(321, 382, 114, 19);
        
        jLabel15.setText("Indent No.");
        jPanel1.add(jLabel15);
        jLabel15.setBounds(30, 411, 71, 15);
        
        jPanel1.add(txtIndentNo);
        txtIndentNo.setBounds(107, 410, 114, 19);
        
        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 38, 458, 439);
    ...
    private void cmdClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdClearActionPerformed
        // TODO add your handling code here:
        strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND JOB_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND JOB_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ";
        Cancelled=false;
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       //strQuery=" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND JOB_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND JOB_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ";
       strQuery=" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" ";
              
       if(!txtDocNo.getText().equals(""))
       {
         strQuery=strQuery+" AND JOB_NO='"+txtDocNo.getText()+"' ";
       }
       
       if(!txtDateFrom.getText().equals(""))
       {
         strQuery=strQuery+" AND JOB_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
       }

       if(!txtDateTo.getText().equals(""))
       {
         strQuery=strQuery+" AND JOB_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
       ...
       if(!txtRGPNo.getText().trim().equals(""))
       {
        subQuery=subQuery+" AND RGP_NO='"+txtRGPNo.getText()+"' ";   
       }
       ...
       {
        subQuery=" AND JOB_NO IN (SELECT JOB_NO FROM D_INV_JOB_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" "+subQuery+")";
       }
