...
public class FrmIssue_General extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setBounds(0, 66, 920, 368);
    ...
    private void cmdInsertMRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertMRActionPerformed
        ...
        if(ObjMR.ShowList()) {
            ...
            for(int i=1;i<=ObjMR.colSelItems.size();i++) {
                ...
                DataModelL.setValueByVariable("ISSUE_CAT",(String)ObjItem.getAttribute("ISSUE_CAT").getObj(),NewRow);
                DataModelL.setValueByVariable("ISSUE_CAT_DESC",(String)ObjItem.getAttribute("ISSUE_CAT_DESC").getObj(),NewRow);                
...
//            ObjIssueItem.setAttribute("GRN_SR_NO",Integer.parseInt(DataModelL.getValueByVariable("GRN_SR_NO",i)));
            ...
            ObjIssueItem.setAttribute("ISSUE_CAT",DataModelL.getValueByVariable("ISSUE_CAT",i));
            ObjIssueItem.setAttribute("ISSUE_CAT_DESC",DataModelL.getValueByVariable("ISSUE_CAT_DESC",i));
            if(EditMode==EITLERPGLOBAL.ADD) {
