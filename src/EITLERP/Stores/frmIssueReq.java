...
public class frmIssueReq extends javax.swing.JApplet {
    
    private int EditMode=0;
    private clsIssueRequisition ObjMR;
    ...
    private void initComponents() {
        ...
        ToolBar.setBounds(0, 0, 860, 40);

        lblTitle.setBackground(new java.awt.Color(0, 102, 153));
        lblTitle.setText(" ISSUE REQUISITION (GENERAL)");
        ...
        Tab1.add(jLabel3);
        jLabel3.setBounds(324, 16, 32, 15);
        ...
        Tab1.add(jLabel4);
        jLabel4.setBounds(60, 52, 44, 15);

        jLabel5.setText("For Dept.");
        jLabel5.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        Tab1.add(jLabel5);
        jLabel5.setBounds(46, 88, 66, 15);
        ...
        Tab1.add(cmbBuyer);
        cmbBuyer.setBounds(112, 48, 160, 24);

        jLabel6.setText("Purpose");
        jLabel6.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        Tab1.add(jLabel6);
        jLabel6.setBounds(60, 132, 50, 15);
        ...
        Tab1.add(txtPurpose);
        txtPurpose.setBounds(114, 128, 366, 19);

        jLabel8.setText("Remarks");
        jLabel8.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        Tab1.add(jLabel8);
        jLabel8.setBounds(47, 162, 63, 15);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(114, 160, 366, 19);
        ...
        jScrollPane1.setBounds(12, 198, 820, 162);
        ...
        Tab1.add(cmdAdd);
        cmdAdd.setBounds(540, 370, 80, 25);
        ...
        Tab1.add(cmdRemove);
        cmdRemove.setBounds(630, 370, 86, 25);

        jPanel3.setBackground(new java.awt.Color(153, 153, 153));
        jPanel3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        Tab1.add(jPanel3);
        jPanel3.setBounds(10, 186, 822, 6);
        ...
        Tab1.add(cmdHistory);
        cmdHistory.setBounds(410, 370, 121, 25);
        ...
        Tab1.add(cmbForDept);
        cmbForDept.setBounds(112, 84, 160, 24);
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,clsIssueRequisition.ModuleID,txtDocNo.getText())) {
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private void DisplayData() {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsIssueRequisition.ModuleID;
        ...
        lblTitle.setText("ISSUE REQUISITION (GENERAL) - "+txtDocNo.getText());
        ...
        for(int i=1;i<=ObjMR.colMRItems.size();i++) {
            ...
            rowData[9]=(String)ObjItem.getAttribute("MFG_PROG_NO").getObj();
            rowData[10]=(String)ObjItem.getAttribute("BLEND_CODE").getObj();
            
            rowData[11]=(String)ObjItem.getAttribute("ISSUE_CAT").getObj();
            rowData[12]=(String)ObjItem.getAttribute("ISSUE_CAT_DESC").getObj();
            DataModel.addRow(rowData);
        }
        ...
        List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsIssueRequisition.ModuleID , DocNo);
        ...
        FormatGridHS();
        HashMap History=clsIssueRequisition.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
        for(int i=1;i<=History.size();i++) {
            clsIssueRequisition ObjHistory=(clsIssueRequisition)History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        for(int i=0;i<Table.getRowCount();i++) {
            ...
            if(clsItem.IsValidItemID(EITLERPGLOBAL.gCompanyID, lItemID)) {
                ...
                ObjItem.setAttribute("REQ_QTY",EITLERPGLOBAL.round(Double.parseDouble((String)Table.getValueAt(i,4)),4));
                ...
                ObjItem.setAttribute("MFG_PROG_NO",(String)Table.getValueAt(i,9));
                ObjItem.setAttribute("BLEND_CODE",(String)Table.getValueAt(i,10));
                ObjItem.setAttribute("ISSUE_CAT",(String)Table.getValueAt(i,11));
                ObjItem.setAttribute("ISSUE_CAT_DESC",(String)Table.getValueAt(i,12));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.addColumn("Mfg. Prog. No."); //9 Remarks
            DataModel.addColumn("Blend Code"); //10 Remarks
            
            DataModel.addColumn("Category"); //11 
            DataModel.addColumn("Category Desc"); //12 
            ...
            DataModel.SetVariable(11,"ISSUE_CAT"); //6 Read Only
            DataModel.SetVariable(12,"ISSUE_CAT_DESC"); //7 Remarks
        ...
        catch(Exception e)
        {
            ...
            Table.getColumnModel().getColumn(11).setCellEditor(new DefaultCellEditor(cmbCatType));
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID= "+clsIssueRequisition.ModuleID);
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsIssueRequisition.ModuleID);
        }
        for(int i=1;i<=List.size();i++) {
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsIssueRequisition.ModuleID ,(String)ObjMR.getAttribute("REQ_NO").getObj());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsIssueRequisition.ModuleID ,(String)ObjMR.getAttribute("REQ_NO").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsIssueRequisition.ModuleID ,FromUserID,(String)ObjMR.getAttribute("REQ_NO").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10341)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Edit Rights --
        cmdEdit.setEnabled(true);
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10342)) {
            cmdEdit.setEnabled(true);
        }
        else {
            cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10343)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10344)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
        ...
        aList.ModuleID=clsIssueRequisition.ModuleID ;
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsIssueRequisition.ModuleID , FFNo,  false));
            txtDocDate.requestFocus();
    ...
    private void Edit() {
        ...
        if(ObjMR.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(clsIssueRequisition.ModuleID ,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10342)) {
                SetFields(true);
            }
            else {
                EnableApproval();
            ...
            /*if(!ApprovalFlow.IsCreator(clsIssueRequisition.ModuleID ,lDocNo)) {
                DataModel.SetReadOnly(1);
                DataModel.SetReadOnly(4);
            }*/
            DisableToolbar();
    ...
    private void Save() {
        ...
        for(int i=0;i<=Table.getRowCount()-1;i++) {
            ...
            String strIssueCat=(String)Table.getValueAt(i,11);
            String strIssueCatDesc=(String)Table.getValueAt(i,12);
            if(strIssueCat.equals("")) {
                JOptionPane.showMessageDialog(null,"Please select any Issue Category!!");
                return;
            }
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            if(ObjMR.Insert()) {                         
                ...
                SelectFirstFree aList = new SelectFirstFree();
                aList.ModuleID = clsIssueRequisition.ModuleID;
                aList.FirstFreeNo = 69;
                FFNo = aList.FirstFreeNo;
                clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsIssueRequisition.ModuleID, FFNo, true);
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID,clsIssueRequisition.ModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID,clsIssueRequisition.ModuleID , txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID,clsIssueRequisition.ModuleID,txtDocNo.getText());
