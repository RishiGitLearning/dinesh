    ...
    public void setAttribute(String PropName,boolean Value)
 {
   ...
   public double getTotalLotQty() {
      ...
      for(int i=1;i<=colItemLot.size();i++) {
         clsGRNLot ObjLot=(clsGRNLot)colItemLot.get(Integer.toString(i));
    ...
    public clsGRNItem() {
        ...
        props.put("COLUMN_40_ID",new Variant(0));
        props.put("COLUMN_40_FORMULA",new Variant(""));
        props.put("COLUMN_40_PER",new Variant(0));
        props.put("COLUMN_40_AMT",new Variant(0));
        props.put("COLUMN_40_CAPTION",new Variant(""));
