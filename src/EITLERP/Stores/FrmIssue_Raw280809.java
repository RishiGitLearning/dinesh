 ...
 */
/*<APPLET CODE=FrmIssue_Raw280809.class HEIGHT=500 WIDTH=800*/
...
public class FrmIssue_Raw280809 extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtIssueDate.setName("ISSUE_DATE");
        ...
        cmbIssueType.setName("ISSUE_TYPE");
        ...
        chkCanceled.setBounds(679, 32, 85, 23);
        ...
        Tab1.add(txtPurpose);
        txtPurpose.setBounds(110, 190, 570, 19);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(110, 220, 570, 19);
        ...
        jTabbedPane1.setBounds(0, 66, 800, 368);
    ...
    private void cmdInsertMRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertMRActionPerformed
        ...
        if(ObjMR.ShowList()) {
            ...
            for(int i=1;i<=ObjMR.colSelItems.size();i++) {
                ...
                double Remaining_Qty = ObjItem.getAttribute("REQ_QTY").getVal();
        ...
        if(EditMode!=0) {
            ...
            if(TableL.getSelectedColumn()==DataModelL.getColFromVariable("COST_CENTER_ID")) {
                if(evt.getKeyCode()==112) //F1 Key pressed
                {
                    ...
                    {
                    aList.SQL="SELECT COST_CENTER_ID,COST_CENTER_NAME FROM D_COM_COST_CENTER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND DEPT_ID="+DeptID+" ORDER BY COST_CENTER_NAME";
                    }*/
    ...
    private void Find(){
        ...
        if(ObjReturn.Cancelled==false) {
            ...
            if(!ObjReturn.strQuery.trim().equals("")) {
                ...
                ObjReturn.strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND ISSUE_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND ISSUE_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ";
            }
