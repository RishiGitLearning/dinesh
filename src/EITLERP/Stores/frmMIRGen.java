 ...
 *
 */
public class frmMIRGen extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText(" MATERIAL INSPECTION REPORT (General)");
        ...
        Tab1.add(jLabel4);
        jLabel4.setBounds(54, 101, 52, 15);
        ...
        txtSuppCode.setBounds(114, 97, 62, 19);

        txtSuppName.setEnabled(false);
        Tab1.add(txtSuppName);
        txtSuppName.setBounds(178, 97, 212, 19);
        ...
        Tab1.add(jLabel6);
        jLabel6.setBounds(254, 138, 29, 15);
        ...
        Tab1.add(jLabel8);
        jLabel8.setBounds(255, 163, 29, 15);
        ...
        txtInvoiceNo.setBounds(114, 184, 114, 19);

        jLabel10.setText("Date");
        Tab1.add(jLabel10);
        jLabel10.setBounds(257, 188, 29, 15);
        ...
        txtInvoiceDate.setBounds(293, 186, 100, 19);
        ...
        chkCancelled.setBounds(439, 84, 85, 23);
        ...
        Tab1.add(txtSuffix);
        txtSuffix.setBounds(114, 71, 62, 19);
        ...
        Tab1.add(cmdChange);
        cmdChange.setBounds(134, 36, 81, 20);
    ...
    private void txtDocNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDocNoFocusLost
        // TODO add your handling code here:
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (clsMIRGen.IsMIRExist(EITLERPGLOBAL.gCompanyID, txtDocNo.getText())) {
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if (ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void DisplayData() {
        ...
        try {
            ...
            String theTitle = "MATERIAL INSPECTION REPORT (General) " + txtDocNo.getText();
            ...
            txtCurrencyRate.setText(Double.toString(ObjMIR.getAttribute("CURRENCY_RATE").getVal()));
            ...
            txtInvoiceAmount.setText(Double.toString(ObjMIR.getAttribute("INVOICE_AMOUNT").getVal()));
            ...
            for (int i = 1; i <= ObjMIR.colMIRItems.size(); i++) {
                ...
                clsMIRGenItem ObjItem = (clsMIRGenItem) ObjMIR.colMIRItems.get(Integer.toString(i));
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 5, DocNo);
            for (int i = 1; i <= List.size(); i++) {
            ...
            FormatGridHS();
            HashMap History = clsMIRGen.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsMIRGen ObjHistory = (clsMIRGen) History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ObjMIR.UserDocNo = txtDocNo.isEnabled();
            ObjMIR.setAttribute("MIR_NO", txtDocNo.getText());
        } else {
            ObjMIR.UserDocNo = false;
        }
        ...
        ObjMIR.setAttribute("CURRENCY_RATE", EITLERPGLOBAL.round(Double.parseDouble(txtCurrencyRate.getText()), 5));
        ObjMIR.setAttribute("OPEN_STATUS", EITLERPGLOBAL.getCombostrCode(cmbStatus));

        ObjMIR.setAttribute("INVOICE_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(txtInvoiceAmount.getText()), 5));
        ...
        ObjMIR.setAttribute("MIR_TYPE", 1); //Fixed type 2 - Raw Material, 1 - General
    ...
    private void SetupColumns() {
        ...
        List = clsColumn.getList(" WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID) + " AND MODULE_ID=5 AND HEADER_LINE='L' ORDER BY COL_ORDER");
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if(!txtSuppCode.getText().startsWith("7")){
                ...
                if(lTaxID==831 || lTaxID==828 || lTaxID==824 || lTaxID==852 || lTaxID==851 || lTaxID==821 || lTaxID==820 || lTaxID==819 || lTaxID==818){
                   DataModelL.SetReadOnly(TableL.getColumnCount() - 1); 
                   if ((boolean) ObjTax.getAttribute("USE_PERCENT").getBool()) {
                       DataModelL.SetReadOnly(TableL.getColumnCount() - 2); 
                   }                   
        ...
        ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=5 AND HIDDEN=0 AND SHOW_LAST=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        ...
        ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=5 AND HIDDEN=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        for (int i = 1; i <= ColList.size(); i++) {
            clsSystemColumn ObjColumn = (clsSystemColumn) ColList.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=5 AND HIDDEN=0 AND SHOW_LAST=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
            for (int i = 1; i <= ColList.size(); i++) {
                clsSystemColumn ObjColumn = (clsSystemColumn) ColList.get(Integer.toString(i));
    ...
    private void SetupColumns_H() {
        ...
        List = clsColumn.getList(" WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID) + " AND MODULE_ID=5 AND HEADER_LINE='H' ORDER BY COL_ORDER");
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=5");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=5");
        }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, 5, (String) ObjMIR.getAttribute("MIR_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, 5, (String) ObjMIR.getAttribute("MIR_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, 5, FromUserID, (String) ObjMIR.getAttribute("MIR_NO").getObj());
        ...
        if (clsHierarchy.CanFinalApprove((int) EITLERPGLOBAL.gCompanyID, SelHierarchyID, (int) EITLERPGLOBAL.gNewUserID)) {
            ...
            if (ApprovalFlow.CanFinalApprove(EITLERPGLOBAL.gCompanyID, 5, EITLERPGLOBAL.gNewUserID)) {
                OpgFinal.setEnabled(true);
            }
            //=================================//
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 511)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 513)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 514)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private boolean Validate() {
        ...
        if (!OpgReject.isSelected()) {
            ...
            for (int i = 0; i < TableL.getRowCount(); i++) {
                double ReceivedQty = EITLERPGLOBAL.round(Double.parseDouble(DataModelL.getValueByVariable("RECEIVED_QTY", i)), 3);
                double RejectedQty = EITLERPGLOBAL.round(Double.parseDouble(DataModelL.getValueByVariable("REJECTED_QTY", i)), 3);

                double AcceptedQty = EITLERPGLOBAL.round(Double.parseDouble(DataModelL.getValueByVariable("QTY", i)), 3);
                ...
                if (ReceivedQty <= 0) {
                    JOptionPane.showMessageDialog(null, "Please enter received qty");
                    return false;
                }
                ...
                if (EditMode == EITLERPGLOBAL.ADD) {
                    ...
                    Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText());
                }

                FinalApprover = ApprovalFlow.getFinalApprover(EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText());
                if (Creator != 0 && EITLERPGLOBAL.gUserID != Creator) {
                    if (clsDepartment.IsUserComesInDept(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, DeptID) || OpgFinal.isSelected()) {
                        ...
                        double TotalQty = EITLERPGLOBAL.round(AcceptedQty + RejectedQty, 3);
                        System.out.println("total Qty " + TotalQty);

                        if (ReceivedQty != TotalQty) {
                            JOptionPane.showMessageDialog(null, "Sum of Accepted Qty+Rejected Qty does not equals to Received Qty. Please verify the input");
                            return false;
                        }
                    }
                }
                ...
                if (OpgFinal.isSelected()) {
                    double TotalQty = EITLERPGLOBAL.round(AcceptedQty + RejectedQty, 3);
                    if (ReceivedQty != TotalQty) {
                        JOptionPane.showMessageDialog(null, "Sum of Accepted Qty+Rejected Qty Qty does not equals to Received Qty. Please verify the input");
                        return false;
                    }
                }
                ...
                if (!PONo.equals("")) {
                    for (int j = 0; j < TableL.getRowCount(); j++) {
                        PONo = DataModelL.getValueByVariable("PO_NO", i);
        ...
        for (int i = 0; i < TableL.getRowCount(); i++) {
            ...
            //bhavesh code   
            double totalQty = AcceptedQty + RejectedQty;
            if (totalQty > (ReceivedQty + 0.001)) {
            ...
            if (OpgFinal.isSelected()) {
                ...
                if (POQty > 0) {
                    ...
                    /* commented by vivek on 9-12-2013 due to rounding issue
                     if (EITLERPGLOBAL.round(TotalQty,2) + EITLERPGLOBAL.round(ActualQty,2) > POQty) {
                    ...
                    if (!data.IsRecordExist("SELECT * FROM D_PUR_PO_HEADER WHERE PO_NO='" + PONo + "' AND SUPP_ID='" + SuppCode + "' ")) {
                        JOptionPane.showMessageDialog(this, "MIRSUPPLIER CODE AND PO SUPPLIER CODE DOES NOT MATCH.");
                        return false;
                    }
                }
            }
    ...
    private void Add() {
        ...
        if (aList.ShowList()) {
            ...
            if (chkKeep.isSelected()) {
                ...
                txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 5, FFNo, false));
    ...
    private void Edit() {
        ...
        if (ObjMIR.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (ApprovalFlow.IsCreator(5, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 512)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.Stores.frmMIRFindGen", true);
        frmMIRFindGen ObjReturn = (frmMIRFindGen) ObjLoader.getObj();
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        ObjMIR.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND MIR_NO='" + pDocNo + "' AND MIR_TYPE=1", pCompanyID);
        ObjMIR.MoveLast();
        DisplayData();
    }
    ...
    public void FindByCompany(int pCompanyID, String pDocNo) {
        ...
        ObjMIR.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND MIR_NO='" + pDocNo + "' AND MIR_TYPE=1", pCompanyID, dbURL);
        ObjMIR.MoveLast();
        DisplayData();
    }

    public void FindWaiting() {
        ObjMIR.Filter(" WHERE MIR_NO IN (SELECT D_INV_MIR_HEADER.MIR_NO FROM D_INV_MIR_HEADER,D_COM_DOC_DATA WHERE D_INV_MIR_HEADER.MIR_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_MIR_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_MIR_HEADER.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND D_COM_DOC_DATA.USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND D_COM_DOC_DATA.STATUS='W' AND D_INV_MIR_HEADER.MIR_TYPE=1 AND MODULE_ID=5)", EITLERPGLOBAL.gCompanyID);
        ObjMIR.MoveLast();
        DisplayData();
    }
    ...
    private void PreviewReport() {
        ...
        String strSQL = "SELECT * FROM (SELECT A.MIR_NO,A.MIR_DATE,B.SR_NO,A.LR_NO,A.LR_DATE,A.GATEPASS_NO,A.CHALAN_NO,"
                ...
                + "A.CHALAN_DATE,A.INVOICE_NO,A.INVOICE_DATE,A.INVOICE_AMOUNT,IF(E.MSME=1,CONCAT(A.PARTY_NAME,' (MSME Party)'),A.PARTY_NAME) AS PARTY_NAME,"
...
//        }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int r = 0; r < TableL.getRowCount(); r++) {
            ...
            if (theDeptID != 0) {
                DeptList = clsDepartment.getApproverList(EITLERPGLOBAL.gCompanyID, 5, theDeptID);
        ...
        List = ApprovalFlow.getUserList((int) EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText());
        for (int i = 1; i <= List.size(); i++) {
            clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
            ComboData aData = new ComboData();
            aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 5, txtDocNo.getText());
