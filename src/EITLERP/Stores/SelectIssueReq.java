...
public class SelectIssueReq extends javax.swing.JApplet {
    ...
    public SelectIssueReq(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn) {
        initComponents();
        setSize(500,500);
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Issue Cat");//10
        DataModel.addColumn("Cat Desc");//11
    ...
    private void GenerateGrid() {
        ...
        if(!MRNo.equals("")) {
            ...
            for(int i=1;i<=List.size();i++) {
                ...
                rowData[12]=(String) ObjItem.getAttribute("ISSUE_CAT").getObj();
                rowData[13]=(String) ObjItem.getAttribute("ISSUE_CAT_DESC").getObj();
