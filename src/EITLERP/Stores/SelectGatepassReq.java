...
public class SelectGatepassReq extends javax.swing.JApplet {
    ...
    public SelectGatepassReq(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn) {
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Select Gatepass Requistion Items from the List");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 10, 310, 15);

        jLabel2.setDisplayedMnemonic('M');
        jLabel2.setText("G.P. Req. No.");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(34, 72, 89, 20);
        ...
        txtGPRNo.setBounds(130, 72, 106, 21);
    ...
    private void txtGPRNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGPRNoKeyPressed
        ...
        if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            if(chkDept.isSelected()) {
                aList.SQL="SELECT DISTINCT(D_INV_GATEPASS_REQ_HEADER.GATEPASS_REQ_NO) AS REQ_NO,DATE_FORMAT(GATEPASS_REQ_DATE,'%d/%m/%Y') AS DATE,DEPT_DESC FROM D_INV_GATEPASS_REQ_HEADER,D_INV_GATEPASS_REQ_DETAIL,D_COM_DEPT_MASTER WHERE D_INV_GATEPASS_REQ_HEADER.COMPANY_ID=D_INV_GATEPASS_REQ_DETAIL.COMPANY_ID AND D_INV_GATEPASS_REQ_HEADER.GATEPASS_REQ_NO=D_INV_GATEPASS_REQ_DETAIL.GATEPASS_REQ_NO AND D_INV_GATEPASS_REQ_HEADER.COMPANY_ID=D_COM_DEPT_MASTER.COMPANY_ID AND D_INV_GATEPASS_REQ_HEADER.DEST_DEPT_ID=D_COM_DEPT_MASTER.DEPT_ID AND D_INV_GATEPASS_REQ_DETAIL.GATEPASS_QTY<D_INV_GATEPASS_REQ_DETAIL.QTY AND  D_INV_GATEPASS_REQ_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_INV_GATEPASS_REQ_HEADER.DEST_DEPT_ID="+SelDeptID+" AND D_INV_GATEPASS_REQ_HEADER.GATEPASS_TYPE='"+GatepassType+"' AND CANCELLED=0";
            }
            else {
                aList.SQL="SELECT DISTINCT(D_INV_GATEPASS_REQ_HEADER.GATEPASS_REQ_NO) AS REQ_NO,DATE_FORMAT(GATEPASS_REQ_DATE,'%d/%m/%Y') AS DATE,DEPT_DESC FROM D_INV_GATEPASS_REQ_HEADER,D_INV_GATEPASS_REQ_DETAIL,D_COM_DEPT_MASTER WHERE D_INV_GATEPASS_REQ_HEADER.COMPANY_ID=D_INV_GATEPASS_REQ_DETAIL.COMPANY_ID AND D_INV_GATEPASS_REQ_HEADER.GATEPASS_REQ_NO=D_INV_GATEPASS_REQ_DETAIL.GATEPASS_REQ_NO AND D_INV_GATEPASS_REQ_HEADER.COMPANY_ID=D_COM_DEPT_MASTER.COMPANY_ID AND D_INV_GATEPASS_REQ_HEADER.DEST_DEPT_ID=D_COM_DEPT_MASTER.DEPT_ID AND D_INV_GATEPASS_REQ_DETAIL.GATEPASS_QTY<D_INV_GATEPASS_REQ_DETAIL.QTY AND  D_INV_GATEPASS_REQ_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_INV_GATEPASS_REQ_HEADER.GATEPASS_TYPE='"+GatepassType+"' AND CANCELLED=0";
            }
            aList.ReturnCol=1;
    ...
    private void cmdShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowActionPerformed
        ...
        String docStatus=clsGPR.getDocStatus(EITLERPGLOBAL.gCompanyID,SelGPRNo);
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Gatepass No.");//7
    ...
    private void GenerateGrid() {
        ...
        if(!GPRNo.equals("")) {
            ...
            List=clsGPR.getGPRItemList(EITLERPGLOBAL.gCompanyID, GPRNo,false,GatepassType);
            
            for(int i=1;i<=List.size();i++) {
                clsGPRItem ObjItem=(clsGPRItem)List.get(Integer.toString(i));
                ...
                rowData[7]=(String) ObjItem.getAttribute("GATEPASS_REQ_NO").getObj();
    ...
    private void SetList() {
        ...
        clsGPR tmpObj=new clsGPR();
        ObjGPR=(clsGPR)tmpObj.getObject(EITLERPGLOBAL.gCompanyID, GPRNo);
        CopyHeader=chkCopyHeader.isSelected();
        
        List=clsGPR.getGPRItemList(EITLERPGLOBAL.gCompanyID, GPRNo, false);
    ...
    public boolean ShowList() {
        try {
            ...
            aDialog=new JDialog(f,"Select GPR Items",true);
