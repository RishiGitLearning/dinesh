...
public class frmMRFind extends javax.swing.JApplet {
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
        subQuery=" AND REQ_NO IN (SELECT REQ_NO FROM D_INV_REQ_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" "+subQuery+")";
       }
