...
public class frmRptGroupwiseStock_old2 extends javax.swing.JApplet {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    tmp = "SELECT * FROM D_INV_ITEM_CATEGORY WHERE CATEGORY_TYPE="+ItemType+" AND COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY CATEGORY_ID";
                    rsCategory=data.getResult("SELECT * FROM D_INV_ITEM_CATEGORY WHERE CATEGORY_TYPE="+ItemType+" AND COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY CATEGORY_ID");
                    ...
                    if(rsCategory.getRow()>0) {
                        while(!rsCategory.isAfterLast()) {
                            ...
                            data.Execute("UPDATE D_INV_ITEM_CATEGORY SET OPENING_VALUE="+TotalOpening+",RECEIPT_VALUE="+TotalReceipt+",ISSUE_VALUE="+TotalIssue+" WHERE CATEGORY_ID="+CategoryID+" AND COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " ");
