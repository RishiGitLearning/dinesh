...
public class frmSTMReqFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel13.setBounds(50, 140, 38, 15);
        ...
        txtItemID.setBounds(100, 140, 121, 19);

        txtItemName.setEditable(false);
        jPanel1.add(txtItemName);
        txtItemName.setBounds(100, 160, 309, 19);
    ...
    private void txtItemIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtItemIDKeyPressed
        ...
        if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            aList.SQL="SELECT ITEM_ID,ITEM_DESCRIPTION FROM D_INV_ITEM_MASTER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND ITEM_ID LIKE 'RM%' AND APPROVED=1 ORDER BY ITEM_ID";
            aList.ReturnCol=1;
    ...
    private void cmdClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdClearActionPerformed
        // TODO add your handling code here:
        strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND STM_REQ_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND STM_REQ_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ";
        Cancelled=false;
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
         strQuery=strQuery+" AND STM_REQ_NO='"+txtDocNo.getText()+"' ";
       }
       
       if(!txtDateFrom.getText().equals(""))
       {
         strQuery=strQuery+" AND STM_REQ_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
       }

       if(!txtDateTo.getText().equals(""))
       {
         strQuery=strQuery+" AND STM_REQ_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
       
       
       if(cmbForDept.getSelectedIndex()>=0)
       {
           strQuery=strQuery+" AND FOR_DEPT_ID="+EITLERPGLOBAL.getComboCode(cmbForDept)+" ";  
       }
       ...
       {
        subQuery=" AND STM_REQ_NO IN (SELECT STM_REQ_NO FROM D_INV_STM_REQ_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" "+subQuery+")";
       }
