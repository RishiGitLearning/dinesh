...
public class frmRptCostCenter5 extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel5.setText("(Enter cost center codes, seperated by comma)");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(100, 130, 290, 15);
        ...
        jLabel7.setBounds(10, 200, 410, 20);
    ...
    private void GenerateReportGen() {
        ...
        try {
            ...
            if(rsTmp.getRow()>0) {
                //Fin_FromDate=rsTmp.getString("ENTRY_DATE");
                Fin_FromDate=EITLERPGLOBAL.getFinYearStartDate(EITLERPGLOBAL.formatDateDB(txtFromDate.getText().trim()));
            }
        }
        catch(Exception e) {
            e.printStackTrace();
        ...
        if(opgBrief.isSelected()) {
            ...
            try {
                ...
                if(EITLERPGLOBAL.gCompanyID==2) //Brd
                {
                    ...
                    System.out.println("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptCostCenter5ExBrd.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+FromDate+"&ToDate="+ToDate+"&Condition="+Condition+"&FinFromDate="+Fin_FromDate);
                ...
                if(EITLERPGLOBAL.gCompanyID==3) //Ank
                {
                    ...
                    String str = "http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptCostCenter5Ex.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+FromDate+"&ToDate="+ToDate+"&Condition="+Condition+"&FinFromDate="+Fin_FromDate;
                    EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
                }
    ...
    private void GenerateReportRawSTM() {
        ...
        if(opgBrief.isSelected()) {
            ...
            try {
                ...
                URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptCostCenter5Ex_Raw_STM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+FromDate+"&ToDate="+ToDate+"&Condition="+Condition+"&FinFromDate="+Fin_FromDate);
                EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
        ...
        if(opgDetailed.isSelected()) {
            ...
            try {
                ...
                URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptCostCenter5_Raw_STM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+FromDate+"&ToDate="+ToDate+"&Condition="+Condition);
                EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
