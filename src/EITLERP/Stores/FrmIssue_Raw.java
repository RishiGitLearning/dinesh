...
public class FrmIssue_Raw extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" ISSUE (Raw Material)");
        ...
        Tab1.add(txtIssueNo);
        txtIssueNo.setBounds(110, 30, 102, 20);
        ...
        txtIssueDate.setBounds(302, 30, 92, 20);
        ...
        cmbIssueType.setBounds(110, 95, 230, 20);
        ...
        chkCanceled.setBounds(679, 32, 71, 23);
        ...
        Tab1.add(cmbDept);
        cmbDept.setBounds(110, 131, 228, 20);

        jLabel44.setText("Purpose");
        Tab1.add(jLabel44);
        jLabel44.setBounds(46, 192, 58, 20);
        ...
        Tab1.add(txtPurpose);
        txtPurpose.setBounds(110, 190, 570, 20);

        jLabel45.setText("Remarks");
        Tab1.add(jLabel45);
        jLabel45.setBounds(42, 222, 58, 20);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(110, 220, 570, 20);
        ...
        cmdNext_Header.setBounds(696, 300, 90, 23);

        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(215, 31, 38, 14);
        ...
        cmdPurposeBig.setBounds(685, 190, 37, 20);
        ...
        cmdRemarksBig.setBounds(685, 219, 37, 20);
        ...
        cmdInsertMR.setBounds(428, 8, 170, 23);
        ...
        jScrollPane1.setBounds(10, 40, 776, 222);
        ...
        cmdRemove.setBounds(696, 8, 90, 23);
        ...
        cmdNext_Detail.setBounds(700, 340, 90, 23);
        ...
        cmdPrev_Detail.setBounds(610, 340, 90, 23);

        jLabel2.setText("Press Ctrl+C to copy selected line.");
        jPanel2.add(jLabel2);
        jLabel2.setBounds(12, 268, 214, 14);
        ...
        cmdReadBarcode.setBounds(320, 270, 127, 23);
        ...
        jPanel2.add(cmdRead);
        cmdRead.setBounds(460, 270, 152, 23);
        ...
        cmdShowRequisition.setBounds(620, 270, 150, 23);
        ...
        cmbHierarchy.setBounds(96, 18, 184, 20);
        ...
        txtFromRemarks.setBounds(96, 78, 518, 20);
        ...
        jLabel36.setBounds(7, 122, 90, 14);
        ...
        jLabel33.setBounds(26, 228, 60, 14);
        ...
        cmbSendTo.setBounds(98, 228, 184, 20);
        ...
        txtToRemarks.setBounds(100, 258, 516, 20);
        ...
        jPanel3.add(cmdPrev);
        cmdPrev.setBounds(692, 298, 90, 23);
        ...
        lblDocumentHistory.setBounds(13, 178, 182, 14);
        ...
        txtAuditRemarks.setBounds(534, 316, 129, 20);

        jTabbedPane1.addTab("Status", jPanel5);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(0, 66, 800, 420);
    ...
    private void txtIssueNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIssueNoFocusLost
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (clsIssueRaw.IsIssueExist(EITLERPGLOBAL.gCompanyID, txtIssueNo.getText())) {
    ...
    private void cmdInsertMRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertMRActionPerformed
        // TODO add your handling code here:
        SelectIssueReq ObjMR = new SelectIssueReq();
        ObjMR.IssueType = 2;
        if (ObjMR.ShowList()) {
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("ISSUE (Raw Material) - " + txtIssueNo.getText());
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 15, DocNo);
            ...
            FormatGridHS();
            HashMap History = clsIssueRaw.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsIssueRaw ObjHistory = (clsIssueRaw) History.get(Integer.toString(i));
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=15");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=15");
        }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, 15, (String) ObjIssue.getAttribute("ISSUE_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, 15, (String) ObjIssue.getAttribute("ISSUE_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, 15, FromUserID, (String) ObjIssue.getAttribute("ISSUE_NO").getObj());
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=15 AND HIDDEN=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 611)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        cmdEdit.setEnabled(true);
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,612)) {
         cmdEdit.setEnabled(true);
         }
         else {
         cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 613)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 614)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        if (aList.ShowList()) {
            ...
            if (chkKeep.isSelected()) {
                ...
                txtIssueNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 15, FFNo, false));
    ...
    private void Edit() {
        ...
        if (ObjIssue.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (ApprovalFlow.IsCreator(15, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 612)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
...
//                        String responce = MailNotification.sendNotificationMail(15, pSubject, pBody, recievers, pcc, EITLERPGLOBAL.getComboCode(cmbHierarchy));
...
//                    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        List = ApprovalFlow.getUserList((int) EITLERPGLOBAL.gCompanyID, 15, txtIssueNo.getText());
        for (int i = 1; i <= List.size(); i++) {
            clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
            ComboData aData = new ComboData();
            aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 15, txtIssueNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 15, txtIssueNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 15, txtIssueNo.getText());
