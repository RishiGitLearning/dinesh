 ...
 * @author Dharmendra
 */
public class JobworkEngNotification {
...
//                    + " AND D.DEPT_ID IN (25,26)\n"                
        ...
        //String recievers = "rishineekhra@dineshmills.com";
            ...
            exprt.fillData(sql3+"#"+sql2+"#"+sql1+"#"+sql, new File("/Email_Attachment/Jobwork_Eng.xls"), "DetailUnapproved#SummaryUnApproved#DetailApproved#SummaryApproved");            
            String responce = sendNotificationMailWithAttachement("Jobwork Eng", "Jobwork Eng", recievers, pcc, "/Email_Attachment/Jobwork_Eng.xls", "Jobwork_Eng.xls");
            System.out.println("Mail Response:" + responce);
        //}
