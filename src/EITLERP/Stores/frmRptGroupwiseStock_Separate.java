/*
 * frmRptGroupwiseStock_Separate.java
 *
...
public class frmRptGroupwiseStock_Separate extends javax.swing.JApplet {
    
    private EITLComboModel cmbItemTypeModel=new EITLComboModel();
    private EITLComboModel cmbReportTypeModel=new EITLComboModel();
    
    /** Initializes the applet frmRptGroupwiseStock_Separate */
    public void init() {
        setSize(487,286);
        initComponents();
        GenerateCombo();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        chkReprocess.setBounds(10, 140, 205, 23);

        lblItem.setText(".");
        getContentPane().add(lblItem);
        lblItem.setBounds(10, 250, 347, 15);

        getContentPane().add(Bar);
        Bar.setBounds(10, 270, 200, 18);
        ...
        jPanel2.setBounds(10, 170, 340, 80);
        ...
        cmbItemType.setBounds(84, 40, 190, 24);

        jLabel7.setText("Report Type");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(5, 110, 80, 15);

        cmbReportType.setAutoscrolls(true);
        getContentPane().add(cmbReportType);
        cmbReportType.setBounds(84, 110, 190, 24);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    int ReportType=EITLERPGLOBAL.getComboCode(cmbReportType);
                    ...
                    if(rsCategory.getRow()>0) {
                        while(!rsCategory.isAfterLast()) {
                            ...
                            if(ReportType==2  || ReportType==3) {
                                //Get STM Issues
                                strSQL="SELECT ROUND(SUM(B.NET_AMOUNT),2) ";
                                strSQL+="FROM ";
    ...
    private void GenerateCombo() {
        try {
            ...
            cmbReportType.removeAll();
            cmbReportType.setModel(cmbReportTypeModel);
                                    
            objData=new ComboData();
            objData.Code=1;
            objData.Text="Without STM";
            
            cmbReportTypeModel.addElement(objData);
                ...
                try {
                    ...
                    if(rsCategory.getRow()>0) {
                        while(!rsCategory.isAfterLast()) {
                            ...
                            rsItem=data.getResult("SELECT ITEM_ID FROM D_INV_ITEM_MASTER WHERE CATEGORY_ID="+CategoryID);
                            rsItem.first();
