/*
 * clsIssueReqItemDetail.java
 *
 * Created on October 1, 2009, 10:42 AM
 */
 ...
 * @author  root
 */
public class clsIssueReqItemDetail {
    ...
    /** Creates a new instance of clsIssueReqItemDetail */
    public clsIssueReqItemDetail() {
        props=new HashMap();
        props.put("COMPANY_ID",new Variant());
        props.put("ITEM_ID", new Variant(""));
        props.put("REQ_NO", new Variant(""));
        props.put("REQ_SR_NO", new Variant(0));
