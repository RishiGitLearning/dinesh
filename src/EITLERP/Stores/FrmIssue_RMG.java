...
import java.util.*;
import EITLERP.*;
import EITLERP.FeltSales.GIDC_SDF.NRGP.clsNRGPItem_SDML;
...
public class FrmIssue_RMG extends javax.swing.JApplet { 
    ...
    private clsIssueRMG ObjIssue;  //clsIssueRaw
    ...
    public void init() {
        ...
        //TableL.setPreferredScrollableViewportSize(TableL.getPreferredSize());
    ...
    private void initComponents() {
        ...
        txtPartyCode = txtPartyCode = new JTextFieldHint(new JTextField(),"Search by F1");
        lblPartyName = new javax.swing.JLabel();
        jLabel5 = new javax.swing.JLabel();
        txttransporter = new javax.swing.JTextField();
        ...
        txtIssueNo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIssueNoActionPerformed(evt);
            }
        });
        ...
        Tab1.add(txtIssueNo);
        txtIssueNo.setBounds(110, 30, 102, 19);
        ...
        txtIssueDate.setBounds(300, 30, 92, 19);

        jLabel39.setText("Issue Type");
        Tab1.add(jLabel39);
        jLabel39.setBounds(32, 97, 68, 20);
        ...
        Tab1.add(jLabel44);
        jLabel44.setBounds(40, 170, 58, 20);
        ...
        Tab1.add(txtPurpose);
        txtPurpose.setBounds(110, 170, 570, 19);

        jLabel45.setText("Remarks");
        Tab1.add(jLabel45);
        jLabel45.setBounds(40, 200, 58, 20);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(110, 200, 570, 19);
        ...
        cmdNext_Header.setBounds(696, 300, 90, 25);
        ...
        cmdPurposeBig.setBounds(680, 170, 37, 20);
        ...
        cmdRemarksBig.setBounds(680, 200, 37, 20);
        ...
        Tab1.add(cmdChange);
        cmdChange.setBounds(130, 60, 88, 20);
        ...
        Tab1.add(jLabel1);
        jLabel1.setBounds(230, 280, 80, 20);

        txtInvoiceNo.setEnabled(false);
        txtInvoiceNo.setNextFocusableComponent(txtIssueDate);
        ...
        txtPartyCode.setBounds(110, 240, 100, 20);
        Tab1.add(lblPartyName);
        lblPartyName.setBounds(220, 230, 340, 30);

        jLabel5.setText("Transporter");
        Tab1.add(jLabel5);
        jLabel5.setBounds(10, 350, 90, 20);

        txttransporter.setEnabled(false);
        Tab1.add(txttransporter);
        txttransporter.setBounds(110, 350, 200, 20);
        Tab1.add(lblGSTIN);
        lblGSTIN.setBounds(580, 236, 180, 20);
        ...
        jScrollPane1.setBounds(10, 40, 920, 222);
        ...
        cmdNext_Detail.setBounds(700, 340, 90, 25);
        ...
        cmdPrev_Detail.setBounds(610, 340, 90, 25);
        ...
        cmdReadBarcode.setBounds(320, 270, 127, 25);
        ...
        jPanel2.add(cmdRead);
        cmdRead.setBounds(460, 270, 152, 25);
        ...
        cmdShowRequisition.setBounds(620, 270, 150, 25);
        ...
        jPanel2.add(DetailPaneLotInfo);
        DetailPaneLotInfo.setBounds(10, 290, 290, 100);
        ...
        jTabbedPane1.setBounds(0, 66, 950, 420);
    ...
    private void txtIssueNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIssueNoFocusLost
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (clsIssueRMG.IsIssueExist(EITLERPGLOBAL.gCompanyID, txtIssueNo.getText())) {
    ...
    private void cmdShowRequisitionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRequisitionActionPerformed
        ...
        try {
            ...
            if (!DocNo.trim().equals("")) {
                ...
                frmIssueReqRaw ObjDoc = (frmIssueReqRaw) aFrame.ObjApplet;
    ...
    private void TableLKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableLKeyReleased
        ...
        /* if (evt.getKeyChar() == KeyEvent.VK_TAB || evt.getKeyChar() == 10) {
         if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("SALES_VALUE")) {
    ...
    private void cmdInsertMRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertMRActionPerformed
        // TODO add your handling code here:
        SelectIssueReqRMG ObjMR = new SelectIssueReqRMG();
        ObjMR.IssueType = 2;
        if (ObjMR.ShowList()) {
            ...
            //It will contain MR Item Objects
            DoNotEvaluate = true;
            ...
            for (int i = 1; i <= ObjMR.colSelItems.size(); i++) {
                ...
                for (int lot = 1; lot <= ObjItem.colIssueReqLot.size(); lot++) {
                    clsIssueLot ObjLot = new clsIssueLot();

                    clsIssueReqItemDetail ObjReqLot = (clsIssueReqItemDetail) ObjItem.colIssueReqLot.get(Integer.toString(lot));
                    ObjLot.setAttribute("COMPANY_ID", ObjReqLot.getAttribute("COMPANY_ID").getInt());
                    ObjLot.setAttribute("ISSUE_NO", txtIssueNo.getText().trim());
                    ObjLot.setAttribute("ISSUE_SR_NO", i);
                    ObjLot.setAttribute("SR_NO", ObjReqLot.getAttribute("SR_NO").getInt());
                    ObjLot.setAttribute("ITEM_ID", ObjReqLot.getAttribute("ITEM_ID").getInt());
                    ObjLot.setAttribute("ITEM_LOT_NO", ObjReqLot.getAttribute("ITEM_LOT_NO").getString());
                    ObjLot.setAttribute("AUTO_LOT_NO", ObjReqLot.getAttribute("AUTO_LOT_NO").getString());
                    ObjLot.setAttribute("ISSUED_LOT_QTY", ObjReqLot.getAttribute("ISSUED_LOT_QTY").getDouble());
                ...
                DataModelL.setValueByVariable("COST_CENTER_ID", Integer.toString(ObjItem.getAttribute("COST_CENTER_CODE").getInt()), NewRow);
                String lCCName = clsCostCenter.getCostCenterName(EITLERPGLOBAL.gCompanyID, ObjItem.getAttribute("COST_CENTER_CODE").getInt());
                DataModelL.setValueByVariable("COST_CENTER_NAME", lCCName, NewRow);

                DataModelL.setValueByVariable("DEPT_ID", Integer.toString(ObjItem.getAttribute("DEPT_ID").getInt()), NewRow);
                String lDeptName = clsDepartment.getDeptName(EITLERPGLOBAL.gCompanyID, ObjItem.getAttribute("DEPT_ID").getInt());
                DataModelL.setValueByVariable("DEPT_NAME", lDeptName, NewRow);
                ...
                DataModelL.setValueByVariable("QTY_REQD", Double.toString(EITLERPGLOBAL.round(ObjItem.getAttribute("REQ_QTY").getVal(), 3)), NewRow);
    ...
    private void TableLKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableLKeyPressed
        ...
        if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("QTY")) {
            ...
            {
                EnterIssueLotQty ObjLot = new EnterIssueLotQty();
                ObjLot.lIssueNo = txtIssueNo.getText().trim();
                ObjLot.lIssueSrNo = TableL.getSelectedRow() + 1;
                ObjLot.lItemID = DataModelL.getValueByVariable("ITEM_CODE", TableL.getSelectedRow());
                if (EditMode == 0) {
                ...
                ObjLot.ItemID = DataModelL.getValueByVariable("ITEM_CODE", TableL.getSelectedRow());
                ...
                if (ObjLot.ShowList()) //Ok Pressed
                {
                    ...
                    for (int i = 0; i < ObjLot.colLot.size(); i++) {
                        clsIssueLot ObjItemLot = (clsIssueLot) ObjLot.colLot.get(Integer.toString(i + 1));
                        ...
                        if (QtyReqd < QtyIssue) {
                            ...
                            DataModelL.setValueByVariable("ISSUE_VALUE", "0.0", TableL.getSelectedRow());
                            return;
                        }
                    }
                    // PUT VALIDATION END
                    ...
                    for (int i = 1; i <= ObjLot.colLot.size(); i++) {
                        clsIssueLot ObjItemLot = (clsIssueLot) ObjLot.colLot.get(Integer.toString(i));
        ...
        if (EditMode != 0) {
         ...
         /*   
             ...
             //if (evt.getKeyChar() == KeyEvent.VK_TAB || evt.getKeyChar() == 10) {
             if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("SALES_RATE")) {
             ...
             //}
             if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("DISCOUNT")) {
             ...
             if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("CGST_RATE")) {
             ...
             if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("SGST_RATE")) {
             ...
             if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("IGST_RATE")) {
             ...
             */
            /*if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("TOTAL")) {
             SalesRate= Double.parseDouble(DataModelL.getValueByVariable("SALES_RATE", TableL.getSelectedRow()));
             Qty=Double.parseDouble(DataModelL.getValueByVariable("QTY", TableL.getSelectedRow())); 
             Discount= Double.parseDouble(DataModelL.getValueByVariable("DISCOUNT", TableL.getSelectedRow()));
             IGSTRate= Double.parseDouble(DataModelL.getValueByVariable("IGST_RATE", TableL.getSelectedRow())); 
            ...
            if (EditMode == 0) {
                if (!DataModelL.getUserObject(TableL.getSelectedRow()).equals("")) {
                    ...
                    for (int l = 1; l <= lcolLot.size(); l++) {
                        ...
                        DataModelLot.setValueByVariable("ISSUE_RATE", Double.toString(ObjList.getAttribute("ISSUE_RATE").getDouble()), NewRow);
    ...
    private void txtPartyCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPartyCodeFocusLost
        ...
        } else if (data.getStringValueFromDB("SELECT PARTY_CODE FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE MAIN_ACCOUNT_CODE='210034' AND PARTY_CODE='" + txtPartyCode.getText() + "'").equalsIgnoreCase("")) {
    ...
    private void txtIssueNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIssueNoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtIssueNoActionPerformed
    ...
    private javax.swing.JTextField txttransporter;
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("ISSUE (RMG) Sales - " + txtIssueNo.getText());
            ...
            lblPartyName.setText(clsSales_Party.getPartyName(EITLERPGLOBAL.gCompanyID, txtPartyCode.getText()));
            txttransporter.setText((String) ObjIssue.getAttribute("TRANSPORTER_NAME").getObj());
            txtInvoiceNo.setText((String) ObjIssue.getAttribute("INVOICE_NO").getObj());
            txtInvoiceDate.setText(EITLERPGLOBAL.formatDate((String) ObjIssue.getAttribute("INVOICE_DATE").getObj()));
            txtInvoiceAmount.setText(Double.toString(ObjIssue.getAttribute("INVOICE_VALUE").getVal()));
            ...
            for (int i = 1; i <= ObjIssue.colLineItems.size(); i++) {
                ...
                DataModelL.setValueByVariable("LOT_NO", (String) ObjItem.getAttribute("LOT_NO").getObj(), NewRow);
                DataModelL.setValueByVariable("MFG_PROG_NO", (String) ObjItem.getAttribute("MFG_PROG_NO").getObj(), NewRow);
                DataModelL.setValueByVariable("LF_NO", (String) ObjItem.getAttribute("LF_NO").getObj(), NewRow);
                DataModelL.setValueByVariable("BLEND_CODE", (String) ObjItem.getAttribute("BLEND_CODE").getObj(), NewRow);
                DataModelL.setValueByVariable("MATERIAL_CODE_NO", (String) ObjItem.getAttribute("MATERIAL_CODE_NO").getObj(), NewRow);
                ...
                if (Cancelled == 0) {
                    ...
                    DataModelL.setValueByVariable("STOCK_QTY", Double.toString(EITLERPGLOBAL.round((OnHandStock), 3)), NewRow);
                    DataModelL.setValueByVariable("BAL_STOCK_QTY", Double.toString(EITLERPGLOBAL.round((BalQty), 3)), NewRow);
                }
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 112, DocNo); //15
            ...
            FormatGridHS();
            HashMap History = clsIssueRMG.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsIssueRMG ObjHistory = (clsIssueRMG) History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        ObjIssue.setAttribute("TRANSPORTER_NAME", txttransporter.getText());
        ObjIssue.setAttribute("PARTY_CODE", txtPartyCode.getText());

        ObjIssue.setAttribute("INVOICE_NO", txtInvoiceNo.getText());
        ObjIssue.setAttribute("INVOICE_DATE", EITLERPGLOBAL.formatDateDB(txtInvoiceDate.getText()));

        UpdateInvoiceAmount();
        ObjIssue.setAttribute("INVOICE_VALUE", Double.parseDouble(txtInvoiceAmount.getText()));
        ...
        for (int i = 0; i < TableL.getRowCount(); i++) {
            ...
            ObjIssueItem.setAttribute("BOE_SRNO", DataModelL.getValueByVariable("BOE_SR_NO", i));
            ...
            ObjIssueItem.setAttribute("LOT_NO", "X");
            ObjIssueItem.setAttribute("MFG_PROG_NO", DataModelL.getValueByVariable("MFG_PROG_NO", i));
            ObjIssueItem.setAttribute("LF_NO", DataModelL.getValueByVariable("LF_NO", i));
            ObjIssueItem.setAttribute("BLEND_CODE", DataModelL.getValueByVariable("BLEND_CODE", i));
            ObjIssueItem.setAttribute("MATERIAL_CODE_NO", DataModelL.getValueByVariable("MATERIAL_CODE_NO", i));
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=112"); //15

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=112"); //15
        }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, 112, (String) ObjIssue.getAttribute("ISSUE_NO").getObj());//112
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, 112, (String) ObjIssue.getAttribute("ISSUE_NO").getObj());//15
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, 112, FromUserID, (String) ObjIssue.getAttribute("ISSUE_NO").getObj());//15
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=112 AND HIDDEN=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");//15
                ...
                public void tableChanged(TableModelEvent e) {
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        /* 
                         ...
                         System.out.println(Qty);
                         double SalesValue=SalesRate*Qty;
                         double TaxableValue=SalesValue-Discount;                        
                         double Total=TaxableValue+CGSTAmt+SGSTAmt+IGSTAmt;
                         DataModelL.setValueByVariable("SALES_VALUE", Double.toString(SalesValue), TableL.getSelectedRow());                               
                         DataModelL.setValueByVariable("TAXABLE_VALUE", Double.toString(TaxableValue), TableL.getSelectedRow());                               
                         DataModelL.setValueByVariable("TOTAL",Double.toString(Total),TableL.getSelectedRow());
                         }
    ...
    private void FormatGridLotDetail() {
        try {
            ...
            DataModelLot.addColumn("Issue Rate");
            ...
            DataModelLot.SetVariable(4, "ISSUE_RATE");
    ...
    private void SetFields(boolean pStat) {
        ...
        txtInvoiceDate.setEnabled(false);
        txtInvoiceAmount.setEnabled(false);
        txttransporter.setEnabled(pStat);
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 112, 12721)) {//611
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
//        cmdEdit.setEnabled(true);
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 112,12722)) {  //612
         cmdEdit.setEnabled(true);
         }
         else {
         cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 112, 12723)) {//613
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 112, 12725)) {//614
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        if (aList.ShowList()) {
            ...
            if (chkKeep.isSelected()) {
                ...
                txtIssueNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 112, FFNo, false));
    ...
    private void Edit() {
        ...
        if (ObjIssue.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (ApprovalFlow.IsCreator(112, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 1272, 12722)) {   //15
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjIssue.Insert(SelPrefix, SelNo)) {
                FindEx(EITLERPGLOBAL.gCompanyID, txtIssueNo.getText());
                if (OpgFinal.isSelected()) {
...
//                                if (TableL.getValueAt(i, 4).toString().equalsIgnoreCase("8888")) {
...
//                                    ObjNRGP.setAttribute("GATEPASS_ISSUE_NO", DOC_NO);
//                                    ObjNRGP.setAttribute("GATEPASS_ISSUE_SR_NO", ((String) TableL.getValueAt(i, 0)).trim());
//                                    ObjNRGP.setAttribute("GATEPASS_DATE", EITLERPGLOBAL.getCurrentDateDB());
//                                    ObjNRGP.setAttribute("REMARKS", "");
//                                    ObjNRGP.setAttribute("NET_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(((String) TableL.getValueAt(i, 24)).trim()), 2));
//                                    ObjNRGP.setAttribute("GATEPASS_TYPE", "BS");
...
//                                    ObjNRGP.setAttribute("ADD1", "Makarpura,GIDC,");
...
//                                    ObjNRGP.setAttribute("GROSS_WEIGHT", ((String) TableL.getValueAt(i, 13)).trim());
//
//                                    //----- Update Approval Specific Fields -----------//
//                                    ObjNRGP.setAttribute("HIERARCHY_ID", 3727);
...
//
//                                    ObjNRGPItem.setAttribute("GATEPASS_ISSUE_NO", DOC_NO);
//                                    ObjNRGPItem.setAttribute("GATEPASS_ISSUE_SR_NO", TableL.getValueAt(i, 0).toString().trim());
//                                    ObjNRGPItem.setAttribute("ITEM_CODE", ((String) TableL.getValueAt(i, 1)).trim());
//                                    ObjNRGPItem.setAttribute("NRGP_DESC", ((String) TableL.getValueAt(i, 2)).trim());
//                                    ObjNRGPItem.setAttribute("QTY", EITLERPGLOBAL.round(Double.parseDouble(TableL.getValueAt(i, 13).toString().trim()), 2));
//                                    ObjNRGPItem.setAttribute("RATE", EITLERPGLOBAL.round(Double.parseDouble(((String) TableL.getValueAt(i, 23)).trim()), 2));
//                                    ObjNRGPItem.setAttribute("NET_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(((String) TableL.getValueAt(i, 24)).trim()), 2));
...
//                    String msg = data.getStringValueFromDB("SELECT GROUP_CONCAT(GATEPASS_NO ORDER BY GATEPASS_ISSUE_NO SEPARATOR ' , ') AS NGATEPASS  FROM PRODUCTION.GIDC_FELT_NRGP WHERE GATEPASS_ISSUE_NO='" + DOC_NO + "'");
//                    if (msg.trim().length() > 0) {
//                        String pSubject, pBody, recievers, pcc;
//                        pSubject = "Non-Returnable Gatepass Genereted";
//                        pBody = "Non-Returnable Gatepass : " + msg + " has been Generated...";
//                        pBody = pBody + "<br><br><br>**** This is an auto-generated email, please do not reply ****<br><br>";
//                        recievers = "brdfltfin@dineshmills.com";
//                        pcc = "yrpatel@dineshmills.com,amitkanti@dineshmills.com,feltpp@dineshmills.com,sdmlerp@dineshmills.com";
//                        String responce = MailNotification.sendNotificationMail(112, pSubject, pBody, recievers, pcc, EITLERPGLOBAL.getComboCode(cmbHierarchy)); //15
//                        System.out.println("Send Mail Responce : " + responce);
//                        JOptionPane.showMessageDialog(null, "Non-Returnable Gatepass : " + msg + " has been Generated...");
//                    }
                }
                MoveLast();
                DisplayData();
...
//                    }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.Stores.frmIssueRawFind", true);
        frmIssueRawFind ObjReturn = (frmIssueRawFind) ObjLoader.getObj();
        ...
        if (ObjReturn.Cancelled == false) {
            ...
            if (!ObjReturn.strQuery.trim().equals("")) {
                ...
                ObjReturn.strQuery = " WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND ISSUE_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND ISSUE_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' AND ISSUE_TYPE = 'MAT' ";
            }
    ...
    private boolean Validate() {
        ...
        /*double ItemRate = 0;
         ...
         //JOptionPane.showMessageDialog(null,"Required Quantity less then Issued Quantity.--> " + ItemID + "REQ NO : " + ReqNo);
         }
         if(TotalValue<=0) {
         int Conform = JOptionPane.showConfirmDialog(null,"Total Value for the Item:" + DataModelL.getValueByVariable("ITEM_CODE",i) + " is Zero \n" + " Do You want To continue...","Message..",JOptionPane.YES_NO_OPTION);
        ...
        for (int i = 0; i < TableL.getRowCount(); i++) {
            ...
            //clsIssueGenItem ObjIssueItem=new clsIssueGenItem();
            String ItemID = DataModelL.getValueByVariable("ITEM_CODE", i);
            //double Qty = Double.parseDouble(DataModelL.getValueByVariable("QTY",i));

            HashMap lcolLot = (HashMap) DataModelL.getUserObject(i);
            for (int j = 1; j <= lcolLot.size(); j++) {
                clsIssueLot ObjList = (clsIssueLot) lcolLot.get(Integer.toString(j));
                String AutoLotNo = ObjList.getAttribute("AUTO_LOT_NO").getString();
                double LotQty = ObjList.getAttribute("ISSUED_LOT_QTY").getDouble();

                double TotalIssueLotQty = 0;
                for (int k = i + 1; k < TableL.getRowCount(); k++) {

                    String ItemIDInner = DataModelL.getValueByVariable("ITEM_CODE", k);

                    if (ItemID.equals(ItemIDInner)) {

                        HashMap lcolLotInner = (HashMap) DataModelL.getUserObject(k);

                        for (int l = 1; l <= lcolLotInner.size(); l++) {
                            clsIssueLot ObjListInner = (clsIssueLot) lcolLotInner.get(Integer.toString(l));
                            String AutoLotNoInner = ObjListInner.getAttribute("AUTO_LOT_NO").getString();
                            double LotQtyInner = ObjListInner.getAttribute("ISSUED_LOT_QTY").getDouble();

                            if (AutoLotNo.equals(AutoLotNoInner)) {
                                TotalIssueLotQty += LotQtyInner;
                            }
                        }
                ...
                double BalanceQty = clsTempLot.getLOTActualBalanceQTYItemWise(AutoLotNo, ItemID);
                if (TotalIssueLotQty + LotQty > BalanceQty) {
                    JOptionPane.showMessageDialog(null, "Total Qty of the Item : " + ItemID + " and Lot No: " + AutoLotNo + " Is :" + BalanceQty + "\n" + " and you are trying to Issue Qty: " + (TotalIssueLotQty + LotQty));
                    return false;
                }
        ...
        for (int i = 0; i < TableL.getRowCount(); i++) {
            ...
            if (OpgFinal.isSelected()) {
                ...
                if (mval <= 0.0 && !txtIssueNo.getText().startsWith("RMG")) {
            ...
            if (IssuedQty == 0) {
                JOptionPane.showMessageDialog(null, "Issued Qty should not zero. " + ItemID);
                return false;
            }
            ...
            //ReqdQty = ReqdQty - EITLERPGLOBAL.round(data.getDoubleValueFromDB("SELECT QTY FROM D_INV_ISSUE_DETAIL WHERE REQ_NO='"+ReqNo+"' AND REQ_SRNO="+ReqSrNo),1);
            ReqdQty -= EITLERPGLOBAL.round(data.getDoubleValueFromDB("SELECT B.QTY FROM D_INV_ISSUE_HEADER A,D_INV_ISSUE_DETAIL B WHERE A.ISSUE_NO=B.ISSUE_NO AND A.COMPANY_ID=B.COMPANY_ID AND A.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND B.REQ_NO='" + ReqNo + "' AND B.REQ_SRNO=" + ReqSrNo + " AND A.ISSUE_NO<>'" + txtIssueNo.getText().trim() + "' AND A.CANCELED=0"), 1);////add on 28/08/2009
                ...
                if (OnHand >= IssuedQty) {
                    ...
                    if (ReqdQty > IssuedQty) {
                        if (OnHand > ReqdQty) {
                            ...
                            JOptionPane.showMessageDialog(null, "On Hand Quantity already exists as much as Required Quantity.--> " + ItemID + "REQ NO : " + ReqNo);
                            return false;
                        }
                    ...
                    JOptionPane.showMessageDialog(null, "On Hand quantity is less then Issued quantity.--> " + ItemID + "REQ NO : " + ReqNo);
                    return false;
                }
            } else {
                JOptionPane.showMessageDialog(null, "On Hand Stock Not Available.--> " + ItemID + "REQ NO : " + ReqNo);
                return false;
            }
        }
        ...
        if (txttransporter.getText().trim().equals("")) {
        ...
        /*for(int i=0;i<=TableL.getRowCount()-1;i++) {
         ...
         if(DataModelL.getNumeric(c)) {
         String theVal=(String)TableL.getValueAt(i,c);
         if(EITLERPGLOBAL.IsNumber(theVal)) {
         if(Double.parseDouble((String)TableL.getValueAt(i,c))<0) {
         JOptionPane.showMessageDialog(null," Negative values found in Table. Please verify the input");
         return false;
         }
         }
         }
...
//
//        try {
//            URL ReportFile = new URL("http://" + EITLERPGLOBAL.HostIP + "/EITLERP/Reports/rptIssueRaw.jsp?dbURL=" + EITLERPGLOBAL.DatabaseURL + "&CompanyID=" + EITLERPGLOBAL.gCompanyID + "&DocNo=" + txtIssueNo.getText());
...
//                parameterMap.put("CONTEXT","http://200.0.0.230:8080/SDMLERP/");
                ...
                String strSQL = "SELECT *,@A:=@A+1 AS 'SR_NO' FROM (SELECT @A:= 0) AS A,(SELECT H.ISSUE_NO,H.ISSUE_DATE,H.INVOICE_NO,H.INVOICE_DATE,H.INVOICE_VALUE,H.INVOICE_VALUE_IN_WORDS,H.PARTY_CODE,H.TRANSPORTER_NAME,D.ITEM_CODE,D.HSN,D.SALES_QTY,D.UNIT,D.SALES_RATE,D.SALES_VALUE,D.DISCOUNT,D.TAXABLE_VALUE,D.CGST_RATE,D.CGST_AMT,D.SGST_RATE,D.SGST_AMT,D.IGST_RATE,D.IGST_AMT FROM DINESHMILLS.D_INV_ISSUE_HEADER H, DINESHMILLS.D_INV_ISSUE_DETAIL D WHERE H.COMPANY_ID=D.COMPANY_ID AND D.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND H.ISSUE_NO=D.ISSUE_NO AND H.APPROVED=1 AND H.CANCELED=0 AND H.ISSUE_NO='" + txtIssueNo.getText().trim() + "' AND H.ISSUE_DATE='" + EITLERPGLOBAL.formatDateDB(txtIssueDate.getText().trim()) + "') AS ISS LEFT JOIN (SELECT PARTY_CODE,PARTY_NAME,ADDRESS1,ADDRESS2,PINCODE,STATE,STATE_GST_CODE,GSTIN_NO FROM DINESHMILLS.D_SAL_PARTY_MASTER) AS PM ON ISS.PARTY_CODE=PM.PARTY_CODE LEFT JOIN (SELECT ITEM_ID,ITEM_DESCRIPTION FROM DINESHMILLS.D_INV_ITEM_MASTER WHERE CANCELLED=0) AS IM ON ISS.ITEM_CODE=IM.ITEM_ID LEFT JOIN (SELECT PARA_CODE,`DESC` AS UNIT_NAME FROM DINESHMILLS.D_COM_PARAMETER_MAST WHERE PARA_ID='UNIT') AS PA ON PA.PARA_CODE=ISS.UNIT ";
    ...
    private void PreviewAuditReport() {
        try {
            URL ReportFile = new URL("http://" + EITLERPGLOBAL.HostIP + "/EITLERP/Reports/rptISSUE2A.jsp?dbURL=" + EITLERPGLOBAL.DatabaseURL + "&CompanyID=" + EITLERPGLOBAL.gCompanyID + "&DocNo=" + txtIssueNo.getText() + "&DocType=G");
            EITLERPGLOBAL.loginContext.showDocument(ReportFile, "_blank");
        } catch (Exception e) {
    ...
    private void GenerateRejectedUserCombo() {
        ...
        List = ApprovalFlow.getUserList((int) EITLERPGLOBAL.gCompanyID, 112, txtIssueNo.getText()); //15
        for (int i = 1; i <= List.size(); i++) {
            clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
            ComboData aData = new ComboData();
            aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 112, txtIssueNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);  //15
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 112, txtIssueNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID); //15
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 112, txtIssueNo.getText());  //15
    ...
    private void UpdateInvoiceAmount() {
        ...
        try {
            ...
            txtInvoiceAmount.setText(Double.toString(NetAmount));
...
//                    }
                    //objVoucher.setAttribute("BOOK_CODE", "02");
                    SalesAccountCode = "315027";
                    ...
                    objVoucher.setAttribute("MODULE_ID", clsIssueRMG.ModuleId);
                    objVoucher.setAttribute("REMARKS", "");

                    objVoucher.setAttribute("HIERARCHY_ID", 3794);
                    int FirstUserID = data.getIntValueFromDB("SELECT USER_ID FROM D_COM_HIERARCHY_RIGHTS WHERE HIERARCHY_ID=3794 AND SR_NO=1");
                    ...
                    if (NetAmount > 0) {
                        ...
                        objVoucherItem.setAttribute("MODULE_ID", clsIssueRMG.ModuleId);
