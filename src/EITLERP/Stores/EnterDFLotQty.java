 ...
 * EnterDFLotQty.java
 *
 * Created on June 10 2004, 2:17 PM
 */
...
public class EnterDFLotQty extends javax.swing.JApplet {
    ...
    public String DecID="";
    public int DecSrNo=0;
    
    /** Creates new form frmTemplate */
    public EnterDFLotQty() {
        System.gc();
        initComponents();
        GenerateGrid();      
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmdRead.setBounds(197, 279, 152, 25);
...
private boolean Validate()
{
   ...
   if(Table.getRowCount()<=0) 
   {
      JOptionPane.showMessageDialog(null,"Please enter at least one lot no. and qty. \n If you don't want to enter lot no. Use default lot no. 'X'");
      return false; 
   }
...
private void GenerateGrid()    
{
   ...
   {
     clsDeclarationFormItemDetail ObjLot=(clsDeclarationFormItemDetail)colLot.get(Integer.toString(i));
     Object[] rowData=new Object[3];
...
private void SetLot()
{
   ...
   for(int i=0;i<Table.getRowCount();i++) 
   {
     ...
     ObjLot.setAttribute("DECLARATION_ID",DecID);
     ObjLot.setAttribute("SR_NO",DecSrNo);
     ObjLot.setAttribute("SRNO",i);
     ObjLot.setAttribute("LOT_NO",LotNo);
     ObjLot.setAttribute("LOT_QTY",LotQty);
...
public boolean ShowList() {
       try {
           GenerateGrid();
            ...
            aDialog=new JDialog(f,"Select DF Items",true);
