...
public class clsMaterialRequisition {
    ...
    public clsMaterialRequisition() {
        ...
        props.put("TESTING_FLAG",new Variant(0));
        props.put("TESTING_DAYS",new Variant(""));
        props.put("TESTING_REASON",new Variant(""));
    ...
    public boolean Insert() {
        ...
        try {
            ...
            rsResultSet.updateLong("TESTING_FLAG",(long) getAttribute("TESTING_FLAG").getVal());
           // rsResultSet.updateLong("TESTING_DAYS",(long) getAttribute("TESTING_DAYS").getVal());
            rsResultSet.updateString("TESTING_DAYS",(String)getAttribute("TESTING_DAYS").getObj());
            rsResultSet.updateString("TESTING_REASON",(String)getAttribute("TESTING_REASON").getObj());
            ...
            rsHistory.updateLong("TESTING_FLAG",(long) getAttribute("TESTING_FLAG").getVal());
            //rsHistory.updateLong("TESTING_DAYS",(long) getAttribute("TESTING_DAYS").getVal());
            rsHistory.updateString("TESTING_DAYS",(String)getAttribute("TESTING_DAYS").getObj());
            rsHistory.updateString("TESTING_REASON",(String)getAttribute("TESTING_REASON").getObj());
    ...
    public static HashMap getList(String pCondition) {
        ...
        try {
            ...
            while(rsTmp.next()) {
                ...
                ObjMaterialRequisition.setAttribute("TESTING_FLAG",rsTmp.getInt("TESTING_FLAG"));
           //     ObjMaterialRequisition.setAttribute("TESTING_DAYS",rsTmp.getInt("TESTING_DAYS"));
                ObjMaterialRequisition.setAttribute("TESTING_DAYS",rsTmp.getString("TESTING_DAYS"));
                ObjMaterialRequisition.setAttribute("TESTING_REASON",rsTmp.getString("TESTING_REASON"));
                ...
                while(rsTmp2.next()) {
                    ...
                    ObjMRItems.setAttribute("REQ_QTY",EITLERPGLOBAL.round(rsTmp2.getFloat("REQ_QTY"),3));
                    ObjMRItems.setAttribute("INDENT_QTY",EITLERPGLOBAL.round(rsTmp2.getFloat("INDENT_QTY"),3));
                    ObjMRItems.setAttribute("BAL_QTY",EITLERPGLOBAL.round(rsTmp2.getFloat("BAL_QTY"),3));
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("TESTING_FLAG",rsResultSet.getInt("TESTING_FLAG"));
          //  setAttribute("TESTING_DAYS",rsResultSet.getInt("TESTING_DAYS"));
            setAttribute("TESTING_DAYS",rsResultSet.getString("TESTING_DAYS"));
            setAttribute("TESTING_REASON",rsResultSet.getString("TESTING_REASON"));
            ...
            while(!rsTmp.isAfterLast() && rsTmp.getRow()>0) {
                ...
                ObjMRItems.setAttribute("REQ_QTY",EITLERPGLOBAL.round(rsTmp.getFloat("REQ_QTY"),3));
                ObjMRItems.setAttribute("ALLOCATED_QTY",EITLERPGLOBAL.round(rsTmp.getFloat("ALLOCATED_QTY"),3));
                ObjMRItems.setAttribute("INDENT_QTY",EITLERPGLOBAL.round(rsTmp.getFloat("INDENT_QTY"),3));
                ObjMRItems.setAttribute("BAL_QTY",EITLERPGLOBAL.round(rsTmp.getFloat("BAL_QTY"),3));
    ...
    public static HashMap getMRItemList(int pCompanyID,String pMRNo,boolean pAllData) {
        ...
        try {
            ...
            while(! rsTmp2.isAfterLast()) {
                ...
                ObjMRItems.setAttribute("REQ_QTY",EITLERPGLOBAL.round(rsTmp2.getFloat("REQ_QTY"),3));
                ObjMRItems.setAttribute("ALLOCATED_QTY",EITLERPGLOBAL.round(rsTmp2.getFloat("ALLOCATED_QTY"),3));
                ...
                ObjMRItems.setAttribute("INDENT_QTY",EITLERPGLOBAL.round(IndentQty,3));
                
                ObjMRItems.setAttribute("BAL_QTY",EITLERPGLOBAL.round(rsTmp2.getDouble("REQ_QTY"),3)-EITLERPGLOBAL.round(IndentQty,3));
                ObjMRItems.setAttribute("UNIT",rsTmp2.getLong("UNIT"));
                ObjMRItems.setAttribute("REMARKS",rsTmp2.getString("REMARKS"));
                ObjMRItems.setAttribute("REQUIRED_DATE",rsTmp2.getString("REQUIRED_DATE"));
    ...
    public static String getItemDesc(int pCompanyID,String pDocNo,String Item_Id,String SrNo) {
        ...
        try {
            //First check that Document exist
            String str = "SELECT ITEM_EXTRA_DESC FROM D_INV_REQ_DETAIL WHERE COMPANY_ID="+pCompanyID+" AND REQ_NO='"+pDocNo+"' AND ITEM_CODE='"+Item_Id+"' AND SR_NO='"+SrNo+"' ";
