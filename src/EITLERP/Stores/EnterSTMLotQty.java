...
public class EnterSTMLotQty extends javax.swing.JApplet {
    ...
    public String STMNo="";
    public int STMSrNo=0;
    
//    public String ItemID="";
//    public String BOENo="";
//    public String WareHouseID="";
//    public String LocationID="";
    public String lSTMNo="";
    public int lSTMSrNo=0;
    public String lItemID="";
    public boolean Editdata=true;
    
    public EnterSTMLotQty() {
        System.gc();
        initComponents();
    }
        ...
        if(Editdata) {
            ...
            if(Table.getSelectedColumn()==DataModel.getColFromVariable("ITEM_LOT_NO")) {
                if(evt.getKeyCode()==112) {//F1 Key pressed
                    ...
                    LOV aList=new LOV();
                    aList.SQL="SELECT ITEM_LOT_NO AS BATCH_NO, AUTO_LOT_NO AS RECEIPT_NO, BALANCE_QTY FROM D_INV_TEMP_LOT WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND ITEM_ID='"+lItemID+"' ORDER BY AUTO_LOT_NO"; 
                    aList.ReturnCol=1;
                    aList.SecondCol=2;
    ...
    private void GenerateGrid() {
        ...
        for(int i=1;i<=colLot.size();i++) {
            clsSTMLot ObjLot=(clsSTMLot)colLot.get(Integer.toString(i));
            Object[] rowData=new Object[4];
    ...
    private void SetLot() {
        ...
        for(int i=0;i<Table.getRowCount();i++) {
            ...
            ObjLot.setAttribute("STM_NO",lSTMNo);
            ObjLot.setAttribute("STM_SR_NO",lSTMSrNo);
    ...
    public boolean ShowList() {
        try {
            ...
            aDialog=new JDialog(f,"STM Lot Entry",true);
