 ...
 */
/*<APPLET CODE=FrmIssue_General280809.class HEIGHT=500 WIDTH=800*/
...
public class FrmIssue_General280809 extends javax.swing.JApplet {
    
    private int EditMode=0;
    private EITLTableModel DataModelL;
    private EITLTableCellRenderer Renderer=new EITLTableCellRenderer();
    
    private clsIssue ObjIssue;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText(" ISSUE (General)");
    ...
    private void txtIssueNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIssueNoFocusLost
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            if(clsIssue.IsIssueExist(EITLERPGLOBAL.gCompanyID,txtIssueNo.getText())) {
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("ISSUE (General) - "+txtIssueNo.getText());
            ...
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 14, DocNo);
            ...
            FormatGridHS();
            HashMap History=clsIssue.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for(int i=1;i<=History.size();i++) {
                clsIssue ObjHistory=(clsIssue)History.get(Integer.toString(i));
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=14");
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=14");
        }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, 14,(String)ObjIssue.getAttribute("ISSUE_NO").getObj());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, 14,(String)ObjIssue.getAttribute("ISSUE_NO").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,14,FromUserID,(String)ObjIssue.getAttribute("ISSUE_NO").getObj());
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=14 AND HIDDEN=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,601)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Edit Rights --
        cmdEdit.setEnabled(true);
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,602)) {
            cmdEdit.setEnabled(true);
        }
        else {
            cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,603)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,604)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
        ...
        if(aList.ShowList()) {
            ...
            if(chkKeep.isSelected()) {
                ...
                txtIssueNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 14, FFNo,  false));
    ...
    private void Edit(){
        ...
        if(ObjIssue.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(14,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,602)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private boolean Validate() {
        ...
        for(int i=0;i<TableL.getRowCount();i++) {
            ...
            double IssuedQty = EITLERPGLOBAL.round(Double.parseDouble(DataModelL.getValueByVariable("QTY", i)),1);
            ...
            double ReqdQty = EITLERPGLOBAL.round(data.getDoubleValueFromDB("SELECT REQ_QTY FROM D_INV_ISSUE_REQ_DETAIL WHERE REQ_NO='"+ReqNo+"' AND SR_NO="+ReqSrNo),1);
            ...
            double OnHand=EITLERPGLOBAL.round(objStock.StockQty,1);
    ...
    private void GenerateRejectedUserCombo() {
        ...
        List=ApprovalFlow.getUserList((int)EITLERPGLOBAL.gCompanyID,14,txtIssueNo.getText());
        for(int i=1;i<=List.size();i++) {
            clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
            ComboData aData=new ComboData();
            aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 14, txtIssueNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 14, txtIssueNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 14, txtIssueNo.getText());
