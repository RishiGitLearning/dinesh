 ...
 *
 */
public class frmJobwork extends javax.swing.JApplet {
    ...
    private EITLTableModel DataModelHSNJOBPJV;
    ...
    public void init() {
        ...
        if(getName().equals("Link")) {
            ...
            if(ObjJOB.LoadData(EITLERPGLOBAL.gCompanyID)) {
                ObjJOB.MoveLast();
                DisplayData();
            }
            else {
                JOptionPane.showMessageDialog(null,"Error occured while loading data. Error is "+ObjJOB.LastError);
            }
        }
    ...
    private void initComponents() {
        ...
        TableHSNJOBPJV = new javax.swing.JTable();
        ...
        lblTitle.setText(" JOB WORK ENTRY");
        ...
        txtSuppCode.setBounds(114, 92, 62, 19);

        txtSuppName.setEnabled(false);
        Tab1.add(txtSuppName);
        txtSuppName.setBounds(178, 92, 212, 19);

        jLabel5.setText("Chalan No.");
        Tab1.add(jLabel5);
        jLabel5.setBounds(40, 132, 68, 15);
        ...
        txtChalanNo.setBounds(114, 128, 114, 19);

        jLabel6.setText("Date");
        Tab1.add(jLabel6);
        jLabel6.setBounds(254, 132, 34, 15);
        ...
        txtChalanDate.setBounds(290, 130, 100, 19);

        jLabel7.setText("L.R. No.");
        Tab1.add(jLabel7);
        jLabel7.setBounds(52, 164, 50, 15);
        ...
        Tab1.add(txtLRNo);
        txtLRNo.setBounds(114, 160, 114, 19);

        jLabel8.setText("Date");
        Tab1.add(jLabel8);
        jLabel8.setBounds(254, 164, 34, 15);
        ...
        Tab1.add(txtLRDate);
        txtLRDate.setBounds(290, 162, 100, 19);

        jLabel9.setText("Invoice No.");
        Tab1.add(jLabel9);
        jLabel9.setBounds(33, 194, 74, 15);
        ...
        Tab1.add(jLabel10);
        jLabel10.setBounds(254, 196, 34, 15);
        ...
        txtInvoiceDate.setBounds(290, 194, 100, 19);

        jLabel11.setText("Transporter ");
        Tab1.add(jLabel11);
        jLabel11.setBounds(21, 236, 85, 15);

        cmbTransporter.setName("TRANSPORTER"); // NOI18N
        cmbTransporter.setNextFocusableComponent(txtGatepassNo);
        ...
        cmbTransporter.setBounds(114, 232, 274, 24);

        jLabel12.setText("Gatepass No.");
        Tab1.add(jLabel12);
        jLabel12.setBounds(15, 272, 91, 15);
        ...
        txtGatepassNo.setBounds(114, 268, 114, 19);

        jLabel13.setText("Currency");
        Tab1.add(jLabel13);
        jLabel13.setBounds(48, 301, 56, 15);
        ...
        cmbCurrency.setBounds(116, 297, 134, 24);

        jLabel14.setText("Rate");
        Tab1.add(jLabel14);
        jLabel14.setBounds(259, 301, 35, 15);
        ...
        Tab1.add(jLabel21);
        jLabel21.setBounds(49, 330, 62, 15);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(116, 327, 416, 19);
        ...
        txtCurrencyRate.setBounds(298, 298, 72, 19);
        ...
        cmdRemarksBig.setBounds(536, 325, 37, 22);
        ...
        Tab1.add(cmdChange);
        cmdChange.setBounds(127, 36, 88, 20);
        ...
        Tab2.add(cmdInsert);
        cmdInsert.setBounds(404, 7, 140, 25);
        ...
        Tab2.add(jLabel18);
        jLabel18.setBounds(444, 226, 150, 15);
        ...
        jLabel16.setText("Press Ctrl+C to copy selected line.");
        Tab2.add(jLabel16);
        jLabel16.setBounds(8, 218, 298, 15);
        ...
        txtInvoiceAmount.setBounds(598, 288, 136, 19);

        jLabel22.setText("Invoice Amount");
        Tab2.add(jLabel22);
        jLabel22.setBounds(490, 292, 108, 15);
        ...
        Tab2.add(cmdRead);
        cmdRead.setBounds(246, 8, 152, 25);
        ...
        Tab2.add(jButton3);
        jButton3.setBounds(310, 320, 94, 25);
        ...
        jLabel23.setBounds(30, 58, 50, 15);
        ...
        jButton2.setBounds(480, 50, 94, 25);

        Tab.addTab("Posting Information", jPanel2);

        jPanel7.setLayout(null);

        TableHSNJOBPJV.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        TableHSNJOBPJV.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TableHSNJOBPJVKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TableHSNJOBPJVKeyReleased(evt);
            }
        });
        jScrollPane8.setViewportView(TableHSNJOBPJV);

        jPanel7.add(jScrollPane8);
        jScrollPane8.setBounds(10, 10, 710, 310);

        Tab.addTab("HSN Wise JOB PJV Posting", jPanel7);
        ...
        lblDocumentHistory.setBounds(14, 191, 182, 15);
        ...
        jScrollPane3.setBounds(14, 207, 549, 138);
        ...
        cmdViewHistory.setBounds(575, 236, 132, 24);
        ...
        cmdNormalView.setBounds(575, 266, 132, 24);
        ...
        cmdShowRemarks.setBounds(575, 297, 132, 24);

        txtAuditRemarks.setEnabled(false);
        jPanel1.add(txtAuditRemarks);
        txtAuditRemarks.setBounds(576, 338, 129, 19);
    ...
    private void txtDocNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDocNoFocusLost
        ...
        {
        if(clsJobwork.IsJobExist(EITLERPGLOBAL.gCompanyID,txtDocNo.getText()))
        {
          JOptionPane.showMessageDialog(null,"Job no. already exist. Please specify other job no.");  
        }
        }
    ...
    private void cmdNormalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNormalViewActionPerformed
        // TODO add your handling code here:
        ObjJOB.LoadData(EITLERPGLOBAL.gCompanyID);
        MoveLast();
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        ...
        ObjJOB.ShowHistory(EITLERPGLOBAL.gCompanyID, DocNo);
        MoveLast();
    ...
    private void TableLKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableLKeyPressed
        ...
        if(EditMode!=0) {
            ...
            //======================================================//
            if(TableL.getSelectedColumn()==DataModelL.getColFromVariable("RGP_NO")) {
                if(evt.getKeyCode()==112) //F1 Key pressed
                {
                    
                    SelectRGPNo aList=new SelectRGPNo();
                    
                    aList.ItemID=DataModelL.getValueByVariable("ITEM_ID", TableL.getSelectedRow());
                    
                    if(aList.ShowList()) {
                        DataModelL.setValueByVariable("RGP_NO",aList.SelRGPNo,TableL.getSelectedRow());
                        DataModelL.setValueByVariable("RGP_SR_NO",Integer.toString(aList.SelRGPSrNo),TableL.getSelectedRow());
                    }
                }
            }
            //=====================================================================//
            ...
            if(TableL.getSelectedColumn()==DataModelL.getColFromVariable("ITEM_ID")) {
                if(evt.getKeyCode()==112) //F1 Key pressed
                {
                    ...
                    if(aList.ShowLOV()) {
                        ...
                        TableL.setValueAt(clsItem.getHsnSacCode(EITLERPGLOBAL.gCompanyID, aList.ReturnVal), TableL.getSelectedRow(),DataModelL.getColFromVariable("HSN_SAC_CODE"));
...
//            //Duplication check completed
            ...
            for(int i=1;i<=ObjPO.colSelItems.size();i++) {
                ...
                DataModelL.setValueByVariable("HSN_SAC_CODE",clsItem.getHsnSacCode(EITLERPGLOBAL.gCompanyID, ItemID),NewRow);
                ...
                DataModelL.setValueByVariable("PO_QTY",Double.toString(ObjItem.getAttribute("QTY").getVal()),NewRow);
                DataModelL.setValueByVariable("BALANCE_PO_QTY",Double.toString(ObjItem.getAttribute("QTY").getVal()-ObjItem.getAttribute("RECD_QTY").getVal()),NewRow);
    ...
    private void TableHSNJOBPJVKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableHSNJOBPJVKeyPressed
        // TODO add your handling code here:
        DecimalFormat newFormat = new DecimalFormat("#.##");
        for (int i = 0; i < TableHSNJOBPJV.getRowCount(); i++) {
            double rcvd_net_amt = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 2).toString());
            double rcvd_cgst = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 5).toString());
            double rcvd_sgst = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 8).toString());
            double rcvd_igst = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 11).toString());
            double rcvd_rcm = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 14).toString());
            double rcvd_composition = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 17).toString());
            double rcvd_gst_compensdation_cess = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 20).toString());

            double inv_net_amt = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 1).toString());
            double inv_cgst = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 4).toString());
            double inv_sgst = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 7).toString());
            double inv_igst = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 10).toString());
            double inv_rcm = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 13).toString());
            double inv_composition = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 16).toString());
            double inv_gst_compensdation_cess = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 19).toString());

            TableHSNJOBPJV.setValueAt(newFormat.format(inv_net_amt - rcvd_net_amt), i, 3);
            TableHSNJOBPJV.setValueAt(newFormat.format(inv_cgst - rcvd_cgst), i, 6);
            TableHSNJOBPJV.setValueAt(newFormat.format(inv_sgst - rcvd_sgst), i, 9);
            TableHSNJOBPJV.setValueAt(newFormat.format(inv_igst - rcvd_igst), i, 12);
            TableHSNJOBPJV.setValueAt(newFormat.format(inv_rcm - rcvd_rcm), i, 15);
            TableHSNJOBPJV.setValueAt(newFormat.format(inv_composition - rcvd_composition), i, 18);
            TableHSNJOBPJV.setValueAt(newFormat.format(inv_gst_compensdation_cess - rcvd_gst_compensdation_cess), i, 21);
        }
    }//GEN-LAST:event_TableHSNJOBPJVKeyPressed

    private void TableHSNJOBPJVKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableHSNJOBPJVKeyReleased
        // TODO add your handling code here:
        DecimalFormat newFormat = new DecimalFormat("#.##");
        for (int i = 0; i < TableHSNJOBPJV.getRowCount(); i++) {
            double rcvd_net_amt = Double.parseDouble(DataModelHSNJOBPJV.getValueAt(i, 2).toString());
    ...
    }//GEN-LAST:event_TableHSNJOBPJVKeyReleased

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
//        System.out.println("for voucher post");
//        System.out.println(txtDocNo.getText());
//        ObjJOB.PostVoucherNonGST(txtDocNo.getText(), 1, "");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ObjJOB.PostVoucherHSNWiseGST(txtDocNo.getText().toString(), 1, "");
    ...
    private javax.swing.JTable TableHSNJOBPJV;
    ...
    private void DisplayData() {
        ...
        if(EditMode==0)
        {
           if(ObjJOB.getAttribute("APPROVED").getInt()==1)
           {
           ...
           if(ObjJOB.getAttribute("CANCELLED").getInt()==1)
           {
        ...
        try {
            ...
            txtDocNo.setText((String)ObjJOB.getAttribute("JOB_NO").getObj());
            lblRevNo.setText(Integer.toString((int)ObjJOB.getAttribute("REVISION_NO").getVal()));
            
            String theTitle="JOB WORK ENTRY "+txtDocNo.getText();
            lblTitle.setText(theTitle);
            
            txtDocDate.setText(EITLERPGLOBAL.formatDate((String)ObjJOB.getAttribute("JOB_DATE").getObj()));
            txtSuppCode.setText((String)ObjJOB.getAttribute("SUPP_ID").getObj());
            txtSuffix.setText((String)ObjJOB.getAttribute("REFA").getObj());
            txtSuppName.setText(clsSupplier.getSupplierName(EITLERPGLOBAL.gCompanyID, txtSuppCode.getText()));
            
            if(txtSuppCode.getText().trim().equals("000000")) {
                txtSuppName.setText((String)ObjJOB.getAttribute("PARTY_NAME").getObj());
            }
            
            txtChalanNo.setText((String)ObjJOB.getAttribute("CHALAN_NO").getObj());
            txtChalanDate.setText(EITLERPGLOBAL.formatDate((String)ObjJOB.getAttribute("CHALAN_DATE").getObj()));
            txtLRNo.setText((String)ObjJOB.getAttribute("LR_NO").getObj());
            txtLRDate.setText(EITLERPGLOBAL.formatDate((String)ObjJOB.getAttribute("LR_DATE").getObj()));
            txtInvoiceNo.setText((String)ObjJOB.getAttribute("INVOICE_NO").getObj());
            txtInvoiceDate.setText(EITLERPGLOBAL.formatDate((String)ObjJOB.getAttribute("INVOICE_DATE").getObj()));
            EITLERPGLOBAL.setComboIndex(cmbTransporter,(int)ObjJOB.getAttribute("TRANSPORTER").getVal());
            txtGatepassNo.setText((String)ObjJOB.getAttribute("GATEPASS_NO").getObj());
            EITLERPGLOBAL.setComboIndex(cmbCurrency,(int)ObjJOB.getAttribute("CURRENCY_ID").getVal());
            txtCurrencyRate.setText(Double.toString(ObjJOB.getAttribute("CURRENCY_RATE").getVal()));
            EITLERPGLOBAL.setComboIndex(cmbStatus,(String)ObjJOB.getAttribute("OPEN_STATUS").getObj());
            
            chkImportConcess.setSelected(ObjJOB.getAttribute("IMPORT_CONCESS").getBool());
            chkCancelled.setSelected(ObjJOB.getAttribute("CANCELLED").getBool());
            txtRemarks.setText((String)ObjJOB.getAttribute("REMARKS").getObj());
            
            EITLERPGLOBAL.setComboIndex(cmbHierarchy,(int)ObjJOB.getAttribute("HIERARCHY_ID").getVal());
            EITLERPGLOBAL.setComboIndex(cmbPFPost,ObjJOB.getAttribute("PF_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbFreightPost,ObjJOB.getAttribute("FREIGHT_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbOctroiPost,ObjJOB.getAttribute("OCTROI_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbInsurancePost,ObjJOB.getAttribute("INSURANCE_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbClearancePost,ObjJOB.getAttribute("CLEARANCE_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbAirFreightPost,ObjJOB.getAttribute("AIR_FREIGHT_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbOthersPost,ObjJOB.getAttribute("OTHERS_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbPaymentType,ObjJOB.getAttribute("PAYMENT_TYPE").getInt());
            
            txtInvoiceAmount.setText(Double.toString(ObjJOB.getAttribute("INVOICE_AMOUNT").getVal()));
            
            //============= Display Custom Columns ========================
            for(int i=1;i<=30;i++) {
                int ColID=(int)ObjJOB.getAttribute("COLUMN_"+Integer.toString(i)+"_ID").getVal();
                ...
                if(ColID!=0) {
                    //Set the Formula
                    if(ObjJOB.getAttribute("COLUMN_"+Integer.toString(i)+"_FORMULA").getObj()!=null) {
                        DataModelH.SetFormula(Col, (String)ObjJOB.getAttribute("COLUMN_"+Integer.toString(i)+"_FORMULA").getObj());
                    }
                    else {
                    ...
                    if(ObjTax.getUsePercentage(EITLERPGLOBAL.gCompanyID, TaxID)) {
                        DataModelH.setValueByVariableEx("P_"+ColID, Double.toString(ObjJOB.getAttribute("COLUMN_"+Integer.toString(i)+"_PER").getVal()),1);
                    }
                    
                    //Set the Value
                    DataModelH.setValueByVariableEx(Variable, Double.toString(ObjJOB.getAttribute("COLUMN_"+Integer.toString(i)+"_AMT").getVal()), 1);
                }
            }
            //=================================================================//
            ...
            for(int i=1;i<=ObjJOB.colMIRItems.size();i++) {
                ...
                DataModelL.setValueByVariable("RGP_NO",(String)ObjItem.getAttribute("RGP_NO").getObj(),NewRow);
                DataModelL.setValueByVariable("RGP_SR_NO",Integer.toString((int)ObjItem.getAttribute("RGP_SR_NO").getVal()),NewRow);
                
                DataModelL.setValueByVariable("PO_TYPE",Integer.toString((int)ObjItem.getAttribute("PO_TYPE").getVal()),NewRow);
                
                DataModelL.setValueByVariable("JOB_CAT",(String)ObjItem.getAttribute("JOB_CAT").getObj(),NewRow);
                DataModelL.setValueByVariable("JOB_CAT_DESC",(String)ObjItem.getAttribute("JOB_CAT_DESC").getObj(),NewRow);
            ...
            for (int i = 1; i <= ObjJOB.colHSNGRNPJVItems.size(); i++) {
                //Insert New Row
                Object[] rowData = new Object[1];
                DataModelHSNJOBPJV.addRow(rowData);
                int NewRow = TableHSNJOBPJV.getRowCount() - 1;

                clsHSNGRNPJVItem ObjHSNItem = (clsHSNGRNPJVItem) ObjJOB.colHSNGRNPJVItems.get(Integer.toString(i));
                
                DataModelHSNJOBPJV.setValueByVariable("HSN_CODE", (String) ObjHSNItem.getAttribute("HSN_CODE").getObj(), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_AMOUNT", Double.toString(ObjHSNItem.getAttribute("INVOICE_AMOUNT").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_CGST", Double.toString(ObjHSNItem.getAttribute("INVOICE_CGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_SGST", Double.toString(ObjHSNItem.getAttribute("INVOICE_SGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_IGST", Double.toString(ObjHSNItem.getAttribute("INVOICE_IGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_RCM", Double.toString(ObjHSNItem.getAttribute("INVOICE_RCM").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_COMPOSITION", Double.toString(ObjHSNItem.getAttribute("INVOICE_COMPOSITION").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("INVOICE_GST_COMP_CESS", Double.toString(ObjHSNItem.getAttribute("INVOICE_GST_COMP_CESS").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_AMOUNT", Double.toString(ObjHSNItem.getAttribute("RECEIVED_AMOUNT").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_CGST", Double.toString(ObjHSNItem.getAttribute("RECEIVED_CGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_SGST", Double.toString(ObjHSNItem.getAttribute("RECEIVED_SGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_IGST", Double.toString(ObjHSNItem.getAttribute("RECEIVED_IGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_RCM", Double.toString(ObjHSNItem.getAttribute("RECEIVED_RCM").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_COMPOSITION", Double.toString(ObjHSNItem.getAttribute("RECEIVED_COMPOSITION").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("RECEIVED_GST_COMP_CESS", Double.toString(ObjHSNItem.getAttribute("RECEIVED_GST_COMP_CESS").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_AMOUNT", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_AMOUNT").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_CGST", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_CGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_SGST", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_SGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_IGST", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_IGST").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_RCM", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_RCM").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_COMPOSITION", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_COMPOSITION").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("DEBIT_NOTE_GST_COMP_CESS", Double.toString(ObjHSNItem.getAttribute("DEBIT_NOTE_GST_COMP_CESS").getVal()), NewRow);
                
                DataModelHSNJOBPJV.setValueByVariable("CGST_INPUT_CR_PER", Double.toString(ObjHSNItem.getAttribute("CGST_INPUT_CR_PER").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("CGST_INPUT_CR_AMT", Double.toString(ObjHSNItem.getAttribute("CGST_INPUT_CR_AMT").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("SGST_INPUT_CR_PER", Double.toString(ObjHSNItem.getAttribute("SGST_INPUT_CR_PER").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("SGST_INPUT_CR_AMT", Double.toString(ObjHSNItem.getAttribute("SGST_INPUT_CR_AMT").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("IGST_INPUT_CR_PER", Double.toString(ObjHSNItem.getAttribute("IGST_INPUT_CR_PER").getVal()), NewRow);
                DataModelHSNJOBPJV.setValueByVariable("IGST_INPUT_CR_AMT", Double.toString(ObjHSNItem.getAttribute("IGST_INPUT_CR_AMT").getVal()), NewRow);
            }
            //=================================================================//
            ...
            String DocNo=(String)ObjJOB.getAttribute("JOB_NO").getObj();
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 48, DocNo);
            ...
            FormatGridHS();
            HashMap History=clsJobwork.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for(int i=1;i<=History.size();i++) {
                clsJobwork ObjHistory=(clsJobwork)History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD)
        {
        ObjJOB.UserDocNo=txtDocNo.isEnabled();  
        ObjJOB.setAttribute("JOB_NO",txtDocNo.getText());
        }
        else
        {
        ObjJOB.UserDocNo=false;      
        }
        
        ObjJOB.setAttribute("COMPANY_ID",EITLERPGLOBAL.gCompanyID);
        ObjJOB.setAttribute("PREFIX",SelPrefix);
        ObjJOB.setAttribute("SUFFIX",SelSuffix);
        ObjJOB.setAttribute("FFNO",FFNo);
        ObjJOB.setAttribute("JOB_DATE",EITLERPGLOBAL.formatDateDB(txtDocDate.getText()));
        ObjJOB.setAttribute("SUPP_ID",txtSuppCode.getText());
        
        ObjJOB.setAttribute("PARTY_NAME","");
        if(txtSuppCode.getText().trim().equals("000000")) {
            ObjJOB.setAttribute("PARTY_NAME",txtSuppName.getText());
        }
        
        ObjJOB.setAttribute("REFA",txtSuffix.getText());
        ObjJOB.setAttribute("CHALAN_NO",txtChalanNo.getText());
        ObjJOB.setAttribute("CHALAN_DATE",EITLERPGLOBAL.formatDateDB(txtChalanDate.getText()));
        ObjJOB.setAttribute("LR_NO",txtLRNo.getText());
        ObjJOB.setAttribute("LR_DATE",EITLERPGLOBAL.formatDateDB(txtLRDate.getText()));
        ObjJOB.setAttribute("INVOICE_NO",txtInvoiceNo.getText());
        ObjJOB.setAttribute("INVOICE_DATE",EITLERPGLOBAL.formatDateDB(txtInvoiceDate.getText()));
        ObjJOB.setAttribute("TRANSPORTER",EITLERPGLOBAL.getComboCode(cmbTransporter));
        ObjJOB.setAttribute("GATEPASS_NO",txtGatepassNo.getText());
        ObjJOB.setAttribute("CURRENCY_ID",EITLERPGLOBAL.getComboCode(cmbCurrency));
        ObjJOB.setAttribute("CURRENCY_RATE",EITLERPGLOBAL.round(Double.parseDouble(txtCurrencyRate.getText()),5));
        ObjJOB.setAttribute("OPEN_STATUS",EITLERPGLOBAL.getCombostrCode(cmbStatus));
        
        ObjJOB.setAttribute("INVOICE_AMOUNT",EITLERPGLOBAL.round(Double.parseDouble(txtInvoiceAmount.getText()),5));
        ObjJOB.setAttribute("PF_POST",EITLERPGLOBAL.getComboCode(cmbPFPost));
        ObjJOB.setAttribute("FREIGHT_POST",EITLERPGLOBAL.getComboCode(cmbFreightPost));
        ObjJOB.setAttribute("OCTROI_POST",EITLERPGLOBAL.getComboCode(cmbOctroiPost));
        ObjJOB.setAttribute("INSURANCE_POST",EITLERPGLOBAL.getComboCode(cmbInsurancePost));
        ObjJOB.setAttribute("CLEARANCE_POST",EITLERPGLOBAL.getComboCode(cmbClearancePost));
        ObjJOB.setAttribute("AIR_FREIGHT_POST",EITLERPGLOBAL.getComboCode(cmbAirFreightPost));
        ObjJOB.setAttribute("OTHERS_POST",EITLERPGLOBAL.getComboCode(cmbOthersPost));
        ObjJOB.setAttribute("PAYMENT_TYPE",EITLERPGLOBAL.getComboCode(cmbPaymentType));
        
        if(chkImportConcess.isSelected()) {
            ObjJOB.setAttribute("IMPORT_CONCESS",true);
        }
        else {
            ObjJOB.setAttribute("IMPORT_CONCESS",false);
        }
        
        
        if(chkCancelled.isSelected()) {
            ObjJOB.setAttribute("CANCELLED",true);
        }
        else {
            ObjJOB.setAttribute("CANCELLED",false);
        }
        
        ObjJOB.setAttribute("FOR_STORE",clsUser.getDeptID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID));
        ObjJOB.setAttribute("REMARKS",txtRemarks.getText());
        
        //----- Update Approval Specific Fields -----------//
        ObjJOB.setAttribute("HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbHierarchy));
        ObjJOB.setAttribute("FIN_HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbFinHierarchy));
        ObjJOB.setAttribute("FROM",EITLERPGLOBAL.gNewUserID);
        ObjJOB.setAttribute("TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        ObjJOB.setAttribute("FROM_REMARKS",txtToRemarks.getText());
        
        if(OpgApprove.isSelected()) {
            ObjJOB.setAttribute("APPROVAL_STATUS","A");
        }
        
        if(OpgFinal.isSelected()) {
            ObjJOB.setAttribute("APPROVAL_STATUS","F");
        }
        
        if(OpgReject.isSelected()) {
            ObjJOB.setAttribute("APPROVAL_STATUS","R");
            ObjJOB.setAttribute("SEND_DOC_TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        }
        
        if(OpgHold.isSelected()) {
            ObjJOB.setAttribute("APPROVAL_STATUS","H");
        }
        //-------------------------------------------------//
        
        if(EditMode==EITLERPGLOBAL.ADD) {
            ObjJOB.setAttribute("CREATED_BY",EITLERPGLOBAL.gNewUserID);
            ObjJOB.setAttribute("CREATED_DATE",EITLERPGLOBAL.getCurrentDateDB());
        }
        else {
            ObjJOB.setAttribute("MODIFIED_BY",EITLERPGLOBAL.gNewUserID);
            ObjJOB.setAttribute("MODIFIED_DATE",EITLERPGLOBAL.getCurrentDateDB());
        }
        ...
        for(int i=0;i<TableH.getRowCount();i++) {
            ...
            if( (ColID!=0) && (ColID!=-99) && (!Variable.substring(0,2).equals("P_"))) {
                ColCounter++;
                ObjJOB.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_ID",ColID);
                ObjJOB.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_FORMULA",DataModelH.getFormula(i));
                
                if(ObjTax.getUsePercentage(EITLERPGLOBAL.gCompanyID, TaxID)) {
                    lnPercentValue=Double.parseDouble(DataModelH.getValueByVariableEx("P_"+ColID,1));
                    ObjJOB.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_PER",EITLERPGLOBAL.round(lnPercentValue,3));
                }
                ObjJOB.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_AMT",EITLERPGLOBAL.round(Double.parseDouble(DataModelH.getValueByVariableEx(Variable, 1)),5));
                ObjJOB.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_CAPTION",(String)TableH.getValueAt(i, 0));
            }
        }
        //=================================================================
        ...
        for(int i=0;i<TableL.getRowCount();i++) {
            ...
            ObjItem.setAttribute("RGP_NO",DataModelL.getValueByVariable("RGP_NO",i));
            ObjItem.setAttribute("RGP_SR_NO",Integer.parseInt(DataModelL.getValueByVariable("RGP_SR_NO",i)));
            ...
            ObjItem.setAttribute("JOB_CAT",DataModelL.getValueByVariable("JOB_CAT",i));
            ObjItem.setAttribute("JOB_CAT_DESC",DataModelL.getValueByVariable("JOB_CAT_DESC",i));
            ...
            ObjJOB.colMIRItems.put(Integer.toString(ObjJOB.colMIRItems.size()+1),ObjItem);
        }
        //======================Completed ===========================//
        
        //=================== Setting up HSN JOB Items ==================//
        ObjJOB.colHSNGRNPJVItems.clear();

        for (int i = 0; i < TableHSNJOBPJV.getRowCount(); i++) {
            clsHSNGRNPJVItem ObjHSNItem = new clsHSNGRNPJVItem();
            
            ObjHSNItem.setAttribute("HSN_CODE", DataModelHSNJOBPJV.getValueAt(i, 0).toString());
            ObjHSNItem.setAttribute("INVOICE_AMOUNT", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 1).toString(), 0));
            ObjHSNItem.setAttribute("INVOICE_CGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 4).toString(), 0));
            ObjHSNItem.setAttribute("INVOICE_SGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 7).toString(), 0));
            ObjHSNItem.setAttribute("INVOICE_IGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 10).toString(), 0));
            ObjHSNItem.setAttribute("INVOICE_RCM", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 13).toString(), 0));
            ObjHSNItem.setAttribute("INVOICE_COMPOSITION", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 16).toString(), 0));
            ObjHSNItem.setAttribute("INVOICE_GST_COMP_CESS", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 19).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_AMOUNT", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 2).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_CGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 5).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_SGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 8).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_IGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 11).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_RCM", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 14).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_COMPOSITION", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 17).toString(), 0));
            ObjHSNItem.setAttribute("RECEIVED_GST_COMP_CESS", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 20).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_AMOUNT", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 3).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_CGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 6).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_SGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 9).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_IGST", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 12).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_RCM", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 15).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_COMPOSITION", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 18).toString(), 0));
            ObjHSNItem.setAttribute("DEBIT_NOTE_GST_COMP_CESS", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 21).toString(), 0));
            
            ObjHSNItem.setAttribute("CGST_INPUT_CR_PER", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 22).toString(), 0));
            ObjHSNItem.setAttribute("CGST_INPUT_CR_AMT", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 23).toString(), 0));
            ObjHSNItem.setAttribute("SGST_INPUT_CR_PER", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 24).toString(), 0));
            ObjHSNItem.setAttribute("SGST_INPUT_CR_AMT", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 25).toString(), 0));
            ObjHSNItem.setAttribute("IGST_INPUT_CR_PER", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 26).toString(), 0));
            ObjHSNItem.setAttribute("IGST_INPUT_CR_AMT", HSNDouble(DataModelHSNJOBPJV.getValueAt(i, 27).toString(), 0));
            
            ObjJOB.colHSNGRNPJVItems.put(Integer.toString(ObjJOB.colHSNGRNPJVItems.size() + 1), ObjHSNItem);
        }
        //======================Completed ===========================//
    ...
    private void SetupColumns() {
        ...
        List=clsColumn.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND MODULE_ID=48 AND HEADER_LINE='L' ORDER BY COL_ORDER");
        ...
        ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=48 AND HIDDEN=0 AND SHOW_LAST=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
...
//            }
        ...
        ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=48 AND HIDDEN=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        for(int i=1;i<=ColList.size();i++) {
            clsSystemColumn ObjColumn=(clsSystemColumn)ColList.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=48 AND HIDDEN=0 AND SHOW_LAST=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
            for(int i=1;i<=ColList.size();i++) {
                clsSystemColumn ObjColumn=(clsSystemColumn)ColList.get(Integer.toString(i));
...
//            TableL.getColumnModel().getColumn(DataModelL.getColFromVariable("BARCODE_TYPE")).setCellEditor(new DefaultCellEditor(cmbBarcodeType));
            ...
            //Combo create start
            JComboBox cmbCatType = new JComboBox();

            EITLComboModel cmbCatTypeModel = new EITLComboModel();
            cmbCatType.removeAllItems();
            cmbCatType.setModel(cmbCatTypeModel);
        ...
        try
        {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM DINESHMILLS.ISSUE_CATEGORY_MASTER");
            rsTmp.first();
            Counter=0;
            while(!rsTmp.isAfterLast())
            {
                Counter=Counter+1;
                ComboData aData = new ComboData();
                aData.Code = rsTmp.getInt("ISSUE_CAT_ID");
                aData.Text = rsTmp.getString("ISSUE_CAT_DESC");
                aData.strCode = "";
                cmbCatTypeModel.addElement(aData);               
        ...
        catch(Exception e)
        {
            ...
            //TableL.getColumnModel().getColumn(11).setCellEditor(new DefaultCellEditor(cmbCatType));
            TableL.getColumnModel().getColumn(DataModelL.getColFromVariable("JOB_CAT")).setCellEditor(new DefaultCellEditor(cmbCatType));            
            //Combo create end
    ...
    private void SetupColumns_H() {
        ...
        List=clsColumn.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND MODULE_ID=48 AND HEADER_LINE='H' ORDER BY COL_ORDER");
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            clsTaxColumn ObjTax = (clsTaxColumn)clsTaxColumn.getObject((int)EITLERPGLOBAL.gCompanyID,lTaxID);
           // System.out.println("caption : "+ObjColumn.getAttribute("CAPTION").getObj()+" , Visible : "+ObjTax.getAttribute("VISIBLE_ON_FORM").getBool());
            if(ObjTax.getAttribute("VISIBLE_ON_FORM").getBool()) {
            if((boolean)ObjTax.getAttribute("USE_PERCENT").getBool()) {
                //Add Percentage Column
                //DataModelL.addColumn((String)ObjColumn.getAttribute("CAPTION").getObj()+"%");
    ...
    private void FormatGridHSNJOBPJV() {

        Updating = true; //Stops recursion

        try {

            DataModelHSNJOBPJV = new EITLTableModel();
            TableHSNJOBPJV.removeAll();
            TableHSNJOBPJV.setModel(DataModelHSNJOBPJV);
            TableColumnModel ColModel = TableHSNJOBPJV.getColumnModel();
            TableHSNJOBPJV.setAutoResizeMode(TableHSNJOBPJV.AUTO_RESIZE_OFF);
            EITLTableCellRenderer Renderer = new EITLTableCellRenderer();
            Renderer.setColor(0, 0, Color.LIGHT_GRAY);

            //DataModelDesc.addColumn("Sr.");    //0
            DataModelHSNJOBPJV.addColumn("HSN Code");    //1
            DataModelHSNJOBPJV.addColumn("Invoice Amt");    //2
            DataModelHSNJOBPJV.addColumn("Receive Amt");    //3
            DataModelHSNJOBPJV.addColumn("Debit Note Amt");    //4
            DataModelHSNJOBPJV.addColumn("Invoice CGST");    //5
            DataModelHSNJOBPJV.addColumn("Receive CGST");    //6
            DataModelHSNJOBPJV.addColumn("Debit Note CGST");    //7
            DataModelHSNJOBPJV.addColumn("Invoice SGST");    //8
            DataModelHSNJOBPJV.addColumn("Receive SGST");    //9
            DataModelHSNJOBPJV.addColumn("Debit Note SGST");    //10
            DataModelHSNJOBPJV.addColumn("Invoice IGST");    //11
            DataModelHSNJOBPJV.addColumn("Receive IGST");    //12
            DataModelHSNJOBPJV.addColumn("Debit Note IGST");    //13
            DataModelHSNJOBPJV.addColumn("Invoice RCM");    //14
            DataModelHSNJOBPJV.addColumn("Receive RCM");    //15
            DataModelHSNJOBPJV.addColumn("Debit Note RCM");    //16
            DataModelHSNJOBPJV.addColumn("Invoice Composition");    //17
            DataModelHSNJOBPJV.addColumn("Receive Composition");    //18
            DataModelHSNJOBPJV.addColumn("Debit Note Composition");    //19
            DataModelHSNJOBPJV.addColumn("Invoice GST Comp Cess");    //20
            DataModelHSNJOBPJV.addColumn("Receive GST Comp Cess");    //21
            DataModelHSNJOBPJV.addColumn("Debit Note GST Comp Cess");    //22
            
            DataModelHSNJOBPJV.addColumn("CGST Input Cr Per");    //23
            DataModelHSNJOBPJV.addColumn("CGST Input Cr Amt");    //24
            DataModelHSNJOBPJV.addColumn("SGST Input Cr Per");    //25
            DataModelHSNJOBPJV.addColumn("SGST Input Cr Amt");    //26
            DataModelHSNJOBPJV.addColumn("IGST Input Cr Per");    //27
            DataModelHSNJOBPJV.addColumn("IGST Input Cr Amt");    //28

            DataModelHSNJOBPJV.SetVariable(0, "HSN_CODE");    //1
            DataModelHSNJOBPJV.SetVariable(1, "INVOICE_AMOUNT");    //2
            DataModelHSNJOBPJV.SetVariable(2, "RECEIVED_AMOUNT");    //3
            DataModelHSNJOBPJV.SetVariable(3, "DEBIT_NOTE_AMOUNT");    //4
            DataModelHSNJOBPJV.SetVariable(4, "INVOICE_CGST");    //5
            DataModelHSNJOBPJV.SetVariable(5, "RECEIVED_CGST");    //6
            DataModelHSNJOBPJV.SetVariable(6, "DEBIT_NOTE_CGST");    //7
            DataModelHSNJOBPJV.SetVariable(7, "INVOICE_SGST");    //8
            DataModelHSNJOBPJV.SetVariable(8, "RECEIVED_SGST");    //9
            DataModelHSNJOBPJV.SetVariable(9, "DEBIT_NOTE_SGST");    //10
            DataModelHSNJOBPJV.SetVariable(10, "INVOICE_IGST");    //11
            DataModelHSNJOBPJV.SetVariable(11, "RECEIVED_IGST");    //12
            DataModelHSNJOBPJV.SetVariable(12, "DEBIT_NOTE_IGST");    //13
            DataModelHSNJOBPJV.SetVariable(13, "INVOICE_RCM");    //14
            DataModelHSNJOBPJV.SetVariable(14, "RECEIVED_RCM");    //15
            DataModelHSNJOBPJV.SetVariable(15, "DEBIT_NOTE_RCM");    //16
            DataModelHSNJOBPJV.SetVariable(16, "INVOICE_COMPOSITION");    //17
            DataModelHSNJOBPJV.SetVariable(17, "RECEIVED_COMPOSITION");    //18
            DataModelHSNJOBPJV.SetVariable(18, "DEBIT_NOTE_COMPOSITION");    //19
            DataModelHSNJOBPJV.SetVariable(19, "INVOICE_GST_COMP_CESS");    //20
            DataModelHSNJOBPJV.SetVariable(20, "RECEIVED_GST_COMP_CESS");    //21
            DataModelHSNJOBPJV.SetVariable(21, "DEBIT_NOTE_GST_COMP_CESS");    //22
            
            DataModelHSNJOBPJV.SetVariable(22, "CGST_INPUT_CR_PER");    //23
            DataModelHSNJOBPJV.SetVariable(23, "CGST_INPUT_CR_AMT");    //24
            DataModelHSNJOBPJV.SetVariable(24, "SGST_INPUT_CR_PER");    //25
            DataModelHSNJOBPJV.SetVariable(25, "SGST_INPUT_CR_AMT");    //26
            DataModelHSNJOBPJV.SetVariable(26, "IGST_INPUT_CR_PER");    //27
            DataModelHSNJOBPJV.SetVariable(27, "IGST_INPUT_CR_AMT");    //28


            DataModelHSNJOBPJV.SetReadOnly(0);
            DataModelHSNJOBPJV.SetReadOnly(2);
            DataModelHSNJOBPJV.SetReadOnly(3);
            DataModelHSNJOBPJV.SetReadOnly(5);
            DataModelHSNJOBPJV.SetReadOnly(6);
            DataModelHSNJOBPJV.SetReadOnly(8);
            DataModelHSNJOBPJV.SetReadOnly(9);
            DataModelHSNJOBPJV.SetReadOnly(11);
            DataModelHSNJOBPJV.SetReadOnly(12);
            DataModelHSNJOBPJV.SetReadOnly(14);
            DataModelHSNJOBPJV.SetReadOnly(15);
            DataModelHSNJOBPJV.SetReadOnly(17);
            DataModelHSNJOBPJV.SetReadOnly(18);
            DataModelHSNJOBPJV.SetReadOnly(20);
            DataModelHSNJOBPJV.SetReadOnly(21);
            
            DataModelHSNJOBPJV.SetReadOnly(22);
            DataModelHSNJOBPJV.SetReadOnly(23);
            DataModelHSNJOBPJV.SetReadOnly(24);
            DataModelHSNJOBPJV.SetReadOnly(25);
            DataModelHSNJOBPJV.SetReadOnly(26);
            DataModelHSNJOBPJV.SetReadOnly(27);

//            //------- Install Table List Selection Listener ------//
//            TableHSNJOBPJV.getColumnModel().getSelectionModel().addListSelectionListener(
//                    new ListSelectionListener() {
//                        public void valueChanged(ListSelectionEvent e) {
//                            int last = TableHSNJOBPJV.getSelectedColumn();
//                            String strVar = DataModelHSNJOBPJV.getVariable(last);
//
//                            //=============== Cell Editing Routine =======================//
//                            try {
//                                String cellLastValue = (String) TableHSNJOBPJV.getValueAt(TableHSNJOBPJV.getSelectedRow(), TableHSNJOBPJV.getSelectedColumn());
//
//                                TableHSNJOBPJV.editCellAt(TableHSNJOBPJV.getSelectedRow(), TableHSNJOBPJV.getSelectedColumn());
//                                if (TableHSNJOBPJV.getEditorComponent() instanceof JTextComponent) {
//                                    ((JTextComponent) TableHSNJOBPJV.getEditorComponent()).selectAll();
//                                }
//                            } catch (Exception cell) {
//                            }
//                            //============= Cell Editing Routine Ended =================//
...
//            );
            ...
            for (int q = 0; q < 22; q++) {
                TableHSNJOBPJV.getColumnModel().getColumn(q).setMinWidth(100);
                //TableHSNJOBPJV.getColumnModel().getColumn(q).setMaxWidth(150);
            }
    ...
    private void GeneratePaymentTypeCombo() {
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=48");
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=48");
        }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, 48,(String)ObjJOB.getAttribute("JOB_NO").getObj());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,875)) {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, 48,(String)ObjJOB.getAttribute("JOB_NO").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,48,FromUserID,(String)ObjJOB.getAttribute("JOB_NO").getObj());
        ...
        if(clsHierarchy.CanFinalApprove((int)EITLERPGLOBAL.gCompanyID, SelHierarchyID, (int)EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.CanFinalApprove(EITLERPGLOBAL.gCompanyID, 48, EITLERPGLOBAL.gNewUserID)) {
                OpgFinal.setEnabled(true);
            }
            //=================================//
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,871)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Edit Rights --
        cmdEdit.setEnabled(true);
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,512)) {
            cmdEdit.setEnabled(true);
        }
        else {
            cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,873)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,874)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void UpdateAmounts() {
        ...
        for(int i=0;i<TableL.getRowCount();i++) {
            if(TableL.getValueAt(i,NetAmountCol)!=null) {
                ...
                //Scan through each Header Level Taxes
    ...
    private boolean Validate() {
        ...
        for(int i=0;i<TableL.getRowCount();i++) {
            ...
            String strIssueCat = (String) TableL.getValueAt(i, DataModelL.getColFromVariable("JOB_CAT"));
            String strIssueCatDesc = (String) TableL.getValueAt(i, DataModelL.getColFromVariable("JOB_CAT_DESC"));
            if (strIssueCat.equals("")) {
                JOptionPane.showMessageDialog(null, "Please select any Job Category!!");
                return false;
            }
            if (strIssueCat.equals("OTHERS") && strIssueCatDesc.equals("")) {
                JOptionPane.showMessageDialog(null, "Please enter description for OTHERS category!!");
                return false;
            }
        }
...
//          return false;
//        } 
             /*   for (int j = 0; j < TableHSNJOBPJV.getRowCount(); j++) {
            if(Double.valueOf(DataModelHSNJOBPJV.getValueByVariable("CGST_INPUT_CR_PER", j))==0){
                if(Double.valueOf(DataModelHSNJOBPJV.getValueByVariable("CGST_INPUT_CR_AMT", j))!=0){
                    JOptionPane.showMessageDialog(this, "Please enter valid Input Credit CGST % at detail level");
                    return false;
                }
            }
            if(Double.valueOf(DataModelHSNJOBPJV.getValueByVariable("SGST_INPUT_CR_PER", j))==0){
                if(Double.valueOf(DataModelHSNJOBPJV.getValueByVariable("SGST_INPUT_CR_AMT", j))!=0){
                    JOptionPane.showMessageDialog(this, "Please enter valid Input Credit SGST % at detail level");
                    return false;
                }
            }
            if(Double.valueOf(DataModelHSNJOBPJV.getValueByVariable("IGST_INPUT_CR_PER", j))==0){
                if(Double.valueOf(DataModelHSNJOBPJV.getValueByVariable("IGST_INPUT_CR_AMT", j))!=0){
    ...
    private void Add() {
        ...
        if(aList.ShowList()) {
            ...
            {
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 48, FFNo,  false));
            txtDocDate.setText(EITLERPGLOBAL.getCurrentDate());
            }
            
            GeneratePaymentTypeCombo();
    ...
    private void Edit() {
        ...
        String lDocNo=(String)ObjJOB.getAttribute("JOB_NO").getObj();
        if(ObjJOB.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(48,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,872)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Delete() {
        ...
        if(JOptionPane.showConfirmDialog(null,"Are you sure you want to delete this record ?","SDML ERP",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) {
            if(ObjJOB.CanDelete(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
                if(ObjJOB.Delete(EITLERPGLOBAL.gNewUserID)) {
                    MoveLast();
                }
                else {
                    JOptionPane.showMessageDialog(null,"Error occured while deleting. Error is "+ObjJOB.LastError);
                }
            }
            else {
    ...
    private void Save() {
        ...
        //ADDED BY GAURANG on 22/08/2017 for HSN/SAC Code Validation on Final Approval
        String AStatus = (String) ObjJOB.getAttribute("APPROVAL_STATUS").getObj();
        if (AStatus.equals("F")) {
            for (int i = 1; i <= ObjJOB.colMIRItems.size(); i++) {
                clsJobworkItem ItemDetail = (clsJobworkItem) ObjJOB.colMIRItems.get(Integer.toString(i));
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            if(ObjJOB.Insert()) {
                ...
                JOptionPane.showMessageDialog(null,"Error occured while saving. Error is "+ObjJOB.LastError);
                return;
            }
        }
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Stores.frmJobworkFind",true);
        frmJobworkFind ObjReturn= (frmJobworkFind) ObjLoader.getObj();
        
        if(ObjReturn.Cancelled==false) {
            if(!ObjJOB.Filter(ObjReturn.strQuery,EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID,String pDocNo) {
        ObjJOB.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND JOB_NO='"+pDocNo+"' ",pCompanyID);
        ObjJOB.MoveLast();
        DisplayData();
    }
    ...
    public void FindByCompany(int pCompanyID,String pDocNo) {
        ...
        ObjJOB.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND JOB_NO='"+pDocNo+"' ",pCompanyID,dbURL);
        ObjJOB.MoveLast();
        DisplayData();
    }
    
    public void FindWaiting() {
        ObjJOB.Filter(" WHERE JOB_NO IN (SELECT D_INV_JOB_HEADER.JOB_NO FROM D_INV_JOB_HEADER,D_COM_DOC_DATA WHERE D_INV_JOB_HEADER.JOB_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_JOB_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_JOB_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_COM_DOC_DATA.USER_ID="+EITLERPGLOBAL.gNewUserID+" AND D_COM_DOC_DATA.STATUS='W' AND MODULE_ID=48)",EITLERPGLOBAL.gCompanyID);
        ObjJOB.MoveLast();
        DisplayData();
    }
    ...
    private void PreviewReport() {
        ...
        try {
            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptJob.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
    ...
    private void GenerateRejectedUserCombo() {
        ...
        if(EditMode==EITLERPGLOBAL.EDIT&&OpgReject.isSelected()) {
            try {
                String GRNNo=ObjJOB.getAttribute("JOB_NO").getString();
                
                //--> Find distinct PO nos in this GRN
                ResultSet rsPO=data.getResult("SELECT DISTINCT(PO_NO) FROM D_INV_JOB_DETAIL WHERE JOB_NO='"+GRNNo+"' AND PO_NO<>''");
                rsPO.first();
        ...
        List=ApprovalFlow.getUserList((int)EITLERPGLOBAL.gCompanyID,48,txtDocNo.getText());
        for(int i=1;i<=List.size();i++) {
            clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
            ComboData aData=new ComboData();
            aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 48, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 48, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 48, txtDocNo.getText());
            EITLERPGLOBAL.setComboIndex(cmbSendTo,Creator);
        }
        
    }
    
//    private void GenerateHSNJOBData1() {
...
//                rowData2[21] = 0.00;
//                DataModelHSNJOBPJV.addRow(rowData2);
//            }
//        }
//    }
    
    private void GenerateHSNJOBData() {
        try {
            String hsnCd = "";
            int aCnt = 0;
            int bCnt = 0;
                ...
                for (int i = 0; i < bCnt; i++) {
                    ...
                    for (int j = 0; j < TableL.getRowCount(); j++) {
                        ...
                        if (b[i].equals(hsnCode)) {
                            ...
                            CGSTInputCrPer = Double.valueOf(DataModelL.getValueByVariable("P_735", j));//P_723 //P_872 //9 //sr no of dcomcolumns
                            SGSTInputCrPer = Double.valueOf(DataModelL.getValueByVariable("P_736", j));//P_725 //P_873 //10
                            IGSTInputCrPer = Double.valueOf(DataModelL.getValueByVariable("P_737", j));//P_727 //p_874 //11
                        }
                    }
