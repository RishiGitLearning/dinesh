 ...
 *
 */
public class frmSTMReceiptRaw extends javax.swing.JApplet {
    ...
    private clsSTMReceiptRaw ObjSTM;
    public clsSTMRaw ObjSTMRaw;
    
    public int STMType=2; //1-GEN 2-RAW MATERIAL
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("STM Receipt (Raw Material)");
        ...
        Tab1.add(txtDocNo);
        txtDocNo.setBounds(114, 14, 102, 19);
        ...
        txtSuppCode.setBounds(114, 90, 62, 19);

        txtSuppName.setEnabled(false);
        Tab1.add(txtSuppName);
        txtSuppName.setBounds(178, 90, 212, 19);

        jLabel5.setText("Chalan No.");
        Tab1.add(jLabel5);
        jLabel5.setBounds(40, 130, 68, 15);
        ...
        txtChalanNo.setBounds(114, 126, 114, 19);

        jLabel6.setText("Date");
        Tab1.add(jLabel6);
        jLabel6.setBounds(254, 130, 29, 15);
        ...
        txtChalanDate.setBounds(290, 128, 100, 19);

        jLabel7.setText("L.R. No.");
        Tab1.add(jLabel7);
        jLabel7.setBounds(53, 155, 50, 15);
        ...
        Tab1.add(txtLRNo);
        txtLRNo.setBounds(114, 151, 114, 19);

        jLabel8.setText("Date");
        Tab1.add(jLabel8);
        jLabel8.setBounds(255, 155, 29, 15);
        ...
        Tab1.add(txtLRDate);
        txtLRDate.setBounds(291, 153, 100, 19);

        jLabel9.setText("Invoice No.");
        Tab1.add(jLabel9);
        jLabel9.setBounds(37, 181, 76, 15);
        ...
        txtInvoiceNo.setBounds(114, 178, 114, 19);

        jLabel10.setText("Date");
        Tab1.add(jLabel10);
        jLabel10.setBounds(257, 182, 29, 15);
        ...
        txtInvoiceDate.setBounds(292, 180, 100, 19);

        jLabel11.setText("Transporter ");
        Tab1.add(jLabel11);
        jLabel11.setBounds(23, 234, 82, 15);
        ...
        cmbTransporter.setBounds(114, 230, 274, 24);

        jLabel12.setText("Inward No.");
        Tab1.add(jLabel12);
        jLabel12.setBounds(26, 296, 77, 15);
        ...
        txtGatepassNo.setBounds(114, 294, 114, 19);

        jLabel13.setText("Currency");
        Tab1.add(jLabel13);
        jLabel13.setBounds(429, 68, 56, 15);
        ...
        cmbCurrency.setBounds(497, 64, 134, 24);

        jLabel14.setText("Rate");
        Tab1.add(jLabel14);
        jLabel14.setBounds(454, 96, 38, 15);
        ...
        chkImportConcess.setBounds(490, 4, 163, 23);
        ...
        chkCancelled.setBounds(657, 3, 85, 23);

        jLabel17.setText("Status");
        Tab1.add(jLabel17);
        jLabel17.setBounds(443, 35, 46, 15);
        ...
        Tab1.add(cmbStatus);
        cmbStatus.setBounds(495, 31, 94, 24);

        jLabel21.setText("Remarks");
        Tab1.add(jLabel21);
        jLabel21.setBounds(48, 339, 62, 15);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(114, 336, 416, 19);
        ...
        Tab1.add(jLabel16);
        jLabel16.setBounds(406, 126, 89, 15);
        ...
        lblTransName.setBounds(31, 266, 86, 15);
        ...
        txtTransName.setBounds(114, 264, 271, 19);
        ...
        Tab2.add(cmdInsert);
        cmdInsert.setBounds(410, 8, 141, 25);
        ...
        Tab2.add(jLabel18);
        jLabel18.setBounds(494, 227, 97, 15);

        jLabel19.setText("Net Amount");
        Tab2.add(jLabel19);
        jLabel19.setBounds(513, 252, 81, 15);
        ...
        Tab2.add(cmdNext2);
        cmdNext2.setBounds(630, 335, 102, 25);
        ...
        Tab2.add(cmdBack2);
        cmdBack2.setBounds(524, 335, 102, 25);
        ...
        txtNetAmount.setBounds(597, 250, 136, 19);

        jLabel23.setText("Final Amount");
        Tab2.add(jLabel23);
        jLabel23.setBounds(498, 279, 93, 15);
        ...
        txtFinalAmount.setBounds(599, 277, 136, 19);
        ...
        txtAuditRemarks.setBounds(516, 335, 129, 19);
    ...
    private void cmdInsertFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cmdInsertFocusGained
        // TODO add your handling code here:
        ShowMessage("Click this button to bring Gate Inward selection dialog box");
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,clsSTMReceiptRaw.ModuleID,txtDocNo.getText())) {
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private void TableLKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableLKeyPressed
        ...
        if(TableL.getSelectedColumn()==DataModelL.getColFromVariable("RECEIVED_QTY")) {
            ...
            {
                EnterSTMReceiptRawLotQty ObjLot=new EnterSTMReceiptRawLotQty();
                ...
                if(ObjLot.ShowList()) //Ok Pressed
                {
                    ...
                    for(int i=1;i<=ObjLot.colLot.size();i++) {
                        clsSTMReceiptRawLot ObjItemLot=(clsSTMReceiptRawLot)ObjLot.colLot.get(Integer.toString(i));
    ...
    private void cmdInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertActionPerformed
        ...
        //        "AND STM_NO NOT IN "+
        //        "(SELECT DISTINCT MIR_NO FROM D_INV_GRN_DETAIL WHERE COMPANY_ID ="+ EITLERPGLOBAL.gCompanyID +" AND GRN_TYPE = 3 AND APPROVED =1 AND CANCELLED = 0)";
        if(EITLERPGLOBAL.gCompanyID ==2) {
            ...
            "AND A.STM_NO = B.STM_NO AND B.STM_TYPE = 2 "+
            "AND A.STM_NO <> '' AND A.STM_NO IS NOT NULL "+
            "AND A.STM_NO NOT IN  "+
            "(SELECT DISTINCT D.MIR_NO FROM D_INV_GRN_HEADER C, D_INV_GRN_DETAIL D WHERE C.COMPANY_ID ="+ EITLERPGLOBAL.gCompanyID +" AND D.GRN_TYPE = 3  "+
            "AND C.GRN_NO = D.GRN_NO AND C.APPROVED =1 AND C.CANCELLED = 0)";
        }
        ...
        if(aList.ShowLOV()) {
            ...
            if(EITLERPGLOBAL.gCompanyID==2) {
                ...
                List=clsSTMRaw.getSTMItemList(tmpCompanyId,STMNo,false,STMType,dbURL);
                DeptID=5;
            }
            ...
            Qry = "SELECT D_COM_PARAMETER_MAST.DESC FROM D_COM_PARAMETER_MAST "+
            "WHERE PARA_ID='TRANSPORT' AND PARA_CODE = (SELECT TRANSPORTER FROM D_INV_STM_HEADER WHERE STM_NO = '" + STMNo + "' )";
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            String ItemName = clsItem.getItemName(tmpCompanyId,ObjItem.getAttribute("ITEM_ID").getString(),dbURL);
            ...
            DataModelL.setValueByVariable("QTY",String.valueOf(ObjItem.getAttribute("QTY").getDouble()),NewRow);
            DataModelL.setValueByVariable("EXCESS_QTY",String.valueOf("0.0"),NewRow);
            DataModelL.setValueByVariable("CHALAN_QTY","0.0",NewRow);
            DataModelL.setValueByVariable("RATE",String.valueOf(ObjItem.getAttribute("RATE").getDouble()),NewRow);
            DataModelL.setValueByVariable("LANDED_RATE",String.valueOf(ObjItem.getAttribute("RATE").getDouble()),NewRow);
            ...
            DataModelL.setValueByVariable("UNIT_ID",String.valueOf(ObjItem.getAttribute("UNIT").getInt()),NewRow);
            DataModelL.setValueByVariable("REMARKS",ObjItem.getAttribute("REMARKS").getString(),NewRow);
            
            DataModelL.setValueByVariable("NET_AMOUNT",String.valueOf(ObjItem.getAttribute("QTY").getDouble() * ObjItem.getAttribute("RATE").getDouble()),NewRow);
            DataModelL.setValueByVariable("GROSS_AMOUNT",String.valueOf(ObjItem.getAttribute("QTY").getDouble() * ObjItem.getAttribute("RATE").getDouble()),NewRow);
    ...
    private void DisplayData() {
        ...
        try {
            ClearFields();
            txtDocNo.setText((String)ObjSTM.getAttribute("GRN_NO").getObj());
            lblTitle.setText("STM Receipt (Raw Material) - "+txtDocNo.getText());
            lblRevNo.setText(Integer.toString((int)ObjSTM.getAttribute("REVISION_NO").getVal()));
            txtDocDate.setText(EITLERPGLOBAL.formatDate((String)ObjSTM.getAttribute("GRN_DATE").getObj()));
            txtSuppCode.setText((String)ObjSTM.getAttribute("SUPP_ID").getObj());
            
            txtSuffix.setText((String)ObjSTM.getAttribute("REFA").getObj());
            txtSuppName.setText(clsSupplier.getSupplierName(EITLERPGLOBAL.gCompanyID, txtSuppCode.getText()));
            
            if(txtSuppCode.getText().trim().equals("000000")) {
                txtSuppName.setText((String)ObjSTM.getAttribute("PARTY_NAME").getObj());
            }
            
            txtChalanNo.setText((String)ObjSTM.getAttribute("CHALAN_NO").getObj());
            txtChalanDate.setText(EITLERPGLOBAL.formatDate((String)ObjSTM.getAttribute("CHALAN_DATE").getObj()));
            txtLRNo.setText((String)ObjSTM.getAttribute("LR_NO").getObj());
            txtLRDate.setText(EITLERPGLOBAL.formatDate((String)ObjSTM.getAttribute("LR_DATE").getObj()));
            txtInvoiceNo.setText((String)ObjSTM.getAttribute("INVOICE_NO").getObj());
            txtInvoiceDate.setText(EITLERPGLOBAL.formatDate((String)ObjSTM.getAttribute("INVOICE_DATE").getObj()));
            EITLERPGLOBAL.setComboIndex(cmbTransporter,(int)ObjSTM.getAttribute("TRANSPORTER").getVal());
            txtGatepassNo.setText((String)ObjSTM.getAttribute("GATEPASS_NO").getObj());
            txtTransName.setText((String)ObjSTM.getAttribute("TRANSPORTER_NAME").getObj());
            EITLERPGLOBAL.setComboIndex(cmbCurrency,(int)ObjSTM.getAttribute("CURRENCY_ID").getVal());
            txtCurrencyRate.setText(Double.toString(ObjSTM.getAttribute("CURRENCY_RATE").getVal()));
            txtPaymentRate.setText(Double.toString(ObjSTM.getAttribute("CURRENCY_RATE_PAYMENT").getVal()));
            EITLERPGLOBAL.setComboIndex(cmbStatus,(String)ObjSTM.getAttribute("OPEN_STATUS").getObj());
            
            chkImportConcess.setSelected(ObjSTM.getAttribute("IMPORT_CONCESS").getBool());
            chkCancelled.setSelected(ObjSTM.getAttribute("CANCELLED").getBool());
            txtRemarks.setText((String)ObjSTM.getAttribute("REMARKS").getObj());
            txtInvoiceAmount.setText(Double.toString(ObjSTM.getAttribute("INVOICE_AMOUNT").getVal()));
            
            
            EITLERPGLOBAL.setComboIndex(cmbHierarchy,(int)ObjSTM.getAttribute("HIERARCHY_ID").getVal());
            
            EITLERPGLOBAL.setComboIndex(cmbPFPost,ObjSTM.getAttribute("PF_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbFreightPost,ObjSTM.getAttribute("FREIGHT_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbOctroiPost,ObjSTM.getAttribute("OCTROI_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbInsurancePost,ObjSTM.getAttribute("INSURANCE_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbClearancePost,ObjSTM.getAttribute("CLEARANCE_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbAirFreightPost,ObjSTM.getAttribute("AIR_FREIGHT_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbOthersPost,ObjSTM.getAttribute("OTHERS_POST").getInt());
            EITLERPGLOBAL.setComboIndex(cmbPaymentType,ObjSTM.getAttribute("PAYMENT_TYPE").getInt());
            ...
            FormatGridA();
            HashMap List=new HashMap();
            String DocNo=(String)ObjSTM.getAttribute("GRN_NO").getObj();
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 181, DocNo);
            for(int i=1;i<=List.size();i++) {
            ...
            FormatGridHS();
            HashMap History=clsSTMReceiptRaw.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for(int i=1;i<=History.size();i++) {
                clsSTMReceiptRaw ObjHistory=(clsSTMReceiptRaw)History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        ObjSTM.setAttribute("GRN_DATE",EITLERPGLOBAL.formatDateDB(txtDocDate.getText()));
        ObjSTM.setAttribute("SUPP_ID",txtSuppCode.getText());
        
        ObjSTM.setAttribute("PARTY_NAME","");
        if(txtSuppCode.getText().trim().equals("000000")) {
            ObjSTM.setAttribute("PARTY_NAME",txtSuppName.getText());
        }
        
        ObjSTM.setAttribute("REFA",txtSuffix.getText());
        ObjSTM.setAttribute("CHALAN_NO",txtChalanNo.getText());
        ObjSTM.setAttribute("CHALAN_DATE",EITLERPGLOBAL.formatDateDB(txtChalanDate.getText()));
        ObjSTM.setAttribute("LR_NO",txtLRNo.getText());
        ObjSTM.setAttribute("LR_DATE",EITLERPGLOBAL.formatDateDB(txtLRDate.getText()));
        ObjSTM.setAttribute("INVOICE_NO",txtInvoiceNo.getText());
        ObjSTM.setAttribute("INVOICE_DATE",EITLERPGLOBAL.formatDateDB(txtInvoiceDate.getText()));
        ObjSTM.setAttribute("TRANSPORTER",EITLERPGLOBAL.getComboCode(cmbTransporter));
        ObjSTM.setAttribute("TRANSPORTER_NAME",txtTransName.getText());
        ObjSTM.setAttribute("GATEPASS_NO",txtGatepassNo.getText());
        ObjSTM.setAttribute("CURRENCY_ID",EITLERPGLOBAL.getComboCode(cmbCurrency));
        ObjSTM.setAttribute("CURRENCY_RATE",EITLERPGLOBAL.round(Double.parseDouble(txtCurrencyRate.getText()),3));
        ObjSTM.setAttribute("CURRENCY_RATE_PAYMENT",EITLERPGLOBAL.round(Double.parseDouble(txtPaymentRate.getText()),3));
        ObjSTM.setAttribute("OPEN_STATUS",EITLERPGLOBAL.getCombostrCode(cmbStatus));
        ObjSTM.setAttribute("PF_POST",EITLERPGLOBAL.getComboCode(cmbPFPost));
        ObjSTM.setAttribute("FREIGHT_POST",EITLERPGLOBAL.getComboCode(cmbFreightPost));
        ObjSTM.setAttribute("OCTROI_POST",EITLERPGLOBAL.getComboCode(cmbOctroiPost));
        ObjSTM.setAttribute("INSURANCE_POST",EITLERPGLOBAL.getComboCode(cmbInsurancePost));
        ObjSTM.setAttribute("CLEARANCE_POST",EITLERPGLOBAL.getComboCode(cmbClearancePost));
        ObjSTM.setAttribute("AIR_FREIGHT_POST",EITLERPGLOBAL.getComboCode(cmbAirFreightPost));
        ObjSTM.setAttribute("OTHERS_POST",EITLERPGLOBAL.getComboCode(cmbOthersPost));
        ObjSTM.setAttribute("PAYMENT_TYPE",EITLERPGLOBAL.getComboCode(cmbPaymentType));
        ObjSTM.setAttribute("INVOICE_AMOUNT",EITLERPGLOBAL.round(Double.parseDouble(txtInvoiceAmount.getText()),3));
        
        
        if(chkImportConcess.isSelected()) {
            ObjSTM.setAttribute("IMPORT_CONCESS",true);
        }
        else {
            ObjSTM.setAttribute("IMPORT_CONCESS",false);
        }
        ...
        ObjSTM.setAttribute("GRN_TYPE",clsSTMReceiptRaw.GRNType);  //Fixed type 2 - Raw Material, 1 - General, 3 - STM Raw Material
        ObjSTM.setAttribute("FOR_STORE",clsUser.getDeptID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID));
        ...
        //        ObjSTM.setAttribute("FIN_HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbFinHierarchy));
        ...
        if(OpgReject.isSelected()) {
            ...
            ObjSTM.setAttribute("SEND_DOC_TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        }
        ...
        for(int i=0;i<TableH.getRowCount();i++) {
            ...
            if( (ColID!=0) && (ColID!=-99) && (!Variable.substring(0,2).equals("P_"))) {
                ...
                ObjSTM.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_AMT",EITLERPGLOBAL.round(Double.parseDouble(DataModelH.getValueByVariableEx(Variable, 1)),3));
        ...
        for(int i=0;i<TableL.getRowCount();i++) {
            ...
            for(int l=1;l<=lcolLot.size();l++) {
                clsSTMReceiptRawLot ObjLot=new clsSTMReceiptRawLot();
                clsSTMReceiptRawLot ObjList=(clsSTMReceiptRawLot)lcolLot.get(Integer.toString(l));
    ...
    private void SetupColumns() {
        ...
        List=clsColumn.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND MODULE_ID='" + clsSTMReceiptRaw.ModuleID +"' AND HEADER_LINE='L' ORDER BY COL_ORDER");
        ...
        ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID='" + clsSTMReceiptRaw.ModuleID + "' AND HIDDEN=0 AND SHOW_LAST=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        ...
        ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID='" + clsSTMReceiptRaw.ModuleID + "' AND HIDDEN=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        for(int i=1;i<=ColList.size();i++) {
            clsSystemColumn ObjColumn=(clsSystemColumn)ColList.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID='" + clsSTMReceiptRaw.ModuleID + "' AND HIDDEN=0 AND SHOW_LAST=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
            for(int i=1;i<=ColList.size();i++) {
                clsSystemColumn ObjColumn=(clsSystemColumn)ColList.get(Integer.toString(i));
    ...
    private void UpdateResults(int pCol) {
        if(!DoNotEvaluate) {
            try {
                ...
                if(result!=null) {
                    String RoundNum=Double.toString(EITLERPGLOBAL.round(Double.parseDouble(result.toString())*CurrencyRate,3));
    ...
    private void SetupColumns_H() {
        ...
        List=clsColumn.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND MODULE_ID='" + clsSTMReceiptRaw.ModuleID + "' AND HEADER_LINE='H' ORDER BY COL_ORDER");
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=" + clsSTMReceiptRaw.ModuleID);
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsSTMReceiptRaw.ModuleID);
        }
        for(int i=1;i<=List.size();i++) {
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, 181,(String)ObjSTM.getAttribute("GRN_NO").getObj());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsSTMReceiptRaw.ModuleID,(String)ObjSTM.getAttribute("GRN_NO").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsSTMReceiptRaw.ModuleID,FromUserID,(String)ObjSTM.getAttribute("GRN_NO").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,11811)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,11783)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,11814)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void UpdateAmounts() {
        ...
        try {
            ...
            txtGrossAmount.setText(Double.toString(EITLERPGLOBAL.round(lnSumGrossAmount,3)));
            txtNetAmount.setText(Double.toString(EITLERPGLOBAL.round(lnSumNetAmount,3)));
            txtFinalAmount.setText(Double.toString(EITLERPGLOBAL.round(lnSumNetAmount+lnGrossAmount,3)));
    ...
    private boolean Validate() {
        ...
        for(int i=0;i<TableL.getRowCount();i++) {
            ...
            if(TableL.getValueAt(i, ItemCol)!=null && TableL.getValueAt(i, RateCol)!=null && TableL.getValueAt(i, QtyCol)!=null) {
                ...
                if(clsItem.IsValidItemID(EITLERPGLOBAL.gCompanyID, ItemID) && DeptID>0) {
                    ValidEntryCount++;
                } else {
        ...
        if(txtDocDate.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null,"Please enter STM Receipt Date");
            return false;
        }
        ...
        if(!EITLERPGLOBAL.isDate(txtDocDate.getText())) {
            JOptionPane.showMessageDialog(null,"Invalid STM Receipt Date");
            return false;
        }
        ...
        //CHECK THE TOTAL ITEM OF THE STM RECEIPT AND STM DETAIL
        String dbURL="";
        int tmpCompanyId=0;
        if(EITLERPGLOBAL.gCompanyID==2) {
            tmpCompanyId = 3;
    ...
    private void Add() {
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 181, FFNo,  false));
    ...
    private void Edit() {
        ...
        String lDocNo=(String)ObjSTM.getAttribute("GRN_NO").getObj();
        if(ObjSTM.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(clsSTMReceiptRaw.ModuleID,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,542)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Stores.frmSTMReceiptFind",true);
        frmSTMReceiptFind ObjReturn= (frmSTMReceiptFind) ObjLoader.getObj();
    ...
    public void FindEx(int pCompanyID,String pDocNo) {
        ObjSTM.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND GRN_NO='"+pDocNo+"' AND GRN_TYPE='" + clsSTMReceiptRaw.GRNType + "'",pCompanyID);
        ObjSTM.MoveLast();
        DisplayData();
    }
    ...
    public void FindByCompany(int pCompanyID,String pDocNo) {
        ...
        ObjSTM.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND GRN_NO='"+pDocNo+"' AND GRN_TYPE='" + clsSTMReceiptRaw.GRNType + "'",pCompanyID,dbURL);
        ObjSTM.MoveLast();
        DisplayData();
    }
    
    public void FindWaiting() {
        ObjSTM.Filter(" WHERE GRN_NO IN(SELECT D_INV_GRN_HEADER.GRN_NO FROM D_INV_GRN_HEADER,D_COM_DOC_DATA WHERE D_INV_GRN_HEADER.GRN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_GRN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_GRN_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_COM_DOC_DATA.USER_ID="+EITLERPGLOBAL.gNewUserID+" AND D_COM_DOC_DATA.STATUS='W' AND D_INV_GRN_HEADER.GRN_TYPE='" + clsSTMReceiptRaw.GRNType + "' AND MODULE_ID='" + clsSTMReceiptRaw.ModuleID + "')",EITLERPGLOBAL.gCompanyID);
        ObjSTM.MoveLast();
        DisplayData();
    }
...
//            try {
//                String GRNNo=ObjSTM.getAttribute("GRN_NO").getString();
//                
...
//        }
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsSTMReceiptRaw.ModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsSTMReceiptRaw.ModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsSTMReceiptRaw.ModuleID,txtDocNo.getText());
    ...
    private void PreviewReport() {
        ...
        try {
            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptSTMReceiptRaw.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
            System.out.println("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptSTMReceiptRaw.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
        }
        catch(Exception e) {
