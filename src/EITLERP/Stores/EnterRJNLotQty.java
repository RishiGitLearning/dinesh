...
public class EnterRJNLotQty extends javax.swing.JApplet {
    ...
    private void GenerateGrid() {
        ...
        for(int i=1;i<=colLot.size();i++) {
            clsRJNLot ObjLot=(clsRJNLot)colLot.get(Integer.toString(i));
            Object[] rowData=new Object[3];
    ...
    private void SetLot() {
        ...
        for(int i=0;i<Table.getRowCount();i++) {
            ...
            ObjLot.setAttribute("RJN_NO",RJNNo);
            ObjLot.setAttribute("RJN_SR_NO",RJNSrNo);
