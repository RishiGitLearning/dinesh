...
public class frmIssueRawFind extends javax.swing.JApplet {
    ...
    private void cmdClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdClearActionPerformed
        // TODO add your handling code here:
        strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND ISSUE_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND ISSUE_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' AND FOR_STORE='R'";
        Cancelled=false;
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       String subQuery="";
       strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND FOR_STORE='R' ";
