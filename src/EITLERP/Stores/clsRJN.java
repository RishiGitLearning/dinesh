...
public class clsRJN {
    ...
    public clsRJN() {
        ...
        props.put("RJN_TYPE",new Variant(2)); //1 - General, 2- Raw Material
    ...
    public boolean LoadData(int pCompanyID) {
        ...
        try {
            ...
            rsResultSet=Stmt.executeQuery("SELECT * FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+pCompanyID+" AND RJN_TYPE=2 AND RJN_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND RJN_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ORDER BY RJN_NO "); //2 -Raw material rejection memo
            HistoryView=false;
            Ready=true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        Statement stItem,stLot,stStock,stTmp,stItemMaster,stPO,stHistory,stHDetail,stHLot;
        ...
        try {
            ...
            rsHDetail.first();
            rsHLot=stHLot.executeQuery("SELECT * FROM D_INV_RJN_LOT_H WHERE RJN_NO='1'");
            rsHLot.first();
            //------------------------------------//
            ...
            for(int i=1;i<=colRJNItems.size();i++) {
                clsRJNItem ObjItem=(clsRJNItem)colRJNItems.get(Integer.toString(i));
                ...
                if((!GRNNo.trim().equals(""))&&(GRNSrNo>0)) //GRN No. entered
                {
                    ...
                    strSQL="SELECT REJECTED_QTY FROM D_INV_GRN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND GRN_NO='"+GRNNo+"' AND SR_NO="+GRNSrNo+" AND GRN_TYPE=2";
                    ...
                    PrevQty=0;
                    stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                    strSQL="SELECT SUM(QTY) AS SUMQTY FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND GRN_NO='"+GRNNo+"' AND GRN_SR_NO="+GRNSrNo+" AND RJN_TYPE=2 AND RJN_NO NOT IN(SELECT RJN_NO FROM D_INV_RJN_HEADER WHERE CANCELLED=1)";
                    rsTmp=stTmp.executeQuery(strSQL);
                    rsTmp.first();
            ...
            if(AStatus.equals("F")) {
                ...
                /*if(clsItem.getMaintainStock(CompanyID,ItemID)) {
                    for(int l=1;l<=ObjItem.colItemLot.size();l++) {
                        clsRJNLot ObjLot=(clsRJNLot)ObjItem.colItemLot.get(Integer.toString(l));
            ...
            if(UserDocNo) {
                ...
                //--------- Generate New RJN No. ------------
                setAttribute("RJN_NO",clsFirstFree.getNextFreeNo((int)EITLERPGLOBAL.gCompanyID,10, (int)getAttribute("FFNO").getVal(),true));
                //-------------------------------------------------
            }
            //-------------------------------------------------
            ...
            rsLot=stLot.executeQuery("SELECT * FROM D_INV_RJN_LOT WHERE RJN_NO='1'");
            rsLot.first();
            ...
            for(int i=1;i<=colRJNItems.size();i++) {
                ...
                rsItem.updateInt("RJN_TYPE",2); // 2 - Raw Material
                ...
                rsHDetail.updateInt("RJN_TYPE",2); // 2 - Raw Material
                ...
                rsHDetail.updateInt("GRN_TYPE",2);
                ...
                for(int l=1;l<=ObjItem.colItemLot.size();l++) {
                    ...
                    rsLot.updateString("RJN_NO",(String)getAttribute("RJN_NO").getObj());
                    rsLot.updateInt("RJN_SR_NO",i);
                    rsLot.updateInt("RJN_TYPE",2); // 2 - Raw Material
                    ...
                    rsHLot.updateString("RJN_NO",(String)getAttribute("RJN_NO").getObj());
                    rsHLot.updateInt("RJN_SR_NO",i);
                    rsHLot.updateInt("RJN_TYPE",2); // 2 - Raw Material
            ...
            ObjFlow.ModuleID=10; //RJN Raw Material
    ...
    public boolean Update() {
        ...
        try {
            ...
            //stHeader=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            //rsHeader=stHeader.executeQuery("SELECT * FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND TRIM(RJN_NO)='"+theDocNo+"' AND RJN_TYPE=2");
            //rsHeader.first();
            ...
            for(int i=1;i<=colRJNItems.size();i++) {
                ...
                if((!GRNNo.trim().equals(""))&&(GRNSrNo>0)) //GRN No. entered
                {
                    ...
                    PrevQty=0;
                    stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                    strSQL="SELECT SUM(QTY) AS SUMQTY FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND GRN_NO='"+GRNNo+"' AND GRN_SR_NO="+GRNSrNo+" AND GRN_TYPE=2 AND NOT(RJN_NO='"+RJNNo+"' AND RJN_TYPE=2) AND RJN_NO NOT IN(SELECT RJN_NO FROM D_INV_RJN_HEADER WHERE CANCELLED=1)";
                    rsTmp=stTmp.executeQuery(strSQL);
                    rsTmp.first();
            ...
            /*for(int i=1;i<=colRJNItems.size();i++) {
                ...
                if(MinQty>0) { //Minimum level maintained
                    ...
                    stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                    rsTmp=stTmp.executeQuery("SELECT QTY FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND TRIM(RJN_NO)='"+RJNNo+"' AND SR_NO="+i+" AND RJN_TYPE=2");
                    rsTmp.first();
            ...
            //========= Inserting Into History =================//
            //Get the Maximum Revision No.
            int RevNo=EITLERPGLOBAL.GetQueryResult("SELECT MAX(REVISION_NO) FROM D_INV_RJN_HEADER_H WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND RJN_NO='"+(String)getAttribute("RJN_NO").getObj()+"' AND RJN_TYPE=2");
            RevNo++;
            ...
            data.Execute("DELETE FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_TYPE=2");
            data.Execute("DELETE FROM D_INV_RJN_LOT WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_TYPE=2");
            ...
            if(IsRejected) {
                ...
                data.Execute("UPDATE D_INV_RJN_HEADER_H SET REJECTED=0,CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND RJN_NO='"+ObjFlow.DocNo+"' AND RJN_TYPE=2");
                //Remove Old Records from D_COM_DOC_DATA
                data.Execute("DELETE FROM D_COM_DOC_DATA WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=10 AND DOC_NO='"+ObjFlow.DocNo+"'");
    ...
    private void RevertStockEffect() {
        ...
        try {
            ...
            strSQL="SELECT A.COMPANY_ID,A.RJN_NO,A.SR_NO,A.WAREHOUSE_ID,A.LOCATION_ID,B.LOT_QTY,A.ITEM_ID,B.ITEM_LOT_NO,A.BOE_NO FROM D_INV_RJN_DETAIL A,D_INV_RJN_LOT B WHERE A.COMPANY_ID=B.COMPANY_ID AND A.RJN_NO=B.RJN_NO AND A.SR_NO=B.RJN_SR_NO AND A.RJN_TYPE=B.RJN_TYPE AND A.COMPANY_ID="+CompanyID+" AND A.RJN_NO='"+RJNNo+"' AND A.RJN_TYPE=2";
            ...
            /*while(!rsTmp.isAfterLast()) {
                ...
                stItem=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rsItem=stItem.executeQuery("SELECT * FROM D_INV_ITEM_LOT_MASTER WHERE COMPANY_ID="+CompanyID+" AND TRIM(ITEM_ID)='"+ItemID.trim()+"' AND TRIM(BOE_NO)='"+BOENo.trim()+"' AND TRIM(LOT_NO)='"+LotNo.trim()+"' AND TRIM(WAREHOUSE_ID)='"+WareHouseID.trim()+"' AND TRIM(LOCATION_ID)='"+LocationID.trim()+"'");
                rsItem.first();
            ...
            strSQL="SELECT * FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_TYPE=2";
    ...
    public boolean Delete(int pUserID) {
        try {
            ...
            if(CanDelete(lCompanyID,lDocNo,pUserID)) {
                ...
                data.Execute("DELETE FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+lCompanyID+" AND RJN_NO='"+lDocNo.trim()+"' AND RJN_TYPE=2");
                data.Execute("DELETE FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+lCompanyID+" AND RJN_NO='"+lDocNo.trim()+"' AND RJN_TYPE=2");
                data.Execute("DELETE FROM D_INV_RJN_LOT WHERE COMPANY_ID="+lCompanyID+" AND RJN_NO='"+lDocNo.trim()+"' AND RJN_TYPE=2");
    ...
    public Object getObject(int pCompanyID,String pDocNo) {
        String strCondition = " WHERE COMPANY_ID=" + Integer.toString(pCompanyID)+" AND RJN_NO='"+pDocNo+"' AND RJN_TYPE=2";
        clsRJN ObjRJN = new clsRJN();
        ObjRJN.Filter(strCondition,pCompanyID);
        return ObjRJN;
    }
    ...
    public boolean Filter(String pCondition,int pCompanyID) {
        ...
        try {
            ...
            if(!rsResultSet.first()) {
                strSql = "SELECT * FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+Long.toString(pCompanyID)+" AND RJN_TYPE=2 AND RJN_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND RJN_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ORDER BY RJN_NO ";
                rsResultSet=Stmt.executeQuery(strSql);
                Ready=true;
                MoveLast();
                return false;
    ...
    public boolean setData() {
        ...
        try {
            ...
            if(HistoryView) {
                rsItem=stItem.executeQuery("SELECT * FROM D_INV_RJN_DETAIL_H WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_TYPE=2 AND REVISION_NO="+RevNo+" ORDER BY SR_NO");
            }
            else {
                rsItem=stItem.executeQuery("SELECT * FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_TYPE=2 ORDER BY SR_NO");
            }
            rsItem.first();
            ...
            while(!rsItem.isAfterLast()&&rsItem.getRow()>0) {
                ...
                stLot=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                if(HistoryView) {
                    rsLot=stLot.executeQuery("SELECT * FROM D_INV_RJN_LOT_H WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_SR_NO="+SrNo+" AND RJN_TYPE=2 AND REVISION_NO="+RevNo+" ORDER BY SR_NO");
                }
                else {
                    rsLot=stLot.executeQuery("SELECT * FROM D_INV_RJN_LOT WHERE COMPANY_ID="+CompanyID+" AND RJN_NO='"+RJNNo+"' AND RJN_SR_NO="+SrNo+" AND RJN_TYPE=2 ORDER BY SR_NO");
                }
                rsLot.first();
                ...
                while((!rsLot.isAfterLast())&&(rsLot.getRow()>0)) {
                    ...
                    ObjLot.setAttribute("RJN_NO",rsLot.getString("RJN_NO"));
                    ObjLot.setAttribute("RJN_SR_NO",rsLot.getInt("RJN_SR_NO"));
                    ObjLot.setAttribute("RJN_TYPE",rsLot.getInt("RJN_TYPE"));
    ...
    public boolean IsEditable(int pCompanyID,String pDocNo,int pUserID) {
        ...
        try {
            ...
            strSQL="SELECT COUNT(*) AS COUNT FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND RJN_NO='"+pDocNo+"' AND (APPROVED=1) AND RJN_TYPE=2";
            ...
            if(rsTmp.getInt("COUNT")>0)  //Item is Approved
            {
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID=10 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND STATUS='W'";
                tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean CanDelete(int pCompanyID,String pDocNo,int pUserID) {
        ...
        try {
            ...
            if(rsTmp.getInt("COUNT")>0)  //Item is Approved
            {
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM D_COM_DOC_DATA WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND MODULE_ID=10 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND TYPE='C' AND STATUS='W'";
                tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getPendingApprovals(int pCompanyID,int pUserID,int pType,int pOrder,int FinYearFrom) {
        ...
        try {
            if(pOrder==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT D_INV_RJN_HEADER.RJN_NO,D_INV_RJN_HEADER.RJN_DATE,RECEIVED_DATE,0 AS DEPT_ID FROM D_INV_RJN_HEADER,D_COM_DOC_DATA WHERE D_INV_RJN_HEADER.RJN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND D_INV_RJN_HEADER.RJN_TYPE="+pType+" AND MODULE_ID="+(8+pType)+" ORDER BY D_COM_DOC_DATA.RECEIVED_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocDate) {
                strSQL="SELECT D_INV_RJN_HEADER.RJN_NO,D_INV_RJN_HEADER.RJN_DATE,RECEIVED_DATE,0 AS DEPT_ID FROM D_INV_RJN_HEADER,D_COM_DOC_DATA WHERE D_INV_RJN_HEADER.RJN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND D_INV_RJN_HEADER.RJN_TYPE="+pType+" AND MODULE_ID="+(8+pType)+" ORDER BY D_INV_RJN_HEADER.RJN_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocNo) {
                strSQL="SELECT D_INV_RJN_HEADER.RJN_NO,D_INV_RJN_HEADER.RJN_DATE,RECEIVED_DATE,0 AS DEPT_ID FROM D_INV_RJN_HEADER,D_COM_DOC_DATA WHERE D_INV_RJN_HEADER.RJN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND D_INV_RJN_HEADER.RJN_TYPE="+pType+" AND MODULE_ID="+(8+pType)+" ORDER BY D_INV_RJN_HEADER.RJN_NO";
            }
            //strSQL="SELECT D_INV_RJN_HEADER.RJN_NO,D_INV_RJN_HEADER.RJN_DATE FROM D_INV_RJN_HEADER,D_COM_DOC_DATA WHERE D_INV_RJN_HEADER.RJN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND D_INV_RJN_HEADER.RJN_TYPE="+pType+" AND MODULE_ID="+(8+pType);
            ...
            while(!rsTmp.isAfterLast()&&rsTmp.getRow()>0) {
                if(EITLERPGLOBAL.isWithinDate(rsTmp.getString("RJN_DATE"),FinYearFrom))
                {
                Counter=Counter+1;
                clsRJN ObjDoc=new clsRJN();
                
                //------------- Header Fields --------------------//
                ObjDoc.setAttribute("RJN_NO",rsTmp.getString("RJN_NO"));
                ObjDoc.setAttribute("RJN_DATE",rsTmp.getString("RJN_DATE"));
    ...
    public static HashMap getRJNItemList(int pCompanyID,String pRjnNo,boolean pAllData) {
        ...
        try {
            ...
            if(pAllData) {
                strSql = "SELECT * FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND RJN_NO IN (SELECT RJN_NO FROM D_INV_RJN_HEADER WHERE RJN_NO='"+pRjnNo+"' AND APPROVED=1) ORDER BY ITEM_ID";
            }
            else{
                strSql = "SELECT * FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND RJN_NO='"+pRjnNo.trim()+"' AND RJN_NO IN (SELECT RJN_NO FROM D_INV_RJN_HEADER WHERE RJN_NO='"+pRjnNo+"' AND APPROVED=1) ORDER BY ITEM_ID";
            }
            ...
            while(! rsTmp2.isAfterLast()) {
                Counter1++;
                clsRJNItem ObjMRItems=new clsRJNItem();
                ...
                ObjMRItems.setAttribute("REJECTED_REASON_ID",rsTmp2.getInt("REJECTED_REASON_ID"));
                ...
                //Now Fetch Lots.
                int RjnSrno=rsTmp2.getInt("SR_NO");
                
                stLot=tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsLot=stLot.executeQuery("SELECT * FROM D_INV_RJN_LOT WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pRjnNo+"' AND RJN_SR_NO="+RjnSrno);
                rsLot.first();
    ...
    public static HashMap getRJNLotList(int pCompanyID,String pRjnNo,int pSrno,boolean pAllData) {
        ResultSet rsTmp=null;
        Connection tmpConn=null;
        Statement tmpStmt=null;
        ...
        try {
            ...
            tmpStmt=tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
            if(pAllData) {
                strSql = "SELECT * FROM D_INV_RJN_LOT WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" ORDER BY RJN_NO";
            }
            else{
                strSql = "SELECT * FROM D_INV_RJN_LOT WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND RJN_NO='"+pRjnNo.trim()+"' AND RJN_SR_NO="+pSrno+" ORDER BY RJN_SR_NO";
            }
            ...
            while(! rsTmp2.isAfterLast()) {
                Counter1++;
                clsRJNLot ObjMRItems=new clsRJNLot();
                
                ObjMRItems.setAttribute("COMPANY_ID",rsTmp2.getInt("COMPANY_ID"));
                ObjMRItems.setAttribute("RJN_NO",rsTmp2.getString("RJN_NO"));
                ObjMRItems.setAttribute("RJN_SR_NO",rsTmp2.getString("RJN_SR_NO"));
                ObjMRItems.setAttribute("SR_NO",rsTmp2.getLong("SR_NO"));
    ...
    public boolean ShowHistory(int pCompanyID,String pDocNo) {
        ...
        try {
            ...
            rsResultSet=Stmt.executeQuery("SELECT * FROM D_INV_RJN_HEADER_H WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"' AND RJN_TYPE=2");
            Ready=true;
            HistoryView=true;
            MoveFirst();
            return true;
    ...
    public static HashMap getHistoryList(int pCompanyID,String pDocNo) {
        ...
        try {
            ...
            rsTmp=stTmp.executeQuery("SELECT * FROM D_INV_RJN_HEADER_H WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND RJN_NO='"+pDocNo+"' AND RJN_TYPE=2");
    ...
    public static int getRJNType(int pCompanyID,String pDocNo) {
        Connection tmpConn;
        Statement stTmp;
        ResultSet rsTmp;
        ...
        try {
            ...
            rsTmp=stTmp.executeQuery("SELECT RJN_TYPE FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"'");
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                RJNType=rsTmp.getInt("RJN_TYPE");
            }
    ...
    public static String getDocStatus(int pCompanyID,String pDocNo) {
        ...
        try {
            ...
            rsTmp=data.getResult("SELECT RJN_NO,APPROVED,CANCELLED FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"'");
            rsTmp.first();
    ...
    public static boolean CanCancel(int pCompanyID,String pDocNo) {
        ...
        try {
            rsTmp=data.getResult("SELECT RJN_NO FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"' AND CANCELLED=0 AND RJN_TYPE=2");
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                //Now check every item for received qty.
                rsTmp=data.getResult("SELECT RJN_NO FROM D_INV_RJN_DETAIL WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"' AND GATEPASS_QTY>0 AND RJN_TYPE=2");
                rsTmp.first();
    ...
    public static boolean CancelRJN(int pCompanyID,String pDocNo) {
        ...
        try {
            ...
            if(CanCancel(pCompanyID,pDocNo)) {
                ...
                rsTmp=data.getResult("SELECT APPROVED FROM D_INV_RJN_HEADER WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"' AND RJN_TYPE=2");
                rsTmp.first();
                ...
                if(ApprovedDoc) {
                    ...
                    data.Execute("DELETE FROM D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND DOC_NO='"+pDocNo+"' AND MODULE_ID=10");
                }
                
                //Now Update the header with cancel falg to true
                data.Execute("UPDATE D_INV_RJN_HEADER SET CANCELLED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+pCompanyID+" AND RJN_NO='"+pDocNo+"' AND RJN_TYPE=2");
