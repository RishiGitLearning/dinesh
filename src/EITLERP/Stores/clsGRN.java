...
public class clsGRN {
    ...
    public clsGRN() {
        ...
        props.put("GRN_TYPE", new Variant(2)); //2 - Raw Material
    ...
    public boolean LoadData(int pCompanyID) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM D_INV_GRN_HEADER WHERE COMPANY_ID=" + pCompanyID + " AND GRN_TYPE=2 AND GRN_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND GRN_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY GRN_NO");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
        ...
        try {
            ...
            for (int i = 1; i <= colGRNItems.size(); i++) {
                ...
                if ((!MIRNo.trim().equals("")) && (MIRSrNo > 0)) //MIR No. entered
                {
                    ...
                    if (rsTmp.getRow() > 0) {
                        MIRQty = EITLERPGLOBAL.round(rsTmp.getDouble("QTY"), 3);
                    }
                    
                    //Get Total Qty Entered in GRN Against this MIR No.
                    PrevQty = 0;
                    stTmp = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                    strSQL = "SELECT SUM(QTY) AS SUMQTY FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND MIR_NO='" + MIRNo + "' AND MIR_SR_NO=" + MIRSrNo + " AND GRN_TYPE=2 AND GRN_NO NOT IN(SELECT GRN_NO FROM D_INV_GRN_HEADER WHERE CANCELLED=1)";
                    rsTmp = stTmp.executeQuery(strSQL);
                    rsTmp.first();
            ...
            for (int i = 1; i <= colGRNItems.size(); i++) {
                ...
                double MaxQty = EITLERPGLOBAL.round(clsItem.getMaxQty(CompanyID, ItemID), 3);
            ...
            if (AStatus.equals("F")) {
                ...
                for (int i = 1; i <= colGRNItems.size(); i++) {
                    ...
                    RejectedQty = EITLERPGLOBAL.round(ObjItem.getAttribute("REJECTED_QTY").getVal(), 3);
                    ItemID = (String) ObjItem.getAttribute("ITEM_ID").getObj();
                    ...
                    if (clsItem.getMaintainStock(CompanyID, ItemID)) {
                        ...
                        double Rate = EITLERPGLOBAL.round(ObjItem.getAttribute("RATE").getVal(), 3);
                        ...
                        if (rsIssue.getRow() > 0) {
                            while (!rsIssue.isAfterLast()) {
                                IssuedQty = EITLERPGLOBAL.round(rsIssue.getDouble("EXCESS_ISSUE_QTY"), 3);
                        ...
                        } else //Entry already exist. Update the stock values.
                        {
                            ...
                            //======================================================//
                            if (Rate <= 0) {
                                rsStock.updateDouble("ZERO_RECEIPT_QTY", EITLERPGLOBAL.round(rsStock.getDouble("ZERO_RECEIPT_QTY"), 3) + EITLERPGLOBAL.round(lnLotQty, 3));
                                rsStock.updateDouble("ZERO_VAL_QTY", EITLERPGLOBAL.round(rsStock.getDouble("ZERO_VAL_QTY"), 3) + EITLERPGLOBAL.round(lnLotQty, 3));
                            }
                            
                            rsStock.updateDouble("TOTAL_RECEIPT_QTY", EITLERPGLOBAL.round(rsStock.getDouble("TOTAL_RECEIPT_QTY"), 3) + EITLERPGLOBAL.round(lnLotQty, 3));
                            rsStock.updateString("LAST_RECEIPT_DATE", EITLERPGLOBAL.getCurrentDateDB());
                            rsStock.updateDouble("ON_HAND_QTY", EITLERPGLOBAL.round(rsStock.getDouble("ON_HAND_QTY"), 3) + EITLERPGLOBAL.round(lnLotQty, 3));
                            rsStock.updateDouble("AVAILABLE_QTY", EITLERPGLOBAL.round(rsStock.getDouble("AVAILABLE_QTY"), 3) + EITLERPGLOBAL.round(lnLotQty, 3));
                            rsStock.updateInt("MODIFIED_BY", (int) getAttribute("MODIFIED_BY").getVal());
                            rsStock.updateString("MODIFIED_DATE", (String) getAttribute("MODIFIED_DATE").getObj());
                            rsStock.updateBoolean("CHANGED", true);
                            rsStock.updateString("CHANGED_DATE", EITLERPGLOBAL.getCurrentDateDB());
                        ...
                        if (rsItemMaster.getRow() > 0) {
                            double lnQty = EITLERPGLOBAL.round(ObjItem.getAttribute("QTY").getVal(), 3);
                            rsItemMaster.updateDouble("TOTAL_RECEIPT_QTY", EITLERPGLOBAL.round(rsItemMaster.getDouble("TOTAL_RECEIPT_QTY"), 3) + EITLERPGLOBAL.round(lnQty, 3));
                            rsItemMaster.updateString("LAST_RECEIPT_DATE", EITLERPGLOBAL.getCurrentDateDB());
                            rsItemMaster.updateDouble("ON_HAND_QTY", EITLERPGLOBAL.round(rsItemMaster.getDouble("ON_HAND_QTY"), 3) + EITLERPGLOBAL.round(lnQty, 3));
                            rsItemMaster.updateDouble("AVAILABLE_QTY", EITLERPGLOBAL.round(rsItemMaster.getDouble("AVAILABLE_QTY"), 3) + EITLERPGLOBAL.round(lnQty, 3));
            ...
            //--------- Generate New GRN No. ------------
            setAttribute("GRN_NO", clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 8, (int) getAttribute("FFNO").getVal(), true));
            //-------------------------------------------------
            ...
            rsResultSet.updateDouble("CURRENCY_RATE_PAYMENT", EITLERPGLOBAL.round(getAttribute("CURRENCY_RATE_PAYMENT").getVal(), 3));
            ...
            rsHistory.updateDouble("INVOICE_AMOUNT", EITLERPGLOBAL.round(getAttribute("INVOICE_AMOUNT").getDouble(), 3));
            ...
            rsHistory.updateDouble("CURRENCY_RATE_PAYMENT", EITLERPGLOBAL.round(getAttribute("CURRENCY_RATE_PAYMENT").getVal(), 3));
            ...
            //            rsHistory.updateString("COLUMN_31_CAPTION",(String)getAttribute("COLUMN_31_CAPTION").getObj());
            //
            ...
            for (int i = 1; i <= colGRNItems.size(); i++) {
                ...
                rsItem.updateInt("GRN_TYPE", 2);// 2 - Raw Material
                ...
                rsItem.updateDouble("MIR_QTY", EITLERPGLOBAL.round(ObjItem.getAttribute("MIR_QTY").getVal(), 3));
                ...
                rsHDetail.updateInt("GRN_TYPE", 2);// 2 - Raw Material
                ...
                rsHDetail.updateDouble("MIR_QTY", EITLERPGLOBAL.round(ObjItem.getAttribute("MIR_QTY").getVal(), 3));
                ...
                for (int l = 1; l <= ObjItem.colItemLot.size(); l++) {
                    ...
                    rsLot.updateDouble("BALANCE_QTY", EITLERPGLOBAL.round(ObjLot.getAttribute("LOT_ACCEPTED_QTY").getDouble(), 3));
                    ...
                    rsHLot.updateDouble("BALANCE_QTY", EITLERPGLOBAL.round(ObjLot.getAttribute("LOT_ACCEPTED_QTY").getDouble(), 3));
            ...
            ObjFlow.ModuleID = 8; //GRN Raw Material
            ...
            if (AStatus.equals("F")) {
                ...
                for (int i = 1; i <= 3; i++) {
                    if (!data.IsRecordExist(Qry, FinanceGlobal.FinURL)) {
                        ...
                        //   PostVoucher(getAttribute("GRN_NO").getString(), 2,"");
                        String GRNCAPTION = data.getStringValueFromDB("SELECT DISTINCT COLUMN_3_CAPTION FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + getAttribute("GRN_NO").getString() + "'");
                        System.out.print("" + GRNCAPTION);
                        ...
                        if (GRNCAPTION.equals("CGST")) {
                            ...
                            if (GST_value > 0) {
                                ...
                                PostVoucherHSNWiseGST(getAttribute("GRN_NO").getString(), 2, "");
                                ...
                                PostVoucherNonGST(getAttribute("GRN_NO").getString(), 2, "");
                            }
                ...
                if (!data.IsRecordExist(Qry1, FinanceGlobal.FinURL)) {
                    ...
                    data.Execute("UPDATE D_COM_DOC_DATA SET STATUS='W' WHERE DOC_NO='" + ObjFlow.DocNo + "' AND MODULE_ID='"+clsGRN.ModuleID+"' AND STATUS='F'");
    ...
    private void RevertStockEffect() {
        ...
        try {
            ...
            strSQL = "SELECT A.COMPANY_ID,A.GRN_NO,A.SR_NO,A.WAREHOUSE_ID,A.LOCATION_ID,B.LOT_QTY,A.ITEM_ID,B.ITEM_LOT_NO,A.BOE_NO FROM D_INV_GRN_DETAIL A,D_INV_GRN_LOT B WHERE A.COMPANY_ID=B.COMPANY_ID AND A.GRN_NO=B.GRN_NO AND A.SR_NO=B.GRN_SR_NO AND A.GRN_TYPE=B.GRN_TYPE AND A.COMPANY_ID=" + CompanyID + " AND A.GRN_NO='" + GRNNo + "' AND A.GRN_TYPE=2";
            ...
            while (!rsTmp.isAfterLast()) {
                ...
                Qty = EITLERPGLOBAL.round(rsTmp.getDouble("LOT_QTY"), 3);
                ...
                if (rsItem.getRow() > 0) {
                    rsItem.updateDouble("TOTAL_RECEIPT_QTY", EITLERPGLOBAL.round(rsItem.getDouble("TOTAL_RECEIPT_QTY"), 3) - EITLERPGLOBAL.round(Qty, 3));
                    rsItem.updateDouble("ON_HAND_QTY", EITLERPGLOBAL.round(rsItem.getDouble("ON_HAND_QTY"), 3) - EITLERPGLOBAL.round(Qty, 3));
                    rsItem.updateDouble("AVAILABLE_QTY", EITLERPGLOBAL.round(rsItem.getDouble("AVAILABLE_QTY"), 3) - EITLERPGLOBAL.round(Qty, 3));
                    rsItem.updateRow();
                }
                ...
                if (rsItemMaster.getRow() > 0) {
                    rsItemMaster.updateDouble("TOTAL_RECEIPT_QTY", EITLERPGLOBAL.round(rsItemMaster.getDouble("TOTAL_RECEIPT_QTY"), 3) - EITLERPGLOBAL.round(Qty, 3));
                    rsItemMaster.updateDouble("ON_HAND_QTY", EITLERPGLOBAL.round(rsItemMaster.getDouble("ON_HAND_QTY"), 3) - EITLERPGLOBAL.round(Qty, 3));
                    rsItemMaster.updateDouble("AVAILABLE_QTY", EITLERPGLOBAL.round(rsItemMaster.getDouble("AVAILABLE_QTY"), 3) - EITLERPGLOBAL.round(Qty, 3));
                    rsItemMaster.updateRow();
                }
            ...
            strSQL = "SELECT * FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_TYPE=2";
            ...
            while (!rsTmp.isAfterLast()) {
                ...
                RejectedQty = EITLERPGLOBAL.round(rsTmp.getDouble("REJECTED_QTY"), 3);
    ...
    public boolean Update() {
        ...
        try {
            ...
            if (Validate) {
                ...
                for (int i = 1; i <= colGRNItems.size(); i++) {
                    ...
                    if ((!MIRNo.trim().equals("")) && (MIRSrNo > 0)) //MIR No. entered
                    {
                        ...
                        PrevQty = 0;
                        stTmp = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                        strSQL = "SELECT SUM(QTY) AS SUMQTY FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND MIR_NO='" + MIRNo + "' AND MIR_SR_NO=" + MIRSrNo + " AND MIR_TYPE=2 AND NOT(TRIM(GRN_NO)='" + GRNNo + "' AND GRN_TYPE=2) AND GRN_NO NOT IN (SELECT GRN_NO FROM D_INV_GRN_HEADER WHERE CANCELLED=1)";
                        rsTmp = stTmp.executeQuery(strSQL);
                        rsTmp.first();
                ...
                for (int i = 1; i <= colGRNItems.size(); i++) {
                    ...
                    if (MaxQty > 0) {
                        ...
                        stTmp = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                        rsTmp = stTmp.executeQuery("SELECT QTY FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND SR_NO=" + i + " AND GRN_TYPE=2");
                        rsTmp.first();
                        
                        if (rsTmp.getRow() > 0) {
                            AvailableQty = EITLERPGLOBAL.round(AvailableQty, 3) - EITLERPGLOBAL.round(rsTmp.getDouble("QTY"), 3);
                        }
                ...
                if (AStatus.equals("F")) {
                    ...
                    for (int i = 1; i <= colGRNItems.size(); i++) {
                        ...
                        if (clsItem.getMaintainStock(CompanyID, ItemID)) {
                            ...
                            //======= Update the Item Master =========
                            stItemMaster = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                            rsItemMaster = stItemMaster.executeQuery("SELECT * FROM D_INV_ITEM_MASTER WHERE COMPANY_ID=" + CompanyID + " AND ITEM_ID='" + ItemID + "'");
                            rsItemMaster.first();
            ...
            rsResultSet.updateString("INVOICE_NO", (String) getAttribute("INVOICE_NO").getObj());
            rsResultSet.updateString("INVOICE_DATE", (String) getAttribute("INVOICE_DATE").getObj());
            rsResultSet.updateDouble("INVOICE_AMOUNT", EITLERPGLOBAL.round(getAttribute("INVOICE_AMOUNT").getDouble(), 3));
            rsResultSet.updateInt("TRANSPORTER", (int) getAttribute("TRANSPORTER").getVal());
            rsResultSet.updateString("TRANSPORTER_NAME", (String) getAttribute("TRANSPORTER_NAME").getObj());
            rsResultSet.updateString("GATEPASS_NO", (String) getAttribute("GATEPASS_NO").getObj());
            rsResultSet.updateBoolean("IMPORT_CONCESS", getAttribute("IMPORT_CONCESS").getBool());
            ...
            //========= Inserting Into History =================//
            //Get the Maximum Revision No.
            int RevNo = EITLERPGLOBAL.GetQueryResult("SELECT MAX(REVISION_NO) FROM D_INV_GRN_HEADER_H WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND GRN_NO='" + (String) getAttribute("GRN_NO").getObj() + "' AND GRN_TYPE=2");
            RevNo++;
            ...
            data.Execute("DELETE FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_TYPE=2");
            data.Execute("DELETE FROM D_INV_GRN_LOT WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_TYPE=2");
            ...
            if (IsRejected) {
                //Remove the Rejected Flag First
                data.Execute("UPDATE D_INV_GRN_HEADER SET REJECTED=0,CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND GRN_NO='" + ObjFlow.DocNo + "' AND GRN_TYPE=2");
                data.Execute("UPDATE D_INV_GRN_HSN SET REJECTED=0,CHANGED=1,CHANGED_DATE=CURDATE() WHERE GRN_NO='" + ObjFlow.DocNo + "' ");
                //Remove Old Records from D_COM_DOC_DATA
                data.Execute("DELETE FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=8 AND DOC_NO='" + ObjFlow.DocNo + "'");
            ...
            try {
                if (AStatus.equals("F")) {
                    ...
                    //---------for solving not post voucher----------//
                    //                    String Qry="SELECT * FROM D_FIN_VOUCHER_DETAIL WHERE COMPANY_ID = '" + EITLERPGLOBAL.gCompanyID + "' AND GRN_NO = '" + getAttribute("GRN_NO").getString() + "' AND GRN_DATE = '" + getAttribute("GRN_DATE").getString()+ "' ";
                    //                    for(int i=1;i<=3;i++) {
                    //                        if(!data.IsRecordExist(Qry,FinanceGlobal.FinURL)) {
                    
                    //Comment code for updating GST
                    //PostVoucher(getAttribute("GRN_NO").getString(), 2,"");
                    //                        }
                    //                        else {
                    //                            break;
                    ...
                    //
                    //                    Double GST_value = data.getDoubleValueFromDB("SELECT  COALESCE(COLUMN_3_AMT,0)+COALESCE(COLUMN_4_AMT,0)+COALESCE(COLUMN_5_AMT,0)+COALESCE(COLUMN_6_AMT,0)+COALESCE(COLUMN_7_AMT,0)+COALESCE(COLUMN_8_AMT,0) FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + getAttribute("GRN_NO").getString() + "'");
                    //                    System.out.println("GST VAlue : " + GST_value);
                    //                    if (GRNCAPTION.equals("CGST")) {
                    //                        System.out.println("New EXCISE Based");
                    //                        if (GST_value > 0) {
                    //                            System.out.println("NEW GST > 0 : GST");
                    //                            PostVoucherGST(getAttribute("GRN_NO").getString(), 2, "");
                    //
                    //                            //PostDNGST(EITLERPGLOBAL., GRNNo, GRNDate)
                    //                            PostDNGST((int) getAttribute("COMPANY_ID").getVal(), getAttribute("GRN_NO").getString(), getAttribute("GRN_DATE").getString());
                    //                        } else {
                    //                            System.out.println("NEW GST not > 0 : NonGST");
                    //                            PostVoucherNonGST(getAttribute("GRN_NO").getString(), 2, "");
                    //                        }
                    //                    } else {
                    //                        System.out.println("Old EXCISE Based");
    ...
    public boolean Delete(int pUserID) {
        try {
            ...
            if (CanDelete(lCompanyID, lDocNo, pUserID)) {
                ...
                //Give reverse effect to Stock
                //RevertStockEffect();
                data.Execute("DELETE FROM D_INV_GRN_HEADER WHERE COMPANY_ID=" + lCompanyID + " AND GRN_NO='" + lDocNo.trim() + "' AND GRN_TYPE=2");
                data.Execute("DELETE FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + lCompanyID + " AND GRN_NO='" + lDocNo.trim() + "' AND GRN_TYPE=2");
                data.Execute("DELETE FROM D_INV_GRN_LOT WHERE COMPANY_ID=" + lCompanyID + " GRN_NO='" + lDocNo.trim() + "' AND GRN_TYPE=2");
    ...
    public Object getObject(int pCompanyID, String pDocNo) {
        String strCondition = " WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2";
    ...
    public boolean Filter(String pCondition, int pCompanyID) {
        ...
        try {
            ...
            if (!rsResultSet.first()) {
                strSql = "SELECT * FROM D_INV_GRN_HEADER WHERE COMPANY_ID=" + Long.toString(pCompanyID) + " AND GRN_TYPE=2 AND GRN_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND GRN_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY GRN_NO";
                rsResultSet = Stmt.executeQuery(strSql);
                Ready = true;
                MoveLast();
                return false;
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("CURRENCY_RATE_PAYMENT", EITLERPGLOBAL.round(rsResultSet.getDouble("CURRENCY_RATE_PAYMENT"), 3));
            ...
            //             setAttribute("INV_GROSS_AMT", rsResultSet.getString("INV_GROSS_AMT"));
            //            setAttribute("INV_NET_AMT", rsResultSet.getString("INV_NET_AMT"));
            //            setAttribute("INV_FINAL_AMT", rsResultSet.getString("INV_FINAL_AMT"));
            //            setAttribute("INV_INVOICE_AMT", rsResultSet.getString("INV_INVOICE_AMT"));
            //            setAttribute("INV_CGST", rsResultSet.getString("INV_CGST"));
            //            setAttribute("INV_SGST", rsResultSet.getString("INV_SGST"));
            //            setAttribute("INV_IGST", rsResultSet.getString("INV_IGST"));
            //            setAttribute("INV_RCM", rsResultSet.getString("INV_RCM"));
            //            setAttribute("INV_COMPOSITION", rsResultSet.getString("INV_COMPOSITION"));
            //            setAttribute("INV_GST_COMPENSATION_CESS", rsResultSet.getString("INV_GST_COMPENSATION_CESS"));
            //
            //            setAttribute("RCVD_GROSS_AMT", rsResultSet.getString("RCVD_GROSS_AMT"));
            //            setAttribute("RCVD_NET_AMT", rsResultSet.getString("RCVD_NET_AMT"));
            //            setAttribute("RCVD_FINAL_AMT", rsResultSet.getString("RCVD_FINAL_AMT"));
            //            setAttribute("RCVD_INVOICE_AMT", rsResultSet.getString("RCVD_INVOICE_AMT"));
            //            setAttribute("RCVD_CGST", rsResultSet.getString("RCVD_CGST"));
            //            setAttribute("RCVD_SGST", rsResultSet.getString("RCVD_SGST"));
            //            setAttribute("RCVD_IGST", rsResultSet.getString("RCVD_IGST"));
            //            setAttribute("RCVD_RCM", rsResultSet.getString("RCVD_RCM"));
            //            setAttribute("RCVD_COMPOSITION", rsResultSet.getString("RCVD_COMPOSITION"));
            //            setAttribute("RCVD_GST_COMPENSATION_CESS", rsResultSet.getString("RCVD_GST_COMPENSATION_CESS"));
            //
            //            setAttribute("DB_GROSS_AMT", rsResultSet.getString("DB_GROSS_AMT"));
            //            setAttribute("DB_NET_AMT", rsResultSet.getString("DB_NET_AMT"));
            //            setAttribute("DB_FINAL_AMT", rsResultSet.getString("DB_FINAL_AMT"));
            //            setAttribute("DB_INVOICE_AMT", rsResultSet.getString("DB_INVOICE_AMT"));
            //            setAttribute("DB_CGST", rsResultSet.getString("DB_CGST"));
            //            setAttribute("DB_SGST", rsResultSet.getString("DB_SGST"));
            //            setAttribute("DB_IGST", rsResultSet.getString("DB_IGST"));
            //            setAttribute("DB_RCM", rsResultSet.getString("DB_RCM"));
            //            setAttribute("DB_COMPOSITION", rsResultSet.getString("DB_COMPOSITION"));
            //            setAttribute("DB_GST_COMPENSATION_CESS", rsResultSet.getString("DB_GST_COMPENSATION_CESS"));
            ...
            stItem = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            if (HistoryView) {
                rsItem = stItem.executeQuery("SELECT * FROM D_INV_GRN_DETAIL_H WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_TYPE=2 AND REVISION_NO=" + RevNo + " ORDER BY SR_NO");
            } else {
                rsItem = stItem.executeQuery("SELECT * FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_TYPE=2 ORDER BY SR_NO");
            }
            rsItem.first();
            ...
            while (!rsItem.isAfterLast() && rsItem.getRow() > 0) {
                ...
                ObjItem.setAttribute("MIR_QTY", EITLERPGLOBAL.round(rsItem.getDouble("MIR_QTY"), 3));
                ...
                stLot = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                if (HistoryView) {
                    rsLot = stLot.executeQuery("SELECT * FROM D_INV_GRN_LOT_H WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_SR_NO=" + SrNo + " AND GRN_TYPE=2 AND REVISION_NO=" + RevNo + " ORDER BY SR_NO");
                } else {
                    rsLot = stLot.executeQuery("SELECT * FROM D_INV_GRN_LOT WHERE COMPANY_ID=" + CompanyID + " AND GRN_NO='" + GRNNo + "' AND GRN_SR_NO=" + SrNo + " AND GRN_TYPE=2 ORDER BY SR_NO");
                }
                ...
                while ((!rsLot.isAfterLast()) && (rsLot.getRow() > 0)) {
                    ...
                    ObjLot.setAttribute("LOT_RECEIVED_QTY", EITLERPGLOBAL.round(rsLot.getDouble("LOT_RECEIVED_QTY"), 3));
                    ObjLot.setAttribute("LOT_REJECTED_QTY", EITLERPGLOBAL.round(rsLot.getDouble("LOT_REJECTED_QTY"), 3));
                    ObjLot.setAttribute("LOT_ACCEPTED_QTY", EITLERPGLOBAL.round(rsLot.getDouble("LOT_ACCEPTED_QTY"), 3));
                    ObjLot.setAttribute("BALANCE_QTY", EITLERPGLOBAL.round(rsLot.getDouble("BALANCE_QTY"), 3));
    ...
    public boolean IsEditable(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM D_INV_GRN_HEADER WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND GRN_NO='" + pDocNo + "' AND (APPROVED=1) AND GRN_TYPE=2";
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND MODULE_ID=8 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean CanDelete(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND MODULE_ID=8 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND TYPE='C' AND STATUS='W'";
        ...
        try {
            ...
            if (rsTmp.getRow() > 0) {
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    ObjItem.setAttribute("EXCESS_QTY", EITLERPGLOBAL.round(rsTmp.getDouble("EXCESS_QTY"), 3));
                    ObjItem.setAttribute("PO_QTY", EITLERPGLOBAL.round(rsTmp.getDouble("PO_QTY"), 3));
                    ObjItem.setAttribute("RECEIVED_QTY", EITLERPGLOBAL.round(rsTmp.getDouble("RECEIVED_QTY"), 3));
                    ObjItem.setAttribute("BALANCE_PO_QTY", EITLERPGLOBAL.round(rsTmp.getDouble("BALANCE_PO_QTY"), 3));
                    ...
                    ObjItem.setAttribute("REJECTED_QTY", EITLERPGLOBAL.round(rsTmp.getDouble("REJECTED_QTY"), 3));
                    ...
                    if (rsLot.getRow() > 0) {
                        ...
                        while (!rsLot.isAfterLast()) {
                            ...
                            ObjLot.setAttribute("SR_NO", rsLot.getInt("SR_NO"));
                            ObjLot.setAttribute("ITEM_LOT_NO", rsLot.getString("ITEM_LOT_NO"));
                            //ObjLot.setAttribute("LOT_QTY",EITLERPGLOBAL.round(rsLot.getDouble("LOT_QTY"),3));
                            ObjLot.setAttribute("LOT_RECEIVED_QTY", EITLERPGLOBAL.round(rsLot.getDouble("LOT_RECEIVED_QTY"), 3));
    ...
    public boolean ShowHistory(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM D_INV_GRN_HEADER_H WHERE COMPANY_ID=" + pCompanyID + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2");
            Ready = true;
            HistoryView = true;
            MoveFirst();
            return true;
    ...
    public static HashMap getHistoryList(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM D_INV_GRN_HEADER_H WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2");
    ...
    public static boolean CanCancel(int pCompanyID, String pDocNo) {
        ...
        try {
            rsTmp = data.getResult("SELECT GRN_NO FROM D_INV_GRN_HEADER WHERE COMPANY_ID=" + pCompanyID + " AND GRN_NO='" + pDocNo + "' AND CANCELLED=0 AND GRN_TYPE=2");
            rsTmp.first();
    ...
    public static boolean CancelGRN(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            if (CanCancel(pCompanyID, pDocNo)) {
                ...
                rsTmp = data.getResult("SELECT APPROVED FROM D_INV_GRN_HEADER WHERE COMPANY_ID=" + pCompanyID + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2");
                rsTmp.first();
                ...
                if (ApprovedDoc) {
                    rsTmp = data.getResult("SELECT * FROM D_INV_GRN_DETAIL WHERE COMPANY_ID=" + pCompanyID + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2");
                    rsTmp.first();
                    ...
                    data.Execute("DELETE FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + pCompanyID + " AND DOC_NO='" + pDocNo + "' AND MODULE_ID=8");
                }
                
                //Now Update the header with cancel falg to true
                data.Execute("UPDATE D_INV_GRN_HEADER SET CANCELLED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID=" + pCompanyID + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2");
                //data.Execute("UPDATE D_INV_GRN_LOT SET CANCELLED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID="+pCompanyID+" AND GRN_NO='"+pDocNo+"' AND GRN_TYPE=2");
                data.Execute("DELETE FROM D_INV_GRN_LOT WHERE COMPANY_ID=" + pCompanyID + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2");
    ...
    public static boolean IsGRNExist(String pDocNo) {
        ...
        try {
            tmpConn = data.getConn();
            stTmp = tmpConn.createStatement();
            rsTmp = stTmp.executeQuery("SELECT GRN_NO FROM D_INV_GRN_HEADER WHERE GRN_NO='" + pDocNo + "' AND GRN_TYPE=2 AND CANCELLED=0");
            rsTmp.first();
                ...
                if (rsItems.getRow() > 0) {
                    while (!rsItems.isAfterLast()) {
                        ...
                        if (rsTmp.getRow() > 0) {
                            ...
                            objVoucherItem.setAttribute("MODULE_ID", clsGRN.ModuleID);
    ...
    public boolean PostVoucher(String DocNo, int DocType, String ExVoucherNo) {
        ...
        try {
            ...
            if (!PONo.trim().equals("")) {
                ...
                HashMap List = clsApprovalRules.getApprovalRules(EITLERPGLOBAL.gCompanyID, clsGRN.ModuleID, "CHOOSE_HIERARCHY", "PO_TYPE", Integer.toString(POType));
            ...
            HashMap List = clsApprovalRules.getApprovalRules(EITLERPGLOBAL.gCompanyID, clsGRN.ModuleID, "CHOOSE_HIERARCHY", "PAYMENT_TYPE", Integer.toString(PaymentType));
            ...
            List = clsApprovalRules.getApprovalRules(EITLERPGLOBAL.gCompanyID, clsGRN.ModuleID, "POST_VOUCHER", "SUPP_ID", SuppID);
            ...
            //(4) Based on Payment Type, decide whether to post voucher
            List = clsApprovalRules.getApprovalRules(EITLERPGLOBAL.gCompanyID, clsGRN.ModuleID, "POST_VOUCHER", "PAYMENT_TYPE", Integer.toString(PaymentType));
            ...
            if (EITLERPGLOBAL.gCompanyID == 2) {
                objVoucher.setAttribute("BOOK_CODE", "43");
            } else {
            ...
            objVoucher.setAttribute("MODULE_ID", clsGRN.ModuleID);
            ...
            Entry3 = 0;
            Entry4 = 0;
            HashMap debitEntries = getDebitPJVEntries(GRNNo, 2, PONo, PODate, InvoiceNo, InvoiceDate, InvoiceAmount, GRNDate);
    ...
    public boolean PostVoucherNonGST(String DocNo, int DocType, String ExVoucherNo) {
        ...
        try {
            ...
            System.out.println("A2" + GRNNo);
            
            System.out.println("A3" + GRNDate);
            ...
            //Get MIR No.
            String MIRNo = data.getStringValueFromDB("SELECT MIR_NO FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + GRNNo + "' AND GRN_TYPE=2");
            
            System.out.println("A5" + MIRNo);
            if (!MIRNo.trim().equals("")) {
                InvoiceAmount = data.getDoubleValueFromDB("SELECT INVOICE_AMOUNT FROM D_INV_MIR_HEADER WHERE MIR_NO='" + MIRNo + "' AND MIR_TYPE=2");
            }
            ...
            for (int i = 1; i <= objGRN.colGRNItems.size(); i++) {
                ...
                PF += objItem.getAttribute("COLUMN_2_AMT").getDouble();
                Freight += objItem.getAttribute("COLUMN_16_AMT").getDouble();
                FCA += objItem.getAttribute("COLUMN_19_AMT").getDouble();
                ...
                Cess += objItem.getAttribute("COLUMN_14_AMT").getDouble();
                Cenvat += objItem.getAttribute("COLUMN_18_AMT").getDouble();
                ST += objItem.getAttribute("COLUMN_15_AMT").getDouble();
                
                if (objItem.getAttribute("COLUMN_15_PER").getDouble() > 0) {
                    STPer = Double.toString(objItem.getAttribute("COLUMN_15_PER").getDouble());
                }
                
                Octroi += objItem.getAttribute("COLUMN_17_AMT").getDouble();
                
                if (objItem.getAttribute("COLUMN_17_PER").getDouble() > 0) {
                    OctroiPer = Double.toString(objItem.getAttribute("COLUMN_17_PER").getDouble());
                }
                
                CustomDuty += objItem.getAttribute("COLUMN_21_AMT").getDouble();
                ...
                ImportEduCess += objItem.getAttribute("COLUMN_32_AMT").getDouble();
                CVD += objItem.getAttribute("COLUMN_33_AMT").getDouble();
                Surcharge += objItem.getAttribute("COLUMN_24_AMT").getDouble();
                CustomEduCess += objItem.getAttribute("COLUMN_25_AMT").getDouble();
                SpAddDuty += objItem.getAttribute("COLUMN_26_AMT").getDouble();
                SpExcise += objItem.getAttribute("COLUMN_27_AMT").getDouble();
            ...
            Discount += objGRN.getAttribute("COLUMN_1_AMT").getDouble();
            PF += objGRN.getAttribute("COLUMN_2_AMT").getDouble();
            Freight += objGRN.getAttribute("COLUMN_16_AMT").getDouble();
            FCA += objGRN.getAttribute("COLUMN_19_AMT").getDouble();
            ...
            Cess += objGRN.getAttribute("COLUMN_14_AMT").getDouble();
            Cenvat += objGRN.getAttribute("COLUMN_18_AMT").getDouble();
            ST += objGRN.getAttribute("COLUMN_15_AMT").getDouble();
            Octroi += objGRN.getAttribute("COLUMN_17_AMT").getDouble();
            
            CustomDuty += objGRN.getAttribute("COLUMN_21_AMT").getDouble();
            LessDuty += objGRN.getAttribute("COLUMN_32_AMT").getDouble();
            ImportEduCess += objGRN.getAttribute("COLUMN_22_AMT").getDouble();
            CVD += objGRN.getAttribute("COLUMN_23_AMT").getDouble();
            Surcharge += objGRN.getAttribute("COLUMN_24_AMT").getDouble();
            CustomEduCess += objGRN.getAttribute("COLUMN_25_AMT").getDouble();
            SpAddDuty += objGRN.getAttribute("COLUMN_26_AMT").getDouble();
            SpExcise += objGRN.getAttribute("COLUMN_27_AMT").getDouble();
            ...
            Entry3 = 0;
            Entry4 = 0;
            HashMap debitEntries = getDebitPJVEntriesNonGST(GRNNo, 2, PONo, PODate, InvoiceNo, InvoiceDate, InvoiceAmount, GRNDate);
    ...
    public HashMap getDebitPJVEntriesNonGST(String GRNNo, int GRNType, String PONo, String PODate, String InvoiceNo, String InvoiceDate, double InvoiceAmount, String GRNDate) {
        ...
        try {
            ...
            //Derive line level tax Amounts
            rsTmp = data.getResult("SELECT SUM(TOTAL_AMOUNT) AS GROSS_AMOUNT,SUM(COLUMN_1_AMT) AS DISCOUNT,SUM(COLUMN_19_AMT) AS FCA,SUM(COLUMN_2_AMT) AS PF,SUM(COLUMN_16_AMT) AS FREIGHT,SUM(COLUMN_28_AMT) AS INSURANCE,SUM(COLUMN_30_AMT) AS AIR_FREIGHT,SUM(COLUMN_31_AMT) AS OTHERS,SUM(COLUMN_37_AMT) AS TRADE_DISCOUNT,SUM(COLUMN_38_AMT) AS RND_DISCOUNT,SUM(COLUMN_13_AMT) AS EXCISE,SUM(COLUMN_14_AMT) AS CESS,SUM(COLUMN_18_AMT) AS CENVAT,SUM(COLUMN_15_AMT) AS ST,SUM(COLUMN_17_AMT) AS OCTROI,SUM(COLUMN_27_AMT) AS SP_EXCISE FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + GRNNo + "' AND GRN_TYPE=" + GRNType + " ");
            rsTmp.first();
                ...
                if (rsItems.getRow() > 0) {
                    while (!rsItems.isAfterLast()) {
                        ...
                        if (rsTmp.getRow() > 0) {
                            ...
                            if (Entry3 > 0) {
                                double STPercentage = data.getDoubleValueFromDB("SELECT COLUMN_15_PER FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + GRNNo + "' AND GRN_TYPE=" + GRNType + " AND ITEM_ID LIKE '" + ItemGroup + "%'");
                                String ExCode = data.getStringValueFromDB("SELECT EX_ACCOUNT_CODE FROM D_FIN_EX_ACCOUNT_MASTER WHERE PERCENTAGE=" + STPercentage, FinanceGlobal.FinURL);
                                String STAcCode = MainCode;
                    ...
                    if (rsTmp.getRow() > 0) {
                        ...
                        if (Entry3 > 0) {
                            double STPercentage = data.getDoubleValueFromDB("SELECT COLUMN_15_PER FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + GRNNo + "' AND GRN_TYPE=" + GRNType + " ");
                            String ExCode = data.getStringValueFromDB("SELECT EX_ACCOUNT_CODE FROM D_FIN_EX_ACCOUNT_MASTER WHERE PERCENTAGE=" + STPercentage, FinanceGlobal.FinURL);
                            String STAcCode = MainCode;
    ...
    public boolean PostVoucherGST(String DocNo, int DocType, String ExVoucherNo) {
        ...
        try {
            ...
            for (int i = 1; i <= objGRN.colGRNItems.size(); i++) {
                ...
                Others += objItem.getAttribute("COLUMN_31_AMT").getDouble();
                LessDuty += objItem.getAttribute("COLUMN_32_AMT").getDouble();
                ImportEduCess += objItem.getAttribute("COLUMN_22_AMT").getDouble();
                CVD += objItem.getAttribute("COLUMN_23_AMT").getDouble();
            ...
            HashMap debitEntries = getDebitPJVEntriesGST(GRNNo, 2, PONo, PODate, InvoiceNo, InvoiceDate, InvoiceAmount, GRNDate);
            ...
            System.out.println("Entry2 :" + Entry2a);
    ...
    public boolean PostVoucherHSNWiseGST(String DocNo, int DocType, String ExVoucherNo) {
        ...
        try {
            ...
            //DefaultMainCode = clsTRMapping.getMainCodeFromItemCode(EITLERPGLOBAL.gCompanyID, "DEFAULT");   
            DefaultMainCode = clsTRMapping.getMainCodeFromItemCode(EITLERPGLOBAL.gCompanyID, "RMDEFAULT");   
            ...
            // Entry3=0;
            //  Entry4=0;
            //HashMap debitEntries = getDebitPJVEntriesHSNGST(GRNNo, 2, PONo, PODate, InvoiceNo, InvoiceDate, InvoiceAmount, GRNDate);
            HashMap debitEntries = getDebitPJVEntriesHSNGSTwithInputCredit(GRNNo, 2, PONo, PODate, InvoiceNo, InvoiceDate, InvoiceAmount, GRNDate);
            ...
            if (Total > 0) {
                if (rsHSNHeader.getRow() > 0) {
                    while (!rsHSNHeader.isAfterLast()) {
                        ...
                        if (ItemGroup.equals("")) {
                            //MainCode = clsTRMapping.getMainCodeFromItemCode(EITLERPGLOBAL.gCompanyID, "DEFAULT");
                            MainCode = clsTRMapping.getMainCodeFromItemCode(EITLERPGLOBAL.gCompanyID, "RMDEFAULT");
                        } else {
                            MainCode = clsTRMapping.getMainCodeFromItemCode(EITLERPGLOBAL.gCompanyID, ItemGroup);
                        }
    ...
    public HashMap getDebitPJVEntriesGST(String GRNNo, int GRNType, String PONo, String PODate, String InvoiceNo, String InvoiceDate, double InvoiceAmount, String GRNDate) {
        ...
        try {
            ...
            if (UtilFunctions.getInt(rsGRN, "FREIGHT_POST", 0) == 1) {//Freight
                FreightAmount = data.getDoubleValueFromDB("SELECT COLUMN_6_AMT FROM D_INV_GRN_HEADER WHERE GRN_NO='" + GRNNo + "' AND GRN_TYPE=" + GRNType);
                FreightAmount += data.getDoubleValueFromDB("SELECT SUM(COLUMN_16_AMT) FROM D_INV_GRN_DETAIL WHERE GRN_NO='" + GRNNo + "' AND GRN_TYPE=" + GRNType);
            }
            TotalNetAmount = TotalNetAmount - FreightAmount;
            double ItemTotalNetAmount = 0;
            double ItemWeightage = 0;
    ...
    public boolean PostDNGST(int CompanyID, String GRNNo, String GRNDate) {
        try {
            ...
            clsGRN objGRN = (clsGRN) (new clsGRN()).getObject(CompanyID, GRNNo, GRNDate);
            ...
            strSQL += EITLERPGLOBAL.DBName + ".D_INV_GRN_DETAIL B ";
            strSQL += "WHERE ";
            strSQL += "B.GRN_NO='" + GRNNo + "' AND B.GRN_TYPE=2 AND ";
            strSQL += "SUBSTRING(B.ITEM_ID,1,LENGTH(A.ITEM_CODE))=A.ITEM_CODE AND A.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " ";
            ...
            double DB_INVOICE_AMOUNT = objGRN.getAttribute("DB_INVOICE_AMT").getVal();
            double DB_CGST = objGRN.getAttribute("DB_CGST").getVal();
            double DB_SGST = objGRN.getAttribute("DB_SGST").getVal();
            double DB_IGST = objGRN.getAttribute("DB_IGST").getVal();
            double DB_RCM = objGRN.getAttribute("DB_RCM").getVal();
            double DB_COMPOSITION = objGRN.getAttribute("DB_COMPOSITION").getVal();
            double DB_GST_COMPENSATION_CESS = objGRN.getAttribute("DB_GST_COMPENSATION_CESS").getVal();
            double DB_NET_AMOUNT = objGRN.getAttribute("DB_NET_AMT").getVal();
            ...
            System.out.println("DB INVOICE AMT = " + objGRN.getAttribute("DB_INVOICE_AMT").getVal());
            System.out.println("DB CGST = " + objGRN.getAttribute("DB_CGST").getVal());
            System.out.println("DB SGST = " + objGRN.getAttribute("DB_SGST").getVal());
            System.out.println("DB IGST = " + objGRN.getAttribute("DB_IGST").getVal());
            System.out.println("DB RCM = " + objGRN.getAttribute("DB_RCM").getVal());
            System.out.println("DB COMPOSITION = " + objGRN.getAttribute("DB_COMPOSITION").getVal());
            System.out.println("DB_GST_COMPENSATION_CESS = " + objGRN.getAttribute("DB_GST_COMPENSATION_CESS").getVal());
            System.out.println("DB NET AMT = " + objGRN.getAttribute("DB_NET_AMT").getVal());
            ...
            if (objVoucher.Insert()) {
                ...
                System.out.println("RM Purchase DN Vouched Posted " + DNNo);
                return true;
            } else {
    ...
    public boolean PostDNHSNGST(int CompanyID, String GRNNo, String GRNDate) {
        try {
            ...
            clsGRN objGRNGen = (clsGRN) (new clsGRN()).getObject(CompanyID, GRNNo, GRNDate);
