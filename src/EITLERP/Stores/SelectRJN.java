 ...
 * SelectRJN.java
 *
 * Created on May 28, 2004, 1:22 PM
 */
/*<APPLET CODE=SelectRJN.Class HEIGHT=400 WIDTH=700></APPLET>*/
 ...
 * @author  nhpatel
 */
public class SelectRJN extends javax.swing.JApplet {
    ...
    public clsRJNGen ObjRJNGen;
    public clsRJN ObjRJN;
 ...
 public SelectRJN(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn)
 {
     initComponents();
...
//     lblSearch.setLabelFor((Component) txtSearch);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Select Rejeection Memo Items from the List");
        ...
        jLabel2.setBounds(19, 76, 60, 20);

        txtRJNNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtRJNNoKeyPressed(evt);
            }
        });

        getContentPane().add(txtRJNNo);
        txtRJNNo.setBounds(72, 76, 106, 21);
        ...
        cmdShow.setBounds(185, 76, 110, 22);
        ...
        cmbDept.setBounds(72, 48, 224, 24);
    ...
    private void cmdShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowActionPerformed
        // TODO add your handling code here:
        SelRJNNo=txtRJNNo.getText();
        
        String docStatus=clsRJN.getDocStatus(EITLERPGLOBAL.gCompanyID, SelRJNNo);
    ...
    private void txtRJNNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRJNNoKeyPressed
        // TODO add your handling code here:
        // TODO add your handling code here:
        if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            if(chkDept.isSelected())
            {
              aList.SQL="SELECT DISTINCT(D_INV_RJN_HEADER.RJN_NO) AS RJN_NO,DATE_FORMAT(RJN_DATE,'%d/%m/%Y') AS DATE,DEPT_DESC AS DEPT FROM D_INV_RJN_HEADER,D_INV_RJN_DETAIL,D_COM_USER_MASTER,D_COM_DEPT_MASTER WHERE D_INV_RJN_HEADER.COMPANY_ID=D_INV_RJN_DETAIL.COMPANY_ID AND D_INV_RJN_HEADER.RJN_NO=D_INV_RJN_DETAIL.RJN_NO  AND D_INV_RJN_HEADER.RJN_TYPE=D_INV_RJN_DETAIL.RJN_TYPE AND D_INV_RJN_HEADER.APPROVED=1 AND D_INV_RJN_HEADER.CANCELLED=0 AND D_INV_RJN_HEADER.CREATED_BY=D_COM_USER_MASTER.USER_ID AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_USER_MASTER.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DEPT_MASTER.COMPANY_ID AND D_COM_USER_MASTER.DEPT_ID=D_COM_DEPT_MASTER.DEPT_ID AND D_COM_USER_MASTER.DEPT_ID="+SelDeptID+" AND D_INV_RJN_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_INV_RJN_HEADER.RJN_TYPE="+RJNType;  
            }
            else
            {
              aList.SQL="SELECT DISTINCT(D_INV_RJN_HEADER.RJN_NO) AS RJN_NO,DATE_FORMAT(RJN_DATE,'%d/%m/%Y') AS DATE,DEPT_DESC AS DEPT FROM D_INV_RJN_HEADER,D_INV_RJN_DETAIL,D_COM_USER_MASTER,D_COM_DEPT_MASTER WHERE D_INV_RJN_HEADER.COMPANY_ID=D_INV_RJN_DETAIL.COMPANY_ID AND D_INV_RJN_HEADER.RJN_NO=D_INV_RJN_DETAIL.RJN_NO  AND D_INV_RJN_HEADER.RJN_TYPE=D_INV_RJN_DETAIL.RJN_TYPE AND D_INV_RJN_HEADER.APPROVED=1 AND D_INV_RJN_HEADER.CANCELLED=0 AND D_INV_RJN_HEADER.CREATED_BY=D_COM_USER_MASTER.USER_ID AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_USER_MASTER.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DEPT_MASTER.COMPANY_ID AND D_COM_USER_MASTER.DEPT_ID=D_COM_DEPT_MASTER.DEPT_ID AND D_INV_RJN_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_INV_RJN_HEADER.RJN_TYPE="+RJNType;    
            }
            ...
            if(aList.ShowLOV()) {
                txtRJNNo.setText(aList.ReturnVal);
            }
        }
    }//GEN-LAST:event_txtRJNNoKeyPressed
...
private void FormatGrid()    
{
        ...
        DataModel.addColumn("Rejection No.");//7
        DataModel.addColumn("Bal. Qty");//8
...
private void GenerateGrid()
{
    ...
    String RjnNo=txtRJNNo.getText();
    
    if(!RjnNo.equals(""))
    {
       List=clsRJN.getRJNItemList(EITLERPGLOBAL.gCompanyID, RjnNo,false);
       
       for(int i=1;i<=List.size();i++)
       {
           clsRJNItem ObjItem=(clsRJNItem)List.get(Integer.toString(i));
           ...
           rowData[8]=Double.toString(ObjItem.getAttribute("BAL_QTY").getVal());
           ...
           rowData[7]=(String) ObjItem.getAttribute("RJN_NO").getObj();
           rowData[9]=data.getStringValueFromDB("SELECT REMARKS FROM D_INV_RJN_HEADER WHERE RJN_NO ='"+RjnNo+"'");
...
private void SetList()
{
    ...
    if(RJNType==1)
    {
       clsRJNGen tmpObj=new clsRJNGen();
       ObjRJNGen=(clsRJNGen)tmpObj.getObject(EITLERPGLOBAL.gCompanyID, RJNNo);
    }
    else
    {
       clsRJN tmpObj=new clsRJN();
       ObjRJN=(clsRJN)tmpObj.getObject(EITLERPGLOBAL.gCompanyID, RJNNo);
    }
...
public boolean ShowList() {
        try {
            ...
            aDialog=new JDialog(f,"Select RJN Items",true);
