...
/*<APPLET CODE=frmGRN.class HEIGHT=525 WIDTH=773></APPLET>*/
import javax.swing.*;
import java.awt.*;
import java.util.*;
import EITLERP.*;
 ...
 *
 */
public class frmGRN extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jMenuItem1.getAccessibleContext().setAccessibleName("GST");
        ...
        jMenuItem2.getAccessibleContext().setAccessibleName("Non GST");
        ...
        jMenuItem3.getAccessibleContext().setAccessibleName("Non GST Updated");
        ...
        lblTitle.setText(" GOODS RECEIPT NOTE (Raw Material)");
        ...
        txtSuppCode.setBounds(114, 90, 62, 27);

        txtSuppName.setEnabled(false);
        Tab1.add(txtSuppName);
        txtSuppName.setBounds(178, 90, 212, 27);

        jLabel5.setText("Chalan No.");
        Tab1.add(jLabel5);
        jLabel5.setBounds(40, 130, 68, 17);
        ...
        txtChalanNo.setBounds(114, 126, 114, 27);

        jLabel6.setText("Date");
        Tab1.add(jLabel6);
        jLabel6.setBounds(254, 130, 31, 17);
        ...
        txtChalanDate.setBounds(290, 128, 100, 27);

        jLabel7.setText("L.R. No.");
        Tab1.add(jLabel7);
        jLabel7.setBounds(53, 155, 50, 17);
        ...
        Tab1.add(txtLRNo);
        txtLRNo.setBounds(114, 151, 114, 27);

        jLabel8.setText("Date");
        Tab1.add(jLabel8);
        jLabel8.setBounds(255, 155, 31, 17);
        ...
        Tab1.add(txtLRDate);
        txtLRDate.setBounds(291, 153, 100, 27);

        jLabel9.setText("Invoice No.");
        Tab1.add(jLabel9);
        jLabel9.setBounds(37, 181, 76, 17);
        ...
        txtInvoiceNo.setBounds(114, 178, 114, 27);

        jLabel10.setText("Date");
        Tab1.add(jLabel10);
        jLabel10.setBounds(257, 182, 31, 17);
        ...
        txtInvoiceDate.setBounds(292, 180, 100, 27);

        jLabel11.setText("Transporter ");
        Tab1.add(jLabel11);
        jLabel11.setBounds(23, 234, 82, 17);
        ...
        cmbTransporter.setBounds(114, 230, 274, 27);

        jLabel12.setText("Inward No.");
        Tab1.add(jLabel12);
        jLabel12.setBounds(26, 296, 77, 17);
        ...
        txtGatepassNo.setBounds(114, 294, 114, 27);

        jLabel13.setText("Currency");
        Tab1.add(jLabel13);
        jLabel13.setBounds(429, 68, 56, 17);
        ...
        cmbCurrency.setBounds(497, 64, 134, 27);

        jLabel14.setText("Rate");
        Tab1.add(jLabel14);
        jLabel14.setBounds(454, 96, 38, 17);
        ...
        chkImportConcess.setBounds(490, 4, 163, 22);
        ...
        chkCancelled.setBounds(657, 3, 86, 22);

        jLabel17.setText("Status");
        Tab1.add(jLabel17);
        jLabel17.setBounds(443, 35, 46, 17);
        ...
        Tab1.add(cmbStatus);
        cmbStatus.setBounds(495, 31, 94, 27);

        jLabel21.setText("Remarks");
        Tab1.add(jLabel21);
        jLabel21.setBounds(48, 339, 62, 17);
        ...
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(114, 336, 416, 27);
        ...
        Tab1.add(cmdNext1);
        cmdNext1.setBounds(630, 282, 102, 29);
        ...
        txtCurrencyRate.setBounds(498, 94, 97, 21);

        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(220, 15, 33, 17);

        txtSuffix.setName("REFA"); // NOI18N
        txtSuffix.setEnabled(false);
        Tab1.add(txtSuffix);
        txtSuffix.setBounds(114, 63, 62, 27);

        jLabel15.setText("Suffix");
        Tab1.add(jLabel15);
        jLabel15.setBounds(67, 65, 43, 17);
        ...
        txtTransName.setBounds(114, 264, 271, 27);
        ...
        Tab2.add(cmdInsert);
        cmdInsert.setBounds(410, 8, 141, 29);
        ...
        Tab2.add(jLabel18);
        jLabel18.setBounds(494, 227, 97, 17);

        jLabel19.setText("Net Amount");
        Tab2.add(jLabel19);
        jLabel19.setBounds(513, 252, 81, 17);
        ...
        Tab2.add(cmdNext2);
        cmdNext2.setBounds(630, 335, 102, 29);
        ...
        Tab2.add(cmdBack2);
        cmdBack2.setBounds(524, 335, 102, 29);
        ...
        txtGrossAmount.setBounds(596, 224, 138, 27);
        ...
        txtNetAmount.setBounds(597, 250, 136, 27);
        ...
        Tab2.add(cmdShowMIR);
        cmdShowMIR.setBounds(270, 220, 110, 26);
        ...
        Tab2.add(cmdShowPO);
        cmdShowPO.setBounds(390, 220, 90, 26);

        jLabel23.setText("Final Amount");
        Tab2.add(jLabel23);
        jLabel23.setBounds(498, 279, 93, 17);
        ...
        txtInvoiceAmount.setBounds(598, 300, 136, 27);
        ...
        btnHSNUpdate.setBounds(430, 40, 130, 29);
        ...
        Tab3.add(cmdBack3);
        cmdBack3.setBounds(620, 320, 102, 29);
        ...
        jScrollPane2.setBounds(12, 40, 634, 144);

        lblDocumentHistory.setText("Document Update History");
        jPanel1.add(lblDocumentHistory);
        lblDocumentHistory.setBounds(13, 193, 182, 17);
        ...
        jScrollPane3.setBounds(13, 209, 491, 131);
        ...
        cmdViewHistory.setBounds(514, 240, 132, 24);
        ...
        cmdNormalView.setBounds(514, 270, 132, 24);
        ...
        cmdPreviewA.setBounds(514, 210, 132, 24);
        ...
        cmdShowRemarks.setBounds(514, 299, 132, 24);

        txtAuditRemarks.setEnabled(false);
        jPanel1.add(txtAuditRemarks);
        txtAuditRemarks.setBounds(516, 335, 129, 27);

        Tab.addTab("Status", jPanel1);

        getContentPane().add(Tab);
        Tab.setBounds(4, 68, 752, 430);

        lblStatus.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblStatus.setForeground(new java.awt.Color(51, 51, 255));
        lblStatus.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(lblStatus);
        lblStatus.setBounds(0, 500, 752, 22);
    ...
    private void cmdShowMIRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowMIRActionPerformed
        ...
        try {
            ...
            if (!DocNo.trim().equals("")) {
                ...
                aFrame.startAppletEx("EITLERP.Stores.frmMIR", "MIR");
    ...
    private void txtSuppCodeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSuppCodeFocusGained
        // TODO add your handling code here:
        ShowMessage("Enter supplier code. Press F1 for the list of suppliers");
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if (ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID, 8, txtDocNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void TableLKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableLKeyPressed
        ...
        if (TableL.getSelectedColumn() == DataModelL.getColFromVariable("RECEIVED_QTY")) {
            ...
            {
                EnterGRNLotQty ObjLot = new EnterGRNLotQty();
                ObjLot.lGRNNo = txtDocNo.getText().trim();
                ObjLot.lGRNSrNo = TableL.getSelectedRow() + 1;
                ...
                if (ObjLot.ShowList()) //Ok Pressed
                {
                    ...
                    for (int i = 1; i <= ObjLot.colLot.size(); i++) {
                        clsGRNLot ObjItemLot = (clsGRNLot) ObjLot.colLot.get(Integer.toString(i));
    ...
    private void cmdInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertActionPerformed
        ...
        ObjMIR.MIRType = 2; //Raw Material MIRs
        if (ObjMIR.ShowList()) {
            DoNotEvaluate = true;
            
            if (ObjMIR.CopyHeader) {
                txtSuppCode.setText((String) ObjMIR.ObjMIRRaw.getAttribute("SUPP_ID").getObj());
                txtSuffix.setText((String) ObjMIR.ObjMIRRaw.getAttribute("REFA").getObj());
                txtSuppName.setText(clsSupplier.getSupplierName(EITLERPGLOBAL.gCompanyID, txtSuppCode.getText()));
                
                if (txtSuppCode.getText().trim().equals("000000")) {
                    txtSuppName.setText((String) ObjMIR.ObjMIRRaw.getAttribute("PARTY_NAME").getObj());
                }
                
                txtChalanNo.setText((String) ObjMIR.ObjMIRRaw.getAttribute("CHALAN_NO").getObj());
                txtChalanDate.setText(EITLERPGLOBAL.formatDate((String) ObjMIR.ObjMIRRaw.getAttribute("CHALAN_DATE").getObj()));
                txtLRNo.setText((String) ObjMIR.ObjMIRRaw.getAttribute("LR_NO").getObj());
                txtLRDate.setText(EITLERPGLOBAL.formatDate((String) ObjMIR.ObjMIRRaw.getAttribute("LR_DATE").getObj()));
                txtInvoiceNo.setText((String) ObjMIR.ObjMIRRaw.getAttribute("INVOICE_NO").getObj());
                txtInvoiceDate.setText(EITLERPGLOBAL.formatDate((String) ObjMIR.ObjMIRRaw.getAttribute("INVOICE_DATE").getObj()));
                EITLERPGLOBAL.setComboIndex(cmbTransporter, (int) ObjMIR.ObjMIRRaw.getAttribute("TRANSPORTER").getVal());
                EITLERPGLOBAL.setComboIndex(cmbCurrency, (int) ObjMIR.ObjMIRRaw.getAttribute("CURRENCY_ID").getVal());
                txtCurrencyRate.setText(Double.toString(ObjMIR.ObjMIRRaw.getAttribute("CURRENCY_RATE").getVal()));
                txtGatepassNo.setText((String) ObjMIR.ObjMIRRaw.getAttribute("GATEPASS_NO").getObj());
                txtTransName.setText((String) ObjMIR.ObjMIRRaw.getAttribute("TRANSPORTER_NAME").getObj());
                chkImportConcess.setSelected(ObjMIR.ObjMIRRaw.getAttribute("IMPORT_CONCESS").getBool());
                Tab.setSelectedIndex(0);
            }
            ...
            for (int i = 1; i <= ObjMIR.colSelItems.size(); i++) {
                ...
                for (int lot = 1; lot <= ObjItem.colMIRLot.size(); lot++) {
                    clsGRNLot ObjLot = new clsGRNLot();
                    
                    clsMIRRawItemDetail ObjMIRLot = (clsMIRRawItemDetail) ObjItem.colMIRLot.get(Integer.toString(lot));
                    ObjLot.setAttribute("COMPANY_ID", ObjMIRLot.getAttribute("COMPANY_ID").getInt());
                    ObjLot.setAttribute("GRN_NO", txtDocNo.getText().trim());
                    ObjLot.setAttribute("GRN_SR_NO", i);
                    ObjLot.setAttribute("SR_NO", ObjMIRLot.getAttribute("SR_NO").getInt());
                    ObjLot.setAttribute("ITEM_ID", ObjMIRLot.getAttribute("ITEM_ID").getInt());
                    //ObjLot.setAttribute("HSN_SAC_CODE",ObjMIRLot.getAttribute("HSN_SAC_CODE").getString());
                    ObjLot.setAttribute("ITEM_LOT_NO", ObjMIRLot.getAttribute("ITEM_LOT_NO").getString());
                    ObjLot.setAttribute("AUTO_LOT_NO", ObjMIRLot.getAttribute("AUTO_LOT_NO").getString());
                    ObjLot.setAttribute("LOT_RECEIVED_QTY", ObjMIRLot.getAttribute("LOT_RECEIVED_QTY").getDouble());
                    ObjLot.setAttribute("LOT_REJECTED_QTY", ObjMIRLot.getAttribute("LOT_REJECTED_QTY").getDouble());
                    ObjLot.setAttribute("LOT_ACCEPTED_QTY", ObjMIRLot.getAttribute("LOT_ACCEPTED_QTY").getDouble());
                    ObjLot.setAttribute("BALANCE_QTY", ObjMIRLot.getAttribute("LOT_ACCEPTED_QTY").getDouble());
                ...
                DataModelL.setValueByVariable("HSN_SAC_CODE", clsItem.getHsnSacCode(EITLERPGLOBAL.gCompanyID, (String) ObjItem.getAttribute("ITEM_ID").getObj()), NewRow);
                ...
                DataModelL.setValueByVariable("P_872", DataModelL.getValueByVariable("P_865", NewRow), NewRow); //,P_856 //P_850,P_844
                DataModelL.setValueByVariable("CGST_INPUT_CREDIT", DataModelL.getValueByVariable("CGST", NewRow), NewRow);
                
                DataModelL.setValueByVariable("P_873", DataModelL.getValueByVariable("P_867", NewRow), NewRow); //,P_857 //P_851,P_845
                DataModelL.setValueByVariable("SGST_INPUT_CREDIT", DataModelL.getValueByVariable("SGST", NewRow), NewRow); //IGST_PER
                
                DataModelL.setValueByVariable("P_874", DataModelL.getValueByVariable("P_868", NewRow), NewRow);//,P_858  //P_852,P_846
            ...
            //Update the Header tax columns.
            clsMIRRaw objMIR = (clsMIRRaw) (new clsMIRRaw()).getObject(EITLERPGLOBAL.gCompanyID, MIRNo);
            
            //========= Import Tax Columns - Match both columns with variable name ==========//
            for (int c = 1; c <= 30; c++) {
                //Get the Column ID
                int lnColID = (int) objMIR.getAttribute("COLUMN_" + c + "_ID").getVal();
                String strVariable = "";
                double lnPercentValue = 0, lnValue = 0;
                
                //Record the values
                lnPercentValue = objMIR.getAttribute("COLUMN_" + c + "_PER").getVal();
                lnValue = objMIR.getAttribute("COLUMN_" + c + "_AMT").getVal();
                ...
                DataModelH.setValueByVariableEx("P_" + lnColID, Double.toString(lnPercentValue), 1);
                DataModelH.setValueByVariableEx(strVariable, Double.toString(lnValue), 1);
            }
    ...
    private void btnHSNUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHSNUpdateActionPerformed
        ...
        for (int p = 0; p < TableHSN.getRowCount(); p++) {
            String pItemId = TableHSN.getValueAt(p, 0).toString();
            ...
            for (int q = 0; q < TableL.getRowCount(); q++) {
                ...
                if (qItemId.equals(pItemId)) {
                    ...
                    TableL.setValueAt(pHSNCd, q, DataModelL.getColFromVariable("HSN_SAC_CODE"));
                }
            }
        }
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("GOODS RECEIPT NOTE (Raw Material) - " + txtDocNo.getText());
            ...
            txtInvoiceAmount.setText(new BigDecimal(ObjGRN.getAttribute("INVOICE_AMOUNT").getVal()).setScale(3, BigDecimal.ROUND_HALF_UP).toString());
            ...
            //
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_GROSS_AMT").getVal()), 0, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_NET_AMT").getVal()), 1, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_FINAL_AMT").getVal()), 2, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_INVOICE_AMT").getVal()), 3, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_CGST").getVal()), 4, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_SGST").getVal()), 5, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_IGST").getVal()), 6, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_RCM").getVal()), 7, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_COMPOSITION").getVal()), 8, 1);
            //            Table_DEBIT_NOTE.setValueAt(Double.toString(ObjGRN.getAttribute("DB_GST_COMPENSATION_CESS").getVal()), 9, 1);
            //
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_GROSS_AMT").getVal()), 0, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_NET_AMT").getVal()), 1, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_FINAL_AMT").getVal()), 2, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_INVOICE_AMT").getVal()), 3, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_CGST").getVal()), 4, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_SGST").getVal()), 5, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_IGST").getVal()), 6, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_RCM").getVal()), 7, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_COMPOSITION").getVal()), 8, 1);
            //            Table_INVOICED.setValueAt(Double.toString(ObjGRN.getAttribute("INV_GST_COMPENSATION_CESS").getVal()), 9, 1);
            //
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_GROSS_AMT").getVal()), 0, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_NET_AMT").getVal()), 1, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_FINAL_AMT").getVal()), 2, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_INVOICE_AMT").getVal()), 3, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_CGST").getVal()), 4, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_SGST").getVal()), 5, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_IGST").getVal()), 6, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_RCM").getVal()), 7, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_COMPOSITION").getVal()), 8, 1);
            //            Table_RECEIVED.setValueAt(Double.toString(ObjGRN.getAttribute("RCVD_GST_COMPENSATION_CESS").getVal()), 9, 1);
            ...
            for (int i = 1; i <= ObjGRN.colGRNItems.size(); i++) {
                ...
                clsGRNItem ObjItem = (clsGRNItem) ObjGRN.colGRNItems.get(Integer.toString(i));
                ...
                DataModelL.setValueByVariable("BOE_DATE", EITLERPGLOBAL.formatDate((String) ObjItem.getAttribute("BOE_DATE").getObj()), NewRow);
                DataModelL.setValueByVariable("REJECTED_QTY", Double.toString(ObjItem.getAttribute("REJECTED_QTY").getVal()), NewRow);
                DataModelL.setValueByVariable("REASON", (String) ObjItem.getAttribute("REJECTED_REASON").getObj(), NewRow);
                DataModelL.setValueByVariable("SHADE", (String) ObjItem.getAttribute("SHADE").getObj(), NewRow);
                DataModelL.setValueByVariable("W_MIE", (String) ObjItem.getAttribute("W_MIE").getObj(), NewRow);
                DataModelL.setValueByVariable("NO_CASE", (String) ObjItem.getAttribute("NO_CASE").getObj(), NewRow);
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 8, DocNo);
            ...
            FormatGridHS();
            HashMap History = clsGRN.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsGRN ObjHistory = (clsGRN) History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        //
        //        ObjGRN.setAttribute("RCVD_GROSS_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(0, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_NET_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(1, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_FINAL_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(2, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_INVOICE_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(3, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_CGST", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(4, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_SGST", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(5, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_IGST", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(6, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_RCM", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(7, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_COMPOSITION", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(8, 1)+""))));
        //        ObjGRN.setAttribute("RCVD_GST_COMPENSATION_CESS", Double.valueOf(newFormat.format(Double.parseDouble(Table_RECEIVED.getValueAt(9, 1)+""))));
        //
        //        ObjGRN.setAttribute("DB_GROSS_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(0, 1)+""))));
        //        ObjGRN.setAttribute("DB_NET_AMT",Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(1, 1)+""))));
        //        ObjGRN.setAttribute("DB_FINAL_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(2, 1)+""))));
        //        ObjGRN.setAttribute("DB_INVOICE_AMT", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(3, 1)+""))));
        //        ObjGRN.setAttribute("DB_CGST", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(4, 1)+""))));
        //        ObjGRN.setAttribute("DB_SGST", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(5, 1)+""))));
        //        ObjGRN.setAttribute("DB_IGST", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(6, 1)+""))));
        //        ObjGRN.setAttribute("DB_RCM", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(7, 1)+""))));
        //        ObjGRN.setAttribute("DB_COMPOSITION", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(8, 1)+""))));
        //        ObjGRN.setAttribute("DB_GST_COMPENSATION_CESS", Double.valueOf(newFormat.format(Double.parseDouble(Table_DEBIT_NOTE.getValueAt(9, 1)+""))));
        ...
        ObjGRN.setAttribute("GRN_TYPE", 2); //Fixed type 2 - Raw Material, 1 - General
        ...
        for (int i = 0; i < TableL.getRowCount(); i++) {
            ...
            for (int l = 1; l <= lcolLot.size(); l++) {
                clsGRNLot ObjLot = new clsGRNLot();
                clsGRNLot ObjList = (clsGRNLot) lcolLot.get(Integer.toString(l));
                ObjLot.setAttribute("COMPANY_ID", ObjList.getAttribute("COMPANY_ID").getInt());
                ObjLot.setAttribute("GRN_NO", txtDocNo.getText().trim());
                ObjLot.setAttribute("GRN_SR_NO", i + 1);
                ObjLot.setAttribute("SR_NO", l);
                ObjLot.setAttribute("ITEM_ID", DataModelL.getValueByVariable("ITEM_ID", i));
                ...
                ObjLot.setAttribute("BALANCE_QTY", ObjList.getAttribute("LOT_ACCEPTED_QTY").getDouble());
                ObjLot.setAttribute("LOT_CLOSE", 0);
    ...
    private void SetupColumns() {
        ...
        List = clsColumn.getList(" WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID) + " AND MODULE_ID=8 AND HEADER_LINE='L' ORDER BY COL_ORDER");
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if ((boolean) ObjTax.getAttribute("USE_PERCENT").getBool()) {
             ...
             if(!txtSuppCode.getText().startsWith("7")){
                ...
                if(lTaxID==872 || lTaxID==871 || lTaxID==870 || lTaxID==869 || lTaxID==868 || lTaxID==867 || lTaxID==866 || lTaxID==865 || lTaxID==863){
                   DataModelL.SetReadOnly(TableL.getColumnCount() - 1); 
                   if ((boolean) ObjTax.getAttribute("USE_PERCENT").getBool()) {
                       DataModelL.SetReadOnly(TableL.getColumnCount() - 2); 
                   }                   
        ...
        ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=8 AND HIDDEN=0 AND SHOW_LAST=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        ...
        ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=8 AND HIDDEN=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        for (int i = 1; i <= ColList.size(); i++) {
            clsSystemColumn ObjColumn = (clsSystemColumn) ColList.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            TableL.setDragEnabled(false);
            
            ColList = clsSystemColumn.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=8 AND HIDDEN=0 AND SHOW_LAST=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
            for (int i = 1; i <= ColList.size(); i++) {
                clsSystemColumn ObjColumn = (clsSystemColumn) ColList.get(Integer.toString(i));
    ...
    private void UpdateResults(int pCol) {
        if (!DoNotEvaluate) {
            try {
                ...
                Object result;
                boolean updateIt = true, IsPercentColumn = false;
    ...
    private void SetupColumns_H() {
        ...
        List = clsColumn.getList(" WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID) + " AND MODULE_ID=8 AND HEADER_LINE='H' ORDER BY COL_ORDER");
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=8");
        
        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=8");
        }
        for (int i = 1; i <= List.size(); i++) {
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, 8, (String) ObjGRN.getAttribute("GRN_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, 8, (String) ObjGRN.getAttribute("GRN_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, 8, FromUserID, (String) ObjGRN.getAttribute("GRN_NO").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 541)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 543)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 544)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
        ...
        try {
            ...
            for (int i = 0; i < TableL.getRowCount(); i++) {
                if (TableL.getValueAt(i, NetAmountCol) != null) {
                    ...
                    //Do not include RND Deduction in Landed Rate Calculations
    ...
    private boolean Validate() {
        ...
        for (int i = 0; i < TableH.getRowCount(); i++) {
            if (Double.parseDouble(txtGrossAmount.getText().trim()) > 0) {
                ...
                if ((ColID != 0) && (ColID != -99) && (!Variable.substring(0, 2).equals("P_"))) {
                    if (data.IsRecordExist("SELECT * FROM D_COM_TAX_HEADER WHERE COMPANY_ID=" + Integer.toString(EITLERPGLOBAL.gCompanyID) + " AND TAX_ID=" + Integer.toString(TaxID) + " AND TAX_ID NOT IN (396,350) ")) {
                        lnPercentValue = Double.parseDouble(TableH.getValueAt(i, 1).toString());
            ...
            for (int j = 1; j < TableL.getColumnCount(); j++) {
                if (Double.parseDouble(DataModelL.getValueByVariable("GROSS_AMOUNT", i)) > 0) {
                    ...
                    if ((ColID != 0) && (ColID != -99) && (!Variable.substring(0, 2).equals("P_"))) {
                        ...
                        + "AND TAX_ID=" + Integer.toString(TaxID) + " AND TAX_ID NOT IN (341,389,391,392) ")) {
                            lnPercentValue = Double.parseDouble(TableL.getValueAt(i, j).toString());
        ...
        for (int j = 0; j < TableHSNGRNPJV.getRowCount(); j++) {
         /*   if (Double.parseDouble(TableHSNGRNPJV.getValueAt(j, 22).toString()) == 0) {
                if (Double.parseDouble(TableHSNGRNPJV.getValueAt(j, 23).toString()) != 0) {
                    JOptionPane.showMessageDialog(this, "Please enter valid Input Credit CGST % at detail level");
                    return false;
                }
            }
    ...
    private void Add() {
        ...
        if (aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 8, FFNo, false));
    ...
    private void Edit() {
        ...
        if (ObjGRN.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (ApprovalFlow.IsCreator(8, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 542)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        if (hieId != 1670) {
            if (!StatusCd.equals("R")) {
                for (int i = 1; i <= ObjGRN.colGRNItems.size(); i++) {
                    clsGRNItem ItemDetail = (clsGRNItem) ObjGRN.colGRNItems.get(Integer.toString(i));
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.Stores.frmGRNFind", true);
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        ObjGRN.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2", pCompanyID);
        ObjGRN.MoveLast();
        DisplayData();
    }
    ...
    public void FindByCompany(int pCompanyID, String pDocNo) {
        ...
        ObjGRN.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND GRN_NO='" + pDocNo + "' AND GRN_TYPE=2", pCompanyID, dbURL);
        ObjGRN.MoveLast();
        DisplayData();
    }
    
    public void FindWaiting() {
        ObjGRN.Filter(" WHERE GRN_NO IN(SELECT D_INV_GRN_HEADER.GRN_NO FROM D_INV_GRN_HEADER,D_COM_DOC_DATA WHERE D_INV_GRN_HEADER.GRN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_GRN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_GRN_HEADER.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND D_COM_DOC_DATA.USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND D_COM_DOC_DATA.STATUS='W' AND D_INV_GRN_HEADER.GRN_TYPE=2 AND MODULE_ID=8)", EITLERPGLOBAL.gCompanyID);
        ObjGRN.MoveLast();
        DisplayData();
    }
    ...
    private void PreviewAuditReport() {
        try {
            URL ReportFile = new URL("http://" + EITLERPGLOBAL.HostIP + "/EITLERP/Reports/rptGRN2A.jsp?dbURL=" + EITLERPGLOBAL.DatabaseURL + "&CompanyID=" + EITLERPGLOBAL.gCompanyID + "&DocNo=" + txtDocNo.getText() + "&DocType=2");
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 8, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 8, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 8, txtDocNo.getText());
    ...
    private void PreviewReport() {
        ...
        + " b.item_extra_desc,usr.user_name usr_name,a.created_date usr_date,e.company_id,e.company_name,"
        ...
        + " b.po_no,f1.po_date,b.po_sr_no,b.mir_no,x.mir_date,b.location_id,b.remarks BRE,b.received_qty rec_qty,b.mir_sr_no,"
        + " b.CHALAN_QTY,b.REJECTED_QTY ,b.qty acc_qty,f.qty po_qty,round((f.qty - b.qty ),2) bal_qty,c.supplier_code,"
        + " d.item_sys_id,f2.indent_no,f2.indent_date,b.landed_rate fnl_rate,b.column_5_amt freight_detail,b.column_6_amt octroi_detail,"
        + " b.column_21_amt others_detail,a.column_5_amt freight_header,a.column_6_amt octroi_header,a.column_9_amt others_header,dept.dept_desc "
        + " from "
        ...
        + " left join D_COM_DEPT_MASTER as dept on (b.company_id = dept.company_id and b.dept_id = dept.dept_id) "
        + " left join D_INV_MIR_HEADER AS x on (b.company_id=x.company_id and b.mir_no=x.mir_no) "
        + " left join D_PUR_PO_DETAIL as f on (b.company_id=f.company_id and b.po_no=f.po_no and b.item_id = f.item_id "
        + " and b.po_sr_no=f.sr_no) "
        ...
        + " and d.approved = 1 and d.cancelled = 0) sub ";
        
        System.out.println(strSQL);
        
        rpt.setReportName("/EITLERP/Reports/jrxml/rpt_INV_GRN_RAW.jrxml", 1, strSQL); //productlist is the name of my jasper file.
        rpt.callReport();
        
        //        try {
        //            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGRNRaw.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
        //            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
        //        }
        //        catch(Exception e) {
    ...
    private void PreviewReport_GST() {
        ...
        +" d.item_sys_id,f2.indent_no,f2.indent_date,b.landed_rate fnl_rate,b.column_5_amt freight_detail,b.column_6_amt octroi_detail,"
        +" b.column_21_amt others_detail,a.column_5_amt freight_header,a.column_6_amt octroi_header,a.column_9_amt others_header,dept.dept_desc,"
        +" e.GSTIN_NO COM_GSTIN,c.GSTIN_NO as SUPP_GSTIN,d.HSN_SAC_CODE "
        +" from "
        +" D_INV_GRN_HEADER as  a  "
        +" left join D_COM_SUPP_MASTER  as c on ( a.supp_id= c.supplier_code and a.company_id = c.company_id) "
        +" left join D_COM_PARAMETER_MAST as g1 on ( g1.PARA_ID='TRANSPORT' AND g1.PARA_CODE=a.transporter and g1.company_id = a.company_id) "
        ...
        System.out.println(strSQL);
        System.out.println("/EITLERP/Reports/jrxml/rpt_INV_GRN_RAW_GST.jrxml");
        
        rpt.setReportName("/EITLERP/Reports/jrxml/rpt_INV_GRN_RAW_GST.jrxml", 1, strSQL); //productlist is the name of my jasper file.
        rpt.callReport();
        
        //        try {
        //            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGRNRaw_GST.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
        //            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
        //        }
        //        catch(Exception e) {
        //            JOptionPane.showMessageDialog(null,"File error "+e.getMessage());
    ...
    private void PreviewReport_NonGST_updated() {
        ...
        + " b.po_no,f1.po_date,b.po_sr_no,b.mir_no,x.mir_date,b.location_id,b.remarks BRE,b.received_qty rec_qty,b.mir_sr_no,"
        + " b.CHALAN_QTY,b.REJECTED_QTY ,b.qty acc_qty,f.qty po_qty,round((f.qty - b.qty ),2) bal_qty,c.supplier_code,"
        + " d.item_sys_id,f2.indent_no,f2.indent_date,b.landed_rate fnl_rate,b.column_16_amt freight_detail,b.column_17_amt octroi_detail,"
        + " b.column_31_amt others_detail,a.column_5_amt freight_header,a.column_6_amt octroi_header,a.column_9_amt others_header,dept.dept_desc "
        + " from "
        + " D_INV_GRN_HEADER as  a  "
        + " left join D_COM_SUPP_MASTER  as c on ( a.supp_id= c.supplier_code and a.company_id = c.company_id) "
        + " left join D_COM_PARAMETER_MAST as g1 on ( g1.PARA_ID=\"TRANSPORT\" AND g1.PARA_CODE=a.transporter and g1.company_id = a.company_id) "
        ...
        rpt.setReportName("/EITLERP/Reports/jrxml/rpt_INV_GRN_RAW_UPDATE.jrxml", 1, strSQL); //productlist is the name of my jasper file.
        rpt.callReport();
        
        //        try {
        //            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGRNRaw_NonGST_updated.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
        //            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
        //        }
        //        catch(Exception e) {
        //            JOptionPane.showMessageDialog(null,"File error "+e.getMessage());
    ...
    private void UpdateUserObject() {
        for (int i = 0; i < TableL.getRowCount(); i++) {
            //DataModelL.colUserObject.clear();
            int SRNO = Integer.parseInt(DataModelL.getValueByVariable("SR_NO", i).toString());
            DataModelL.SetUserObject(SRNO - 1, (HashMap) DataModelL.getUserObject(SRNO - 1));
        }
    }
                ...
                for (int i = 0; i < bCnt; i++) {
                    ...
                    for (int j = 0; j < TableL.getRowCount(); j++) {
                        ...
                        if (b[i].equals(hsnCode)) {
                            ...
                            CGSTInputCrPer = Double.valueOf(DataModelL.getValueByVariable("P_872", j)); //9 //sr no of dcomcolumns
                            SGSTInputCrPer = Double.valueOf(DataModelL.getValueByVariable("P_873", j)); //10
                            IGSTInputCrPer = Double.valueOf(DataModelL.getValueByVariable("P_874", j)); //11
                        }
                    }
