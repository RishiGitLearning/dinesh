...
public class clsIssueRMG {
    ...
    public static int ModuleId = 112;
    ...
    public boolean Insert(String pPrefix, String pDocno) {
        ...
        try {
            ...
            if (UserDocNo) {
                ...
                setAttribute("ISSUE_NO", clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 112, (int) getAttribute("FFNO").getVal(), true));//15
            }
            //-------------------------------------------------
            ...
            rsIssue.updateString("INVOICE_DATE", (String) getAttribute("INVOICE_DATE").getObj());
            rsIssue.updateDouble("INVOICE_VALUE", getAttribute("INVOICE_VALUE").getVal());
            ...
            rsHistory.updateDouble("INVOICE_VALUE", getAttribute("INVOICE_VALUE").getVal());
            ...
            ObjFlow.ModuleID = 112; //Issue RMG MODULE ID //15
        ...
        try {
            ...
            if (AStatus.equals("F")) {
                ...
                if((int) getAttribute("COMPANY_ID").getVal()==2){
                 minvno = clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 0, 300, true);
                }else if((int) getAttribute("COMPANY_ID").getVal()==3){
                 minvno = clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 0, 86, true);
                }
                SQL = "UPDATE D_INV_ISSUE_HEADER SET INVOICE_NO='" + minvno + "',INVOICE_DATE=CURDATE() "
                ...
                SQL = "INSERT INTO D_INV_NRGP_HEADER (COMPANY_ID,GATEPASS_NO,GATEPASS_DATE,"
                        ...
                        + "5,'GPR',0," + (String) getAttribute("PARTY_CODE").getObj() + ",0,0," + getAttribute("INVOICE_VALUE").getVal() + ","
                        + "0,'0000-00-00','0000-00-00',NULL,'',0,359,CURDATE(),NULL,NULL,"
                        + "3783,359,'"
                    ...
                    SQL = "INSERT INTO D_INV_NRGP_HEADER (COMPANY_ID,GATEPASS_NO,GATEPASS_DATE,"
                        ...
                        + "5,'GPR',0," + (String) getAttribute("PARTY_CODE").getObj() + ",0,0," + getAttribute("INVOICE_VALUE").getVal() + ","
                        + "0,'0000-00-00','0000-00-00',NULL,'',0,165,CURDATE(),NULL,NULL,"
                        + "751,165,'"  //747
                        + (String) getAttribute("PURPOSE").getObj() + "','','',0,1,CURDATE(),'')";
                }
                System.out.println("SQL:"+SQL);
                ...
                SQL = "INSERT INTO D_INV_NRGP_HEADER_H (REVISION_NO,UPDATED_BY,APPROVAL_STATUS,ENTRY_DATE,APPROVER_REMARKS,COMPANY_ID,GATEPASS_NO,GATEPASS_DATE,FOR_DEPT,GATEPASS_TYPE,NRGP_WITH_LOT,SUPP_ID,MODE_TRANSPORT,TRANSPORTER,TOTAL_AMOUNT,APPROVED,APPROVED_DATE,REJECTED_DATE,REJECTED_REMARKS,REMARKS,CANCELED,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,HIERARCHY_ID,USER_ID,PARTY_NAME,ADD1,ADD2,ADD3,CITY,EXP_RETURN_DATE,PURPOSE,DESPATCH_MODE,PACKING,REJECTED,CHANGED,CHANGED_DATE,GROSS_WEIGHT) "
                        + "SELECT 1,359,'H',CURDATE(),'',D.* FROM D_INV_NRGP_HEADER D WHERE GATEPASS_NO='" + minvno + "'";
                }else if((int) getAttribute("COMPANY_ID").getVal()==3){
                    SQL = "INSERT INTO D_INV_NRGP_HEADER_H (REVISION_NO,UPDATED_BY,APPROVAL_STATUS,ENTRY_DATE,APPROVER_REMARKS,COMPANY_ID,GATEPASS_NO,GATEPASS_DATE,FOR_DEPT,GATEPASS_TYPE,NRGP_WITH_LOT,SUPP_ID,MODE_TRANSPORT,TRANSPORTER,TOTAL_AMOUNT,APPROVED,APPROVED_DATE,REJECTED_DATE,REJECTED_REMARKS,REMARKS,CANCELED,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,HIERARCHY_ID,USER_ID,PARTY_NAME,ADD1,ADD2,ADD3,CITY,EXP_RETURN_DATE,PURPOSE,DESPATCH_MODE,PACKING,REJECTED,CHANGED,CHANGED_DATE,GROSS_WEIGHT) "
                        + "SELECT 1,165,'H',CURDATE(),'',D.* FROM D_INV_NRGP_HEADER D WHERE GATEPASS_NO='" + minvno + "'";
                }
                System.out.println("SQL:"+SQL);
                data.Execute(SQL);
                ...
                SQL="INSERT INTO D_COM_DOC_DATA (COMPANY_ID,MODULE_ID,DOC_NO,DOC_DATE,USER_ID,STATUS,TYPE,REMARKS,"
                        ...
                        + "VALUES(2,11,'"+minvno+"',CURDATE(),359,'W','C','',"
                        + "1,0,'',CURDATE(),'0000-00-00',1,CURDATE())";
                } else if((int) getAttribute("COMPANY_ID").getVal()==3){
                    SQL="INSERT INTO D_COM_DOC_DATA (COMPANY_ID,MODULE_ID,DOC_NO,DOC_DATE,USER_ID,STATUS,TYPE,REMARKS,"
                        + "SR_NO,FROM_USER_ID,FROM_REMARKS,RECEIVED_DATE,ACTION_DATE,CHANGED,CHANGED_DATE) "
                        + "VALUES(3,11,'"+minvno+"',CURDATE(),165,'W','C','',"
                        + "1,0,'',CURDATE(),'0000-00-00',1,CURDATE())";
                }
                System.out.println("SQL:"+SQL);
                data.Execute(SQL);
                ...
                String rsInWord = num.convertNumToWord(Math.round(getAttribute("INVOICE_VALUE").getVal()));
    ...
    public boolean CanDelete(int pCompanyID, String pIssueno, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND MODULE_ID=112 AND DOC_NO='" + pIssueno + "' AND USER_ID=" + Integer.toString(pUserID) + " AND TYPE='C' AND STATUS='W'"; //15
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean IsEditable(int pCompanyID, String pIssueno, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND MODULE_ID=112 AND DOC_NO='" + pIssueno + "' AND USER_ID=" + Integer.toString(pUserID) + " AND STATUS='W'";  //15
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getPendingApprovals(int pCompanyID, int pUserID, int pOrder, int FinYearFrom) {
        ...
        try {
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT D_INV_ISSUE_HEADER.ISSUE_NO,D_INV_ISSUE_HEADER.ISSUE_DATE,RECEIVED_DATE,D_INV_ISSUE_HEADER.FOR_DEPT_ID AS DEPT_ID FROM D_INV_ISSUE_HEADER,D_COM_DOC_DATA WHERE D_INV_ISSUE_HEADER.ISSUE_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_ISSUE_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_ISSUE_HEADER.COMPANY_ID=" + Integer.toString(pCompanyID) + " AND D_COM_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND D_COM_DOC_DATA.STATUS='W' AND D_COM_DOC_DATA.MODULE_ID=112 ORDER BY D_COM_DOC_DATA.RECEIVED_DATE"; //15
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT D_INV_ISSUE_HEADER.ISSUE_NO,D_INV_ISSUE_HEADER.ISSUE_DATE,RECEIVED_DATE,D_INV_ISSUE_HEADER.FOR_DEPT_ID AS DEPT_ID FROM D_INV_ISSUE_HEADER,D_COM_DOC_DATA WHERE D_INV_ISSUE_HEADER.ISSUE_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_ISSUE_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_ISSUE_HEADER.COMPANY_ID=" + Integer.toString(pCompanyID) + " AND D_COM_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND D_COM_DOC_DATA.STATUS='W' AND D_COM_DOC_DATA.MODULE_ID=112 ORDER BY D_INV_ISSUE_HEADER.ISSUE_DATE"; //15
            }

            if (pOrder == EITLERPGLOBAL.OnDocNo) {
                strSQL = "SELECT D_INV_ISSUE_HEADER.ISSUE_NO,D_INV_ISSUE_HEADER.ISSUE_DATE,RECEIVED_DATE,D_INV_ISSUE_HEADER.FOR_DEPT_ID AS DEPT_ID FROM D_INV_ISSUE_HEADER,D_COM_DOC_DATA WHERE D_INV_ISSUE_HEADER.ISSUE_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_ISSUE_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_ISSUE_HEADER.COMPANY_ID=" + Integer.toString(pCompanyID) + " AND D_COM_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND D_COM_DOC_DATA.STATUS='W' AND D_COM_DOC_DATA.MODULE_ID=112 ORDER BY D_INV_ISSUE_HEADER.ISSUE_NO";  //15
            }

            //strSQL="SELECT D_INV_ISSUE_HEADER.ISSUE_NO,D_INV_ISSUE_HEADER.ISSUE_DATE FROM D_INV_ISSUE_HEADER,D_COM_DOC_DATA WHERE D_INV_ISSUE_HEADER.ISSUE_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_ISSUE_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_ISSUE_HEADER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND D_COM_DOC_DATA.MODULE_ID=112";//15
            ...
            while (!rsTmp.isAfterLast()) {
                if (EITLERPGLOBAL.isWithinDate(rsTmp.getString("ISSUE_DATE"), FinYearFrom)) {
                    Counter = Counter + 1;
                    clsIssueRMG ObjDoc = new clsIssueRMG();
    ...
    private boolean setData() {
        ...
        try {
            ...
            setAttribute("INVOICE_DATE", rsIssue.getString("INVOICE_DATE"));
            setAttribute("INVOICE_VALUE", rsIssue.getDouble("INVOICE_VALUE"));
    ...
    public static HashMap getHistoryList(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            while (rsTmp.next()) {
                clsIssueRMG ObjIssue = new clsIssueRMG();
        ...
        try {
            ...
            if (CanCancel(pCompanyID, pDocNo)) {
                ...
                if (ApprovedDoc) {
                    ...
                    data.Execute("DELETE FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + pCompanyID + " AND DOC_NO='" + pDocNo + "' AND MODULE_ID=112");//15
                }
