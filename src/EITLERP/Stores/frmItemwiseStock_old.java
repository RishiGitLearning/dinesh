...
public class frmItemwiseStock_old extends javax.swing.JApplet {
        ...
        try{
            ...
            if(EITLERPGLOBAL.gCompanyID ==2 ) {
                if(ItemType==1) {
                    ...
                    Condition = " AND A.ITEM_ID LIKE 'RM%' ";
            ...
            while(!rsItem.isAfterLast()){
                ...
                if(StockQty>0) {
                    ...
                    objRow.setValue("STOCK_VALUE",String.valueOf(EITLERPGLOBAL.round(StockValue,2)));
