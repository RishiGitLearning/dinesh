 ...
 * clsSTMRawItem.java
 *
 * Created on May 10, 2004, 2:12 PM
 */
...
public class clsSTMRawItem {
    
    private HashMap props;
    public boolean Ready = false;
    
    public HashMap colSTMLot=new HashMap();
    ...
    public void setAttribute(String PropName,boolean Value)
 {
    ...
    /** Creates new clsSTMRawItem */
    public clsSTMRawItem() {
        props=new HashMap();
        ...
        props.put("BAL_STOCK_QTY",new Variant(0));
