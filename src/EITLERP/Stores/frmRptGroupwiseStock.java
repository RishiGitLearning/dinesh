...
public class frmRptGroupwiseStock extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        opgSTM = new javax.swing.JRadioButton();
        ...
        jLabel7.setText("<html> <b> <font color='RED'> NOTE :  Please reprocess stock ledger <br> before  run  this report. </font></b></html>");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(220, 220, 260, 40);
    ...
    private void cmbItemTypeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbItemTypeItemStateChanged
        ...
        if(cmbItemType.getSelectedIndex()==1 || cmbItemType.getSelectedIndex()==2)
        {
            opgItemwise.setEnabled(true);
        }
        else
        {
            opgItemwise.setEnabled(false);
    ...
    private void opgBriefActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opgBriefActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_opgBriefActionPerformed
    ...
    private javax.swing.JRadioButton opgSTM;
                        ...
                        while((!rsItem.isAfterLast())&&rsItem.getRow()>0) {
                            ...
                            while((!rsIssue.isAfterLast())&&rsIssue.getRow()>0) {
                                ...
                                if(IssueQty<=OpeningQty) {
                                    ...
                                    IssueValue=EITLERPGLOBAL.round(OpeningRate*IssueQty,3);
                                    ...
                                    IssueValue=EITLERPGLOBAL.round(DiffQty*OpeningRate,3);
                                    ...
                                    if(rsRcpt.getRow()>0) {
                                        ...
                                        while((!Done)&&(!rsRcpt.isAfterLast())) {
                                            ...
                                            if(IssueQty<Qty) //Is GRN Qty sufficient to fulfill the issue ?
                                            {
                                                ...
                                                IssueValue=EITLERPGLOBAL.round(IssueValue+(IssueQty*Rate),3);
                                            ...
                                            else //GRN Qty. is not sufficient
                                            {
                                                ...
                                                IssueValue=EITLERPGLOBAL.round(IssueValue+(Qty*Rate),3);
                                    ...
                                    if(IssueQty>0) {
                                        ...
                                        if((rsIssue.getDouble("QTY")-IssueQty)==0) {
                                            ...
                                            IssueRate=EITLERPGLOBAL.round(IssueValue/(rsIssue.getDouble("QTY")-IssueQty),3);
                                        }
                                        
                                        
                                        IssueValue=EITLERPGLOBAL.round(rsIssue.getDouble("QTY")*IssueRate,3);
                                        
                                    }
                                    else {
                                        
                                        //Otherwise devide the value
                                        IssueRate=EITLERPGLOBAL.round(IssueValue/rsIssue.getDouble("QTY"),3);
                                    }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if(opgSTM.isSelected()) {
                        try {
                            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseSTMGen.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"&ToDate="+EITLERPGLOBAL.formatDateDB(txtToDate.getText())+"");
                            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
                        }
                        catch(Exception e) {
                        }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //======= Find the last cut-off date stock entry =================//
                    String tmp = "SELECT ENTRY_NO,ENTRY_DATE FROM D_COM_OPENING_STOCK_HEADER WHERE ENTRY_DATE<='"+EITLERPGLOBAL.formatDateDB(txtFromDate.getText())+"' AND COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY ENTRY_DATE DESC";
                    
                    rsTmp=data.getResult("SELECT ENTRY_NO,ENTRY_DATE FROM D_COM_OPENING_STOCK_HEADER WHERE ENTRY_DATE<='"+EITLERPGLOBAL.formatDateDB(txtFromDate.getText())+"' AND COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY ENTRY_DATE DESC");
                    rsTmp.first();
                    ...
                    tmp = "SELECT * FROM D_INV_ITEM_CATEGORY WHERE COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY CATEGORY_ID";
/*                    if(ItemType ==2) {
                        tmp = "SELECT * FROM D_INV_ITEM_CATEGORY WHERE CATEGORY_ID <> 13 AND COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY CATEGORY_ID";
                    }
                    else if(ItemType == 13) {
                        tmp = "SELECT * FROM D_INV_ITEM_CATEGORY WHERE CATEGORY_ID= 13 AND COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ORDER BY CATEGORY_ID";
                    }
 */
                    rsCategory=data.getResult(tmp);
                    ...
                    if(rsCategory.getRow()>0) {
                        while(!rsCategory.isAfterLast()) {
                            ...
                            strSQL+="AND A.COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ";
                            strSQL+="AND B.COMPANY_ID = " + EITLERPGLOBAL.gCompanyID + " ";
                            
                            
                            TotalOpening=EITLERPGLOBAL.round(data.getDoubleValueFromDB(strSQL),3);
                            ...
                            TotalOpening=TotalOpening-(EITLERPGLOBAL.round(data.getDoubleValueFromDB(strSQL),3));
                            
                            
                            
                            //Get STM Issues
                            strSQL="SELECT ROUND(SUM(NET_AMOUNT),3) ";
                            strSQL+="FROM ";
                            strSQL+="D_INV_STM_HEADER A, ";
                            strSQL+="D_INV_STM_DETAIL B, ";
                            strSQL+="D_INV_ITEM_MASTER I ";
                            ...
                            TotalReceipt=EITLERPGLOBAL.round(data.getDoubleValueFromDB(strSQL),3);
                            ...
                            TotalIssue=EITLERPGLOBAL.round(data.getDoubleValueFromDB(strSQL),3);
                            ...
                            TotalSTM=EITLERPGLOBAL.round(data.getDoubleValueFromDB(strSQL),3);
                            
                            finalTotal=TotalOpening+TotalReceipt-TotalIssue-TotalSTM;
                            
                            data.Execute("UPDATE D_INV_ITEM_CATEGORY SET OPENING_VALUE="+TotalOpening+",RECEIPT_VALUE="+TotalReceipt+",ISSUE_VALUE="+TotalIssue+", STM_VALUE="+TotalSTM+" WHERE CATEGORY_ID="+CategoryID+" AND COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " ");
                    ...
                    if(opgBrief.isSelected()) {
                        try {
                            if(EITLERPGLOBAL.getComboCode(cmbItemType) ==13) {
                                Condition = "AND A.CATEGORY_ID = 13 ";
                            }
                            else {
                                Condition = "AND A.CATEGORY_ID NOT IN (13) ";
                            }
                            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseStockRM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&AsOnDate="+txtToDate.getText());
                            ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseStockRM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&AsOnDate="+txtToDate.getText()+"&Condition="+Condition);
                    ...
                    if(opgDetailed.isSelected()) {
                        try {
                            ...
                            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseStock2RM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&AsOnDate="+txtToDate.getText());
                            ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseStock2RM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&AsOnDate="+txtToDate.getText()+"&Condition="+Condition);
                            System.out.println(ReportFile);
                            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
                        }
                        catch(Exception e) {
                    ...
                    if(opgReceipts.isSelected()) {
                        try {
                            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseReceiptsRM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"&ToDate="+EITLERPGLOBAL.formatDateDB(txtToDate.getText())+"&Condition="+Condition);
                            if(EITLERPGLOBAL.getComboCode(cmbItemType) ==13) {
                                Condition = "AND I.CATEGORY_ID = 13";
                            }
                            else {
                                Condition = "AND I.CATEGORY_ID <> 13";
                            }
                            ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseReceiptsRM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"&ToDate="+EITLERPGLOBAL.formatDateDB(txtToDate.getText())+"&Condition="+Condition);
                            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
                        }
                        catch(Exception e) {
                        }
                    ...
                    if(opgIssues.isSelected()) {
                        try {
                            ...
                            String tmp1 = "http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseIssuesRM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"&ToDate="+EITLERPGLOBAL.formatDateDB(txtToDate.getText())+"&Condition="+Condition;
                            URL ReportFile=new URL(tmp1);
                            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
                        }
                        catch(Exception e) {
                        }
                    ...
                    if(opgSTM.isSelected()) {
                        try {
                            ...
                            String tmp1 = "http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptGroupwiseSTMRM.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FromDate="+EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"&ToDate="+EITLERPGLOBAL.formatDateDB(txtToDate.getText())+"&Condition="+Condition;
                            URL ReportFile=new URL(tmp1);
                            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
                        }
                        catch(Exception e) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    rsCategory=data.getResult("SELECT * FROM D_INV_ITEM_CATEGORY WHERE " + Condition + " ORDER BY CATEGORY_ID");
                    rsCategory.first();
                        ...
                        while(!rsCategory.isAfterLast()) {
                            ...
                            if(rsItem.getRow()>0) {
                                ...
                                while(!rsItem.isAfterLast()) {
                                    ...
                                    //Opening Value
                                    strSQL="SELECT ROUND(SUM(A.OPENING_VALUE),3) AS OPENING_VALUE,SUM(A.OPENING_QTY) AS OPENING_QTY ";
                                    strSQL+="FROM ";
                                    strSQL+="D_COM_OPENING_STOCK_DETAIL A, ";
                                    strSQL+="D_INV_ITEM_MASTER B ";
                                    strSQL+="WHERE ";
                                    ...
                                    rsTmp=data.getResult(strSQL);
                                    TotalOpening=EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"OPENING_VALUE",0),3);
                                    TotalOpeningQty=EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"OPENING_QTY",0),3);
                                    
                                    //Get Receipts and Issues between the opening date and from date
                                    strSQL="SELECT ROUND(SUM(B.LANDED_RATE*B.QTY),3) AS RECEIPT_VALUE,SUM(B.QTY) AS RECEIPT_QTY ";
                                    strSQL+="FROM ";
                                    strSQL+="D_INV_GRN_HEADER A, ";
                                    strSQL+="D_INV_GRN_DETAIL B, ";
                                    strSQL+="D_INV_ITEM_MASTER I ";
                                    ...
                                    rsTmp=data.getResult(strSQL);
                                    TotalOpening+=EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"RECEIPT_VALUE", 0),3);
                                    TotalOpeningQty+=EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"RECEIPT_QTY", 0),3);
                                    
                                    
                                    //Get Issues
                                    strSQL="SELECT ROUND(SUM(B.ISSUE_VALUE),3) AS ISSUE_VALUE,SUM(B.QTY) AS ISSUE_QTY ";
                                    strSQL+="FROM ";
                                    strSQL+="D_INV_ISSUE_HEADER A, ";
                                    strSQL+="D_INV_ISSUE_DETAIL B, ";
                                    strSQL+="D_INV_ITEM_MASTER I ";
                                    ...
                                    rsTmp=data.getResult(strSQL);
                                    TotalOpening=TotalOpening-(EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"ISSUE_VALUE",0),3));
                                    TotalOpeningQty=TotalOpeningQty-(EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"ISSUE_QTY",0),3));
                                    
                                    
                                    
                                    //Get STM Issues
                                    strSQL="SELECT ROUND(SUM(B.NET_AMOUNT),3) AS ISSUE_VALUE,SUM(B.QTY) AS ISSUE_QTY ";
                                    strSQL+="FROM ";
                                    strSQL+="D_INV_STM_HEADER A, ";
                                    strSQL+="D_INV_STM_DETAIL B, ";
                                    strSQL+="D_INV_ITEM_MASTER I ";
                                    ...
                                    //Now get Actual Receipts
                                    //Get Receipts and Issues between the opening date and from date
                                    strSQL="SELECT ROUND(SUM(B.LANDED_RATE*B.QTY),3) AS RECEIPT_VALUE,SUM(QTY) AS RECEIPT_QTY,ROUND(SUM(B.COLUMN_8_AMT),3) AS MODVAT ";
                                    strSQL+="FROM ";
                                    strSQL+="D_INV_GRN_HEADER A, ";
                                    strSQL+="D_INV_GRN_DETAIL B, ";
                                    strSQL+="D_INV_ITEM_MASTER I ";
                                    ...
                                    TotalExcise=EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"MODVAT", 0),3);
                                    
                                    
                                    
                                    //Get Issues
                                    strSQL="SELECT ROUND(SUM(B.ISSUE_VALUE),3) AS ISSUE_VALUE,SUM(QTY) AS ISSUE_QTY ";
                                    strSQL+="FROM ";
                                    strSQL+="D_INV_ISSUE_HEADER A, ";
                                    strSQL+="D_INV_ISSUE_DETAIL B, ";
                                    strSQL+="D_INV_ITEM_MASTER I ";
                                    ...
                                    //Get STM Issues
                                    strSQL="SELECT ROUND(SUM(B.NET_AMOUNT),3) AS ISSUE_VALUE,SUM(QTY) AS ISSUE_QTY ";
                                    strSQL+="FROM ";
                                    strSQL+="D_INV_STM_HEADER A, ";
                                    strSQL+="D_INV_STM_DETAIL B, ";
                                    strSQL+="D_INV_ITEM_MASTER I ";
                                    ...
                                    TotalIssueQty=TotalIssueQty+EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"ISSUE_QTY",0),3);
                    ...
                    try {
                        ...
                        else if(EITLERPGLOBAL.getComboCode(cmbItemType) ==13) {
    ...
    private void GenerateStockReport() {
        try {
            ...
            String Condition = "";
            if(EITLERPGLOBAL.getComboCode(cmbItemType)==13) {
                Condition = " AND C.CATEGORY_ID = 13 ";
            }
            else {
                Condition = " AND C.CATEGORY_ID <> 13 ";
            }
            ...
            int Comp_ID;
            String City;
            System.out.println("SR NO"+'~'+"CATEGORY NAME"+'~'+"ITEM ID"+'~'+"ITEM DESC"+'~'+"OPENING QTY"+""+'~'+"OPENING VALUE"+""+'~'+"RECEIPT QTY"+""+'~'+"RECEIPT VALUE"+'~'+"RECEIPT STM QTY"+""+'~'+"RECEIPT STM VALUE"+'~'+"ISSUE QTY"+""+'~'+"ISSE VALUE"+'~'+"ISSUE STM QTY"+""+'~'+"ISSE STM VALUE"+'~'+"CLOSING QTY"+'~'+"CLOSING VALUE"+'~'+"CLOSING QTY"+'~'+"CLOSING VALUE");
            ...
            if(EITLERPGLOBAL.getComboCode(cmbItemType)==2) {
                ...
                "WHERE A.CATEGORY_TYPE=2 AND C.CATEGORY_ID=A.CATEGORY_ID " +
                Condition +
                ...
                if(rsTmp.getRow()>0) {
                    while(!rsTmp.isAfterLast()) {
                        ...
                        if (CloseQty == 0) {
                           ...
                           // System.out.println(Double.toString(EITLERPGLOBAL.round((UtilFunctions.getDouble(rsTmp,"OPENING_VALUE",0) + ReceiptValue),3) - IssueValue));
                        }
                        //System.out.println(String.valueOf(Counter)+'~'+UtilFunctions.getString(rsTmp,"CATEGORY_NAME","")+'~'+UtilFunctions.getString(rsTmp,"ITEM_ID","")+'~'+UtilFunctions.getString(rsTmp,"ITEM_DESCRIPTION","")+'~'+UtilFunctions.getString(rsTmp,"OPENING_QTY","")+'~'+UtilFunctions.getString(rsTmp,"OPENING_VALUE","")+'~'+String.valueOf(ReceiptQty)+'~'+String.valueOf(ReceiptValue)+'~'+String.valueOf(ReceiptSTMQty)+'~'+String.valueOf(ReceiptSTMValue)+'~'+String.valueOf(IssueQty)+'~'+String.valueOf(IssueValue)+'~'+String.valueOf(IssueSTMQty)+'~'+String.valueOf(IssueSTMValue)+'~'+UtilFunctions.getString(rsTmp,"CLOSING_QTY","")+'~'+Double.toString(EITLERPGLOBAL.round(Double.parseDouble(UtilFunctions.getString(rsTmp,"CLOSING_VALUE","")),3))+'~'+Double.toString(EITLERPGLOBAL.round(CloseQty,3)+'~'+Double.toString(EITLERPGLOBAL.round((UtilFunctions.getDouble(rsTmp,"OPENING_VALUE",0) + ReceiptValue),3) - IssueValue)));
                        
                        System.out.println(String.valueOf(Counter)+'~'+UtilFunctions.getString(rsTmp,"CATEGORY_NAME","")+'~'+UtilFunctions.getString(rsTmp,"ITEM_ID","")+'~'+UtilFunctions.getString(rsTmp,"ITEM_DESCRIPTION","")+'~'+EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"OPENING_QTY",0),3)+'~'+EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"OPENING_VALUE",0),3)+'~'+EITLERPGLOBAL.round(ReceiptQty,3)+'~'+dFormat.format(EITLERPGLOBAL.round(ReceiptValue,3))+'~'+EITLERPGLOBAL.round(ReceiptSTMQty,3)+'~'+dFormat.format(EITLERPGLOBAL.round(ReceiptSTMValue,3))+'~'+EITLERPGLOBAL.round(IssueQty,3)+'~'+dFormat.format(EITLERPGLOBAL.round(IssueValue,3))+'~'+EITLERPGLOBAL.round(IssueSTMQty,3)+'~'+dFormat.format(EITLERPGLOBAL.round(IssueSTMValue,3))+'~'+EITLERPGLOBAL.round(UtilFunctions.getDouble(rsTmp,"CLOSING_QTY",0),3)+'~'+EITLERPGLOBAL.round(Double.parseDouble(UtilFunctions.getString(rsTmp,"CLOSING_VALUE","")),3));
                        //+'~'+EITLERPGLOBAL.round(CloseQty,3)+'~'+ dFormat.format(EITLERPGLOBAL.round((UtilFunctions.getDouble(rsTmp,"OPENING_VALUE",0) + ReceiptValue),3) - IssueValue));
