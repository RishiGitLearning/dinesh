 ...
 * @author Dharmendra
 */
public class JobworkWeavingNotification {
    ...
    public static void main(String[] args) {
        ...
        //if (EITLERPGLOBAL.getCurrentDay() == 25) {
            String sql = "SELECT D.DEPT_ID,UPPER(D.DEPT_DESC) AS DEPT_NAME, JOB_CAT,SUM(RECEIVED_QTY) AS RECEIVED_QTY,SUM(B.TOTAL_AMOUNT) AS TOTAL_AMOUNT,NOW()      FROM\n"                
                ...
                + " B.JOB_NO NOT LIKE ('RM%') AND D.DEPT_ID=20\n"                
            ...
            String sql1 = "SELECT D.DEPT_ID,UPPER(D.DEPT_DESC) AS DEPT_NAME, JOB_CAT,UPPER(B.ITEM_ID) AS ITEM,ITEM_EXTRA_DESC,A.JOB_NO, A.JOB_DATE,RECEIVED_QTY,RATE,B.TOTAL_AMOUNT,NOW()     FROM\n"                
                ...
                + " AND B.JOB_NO NOT LIKE ('RM%')  AND D.DEPT_ID=20\n"    
                + " UNION ALL\n"                
        ...
        //String recievers = "rishineekhra@dineshmills.com";
            ...
            exprt.fillData(sql3+"#"+sql2+"#"+sql1+"#"+sql, new File("/Email_Attachment/Jobwork_Weaving.xls"), "DetailUnapproved#SummaryUnApproved#DetailApproved#SummaryApproved");            
            String responce = sendNotificationMailWithAttachement("Jobwork Weaving", "Jobwork Weaving", recievers, pcc, "/Email_Attachment/Jobwork_Weaving.xls", "Jobwork_Weaving.xls");
            System.out.println("Mail Response:" + responce);
        //}
