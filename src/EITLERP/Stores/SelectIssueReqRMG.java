...
public class SelectIssueReqRMG extends javax.swing.JApplet {
    ...
    public SelectIssueReqRMG(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn) {
        initComponents();
        setSize(500,500);
    ...
    private void initComponents() {
        ...
        cmbDept.setBounds(76, 46, 224, 20);
    ...
    private void txtMRNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMRNoKeyPressed
        ...
        if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            if(chkDept.isSelected()) {
                ...
                strSQL+="B.COST_CENTER_CODE=5555 AND ";
