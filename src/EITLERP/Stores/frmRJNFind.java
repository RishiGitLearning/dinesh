 ...
 * @author  nrpithva
 */
/*<APPLET CODE=frmRJNFind.class HEIGHT=271 WIDTH=570></APPLET>*/
...
public class frmRJNFind extends javax.swing.JApplet {

    public boolean Cancelled=false;
    public String strQuery;
    public int RJNType=2;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.setBounds(6, 38, 458, 284);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       strQuery=" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND RJN_TYPE=2 ";
