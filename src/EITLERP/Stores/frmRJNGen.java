...
/*<APPLET CODE=frmRJNGen.class HEIGHT=525 WIDTH=773></APPLET>*/
 ...
 *
 */
public class frmRJNGen extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if(getName().equals("Link")) {
            ...
            if(ObjRJNGen.LoadData(EITLERPGLOBAL.gCompanyID)) {
                ObjRJNGen.MoveLast();
                DisplayData();
            }
            else {
                JOptionPane.showMessageDialog(null,"Error occured while loading data. Error is "+ObjRJNGen.LastError);
            }
        }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText(" REJECTION MEMO (General)");
        ...
        txtSuppCode.setBounds(115, 70, 62, 19);
        
        txtSuppName.setEnabled(false);
        Tab1.add(txtSuppName);
        txtSuppName.setBounds(179, 70, 212, 19);
        
        jLabel11.setText("Transporter ");
        Tab1.add(jLabel11);
        jLabel11.setBounds(29, 137, 86, 15);
        ...
        cmbTransporter.setBounds(115, 134, 274, 24);
        
        jLabel12.setText("Gatepass No.");
        Tab1.add(jLabel12);
        jLabel12.setBounds(21, 204, 88, 15);
        ...
        txtGatepassNo.setBounds(115, 202, 114, 19);
        
        jLabel13.setText("Currency");
        Tab1.add(jLabel13);
        jLabel13.setBounds(49, 242, 56, 15);
        ...
        cmbCurrency.setBounds(115, 238, 134, 24);
        
        jLabel14.setText("Currency Rate");
        Tab1.add(jLabel14);
        jLabel14.setBounds(23, 274, 90, 15);
        ...
        chkCancelled.setBounds(632, 38, 85, 23);
        ...
        Tab1.add(jLabel15);
        jLabel15.setBounds(13, 108, 107, 15);
        ...
        cmbTransportMode.setBounds(115, 104, 274, 24);
        
        jLabel16.setText("Gatepass Type ");
        Tab1.add(jLabel16);
        jLabel16.setBounds(17, 174, 96, 15);
        ...
        cmbGatepassType.setBounds(115, 170, 172, 24);
        
        jLabel5.setText("Date");
        Tab1.add(jLabel5);
        jLabel5.setBounds(247, 204, 29, 15);
        ...
        txtGatepassDate.setBounds(283, 202, 100, 19);
        ...
        txtCurrencyRate.setBounds(115, 272, 134, 19);
        
        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(217, 15, 31, 15);
        ...
        cmdRemarksBig.setBounds(454, 341, 33, 21);
        ...
        Tab1.add(cmdChange);
        cmdChange.setBounds(126, 38, 88, 20);
        ...
        Tab2.add(cmdInsert);
        cmdInsert.setBounds(409, 8, 141, 25);
        ...
        Tab2.add(jPanel4);
        jPanel4.setBounds(104, 19, 144, 8);
        ...
        Tab2.add(jLabel6);
        jLabel6.setBounds(6, 218, 280, 15);
        ...
        Tab2.add(cmdRead);
        cmdRead.setBounds(253, 8, 152, 25);
        ...
        cmdFromRemarksBig.setBounds(610, 77, 33, 21);
        ...
        jScrollPane2.setBounds(12, 40, 702, 144);
        ...
        jScrollPane3.setBounds(14, 207, 547, 127);
        ...
        cmdViewHistory.setBounds(579, 238, 132, 24);
        ...
        cmdNormalView.setBounds(579, 269, 132, 24);
        ...
        cmdPreviewA.setBounds(579, 208, 132, 24);
        ...
        cmdShowRemarks.setBounds(579, 301, 132, 24);
        
        txtAuditRemarks.setEnabled(false);
        jPanel1.add(txtAuditRemarks);
        txtAuditRemarks.setBounds(584, 334, 129, 19);
    ...
    private void txtDocNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDocNoFocusLost
        ...
        {
        if(clsRJNGen.IsRJNExist(EITLERPGLOBAL.gCompanyID,txtDocNo.getText()))
        {
          JOptionPane.showMessageDialog(null,"RJN No. already exist. Please specify other document no.");
        }
        }
    ...
    private void cmdNormalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNormalViewActionPerformed
        // TODO add your handling code here:
        ObjRJNGen.LoadData(EITLERPGLOBAL.gCompanyID);
        MoveLast();
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        ...
        ObjRJNGen.ShowHistory(EITLERPGLOBAL.gCompanyID, DocNo);
        MoveLast();
    ...
    private void cmdInsertFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cmdInsertFocusGained
        // TODO add your handling code here:
        ShowMessage("Click this button to bring GRN Itme dialog box");
    ...
    private void txtGatepassDateFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtGatepassDateFocusGained
        // TODO add your handling code here:
        ShowMessage("Shows the date of selected gatepass");
    ...
    private void cmdInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdInsertActionPerformed
        ...
        ObjGRN.GRNType=1; //General Material GRNs
        if(ObjGRN.ShowList()) {
            DoNotEvaluate=true;
            
            if(ObjGRN.CopyHeader) {
                txtSuppCode.setText((String)ObjGRN.ObjGRNGen.getAttribute("SUPP_ID").getObj());
                txtSuppName.setText(clsSupplier.getSupplierName(EITLERPGLOBAL.gCompanyID, txtSuppCode.getText()));
                
                if(txtSuppCode.getText().trim().equals("000000")) {
                    txtSuppName.setText((String)ObjGRN.ObjGRNGen.getAttribute("PARTY_NAME").getObj());
                }
                
                EITLERPGLOBAL.setComboIndex(cmbCurrency,(int)ObjGRN.ObjGRNGen.getAttribute("CURRENCY_ID").getVal());
                txtCurrencyRate.setText(Double.toString(ObjGRN.ObjGRNGen.getAttribute("CURRENCY_RATE").getVal()));
            }
            ...
            for(int i=1;i<=ObjGRN.colSelItems.size();i++) {
                ...
                DataModelL.setValueByVariable("REASON",(String)ObjItem.getAttribute("REASON").getObj(),NewRow);
    ...
    private void DisplayData() {
        ...
        if(EditMode==0)
        {
           if(ObjRJNGen.getAttribute("APPROVED").getInt()==1)
           {
           ...
           if(ObjRJNGen.getAttribute("CANCELLED").getInt()==1)
           {
        ...
        try {
            ClearFields();
            txtDocNo.setText((String)ObjRJNGen.getAttribute("RJN_NO").getObj());
            lblTitle.setText("REJECTION MEMO (General) - "+txtDocNo.getText());
            lblRevNo.setText(Integer.toString((int)ObjRJNGen.getAttribute("REVISION_NO").getVal()));
            txtDocDate.setText(EITLERPGLOBAL.formatDate((String)ObjRJNGen.getAttribute("RJN_DATE").getObj()));
            txtSuppCode.setText((String)ObjRJNGen.getAttribute("SUPP_ID").getObj());
            txtSuppName.setText(clsSupplier.getSupplierName(EITLERPGLOBAL.gCompanyID, txtSuppCode.getText()));
            
            if(txtSuppCode.getText().trim().equals("000000")) {
                txtSuppName.setText((String)ObjRJNGen.getAttribute("PARTY_NAME").getObj());
            }
            
            EITLERPGLOBAL.setComboIndex(cmbTransporter,(int)ObjRJNGen.getAttribute("TRANSPORTER").getVal());
            EITLERPGLOBAL.setComboIndex(cmbTransportMode,(int)ObjRJNGen.getAttribute("MODE_TRANSPORT").getVal());
            EITLERPGLOBAL.setComboIndex(cmbGatepassType,(String)ObjRJNGen.getAttribute("GATEPASS_TYPE").getObj());
            txtGatepassNo.setText((String)ObjRJNGen.getAttribute("GATEPASS_NO").getObj());
            txtGatepassDate.setText(EITLERPGLOBAL.formatDate((String)ObjRJNGen.getAttribute("GATEPASS_DATE").getObj()));
            EITLERPGLOBAL.setComboIndex(cmbCurrency,(int)ObjRJNGen.getAttribute("CURRENCY_ID").getVal());
            txtCurrencyRate.setText(Double.toString(ObjRJNGen.getAttribute("CURRENCY_RATE").getVal()));
            chkCancelled.setSelected(ObjRJNGen.getAttribute("CANCELLED").getBool());
            txtRemarks.setText((String)ObjRJNGen.getAttribute("REMARKS").getObj());
            
            EITLERPGLOBAL.setComboIndex(cmbHierarchy,(int)ObjRJNGen.getAttribute("HIERARCHY_ID").getVal());
            
            //============= Display Custom Columns ========================
            for(int i=1;i<=10;i++) {
                int ColID=(int)ObjRJNGen.getAttribute("COLUMN_"+Integer.toString(i)+"_ID").getVal();
                ...
                if(ColID!=0) {
                    //Set the Formula
                    if(ObjRJNGen.getAttribute("COLUMN_"+Integer.toString(i)+"_FORMULA").getObj()!=null) {
                        DataModelH.SetFormula(Col, (String)ObjRJNGen.getAttribute("COLUMN_"+Integer.toString(i)+"_FORMULA").getObj());
                    }
                    else {
                    ...
                    if(ObjTax.getUsePercentage(EITLERPGLOBAL.gCompanyID, TaxID)) {
                        DataModelH.setValueByVariableEx("P_"+ColID, Double.toString(ObjRJNGen.getAttribute("COLUMN_"+Integer.toString(i)+"_PER").getVal()),1);
                    }
                    
                    //Set the Value
                    DataModelH.setValueByVariableEx(Variable, Double.toString(ObjRJNGen.getAttribute("COLUMN_"+Integer.toString(i)+"_AMT").getVal()), 1);
                }
            }
            //=================================================================//
            ...
            for(int i=1;i<=ObjRJNGen.colRJNItems.size();i++) {
                //Insert New Row
                Object[] rowData=new Object[1];
                DataModelL.addRow(rowData);
                int NewRow=TableL.getRowCount()-1;
                
                clsRJNGenItem ObjItem=(clsRJNGenItem)ObjRJNGen.colRJNItems.get(Integer.toString(i));
            ...
            String DocNo=(String)ObjRJNGen.getAttribute("RJN_NO").getObj();
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 9, DocNo);
            ...
            FormatGridHS();
            HashMap History=clsRJNGen.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for(int i=1;i<=History.size();i++) {
                clsRJNGen ObjHistory=(clsRJNGen)History.get(Integer.toString(i));
    ...
    private void SetData() {
        //Header Fields
        if(EditMode==EITLERPGLOBAL.ADD) {
            ObjRJNGen.UserDocNo=txtDocNo.isEnabled();
            ObjRJNGen.setAttribute("RJN_NO",txtDocNo.getText());
        }
        else {
            ObjRJNGen.UserDocNo=false;
        }
        
        ObjRJNGen.setAttribute("COMPANY_ID",EITLERPGLOBAL.gCompanyID);
        ObjRJNGen.setAttribute("PREFIX",SelPrefix);
        ObjRJNGen.setAttribute("SUFFIX",SelSuffix);
        ObjRJNGen.setAttribute("FFNO",FFNo);
        ObjRJNGen.setAttribute("RJN_DATE",EITLERPGLOBAL.formatDateDB(txtDocDate.getText()));
        ObjRJNGen.setAttribute("SUPP_ID",txtSuppCode.getText());
        
        ObjRJNGen.setAttribute("PARTY_NAME","");
        if(txtSuppCode.getText().trim().equals("000000")) {
            ObjRJNGen.setAttribute("PARTY_NAME",txtSuppName.getText());
        }
        
        ObjRJNGen.setAttribute("MODE_TRANSPORTER",EITLERPGLOBAL.getComboCode(cmbTransportMode));
        ObjRJNGen.setAttribute("TRANSPORTER",EITLERPGLOBAL.getComboCode(cmbTransporter));
        ObjRJNGen.setAttribute("GATEPASS_TYPE",EITLERPGLOBAL.getCombostrCode(cmbGatepassType));
        ObjRJNGen.setAttribute("GATEPASS_NO",txtGatepassNo.getText());
        ObjRJNGen.setAttribute("GATEPASS_DATE",EITLERPGLOBAL.formatDate(txtGatepassDate.getText()));
        ObjRJNGen.setAttribute("CURRENCY_ID",EITLERPGLOBAL.getComboCode(cmbCurrency));
        ObjRJNGen.setAttribute("CURRENCY_RATE",EITLERPGLOBAL.round(Double.parseDouble(txtCurrencyRate.getText()),5));
        
        if(chkCancelled.isSelected()) {
            ObjRJNGen.setAttribute("CANCELLED",true);
        }
        else {
        ...
        ObjRJNGen.setAttribute("FOR_STORE",clsUser.getDeptID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID));
        ObjRJNGen.setAttribute("REMARKS",txtRemarks.getText());
        
        //----- Update Approval Specific Fields -----------//
        ObjRJNGen.setAttribute("HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbHierarchy));
        ObjRJNGen.setAttribute("FROM",EITLERPGLOBAL.gNewUserID);
        ObjRJNGen.setAttribute("TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        ObjRJNGen.setAttribute("FROM_REMARKS",txtToRemarks.getText());
        
        if(OpgApprove.isSelected()) {
            ObjRJNGen.setAttribute("APPROVAL_STATUS","A");
        }
        
        if(OpgFinal.isSelected()) {
            ObjRJNGen.setAttribute("APPROVAL_STATUS","F");
        }
        
        if(OpgReject.isSelected()) {
            ObjRJNGen.setAttribute("APPROVAL_STATUS","R");
        }
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ObjRJNGen.setAttribute("CREATED_BY",EITLERPGLOBAL.gNewUserID);
            ObjRJNGen.setAttribute("CREATED_DATE",EITLERPGLOBAL.getCurrentDateDB());
        }
        else {
            ObjRJNGen.setAttribute("MODIFIED_BY",EITLERPGLOBAL.gNewUserID);
            ObjRJNGen.setAttribute("MODIFIED_DATE",EITLERPGLOBAL.getCurrentDateDB());
        }
        ...
        for(int i=0;i<TableH.getRowCount();i++) {
            ...
            if( (ColID!=0) && (ColID!=-99) && (!Variable.substring(0,2).equals("P_"))) {
                ColCounter++;
                ObjRJNGen.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_ID",ColID);
                ObjRJNGen.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_FORMULA",DataModelH.getFormula(i));
                
                if(ObjTax.getUsePercentage(EITLERPGLOBAL.gCompanyID, TaxID)) {
                    lnPercentValue=Double.parseDouble(DataModelH.getValueByVariableEx("P_"+ColID,1));
                    ObjRJNGen.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_PER",EITLERPGLOBAL.round(lnPercentValue,3));
                }
                ObjRJNGen.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_AMT",EITLERPGLOBAL.round(Double.parseDouble(DataModelH.getValueByVariableEx(Variable, 1)),5));
                ObjRJNGen.setAttribute("COLUMN_"+Integer.toString(ColCounter)+"_CAPTION",(String)TableH.getValueAt(i, 0));
            }
        }
        //=================================================================
    ...
    private void SetupColumns() {
        ...
        List=clsColumn.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND MODULE_ID=9 AND HEADER_LINE='L' ORDER BY COL_ORDER");
        ...
        ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=9 AND HIDDEN=0 AND SHOW_LAST=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        ...
        ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=9 AND HIDDEN=1 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
        for(int i=1;i<=ColList.size();i++) {
            clsSystemColumn ObjColumn=(clsSystemColumn)ColList.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            ColList=clsSystemColumn.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=9 AND HIDDEN=0 AND SHOW_LAST=0 ORDER BY D_COM_SYSTEM_COLUMNS.ORDER");
            for(int i=1;i<=ColList.size();i++) {
                clsSystemColumn ObjColumn=(clsSystemColumn)ColList.get(Integer.toString(i));
    ...
    private void SetupColumns_H() {
        ...
        List=clsColumn.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND MODULE_ID=9 AND HEADER_LINE='H' ORDER BY COL_ORDER");
    ...
    private void GenerateCombos() {
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=9");
        }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, 9,(String)ObjRJNGen.getAttribute("RJN_NO").getObj());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,555)) {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, 9,(String)ObjRJNGen.getAttribute("RJN_NO").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,9,FromUserID,(String)ObjRJNGen.getAttribute("RJN_NO").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,551)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Edit Rights --
        cmdEdit.setEnabled(true);
   /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,552))
   {
      cmdEdit.setEnabled(true);
   }
   else
   {
       cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,553)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,554)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
        ...
        if(aList.ShowList()) {
            ...
            {
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 9, FFNo,  false));
    ...
    private void Edit() {
        ...
        String lDocNo=(String)ObjRJNGen.getAttribute("RJN_NO").getObj();
        if(ObjRJNGen.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(9,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,552)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Delete() {
        ...
        if(JOptionPane.showConfirmDialog(null,"Are you sure you want to delete this record ?","SDML ERP",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) {
            if(ObjRJNGen.CanDelete(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
                if(ObjRJNGen.Delete(EITLERPGLOBAL.gNewUserID)) {
                    MoveLast();
                }
                else {
                    JOptionPane.showMessageDialog(null,"Error occured while deleting. Error is "+ObjRJNGen.LastError);
                }
            }
            else {
    ...
    private void Save() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            if(ObjRJNGen.Insert()) {
                ...
                JOptionPane.showMessageDialog(null,"Error occured while saving. Error is "+ObjRJNGen.LastError);
                return;
            }
        }
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Stores.frmRJNGenFind",true);
        frmRJNGenFind ObjReturn= (frmRJNGenFind) ObjLoader.getObj();
        
        if(ObjReturn.Cancelled==false) {
            if(!ObjRJNGen.Filter(ObjReturn.strQuery,EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID,String pDocNo) {
        ObjRJNGen.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND RJN_NO='"+pDocNo+"' AND RJN_TYPE=1",pCompanyID);
        ObjRJNGen.MoveLast();
        DisplayData();
    }
    
    public void FindWaiting() {
        ObjRJNGen.Filter(" WHERE RJN_NO IN(SELECT D_INV_RJN_HEADER.RJN_NO FROM D_INV_RJN_HEADER,D_COM_DOC_DATA WHERE D_INV_RJN_HEADER.RJN_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_RJN_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_RJN_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_COM_DOC_DATA.USER_ID="+EITLERPGLOBAL.gNewUserID+" AND D_COM_DOC_DATA.STATUS='W' AND D_INV_RJN_HEADER.RJN_TYPE=1 AND MODULE_ID=9)",EITLERPGLOBAL.gCompanyID);
        ObjRJNGen.MoveLast();
        DisplayData();
    }
    ...
    private void PreviewReport() {
        ...
        try {
            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptRJNGen.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText());
    ...
    private void PreviewAuditReport() {
        try {
            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptRJN1A.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+txtDocNo.getText()+"&DocType=1");
            EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
        }
        catch(Exception e) {
