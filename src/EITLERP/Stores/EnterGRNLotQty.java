...
public class EnterGRNLotQty extends javax.swing.JApplet {
    ...
    public String lGRNNo="";
    public int lGRNSrNo=0;
    public String lItemID="";
    
    public EnterGRNLotQty() {
        System.gc();
        initComponents();
    }
...
//        }
    ...
    private void GenerateGrid() {
        ...
        for(int i=1;i<=colLot.size();i++) {
            clsGRNLot ObjLot=(clsGRNLot)colLot.get(Integer.toString(i));
            Object[] rowData=new Object[6];
    ...
    private void SetLot() {
        ...
        for(int i=0;i<Table.getRowCount();i++) {
            ...
            ObjLot.setAttribute("GRN_NO",lGRNNo);
            ObjLot.setAttribute("GRN_SR_NO",lGRNSrNo);
            ...
            ObjLot.setAttribute("BALANCE_QTY",Double.parseDouble(DataModel.getValueByVariable("LOT_ACCEPTED_QTY",i)));
