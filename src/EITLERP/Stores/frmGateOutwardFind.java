...
public class frmGateOutwardFind extends javax.swing.JApplet {
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
         strQuery=strQuery+" AND OUTWARD_NO='"+txtDocNo.getText()+"' ";
       }
       
       if(!txtDateFrom.getText().equals(""))
       {
         strQuery=strQuery+" AND OUTWARD_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
       }

       if(!txtDateTo.getText().equals(""))
       {
         strQuery=strQuery+" AND OUTWARD_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
       
       if (!txtGatePassNo.getText().trim().equals("")) {
           strQuery = strQuery+ " AND GATEPASS_NO='"+ txtGatePassNo.getText().trim() +"' ";
       }
