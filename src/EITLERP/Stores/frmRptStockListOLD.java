...
public class frmRptStockListOLD extends javax.swing.JApplet {
                    ...
                    if(rsItemGroup.getRow()>0) {
                        while(!rsItemGroup.isAfterLast()) {
                            ...
                            while((!rsItem.isAfterLast())&&rsItem.getRow()>0) {
                                ...
                                strSQL="SELECT * FROM D_COM_OPENING_STOCK_DETAIL WHERE ITEM_ID LIKE '"+ItemID+"%' AND ENTRY_NO="+StockEntryNo;
                                rsTmp=data.getResult(strSQL);
                                rsTmp.first();
