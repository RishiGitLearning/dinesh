...
public class frmRMGroupStock_05_05_2010 extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel5.setBounds(200, 70, 20, 15);

        getContentPane().add(txtToDate);
        txtToDate.setBounds(220, 70, 112, 20);
        ...
        cmdExit.setBounds(360, 120, 116, 25);
        ...
        txtFromDate.setBounds(80, 70, 112, 20);
        ...
        cmdSummary.setBounds(360, 80, 119, 29);
                        ...
                        while(!rsCategory.isAfterLast()) {
                            ...
                            if(rsItem.getRow()>0) {
                                ...
                                while(!rsItem.isAfterLast()) {
                                    ...
                                    TotalOpening=UtilFunctions.getDouble(rsTmp,"OPENING_VALUE",0.0);
                                    TotalOpeningQty=UtilFunctions.getDouble(rsTmp,"OPENING_QTY",0.0);
                                    ...
                                    rsTmp=data.getResult(strSQL);
                                    TotalOpening+=UtilFunctions.getDouble(rsTmp,"RECEIPT_VALUE", 0.0);
                                    TotalOpeningQty+=UtilFunctions.getDouble(rsTmp,"RECEIPT_QTY", 0.0);
                                    ...
                                    rsTmp=data.getResult(strSQL);
                                    TotalOpening=TotalOpening-(UtilFunctions.getDouble(rsTmp,"ISSUE_VALUE",0.0));
                                    TotalOpeningQty=TotalOpeningQty-(UtilFunctions.getDouble(rsTmp,"ISSUE_QTY",0.0));
    ...
    private void GenerateStockReport() {
        try {
            ...
            "WHERE A.CANCELLED = 0 AND APPROVED = 1 AND A.COMPANY_ID =D.COMPANY_ID AND "+
            "SUBSTRING(A.ITEM_ID,7,1) =B.CATEGORY_SUB_ID AND "+
            "C.CATEGORY_ID =A.CATEGORY_ID AND " + Condition + " AND  "+
        ...
        try {
            ...
            if(rsCategory.getRow()>0) {
                while(!rsCategory.isAfterLast()) {
                    ...
                    "SUM((A.OPENING_QTY+A.TOTAL_RECEIPT_QTY-A.TOTAL_ISSUED_QTY)) AS CLOSING_QTY "+
                    "FROM D_INV_ITEM_MASTER A,D_INV_ITEM_GROUP B,D_INV_ITEM_CATEGORY C,D_COM_COMPANY_MASTER D  "+
                    "WHERE A.COMPANY_ID =D.COMPANY_ID AND  "+
                    //"SUBSTRING(A.ITEM_ID,7,1) =B.CATEGORY_SUB_ID AND  "+
                    "C.CATEGORY_ID =A.CATEGORY_ID AND A.CATEGORY_ID = '13' AND   "+
                    //"SUBSTRING(A.ITEM_ID,4,1) =B.CATEGORY_ID AND  "+
                    "A.COMPANY_ID = "+ EITLERPGLOBAL.gCompanyID+" AND  "+
