 ...
 */
public class frmGSTR1Info extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        Table_b2bHSN = new javax.swing.JTable();
        btnShowB2BHSN = new javax.swing.JButton();
        Export_B2BHSN = new javax.swing.JButton();
        ...
        Export_B2B.setBounds(540, 10, 170, 23);
        jPanel10.add(file1);
        file1.setBounds(150, 0, 582, 380);

        jLabel6.setText("INVOICE VALUE");
        jPanel10.add(jLabel6);
        jLabel6.setBounds(110, 400, 110, 14);

        jLabel7.setText("TAXABLE VALUE");
        jPanel10.add(jLabel7);
        jLabel7.setBounds(230, 400, 110, 14);

        jLabel8.setText("CGST VALUE");
        jPanel10.add(jLabel8);
        jLabel8.setBounds(480, 400, 110, 14);

        jLabel9.setText("SGST VALUE");
        jPanel10.add(jLabel9);
        jLabel9.setBounds(360, 400, 110, 14);

        jLabel10.setText("IGST VALUE");
        jPanel10.add(jLabel10);
        jLabel10.setBounds(600, 400, 120, 14);
        ...
        totalInvAmt.setBounds(110, 420, 110, 20);
        jPanel10.add(totalTaxAmt);
        totalTaxAmt.setBounds(230, 420, 110, 20);
        jPanel10.add(totalCGSTAmt);
        totalCGSTAmt.setBounds(470, 420, 110, 20);
        jPanel10.add(totalSGSTAmt);
        totalSGSTAmt.setBounds(350, 420, 110, 20);
        jPanel10.add(totalIGSTAmt);
        totalIGSTAmt.setBounds(590, 420, 110, 20);

        jTabbedPane2.addTab("B2B", jPanel10);

        jPanel11.setLayout(null);

        Table_b2bHSN.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        Table_b2bHSN.setSelectionBackground(new java.awt.Color(208, 220, 234));
        Table_b2bHSN.setSelectionForeground(new java.awt.Color(231, 16, 16));
        Table_b2bHSN.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Table_b2bHSNKeyPressed(evt);
            }
        });
        jScrollPane11.setViewportView(Table_b2bHSN);

        jPanel11.add(jScrollPane11);
        jScrollPane11.setBounds(10, 50, 720, 340);

        btnShowB2BHSN.setText("Show List");
        btnShowB2BHSN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnShowB2BHSNActionPerformed(evt);
            }
        });
        jPanel11.add(btnShowB2BHSN);
        btnShowB2BHSN.setBounds(10, 10, 130, 30);

        Export_B2BHSN.setText("EXPORT TO EXCEL");
        Export_B2BHSN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Export_B2BHSNActionPerformed(evt);
            }
        });
        jPanel11.add(Export_B2BHSN);
        Export_B2BHSN.setBounds(540, 10, 170, 23);
        jPanel11.add(file2);
        file2.setBounds(150, 0, 582, 380);

        jTabbedPane2.addTab("B2B HSN wise Summary", jPanel11);
        ...
        jLabel1.setText("GST Return (GSTR) Information System");
    ...
    private void Table_b2bHSNKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Table_b2bHSNKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Table_b2bHSNKeyPressed

    private void btnShowB2BHSNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowB2BHSNActionPerformed
        // TODO add your handling code here:
        if ( ! Validate()) {
            return;
        }
        FormatGridHSN();
        GenerateB2BHSNData();
    }//GEN-LAST:event_btnShowB2BHSNActionPerformed

    private void Export_B2BHSNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Export_B2BHSNActionPerformed
        // TODO add your handling code here:
        File file = null;
        ...
        try {
            ...
            expHSN.fillData(Table_b2bHSN, file, "B2B_HSN_GSTR1");
            JOptionPane.showMessageDialog(null, "Data saved at "
    ...
    }//GEN-LAST:event_Export_B2BHSNActionPerformed
    ...
    private javax.swing.JButton Export_B2BHSN;
    private javax.swing.JTable Table_b2b;
    private javax.swing.JTable Table_b2bHSN;
    private javax.swing.JButton btnShowB2B;
    private javax.swing.JButton btnShowB2BHSN;
    ...
    private void FormatGrid() {
        try {
            ...
            DataModelB2B.addColumn("Invoice Number"); //2
            DataModelB2B.addColumn("Invoice date"); //3
            DataModelB2B.addColumn("Invoice Value"); //4
            DataModelB2B.addColumn("Place Of Supply"); //5
            DataModelB2B.addColumn("Reverse Charge"); //6
            DataModelB2B.addColumn("Invoice Type"); //7
            DataModelB2B.addColumn("E-Commerce GSTIN"); //8
            DataModelB2B.addColumn("Rate"); //9
            DataModelB2B.addColumn("Taxable Value"); //10
            DataModelB2B.addColumn("Cess Amount"); //11
            //ADDED EXTRA FIELDS FOR MORE DETAIL
            DataModelB2B.addColumn("Party Code"); //12
            DataModelB2B.addColumn("Party Name"); //13
            DataModelB2B.addColumn("SGST Per"); //14
            DataModelB2B.addColumn("SGST Value"); //15
            DataModelB2B.addColumn("CGST Per"); //16
            DataModelB2B.addColumn("CGST Value"); //17
            DataModelB2B.addColumn("IGST Per"); //18
            DataModelB2B.addColumn("IGST Value"); //19
            DataModelB2B.addColumn("HSN Code");//20
            DataModelB2B.addColumn("Total QTY");
            ...
            Table_b2b.getColumnModel().getColumn(21).setMinWidth(80);
    ...
    public void GenerateB2BData(String ORDER_BY) {
        ...
        try {
            ...
            while (!rs.isAfterLast()) {
                ...
                rowData[5] = rs.getString("PLACE_OF_SUPPLY");
                rowData[6] = rs.getString("REV_CHRG");
                rowData[7] = rs.getString("INVOICE_TYPE");
                rowData[8] = rs.getString("E_COMM_GSTIN_NO");
                rowData[9] = rs.getInt("RATE");
                rowData[10] = rs.getString("TAXABLE_VALUE");
                rowData[11] = "";
                
                rowData[12] = rs.getString("PARTY_CODE");
                ...
                rowData[13] = pName;
                rowData[14] = rs.getString("PER_SGST");
                rowData[15] = rs.getString("SGST_AMT");
                rowData[16] = rs.getString("PER_CGST");
                rowData[17] = rs.getString("CGST_AMT");
                rowData[18] = rs.getString("PER_IGST");
                rowData[19] = rs.getString("IGST_AMT");
                rowData[20] = rs.getString("HSN");
                rowData[21] = rs.getString("TOTAL_QTY");
    ...
    private void FormatGridHSN() {
        try {
            DataModelB2BHSN = new EITLTableModel();
            Table_b2bHSN.removeAll();

            Table_b2bHSN.setModel(DataModelB2BHSN);
            Table_b2bHSN.setAutoResizeMode(0);

            DataModelB2BHSN.addColumn("SrNo"); //0 - Read Only
            DataModelB2BHSN.addColumn("HSN"); //1
            DataModelB2BHSN.addColumn("Description"); //2
            DataModelB2BHSN.addColumn("UQC"); //3
            DataModelB2BHSN.addColumn("Total Quantity"); //4
            DataModelB2BHSN.addColumn("Total value"); //5
            DataModelB2BHSN.addColumn("Total Taxable Value"); //6
            DataModelB2BHSN.addColumn("Integrated Tax"); //7
            DataModelB2BHSN.addColumn("Central Tax"); //8
            DataModelB2BHSN.addColumn("State/UT Tax"); //9
            DataModelB2BHSN.addColumn("CESS"); //10
            DataModelB2BHSN.addColumn("Actions"); //11
            
            DataModelB2BHSN.SetNumeric(4, true);
            DataModelB2BHSN.SetNumeric(5, true);
            DataModelB2BHSN.SetNumeric(6, true);
            DataModelB2BHSN.SetNumeric(7, true);
            DataModelB2BHSN.SetNumeric(8, true);
            DataModelB2BHSN.SetNumeric(9, true);
            
            for(int i=0;i<=11;i++) {
                DataModelB2BHSN.SetReadOnly(i);
            }
                        
            Table_b2bHSN.getColumnModel().getColumn(0).setMinWidth(40);
//            Table_b2b.getColumnModel().getColumn(0).setMaxWidth(40);
            Table_b2bHSN.getColumnModel().getColumn(1).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(1).setMaxWidth(70);
            Table_b2bHSN.getColumnModel().getColumn(2).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(2).setMaxWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(3).setMinWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(4).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(4).setMaxWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(5).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(5).setMaxWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(6).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(6).setMaxWidth(100);
            Table_b2bHSN.getColumnModel().getColumn(7).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(7).setMaxWidth(100);
            Table_b2bHSN.getColumnModel().getColumn(8).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(8).setMaxWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(9).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(9).setMaxWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(10).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(10).setMaxWidth(80);
            Table_b2bHSN.getColumnModel().getColumn(11).setMinWidth(80);
            //Table_b2b.getColumnModel().getColumn(11).setMaxWidth(80);
    ...
    public void GenerateB2BHSNData() {
        
        try {
            
            String strSQL = "SELECT HSN_CODE,HSN_SAC_DESC,A.UQC,QUANTITY,TOTAL_VALUE,TOT_TAXABLE_VALUE,IGST,CGST,SGST FROM ";
            strSQL += "(SELECT HSN_CODE,UOM AS UQC,SUM(QUANTITY) AS QUANTITY ,SUM(TAXABLE_VALUE) AS TOT_TAXABLE_VALUE,SUM(INVOICE_VALUE) AS TOTAL_VALUE,SUM(IGST_AMT) AS IGST,SUM(CGST_AMT) AS CGST,SUM(SGST_AMT) AS SGST ";
            strSQL += "FROM FINANCE.D_SAL_GSTR_INVOICE_ERP ";
            strSQL += "WHERE INVOICE_DATE >='"+ EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"' AND INVOICE_DATE <= '"+ EITLERPGLOBAL.formatDateDB(txtToDate.getText()) +"'  "; 
            strSQL += "AND CANCELLED =0 ";
            strSQL += "GROUP BY HSN_CODE,UOM) AS A ";
            strSQL += "LEFT JOIN ";
            strSQL += "(SELECT * FROM DINESHMILLS.D_COM_HSN_SAC_MASTER) AS H ";
            strSQL += "ON HSN_CODE = HSN_SAC_CODE AND H.UQC = A.UQC ";
            ...
            while (!rs.isAfterLast()) {
                ...
                // rowData[0]=rs.getString("");
                rowData[0] = cnt++;
                rowData[1] = rs.getString("HSN_CODE");
                rowData[2] = rs.getString("HSN_SAC_DESC");
                rowData[3] = rs.getString("UQC");
                rowData[4] = rs.getString("QUANTITY");
                rowData[5] = rs.getString("TOTAL_VALUE");
                rowData[6] = rs.getString("TOT_TAXABLE_VALUE");
                rowData[7] = rs.getString("IGST");
                rowData[8] = rs.getString("CGST");
                rowData[9] = rs.getString("SGST");
                rowData[10] = "";
                rowData[11] = "";
                
                DataModelB2BHSN.addRow(rowData);
                rs.next();
            }
            rs.close();
