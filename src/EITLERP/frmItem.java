...
public class frmItem extends javax.swing.JApplet {
    
    private int EditMode=0;
    private clsItem ObjItem;
    ...
    public frmItem() {
        ...
        if(ObjItem.LoadData(EITLERPGLOBAL.gCompanyID)) {
            ObjItem.MoveLast();
            DisplayData();
            ...
            JOptionPane.showMessageDialog(null,"Error loading item data. Error is "+ObjItem.LastError);
        }
    ...
    private void initComponents() {
        ...
        cmdCopyItem = new javax.swing.JButton();
        ...
        txtToleranceLimit = new javax.swing.JTextField();
        ...
        cmdCopyItem.setText("Copy Item");
        cmdCopyItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdCopyItemActionPerformed(evt);
            }
        });
        ToolBar.add(cmdCopyItem);
        ...
        Tab1.add(txtItemID);
        txtItemID.setBounds(95, 10, 110, 28);

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Name :");
        Tab1.add(jLabel3);
        jLabel3.setBounds(5, 42, 85, 16);
        ...
        Tab1.add(txtName);
        txtName.setBounds(95, 40, 448, 28);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Type :");
        Tab1.add(jLabel4);
        jLabel4.setBounds(5, 85, 85, 16);
        ...
        cmbGroupCode.setBounds(95, 80, 172, 28);

        jLabel5.setText("Search Key :");
        Tab1.add(jLabel5);
        jLabel5.setBounds(285, 80, 75, 16);
        ...
        txtSearchKey.setBounds(365, 78, 94, 28);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Ware House :");
        Tab1.add(jLabel6);
        jLabel6.setBounds(5, 188, 85, 16);
        ...
        cmbWareHouse.setBounds(95, 184, 290, 28);

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Location :");
        Tab1.add(jLabel7);
        jLabel7.setBounds(5, 220, 85, 16);

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("Category :");
        Tab1.add(jLabel9);
        jLabel9.setBounds(5, 115, 85, 16);
        ...
        cmbCategory.setBounds(95, 110, 172, 28);
        ...
        Tab1.add(chkBlocked);
        chkBlocked.setBounds(530, 10, 80, 23);

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Supplier :");
        Tab1.add(jLabel8);
        jLabel8.setBounds(5, 256, 85, 16);
        ...
        cmbSupplier.setBounds(95, 254, 288, 28);
        ...
        Tab1.add(cmdNext1);
        cmdNext1.setBounds(496, 320, 104, 28);
        ...
        cmdItemNameBig.setBounds(545, 40, 40, 21);
        ...
        Tab1.add(chkOneTime);
        chkOneTime.setBounds(95, 150, 190, 20);

        lblAmendNo.setBackground(new java.awt.Color(255, 255, 204));
        lblAmendNo.setText("Amendment No.");
        Tab1.add(lblAmendNo);
        lblAmendNo.setBounds(380, 10, 150, 16);

        jLabel1.setText("XX99999999.XX");
        Tab1.add(jLabel1);
        jLabel1.setBounds(270, 10, 110, 16);
        ...
        txtDiscount.setBounds(90, 12, 112, 28);

        jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel28.setText("Rebate :");
        Tab4.add(jLabel28);
        jLabel28.setBounds(5, 40, 75, 16);
        ...
        Tab4.add(txtRebate);
        txtRebate.setBounds(90, 38, 112, 28);
        ...
        Tab4.add(jLabel29);
        jLabel29.setBounds(5, 118, 75, 16);
        ...
        Tab4.add(txtExcise);
        txtExcise.setBounds(90, 116, 112, 28);

        jLabel30.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel30.setText("Chapter :");
        Tab4.add(jLabel30);
        jLabel30.setBounds(5, 148, 75, 16);
        ...
        Tab4.add(cmbChapter);
        cmbChapter.setBounds(90, 146, 154, 28);
        ...
        txtHSNSACCode.setBounds(410, 40, 110, 28);

        jLabel38.setText("Tax Code Type:");
        Tab4.add(jLabel38);
        jLabel38.setBounds(290, 10, 110, 20);

        jLabel39.setText("HSN/SAC Code:");
        Tab4.add(jLabel39);
        jLabel39.setBounds(290, 40, 110, 20);
        ...
        cmbTaxCodeType.setBounds(410, 10, 81, 28);
        ...
        chkMaintainStock.setBounds(16, 12, 126, 20);

        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel18.setText("Maximum Qty. :");
        Tab3.add(jLabel18);
        jLabel18.setBounds(5, 86, 110, 16);

        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel19.setText("Minimum Qty. :");
        Tab3.add(jLabel19);
        jLabel19.setBounds(5, 52, 110, 16);
        ...
        Tab3.add(txtMinQty);
        txtMinQty.setBounds(125, 50, 122, 28);
        ...
        Tab3.add(txtMaxQty);
        txtMaxQty.setBounds(125, 84, 119, 28);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel20.setText("Unit :");
        Tab3.add(jLabel20);
        jLabel20.setBounds(5, 124, 110, 16);
        ...
        Tab3.add(cmbUnit);
        cmbUnit.setBounds(125, 120, 118, 28);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel21.setText("Rate :");
        Tab3.add(jLabel21);
        jLabel21.setBounds(5, 160, 110, 16);
        ...
        Tab3.add(txtRate);
        txtRate.setBounds(125, 156, 119, 28);
        ...
        Tab3.add(txtQ1Rate);
        txtQ1Rate.setBounds(432, 50, 119, 28);
        ...
        Tab3.add(txtQ2Rate);
        txtQ2Rate.setBounds(432, 76, 119, 28);
        ...
        Tab3.add(txtQ3Rate);
        txtQ3Rate.setBounds(432, 102, 119, 28);
        ...
        Tab3.add(txtQ4Rate);
        txtQ4Rate.setBounds(432, 130, 119, 28);
        ...
        Tab3.add(jLabel37);
        jLabel37.setBounds(5, 193, 110, 16);

        txtToleranceLimit.setEnabled(false);
        Tab3.add(txtToleranceLimit);
        txtToleranceLimit.setBounds(125, 190, 117, 28);
        ...
        cmbHierarchy.setBounds(100, 14, 184, 28);
        ...
        Tab5.add(cmbSendTo);
        cmbSendTo.setBounds(100, 224, 184, 28);
        ...
        txtToRemarks.setBounds(100, 260, 500, 28);

        txtFromRemarks.setBackground(new java.awt.Color(204, 204, 204));
        txtFromRemarks.setEnabled(false);
        Tab5.add(txtFromRemarks);
        txtFromRemarks.setBounds(100, 78, 463, 28);
        ...
        Tab5.add(txtFrom);
        txtFrom.setBounds(100, 50, 182, 28);
    ...
    private void cmbGroupCodeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbGroupCodeItemStateChanged
        ...
        if(EITLERPGLOBAL.getComboCode(cmbGroupCode)!=0) {
            ...
            if(groupCode==1 || groupCode==3  || groupCode==4) {
    ...
    private void txtItemIDFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtItemIDFocusLost
        ...
        int creator = clsHierarchy.getCreatorID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.getComboCode(cmbHierarchy));
        if(EditMode==EITLERPGLOBAL.ADD) {
            if (ItemID.toUpperCase().startsWith("RM") && (creator != 6)) { // && (EditMode==EITLERPGLOBAL.ADD)
                JOptionPane.showMessageDialog(this,"You are not authorised to create Raw Material Item.");
            }
        }
        String str = "SELECT A.ITEM_ID, A.ITEM_HIERARCHY_ID "+
        " FROM D_INV_ITEM_MASTER A , D_COM_HIERARCHY_RIGHTS B "+
        " WHERE A.ITEM_ID = '"+txtItemID.getText().trim()+"' AND A.ITEM_HIERARCHY_ID =B.HIERARCHY_ID "+
        " AND B.USER_ID=6 AND B.SR_NO=1 AND A.CANCELLED=0 ";
        if (ItemID.toUpperCase().startsWith("RM") && (EditMode==EITLERPGLOBAL.EDIT) && (!data.IsRecordExist(str))) {
            JOptionPane.showMessageDialog(this,"You are not authorised to create Raw Material Item.");
        ...
        if (! ItemID.equals("")) {
            ...
            if(len == 7) {
                ...
                if(!EITLERPGLOBAL.IsNumber(ItemID.substring(1,6))) {
                    JOptionPane.showMessageDialog(null,"Please enter valid Item Code");
                }
                ...
                if (len == 8) {
                    if (EITLERPGLOBAL.getComboCode(cmbCategory)==1) {
                        if (! EITLERPGLOBAL.IsNumber(ItemID)) {
                            JOptionPane.showMessageDialog(null,"Item Code Must be Numeric");
                        }
                    }
                }
                if (len == 9) {
    ...
    private void cmdCopyItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCopyItemActionPerformed
        // TODO add your handling code here:
        ...
        if(EditMode!=0) {
            try {
                ...
                if(aList.ShowLOV()) {
                    String CopyItemID=aList.ReturnVal;
                    
                    ObjItem=(clsItem)(new clsItem()).getObject(EITLERPGLOBAL.gCompanyID, CopyItemID);
    ...
    }//GEN-LAST:event_cmdCopyItemActionPerformed
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,1,txtItemID.getText())) {
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private void cmdNormalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNormalViewActionPerformed
        // TODO add your handling code here:
        ObjItem.LoadData(EITLERPGLOBAL.gCompanyID);
        MoveFirst();
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        ...
        ObjItem.ShowHistory(EITLERPGLOBAL.gCompanyID, DocNo);
        MoveFirst();
    ...
    private void cmdPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPreviewActionPerformed
        // TODO add your handling code here:
        try {
            AppletFrame.startApplet("EITLERP.ReportUI.frmItemList","Item List Report");
        }
        catch(Exception e) {
    ...
    private javax.swing.JButton cmdCopyItem;
    ...
    private javax.swing.JTextField txtToleranceLimit;
    ...
    private void SetFields(boolean pStat) {
        ...
        EITLERPGLOBAL.setComboIndex(cmbGroupCode,"");
        EITLERPGLOBAL.setComboIndex(cmbCategory,"");
    ...
    private void DisplayData() {
        ...
        try {
            if(EditMode==0) {
                ...
                if(ObjItem.getAttribute("CANCELLED").getInt()==1) {
                    lblTitle.setBackground(Color.RED);
                }
                
                if(ObjItem.getAttribute("CATEGORY_ID").getVal()==13) {
        ...
        txtItemID.setText((String)ObjItem.getAttribute("ITEM_ID").getObj());
        
        int AmendNo=0;
        AmendNo=clsItemAmend.getAmendmentNo(EITLERPGLOBAL.gCompanyID, txtItemID.getText());
        if(AmendNo>0) {
        ...
        if(ObjItem.getAttribute("CATEGORY_ID").getVal()==13) {
            lblTitle.setText("ITEM MASTER -"+txtItemID.getText() + " - STM ITEM");
        } else {
            lblTitle.setText("ITEM MASTER -"+txtItemID.getText());
        }
        
        
        txtName.setText((String)ObjItem.getAttribute("ITEM_DESCRIPTION").getObj());
        EITLERPGLOBAL.setComboIndex(cmbGroupCode,(int)ObjItem.getAttribute("GROUP_CODE").getVal());
        txtSearchKey.setText((String)ObjItem.getAttribute("SEARCH_KEY").getObj());
        EITLERPGLOBAL.setComboIndex(cmbWareHouse,(String)ObjItem.getAttribute("WAREHOUSE_ID").getObj());
        SelWareHouseID=EITLERPGLOBAL.getCombostrCode(cmbWareHouse);
        
        txtLocationID.setText((String)ObjItem.getAttribute("LOCATION_ID").getObj());
        lblLocationName.setText(clsLocation.getLocationName(EITLERPGLOBAL.gCompanyID,txtLocationID.getText()));
        
        EITLERPGLOBAL.setComboIndex(cmbCategory,(int)ObjItem.getAttribute("CATEGORY_ID").getVal());
        EITLERPGLOBAL.setComboIndex(cmbStdDesc,(int)ObjItem.getAttribute("DESC").getVal());
        EITLERPGLOBAL.setComboIndex(cmbMake,(int)ObjItem.getAttribute("MAKE").getVal());
        EITLERPGLOBAL.setComboIndex(cmbSize,(int)ObjItem.getAttribute("SIZE").getVal());
        EITLERPGLOBAL.setComboIndex(cmbABC,(String)ObjItem.getAttribute("ABC").getObj());
        EITLERPGLOBAL.setComboIndex(cmbXYZ,(String)ObjItem.getAttribute("XYZ").getObj());
        EITLERPGLOBAL.setComboIndex(cmbVEN,(String)ObjItem.getAttribute("VEN").getObj());
        EITLERPGLOBAL.setComboIndex(cmbFSN,(String)ObjItem.getAttribute("FSN").getObj());
        EITLERPGLOBAL.setComboIndex(cmbMF,(String)ObjItem.getAttribute("MF").getObj());
        EITLERPGLOBAL.setComboIndex(cmbEDApproval,(String)ObjItem.getAttribute("SPECIAL_APPROVAL").getObj());
        
        lblRevNo.setText(Integer.toString((int)ObjItem.getAttribute("REVISION_NO").getVal()));
        
        chkOneTime.setSelected(ObjItem.getAttribute("ONETIME").getBool());
        
        if((boolean)ObjItem.getAttribute("MAINTAIN_STOCK").getBool()) {
            chkMaintainStock.setSelected(true);
        }
        else {
        ...
        txtMinQty.setText(Double.toString(ObjItem.getAttribute("MIN_QTY").getVal()));
        txtMaxQty.setText(Double.toString(ObjItem.getAttribute("MAX_QTY").getVal()));
        txtToleranceLimit.setText(Double.toString(ObjItem.getAttribute("TOLERANCE_LIMIT").getVal()));
        
        EITLERPGLOBAL.setComboIndex(cmbUnit,(int)ObjItem.getAttribute("UNIT").getVal());
        txtRate.setText(Double.toString(ObjItem.getAttribute("UNIT_RATE").getVal()));
        txtQ1Rate.setText(Double.toString(ObjItem.getAttribute("QTR1_RATE").getVal()));
        txtQ2Rate.setText(Double.toString(ObjItem.getAttribute("QTR2_RATE").getVal()));
        txtQ3Rate.setText(Double.toString(ObjItem.getAttribute("QTR3_RATE").getVal()));
        txtQ4Rate.setText(Double.toString(ObjItem.getAttribute("QTR4_RATE").getVal()));
        
        txtDiscount.setText(Double.toString(ObjItem.getAttribute("DNP").getVal()));
        txtRebate.setText(Double.toString(ObjItem.getAttribute("REBATE").getVal()));        
        
        
        EITLERPGLOBAL.setComboIndex(cmbTaxCodeType,(String)ObjItem.getAttribute("TAX_CODE_TYPE").getObj());
        SelTaxCodeType=EITLERPGLOBAL.getCombostrCode(cmbTaxCodeType);        
        txtHSNSACCode.setText((String)ObjItem.getAttribute("HSN_SAC_CODE").getObj());
        
        if((boolean)ObjItem.getAttribute("EXCISE_APPLICABLE").getBool()) {
        ...
        txtExcise.setText(Double.toString(ObjItem.getAttribute("EXCISE").getVal()));
        
        EITLERPGLOBAL.setComboIndex(cmbChapter,(int)ObjItem.getAttribute("CHAPTER_NO").getVal());
        
        if((boolean)ObjItem.getAttribute("TAXABLE").getBool()) {
        ...
        if((boolean)ObjItem.getAttribute("CAPTIVE_CONSUMABLE").getBool()) {
        ...
        EITLERPGLOBAL.setComboIndex(cmbSupplier, (int)ObjItem.getAttribute("SUPPLIER_ID").getVal());
        
        
        txtToRemarks.setText("");
        SetupApproval();
        
        EITLERPGLOBAL.setComboIndex(cmbHierarchy, (int)ObjItem.getAttribute("ITEM_HIERARCHY_ID").getVal());
        ...
        FormatGridA();
        HashMap List=new HashMap();
        String DocNo=(String)ObjItem.getAttribute("ITEM_ID").getObj();
        List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, 1, DocNo);
        for(int i=1;i<=List.size();i++) {
        ...
        FormatGridHS();
        DocNo=(String)ObjItem.getAttribute("ITEM_ID").getObj();
        
        HashMap History=clsItem.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
        ...
        FormatGridRD();
        chkRND.setSelected(ObjItem.getAttribute("RND_APPROVAL").getBool());
        lblSpecify.setVisible(chkRND.isSelected());
        lblUser.setVisible(chkRND.isSelected());
        cmbUser.setVisible(chkRND.isSelected());
        TableRD.setVisible(chkRND.isSelected());
        ...
        if(chkRND.isSelected()) {
            for(int i=1;i<=ObjItem.colRNDApprovers.size();i++) {
                clsItemRNDApprover ObjApprover=(clsItemRNDApprover)ObjItem.colRNDApprovers.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        if(!EITLERPGLOBAL.IsNumber(txtToleranceLimit.getText())) {
            txtToleranceLimit.setText("0");
        }
        
        ObjItem.setAttribute("COMPANY_ID",EITLERPGLOBAL.gCompanyID);
        ObjItem.setAttribute("ITEM_ID",txtItemID.getText());
        ObjItem.setAttribute("ITEM_DESCRIPTION",txtName.getText());
        ObjItem.setAttribute("GROUP_CODE",EITLERPGLOBAL.getComboCode(cmbGroupCode));
        ObjItem.setAttribute("SEARCH_KEY",txtSearchKey.getText());
        ObjItem.setAttribute("WAREHOUSE_ID",EITLERPGLOBAL.getCombostrCode(cmbWareHouse));
        ObjItem.setAttribute("LOCATION_ID",txtLocationID.getText());
        ObjItem.setAttribute("CATEGORY_ID",EITLERPGLOBAL.getComboCode(cmbCategory));
        ObjItem.setAttribute("DESC",EITLERPGLOBAL.getComboCode(cmbStdDesc));
        ObjItem.setAttribute("MAKE",EITLERPGLOBAL.getComboCode(cmbMake));
        ObjItem.setAttribute("SIZE",EITLERPGLOBAL.getComboCode(cmbSize));
        ObjItem.setAttribute("ABC",EITLERPGLOBAL.getCombostrCode(cmbABC));
        ObjItem.setAttribute("XYZ",EITLERPGLOBAL.getCombostrCode(cmbXYZ));
        ObjItem.setAttribute("VEN",EITLERPGLOBAL.getCombostrCode(cmbVEN));
        ObjItem.setAttribute("FSN",EITLERPGLOBAL.getCombostrCode(cmbFSN));
        ObjItem.setAttribute("MF",EITLERPGLOBAL.getCombostrCode(cmbMF));
        ObjItem.setAttribute("SPECIAL_APPROVAL",EITLERPGLOBAL.getCombostrCode(cmbEDApproval));
        ObjItem.setAttribute("ONETIME",chkOneTime.isSelected());
        ObjItem.setAttribute("RND_APPROVAL",chkRND.isSelected());
        
        if(chkMaintainStock.isSelected()) {
            ObjItem.setAttribute("MAINTAIN_STOCK",true);
        }
        else {
            ObjItem.setAttribute("MAINTAIN_STOCK",false);
        }
        
        ObjItem.setAttribute("MIN_QTY",Double.parseDouble(txtMinQty.getText()));
        ObjItem.setAttribute("MAX_QTY",Double.parseDouble(txtMaxQty.getText()));
        ObjItem.setAttribute("TOLERANCE_LIMIT",Double.parseDouble(txtToleranceLimit.getText()));
        
        ObjItem.setAttribute("UNIT",EITLERPGLOBAL.getComboCode(cmbUnit));
        ObjItem.setAttribute("UNIT_RATE",Double.parseDouble(txtRate.getText()));
        ObjItem.setAttribute("QTR1_RATE",Double.parseDouble(txtQ1Rate.getText()));
        ObjItem.setAttribute("QTR2_RATE",Double.parseDouble(txtQ2Rate.getText()));
        ObjItem.setAttribute("QTR3_RATE",Double.parseDouble(txtQ3Rate.getText()));
        ObjItem.setAttribute("QTR4_RATE",Double.parseDouble(txtQ4Rate.getText()));
        
        ObjItem.setAttribute("DNP",Double.parseDouble(txtDiscount.getText()));
        ObjItem.setAttribute("REBATE",Double.parseDouble(txtRebate.getText()));                
        
        
        ObjItem.setAttribute("TAX_CODE_TYPE",EITLERPGLOBAL.getCombostrCode(cmbTaxCodeType));
        ObjItem.setAttribute("HSN_SAC_CODE",txtHSNSACCode.getText());
        
        if(chkExciseApplicable.isSelected()) {
            ObjItem.setAttribute("EXCISE_APPLICABLE",true);
        }
        else {
            ObjItem.setAttribute("EXCISE_APPLICABLE",false);
        }
        
        ObjItem.setAttribute("EXCISE",Double.parseDouble(txtExcise.getText()));
        ObjItem.setAttribute("CHAPTER_NO",EITLERPGLOBAL.getComboCode(cmbChapter));
        
        if(chkTaxable.isSelected()) {
            ObjItem.setAttribute("TAXABLE",true);
        }
        else {
            ObjItem.setAttribute("TAXABLE",false);
        }
        
        if(chkCaptive.isSelected()) {
            ObjItem.setAttribute("CAPTIVE_CONSUMABLE",true);
        }
        else {
            ObjItem.setAttribute("CAPTIVE_CONSUMABLE",false);
        }
        
        ObjItem.setAttribute("SUPPLIER_ID",EITLERPGLOBAL.getComboCode(cmbSupplier));
        ObjItem.setAttribute("ITEM_HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbHierarchy));
        
        
        //========= Set RND Approvers ============//
        ObjItem.colRNDApprovers.clear();
        ...
        if(chkRND.isSelected()) {
            for(int i=0;i<TableRD.getRowCount();i++) {
                ...
                ObjItem.colRNDApprovers.put(Integer.toString(ObjItem.colRNDApprovers.size()+1),ObjApprover);
            }
        }
        //========================================//
        ...
        ObjItem.setAttribute("ITEM_HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbHierarchy));
        ObjItem.setAttribute("FROM",EITLERPGLOBAL.gNewUserID);
        ObjItem.setAttribute("TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        ObjItem.setAttribute("FROM_REMARKS",txtToRemarks.getText());
        
        if(OpgApprove.isSelected()) {
            ObjItem.setAttribute("APPROVAL_STATUS","A");
        }
        
        if(OpgFinal.isSelected()) {
            ObjItem.setAttribute("APPROVAL_STATUS","F");
        }
        
        if(OpgReject.isSelected()) {
            ObjItem.setAttribute("APPROVAL_STATUS","R");
            ObjItem.setAttribute("SEND_DOC_TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        }
        
        if(OpgHold.isSelected()) {
            ObjItem.setAttribute("APPROVAL_STATUS","H");
        }
        //-------------------------------------------------//
    }
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, 1,(String)ObjItem.getAttribute("ITEM_ID").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,1,FromUserID,(String)ObjItem.getAttribute("ITEM_ID").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,151)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,153)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,154)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void GenerateCombos() {
        ...
        //List=clsItemCategory.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID));
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=1 ");
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID=1 ");
        }
        for(int i=1;i<=List.size();i++) {
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, 1,(String)ObjItem.getAttribute("ITEM_ID").getObj());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void Add() {
        ...
        lblTitle.setText("ITEM MASTER -"+txtItemID.getText());
        lblTitle.setBackground(Color.BLUE);
        EITLERPGLOBAL.setComboIndex(cmbEDApproval,"A");
        Tab.setSelectedIndex(0);
        txtItemID.requestFocus();
    ...
    private void Edit() {
        ...
        String lDocNo=(String)ObjItem.getAttribute("ITEM_ID").getObj();
        if(ObjItem.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(1,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,152)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Delete() {
        ...
        //----------------------------------//
        if(ObjItem.CanDelete((int)EITLERPGLOBAL.gCompanyID,(String)ObjItem.getAttribute("ITEM_ID").getObj(),(int)EITLERPGLOBAL.gNewUserID)) {
            if(ObjItem.Delete()) {
                MoveLast();
                DisplayData();
            }
            else {
                JOptionPane.showMessageDialog(null,"Error occured while deleting. Error is"+ObjItem.LastError);
            }
        }
        else {
    ...
    private void Save() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            String qry="SELECT COUNT(*) AS COUNT FROM D_INV_ITEM_MASTER "+
            "WHERE COMPANY_ID = '" + EITLERPGLOBAL.gCompanyID + "' AND ITEM_ID = '" + txtItemID.getText() + "' ";
            int count = data.getIntValueFromDB(qry);
            if(count > 0) {
                JOptionPane.showMessageDialog(null,"Item Code:- "+ txtItemID.getText() +" is Already already given \n Please Enter another Item Code");
                return;
            }
        }
        //-----------
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            if(ObjItem.Insert()) {
                ...
                JOptionPane.showMessageDialog(null,"Error occured while saving item. Error is"+ObjItem.LastError);
                return;
            }
        }
    ...
    public void FindEx(int pCompanyID,String pItemID) {
        ObjItem.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND ITEM_ID='"+pItemID+"'");
        ObjItem.MoveFirst();
        DisplayData();
    }
    
    public void FindWaiting() {
        ObjItem.Filter(" WHERE ITEM_ID IN (SELECT D_INV_ITEM_MASTER.ITEM_ID FROM D_INV_ITEM_MASTER,D_COM_DOC_DATA WHERE D_INV_ITEM_MASTER.ITEM_ID=D_COM_DOC_DATA.DOC_NO AND D_INV_ITEM_MASTER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_ITEM_MASTER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_COM_DOC_DATA.USER_ID="+EITLERPGLOBAL.gNewUserID+" AND D_COM_DOC_DATA.STATUS='W' AND MODULE_ID=1)");
        ObjItem.MoveFirst();
        DisplayData();
    }
    ...
    private void Find() {
        ...
        if(ObjReturn.Cancelled==false) {
            if(!ObjItem.Filter(ObjReturn.strQuery)) {
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, 1, txtItemID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, 1, txtItemID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, 1, txtItemID.getText());
