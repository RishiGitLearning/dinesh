...
public class clsItemold {
    ...
    public boolean Insert() {
        ...
        try {
            ...
            String strSQL="SELECT COUNT(*) AS THECOUNT FROM D_INV_ITEM_MASTER WHERE COMPANY_ID="+Long.toString(lCompanyID)+" AND ITEM_ID='"+(String) getAttribute("ITEM_ID").getObj()+"'";
            ResultSet rsCount;
            ...
            setAttribute("ITEM_SYS_ID", data.getMaxID(EITLERPGLOBAL.gCompanyID,"D_INV_ITEM_MASTER","ITEM_SYS_ID"));
            //-------------------------------------------------
    ...
    private boolean Validate() {
        ...
        if (! ItemID.equals("")) {
            ...
            if(getAttribute("GROUP_CODE").getVal()== 4.0 && getAttribute("CATEGORY_ID").getVal() == 3.0) {
                if(len == 7) {
                    
                    if(EITLERPGLOBAL.IsNumber(ItemID.substring(0,1))) {
                        LastError=" Please enter Valid Item Code";
                        //JOptionPane.showMessageDialog(null,"Please enter valid Item Code");
                        return false;
                    }
                    
                    else if(!EITLERPGLOBAL.IsNumber(ItemID.substring(1,6))) {
                        LastError=" Please enter Valid Item Code";
                        //JOptionPane.showMessageDialog(null,"Please enter valid Item Code");
                        return false;
                    }
