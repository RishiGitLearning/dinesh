...
public class clsFeltparty {
    ...
    public boolean Insert() {
        try {
            ...
            setAttribute("PARTY_ID",(int)data.getMaxID(EITLERPGLOBAL.gCompanyID, "D_COM_PARTY","PARTY_ID"));
            //-------------------------------------------------
     ...
     public static String getParyName(int pCompanyID,String pPartyID) {
      ...
      public static String getStation(int pCompanyID,String pPartyID) {
        ...
        try {
            ...
            if(rsTmp.getRow()>0) {
                PartyName=rsTmp.getString("DISPATCH_STATION");
            }
    ...
    public static String getContactNo(int pCompanyID,String pPartyID) {
        Connection tmpConn;
        Statement stTmp;
        ResultSet rsTmp;
        String Contact="";
        ...
        try {
            tmpConn=data.getConn();
            stTmp=tmpConn.createStatement();
            rsTmp=stTmp.executeQuery("SELECT MOBILE_NO FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE="+pPartyID);
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                Contact=rsTmp.getString("MOBILE_NO");
            }
    ...
    public static String getPhone(int pCompanyID,String pPartyID) {
        Connection tmpConn;
        Statement stTmp;
        ResultSet rsTmp;
        String PhoneNo="";
        ...
        try {
            tmpConn=data.getConn();
            stTmp=tmpConn.createStatement();
            rsTmp=stTmp.executeQuery("SELECT PHONE_NO FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE="+pPartyID);
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                PhoneNo=rsTmp.getString("PHONE_NO");
            }
