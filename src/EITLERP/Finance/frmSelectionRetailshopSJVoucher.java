...
public class frmSelectionRetailshopSJVoucher extends javax.swing.JApplet {
    ...
    public frmSelectionRetailshopSJVoucher()
    {
        initComponents();
    ...
    private void GenerateGridSJ() {
        try {
            ...
            List=clsAccount.getMainCodeReceivableDetail(EITLERPGLOBAL.gCompanyID,"210041", txtPartyCode.getText().trim(),  txtInvoiceNo.getText(),"2008-04-01","","","04");
