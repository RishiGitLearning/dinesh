...
public class frmExpense extends javax.swing.JApplet {
    
    private int EditMode=0;
    private clsExpense objExpense;
    ...
    private EITLComboModel cmbExpenseTypeModel;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtExpenseDetails = new javax.swing.JTextField();
        ...
        lblTitle.setText(" MISC. EXPENSE MASTER");
        ...
        txtMainAccountCode.setBounds(134, 47, 200, 19);

        lblSubCode.setText("Main Code");
        Panel1.add(lblSubCode);
        lblSubCode.setBounds(59, 49, 70, 15);
        ...
        lblAccountID.setText("Expense ID :");
        Panel1.add(lblAccountID);
        lblAccountID.setBounds(54, 21, 80, 15);

        txtExpenseID.setName("PARTY_ID");
        Panel1.add(txtExpenseID);
        txtExpenseID.setBounds(134, 18, 200, 19);

        txtExpenseDetails.setName("PARTY_NAME");
        txtExpenseDetails.setEnabled(false);
        Panel1.add(txtExpenseDetails);
        txtExpenseDetails.setBounds(134, 137, 440, 19);

        lblAccountName.setText("Expense Details :");
        Panel1.add(lblAccountName);
        lblAccountName.setBounds(21, 139, 110, 15);

        lblAccountName1.setText("Expense Type");
        Panel1.add(lblAccountName1);
        lblAccountName1.setBounds(37, 104, 90, 15);

        cmbExpenseType.setEnabled(false);
        Panel1.add(cmbExpenseType);
        cmbExpenseType.setBounds(133, 98, 150, 24);

        lblMainAccountName.setText("...");
        Panel1.add(lblMainAccountName);
        lblMainAccountName.setBounds(136, 70, 350, 15);

        lblSubCode1.setText("Max. Amount");
        Panel1.add(lblSubCode1);
        lblSubCode1.setBounds(43, 168, 90, 15);

        txtMaxAmount.setName("PARTY_CODE");
        txtMaxAmount.setEnabled(false);
        Panel1.add(txtMaxAmount);
        txtMaxAmount.setBounds(136, 166, 120, 19);
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        // TODO add your handling code here:
        objExpense.ShowHistory(EITLERPGLOBAL.gCompanyID, objExpense.getAttribute("EXPENSE_ID").getString());
        MoveFirst();
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,clsExpense.ModuleID , Integer.toString(objExpense.getAttribute("EXPENSE_ID").getInt()))) {
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private javax.swing.JComboBox cmbExpenseType;
    ...
    private javax.swing.JTextField txtExpenseDetails;
    ...
    private void SetFields(boolean pStat) {
        ...
        cmbExpenseType.setEnabled(pStat);
        txtMaxAmount.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsExpense.ModuleID;
        ...
        txtMainAccountCode.setText(objExpense.getAttribute("MAIN_ACCOUNT_CODE").getString());
        txtExpenseDetails.setText(objExpense.getAttribute("EXPENSE_DESCRIPTION").getString());
        EITLERPGLOBAL.setComboIndex(cmbExpenseType,objExpense.getAttribute("EXPENSE_TYPE").getInt());
        txtMaxAmount.setText(Double.toString(objExpense.getAttribute("MAX_AMOUNT").getDouble()));
        ...
        String DocNo=objExpense.getAttribute("EXPENSE_ID").getString();
        List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsExpense.ModuleID , DocNo);
        ...
        HashMap History=clsExpense.getHistoryList(EITLERPGLOBAL.gCompanyID, objExpense.getAttribute("EXPENSE_ID").getString());
        for(int i=1;i<=History.size();i++) {
            clsExpense ObjHistory=(clsExpense)History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        objExpense.setAttribute("MAIN_ACCOUNT_CODE",txtMainAccountCode.getText());
        objExpense.setAttribute("EXPENSE_TYPE",EITLERPGLOBAL.getComboCode(cmbExpenseType));
        objExpense.setAttribute("EXPENSE_DESCRIPTION",txtExpenseDetails.getText());
        objExpense.setAttribute("MAX_AMOUNT",UtilFunctions.CDbl(txtMaxAmount.getText()));
    ...
    private void SetMenuForRights() {
        ...
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10621)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10623)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10624)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
       ...
       // SelectFirstFree aList=new SelectFirstFree();
        //aList.ModuleID=clsExpense.ModuleID;
        ...
        //if(aList.ShowList()) {
          ...
          //  SelPrefix=aList.Prefix; //Selected Prefix;
           ...
           //  txtExpenseID.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsExpense.ModuleID , FFNo,  false));
            
            lblTitle.setText(" MISC. EXPENSE MASTER - "+txtExpenseID.getText());
            lblTitle.setBackground(Color.BLUE);
        //}
        /*else {
    ...
    private void Edit() {
        ...
        //----------------------------------//
        String AccountID=objExpense.getAttribute("EXPENSE_ID").getString();
        String lDocNo=AccountID;
        
        
        if(objExpense.IsEditable(EITLERPGLOBAL.gCompanyID, AccountID, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(clsExpense.ModuleID ,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10622)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Finance.frmExpenseMasterFind",true);
        frmExpenseMasterFind ObjReturn= (frmExpenseMasterFind) ObjLoader.getObj();
    ...
    public void FindEx(int pCompanyID,String pDocNo) {
        objExpense.Filter(" WHERE EXPENSE_ID='"+pDocNo+"' ",pCompanyID);
        objExpense.MoveFirst();
        DisplayData();
    }
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsExpense.ModuleID , objExpense.getAttribute("EXPENSE_ID").getString());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsExpense.ModuleID ,FromUserID,objExpense.getAttribute("EXPENSE_ID").getString());
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsExpense.ModuleID ,objExpense.getAttribute("EXPENSE_ID").getString());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID,clsExpense.ModuleID , objExpense.getAttribute("EXPENSE_ID").getString(), ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsExpense.ModuleID, objExpense.getAttribute("EXPENSE_ID").getString(), ObjUser.getAttribute("USER_ID").getInt() , EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsExpense.ModuleID , objExpense.getAttribute("EXPENSE_ID").getString());
    ...
    private void GenerateCombos() {
        try {
            ...
            List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsExpense.ModuleID);
            
            if(EditMode==EITLERPGLOBAL.EDIT) {
                List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsExpense.ModuleID );
            }
            for(int i=1;i<=List.size();i++) {
            ...
            cmbExpenseTypeModel=new EITLComboModel();
            cmbExpenseType.removeAllItems();
            cmbExpenseType.setModel(cmbExpenseTypeModel);
            
            ComboData aData=new ComboData();
            aData.Code=0;
            aData.Text="Periodic Expense";
            cmbExpenseTypeModel.addElement(aData);
            
            aData=new ComboData();
            aData.Code=1;
            aData.Text="Ad-hoc Expense";
            cmbExpenseTypeModel.addElement(aData);
    ...
    private boolean Validate(){
        ...
        if(txtExpenseID.getText().length()>12)
        {
            JOptionPane.showMessageDialog(null,"Length of Expense ID not be more than 12 Digit");
            return false;
