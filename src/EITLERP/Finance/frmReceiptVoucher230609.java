...
public class frmReceiptVoucher230609 extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        Tab1.add(jLabel3);
        jLabel3.setBounds(371, 16, 32, 15);
        ...
        jScrollPane4.setBounds(6, 403, 630, 50);
        ...
        jTabbedPane1.setBounds(9, 170, 630, 210);

        jLabel13.setFont(new java.awt.Font("Dialog", 0, 12));
        jLabel13.setText("Legacy No.");
        Tab1.add(jLabel13);
        jLabel13.setBounds(28, 63, 80, 15);
        ...
        txtLegacyNo.setBounds(114, 61, 102, 19);
        ...
        txtLegacyDate.setBounds(259, 61, 102, 19);
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.addColumn("Date");//5
            DataModel.addColumn("Invoice Amount"); //6
            //DataModel.addColumn("Deductions"); //7
            DataModel.addColumn("Amount Received"); //8
            DataModel.addColumn("SO No."); //9
            DataModel.addColumn("SO Date"); //10
            DataModel.addColumn("Ref. Doc. No."); //11
            DataModel.addColumn("Date"); //12
            DataModel.addColumn("Ref. Doc. Type"); //13
            DataModel.addColumn("Company"); //14
            DataModel.addColumn("Module ID"); //15
            DataModel.addColumn("Ref. Company ID"); //16
            ...
            DataModel.SetVariable(4,"AGENT_SR");
            
            
            DataModel.SetVariable(5,"INVOICE_NO"); //1
            DataModel.SetVariable(6,"INVOICE_DATE"); //2 //Read Only
            DataModel.SetVariable(7,"INVOICE_AMOUNT"); //2 //Read Only
            
            //DataModel.SetVariable(7,"DEDUCTIONS"); //2 //Read Only
            ...
            DataModel.SetVariable(17,"LINK_NO"); 
...
//                if(! EITLERPGLOBAL.isWithinDate(InvDate,EITLERPGLOBAL.FinYearFrom)) {
//                    String FromInvYear = Integer.toString(EITLERPGLOBAL.FinYearFrom).substring(2);
//                    int F_InvYear = Integer.parseInt(FromInvYear) - 1;
//                    String ToInvYear = Integer.toString(EITLERPGLOBAL.FinYearTo).substring(2);
//                    int T_InvYear = Integer.parseInt(ToInvYear) - 1;
//                    AgentAlpha=AgentAlpha+"/"+"0"+F_InvYear+"0"+T_InvYear;                    
//                }
//                else {
//                    AgentAlpha=AgentAlpha+"/"+Integer.toString(EITLERPGLOBAL.FinYearFrom).substring(2)+Integer.toString(EITLERPGLOBAL.FinYearTo).substring(2);
//                }
