...
public class clsCrAdjustmentItem {
    ...
    public clsCrAdjustmentItem() {
        ...
        props.put("PAYMENT_AMOUNT",new Variant(0));
        props.put("ADJUST_AMOUNT",new Variant(0));
        props.put("PJV_NO",new Variant(""));
        props.put("PJV_DATE",new Variant(""));
        props.put("VOUCHER_COMPANY_ID",new Variant(0));
        props.put("PJV_COMPANY_ID",new Variant(0));
    }
}
