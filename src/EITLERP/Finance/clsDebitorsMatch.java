...
public class clsDebitorsMatch {
    ...
    public clsDebitorsMatch(String MainCode) {
    ...
    private void FindMatchDebitsFromClosing() { //final String MainAccountCode,final String PartyCode,final String FromDate,final String ToDate
        try {
            ...
            System.out.println("FindMatchDebitsFromClosing 1 : Started ");
...
"AND EFFECT='D' AND MAIN_ACCOUNT_CODE='"+MainAccountCode+"' AND SUB_ACCOUNT_CODE NOT IN ('021014','161004','161014','330101','330000','330102') " + 
        ...
        System.out.println("FindMatchDebitsFromClosing 1 : Ended ");
    }
