...
public class frmDebitNoteVoucher extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if (getName().equals("Link")) {
            ...
            objVoucher.VoucherType = FinanceGlobal.TYPE_DEBIT_NOTE;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Sales Preview");
        ...
        lblTitle.setText(" DEBIT NOTE VOUCHER");
        ...
        Tab1.add(txtDocNo);
        txtDocNo.setBounds(100, 14, 160, 19);

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Date :");
        Tab1.add(jLabel3);
        jLabel3.setBounds(365, 16, 40, 15);
        ...
        Tab1.add(cmdChange);
        cmdChange.setBounds(270, 14, 30, 20);
        ...
        jPanel3.add(jLabel8);
        jLabel8.setBounds(5, 35, 80, 15);

        txtPartyCode.setName("REQ_DATE"); // NOI18N
        ...
        txtPartyCode.setBounds(90, 33, 100, 19);

        txtPartyCodeName.setName("REMARKS"); // NOI18N
        txtPartyCodeName.setEnabled(false);
        jPanel3.add(txtPartyCodeName);
        txtPartyCodeName.setBounds(200, 33, 366, 19);

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Main Code :");
        jPanel3.add(jLabel10);
        jLabel10.setBounds(5, 12, 80, 15);

        txtMainCode.setName("REQ_DATE"); // NOI18N
        ...
        txtMainCode.setBounds(90, 10, 100, 19);

        txtMainCodeName.setName("REMARKS"); // NOI18N
        txtMainCodeName.setEnabled(false);
        jPanel3.add(txtMainCodeName);
        txtMainCodeName.setBounds(200, 10, 366, 19);

        Tab1.add(jPanel3);
        jPanel3.setBounds(9, 90, 630, 60);

        jLabel9.setText("Remarks :");
        Tab1.add(jLabel9);
        jLabel9.setBounds(12, 377, 80, 15);
        ...
        Table.setNextFocusableComponent(cmdShow);
        ...
        jScrollPane1.setBounds(5, 9, 610, 150);
        ...
        cmdShow.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                cmdShowFocusGained(evt);
            }
        });
        jPanel2.add(cmdShow);
        cmdShow.setBounds(300, 162, 100, 20);
        ...
        cmdRemove.setBounds(105, 163, 86, 20);

        jLabel7.setText("Total Amount :");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(406, 165, 100, 15);

        txtNetAmount.setName("REQ_DATE"); // NOI18N
        txtNetAmount.setEnabled(false);
        jPanel2.add(txtNetAmount);
        txtNetAmount.setBounds(511, 163, 102, 19);
        ...
        cmdAddBlank.setBounds(5, 163, 100, 20);
        ...
        cmdSelect.setBounds(197, 163, 100, 20);

        jTabbedPane1.addTab("Deduction Information", jPanel2);

        Tab1.add(jTabbedPane1);
        jTabbedPane1.setBounds(11, 158, 630, 215);

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Legacy No. :");
        Tab1.add(jLabel11);
        jLabel11.setBounds(10, 69, 85, 15);
        ...
        txtLegacyNo.setBounds(100, 67, 102, 19);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Date :");
        Tab1.add(jLabel12);
        jLabel12.setBounds(215, 70, 40, 15);
        ...
        cmdFromRemarksBig.setBounds(575, 77, 33, 21);
    ...
    private void mnuDebitMemoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuDebitMemoActionPerformed
        try {
            frmSelectionDebitMemo objSelect = new frmSelectionDebitMemo();
            ...
            if (!objSelect.Cancelled) {
                ...
                txtMainCode.setText(objSelect.MainCode);
                txtMainCodeName.setText(clsAccount.getAccountName(objSelect.MainCode, ""));
                txtPartyCode.setText(objSelect.PartyCode);
                txtPartyCodeName.setText(clsPartyMaster.getAccountName(objSelect.MainCode, objSelect.PartyCode));
                //txtBookCode.setText("18");
                txtBookName.setText(clsBook.getBookName(EITLERPGLOBAL.gCompanyID, txtBookCode.getText()));
                System.out.println(objSelect.SelectedItems.size());
                ...
                String GSTINCode = data.getStringValueFromDB("SELECT STATE_GST_CODE FROM D_FIN_PARTY_MASTER WHERE APPROVED=1 AND CANCELLED=0 AND PARTY_CODE='" + objSelect.PartyCode + "'", FinanceGlobal.FinURL);
                if (GSTINCode.equals("")) {
                    GSTINCode = data.getStringValueFromDB("SELECT SUBSTRING(GSTIN_NO,1,2) FROM D_FIN_PARTY_MASTER WHERE APPROVED=1 AND CANCELLED=0 AND PARTY_CODE='" + objSelect.PartyCode + "'", FinanceGlobal.FinURL);
                    GSTINCode = GSTINCode.trim();
                }
                if (GSTINCode.equals("")) {
                    JOptionPane.showMessageDialog(null, "GSTIN detail of Party does not exist.");
                    return;
                } else if (GSTINCode.equals("24")) {
                    int j = 0;
                    for (int r = 1; r <= objSelect.SelectedItems.size(); r++) {
                        j++;
                        //j=Table.getRowCount()+1;
                        clsDebitMemoReceiptMapping objItem = (clsDebitMemoReceiptMapping) objSelect.SelectedItems.get(Integer.toString(r));
                        Object[] rowData = new Object[1];
                        //rowData[0]="1";
                        DataModel.addRow(rowData);
                        int NewRow = Table.getRowCount() - 1;

                        DataModel.setValueByVariable("SR_NO", Integer.toString(j), NewRow);
                        if (objSelect.MainCode.equals("210027")) {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "311090", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("311090", ""), NewRow);
                        } else {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "311100", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("311100", ""), NewRow);
                        }

                        DataModel.setValueByVariable("REF_VOUCHER_NO", objItem.getAttribute("DEBITMEMO_NO").getString(), NewRow);
                        ...
                        DataModel.setValueByVariable("AMOUNT", Double.toString(objItem.getAttribute("INTEREST_AMT").getDouble()), NewRow);
                        ...
                        DataModel.setValueByVariable("SR_NO", Integer.toString(j), NewRow);
                        if (objSelect.MainCode.equals("210027")) {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "127565", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("127565", ""), NewRow);
                        } else {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "127566", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("127566", ""), NewRow);
                        ...
                        //DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(objItem.getAttribute("AMOUNT").getDouble()),NewRow);
                        //DataModel.setValueByVariable("DEDUCTIONS","0",NewRow);
                        double CGST = objItem.getAttribute("INTEREST_AMT").getDouble();
                        if (objSelect.MainCode.equals("210027")) {
                            CGST = CGST * 0.025;
                        } else {
                            CGST = CGST * 0.06;
                        }
                        //DataModel.setValueByVariable("AMOUNT",Double.toString(EITLERPGLOBAL.round(CGST,2)),NewRow);
                        DataModel.setValueByVariable("AMOUNT", Double.toString(EITLERPGLOBAL.round(CGST, 0)), NewRow);
                        DataModel.setValueByVariable("REMARKS", "CGST", NewRow);
                        //DataModel.SetUserObject(NewRow, new HashMap());
                        //DataModel.setValueByVariable("PO_NO",objItem.getAttribute("PO_NO").getString(),NewRow);
                        //DataModel.setValueByVariable("PO_DATE",objItem.getAttribute("PO_DATE").getString(),NewRow);
                        //DataModel.setValueByVariable("REF_DOC_NO",objItem.getAttribute("INVOICE_NO").getString(),NewRow);
                        ...
                        j++;
                        //clsDebitMemoReceiptMapping objItem1=(clsDebitMemoReceiptMapping)objSelect.SelectedItems.get(Integer.toString(r));
                        Object[] rowData2 = new Object[1];
                        //rowData[0]="1";
                        ...
                        DataModel.setValueByVariable("SR_NO", Integer.toString(j), NewRow);
                        if (objSelect.MainCode.equals("210027")) {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "127567", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("127567", ""), NewRow);
                        } else {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "127568", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("127568", ""), NewRow);
                        }
                        DataModel.setValueByVariable("REF_VOUCHER_NO", objItem.getAttribute("DEBITMEMO_NO").getString(), NewRow);
                        ...
                        //DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(objItem.getAttribute("AMOUNT").getDouble()),NewRow);
                        //DataModel.setValueByVariable("DEDUCTIONS","0",NewRow);
                        double SGST = objItem.getAttribute("INTEREST_AMT").getDouble();
                        if (objSelect.MainCode.equals("210027")) {
                            SGST = SGST * 0.025;
                        } else {
                            SGST = SGST * 0.06;
                        ...
                        //DataModel.setValueByVariable("AMOUNT",Double.toString(EITLERPGLOBAL.round(SGST,2)),NewRow);
                        DataModel.setValueByVariable("AMOUNT", Double.toString(EITLERPGLOBAL.round(SGST, 0)), NewRow);
                        DataModel.setValueByVariable("REMARKS", "SGST", NewRow);
                        //DataModel.SetUserObject(NewRow, new HashMap());
                        //DataModel.setValueByVariable("PO_NO",objItem.getAttribute("PO_NO").getString(),NewRow);
                        //DataModel.setValueByVariable("PO_DATE",objItem.getAttribute("PO_DATE").getString(),NewRow);
                        //DataModel.setValueByVariable("REF_DOC_NO",objItem.getAttribute("INVOICE_NO").getString(),NewRow);
                    ...
                    int Rowsize = objSelect.SelectedItems.size();
                    Rowsize = Rowsize * 2;
                    ...
                    for (int r = 1; r <= objSelect.SelectedItems.size(); r++) {
                        ...
                        DataModel.setValueByVariable("SR_NO", Integer.toString(j), NewRow);
                        if (objSelect.MainCode.equals("210027")) {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "127569", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("127569", ""), NewRow);

                        } else {
                            DataModel.setValueByVariable("DEDUCTION_CODE", "127570", NewRow);
                            DataModel.setValueByVariable("DEDUCTION_NAME", clsPartyMaster.getAccountName("127570", ""), NewRow);
                        ...
                        //DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(objItem.getAttribute("AMOUNT").getDouble()),NewRow);
                        //DataModel.setValueByVariable("DEDUCTIONS","0",NewRow);
                        double IGST = objItem.getAttribute("INTEREST_AMT").getDouble();
                        if (objSelect.MainCode.equals("210027")) {
                            IGST = IGST * 0.05;
                        } else {
                            IGST = IGST * 0.12;
                        }
                        //DataModel.setValueByVariable("AMOUNT",Double.toString(EITLERPGLOBAL.round(IGST,2)),NewRow);
                        DataModel.setValueByVariable("AMOUNT", Double.toString(EITLERPGLOBAL.round(IGST, 0)), NewRow);
                        DataModel.setValueByVariable("REMARKS", "IGST", NewRow);
                        //DataModel.SetUserObject(NewRow, new HashMap());
                        //DataModel.setValueByVariable("PO_NO",objItem.getAttribute("PO_NO").getString(),NewRow);
                        //DataModel.setValueByVariable("PO_DATE",objItem.getAttribute("PO_DATE").getString(),NewRow);
                        //DataModel.setValueByVariable("REF_DOC_NO",objItem.getAttribute("INVOICE_NO").getString(),NewRow);
    ...
    }//GEN-LAST:event_mnuDebitMemoActionPerformed
        ...
        try {
            ...
            if (!objSelect.Cancelled) {
                ...
                for (int r = 1; r <= objSelect.SelectedItems.size(); r++) {
                    ...
                    DataModel.setValueByVariable("DEDUCTION_CODE", objSelect.PartyCode, NewRow);
                    DataModel.setValueByVariable("INVOICE_NO", objItem.getAttribute("INVOICE_NO").getString(), NewRow);
                    DataModel.setValueByVariable("INVOICE_DATE", objItem.getAttribute("INVOICE_DATE").getString(), NewRow);
                    //DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(objItem.getAttribute("AMOUNT").getDouble()),NewRow);
                    //DataModel.setValueByVariable("DEDUCTIONS","0",NewRow);
                    ...
                    DisplayAgentAlphaLink(NewRow, objItem.getAttribute("INVOICE_DATE").getString());
                    if (objItem.getAttribute("INVOICE_NO").getString().substring(0, 1).trim().equals("F")) {
                        ...
                        DataModel.setValueByVariable("AGENT_SR", Link, NewRow);
    ...
    private void DisplayAgentAlphaLink(int RowNo, String InvoiceDate) {
        try {
            String AgentAlpha = clsSalesParty.getAgentAlpha(DataModel.getValueByVariable("DEDUCTION_CODE", RowNo));
            ...
            DataModel.setValueByVariable("DEDUCTION_CODE", "999999", RowNo);
    ...
    private void cmdAddBlankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddBlankActionPerformed
        ...
        aList.SQL = "SELECT MAIN_ACCOUNT_CODE,ACCOUNT_NAME FROM D_FIN_GL WHERE APPROVED=1  AND MAIN_ACCOUNT_CODE IN (SELECT MAIN_ACCOUNT_CODE FROM D_FIN_DEPT_EXPENSE_MAPPING WHERE DEPT_ID=" + DeptID + ") ORDER BY ACCOUNT_NAME";
        aList.ReturnCol = 1;
        ...
        if (aList.ShowLOV()) {
            ...
            MainCodeName = clsAccount.getAccountName(MainCode, "");
        }

        Object[] rowData = new Object[7];
        rowData[0] = Integer.toString(Table.getRowCount() + 1);
        rowData[1] = MainCode;
        rowData[2] = MainCodeName;
        rowData[3] = "";
        rowData[4] = "0";
        rowData[5] = "";
        rowData[6] = "";
    ...
    private void txtPartyCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPartyCodeKeyPressed
        ...
        if (evt.getKeyCode() == 112) {
            if (!txtMainCode.getText().trim().equals("")) {
                LOV aList = new LOV();
                aList.SQL = "SELECT PARTY_CODE,PARTY_NAME FROM D_FIN_PARTY_MASTER WHERE APPROVED=1 AND MAIN_ACCOUNT_CODE='" + txtMainCode.getText().trim() + "' ORDER BY PARTY_NAME";
                aList.ReturnCol = 1;
                aList.SecondCol = 2;
                aList.ShowReturnCol = true;
...
//                ObjDoc.FindByCompany(CompanyID,DocNo,DocDate);
    ...
    private void cmdShowFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cmdShowFocusGained
        // TODO add your handling code here:
        ShowMessage("Click on this button to add a new row to table");
    }//GEN-LAST:event_cmdShowFocusGained
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String dbnNo = txtDocNo.getText();
            String dbnDt = txtDocDate.getText();        
            
            
            HashMap Parameters = new HashMap();
            //Parameters.put("VOUCHER_NO", dbnNo);
            //Parameters.put("VOUCHER_DATE", dbnDt);
            Parameters.put("MAIN_ACCOUNT_CODE", txtMainCode.getText().trim());
            //Parameters.put("INTEREST_CODE", data.getStringValueFromDB("SELECT MAIN_ACCOUNT_CODE FROM  D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT = 'C'", FinanceGlobal.FinURL));
            Parameters.put("GSTIN_NO", data.getStringValueFromDB("SELECT GSTIN_NO FROM  DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE = '" + txtPartyCode.getText().trim() + "' AND MAIN_ACCOUNT_CODE = '" + txtMainCode.getText().trim() + "'", FinanceGlobal.FinURL));
            //Parameters.put("ADDRESS", data.getStringValueFromDB("SELECT CONCAT(ADDRESS1,'  ',ADDRESS2) AS ADD1 FROM  DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE = '" + txtPartyCode.getText().trim() + "' AND MAIN_ACCOUNT_CODE = '" + txtMainCode.getText().trim() + "'", FinanceGlobal.FinURL));
            //Parameters.put("INTEREST_CODE", data.getStringValueFromDB("SELECT MAIN_ACCOUNT_CODE FROM  D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT = 'C'", FinanceGlobal.FinURL));
            //Parameters.put("TR_CODE", txtBookCode.getText());
            Parameters.put("PARTY_CODE", txtPartyCode.getText());
            Parameters.put("PARTY_NAME", txtPartyCodeName.getText());
            //Parameters.put("ROUNDED_AMOUNT", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(SUM(DEBIT_NOTE_AMOUNT)) AS AMOUNT FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));
            Parameters.put("ROUNDED_AMOUNT", data.getStringValueFromDB("SELECT ROUND(SUM(AMOUNT),2) AS AMOUNT FROM FINANCE.D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='D'", FinanceGlobal.FinURL));
            //Parameters.put("ROUNDED_AMOUNT",data.getDoubleValueFromDB("SELECT ROUND(SUM(AMOUNT),2) AS AMOUNT FROM FINANCE.D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='D'", FinanceGlobal.FinURL));
            
            //Parameters.put("T_IGST_AMT", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(SUM(IGST_AMT),2) AS IGST_AMT FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));
            //Parameters.put("T_CGST_AMT", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(SUM(CGST_AMT),2) AS CGST_AMT FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));
            //Parameters.put("T_SGST_AMT", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(SUM(SGST_AMT),2) AS SGST_AMT FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));
            //Parameters.put("T_INT_AMT", String.valueOf((data.getDoubleValueFromDB("SELECT  ROUND(SUM(INTEREST_AMT),2) AS INT_AMT FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));

            //Parameters.put("T_IGST_PER", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(AVG(IGST_PER),2) AS IGST_PER FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));
            //Parameters.put("T_CGST_PER", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(AVG(CGST_PER),2) AS CGST_PER FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));
            //Parameters.put("T_SGST_PER", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(AVG(SGST_PER),2) AS SGST_PER FROM D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE DEBITNOTE_VOUCHER_NO = '" + txtDocNo.getText().trim() + "'", FinanceGlobal.FinURL))));

            Parameters.put("CGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS CGST FROM FINANCE.D_FIN_VOUCHER_DETAIL D,FINANCE.D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG='CGST'", FinanceGlobal.FinURL))));
            Parameters.put("SGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS SGST FROM FINANCE.D_FIN_VOUCHER_DETAIL D,FINANCE.D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG='SGST'", FinanceGlobal.FinURL))));
            Parameters.put("IGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS IGST FROM FINANCE.D_FIN_VOUCHER_DETAIL D,FINANCE.D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG='IGST'", FinanceGlobal.FinURL))));
            Parameters.put("AMT", String.valueOf((data.getDoubleValueFromDB("SELECT SUM(AMOUNT) AS GST FROM FINANCE.D_FIN_VOUCHER_DETAIL D,FINANCE.D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG NOT LIKE '%GST'", FinanceGlobal.FinURL))));
            //Parameters.put("PARTY_MAIN_ACC_CODE", String.valueOf((data.getDoubleValueFromDB("SELECT MAIN_ACCOUNT_CODE  FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='D' GROUP BY VOUCHER_NO", FinanceGlobal.FinURL))));
            Parameters.put("TOTAL_AMT", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(SUM(AMOUNT),0) AS AMOUNT FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' ", FinanceGlobal.FinURL))));
            
            String FullAccountName = clsPartyMaster.getAccountNameAddress(txtMainCode.getText().trim(),txtPartyCode.getText());
            Parameters.put("FULL_ACCOUNT_NAME", FullAccountName);
            Parameters.put("CURDATE", EITLERPGLOBAL.getCurrentDate());
            
            double roundValue = data.getDoubleValueFromDB("SELECT ROUND(SUM(AMOUNT),0) AS AMOUNT FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' ", FinanceGlobal.FinURL);
            ...
            String strSQL = "SELECT HEADER_REMARKS,A.CHEQUE_NO,A.CHEQUE_DATE,CHEQUE_AMOUNT,EFFECT,VOUCHER_NO,VOUCHER_DATE,ACCOUNT_CODE,ACCOUNT_NAME,CASE WHEN ACCOUNT_CODE NOT IN (127565,127566,127567,127568,127569,127570) THEN REMARKS WHEN ACCOUNT_CODE IN (127565,127566,127567,127568,127569,127570) THEN REPLACE(ACCOUNT_NAME,'PAYABLE','') END AS REMARKS,CR_AMOUNT,DR_AMOUNT,BOOK_CODE,INVOICE_NO,INVOICE_DATE,PO_NO,PO_DATE,BOOK_CODE,ST_CATEGORY ,MAIN_ACCOUNT_CODE,SUB_ACCOUNT_CODE,BOOK_NAME,LINK_NO,ACCOUNT_NAME_EX,REF_VOUCHER_NO FROM (SELECT A.REMARKS AS HEADER_REMARKS,A.CHEQUE_NO,A.CHEQUE_DATE,A.CHEQUE_AMOUNT,B.EFFECT, \n"
                    ...
                    + " LEFT JOIN FINANCE.D_FIN_BOOK_MASTER BOOK ON (BOOK.BOOK_CODE=A.BOOK_CODE), \n"
                    + " FINANCE.D_FIN_VOUCHER_DETAIL B \n"
                    + " LEFT JOIN FINANCE.D_FIN_GL AS GL ON (GL.MAIN_ACCOUNT_CODE=B.MAIN_ACCOUNT_CODE) \n"
                    + " LEFT JOIN FINANCE.D_FIN_PARTY_MASTER AS PARTY ON (PARTY.PARTY_CODE=B.SUB_ACCOUNT_CODE) \n"
                    + " LEFT JOIN FINANCE.D_FIN_EX_ACCOUNT_MASTER AS EX ON ( SUBSTRING(B.MAIN_ACCOUNT_CODE,LENGTH(B.MAIN_ACCOUNT_CODE)-1)=EX.EX_ACCOUNT_CODE) WHERE  A.VOUCHER_NO=B.VOUCHER_NO AND A.VOUCHER_NO='"+txtDocNo.getText()+"' AND EFFECT ='C' GROUP BY VOUCHER_NO,SR_NO ORDER BY REF_VOUCHER_NO,VOUCHER_NO,SR_NO ) AS A";
            System.out.println("Report :" + strSQL);
            rpt.setReportName("/EITLERP/Finance/rpt_SalesDebitNote.jrxml", 1, strSQL); //productlist is the name of my jasper file.
            //rpt.setReportName("/root/Desktop/rpt_SalesDebitNote.jrxml", 1, strSQL); //productlist is the name of my jasper file.
            rpt.callReport();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            int ModuleID = clsVoucher.DebitNoteModuleID;
        ...
        try {
            ...
            lblTitle.setText("DEBIT NOTE VOUCHER - " + txtDocNo.getText());
            ...
            for (int i = 1; i <= objVoucher.objPayment.colVoucherItems.size(); i++) {
                ...
                if (ObjItem.getAttribute("IS_DEDUCTION").getInt() == 0) {
                    ...
                    DataModel.setValueByVariable("REF_VOUCHER_NO", ObjItem.getAttribute("REF_VOUCHER_NO").getString(), NewRow);

                    if ((txtBookCode.getText().trim().equals("16")) || (txtBookCode.getText().trim().equals("18"))) { //Sales Debit Note Book
                        DisplayAgentAlpha(NewRow, ObjItem.getAttribute("INVOICE_DATE").getString());
                    } else {
                        DataModel.setValueByVariable("AGENT_SR", "", NewRow);
                    }
                }
            }
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, DocNo);
    ...
    private void SetData() {
        ...
        if (Table.getRowCount() > 0) {
            ...
            for (int i = 0; i < Table.getRowCount(); i++) {
                ...
                //                if(txtMainCode.getText().trim().equals("125019")) {
                ...
                objItem.setAttribute("REF_VOUCHER_NO", DataModel.getValueByVariable("REF_VOUCHER_NO", i));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.addColumn("Deduction A/c Code");
            ...
            DataModel.addColumn("Ref. Doc. No."); //6
            DataModel.addColumn("Ref. Doc. Date"); //7
            DataModel.addColumn("Ref. Doc. Type"); //8
            DataModel.addColumn("Company"); //9
            DataModel.addColumn("Module ID"); //10
            DataModel.addColumn("Ref. Company ID"); //11
            DataModel.addColumn("HSN_SAC_Code.");
            DataModel.addColumn("Item_Description");
            DataModel.addColumn("GSTN_Rate");
            DataModel.addColumn("Debit Memo No");

            DataModel.SetVariable(0, "SR_NO"); //0 - Read Only
            DataModel.SetVariable(1, "DEDUCTION_CODE"); //0 - Read Only
            DataModel.SetVariable(2, "DEDUCTION_NAME"); //0 - Read Only
            ...
            DataModel.SetVariable(7, "INVOICE_NO"); //1
            DataModel.SetVariable(8, "INVOICE_DATE"); //2 //Read Only
            DataModel.SetVariable(9, "PO_NO");
            DataModel.SetVariable(10, "PO_DATE");
            DataModel.SetVariable(11, "REF_DOC_NO");
            DataModel.SetVariable(12, "REF_DOC_DATE");
            DataModel.SetVariable(13, "MODULE_NAME");
            DataModel.SetVariable(14, "COMPANY_NAME");
            DataModel.SetVariable(15, "MODULE_ID");
            DataModel.SetVariable(16, "REF_COMPANY_ID");
            DataModel.SetVariable(17, "HSN_SAC_CODE");
            DataModel.SetVariable(18, "ITEM_DESCRIPTION");
            DataModel.SetVariable(19, "GSTN_RATE");
            DataModel.SetVariable(20, "REF_VOUCHER_NO");

            /* DataModel.SetVariable(4,"INVOICE_NO"); //1
             DataModel.SetVariable(5,"INVOICE_DATE"); //2 //Read Only
             DataModel.SetVariable(6,"PO_NO");
             DataModel.SetVariable(7,"PO_DATE");
             DataModel.SetVariable(8,"REF_DOC_NO");
             DataModel.SetVariable(9,"REF_DOC_DATE");
             DataModel.SetVariable(10,"MODULE_NAME");
             DataModel.SetVariable(11,"COMPANY_NAME");
             DataModel.SetVariable(12,"MODULE_ID");
             DataModel.SetVariable(13,"REF_COMPANY_ID");
            ...
            Table.getColumnModel().getColumn(9).setCellRenderer(POColor);
    ...
    private void DisplayInvoiceDetail(int RowNo, String AgentAlpha) {
        try {
            DataModel.setValueByVariable("INVOICE_NO", "", Table.getSelectedRow());
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.DebitNoteModuleID);

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.DebitNoteModuleID);
        }

        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (EITLERPGLOBAL.gNewUserID == ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, txtDocNo.getText())) {
                List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.DebitNoteModuleID));
            } else {
                List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.DebitNoteModuleID));
            }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10712)) {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, FromUserID, objVoucher.getAttribute("VOUCHER_NO").getString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10711)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10713)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10714)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        aList.ModuleID = clsVoucher.DebitNoteModuleID;
        ...
        if (aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, FFNo, false));
    ...
    private void Edit() {
        ...
        if (objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID, clsVoucher.DebitNoteModuleID)) {
            ...
            if (ApprovalFlow.IsCreator(clsVoucher.DebitNoteModuleID, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10712)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
...
//                    }
    ...
    private boolean Validate() {
        ...
        for (int i = 0; i <= Table.getRowCount() - 1; i++) {
            ...
            if (OpgFinal.isSelected()) {
                String DeductCode = DataModel.getValueByVariable("DEDUCTION_CODE", i);
                if (DeductCode.trim().equals("999999")) {
                    JOptionPane.showMessageDialog(null, "Please enter Valid Deduction Code");
                    return false;
                }
            }
            if (!OpgReject.isSelected()) {
                if (!DataModel.getValueByVariable("AGENT_SR", i).toString().trim().equals("")) {
                    String AgentAlpha = DataModel.getValueByVariable("AGENT_SR", i).toString().trim();
                    if (AgentAlpha.indexOf("/") > 0) {
                        if (DataModel.getValueByVariable("INVOICE_NO", i).toString().trim().equals("") || DataModel.getValueByVariable("INVOICE_DATE", i).toString().trim().equals("")) {
                            JOptionPane.showMessageDialog(null, "Please enter Valid Agent Alpha");
                            return false;
                        }
                    }
                }
            ...
            if (FoundSpecificMainCode) {
                for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                    ...
                    if (!PONo.equals("") && !InvoiceNo.equals("")) {
                        ...
                        //String SQL = "SELECT * FROM D_FIN_VOUCHER_DETAIL WHERE SUB_ACCOUNT_CODE='" + PartyCode + "' AND EFFECT='C' AND PO_NO='" + PONo + "' AND INVOICE_NO='" + InvoiceNo + "' ";
                        ...
                        SQL = "SELECT SUM(B.AMOUNT) FROM D_FIN_VOUCHER_HEADER A, D_FIN_VOUCHER_DETAIL B "
                                + "WHERE A.VOUCHER_NO=B.VOUCHER_NO AND A.CANCELLED=0 AND B.MAIN_ACCOUNT_CODE IN ('125019') "
                        ...
                        SQL = "SELECT SUM(B.AMOUNT) FROM D_FIN_VOUCHER_HEADER A, D_FIN_VOUCHER_DETAIL B "
                                ...
                                + "AND B.MAIN_ACCOUNT_CODE IN ('125019') AND B.SUB_ACCOUNT_CODE='" + txtPartyCode.getText().trim() + "' AND B.EFFECT='D' "
                                + "AND B.PO_NO='" + PONo + "' AND B.INVOICE_NO='" + InvoiceNo + "' ";
    ...
    private void Find() {
        ...
        if (ObjReturn.Cancelled == false) {
            if (!objVoucher.Filter(ObjReturn.strQuery + " AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_DEBIT_NOTE, EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        objVoucher.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND VOUCHER_NO='" + pDocNo + "' AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_DEBIT_NOTE + " ", pCompanyID);
        objVoucher.MoveLast();
        DisplayData();
    }

    public void FindWaiting() {
        //        objVoucher.Filter(" WHERE VOUCHER_NO IN (SELECT D_FIN_VOUCHER_HEADER.VOUCHER_NO FROM D_INV_REQ_HEADER,D_COM_DOC_DATA WHERE D_INV_REQ_HEADER.REQ_NO=D_COM_DOC_DATA.DOC_NO AND D_INV_REQ_HEADER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND D_INV_REQ_HEADER.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND D_COM_DOC_DATA.USER_ID="+EITLERPGLOBAL.gNewUserID+" AND D_COM_DOC_DATA.STATUS='W' AND MODULE_ID=2)",EITLERPGLOBAL.gCompanyID);
        //        objVoucher.MoveLast();
        //        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.DebitNoteModuleID, txtDocNo.getText());
        ...
        if (EditMode == 0) {
            try {
                ...
                if (!SimpleLOV.Cancelled) {
                    ...
                    if (objConfig.ProcessType == 14) {
                        //Parameters.put("CGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS CGST FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' AND REMARKS LIKE 'CGST'", FinanceGlobal.FinURL))));
                        //Parameters.put("SGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS SGST FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' AND REMARKS LIKE 'SGST'", FinanceGlobal.FinURL))));
                        //Parameters.put("IGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS IGST FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' AND REMARKS LIKE 'IGST'", FinanceGlobal.FinURL))));
                        //Parameters.put("AMT", String.valueOf((data.getDoubleValueFromDB("SELECT SUM(AMOUNT) AS GST FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' AND REMARKS NOT LIKE '%GST'", FinanceGlobal.FinURL))));
                        Parameters.put("CGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS CGST FROM D_FIN_VOUCHER_DETAIL D,D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG='CGST'",FinanceGlobal.FinURL))));
                    Parameters.put("SGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS SGST FROM D_FIN_VOUCHER_DETAIL D,D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG='SGST'",FinanceGlobal.FinURL))));
                    Parameters.put("IGST", String.valueOf((data.getDoubleValueFromDB("SELECT COALESCE(SUM(AMOUNT),0) AS IGST FROM D_FIN_VOUCHER_DETAIL D,D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG='IGST'",FinanceGlobal.FinURL))));
                    Parameters.put("AMT", String.valueOf((data.getDoubleValueFromDB("SELECT SUM(AMOUNT) AS GST FROM D_FIN_VOUCHER_DETAIL D,D_FIN_GL G WHERE D.MAIN_ACCOUNT_CODE=G.MAIN_ACCOUNT_CODE AND D.VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND D.EFFECT='C' AND G.GST_CATG NOT LIKE '%GST'",FinanceGlobal.FinURL))));
                    Parameters.put("PARTY_MAIN_ACC_CODE", String.valueOf((data.getDoubleValueFromDB("SELECT MAIN_ACCOUNT_CODE  FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='D' GROUP BY VOUCHER_NO", FinanceGlobal.FinURL))));
                        Parameters.put("TOTAL_AMT_IN_WORDS", String.valueOf((data.getDoubleValueFromDB("SELECT ROUND(SUM(AMOUNT),0) AS AMOUNT FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO = '" + txtDocNo.getText().trim() + "' AND EFFECT='C' ", FinanceGlobal.FinURL))));
                    }
                    System.out.print("Report Type:" + objConfig.ProcessType);
                    ...
                    System.out.print("Report :" + objConfig.ReportFileName);
                    objEngine.PreviewReport(objConfig.ReportFileName, Parameters, objData);
                    //objEngine.PreviewReport("/root/Desktop/rptSales_DebitNote_GST.rpt",Parameters,objData);
