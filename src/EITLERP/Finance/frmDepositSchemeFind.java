...
public class frmDepositSchemeFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmdFind.setBounds(492, 40, 70, 25);
        ...
        cmdClear.setBounds(492, 100, 70, 25);
        ...
        jLabel2.setLabelFor(txtSchemeID);
        jLabel2.setText("Scheme ID :");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(27, 15, 74, 15);

        txtSchemeID.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtSchemeIDFocusLost(evt);
            }
        });

        jPanel1.add(txtSchemeID);
        txtSchemeID.setBounds(105, 14, 132, 19);

        jLabel13.setText("Scheme Name :");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(5, 47, 94, 15);

        jPanel1.add(txtSchemeName);
        txtSchemeName.setBounds(105, 47, 340, 19);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 39, 473, 90);

    }//GEN-END:initComponents

    private void txtSchemeIDFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtSchemeIDFocusLost
        // TODO add your handling code here:
        if(!txtSchemeID.getText().trim().equals("")) {
            txtSchemeName.setText(data.getStringValueFromDB("SELECT SCHEME_NAME FROM D_FD_SCHEME_MASTER WHERE SCHEME_ID='"+txtSchemeID.getText()+"'",FinanceGlobal.FinURL));
        }
    }//GEN-LAST:event_txtSchemeIDFocusLost
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       if(!txtSchemeID.getText().equals(""))
       {
         strQuery=strQuery+" AND SCHEME_ID='"+txtSchemeID.getText()+"' ";
       }
       
       if(!txtSchemeName.getText().equals(""))
       {
         strQuery=strQuery+" AND SCHEME_NAME LIKE '%"+txtSchemeName.getText()+"%' ";
       }
