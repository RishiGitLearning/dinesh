...
package EITLERP.Finance.BankStmt;
 ...
 *
 */
public class frmRptBankReco_NEW extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmdSummary.setEnabled(false);
        cmdSummary.setOpaque(false);
        ...
        opg1.setText(" Cheque Issued but bank not Credited ");
        bg1234.add(opg1);
        opg1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opg1ActionPerformed(evt);
            }
        });

        selectionPanel.add(opg1);
        opg1.setBounds(5, 5, 340, 15);
        ...
        opg2.setText(" Cheque accounted but bank not Credited");
        bg1234.add(opg2);
        opg2.setOpaque(false);
        opg2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opg2ActionPerformed(evt);
            }
        });

        selectionPanel.add(opg2);
        opg2.setBounds(5, 25, 360, 15);

        getContentPane().add(selectionPanel);
        selectionPanel.setBounds(5, 150, 380, 85);

    }//GEN-END:initComponents

    private void opg1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opg1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_opg1ActionPerformed

    private void opg2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opg2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_opg2ActionPerformed
    ...
    private void GenerateReportI() {
        try {
           ...
           {    
            ...
            String AsOnDate = EITLERPGLOBAL.formatDateDB(txtAsOnDate.getText().trim());
            String BookCode = txtBookCode.getText().trim();
            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Finance/BankStmt/rptpartycard_new.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&FromDate="+AsOnDate+"&stype="+stype);
