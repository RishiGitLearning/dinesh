...
public class frmOBC extends javax.swing.JApplet {
    
    private int EditMode=0;
    private clsOBC objOBC;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblAccountID7 = new javax.swing.JLabel();
        txtIntAmount = new javax.swing.JTextField();
        ...
        lblTitle.setText(" OUTWARD BANK COLLECTION");
        ...
        lblAccountID.setBounds(5, 21, 127, 15);
        ...
        txtPartyName.setNextFocusableComponent(txtAmount);
        txtPartyName.setEnabled(false);
        Panel1.add(txtPartyName);
        txtPartyName.setBounds(135, 124, 440, 19);
        ...
        txtPartyCode.setBounds(135, 101, 120, 19);
        ...
        txtAgentAlpha.setBounds(360, 100, 120, 19);

        lblAccountID7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblAccountID7.setText("Interest Amount :");
        Panel1.add(lblAccountID7);
        lblAccountID7.setBounds(5, 195, 127, 15);

        txtIntAmount.setName("PARTY_ID");
        txtIntAmount.setNextFocusableComponent(txtReceivedDate);
        txtIntAmount.setEnabled(false);
        Panel1.add(txtIntAmount);
        txtIntAmount.setBounds(135, 192, 120, 19);

        lblAccountID4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblAccountID4.setText("Received Date :");
        Panel1.add(lblAccountID4);
        lblAccountID4.setBounds(5, 222, 127, 15);

        txtReceivedDate.setName("PARTY_ID");
        txtReceivedDate.setNextFocusableComponent(txtRemarks);
        txtReceivedDate.setEnabled(false);
        Panel1.add(txtReceivedDate);
        txtReceivedDate.setBounds(135, 219, 120, 19);

        lblBookCode.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblBookCode.setText("Book Code :");
        Panel1.add(lblBookCode);
        lblBookCode.setBounds(265, 76, 90, 15);

        txtBookCode.setName("PARTY_ID");
        ...
        txtBookCode.setBounds(360, 74, 120, 19);

        txtBookName.setEditable(false);
        txtBookName.setFont(new java.awt.Font("Dialog", 1, 12));
        txtBookName.setName("PARTY_ID");
        txtBookName.setEnabled(false);
        Panel1.add(txtBookName);
        txtBookName.setBounds(486, 74, 156, 19);
        ...
        cmdFromRemarksBig.setBounds(570, 78, 33, 21);
        ...
        txtAuditRemarks.setBounds(502, 335, 129, 19);

        Header.addTab("Status", jPanel6);

        getContentPane().add(Header);
        Header.setBounds(2, 66, 654, 386);
    ...
    private void txtBookCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBookCodeKeyPressed
        ...
        try {
            ...
            if(evt.getKeyCode()==112) {
                ...
                aList.SQL="SELECT BOOK_CODE,BOOK_NAME FROM D_FIN_BOOK_MASTER WHERE BOOK_TYPE=1 AND BOOK_CODE NOT IN (30,70,26) ORDER BY BOOK_NAME";
                aList.ReturnCol=1;
    ...
    private void txtBankRefDateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBankRefDateFocusLost
        try
        {
            ...
            ResultSet rsTmp=data.getResult("SELECT * FROM D_FIN_OBC_INVOICE_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND BANK_REFERENCE_NO='"+txtBankRefNo.getText()+"' AND BANK_REFERENCE_DATE='"+EITLERPGLOBAL.formatDateDB(txtBankRefDate.getText().trim())+"'",FinanceGlobal.FinURL);
            rsTmp.first();
            
            if(rsTmp.getRow()>0)
            {
               // MODIFICATION BY HARDIK 
               //txtBankRefDate.setText(EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp,"BANK_REFERENCE_DATE","0000-00-00")));
               txtMainCode.setText(UtilFunctions.getString(rsTmp,"MAIN_ACCOUNT_CODE",""));
               txtPartyCode.setText(UtilFunctions.getString(rsTmp,"PARTY_CODE",""));
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBankRefDateFocusLost

    private void txtBankRefNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBankRefNoFocusLost
        // TODO add your handling code here:
//        try
//        {
//            txtBankRefDate.setText("");
...
//            txtAgentAlpha.setText("");
//            
//            ResultSet rsTmp=data.getResult("SELECT * FROM D_FIN_OBC_INVOICE_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND BANK_REFERENCE_NO='"+txtBankRefNo.getText()+"' AND BANK_REFERENCE_DATE='"+txtBankRefDate.getText().trim()+"'",FinanceGlobal.FinURL);
//            rsTmp.first();
//            
//            if(rsTmp.getRow()>0)
//            {
...
//            
//        }
    }//GEN-LAST:event_txtBankRefNoFocusLost
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,clsOBC.ModuleID , objOBC.getAttribute("DOC_NO").getString())) {
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private javax.swing.JLabel lblAccountID7;
    ...
    private javax.swing.JTextField txtIntAmount;
    ...
    private void SetFields(boolean pStat) {
        ...
        txtIntAmount.setEnabled(pStat);
        txtReceivedDate.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        txtMainCode.setText(objOBC.getAttribute("MAIN_CODE").getString());
        txtPartyCode.setText(objOBC.getAttribute("PARTY_CODE").getString());
        String PartyName=clsAccount.getAccountName(txtMainCode.getText(),txtPartyCode.getText());
        txtPartyName.setText(PartyName);
        txtBookCode.setText(objOBC.getAttribute("BOOK_CODE").getString());
        String BookName = clsBook.getBookName(EITLERPGLOBAL.gCompanyID, txtBookCode.getText().trim());
        ...
        txtAmount.setText(Double.toString(objOBC.getAttribute("AMOUNT").getDouble()));
        txtIntAmount.setText(Double.toString(objOBC.getAttribute("INTEREST_AMOUNT").getDouble()));
        txtReceivedDate.setText(objOBC.getAttribute("PAYMENT_RECEIVED_DATE").getString());
        ...
        List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsOBC.ModuleID , DocNo);
        ...
        HashMap History=clsOBC.getHistoryList(EITLERPGLOBAL.gCompanyID, objOBC.getAttribute("DOC_NO").getString());
        for(int i=1;i<=History.size();i++) {
            clsOBC ObjHistory=(clsOBC)History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        objOBC.setAttribute("MAIN_CODE",txtMainCode.getText());
        objOBC.setAttribute("PARTY_CODE",txtPartyCode.getText());
        objOBC.setAttribute("BOOK_CODE",txtBookCode.getText().trim());
        objOBC.setAttribute("BANK_REFERENCE_NO",txtBankRefNo.getText());
        objOBC.setAttribute("BANK_REFERENCE_DATE",txtBankRefDate.getText());
        objOBC.setAttribute("AMOUNT",UtilFunctions.CDbl(txtAmount.getText()));
        objOBC.setAttribute("INTEREST_AMOUNT",UtilFunctions.CDbl(txtIntAmount.getText()));
        objOBC.setAttribute("PAYMENT_RECEIVED_DATE",txtReceivedDate.getText());
    ...
    private void SetMenuForRights() {
        ...
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10921)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10923)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10924)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
        ...
        aList.ModuleID=clsOBC.ModuleID;
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsOBC.ModuleID, FFNo,  false));
    ...
    private void Edit() {
        ...
        if(objOBC.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(clsOBC.ModuleID ,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10922)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Save() {
        ...
        if(txtBookCode.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(this,"Insert Book Code...");
            return;
        }
        
        String BankRefNo = txtBankRefNo.getText().trim();
        String BankRefDate = txtBankRefDate.getText().trim();
        
        if(data.IsRecordExist("SELECT * FROM D_FIN_OBC WHERE BANK_REFERENCE_NO='"+BankRefNo+"' AND BANK_REFERENCE_NO='"+BankRefNo+"' AND CANCELLED=0 AND DOC_NO<>'"+txtDocNo.getText().trim()+"' ")) {
            JOptionPane.showMessageDialog(this,"Bank Reference No already exists...");
            return;
        }
        EITLERPGLOBAL.ChangeCursorToWait(this);
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Finance.frmOBCFind",true);
        frmOBCFind ObjReturn= (frmOBCFind) ObjLoader.getObj();
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsOBC.ModuleID , objOBC.getAttribute("DOC_NO").getString());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsOBC.ModuleID ,FromUserID,objOBC.getAttribute("DOC_NO").getString());
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsOBC.ModuleID ,objOBC.getAttribute("DOC_NO").getString());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID,clsOBC.ModuleID , objOBC.getAttribute("DOC_NO").getString(), ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsOBC.ModuleID, objOBC.getAttribute("DOC_NO").getString(), ObjUser.getAttribute("USER_ID").getInt() , EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsOBC.ModuleID , objOBC.getAttribute("DOC_NO").getString());
    ...
    private void GenerateCombos() {
        try {
            ...
            List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsOBC.ModuleID);
            
            if(EditMode==EITLERPGLOBAL.EDIT) {
                List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsOBC.ModuleID );
            }
            for(int i=1;i<=List.size();i++) {
