...
public class frmDepositAmendFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblReceiptNo.setText("Party Code :");
        ...
        txtDateTo.setNextFocusableComponent(txtPartyCode);
         ...
         if(evt.getKeyCode()==112) //F1 Key pressed
                {
                    ...
                    if(aList.ShowLOV()) {
                        ...
                        lblShowMessage.setText(rsData.getString("PARTY_NAME"));
                    }  
                } 
    ...
    private void txtPartyCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPartyCodeFocusLost
        ...
        try{
            if(!txtPartyCode.getText().equals("")){
                    ResultSet rsData = data.getResult("SELECT PARTY_CODE,PARTY_NAME FROM D_FIN_PARTY_MASTER WHERE PARTY_CODE='"+txtPartyCode.getText().trim()+"' ",FinanceGlobal.FinURL);
                    rsData.first();
                    lblShowMessage.setText(rsData.getString("PARTY_NAME"));
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!txtDocNo.getText().equals("")) {
            strQuery=strQuery+" AND AMEND_ID='"+txtDocNo.getText()+"' ";
        }
      ...
      /*  if(lblDateFrom.getText().equals("Doc Date :")) {
            strQuery=strQuery+" AND AMEND_DATE='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
        } else {
            strQuery=strQuery+" AND AMEND_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' AND AMEND_DATE<='"+ EITLERPGLOBAL.formatDateDB(txtDateTo.getText()) +"' ";
        }*/
