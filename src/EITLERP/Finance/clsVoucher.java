...
public class clsVoucher {
    ...
    public static final int JournalVoucherModuleID = 89;
     public static final int ReceiptVoucher2ModuleID = 205;
    ...
    public clsVoucher() {
        ...
        props.put("GSTN_RATE", new Variant(0));
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            String SQL = "SELECT * FROM FINANCE.D_FIN_VOUCHER_HEADER WHERE COMPANY_ID=" + pCompanyID + " AND VOUCHER_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND VOUCHER_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' AND VOUCHER_TYPE=" + VoucherType + " ORDER BY VOUCHER_DATE, VOUCHER_NO";
            System.out.println("SQL : "+SQL);
            rsResultSet = Stmt.executeQuery("SELECT * FROM FINANCE.D_FIN_VOUCHER_HEADER WHERE COMPANY_ID=" + pCompanyID + " AND VOUCHER_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND VOUCHER_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' AND VOUCHER_TYPE=" + VoucherType + " ORDER BY VOUCHER_DATE, VOUCHER_NO");
    ...
    public boolean Insert() {
        ...
        try {
            ...
            System.out.println("FinFromDate "+FinFromDate+" 10");
            System.out.println("FinToDate "+FinToDate+" 10");
            System.out.println("ReqDate "+ReqDate+" 10");
          
            System.out.println("Voucher No -1 : " );
            ...
            //===========================================================//
             System.out.println("Voucher No0 : ");
         ...
         System.out.println("Voucher No1 : " );
            ...
            if (getAttribute("CHEQUE_DATE").getString().equalsIgnoreCase("") || getAttribute("CHEQUE_DATE").getString().equals("0000-00-00")) {
...
//            rsResultSet.updateString("CHEQUE_DATE",EITLERPGLOBAL.formatDateDB(getAttribute("CHEQUE_DATE").getString()));
            if (getAttribute("REALIZATION_DATE").getString().equalsIgnoreCase("") || getAttribute("REALIZATION_DATE").getString().equals("0000-00-00")) {
...
//            rsResultSet.updateString("REALIZATION_DATE",EITLERPGLOBAL.formatDateDB(getAttribute("REALIZATION_DATE").getString()));
            ...
            rsResultSet.updateString("CREATED_BY", EITLERPGLOBAL.gLoginID); //getAttribute("CREATED_BY").getString()
            rsResultSet.updateString("CREATED_DATE", EITLERPGLOBAL.getCurrentDateDB()); //EITLERPGLOBAL.formatDateDB(getAttribute("CREATED_DATE").getString())
            ...
            rsResultSet.updateString("EMP_NAME", getAttribute("EMP_NAME").getString());
            if (getAttribute("LEGACY_DATE").getString().equalsIgnoreCase("") || getAttribute("LEGACY_DATE").getString().equals("0000-00-00")) {
...
//            rsHistory.updateString("REALIZATION_DATE",EITLERPGLOBAL.formatDateDB(getAttribute("REALIZATION_DATE").getString()));
            ...
            rsHistory.updateString("CREATED_DATE", EITLERPGLOBAL.getCurrentDateDB());   //EITLERPGLOBAL.formatDateDB(getAttribute("CREATED_DATE").getString())
            ...
            rsHistory.updateString("EMP_NAME", getAttribute("EMP_NAME").getString());
            if (getAttribute("LEGACY_DATE").getString().equalsIgnoreCase("") || getAttribute("LEGACY_DATE").getString().equals("0000-00-00")) {
                rsHistory.updateString("LEGACY_DATE", "0000-00-00");
            } else {
...
//            rsHistory.updateString("LEGACY_DATE",EITLERPGLOBAL.formatDateDB(getAttribute("LEGACY_DATE").getString()));
            ...
            for (int i = 1; i <= colVoucherItems.size(); i++) {
                ...
                if (objItem.getAttribute("PO_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("PO_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsTmp.updateString("PO_DATE", "0000-00-00");
                } else {
                ...
                if (objItem.getAttribute("INVOICE_DATE").getString().equalsIgnoreCase("")) {
                ...
                //rsTmp.updateString("INVOICE_DATE",EITLERPGLOBAL.formatDateDB(objItem.getAttribute("INVOICE_DATE").getString()));
                if (objItem.getAttribute("VALUE_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("VALUE_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsTmp.updateString("VALUE_DATE", "0000-00-00");
                } else {
                ...
                if (objItem.getAttribute("GRN_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("GRN_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsTmp.updateString("GRN_DATE", "0000-00-00");
                } else {
                ...
                rsTmp.updateString("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                rsTmp.updateString("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                rsTmp.updateDouble("GSTN_RATE", objItem.getAttribute("GSTN_RATE").getDouble());
                
                rsTmp.updateString("GR_INVOICE_NO", objItem.getAttribute("GR_INVOICE_NO").getString());
                rsTmp.updateString("GR_INVOICE_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("GR_INVOICE_DATE").getString()));
                rsTmp.updateString("GR_NO", objItem.getAttribute("GR_NO").getString());
                rsTmp.updateString("GR_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("GR_DATE").getString()));
                ...
                rsHDetail.updateString("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                rsHDetail.updateString("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                rsHDetail.updateDouble("GSTN_RATE", objItem.getAttribute("GSTN_RATE").getDouble());
              
                rsHDetail.updateString("GR_INVOICE_NO", objItem.getAttribute("GR_INVOICE_NO").getString());
                rsHDetail.updateString("GR_INVOICE_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("GR_INVOICE_DATE").getString()));
                rsHDetail.updateString("GR_NO", objItem.getAttribute("GR_NO").getString());
                rsHDetail.updateString("GR_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("GR_DATE").getString()));
                ...
                if (objItem.getAttribute("PO_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("PO_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsHDetail.updateString("PO_DATE", "0000-00-00");
                } else {
                ...
                if (objItem.getAttribute("INVOICE_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("INVOICE_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsHDetail.updateString("INVOICE_DATE", "0000-00-00");
                } else {
                    rsHDetail.updateString("INVOICE_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("INVOICE_DATE").getString()));
                }
                //rsHDetail.updateString("INVOICE_DATE",EITLERPGLOBAL.formatDateDB(objItem.getAttribute("INVOICE_DATE").getString()));
                if (objItem.getAttribute("VALUE_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("VALUE_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsHDetail.updateString("VALUE_DATE", "0000-00-00");
                } else {
                ...
                if (objItem.getAttribute("GRN_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("GRN_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                    rsHDetail.updateString("GRN_DATE", "0000-00-00");
                } else {
                ...
                for (int j = 1; j <= objItem.colVoucherDetailDocs.size(); j++) {
                    ...
                    if (objDetailDoc.getAttribute("DOC_DATE").getString().equalsIgnoreCase("") || objDetailDoc.getAttribute("DOC_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                        rsDetailDocs.updateString("DOC_DATE", "0000-00-00");
                    } else {
            ...
            if ((VoucherType != FinanceGlobal.TYPE_JOURNAL) && (VoucherType != FinanceGlobal.TYPE_SALES_JOURNAL) && (VoucherType != FinanceGlobal.TYPE_DEBIT_NOTE)) //Do not apply seperation logic for Journal Entries
            {
                //======================================================================================//
                ...
                HashMap sEntries = new HashMap();
                  System.out.println( validEntryMessage);
                  System.out.println("Voucher item  "+ colVoucherItems.size()); 
                for (int i = 1; i <= colVoucherItems.size(); i++) {
                    clsVoucherItem objItem = (clsVoucherItem) colVoucherItems.get(Integer.toString(i));
                    ...
                    if (sEntries.size() == 0) {
                        ...
                        if (!CurrentEffect.equals(PreviousEffect)) {
                            if (CurrentEffect.equals("C")) {
                                ...
                                double CurrentAmount = EITLERPGLOBAL.round(objItem.getAttribute("AMOUNT").getDouble(), 2);
                                      System.out.println("CurrentAmount2 "+ CurrentAmount); 
                ...
                for (int i = 1; i <= colVoucherItemsEx.size(); i++) {
                    ...
                    rsTmpEx.updateString("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                    rsTmpEx.updateString("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                    rsTmpEx.updateDouble("GSTN_RATE", objItem.getAttribute("GSTN_RATE").getDouble());

                    rsTmpEx.updateString("GR_INVOICE_NO", objItem.getAttribute("GR_INVOICE_NO").getString());
                    rsTmpEx.updateString("GR_INVOICE_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("GR_INVOICE_DATE").getString()));
                    rsTmpEx.updateString("GR_NO", objItem.getAttribute("GR_NO").getString());
                    rsTmpEx.updateString("GR_DATE", EITLERPGLOBAL.formatDateDB(objItem.getAttribute("GR_DATE").getString()));


                    rsTmpEx.updateString("REF_VOUCHER_NO", objItem.getAttribute("REF_VOUCHER_NO").getString());
                    
                    rsTmpEx.updateString("PO_NO", objItem.getAttribute("PO_NO").getString());
                    if (objItem.getAttribute("PO_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("PO_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                        rsTmpEx.updateString("PO_DATE", "0000-00-00");
                    } else {
                    ...
                    if (objItem.getAttribute("GRN_DATE").getString().equalsIgnoreCase("") || objItem.getAttribute("GRN_DATE").getString().equalsIgnoreCase("0000-00-00")) {
                        rsTmpEx.updateString("GRN_DATE", "0000-00-00");
                    } else {
            ...
            ObjFlow.DocDate=EITLERPGLOBAL.formatDateDB(getAttribute("VOUCHER_DATE").getString());
            ...
            if (ObjFlow.Status.equals("F")) {
                ...
                if (VoucherType == FinanceGlobal.TYPE_RECEIPT || VoucherType == FinanceGlobal.TYPE_RECEIPT_TDS || VoucherType == FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER || (VoucherType == FinanceGlobal.TYPE_JOURNAL && (!DepositTransfer))) {
...
//                    }
                if (MainAccountCode.equals("210010")) {
                        //PostDebitNoteFelt(VoucherNo);
                        PostDebitNoteFeltV2(VoucherNo);
                    }
                    if (MainAccountCode.equals("210027")) {
                        //PostDebitNoteSuitings(VoucherNo);
                        PostDebitNoteSuitingsV2(VoucherNo);
                    }
                }
               if(VoucherType== FinanceGlobal.TYPE_DEBIT_NOTE){
                    data.Execute("UPDATE FINANCE.D_FIN_VOUCHER_DETAIL D,FINANCE.D_FIN_DEBITMEMO_RECEIPT_MAPPING M,FINANCE.D_FIN_VOUCHER_HEADER H SET M.DEBITNOTE_VOUCHER_NO=D.VOUCHER_NO,M.DEBITNOTE_VOUCHER_DATE=H.VOUCHER_DATE,D.REF_VOUCHER_NO=M.DEBITMEMO_NO WHERE D.VOUCHER_NO=H.VOUCHER_NO AND M.INVOICE_NO=D.INVOICE_NO AND M.INVOICE_DATE=D.INVOICE_DATE AND D.INVOICE_DATE<>'0000-00-00' AND D.VOUCHER_NO='"+VoucherNo+"' AND D.VOUCHER_NO LIKE 'DN%'");
                }
...
//                    String MainAccountCode = data.getStringValueFromDB("SELECT MAIN_ACCOUNT_CODE FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO='" + VoucherNo + "' AND EFFECT='C' AND SUB_ACCOUNT_CODE<>'' AND MAIN_ACCOUNT_CODE IN ('210010') ", FinanceGlobal.FinURL);
//                    if (MainAccountCode.equals("210010")) {
//                        String SubAccountCode = data.getStringValueFromDB("SELECT SUB_ACCOUNT_CODE FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO='" + VoucherNo + "' AND EFFECT='C' AND SUB_ACCOUNT_CODE<>'' AND MAIN_ACCOUNT_CODE IN ('210010') ", FinanceGlobal.FinURL);
...
//                            PostTCSDebitNoteFelt(VoucherNo);
//                        }
//                    }
//                }
            }
    ...
    public boolean Update() {
        ...
        try {
            ...
            if (ChangeVoucherNo && (!VoucherNo.equals(OldVoucherNo))) {
                ...
                if (getAttribute("VOUCHER_TYPE").getInt() == FinanceGlobal.TYPE_RECEIPT || getAttribute("VOUCHER_TYPE").getInt() == FinanceGlobal.TYPE_RECEIPT_TDS) {
            ...
            if (ApprovalFlow.HierarchyUpdateNeeded(EITLERPGLOBAL.gCompanyID, ObjFlow.ModuleID, getAttribute("VOUCHER_NO").getString(), getAttribute("HIERARCHY_ID").getInt(), OldHierarchy, EITLERPGLOBAL.gNewUserID, AStatus)) {
                ...
                if (IsRejected) {
                    ...
                    data.Execute("DELETE FROM D_COM_DOC_DATA WHERE COMPANY_ID=" + getAttribute("COMPANY_ID").getInt() + " AND MODULE_ID=" + ObjFlow.ModuleID + " AND DOC_NO='" + ObjFlow.DocNo + "'");
            ...
            if (ObjFlow.Status.equals("F")) {
                ...
                if (VoucherType == FinanceGlobal.TYPE_RECEIPT || VoucherType == FinanceGlobal.TYPE_RECEIPT_TDS || VoucherType == FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER || (VoucherType == FinanceGlobal.TYPE_JOURNAL && (!DepositTransfer))) {
                     ...
                     */
                if (MainAccountCode.equals("210010")) {
                        //PostDebitNoteFelt(currentVoucherNo);
                        PostDebitNoteFeltV2(currentVoucherNo);
                    }
                    if (MainAccountCode.equals("210027")) {
                        //PostDebitNoteSuitings(currentVoucherNo);
                        PostDebitNoteSuitingsV2(currentVoucherNo);
                    }
                }
                            ...
                            while (AdjustAmount > 0) {
                                if (clsVoucher.getVoucherType(GRNNo) > 0) {
                                    ...
                                    if (AdjustAmount > AmountCanAdjust) {
                                        ...
                                        if (GRNVoucherType == FinanceGlobal.TYPE_RECEIPT || GRNVoucherType == FinanceGlobal.TYPE_RECEIPT_TDS || GRNVoucherType == FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER
                ...
                if (VoucherType == FinanceGlobal.TYPE_JOURNAL && currentVoucherNo.startsWith("PY")) {  //|| VoucherType == FinanceGlobal.TYPE_CASH_VOUCHER
                    /*
                    if (EITLERPGLOBAL.FinYearFrom != Integer.parseInt(EITLERPGLOBAL.getCurrentDateDB().substring(0, 4))) {
                        String tempEndDate = EITLERPGLOBAL.getFinYearEndDate(EITLERPGLOBAL.FinYearFrom + "-04-01");
                        String tempStartDate = EITLERPGLOBAL.getFinYearStartDate(EITLERPGLOBAL.FinYearFrom + "-04-01");
             ...
             if(VoucherType== FinanceGlobal.TYPE_DEBIT_NOTE){
                    data.Execute("UPDATE FINANCE.D_FIN_VOUCHER_DETAIL D,FINANCE.D_FIN_DEBITMEMO_RECEIPT_MAPPING M,FINANCE.D_FIN_VOUCHER_HEADER H SET M.DEBITNOTE_VOUCHER_NO=D.VOUCHER_NO,M.DEBITNOTE_VOUCHER_DATE=H.VOUCHER_DATE,D.REF_VOUCHER_NO=M.DEBITMEMO_NO WHERE D.VOUCHER_NO=H.VOUCHER_NO AND M.INVOICE_NO=D.INVOICE_NO AND M.INVOICE_DATE=D.INVOICE_DATE AND D.INVOICE_DATE<>'0000-00-00' AND D.VOUCHER_NO='"+currentVoucherNo+"' AND D.VOUCHER_NO LIKE 'DN%'");
                }
...
//                }
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("VOUCHER_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "VOUCHER_DATE", "")));
            ...
            setAttribute("CHEQUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "CHEQUE_DATE", "")));
            setAttribute("REALIZATION_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "REALIZATION_DATE", "")));
            ...
            setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "CREATED_DATE", "")));
            setAttribute("MODIFIED_BY", UtilFunctions.getString(rsResultSet, "MODIFIED_BY", ""));
            setAttribute("MODIFIED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "MODIFIED_DATE", "")));
            setAttribute("CHANGED", UtilFunctions.getInt(rsResultSet, "CHANGED", 0));
            setAttribute("CHANGED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "CHANGED_DATE", "")));
            setAttribute("APPROVED", UtilFunctions.getInt(rsResultSet, "APPROVED", 0));
            setAttribute("APPROVED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "APPROVED_DATE", "")));
            setAttribute("REJECTED", UtilFunctions.getInt(rsResultSet, "REJECTED", 0));
            setAttribute("REJECTED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "REJECTED_DATE", "")));
            ...
            System.out.println(UtilFunctions.getString(rsResultSet, "EMP_NAME", ""));
            setAttribute("EMP_NAME", UtilFunctions.getString(rsResultSet, "EMP_NAME", ""));
            setAttribute("LEGACY_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "LEGACY_DATE", "")));
            setAttribute("EXCLUDE_IN_ADJ", UtilFunctions.getInt(rsResultSet, "EXCLUDE_IN_ADJ", 0));
            //setAttribute("EMPLOYEE_NO",data.getStringValueFromDB("SELECT EMPLOYEE_NO FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO='"+UtilFunctions.getString(rsResultSet,"VOUCHER_NO","")+"' ",FinanceGlobal.FinURL));
            //setAttribute("EMP_NAME",data.getStringValueFromDB("SELECT EMP_NAME FROM FINANCE.D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO='"+UtilFunctions.getString(rsResultSet,"VOUCHER_NO","")+"' ",FinanceGlobal.FinURL));
            //setAttribute("EMP_NAME",UtilFunctions.getString(rsResultSet,"EMP_NAME",""));
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                objItem.setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "CREATED_DATE", "")));
                objItem.setAttribute("MODIFIED_BY", UtilFunctions.getString(rsTmp, "MODIFIED_BY", ""));
                objItem.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "MODIFIED_DATE", "")));
                objItem.setAttribute("CHANGED", true);
                objItem.setAttribute("CHANGED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "CHANGED_DATE", "")));
                objItem.setAttribute("CANCELLED", 0);
                objItem.setAttribute("PO_NO", UtilFunctions.getString(rsTmp, "PO_NO", ""));
                objItem.setAttribute("PO_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "PO_DATE", "")));
                objItem.setAttribute("INVOICE_NO", UtilFunctions.getString(rsTmp, "INVOICE_NO", ""));
                objItem.setAttribute("INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "INVOICE_DATE", "")));
                objItem.setAttribute("VALUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "VALUE_DATE", "")));
                objItem.setAttribute("GRN_NO", UtilFunctions.getString(rsTmp, "GRN_NO", ""));
                objItem.setAttribute("GRN_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "GRN_DATE", "")));
                ...
                objItem.setAttribute("MATCHED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "MATCHED_DATE", "")));
                objItem.setAttribute("REF_SR_NO", UtilFunctions.getInt(rsTmp, "REF_SR_NO", 0));
                objItem.setAttribute("HSN_SAC_CODE", UtilFunctions.getString(rsTmp, "HSN_SAC_CODE", ""));
                objItem.setAttribute("ITEM_DESCRIPTION", UtilFunctions.getString(rsTmp, "ITEM_DESCRIPTION", ""));
                objItem.setAttribute("GSTN_RATE", UtilFunctions.getString(rsTmp, "GSTN_RATE", ""));
                objItem.setAttribute("GR_INVOICE_NO", UtilFunctions.getString(rsTmp, "GR_INVOICE_NO", ""));
                objItem.setAttribute("GR_INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "GR_INVOICE_DATE", "")));
                objItem.setAttribute("GR_NO", UtilFunctions.getString(rsTmp, "GR_NO", ""));
                objItem.setAttribute("GR_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "GR_DATE", "")));
                objItem.setAttribute("REF_VOUCHER_NO", UtilFunctions.getString(rsTmp, "REF_VOUCHER_NO", ""));
            ...
            if(UtilFunctions.getInt(rsResultSet, "VOUCHER_TYPE", 0) == FinanceGlobal.TYPE_RECEIPT_TDS){                
                getReceipt2Representation();
            }
            //******************************************************//
    ...
    public boolean getCashReceiptRepresentation() {
        ...
        try {
            ...
            objPayment.setAttribute("VOUCHER_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "VOUCHER_DATE", "")));
            ...
            objPayment.setAttribute("CHEQUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "CHEQUE_DATE", "")));
            objPayment.setAttribute("REALIZATION_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "REALIZATION_DATE", "")));
            ...
            objPayment.setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "CREATED_DATE", "")));
            objPayment.setAttribute("MODIFIED_BY", UtilFunctions.getString(rsResultSet, "MODIFIED_BY", ""));
            objPayment.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "MODIFIED_DATE", "")));
            objPayment.setAttribute("CHANGED", UtilFunctions.getInt(rsResultSet, "CHANGED", 0));
            objPayment.setAttribute("CHANGED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "CHANGED_DATE", "")));
            objPayment.setAttribute("APPROVED", UtilFunctions.getInt(rsResultSet, "APPROVED", 0));
            objPayment.setAttribute("APPROVED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "APPROVED_DATE", "")));
            objPayment.setAttribute("REJECTED", UtilFunctions.getInt(rsResultSet, "REJECTED", 0));
            objPayment.setAttribute("REJECTED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "REJECTED_DATE", "")));
            ...
            objPayment.setAttribute("LEGACY_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsResultSet, "LEGACY_DATE", "")));
        ...
        try {
            ...
            if (rsNormalEntries.getRow() > 0) {
                while (!rsNormalEntries.isAfterLast()) {
                    ...
                    objItem.setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "CREATED_DATE", "")));
                    objItem.setAttribute("MODIFIED_BY", UtilFunctions.getString(rsNormalEntries, "MODIFIED_BY", ""));
                    objItem.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "MODIFIED_DATE", "")));
                    objItem.setAttribute("CHANGED", true);
                    objItem.setAttribute("CHANGED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "CHANGED_DATE", "")));
                    objItem.setAttribute("CANCELLED", 0);
                    objItem.setAttribute("PO_NO", UtilFunctions.getString(rsNormalEntries, "PO_NO", ""));
                    objItem.setAttribute("PO_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "PO_DATE", "")));
                    objItem.setAttribute("INVOICE_NO", UtilFunctions.getString(rsNormalEntries, "INVOICE_NO", ""));
                    objItem.setAttribute("INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "INVOICE_DATE", "")));
                    objItem.setAttribute("VALUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "VALUE_DATE", "")));
                    objItem.setAttribute("GRN_NO", UtilFunctions.getString(rsNormalEntries, "GRN_NO", ""));
                    objItem.setAttribute("GRN_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "GRN_DATE", "")));
                    ...
                    objItem.setAttribute("MATCHED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "MATCHED_DATE", "")));
                    objItem.setAttribute("INVOICE_AMOUNT", UtilFunctions.getDouble(rsNormalEntries, "AMOUNT", 0));
                    objItem.setAttribute("INVOICE_DEDUCTIONS", objDeductions);
                    objItem.setAttribute("DEDUCTION_AMOUNT", DeductionAmount);
                    objItem.setAttribute("IS_DEDUCTION", 0);
                           
                    objItem.setAttribute("HSN_SAC_CODE", UtilFunctions.getString(rsNormalEntries, "HSN_SAC_CODE", ""));
                    objItem.setAttribute("ITEM_DESCRIPTION", UtilFunctions.getString(rsNormalEntries, "ITEM_DESCRIPTION", ""));
                    objItem.setAttribute("GSTN_RATE", UtilFunctions.getString(rsNormalEntries, "GSTN_RATE", ""));
                    
                    objItem.setAttribute("GR_INVOICE_NO", UtilFunctions.getString(rsNormalEntries, "GR_INVOICE_NO", ""));
                    objItem.setAttribute("GR_INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "GR_INVOICE_DATE", "")));
                    objItem.setAttribute("GR_NO", UtilFunctions.getString(rsNormalEntries, "GR_NO", ""));
                    objItem.setAttribute("GR_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsNormalEntries, "GR_DATE", "")));
            ...
            if (rsDeductionEntries.getRow() > 0) {
                while (!rsDeductionEntries.isAfterLast()) {
                    ...
                    if (data.IsRecordExist("SELECT * FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO='" + VoucherNo + "' AND REF_SR_NO=" + VoucherSrNo + " AND MAIN_ACCOUNT_CODE<>'' AND EFFECT='C' AND IS_DEDUCTION=1", FinanceGlobal.FinURL)) {
                        ...
                        objItem.setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "CREATED_DATE", "")));
                        objItem.setAttribute("MODIFIED_BY", UtilFunctions.getString(rsDeductionEntries, "MODIFIED_BY", ""));
                        objItem.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "MODIFIED_DATE", "")));
                        objItem.setAttribute("CHANGED", true);
                        objItem.setAttribute("CHANGED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "CHANGED_DATE", "")));
                        objItem.setAttribute("CANCELLED", 0);
                        objItem.setAttribute("PO_NO", UtilFunctions.getString(rsDeductionEntries, "PO_NO", ""));
                        objItem.setAttribute("PO_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "PO_DATE", "")));
                        objItem.setAttribute("INVOICE_NO", UtilFunctions.getString(rsDeductionEntries, "INVOICE_NO", ""));
                        objItem.setAttribute("INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "INVOICE_DATE", "")));
                        objItem.setAttribute("VALUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "VALUE_DATE", "")));
                        objItem.setAttribute("GRN_NO", UtilFunctions.getString(rsDeductionEntries, "GRN_NO", ""));
                        objItem.setAttribute("GRN_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "GRN_DATE", "")));
                        ...
                        objItem.setAttribute("MATCHED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "MATCHED_DATE", "")));
                        objItem.setAttribute("HSN_SAC_CODE", UtilFunctions.getString(rsDeductionEntries, "HSN_SAC_CODE", ""));
                        objItem.setAttribute("ITEM_DESCRIPTION", UtilFunctions.getString(rsDeductionEntries, "ITEM_DESCRIPTION", ""));
                        objItem.setAttribute("GSTN_RATE", UtilFunctions.getString(rsDeductionEntries, "GSTN_RATE", ""));                       
                        
                        objItem.setAttribute("GR_INVOICE_NO", UtilFunctions.getString(rsDeductionEntries, "GR_INVOICE_NO", ""));
                        objItem.setAttribute("GR_INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "GR_INVOICE_DATE", "")));
                        objItem.setAttribute("GR_NO", UtilFunctions.getString(rsDeductionEntries, "GR_NO", ""));
                        objItem.setAttribute("GR_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "GR_DATE", "")));
                        ...
                        if (rsDeduction.getRow() > 0) {
                            while (!rsDeduction.isAfterLast()) {
                                ...
                                objDeductionItem.setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "CREATED_DATE", "")));
                                objDeductionItem.setAttribute("MODIFIED_BY", UtilFunctions.getString(rsDeduction, "MODIFIED_BY", ""));
                                objDeductionItem.setAttribute("MODIFIED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "MODIFIED_DATE", "")));
                                objDeductionItem.setAttribute("CHANGED", true);
                                objDeductionItem.setAttribute("CHANGED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "CHANGED_DATE", "")));
                                objDeductionItem.setAttribute("CANCELLED", 0);
                                objDeductionItem.setAttribute("PO_NO", UtilFunctions.getString(rsDeduction, "PO_NO", ""));
                                objDeductionItem.setAttribute("PO_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "PO_DATE", "")));
                                objDeductionItem.setAttribute("INVOICE_NO", UtilFunctions.getString(rsDeduction, "INVOICE_NO", ""));
                                objDeductionItem.setAttribute("INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "INVOICE_DATE", "")));
                                objDeductionItem.setAttribute("VALUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "VALUE_DATE", "")));
                                objDeductionItem.setAttribute("GRN_NO", UtilFunctions.getString(rsDeduction, "GRN_NO", ""));
                                objDeductionItem.setAttribute("GRN_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "GRN_DATE", "")));
                                ...
                                objDeductionItem.setAttribute("MATCHED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "MATCHED_DATE", "")));
                                ...
                                objDeductionItem.setAttribute("HSN_SAC_CODE", UtilFunctions.getString(rsDeductionEntries, "HSN_SAC_CODE", ""));
                                objDeductionItem.setAttribute("ITEM_DESCRIPTION", UtilFunctions.getString(rsDeductionEntries, "ITEM_DESCRIPTION", ""));
                                objDeductionItem.setAttribute("GSTN_RATE", UtilFunctions.getString(rsDeductionEntries, "GSTN_RATE", ""));

                                objDeductionItem.setAttribute("GR_INVOICE_NO", UtilFunctions.getString(rsDeductionEntries, "GR_INVOICE_NO", ""));
                                objDeductionItem.setAttribute("GR_INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "GR_INVOICE_DATE", "")));
                                objDeductionItem.setAttribute("GR_NO", UtilFunctions.getString(rsDeductionEntries, "GR_NO", ""));
                                objDeductionItem.setAttribute("GR_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeductionEntries, "GR_DATE", "")));
                        ...
                        while (!rsTmp.isAfterLast()) {
                            ...
                            if (rsDeduction.getRow() > 0) {
                                while (!rsDeduction.isAfterLast()) {
                                    ...
                                    objDeductionItem.setAttribute("INVOICE_NO", UtilFunctions.getString(rsDeduction, "INVOICE_NO", ""));
                                    objDeductionItem.setAttribute("INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "INVOICE_DATE", "")));
                                    objDeductionItem.setAttribute("VALUE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsTmp, "VALUE_DATE", "")));
                                    objDeductionItem.setAttribute("GRN_NO", UtilFunctions.getString(rsDeduction, "GRN_NO", ""));
                                    objDeductionItem.setAttribute("GRN_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "GRN_DATE", "")));
                                    objDeductionItem.setAttribute("MODULE_ID", UtilFunctions.getInt(rsDeduction, "MODULE_ID", 0));
                                    objDeductionItem.setAttribute("INVOICE_AMOUNT", UtilFunctions.getDouble(rsDeduction, "INVOICE_AMOUNT", 0));
                                    ...
                                    objDeductionItem.setAttribute("HSN_SAC_CODE", UtilFunctions.getString(rsDeduction, "HSN_SAC_CODE", ""));
                                    objDeductionItem.setAttribute("ITEM_DESCRIPTION", UtilFunctions.getString(rsDeduction, "ITEM_DESCRIPTION", ""));
                                    objDeductionItem.setAttribute("GSTN_RATE", UtilFunctions.getString(rsDeduction, "GSTN_RATE", ""));

                                    objDeductionItem.setAttribute("GR_INVOICE_NO", UtilFunctions.getString(rsDeduction, "GR_INVOICE_NO", ""));
                                    objDeductionItem.setAttribute("GR_INVOICE_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "GR_INVOICE_DATE", "")));
                                    objDeductionItem.setAttribute("GR_NO", UtilFunctions.getString(rsDeduction, "GR_NO", ""));
                                    objDeductionItem.setAttribute("GR_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "GR_DATE", "")));
                            ...
                            if (rsDeduction.getRow() > 0) {
                                while (!rsDeduction.isAfterLast()) {
                                    ...
                                    objDeductionItem.setAttribute("DOC_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "DOC_DATE", "")));
                                    objDeductionItem.setAttribute("AMOUNT", UtilFunctions.getDouble(rsDeduction, "AMOUNT", 0));
                                    objDeductionItem.setAttribute("REMARKS", UtilFunctions.getString(rsDeduction, "REMARKS", ""));
                                    objDeductionItem.setAttribute("CREATED_BY", UtilFunctions.getString(rsDeduction, "CREATED_BY", ""));
                                    objDeductionItem.setAttribute("CREATED_DATE", EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsDeduction, "CREATED_DATE", "")));
    ...
    public static boolean CancelDoc(int CompanyID, String DocNo, int VoucherModuleID) {
        ...
        try {
            if (CanCancel(CompanyID, DocNo, VoucherModuleID)) {
                ...
                // added by gaurang on 07/12/2018
                if (VoucherModuleID == 89 || VoucherModuleID == 90) {
                    if (data.IsRecordExist("SELECT * FROM D_FIN_VOUCHER_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND VOUCHER_NO='" + DocNo + "' AND MODULE_ID=145", FinanceGlobal.FinURL)) {
                        String GRNNo = data.getStringValueFromDB("SELECT GRN_NO FROM D_FIN_VOUCHER_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND VOUCHER_NO='" + DocNo + "' AND MODULE_ID=145", FinanceGlobal.FinURL);
                        data.Execute("DELETE FROM DINESHMILLS.D_COM_DOC_DATA WHERE COMPANY_ID="+CompanyID+" AND DOC_NO='"+GRNNo+"' AND MODULE_ID=145");
                        data.Execute("UPDATE D_FD_SALES_DEPOSIT_REFUND_HEADER SET CANCELLED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE DOC_NO='"+GRNNo+"'",FinanceGlobal.FinURL);
                        
                        String SQL = "SELECT REFUND_DATE FROM D_FD_SALES_DEPOSIT_REFUND_HEADER WHERE DOC_NO='"+GRNNo+"' ";
                        String RefundDate = data.getStringValueFromDB(SQL,FinanceGlobal.FinURL);
                        ResultSet rsResult = data.getResult("SELECT * FROM D_FD_SALES_DEPOSIT_REFUND_DETAIL WHERE DOC_NO='"+GRNNo+"' ",FinanceGlobal.FinURL);
                        rsResult.first();
                        while(!rsResult.isAfterLast()) {
                            String ReceiptNo = rsResult.getString("RECEIPT_NO");
                            String PartyCode = data.getStringValueFromDB("SELECT PARTY_CODE FROM D_FD_SALES_DEPOSIT_REFUND_HEADER WHERE DOC_NO='"+GRNNo+"' ",FinanceGlobal.FinURL);
                            data.Execute("UPDATE D_FD_SALES_DEPOSIT_MASTER SET DEPOSIT_STATUS=0, REFUND_DATE='"+RefundDate+"' WHERE RECEIPT_NO='"+ReceiptNo+"' AND PARTY_CODE='"+PartyCode+"' ",FinanceGlobal.FinURL);
                            data.Execute("UPDATE D_FD_SALES_DEPOSIT_MASTER_H SET DEPOSIT_STATUS=0, REFUND_DATE='"+RefundDate+"' WHERE RECEIPT_NO='"+ReceiptNo+"' AND PARTY_CODE='"+PartyCode+"' ",FinanceGlobal.FinURL);
                            rsResult.next();
                        }
                    }
                }
    ...
    public boolean Validate(int EditMode) {
        try {
            System.out.println("Start of Validae");
            ...
            for (int i = 1; i <= colVoucherItems.size(); i++) {
                ...
                System.out.println("Start of Validae1");
                ...
                if (IsInternalPosting) {
                 ...
                 System.out.println("Start of Validae2");
                if (!IsInternalPosting) {
                ...
                if (!DoNotValidateAccounts) {
                   ...
                   System.out.println("Start of Validae3");
                ...
                System.out.println("Voucher datail doc size  "+objItem.colVoucherDetailDocs.size());
                for (int j = 1; j <= objItem.colVoucherDetailDocs.size(); j++) {
                ...
                //*****************************************************************************************//
               System.out.println("Start of Validae4");
                ...
                if (!PONo.trim().equals("")) {
                 ...
                 System.out.println("Start of Validae5");
                if (!GRNNo.trim().equals("")) {
                    ...
                    System.out.println("Start of Validae6");
                    ...
                    System.out.println("Start of Validae7");
                    ...
                    if (ModuleID == 35) //Service
                    {
                        //if (!data.IsRecordExist("SELECT MIR_NO FROM D_INV_MIR_HEADER WHERE MIR_NO='" + GRNNo + "' AND APPROVED=1 AND CANCELLED=0", CompanyURL)) {
                        if (!data.IsRecordExist("SELECT MIR_NO FROM DINESHMILLS.D_INV_MIR_HEADER WHERE MIR_NO='" + GRNNo + "' AND APPROVED=1 AND CANCELLED=0")) {                            
                            LastError = "Service No. " + GRNNo + " is not valid. Please check and correct it";
                            return false;
                        }
                    }
                }
            ...
            System.out.println("Start of Validae8");
            if (EITLERPGLOBAL.round(CrTotal, 2) != EITLERPGLOBAL.round(DrTotal, 2)) {
             ...
             System.out.println("Start of Validae9");
 ...
 if(bypass == 0) { 
            ...
            String CurrentEffect = "", PreviousEffect = "";
            System.out.println("Start of Validae10");
            HashMap sEntries = new HashMap();
             System.out.println("Start of Validae11");
            for (int i = 1; i <= colVoucherItems.size(); i++) {
                clsVoucherItem objItem = (clsVoucherItem) colVoucherItems.get(Integer.toString(i));
                CurrentEffect = objItem.getAttribute("EFFECT").getString();
                System.out.println("CurrentEffect   "+CurrentEffect);
                ...
                if (sEntries.size() == 0) {
                    ...
                    if (CurrentEffect.equals("C")) {
                        CrTotal += objItem.getAttribute("AMOUNT").getDouble();
                        System.out.println("Credit total12 "+CrTotal); 
                    System.out.println("Start of Validae12");
                    } else {
                        DrTotal += objItem.getAttribute("AMOUNT").getDouble();
                        System.out.println("debit total13 "+DrTotal); 
                        System.out.println("Start of Validae13");
                    }
                } else {
                    if (!CurrentEffect.equals(PreviousEffect)) {
                        if (CurrentEffect.equals("C")) {
                            ...
                            if (DrTotal != CurrentAmount) {
                             ...
                             System.out.println("Start of Validae14");
                            double CurrentAmount = EITLERPGLOBAL.round(objItem.getAttribute("AMOUNT").getDouble(), 2);
                            CrTotal = EITLERPGLOBAL.round(CrTotal, 2);
                            ...
                            if (CrTotal != CurrentAmount) {
                                ...
                                System.out.println("Start of Validae15");
                                sEntries.put(Integer.toString(sEntries.size() + 1), objItem);
                        ...
                        //STACK UP THE ENTRY
                        System.out.println("Start of Validae16");
                        sEntries.put(Integer.toString(sEntries.size() + 1), objItem);

                        if (objItem.getAttribute("EFFECT").getString().equals("C")) {
                            CrTotal += objItem.getAttribute("AMOUNT").getDouble();
                            System.out.println("Credit total16 "+CrTotal);
                        } else {
                            DrTotal += objItem.getAttribute("AMOUNT").getDouble();
                            System.out.println("Debit total16 "+DrTotal);
                        }
                    }
                }
                  System.out.println("Start of Validae17");
                PreviousEffect = objItem.getAttribute("EFFECT").getString();
                System.out.println("PreviousEffect  "+PreviousEffect);
            }
        ...
        try {
            ...
            if (DebitCount == CreditCount) {
                ...
                for (int i = 1; i <= List.size(); i++) {
                    ...
                    newItem.setAttribute("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                    newItem.setAttribute("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                    newItem.setAttribute("GSTN_RATE", objItem.getAttribute("LINK_NO").getString());

                    newItem.setAttribute("GR_INVOICE_NO", objItem.getAttribute("GR_INVOICE_NO").getString());
                    newItem.setAttribute("GR_INVOICE_DATE", objItem.getAttribute("GR_INVOICE_DATE").getString());
                    newItem.setAttribute("GR_NO", objItem.getAttribute("GR_NO").getString());
                    newItem.setAttribute("GR_DATE", objItem.getAttribute("GR_DATE").getString());
            ...
            if (CreditCount > DebitCount) {
                ...
                double drAmt214832=0 ,drAmt1_241162=0,drAmt2_241162=0;
                int count241162=0;
                ...
                for (int i = 1; i <= List.size(); i++) {
                    ...
                    if (objItem.getAttribute("EFFECT").getString().equals("D")) {
                        ...
                        //Start code for RC TDS
                        String mainCode=objDebitItem.getAttribute("MAIN_ACCOUNT_CODE").getString().trim();
                        if(mainCode.equals("214832")){
                            drAmt214832+=objDebitItem.getAttribute("AMOUNT").getDouble();
                        }
                                                
                        if(count241162==1 && mainCode.equals("241162")){
                            drAmt2_241162+=objDebitItem.getAttribute("AMOUNT").getDouble();
                        }                        
                        if(count241162==0 && mainCode.equals("241162")){
                            drAmt1_241162+=objDebitItem.getAttribute("AMOUNT").getDouble();
                            count241162++;
                        }
                        //End code for RC TDS
                    }
                ...
                for (int i = 1; i <= List.size(); i++) {
                    ...
                    if (objItem.getAttribute("EFFECT").getString().equals("C")) {
                        ...
                        if(clsVoucher.getVoucherType(getAttribute("VOUCHER_NO").getString())==FinanceGlobal.TYPE_RECEIPT_TDS){
                           if(Amount==drAmt1_241162){
                               newItem.setAttribute("MAIN_ACCOUNT_CODE", "241162");
                               newItem.setAttribute("SUB_ACCOUNT_CODE", objItem.getAttribute("SUB_ACCOUNT_CODE").getString().trim());
                           } else if(Amount==drAmt2_241162){
                               newItem.setAttribute("MAIN_ACCOUNT_CODE", "241162");
                               newItem.setAttribute("SUB_ACCOUNT_CODE", objItem.getAttribute("SUB_ACCOUNT_CODE").getString().trim());
                           } else{
                               newItem.setAttribute("MAIN_ACCOUNT_CODE", "214832");
                               newItem.setAttribute("SUB_ACCOUNT_CODE", "");       
                           }
    ...
    private boolean ValidateBlock(HashMap List) {
        try {
            ...
            if (VoucherType == FinanceGlobal.TYPE_SALES_JOURNAL || VoucherType == FinanceGlobal.TYPE_RECEIPT || VoucherType == FinanceGlobal.TYPE_RECEIPT_TDS) {
                ...
                for (int i = 1; i <= List.size(); i++) {
                    ...
                    if (!InvoiceNo.trim().equals("")) {
                        ...
                        if (!BookCode.trim().equals("10") && (MainCode.equals("210027") || MainCode.equals("210072"))) {// ||!( || MainCode.equals("210072") || MainCode.equals("210010")) )) {// || MainCode.equals("210010")
                    ...
                    if (Effect.equals("D")) {
                        ...
                        if (ModuleID == 5) {
                            if (!clsMIRGen.IsMIRExistEx(GRNNo, CompanyURL, 1)) {
                                ...
                                System.out.println("MIR Amount : " + MIRAmount);
                                ...
                                VoucherAmountPaid = EITLERPGLOBAL.round(VoucherAmountPaid, 0);
                                System.out.println("VoucherAmountPaid : " + VoucherAmountPaid);     
                                System.out.println(VoucherAmountPaid);
            ...
            if (VoucherType == FinanceGlobal.TYPE_RECEIPT || VoucherType == FinanceGlobal.TYPE_CREDIT_NOTE || VoucherType == FinanceGlobal.TYPE_RECEIPT_TDS) {
    ...
    public static void OpenVoucher(String VoucherNo, frmPendingApprovals objPendingApproval) {
        try {
            ...
            if (VoucherType == 12) {
                aFrame.startAppletEx("EITLERP.Finance.frmReceiptVoucher2", "Receipt Voucher (2)");
                frmReceiptVoucher2 ObjItem = (frmReceiptVoucher2) aFrame.ObjApplet;
                ObjItem.frmPA = objPendingApproval;
                ObjItem.FindEx(CompanyID, VoucherNo);
            }
        } catch (Exception e) {
    ...
    public boolean UpdateForAdjustment() {
        ...
        try {
            ...
            for (int i = 1; i <= colVoucherItems.size(); i++) {
                ...
                rsTmp.updateString("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                rsTmp.updateString("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                rsTmp.updateString("GSTN_RATE", objItem.getAttribute("GSTN_RATE").getString());
                ...
                if (!getAttribute("VOUCHER_NO").getString().startsWith("M")) { // new line by vivek on 26/02/2014 for migrated voucher
                    ...
                    rsHDetail.updateString("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                    rsHDetail.updateString("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                    rsHDetail.updateString("GSTN_RATE", objItem.getAttribute("GSTN_RATE").getString());
            ...
            if ((VoucherType != FinanceGlobal.TYPE_JOURNAL) && (VoucherType != FinanceGlobal.TYPE_SALES_JOURNAL) && (VoucherType != FinanceGlobal.TYPE_CREDIT_NOTE)) {
                ...
                if(VoucherType != FinanceGlobal.TYPE_RECEIPT_TDS){   //line added for RC TDS
                for (int i = 1; i <= colVoucherItems.size(); i++) {
                    clsVoucherItem objItem = (clsVoucherItem) colVoucherItems.get(Integer.toString(i));
                    CurrentEffect = objItem.getAttribute("EFFECT").getString();
            ...
            }else{  //line added for RC TDS 
                    //Start code added for RC TDS
                    for (int i = 1; i <= colVoucherItems.size(); i++) {
                    clsVoucherItem objItem = (clsVoucherItem) colVoucherItems.get(Integer.toString(i));
                    CurrentEffect = objItem.getAttribute("EFFECT").getString();
                ...
                for (int i = 1; i <= colVoucherItemsEx.size(); i++) {
                    ...
                    rsTmpEx.updateString("HSN_SAC_CODE", objItem.getAttribute("HSN_SAC_CODE").getString());
                    rsTmpEx.updateString("ITEM_DESCRIPTION", objItem.getAttribute("ITEM_DESCRIPTION").getString());
                    rsTmpEx.updateString("GSTN_RATE", objItem.getAttribute("GSTN_RATE").getString());
        ...
        try {
            ...
            if (rsVoucher.getRow() > 0) {
                while (!rsVoucher.isAfterLast()) {
                    ...
                    if (data.getIntValueFromDB("SELECT VOUCHER_TYPE FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO='" + VoucherNo + "' ", FinanceGlobal.FinURL) == FinanceGlobal.TYPE_RECEIPT_TDS) {
                        BankMainCode = data.getStringValueFromDB("SELECT MAIN_ACCOUNT_CODE FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO='" + VoucherNo + "' AND EFFECT='D'", FinanceGlobal.FinURL);
                    }
    ...
    private void generateNextLegacyNo(String cVoucherNo) {
        ...
        if(cBookCode==33 || cBookCode==76){
        if(cVoucherType == 9 && cVoucherNo.startsWith("PY")){
            cVoucherType = 2;
        }
        }
        ...
        System.out.println(sVoucherType);
        System.out.println(cVoucherType);
        String Condition = "";
        ...
        if (cVoucherType == FinanceGlobal.TYPE_CASH_VOUCHER) {
            strSQL = "SELECT MAX(CONVERT(LEGACY_NO,UNSIGNED)) AS NEXT_LEGACY_NO FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND VOUCHER_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' "
                    + "AND BOOK_CODE=" + cBookCode + " AND VOUCHER_TYPE IN (" + sVoucherType + ")  " + Condition;
        } else {
            if(cBookCode==31 || cBookCode==36 || cBookCode==58 || cBookCode==54 || cBookCode==37 || cBookCode==33 ){
               strSQL = "SELECT MAX(CONVERT(LEGACY_NO,UNSIGNED)) AS NEXT_LEGACY_NO FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND VOUCHER_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' "
                    + "AND BOOK_CODE=" + cBookCode + " AND SUBSTRING(VOUCHER_NO,3,2)='" + FinRef + "' " + Condition; 
            }else{
            strSQL = "SELECT MAX(CONVERT(LEGACY_NO,UNSIGNED)) AS NEXT_LEGACY_NO FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND VOUCHER_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' "
        ...
        System.out.println(nextLegacyNo);
                    ...
                    //    if (InvoiceType == 2 && (PartyCode.equals("812081") || PartyCode.equals("813003") || PartyCode.equals("828001") || PartyCode.equals("828003"))) {
                     ...
                     //   if(InvoiceType==2 && ChargeCode.equals("82")){
                        ...
                        while (!rsVoucher.isAfterLast()) {
                            ...
                            String ValueDate = UtilFunctions.getString(rsVoucher, "VALUE_DATE", "");
                           ...
                           // VoucherDebitNoteAmount = EITLERPGLOBAL.round(((VoucherAmount * InterestPercentage * InterestDays) / (365 * 100)), 2);
                            InterestDNAmount = EITLERPGLOBAL.round(((VoucherAmount * InterestPercentage * InterestDays) / (365 * 100)), 0);
                             ...
                             CGST_AMT =  EITLERPGLOBAL.round((InterestDNAmount * (CGST_PER/100)),0);
                 ...
                 //       if (InvoiceType == 2 && (PartyCode.equals("812081") || PartyCode.equals("813003") || PartyCode.equals("828001") || PartyCode.equals("828003"))) {
                     ...
                     //   if(InvoiceType==2 && ChargeCode.equals("82")){
                        ...
                        if (IGST_PER  != 0) {
                           ...
                           ObjtempItem.setAttribute("INVOICE_AMOUNT", InvoiceAmount);
                           ObjtempItem.setAttribute("DEBITNOTE_VOUCHER_NO", "");
                           ObjtempItem.setAttribute("DEBITMEMO_TYPE", "AUTO");
    ...
    public static int ValidateVoucherEntry(int EditMode, String VoucherDate) {
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (Integer.parseInt(VoucherDate.substring(5, 7)) == data.getIntValueFromDB("SELECT MONTH(CURDATE()) FROM DUAL")) {
                ...
                //if (EITLERPGLOBAL.getCurrentDay() <= 14) {  //changes done as per request by Mr Apurava Shah date as on 13/05/2020
                    if (EITLERPGLOBAL.getCurrentDay() <= 9) {  //changes done as per request by Mr Apurava Shah date as on 10/09/2020
                    if (Integer.parseInt(VoucherDate.substring(5, 7)) == data.getIntValueFromDB("SELECT MONTH(DATE_SUB(CURDATE(),INTERVAL 1 MONTH))  FROM DUAL")) {
                        //return 0;
                    } else {
        ...
        try {
            ...
            if (pModuleID == clsGRNGen.ModuleID) {
                ...
                for (int i = 1; i <= objGRN.colGRNItems.size(); i++) {
                    ...
                    ObjFASCard.setAttribute("DISPOSED_DATE", "");
                    ...
                    for (int j = 1; j <= Qty; j++) {
                        ...
                        ObjCardDetail.setAttribute("SALE_DATE", "");
            ...
            //                rsResultSet.updateString("PO_DATE","");
            ...
            //                rsResultSet.updateString("DISPOSED_DATE","");
            //                rsResultSet.updateString("SIZE_CAPACITY","");
            //                rsResultSet.updateString("INSTALLATION_DATE","");
            //
...
public static void PostDebitNoteFeltV2(String currentVoucherNo) {
        ...
        //        + "AND EFFECT='C' AND SUB_ACCOUNT_CODE<>'' AND INVOICE_NO<>'' AND MAIN_ACCOUNT_CODE IN ('210010') ORDER BY MAIN_ACCOUNT_CODE,SUB_ACCOUNT_CODE";
        String strSQL = "SELECT DISTINCT SUB_ACCOUNT_CODE,MAIN_ACCOUNT_CODE FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO='" + currentVoucherNo + "' "
                + "AND EFFECT='C' AND SUB_ACCOUNT_CODE<>'' AND INVOICE_NO<>'' AND MAIN_ACCOUNT_CODE IN ('210010') AND SUBSTRING(GRN_NO,1,2)<>'DN' ORDER BY MAIN_ACCOUNT_CODE,SUB_ACCOUNT_CODE";
...
//                    ObjRefItem.colMappingDetail.clear();
                    ...
                    while (!rsInvoice.isAfterLast()) {
                        ...
                        while (!rsDR_ADJ_DETAIL.isAfterLast()) {
                            ...
                            ObjtempItem.setAttribute("DEBITNOTE_VOUCHER_NO", "");
                            ObjtempItem.setAttribute("DEBITNOTE_VOUCHER_DATE", "");
                            //ObjtempItem.setAttribute("DEBITNOTE_VOUCHER_NO", currentVoucherNo);
                            //ObjtempItem.setAttribute("DEBITNOTE_VOUCHER_DATE", CurrentVoucherDate);
                   ...
                   // double diff1 = 0.00;
                        ...
                        if (EITLERPGLOBAL.round(PartyDebitNoteAmount, 0) > 5) {
                            ...
                            for (int i = 1; i <= ObjRefItem.colMappingDetail.size(); i++) {
                                ...
                                rsTmp1.updateString("DEBITNOTE_VOUCHER_NO", "");
                                rsTmp1.updateString("DEBITNOTE_VOUCHER_DATE", "");
                                //rsTmp1.updateString("DEBITNOTE_VOUCHER_NO", currentVoucherNo);
                                //rsTmp1.updateString("DEBITNOTE_VOUCHER_DATE", CurrentVoucherDate);
                                rsTmp1.updateString("DEBITMEMO_TYPE", "AUTO");
                                ...
                                String Msg = "Debit Memo No : " + DebitMemoNo + " posted for party code " + PartyCode + " and invoice no " + ObjItem.getAttribute("INVOICE_NO").getString() + " of Rs." + ObjItem.getAttribute("DEBIT_NOTE_AMOUNT").getDouble();
                                JOptionPane.showMessageDialog(null, Msg);
                            }
                        } else {
                            if (clsSalesInvoice.canDebitNotePost(InvoiceType, ChargeCode)) {
    ...
    public static void PostDebitNoteSuitingsV2(String currentVoucherNo) {
        ...
        //        + "AND EFFECT='C' AND SUB_ACCOUNT_CODE<>'' AND INVOICE_NO<>'' AND MAIN_ACCOUNT_CODE IN ('210027') ORDER BY MAIN_ACCOUNT_CODE,SUB_ACCOUNT_CODE";
         ...
         String strSQL = "SELECT DISTINCT SUB_ACCOUNT_CODE,MAIN_ACCOUNT_CODE FROM D_FIN_VOUCHER_DETAIL WHERE VOUCHER_NO='" + currentVoucherNo + "' "
                + "AND EFFECT='C' AND SUB_ACCOUNT_CODE<>'' AND INVOICE_NO<>'' AND MAIN_ACCOUNT_CODE IN ('210027') AND SUBSTRING(GRN_NO,1,2)<>'DN' ORDER BY MAIN_ACCOUNT_CODE,SUB_ACCOUNT_CODE";
        System.out.println("strSQL 1 : " + strSQL);
...
//                    ObjRefItem.colMappingDetail.clear();
                ...
                //setAttribute("DEBITMEMO_NO", DebitMemoNo);
                            ...
                            for (int i = 1; i <= ObjRefItem.colMappingDetail.size(); i++) {
                                ...
                                rsTmp1.updateDouble("INTEREST_AMT", ObjItem.getAttribute("INTEREST_AMT").getDouble());
                                rsTmp1.updateDouble("INVOICE_AMOUNT", ObjItem.getAttribute("INVOICE_AMOUNT").getDouble());
                                rsTmp1.updateString("DEBITNOTE_VOUCHER_NO", "");//ObjtempItem.setAttribute("DEBITNOTE_VOUCHER_NO", currentVoucherNo);
                                rsTmp1.updateString("DEBITNOTE_VOUCHER_DATE", "");
                                //rsTmp1.updateString("DEBITNOTE_VOUCHER_NO", currentVoucherNo);
                                //rsTmp1.updateString("DEBITNOTE_VOUCHER_DATE", CurrentVoucherDate);
                                rsTmp1.updateString("DEBITMEMO_TYPE", "AUTO");
    ...
    public static void PostTCSDebitNoteFelt(String currentVoucherNo) {
        ...
        clsDebitNoteReceiptMapping ObjRefItem = null;
        String CurrentVoucherDate = data.getStringValueFromDB("SELECT VOUCHER_DATE FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO='" + currentVoucherNo + "' ", FinanceGlobal.FinURL);
        String strSQL = "SELECT SUB_ACCOUNT_CODE,MAIN_ACCOUNT_CODE,V.INVOICE_NO,V.INVOICE_DATE,INVOICE_AMOUNT FROM FINANCE.D_FIN_VOUCHER_DETAIL V,PRODUCTION.FELT_SAL_INVOICE_HEADER I "
                + "WHERE V.INVOICE_NO=I.INVOICE_NO AND V.INVOICE_DATE=I.INVOICE_DATE AND V.SUB_ACCOUNT_CODE=I.PARTY_CODE AND I.TCS_AMT=0 "
                + "AND V.VOUCHER_NO='" + currentVoucherNo + "' AND V.EFFECT='C' AND V.SUB_ACCOUNT_CODE<>'' AND V.INVOICE_NO<>'' "
                + "AND V.MAIN_ACCOUNT_CODE IN ('210010') AND SUBSTRING(V.GRN_NO,1,2)<>'DN' "
                + "AND CONCAT(V.INVOICE_NO,V.INVOICE_DATE) NOT IN (SELECT CONCAT(INVOICE_NO,INVOICE_DATE) FROM FINANCE.D_FIN_DEBITNOTE_RECEIPT_MAPPING WHERE TCS_AMT>0) "
        ...
        try {
            ...
            if (rsParty.getRow() > 0) {
                while (!rsParty.isAfterLast()) {
                    ...
                    Invoice_Amt = UtilFunctions.getDouble(rsParty, "INVOICE_AMOUNT", 0);
...
//                        ObjVoucher.setAttribute("VOUCHER_DATE", EITLERPGLOBAL.formatDate(CurrentVoucherDate));
    ...
    public boolean getReceipt2Representation() {
        ResultSet rsTmp;
        ResultSet rsDeduction;
        Connection tmpConn;
        Statement tmpStmt;
        ...
        try {
            ...
            if (rsInvoices.getRow() > 0) {
                while (!rsInvoices.isAfterLast()) {
                    ...
                    //Find Additions i.e. Bank Charges etc.
                    rsTmp = data.getResult("SELECT * FROM D_FIN_VOUCHER_DETAIL WHERE COMPANY_ID=" + CompanyID + " AND VOUCHER_NO='" + VoucherNo + "' AND SR_NO=" + strSrNo + " AND EFFECT='C' AND MAIN_ACCOUNT_CODE<>'' AND IS_DEDUCTION=2 ", FinanceGlobal.FinURL);
                    rsTmp.first();
