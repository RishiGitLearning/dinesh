...
public class frmCreditorsCrToDr extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblAdjustedCredit = new javax.swing.JLabel();
        ...
        lblFromDate.setBounds(10, 98, 80, 15);

        lblToDate.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblToDate.setText("To Date :");
        panelParty.add(lblToDate);
        lblToDate.setBounds(210, 98, 70, 15);

        panelParty.add(txtFromDate);
        txtFromDate.setBounds(95, 95, 100, 19);

        panelParty.add(txtToDate);
        txtToDate.setBounds(285, 95, 100, 19);

        lblPoNo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblPoNo.setText("PO No.:");
        panelParty.add(lblPoNo);
        lblPoNo.setBounds(10, 122, 80, 15);

        panelParty.add(txtPoNo);
        txtPoNo.setBounds(95, 120, 100, 19);
        ...
        panelPJV.add(jScrollPane2);
        jScrollPane2.setBounds(9, 37, 620, 340);
        ...
        Tab.addTab("Select PJV", panelPJV);
        ...
        panelPayment.add(jScrollPane1);
        jScrollPane1.setBounds(9, 37, 620, 160);

        jLabel2.setText("Add PY. Voucher(s) to below adjustment table and press OK when finished :");
        ...
        lblCreditAmountInfo.setText("Credit Amount :");
        panelPayment.add(lblCreditAmountInfo);
        lblCreditAmountInfo.setBounds(10, 225, 100, 15);

        lblCreditVoucher.setText("...");
        lblCreditVoucher.setBorder(new javax.swing.border.EtchedBorder());
        panelPayment.add(lblCreditVoucher);
        ...
        lblAdjustedCredit.setText("...");
        lblAdjustedCredit.setBorder(new javax.swing.border.EtchedBorder());
        panelPayment.add(lblAdjustedCredit);
        lblAdjustedCredit.setBounds(420, 200, 115, 19);
        ...
        Tab.addTab("Advance Payment Vouchers", panelPayment);
    ...
    private void cmdRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRemoveActionPerformed
        ...
        double RemainingAmount = Double.parseDouble(DataModelPJV.getValueByVariable("REMAINING_AMOUNT", TablePJV.getSelectedRow()));
        double UtilizedAmount = Double.parseDouble(DataModelPJV.getValueByVariable("UTILIZED_AMOUNT", TablePJV.getSelectedRow()));
        RemainingAmount = RemainingAmount - UtilizedAmount;
        double AdjustedCredit = Math.abs(RemainingAmount - CreditAmount);
        ...
        POInvoiceAmount = CreditAmount - AdjustedCredit - TableEnterAmount;
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        if(TablePY.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(this,"Please select payment voucher.");
            return;
        }
        String SelectedPY = DataModelPY.getValueByVariable("VOUCHER_NO",TablePY.getSelectedRow());
        for(int i=0;i<TableAdj.getRowCount();i++) {
            if(DataModelAdj.getValueByVariable("VOUCHER_NO",i).equals(SelectedPY)) {
                JOptionPane.showMessageDialog(this,SelectedPY + " is already used at sr no. " + (i+1));
                return;
            }
        }
        ...
        try {
            if(Double.parseDouble(lblRemainingAmount.getText().trim()) > 0) {
                double AdjAmount = 0;
                double insertAmount = Double.parseDouble(DataModelPY.getValueByVariable("AMOUNT",TablePY.getSelectedRow())) - Double.parseDouble(DataModelPY.getValueByVariable("UTILIZED_AMOUNT",TablePY.getSelectedRow()));
...
//            aFrame.startAppletEx("EITLERP.Finance.frmVoucher","Voucher Entry");
...
//            ObjDoc.FindEx(CompanyID,DocNo);
    ...
    private void cmdNext2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNext2ActionPerformed
        ...
        try {
            ...
            FormatGridPayment();
            FormatGridAdj();
            SelectedPJV = DataModelPJV.getValueByVariable("PJV_NO", TablePJV.getSelectedRow());
            SelectedPONo = DataModelPJV.getValueByVariable("PO_NO", TablePJV.getSelectedRow());
            SelectedInvoiceNo = DataModelPJV.getValueByVariable("INVOICE_NO", TablePJV.getSelectedRow());
            String Msg = "You have selected PJV No.(" + SelectedPJV + ") , PO No. ("+SelectedPONo+") and Invoice No. ("+SelectedInvoiceNo+") \n Are you sure ?";
            if(JOptionPane.showConfirmDialog(this,Msg,"Conform PJV, PO and Invoice",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE)==0) {
                GenerateGridPayment();
                Tab.setSelectedIndex(2);
                Tab.setEnabledAt(0, false);
                Tab.setEnabledAt(1, false);
                Tab.setEnabledAt(2, true);
                lblCreditVoucher.setText(SelectedPJV);
                lblCreditAmount.setText(DataModelPJV.getValueByVariable("AMOUNT", TablePJV.getSelectedRow()));
                double CreditAmount = Double.parseDouble(DataModelPJV.getValueByVariable("AMOUNT", TablePJV.getSelectedRow()));
                double RemainingAmount = Double.parseDouble(DataModelPJV.getValueByVariable("REMAINING_AMOUNT", TablePJV.getSelectedRow()));
                double UtilizedAmount = Double.parseDouble(DataModelPJV.getValueByVariable("UTILIZED_AMOUNT", TablePJV.getSelectedRow()));
                RemainingAmount = Math.abs(RemainingAmount - UtilizedAmount);
                double AdjustedCredit = Math.abs(CreditAmount - RemainingAmount);
                lblAdjustedCredit.setText(Double.toString(AdjustedCredit));
    ...
    private javax.swing.JLabel lblAdjustedCredit;
                ...
                public void tableChanged(TableModelEvent e) {
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        if(col==DataModelAdj.getColFromVariable("ADJ_AMOUNT")) {
                            ...
                            for(int i=0;i<TableAdj.getRowCount();i++) {
                                if(DataModelAdj.getValueByVariable("ADJ_AMOUNT", i).trim().equals("")) {
                                    DataModelAdj.setValueByVariable("ADJ_AMOUNT","0.00" ,i);
                                } 
                            ...
                            for(int j=0;j<TablePY.getRowCount();j++) {
                                if(DataModelAdj.getValueByVariable("VOUCHER_NO", TableAdj.getSelectedRow()).trim().equals(DataModelPY.getValueByVariable("VOUCHER_NO", j))) {
                                    RemainingAmount = Double.parseDouble(DataModelPY.getValueByVariable("AMOUNT", j));
                                    double UtilizedAmount = Double.parseDouble(DataModelPY.getValueByVariable("UTILIZED_AMOUNT", j));
                                    RemainingAmount = RemainingAmount - UtilizedAmount;
                                }
                            }
                            if(Double.parseDouble(DataModelAdj.getValueByVariable("ADJ_AMOUNT", TableAdj.getSelectedRow()).trim()) > RemainingAmount) {
                                ...
                                DataModelAdj.setValueByVariable("ADJ_AMOUNT","0.00", TableAdj.getSelectedRow());
                            }
                        }
                        ...
                        if(col==DataModelAdj.getColFromVariable("ADJ_AMOUNT")) {
                            ...
                            POInvoiceAmount = CreditAmount - EnterAmount - TableEnterAmount;
                            if(POInvoiceAmount < 0) {
                                JOptionPane.showMessageDialog(null,"Adjustment amount exceeding remaining credit amount.","Wrong Input",JOptionPane.ERROR_MESSAGE);
                                DataModelAdj.setValueByVariable("ADJ_AMOUNT","0.00", TableAdj.getSelectedRow());
                            } else {
                                lblRemainingAmount.setText(Double.toString(EITLERPGLOBAL.round(POInvoiceAmount,2)));
                            }
    ...
    private boolean Validate() {
        try {
            if(TableAdj.getRowCount()<=0) {
                JOptionPane.showMessageDialog(null,"Please insert atleast one record at adjustment table.");
                return false;
            }
            ...
            double POInvoiceAmount = 0;
            double CreditAmount = Double.parseDouble(lblCreditAmount.getText().trim());
            double RemainingAmount = Double.parseDouble(DataModelPJV.getValueByVariable("REMAINING_AMOUNT", TablePJV.getSelectedRow()));
            double UtilizedAmount = Double.parseDouble(DataModelPJV.getValueByVariable("UTILIZED_AMOUNT", TablePJV.getSelectedRow()));
            RemainingAmount = RemainingAmount - UtilizedAmount;
            double AdjustedCredit = Math.abs(CreditAmount - RemainingAmount);
    ...
    private void UpdateTotal() {
        ...
        if(POInvoiceAmount < 0) {
            JOptionPane.showMessageDialog(null,"Adjustment amount exceeding remaining credit amount.","Wrong Input",JOptionPane.ERROR_MESSAGE);
            DataModelAdj.setValueByVariable("ADJ_AMOUNT","0.00", TableAdj.getRowCount());
        } else {
            lblRemainingAmount.setText(Double.toString(EITLERPGLOBAL.round(POInvoiceAmount,2)));
        }
    }
