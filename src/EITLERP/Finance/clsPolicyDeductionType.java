...
public class clsPolicyDeductionType{
    ...
    public clsPolicyDeductionType() {
        LastError = "";
        props=new HashMap();
        
        props.put("COMPANY_ID",new Variant(EITLERPGLOBAL.gCompanyID));
        props.put("SR_NO",new Variant(0));
        props.put("DEDECTION_TYPE_ID",new Variant(""));
        props.put("DEDUCTION_TYPE_DESC",new Variant(""));
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            rsResultSet=Stmt.executeQuery("SELECT * FROM D_SAL_POLICY_DEDUCTION_TYPE WHERE COMPANY_ID = '"+ pCompanyID +"' ORDER BY SR_NO");
            HistoryView=false;
            Ready=true;
            MoveLast();
            return true;
    ...
    public static HashMap getList(String pCondition) {
        ...
        try {
            ...
            rsTmp=data.getResult("SELECT * FROM D_SAL_POLICY_DEDUCTION_TYPE "+pCondition+" ORDER BY SR_NO ");
            rsTmp.first();
            Counter=0;
            while(!rsTmp.isAfterLast()) {
                Counter=Counter+1;
                clsPolicyDeductionType ObjTypeMaster=new clsPolicyDeductionType();
                
                //Populate the user
                ObjTypeMaster.setAttribute("DEDUCTION_TYPE_ID",rsTmp.getString("DEDUCTION_TYPE_ID"));
                ObjTypeMaster.setAttribute("DEDUCTION_TYPE_DESC",rsTmp.getString("DEDUCTION_TYPE_DESC"));
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("DEDUCTION_TYPE_ID",UtilFunctions.getString(rsResultSet,"DEDUCTION_TYPE_ID", ""));
            setAttribute("DEDUCTION_TYPE_DESC",UtilFunctions.getString(rsResultSet,"DEDUCTION_TYPE_DESC", ""));
