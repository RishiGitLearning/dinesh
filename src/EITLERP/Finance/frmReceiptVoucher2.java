...
public class frmReceiptVoucher2 extends javax.swing.JApplet {
    ...
    public static String OldRCVoucherNo= "";
    
    private EITLComboModel cmbHierarchyModel;
    private EITLComboModel cmbToModel;
    private EITLComboModel cmbModuleModel;
    private EITLComboModel cmbPaymentModeModel;
    ...
    public void init() {
        ...
        if(getName().equals("Link")) {
            ...
            objVoucher.VoucherType=FinanceGlobal.TYPE_RECEIPT_TDS;
    ...
    private void initComponents() {
        ...
        mnuSelectOBC = new javax.swing.JMenuItem();
        mnuSelectExportSJ = new javax.swing.JMenuItem();
        mnuSelectDebitNote = new javax.swing.JMenuItem();
        mnuSelectRetailShopSJ = new javax.swing.JMenuItem();
        mnuShow = new javax.swing.JPopupMenu();
        mnuShowInvoice = new javax.swing.JMenuItem();
        mnuShowExportSJ = new javax.swing.JMenuItem();
        mnuShowDebitNote = new javax.swing.JMenuItem();
        mnuShowOBC = new javax.swing.JMenuItem();
        ...
        txtCustomerBank = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        lblRelizationDate = new javax.swing.JLabel();
        ...
        mnuSelectOBC.setLabel("Select OBC Entry");
        mnuSelectOBC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuSelectOBCActionPerformed(evt);
            }
        });
        mnuSelect.add(mnuSelectOBC);

        mnuSelectExportSJ.setLabel("Select Export SJ");
        mnuSelectExportSJ.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuSelectExportSJActionPerformed(evt);
            }
        });
        mnuSelect.add(mnuSelectExportSJ);
        ...
        mnuSelectRetailShopSJ.setText("Select Retail Shop SJ");
        mnuSelectRetailShopSJ.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuSelectRetailShopSJActionPerformed(evt);
            }
        });
        mnuSelect.add(mnuSelectRetailShopSJ);
        ...
        mnuShowExportSJ.setText("Show SJ");
        mnuShowExportSJ.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuShowExportSJActionPerformed(evt);
            }
        });
        mnuShow.add(mnuShowExportSJ);

        mnuShowDebitNote.setText("Show Debit Note");
        mnuShowDebitNote.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuShowDebitNoteActionPerformed(evt);
            }
        });
        mnuShow.add(mnuShowDebitNote);

        mnuShowOBC.setActionCommand("Show OBC");
        mnuShowOBC.setLabel("Show OBC");
        mnuShowOBC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuShowOBCActionPerformed(evt);
            }
        });
        mnuShow.add(mnuShowOBC);
        ...
        lblTitle.setText(" RECEIPT VOUCHER 2 - TDS");
        ...
        Tab1.add(txtDocNo);
        txtDocNo.setBounds(113, 14, 160, 19);

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Date :");
        Tab1.add(jLabel3);
        jLabel3.setBounds(364, 16, 39, 15);
        ...
        jScrollPane4.setBounds(8, 434, 630, 50);
        ...
        jLabel11.setBounds(6, 6, 105, 15);

        txtBankCode.setEnabled(false);
        txtBankCode.setName("REQ_DATE"); // NOI18N
        ...
        txtBankCode.setBounds(115, 6, 102, 19);

        txtBankName.setName("REMARKS"); // NOI18N
        txtBankName.setEnabled(false);
        jPanel4.add(txtBankName);
        txtBankName.setBounds(256, 6, 366, 19);

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Cheque No. :");
        jPanel4.add(jLabel5);
        jLabel5.setBounds(7, 32, 105, 15);

        txtChequeNo.setName("REQ_DATE"); // NOI18N
        txtChequeNo.setEnabled(false);
        jPanel4.add(txtChequeNo);
        txtChequeNo.setBounds(115, 34, 102, 19);

        txtChequeDate.setName("REQ_DATE"); // NOI18N
        txtChequeDate.setEnabled(false);
        jPanel4.add(txtChequeDate);
        txtChequeDate.setBounds(261, 33, 101, 19);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Date :");
        jPanel4.add(jLabel6);
        jLabel6.setBounds(219, 36, 40, 15);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Payment Mode :");
        jPanel4.add(jLabel12);
        jLabel12.setBounds(365, 35, 102, 15);

        cmbPaymentMode.setEnabled(false);
        jPanel4.add(cmbPaymentMode);
        cmbPaymentMode.setBounds(471, 32, 154, 20);

        chkAutoAdj.setText("Do not include this voucher in auto-adjustment");
        chkAutoAdj.setEnabled(false);
        jPanel4.add(chkAutoAdj);
        chkAutoAdj.setBounds(6, 81, 360, 21);

        txtCustomerBank.setName("REQ_DATE"); // NOI18N
        txtCustomerBank.setEnabled(false);
        jPanel4.add(txtCustomerBank);
        txtCustomerBank.setBounds(115, 57, 507, 19);

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Customer Bank :");
        jPanel4.add(jLabel8);
        jLabel8.setBounds(7, 60, 105, 15);

        lblRelizationDate.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblRelizationDate.setText("Realization Date :");
        jPanel4.add(lblRelizationDate);
        lblRelizationDate.setBounds(370, 80, 130, 20);

        txtRealizationDate.setEnabled(false);
        txtRealizationDate.setName("REQ_DATE"); // NOI18N
        jPanel4.add(txtRealizationDate);
        txtRealizationDate.setBounds(501, 84, 120, 19);

        Tab1.add(jPanel4);
        jPanel4.setBounds(9, 88, 630, 109);
        ...
        jScrollPane1.setBounds(5, 9, 610, 140);
        ...
        cmdRemove.setBounds(115, 156, 86, 20);

        jLabel7.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        jLabel7.setText("NetAmount :");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(429, 155, 80, 15);

        txtNetAmount.setEnabled(false);
        txtNetAmount.setName("REQ_DATE"); // NOI18N
        jPanel2.add(txtNetAmount);
        txtNetAmount.setBounds(513, 153, 102, 19);

        cmdAddBlank.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        ...
        cmdAddBlank.setBounds(8, 156, 100, 20);
        ...
        cmdSelect.setBounds(208, 156, 100, 20);
        ...
        jPanel2.add(cmdShow);
        cmdShow.setBounds(315, 155, 100, 20);

        jTabbedPane1.addTab("Receipt Information", jPanel2);

        Tab1.add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 204, 630, 210);
        ...
        Tab1.add(jLabel14);
        jLabel14.setBounds(225, 64, 40, 15);
        ...
        txtLegacyDate.setBounds(267, 61, 102, 19);

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel15.setText("Link No. :");
        Tab1.add(jLabel15);
        jLabel15.setBounds(371, 63, 80, 15);

        txtLinkNo.setName("REQ_DATE"); // NOI18N
        txtLinkNo.setEnabled(false);
        Tab1.add(txtLinkNo);
        txtLinkNo.setBounds(457, 61, 102, 19);
        ...
        Tab2.add(cmdBack2);
        cmdBack2.setBounds(528, 439, 102, 25);
        ...
        cmdFromRemarksBig.setBounds(573, 77, 33, 21);
        ...
        Tab.setBounds(2, 66, 654, 514);

        lblStatus.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblStatus.setForeground(new java.awt.Color(51, 51, 255));
        lblStatus.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(lblStatus);
        lblStatus.setBounds(5, 582, 650, 22);
    ...
    private void mnuShowAdvAmountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuShowAdvAmountActionPerformed
        ...
        try {
            ...
            String SubCode=DataModel.getValueByVariable("PARTY_CODE", Table.getSelectedRow());
    ...
    private void txtDocDateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDocDateFocusLost
        // TODO add your handling code here:
        txtRealizationDate.setText(txtDocDate.getText().trim());
    }//GEN-LAST:event_txtDocDateFocusLost
    
    private void mnuShowOBCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuShowOBCActionPerformed
        // TODO add your handling code here:
        try {
            String DocNo=DataModel.getValueByVariable("REF_DOC_NO", Table.getSelectedRow());
            String DocDate=DataModel.getValueByVariable("REF_DOC_DATE", Table.getSelectedRow());
            AppletFrame aFrame=new AppletFrame("Outward bank Collection");
            aFrame.startAppletEx("EITLERP.Finance.frmOBC","Outward bank Collection");
            frmOBC ObjDoc=(frmOBC) aFrame.ObjApplet;
    ...
    }//GEN-LAST:event_mnuShowOBCActionPerformed
    
    private void mnuSelectRetailShopSJActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectRetailShopSJActionPerformed
        // TODO add your handling code here:
        try {
            frmSelectionRetailshopSJVoucher objSelect=new frmSelectionRetailshopSJVoucher();
            ...
            if(!objSelect.Cancelled) {
                ...
                for(int r=1;r<=objSelect.SelectedItems.size();r++) {
                    ...
                    DataModel.setValueByVariable("MAIN_ACCOUNT_CODE","210041" ,NewRow);
                    DataModel.setValueByVariable("PARTY_CODE", "",NewRow);
                    String AccountName=clsAccount.getAccountName("210041","");
                    DataModel.setValueByVariable("ACCOUNT_NAME",AccountName, NewRow);
                    ...
                    DataModel.setValueByVariable("AMOUNT",Double.toString(objItem.getAttribute("AMOUNT_PAID").getDouble()),NewRow);
    ...
    }//GEN-LAST:event_mnuSelectRetailShopSJActionPerformed
    
    private void mnuShowDebitNoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuShowDebitNoteActionPerformed
        // TODO add your handling code here:
        try {
            String DocNo=DataModel.getValueByVariable("REF_DOC_NO", Table.getSelectedRow());
            String DocDate=DataModel.getValueByVariable("REF_DOC_DATE", Table.getSelectedRow());
            ...
            frmDebitNoteVoucher ObjDoc=(frmDebitNoteVoucher) aFrame.ObjApplet;
            int CompanyID=UtilFunctions.CInt(DataModel.getValueByVariable("REF_COMPANY_ID", Table.getSelectedRow()));
            ObjDoc.FindEx(CompanyID,DocNo);
    ...
    }//GEN-LAST:event_mnuShowDebitNoteActionPerformed
    ...
    private void mnuSelectDebitNoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectDebitNoteActionPerformed
        ...
        try {
            ...
            objSelect.PartyCode=DataModel.getValueByVariable("PARTY_CODE", Table.getSelectedRow());
            ...
            if(!objSelect.Cancelled) {
                ...
                for(int r=1;r<=objSelect.SelectedItems.size();r++) {
                    ...
                    int NewRow=Table.getRowCount()-1;
                    DataModel.setValueByVariable("SR_NO",Integer.toString(r),NewRow);
                    DataModel.setValueByVariable("PARTY_CODE", objSelect.PartyCode,NewRow);
                    DataModel.setValueByVariable("INVOICE_NO",objItem.getAttribute("INVOICE_NO").getString(),NewRow);
                    DataModel.setValueByVariable("INVOICE_DATE",objItem.getAttribute("INVOICE_DATE").getString(),NewRow);
                    DataModel.setValueByVariable("VALUE_DATE",txtDocDate.getText().trim(),NewRow);
                    String InvNo = objItem.getAttribute("INVOICE_NO").getString();
    ...
    private void mnuShowExportSJActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuShowExportSJActionPerformed
        // TODO add your handling code here:
        try {
            String DocNo=DataModel.getValueByVariable("REF_DOC_NO", Table.getSelectedRow());
            String DocDate=DataModel.getValueByVariable("REF_DOC_DATE", Table.getSelectedRow());
            AppletFrame aFrame=new AppletFrame("Sales Journal Voucher");
            aFrame.startAppletEx("EITLERP.Finance.frmSalesJournalVoucher","Sales Journal Voucher");
            frmSalesJournalVoucher ObjDoc=(frmSalesJournalVoucher) aFrame.ObjApplet;
            int CompanyID=UtilFunctions.CInt(DataModel.getValueByVariable("REF_COMPANY_ID", Table.getSelectedRow()));
            ObjDoc.FindEx(CompanyID,DocNo);
    ...
    }//GEN-LAST:event_mnuShowExportSJActionPerformed
    
    private void mnuSelectExportSJActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectExportSJActionPerformed
        // TODO add your handling code here:
        try {
            frmSelectionExportSJVoucher objSelect=new frmSelectionExportSJVoucher();
            if(Table.getRowCount()>0&&Table.getSelectedRow()>=0) {
                objSelect.PartyCode=DataModel.getValueByVariable("PARTY_CODE", Table.getSelectedRow());
                objSelect.MainCode=DataModel.getValueByVariable("MAIN_ACCOUNT_CODE", Table.getSelectedRow());
            }
    ...
    }//GEN-LAST:event_mnuSelectExportSJActionPerformed
    
    private void mnuSelectOBCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectOBCActionPerformed
        // TODO add your handling code here:
        try {
            
            
            frmSelectionOBC objSelect=new frmSelectionOBC();
            if(Table.getRowCount()>0&&Table.getSelectedRow()>=0) {
                objSelect.PartyCode=DataModel.getValueByVariable("PARTY_CODE", Table.getSelectedRow());
            }
            objSelect.ShowDialog();
            ...
            if(!objSelect.Cancelled) {
                ...
                for(int r=1;r<=objSelect.SelectedItems.size();r++) {
                    clsOBC objItem=(clsOBC)objSelect.SelectedItems.get(Integer.toString(r));
                    ...
                    DataModel.setValueByVariable("MODULE_ID",Integer.toString(clsOBC.ModuleID),NewRow);
                    DataModel.setValueByVariable("MODULE_NAME",clsModules.getModuleName(EITLERPGLOBAL.gCompanyID,clsOBC.ModuleID),NewRow);
                    DataModel.setValueByVariable("REF_COMPANY_ID",Integer.toString(objItem.getAttribute("COMPANY_ID").getInt()),NewRow);
                    DataModel.setValueByVariable("COMPANY_NAME",clsCompany.getCompanyName(objItem.getAttribute("COMPANY_ID").getInt()),NewRow);
                    DataModel.setValueByVariable("LINK_NO","",NewRow);
                    DisplayAgentAlpha(NewRow,"");
                }
    ...
    }//GEN-LAST:event_mnuSelectOBCActionPerformed
        ...
        try {
            ...
            if(!objSelect.Cancelled) {
                ...
                for(int r=1;r<=objSelect.SelectedItems.size();r++) {
                    ...
                    DataModel.setValueByVariable("PO_NO",objItem.getAttribute("PO_NO").getString(),NewRow);
                    DataModel.setValueByVariable("PO_DATE",objItem.getAttribute("PO_DATE").getString(),NewRow);
                    DataModel.setValueByVariable("REF_DOC_NO",objItem.getAttribute("INVOICE_NO").getString(),NewRow);
                    DataModel.setValueByVariable("REF_DOC_DATE",objItem.getAttribute("INVOICE_DATE").getString(),NewRow);
                    DataModel.setValueByVariable("MODULE_ID",Integer.toString(objItem.getAttribute("MODULE_ID").getInt()),NewRow);
                    DataModel.setValueByVariable("MODULE_NAME",clsModules.getModuleName(EITLERPGLOBAL.gCompanyID,objItem.getAttribute("MODULE_ID").getInt()),NewRow);
                    DataModel.setValueByVariable("REF_COMPANY_ID",Integer.toString(objItem.getAttribute("COMPANY_ID").getInt()),NewRow);
                    DataModel.setValueByVariable("COMPANY_NAME",clsCompany.getCompanyName(objItem.getAttribute("COMPANY_ID").getInt()),NewRow);
    ...
    private void cmdAddBlankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddBlankActionPerformed
        ...
        rowData[5]="";
        rowData[6]="";
        rowData[11]=txtDocDate.getText().trim();
        DataModel.addRow(rowData);
        ...
        if(Table.getRowCount()>1) {
            ...
            DataModel.setValueByVariable("VALUE_DATE",txtDocDate.getText().trim(),NewRow);
            DataModel.setValueByVariable("REF_DOC_NO",DataModel.getValueByVariable("REF_DOC_NO", NewRow-1),NewRow);
            DataModel.setValueByVariable("REF_DOC_DATE",DataModel.getValueByVariable("REF_DOC_DATE", NewRow-1),NewRow);
            ...
            DataModel.setValueByVariable("INVOICE_DATE","0000-00-00",NewRow);
            DataModel.setValueByVariable("VALUE_DATE",txtDocDate.getText().trim(),NewRow);
            DataModel.setValueByVariable("REF_DOC_NO","",NewRow);
            DataModel.setValueByVariable("REF_DOC_DATE","0000-00-00",NewRow);
    ...
    private void txtDocDateFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDocDateFocusGained
        // TODO add your handling code here:
        ShowMessage("Enter Voucher Date");
        ...
        try {
            ...
            if(evt.getKeyCode()==112) //F1 Key
            {
                ...
                if(Table.getSelectedColumn()==DataModel.getColFromVariable("DEDUCTIONS")) {
                    frmReceiptDeductions objForm=new frmReceiptDeductions();
                    
                    //objForm.InvoiceNo=DataModel.getValueByVariable("INVOICE_NO", Table.getSelectedRow());
                    objForm.vType= FinanceGlobal.TYPE_RECEIPT_TDS;
                    objForm.MainCode = DataModel.getValueByVariable("MAIN_ACCOUNT_CODE", Table.getSelectedRow());
                    objForm.PartyCode= DataModel.getValueByVariable("PARTY_CODE", Table.getSelectedRow());
            ...
            if(EditMode!=0) //Only Process keys when in editing mode
            {
                if(evt.getKeyCode()==112) //F1 Key pressed
                {
                    ...
                    if(Table.getSelectedColumn()==DataModel.getColFromVariable("PARTY_CODE")) {
                        if(!DataModel.getValueByVariable("MAIN_ACCOUNT_CODE",Table.getSelectedRow()).equals("")) {
                            LOV aList=new LOV();
                            
                            aList.SQL="SELECT PARTY_CODE,PARTY_NAME FROM D_FIN_PARTY_MASTER WHERE MAIN_ACCOUNT_CODE='"+DataModel.getValueByVariable("MAIN_ACCOUNT_CODE",Table.getSelectedRow())+"' AND APPROVED=1 AND CANCELLED=0 ORDER BY PARTY_NAME";
                            aList.ReturnCol=1;
                            aList.ShowReturnCol=true;
                            aList.DefaultSearchOn=2;
                            aList.UseSpecifiedConn=true;
                            ...
                            if(aList.ShowLOV()) {
                                ...
                                Table.setValueAt(aList.ReturnVal, Table.getSelectedRow(),DataModel.getColFromVariable("PARTY_CODE"));
                            }
                        }
                    }
                }
    ...
    private javax.swing.JLabel lblRelizationDate;
    private javax.swing.JLabel lblRevNo;
    private javax.swing.JLabel lblStatus;
    private javax.swing.JLabel lblTitle;
    private javax.swing.JPopupMenu mnuSelect;
    private javax.swing.JMenuItem mnuSelectDebitNote;
    private javax.swing.JMenuItem mnuSelectExportSJ;
    private javax.swing.JMenuItem mnuSelectInvoice;
    private javax.swing.JMenuItem mnuSelectOBC;
    private javax.swing.JMenuItem mnuSelectRetailShopSJ;
    private javax.swing.JPopupMenu mnuShow;
    private javax.swing.JMenuItem mnuShowAdvAmount;
    private javax.swing.JMenuItem mnuShowDebitNote;
    private javax.swing.JMenuItem mnuShowExportSJ;
    private javax.swing.JMenuItem mnuShowInvoice;
    private javax.swing.JMenuItem mnuShowOBC;
    ...
    private javax.swing.JTextField txtCustomerBank;
    ...
    private void SetFields(boolean pStat) {
        ...
        txtCustomerBank.setEnabled(pStat);
        ...
        cmbPaymentMode.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsVoucher.ReceiptVoucher2ModuleID;
        ...
        try {
            ...
            lblTitle.setText("RECEIPT VOUCHER 2 - TDS - "+txtDocNo.getText());
            ...
            txtCustomerBank.setText(objVoucher.objPayment.getAttribute("CUSTOMER_BANK").getString());
            ...
            EITLERPGLOBAL.setComboIndex(cmbPaymentMode,objVoucher.getAttribute("PAYMENT_MODE").getInt());
            ...
            for(int i=1;i<=objVoucher.objPayment.colVoucherItems.size();i++) {
                ...
                //if(ObjItem.getAttribute("IS_DEDUCTION").getInt()==0) {
                    ...
                    DataModel.setValueByVariable("PARTY_CODE",ObjItem.getAttribute("SUB_ACCOUNT_CODE").getString(),NewRow);
                    String AccountName=clsAccount.getAccountName(ObjItem.getAttribute("MAIN_ACCOUNT_CODE").getString(), ObjItem.getAttribute("SUB_ACCOUNT_CODE").getString());
                    DataModel.setValueByVariable("ACCOUNT_NAME",AccountName,NewRow);
                    DataModel.setValueByVariable("INVOICE_NO",ObjItem.getAttribute("INVOICE_NO").getString(),NewRow);
                    DataModel.setValueByVariable("INVOICE_DATE",ObjItem.getAttribute("INVOICE_DATE").getString(),NewRow);
                    DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(ObjItem.getAttribute("INVOICE_AMOUNT").getDouble()) ,NewRow);
                    //DataModel.setValueByVariable("AMOUNT",new BigDecimal(ObjItem.getAttribute("AMOUNT").getVal()).setScale(2,BigDecimal.ROUND_HALF_UP).toString(),NewRow);
                    
                    DataModel.setValueByVariable("AMOUNT",new BigDecimal(ObjItem.getAttribute("AMOUNT").getVal()+ObjItem.getAttribute("DEDUCTION_AMOUNT").getVal()).setScale(2,BigDecimal.ROUND_HALF_UP).toString(),NewRow);
                    ...
                    //DataModel.setValueByVariable("AMOUNT",new BigDecimal(ObjItem.getAttribute("AMOUNT").getVal()).setScale(2,BigDecimal.ROUND_HALF_UP).toString(),NewRow);
                    /*if((!ObjItem.getAttribute("INVOICE_NO").getString().equals("")) && (ObjItem.getAttribute("MAIN_ACCOUNT_CODE").getString().equals("210027") ||ObjItem.getAttribute("MAIN_ACCOUNT_CODE").getString().equals("210010") ||ObjItem.getAttribute("MAIN_ACCOUNT_CODE").getString().equals("210072")) && (!txtBookCode.getText().equals("10"))) {
            ...
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID, DocNo);
    ...
    //Sets data to the Class Object
        ...
        objVoucher.setAttribute("VOUCHER_TYPE",FinanceGlobal.TYPE_RECEIPT_TDS);
        ...
        objVoucher.setAttribute("PAYMENT_MODE",EITLERPGLOBAL.getComboCode(cmbPaymentMode));
        ...
        objVoucher.setAttribute("CUSTOMER_BANK",txtCustomerBank.getText());
        ...
        if(Table.getRowCount()>0) {
            ...
            for(int i=0;i<Table.getRowCount();i++) {
                ...
                objItem.setAttribute("SUB_ACCOUNT_CODE",DataModel.getValueByVariable("PARTY_CODE", i));
                receivedAmt=EITLERPGLOBAL.round(UtilFunctions.CDbl(DataModel.getValueByVariable("AMOUNT",i)),2);
                ...
                objItem.setAttribute("AMOUNT",EITLERPGLOBAL.round(UtilFunctions.CDbl(DataModel.getValueByVariable("AMOUNT", i)) - UtilFunctions.CDbl(DataModel.getValueByVariable("DEDUCTIONS", i)),2));
                ...
                objItem.setAttribute("VALUE_DATE",DataModel.getValueByVariable("VALUE_DATE",i).trim());
                ...
                if((!DataModel.getValueByVariable("INVOICE_NO",i).equals("")) && (MainAccountCode.equals("210027") ||MainAccountCode.equals("210010") ||MainAccountCode.equals("210072")) && (!txtBookCode.getText().equals("10"))) {
                    objItem.setAttribute("LINK_NO",clsSalesInvoice.getAgentAlphaSrNo(DataModel.getValueByVariable("INVOICE_NO",i),EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("INVOICE_DATE",i))));
                } else {
                    objItem.setAttribute("LINK_NO",DataModel.getValueByVariable("LINK_NO",i));
                }
            ...
            //objItem.setAttribute("AMOUNT",EITLERPGLOBAL.round(UtilFunctions.CDbl(txtNetAmount.getText()),2));
            objItem.setAttribute("AMOUNT",EITLERPGLOBAL.round(UtilFunctions.CDbl(DataModel.getValueByVariable("AMOUNT", i)) - UtilFunctions.CDbl(DataModel.getValueByVariable("DEDUCTIONS", i)),2));
            //objItem.setAttribute("AMOUNT",receivedAmt);
            ...
            if(Table.getRowCount()>=1) {
                ...
                objItem.setAttribute("VALUE_DATE",DataModel.getValueByVariable("VALUE_DATE",0));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.addColumn("Agent Alpha"); //5
            DataModel.addColumn("Invoice No."); //6
            DataModel.addColumn("Date");//7
            DataModel.addColumn("Invoice Amount"); //8
            //DataModel.addColumn("Deductions"); //
            DataModel.addColumn("Amount Received"); //9
            DataModel.addColumn("Deductions"); //
            DataModel.addColumn("Value Date"); //10
            DataModel.addColumn("PO No."); //11
            DataModel.addColumn("PO Date"); //12
            DataModel.addColumn("Ref. Doc. No."); //13
            DataModel.addColumn("Date"); //14
            DataModel.addColumn("Ref. Doc. Type"); //15
            DataModel.addColumn("Company"); //16
            DataModel.addColumn("Module ID"); //17
            DataModel.addColumn("Ref. Company ID"); //18
            
            
            DataModel.SetVariable(0,"SR_NO"); // 0
            DataModel.SetVariable(1,"MAIN_ACCOUNT_CODE"); // 1
            DataModel.SetVariable(2,"PARTY_CODE"); // 2
            DataModel.SetVariable(3,"ACCOUNT_NAME"); // 3
            DataModel.SetVariable(4,"LINK_NO");// 4
            DataModel.SetVariable(5,"AGENT_SR");// 5
            DataModel.SetVariable(6,"INVOICE_NO"); //6
            DataModel.SetVariable(7,"INVOICE_DATE"); //7
            DataModel.SetVariable(8,"INVOICE_AMOUNT"); //8
            //DataModel.SetVariable(7,"DEDUCTIONS");
            DataModel.SetVariable(9,"AMOUNT"); //9
            DataModel.SetVariable(10,"DEDUCTIONS");
            DataModel.SetVariable(11,"VALUE_DATE");//10
            DataModel.SetVariable(12,"PO_NO");//11
            DataModel.SetVariable(13,"PO_DATE");//12
            DataModel.SetVariable(14,"REF_DOC_NO");//13
            DataModel.SetVariable(15,"REF_DOC_DATE");//14
            DataModel.SetVariable(16,"MODULE_NAME");//15
            DataModel.SetVariable(17,"COMPANY_NAME");//16
            DataModel.SetVariable(18,"MODULE_ID");//17
            DataModel.SetVariable(19,"REF_COMPANY_ID");//18
                    ...
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        if(col==DataModel.getColFromVariable("DEDUCTIONS")) {
                            ...
                            if(DeductionAmount>0) {
                                DataModel.setValueByVariable("DEDUCTIONS",Double.toString(DeductionAmount), Table.getSelectedRow());
                            }
                            DoNotEvaluate=false;
                            UpdateTotals();
                        }
                        ...
                        if(col==DataModel.getColFromVariable("MAIN_ACCOUNT_CODE")||col==DataModel.getColFromVariable("PARTY_CODE")){
                            try {
                                String MainCode=DataModel.getValueByVariable("MAIN_ACCOUNT_CODE", Table.getSelectedRow());
                                String PartyCode=DataModel.getValueByVariable("PARTY_CODE", Table.getSelectedRow());
                                String AccountName=clsAccount.getAccountName(MainCode,PartyCode);
    ...
    private void DisplayInvoiceDetail(int RowNo,String AgentAlpha) {
        try {
            ...
            if (rsTmp.getRow() > 0) {
                rsTmp.first();
                DataModel.setValueByVariable("PARTY_CODE",rsTmp.getString("PARTY_CODE"),Table.getSelectedRow());
                ...
                DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(rsTmp.getDouble("NET_AMOUNT")),Table.getSelectedRow());
                DataModel.setValueByVariable("LINK_NO",AgentAlpha,Table.getSelectedRow());
                DataModel.setValueByVariable("REF_DOC_NO",rsTmp.getString("INVOICE_NO"),Table.getSelectedRow());
                DataModel.setValueByVariable("REF_DOC_DATE",EITLERPGLOBAL.formatDate(rsTmp.getString("INVOICE_DATE")),Table.getSelectedRow());
                DataModel.setValueByVariable("MODULE_ID",Integer.toString(clsSalesInvoice.ModuleID),Table.getSelectedRow());
                DataModel.setValueByVariable("MODULE_NAME",clsModules.getModuleName(EITLERPGLOBAL.gCompanyID,clsSalesInvoice.ModuleID),Table.getSelectedRow());
                DataModel.setValueByVariable("REF_COMPANY_ID",Integer.toString(EITLERPGLOBAL.gCompanyID),Table.getSelectedRow());
                DataModel.setValueByVariable("COMPANY_NAME",clsCompany.getCompanyName(EITLERPGLOBAL.gCompanyID),Table.getSelectedRow());
            } else {
    ...
    private void GenerateCombos() {
        try {
            ...
            List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsVoucher.ReceiptVoucher2ModuleID);
            
            if(EditMode==EITLERPGLOBAL.EDIT) {
                List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsVoucher.ReceiptVoucher2ModuleID);
            }
            
            
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(EITLERPGLOBAL.gNewUserID==ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID ,txtDocNo.getText())) {
                    List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+(clsVoucher.ReceiptVoucher2ModuleID));
                }
                else {
                    List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+(clsVoucher.ReceiptVoucher2ModuleID));
            ...
            cmbPaymentModeModel=new EITLComboModel();
            cmbPaymentMode.removeAllItems();
            cmbPaymentMode.setModel(cmbPaymentModeModel);
            
            ResultSet rsPaymentMode=data.getResult("SELECT * FROM D_FIN_PARAMETER_MASTER WHERE PARA_ID='PAYMENT_MODE' ORDER BY PARA_CODE",FinanceGlobal.FinURL);
            rsPaymentMode.first();
            
            if(rsPaymentMode.getRow()>0) {
                while(!rsPaymentMode.isAfterLast()) {
                    
                    ComboData aData=new ComboData();
                    aData.Code=UtilFunctions.getInt(rsPaymentMode,"PARA_CODE",0);
                    aData.Text=UtilFunctions.getString(rsPaymentMode,"PARA_DESCRIPTION","");
                    cmbPaymentModeModel.addElement(aData);
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID ,objVoucher.getAttribute("VOUCHER_NO").getString());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10762) ) {
            //if(ApprovalFlow.IsCreator()) {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID ,objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsVoucher.ReceiptVoucher2ModuleID ,FromUserID,objVoucher.getAttribute("VOUCHER_NO").getString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 2014,20141)) { //10761
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,20143)) { //10763
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,20144)) { //10764
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
        ...
        aList.ModuleID=clsVoucher.ReceiptVoucher2ModuleID;
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID , FFNo,  false));
    ...
    private void Edit() {
        ...
        if(objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID,clsVoucher.ReceiptVoucher2ModuleID)) {
            EditMode=EITLERPGLOBAL.EDIT;
            
            //---New Change ---//
            GenerateCombos();
            DisplayData();
            OldRCVoucherNo = txtDocNo.getText().trim();
            //----------------//
            
            if(ApprovalFlow.IsCreator(clsVoucher.ReceiptVoucher2ModuleID ,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10762)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private boolean Validate() {
        ...
        for(int i=0;i<=Table.getRowCount()-1;i++) {
            ...
            String SubCode=DataModel.getValueByVariable("PARTY_CODE", i);
            ...
            String RefNo = DataModel.getValueByVariable("REF_DOC_NO", i);
            boolean ExportSJ = true;
            if(clsVoucher.getVoucherType(RefNo)==FinanceGlobal.TYPE_SALES_JOURNAL){
                if(data.IsRecordExist("SELECT * FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO='"+RefNo+"' AND BOOK_CODE='10' ",FinanceGlobal.FinURL)) {
                    ExportSJ = false;
                }
            }
            //double InvoiceAmount = Double.parseDouble(DataModel.getValueByVariable("INVOICE_AMOUNT", i));
            ...
            if(ValueDate.equals("")) {
                JOptionPane.showMessageDialog(null,"Insert Value Date. Please enter date in DD/MM/YYYY format");
                return false;
            }
            ...
            if(txtRealizationDate.equals("")) {
                JOptionPane.showMessageDialog(null,"Insert Realization Date. Please enter date in DD/MM/YYYY format");
                return false;
            }
            
            if(!EITLERPGLOBAL.isDate(txtRealizationDate.getText().trim())) {
                JOptionPane.showMessageDialog(null,"Invalid Realization Date. Please enter date in DD/MM/YYYY format");
                return false;
            }
            ...
            if(MainCode.equals("125019")) {
                if(PoNo.equals("") || InvoiceNo.equals("")) {
                    JOptionPane.showMessageDialog(this,"Insert PO NO and Invoice No.");
                    return false;
                }
            }
            
            if(MainCode.equals("210027") || MainCode.equals("210010") || MainCode.equals("210072")) {
                if(!InvoiceNo.trim().equals("") && ExportSJ) {
                    String strSQL = "SELECT INVOICE_NO FROM DINESHMILLS.D_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+InvoiceNo+"' " +
                    "AND INVOICE_DATE='"+EITLERPGLOBAL.formatDateDB(InvoiceDate)+"' AND PARTY_CODE='"+SubCode+"' AND APPROVED=1 AND CANCELLED=0";
                    if(!data.IsRecordExist(strSQL)) {
                        JOptionPane.showMessageDialog(this,"Wrong Invoice selected for party code : " + SubCode+" Invoice No"+InvoiceNo+ "Invoice Date"+InvoiceDate);
                        return false;
                    }
                }
            }
            
            if(!InvoiceNo.equals("") && !InvoiceDate.equals("") && (MainCode.equals("210010") || MainCode.equals("210027") || MainCode.equals("210072")) && ExportSJ) {
                if (!EITLERPGLOBAL.isDate(InvoiceDate)) {
                    JOptionPane.showMessageDialog(null,"Invalid invoice date in row " + (i+1));
                    return false;
                }
                double InvoiceAmount = clsSalesInvoice.getInvoiceAmount(InvoiceNo, EITLERPGLOBAL.formatDateDB(InvoiceDate));
                ...
                "AND A.CANCELLED=0 AND A.VOUCHER_NO<>'"+txtDocNo.getText().trim()+"' AND A.BOOK_CODE NOT IN ('99','93') " +
                ...
                for(int j=0;j<Table.getRowCount();j++) {
                    ...
                    if(oInvNo.equals(InvoiceNo) &&  oInvDate.equals(InvoiceDate)) {
                        if(i!=j) {
            ...
            if(DataModel.getValueByVariable("MODULE_ID", i).equals("65")) {
                double DebitAmount = data.getDoubleValueFromDB("SELECT SUM(AMOUNT) FROM D_FIN_VOUCHER_DETAIL " +
                "WHERE VOUCHER_NO='"+RefNo+"' AND EFFECT='D' AND MAIN_ACCOUNT_CODE='"+MainCode+"' " +
                "AND SUB_ACCOUNT_CODE='"+SubCode+"' ",FinanceGlobal.FinURL);
                
                String SQL = "SELECT SUM(B.AMOUNT) FROM D_FIN_VOUCHER_HEADER A, D_FIN_VOUCHER_DETAIL B WHERE A.VOUCHER_NO=B.VOUCHER_NO " +
                //"AND A.BOOK_CODE<>'99' AND B.GRN_NO='"+RefNo+"' AND B.EFFECT='C' AND A.VOUCHER_NO<>'"+txtDocNo.getText().trim()+"' AND B.MAIN_ACCOUNT_CODE='"+MainCode+"' " +
                "AND A.BOOK_CODE NOT IN ('99','93') AND B.GRN_NO='"+RefNo+"' AND B.EFFECT='C' AND A.VOUCHER_NO<>'"+txtDocNo.getText().trim()+"' AND B.MAIN_ACCOUNT_CODE='"+MainCode+"' " +
                "AND B.SUB_ACCOUNT_CODE='"+SubCode+"' AND A.CANCELLED=0 ";
                double AdjustedAmount = data.getDoubleValueFromDB(SQL,FinanceGlobal.FinURL);
                
                double AdjustAmount = Amount;
                if((AdjustedAmount+AdjustAmount) > DebitAmount) {
                    Msg = "Already Adjusted Amount is "+AdjustedAmount+". \n" +
                    "Debit amount is "+DebitAmount+". \n" +
                    "You are trying to adjust Rs. "+(Math.abs(DebitAmount-AdjustedAmount-AdjustAmount))+" more. \n At line no :"+(i+1);
                    JOptionPane.showMessageDialog(this,Msg,"Wrong Adjustment",JOptionPane.ERROR_MESSAGE);
                    return false;
                }
                ...
                for(int j=0;j<Table.getRowCount();j++) {
                    if(i!=j) {
                        ...
                        if(RefNo.equals(otherRefDocNo)) {
                            otherAdjAmount += UtilFunctions.CDbl(DataModel.getValueByVariable("AMOUNT", j));
                        }
                    }
                }
                
                if((AdjustedAmount+AdjustAmount+otherAdjAmount) > DebitAmount) {
                    Msg = "Already Adjusted Amount is "+AdjustedAmount+". \n" +
                    "Debit amount is "+DebitAmount+". \n" +
                    "You are trying to adjust Rs. "+(Math.abs(DebitAmount-AdjustedAmount-AdjustAmount-otherAdjAmount))+" more. \n At line no :"+(i+1);
                    JOptionPane.showMessageDialog(this,Msg,"Wrong Adjustment",JOptionPane.ERROR_MESSAGE);
                    return false;
                }
            }
    ...
    private void Find() {
        ...
        if(ObjReturn.Cancelled==false) {
            if(!objVoucher.Filter(ObjReturn.strQuery+" AND VOUCHER_TYPE="+FinanceGlobal.TYPE_RECEIPT_TDS,EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID,String pDocNo) {
        objVoucher.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND VOUCHER_NO='"+pDocNo+"' AND VOUCHER_TYPE="+ FinanceGlobal.TYPE_RECEIPT_TDS+" ",pCompanyID);
        objVoucher.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID , txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucher2ModuleID ,txtDocNo.getText());
    ...
    private void DisplayAdditionalInfo() {
        try {
            ...
            for(int i=0;i<Table.getRowCount();i++) {
                String PONo=DataModel.getValueByVariable("PO_NO", i);
                String GRNNo=DataModel.getValueByVariable("REF_DOC_NO",i);
    ...
    private void UpdateTotals() {
        ...
        try {
            ...
            txtNetAmount.setText(new BigDecimal(NetAmount).setScale(2,BigDecimal.ROUND_HALF_UP).toString());
    ...
    */
    ...
    private void UpdateTotals() {
        ...
        try {
            ...
            for(int i=0;i<Table.getRowCount();i++) {
                NetAmount=NetAmount+UtilFunctions.CDbl(DataModel.getValueByVariable("AMOUNT", i))-UtilFunctions.CDbl(DataModel.getValueByVariable("DEDUCTIONS", i));
            }
        ...
        if(EditMode==0) {
            ...
            try {
                ...
                if(!SimpleLOV.Cancelled) {
                    ...
                    System.out.println(objConfig.ReportFileName);
    ...
    //    private void DisplayAgentAlpha(int RowNo) {
    //        try {
    //
    //            String AgentAlpha=clsSalesParty.getAgentAlpha(DataModel.getValueByVariable("PARTY_CODE", RowNo));
    //            String InvoiceNo=DataModel.getValueByVariable("INVOICE_NO", RowNo);
    //
    //            if(!InvoiceNo.trim().equals("")) {
    //                AgentAlpha=AgentAlpha+"/"+data.getStringValueFromDB("SELECT AGENT_SR_NO FROM D_SAL_INVOICE_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND INVOICE_NO ='"+InvoiceNo+"'");
    //                AgentAlpha=AgentAlpha+"/"+Integer.toString(EITLERPGLOBAL.FinYearFrom).substring(2)+Integer.toString(EITLERPGLOBAL.FinYearTo).substring(2);
    //            }
    //
    ...
    private void DisplayAgentAlpha(int RowNo,String InvoiceDate) {
        try {
            ...
            String InvoiceNo=DataModel.getValueByVariable("INVOICE_NO", RowNo);
            if(!InvoiceNo.trim().equals("")) {
                if (InvoiceNo.substring(0,1).trim().equals("F") || InvoiceNo.substring(0,1).trim().equals("B")) {
                    String FinYear = EITLERPGLOBAL.FinancialYear(EITLERPGLOBAL.formatDateDB(InvoiceDate));
                    String Link = InvoiceNo.substring(1) + "/"+ FinYear;
                    DataModel.setValueByVariable("LINK_NO",Link,RowNo);
                } else {
    ...
    public static String getLinkNo(String InvoiceNo,String InvoiceDate, String VoucherNo, String PartyCode) {
        String AgentAlpha = "";
        try {
            AgentAlpha=clsSalesParty.getAgentAlpha(PartyCode);
            
            if(!InvoiceNo.trim().equals("")) {
                AgentAlpha=AgentAlpha+"/"+data.getStringValueFromDB("SELECT AGENT_SR_NO FROM D_SAL_INVOICE_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND INVOICE_NO ='"+InvoiceNo+"' AND INVOICE_DATE='"+InvoiceDate+"' ");
