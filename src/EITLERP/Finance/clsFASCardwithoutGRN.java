...
public class clsFASCardwithoutGRN {
...
//                rsHDetailEx.updateString("MODIFIED_DATE",getAttribute("MODIFIED_DATE").getString());
            ...
            */
            ...
            /*
             if(ObjFlow.Status.equals("F")) {
                if(getAttribute("ITEM_ID").getString().substring(0,2).equals("DI")) {
            ...
            if(getAttribute("ITEM_ID").getString().substring(0,2).equals("DI")) {
                ...
                String SQL = "SELECT * FROM D_FAS_ITEM_MASTER_HEADER WHERE ITEM_ID = '" + getAttribute("ITEM_ID").getString() + "' ";
    ...
    public static HashMap getPendingApprovals(int CompanyID,int UserID,int Order, int ModuleID,int FinYearFrom) {
        ...
        try {
            ...
            if(Order==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT FINANCE.D_FAS_MASTER_HEADER.ASSET_NO,FINANCE.D_FAS_MASTER_HEADER.ASSET_DATE,FINANCE.D_FAS_MASTER_HEADER.SUPPLIER_CODE,"+EITLERPGLOBAL.DBName+".D_COM_DOC_DATA.RECEIVED_DATE " +
            ...
            while(rsTmp3.next()) {
                ...
                ObjDoc.setAttribute("SUPPLIER_CODE",rsTmp3.getString("SUPPLIER_CODE"));
