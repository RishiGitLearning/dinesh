...
public class clsFASCardwithGRNDetailEx {
    ...
    public clsFASCardwithGRNDetailEx() {
        props=new HashMap();    
        ...
        props.put("OPENING_BALANCE",new Variant(""));
        props.put("ADDITIONS",new Variant(""));
        props.put("CLOSING_BALANCE",new Variant(""));
        props.put("DEPRECIATION_FROM_DATE",new Variant(""));
        props.put("DEPRECIATION_TO_DATE",new Variant(""));
        props.put("DEPRECIATION_PERCENTAGE",new Variant(""));
        props.put("DEPRECIATION_METHOD",new Variant(""));
        props.put("DEPRECIATION_METHOD_NAME",new Variant(""));
        props.put("DEPRECIATION_FOR_THE_YEAR",new Variant(""));
        props.put("SHIFT_ALLOW_FOR_THE_YEAR",new Variant(""));
        props.put("CUMULATIVE_DEPRECIATION",new Variant(""));
        props.put("WRITTEN_DOWN_VALUE",new Variant(""));
        //props.put("NET_BLOCK",new Variant(""));
