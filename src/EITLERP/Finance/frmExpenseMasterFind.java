...
public class frmExpenseMasterFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtExpenseID.setBounds(100, 20, 110, 19);

        txtExpenseName.setEditable(false);
        jPanel1.add(txtExpenseName);
        txtExpenseName.setBounds(100, 40, 310, 19);

        jLabel14.setText("Main Code");
        jPanel1.add(jLabel14);
        jLabel14.setBounds(20, 70, 80, 15);

        jPanel1.add(txtMainCode);
        txtMainCode.setBounds(100, 70, 310, 19);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 39, 440, 120);
    ...
    private void txtExpenseIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtExpenseIDKeyPressed
        ...
        if(evt.getKeyCode()==112) {
            ...
            aList.SQL="SELECT EXPENSE_ID,MAIN_ACCOUNT_CODE,EXPENSE_DESCRIPTION FROM D_FIN_EXPENSE_MASTER WHERE APPROVED=1 ORDER BY EXPENSE_DESCRIPTION";
            aList.ReturnCol=1;
            aList.SecondCol=2;
            ...
            if(aList.ShowLOV()) {
                ...
                txtExpenseName.setText(clsExpense.getExpenseName(txtExpenseID.getText()));
                txtMainCode.setText(aList.SecondVal);
            }
        }
 ...
 {
     strQuery=strQuery+" AND MAIN_ACCOUNT_CODE LIKE '%"+txtMainCode.getText()+"%' ";
        }
