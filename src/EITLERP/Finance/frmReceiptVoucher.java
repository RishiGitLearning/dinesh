...
public class frmReceiptVoucher extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if (getName().equals("Link")) {
            ...
            objVoucher.VoucherType = FinanceGlobal.TYPE_RECEIPT;
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" RECEIPT VOUCHER");
        ...
        chkAutoAdj.setBounds(6, 81, 334, 21);
...
//            ObjDoc.FindByCompany(CompanyID, DocNo, DocDate);
    ...
    private void cmdAddBlankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddBlankActionPerformed
        ...
        rowData[5] = "";
        rowData[6] = "";
        rowData[10] = txtDocDate.getText().trim();
        DataModel.addRow(rowData);
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            int ModuleID = clsVoucher.ReceiptVoucherModuleID;
        ...
        try {
            ...
            lblTitle.setText("RECEIPT VOUCHER - " + txtDocNo.getText());
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, DocNo);
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.SetVariable(10, "VALUE_DATE");//10
            DataModel.SetVariable(11, "PO_NO");//11
            DataModel.SetVariable(12, "PO_DATE");//12
            DataModel.SetVariable(13, "REF_DOC_NO");//13
            DataModel.SetVariable(14, "REF_DOC_DATE");//14
            DataModel.SetVariable(15, "MODULE_NAME");//15
            DataModel.SetVariable(16, "COMPANY_NAME");//16
            DataModel.SetVariable(17, "MODULE_ID");//17
            DataModel.SetVariable(18, "REF_COMPANY_ID");//18
    ...
    private void GenerateCombos() {
        try {
            ...
            List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.ReceiptVoucherModuleID);

            if (EditMode == EITLERPGLOBAL.EDIT) {
                List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.ReceiptVoucherModuleID);
            }

            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (EITLERPGLOBAL.gNewUserID == ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, txtDocNo.getText())) {
                    List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.ReceiptVoucherModuleID));
                } else {
                    List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.ReceiptVoucherModuleID));
                }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, FromUserID, objVoucher.getAttribute("VOUCHER_NO").getString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10761)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10763)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10764)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        aList.ModuleID = clsVoucher.ReceiptVoucherModuleID;
        ...
        if (aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, FFNo, false));
    ...
    private void Edit() {
        ...
        if (objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID, clsVoucher.ReceiptVoucherModuleID)) {
            ...
            if (ApprovalFlow.IsCreator(clsVoucher.ReceiptVoucherModuleID, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10762)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Find() {
        ...
        if (ObjReturn.Cancelled == false) {
            if (!objVoucher.Filter(ObjReturn.strQuery + " AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_RECEIPT, EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        objVoucher.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND VOUCHER_NO='" + pDocNo + "' AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_RECEIPT + " ", pCompanyID);
        objVoucher.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.ReceiptVoucherModuleID, txtDocNo.getText());
