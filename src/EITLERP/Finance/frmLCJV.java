...
public class frmLCJV extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if (getName().equals("Link")) {
            ...
            objVoucher.VoucherType = FinanceGlobal.TYPE_LC_JV;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        mnuShowReceiptVou = new javax.swing.JMenuItem();
        ...
        mnuShowReceiptVou.setActionCommand("Receipt Voucher");
        mnuShowReceiptVou.setLabel("Receipt Voucher");
        mnuShowReceiptVou.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuShowReceiptVouActionPerformed(evt);
            }
        });

        mnuShow.add(mnuShowReceiptVou);
        ...
        lblTitle.setText(" L.C. Journal Voucher");
        ...
        jTabbedPane1.addTab("Transfer Information", jPanel2);
        ...
        jPanel3.add(jLabel1);
        jLabel1.setBounds(2, 1, 130, 15);

        jLabel5.setText("Main Code");
        jPanel3.add(jLabel5);
        jLabel5.setBounds(7, 24, 70, 15);
        ...
        txtMainCode.setBounds(76, 22, 110, 19);

        jLabel6.setText("Sub Code");
        jPanel3.add(jLabel6);
        jLabel6.setBounds(200, 24, 70, 15);
        ...
        txtPartyCode.setBounds(269, 22, 110, 19);

        txtPartyName.setEnabled(false);
        jPanel3.add(txtPartyName);
        txtPartyName.setBounds(77, 45, 420, 19);

        jLabel8.setText("Name");
        jPanel3.add(jLabel8);
        jLabel8.setBounds(33, 47, 40, 15);

        Tab1.add(jPanel3);
        jPanel3.setBounds(12, 98, 620, 70);
    ...
    private void mnuShowReceiptVouActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuShowReceiptVouActionPerformed
        // TODO add your handling code here:
        try {
            String DocNo = DataModel.getValueByVariable("REF_DOC_NO", Table.getSelectedRow());
            AppletFrame aFrame = new AppletFrame("Receipt Vocuher");
    ...
    }//GEN-LAST:event_mnuShowReceiptVouActionPerformed

    private void txtPartyCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPartyCodeFocusLost
        // TODO add your handling code here:
        txtPartyName.setText(clsAccount.getAccountName(txtMainCode.getText(), txtPartyCode.getText()));
...
//            ObjDoc.FindByCompany(CompanyID,DocNo,DocDate);
        ...
        try {
            ...
            if (!objSelect.Cancelled) {
                ...
                for (int r = 1; r <= objSelect.SelectedItems.size(); r++) {
                    ...
                    String AccountName = clsAccount.getAccountName(objSelect.MainCode, objSelect.PartyCode);
    ...
    private javax.swing.JMenuItem mnuShowReceiptVou;
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            int ModuleID = clsVoucher.SalesJVModuleID;
        ...
        try {
            ...
            lblTitle.setText("L.C. Journal Voucher- " + txtDocNo.getText());
            ...
            txtPartyCode.setText(objVoucher.objPayment.getAttribute("PARTY_CODE").getString());
            ...
            for (int i = 1; i <= objVoucher.objPayment.colVoucherItems.size(); i++) {
                ...
                if (ObjItem.getAttribute("IS_DEDUCTION").getInt() == 0) {
                    ...
                    DataModel.setValueByVariable("AGENT_SR", ObjItem.getAttribute("LINK_NO").getString(), NewRow);
                    //DisplayAgentAlpha(NewRow,ObjItem.getAttribute("INVOICE_DATE").getString());
                }
            }
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, DocNo);
    ...
    private void SetData() {
        ...
        objVoucher.setAttribute("VOUCHER_TYPE", FinanceGlobal.TYPE_LC_JV);
        ...
        objVoucher.setAttribute("MAIN_ACCOUNT_CODE", txtMainCode.getText());
        objVoucher.setAttribute("PARTY_CODE", txtPartyCode.getText());
        ...
        if (Table.getRowCount() > 0) {
            ...
            for (int i = 0; i < Table.getRowCount(); i++) {
                ...
                objItem.setAttribute("APPLICABLE_AMOUNT", 0);
                ...
                if ((!DataModel.getValueByVariable("INVOICE_NO", i).equals("")) && (MainAccountCode.equals("210027") || MainAccountCode.equals("210010") || MainAccountCode.equals("210072")) && (!txtBookCode.getText().equals("10"))) {
                    ...
                    objItem.setAttribute("LINK_NO", DataModel.getValueByVariable("AGENT_SR", i));
                }
                    ...
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        if (col == DataModel.getColFromVariable("INVOICE_NO")) {
                            ...
                            /*
                             ...
                             String InvoiceDate=EITLERPGLOBAL.formatDate(clsSalesInvoice.getInvoiceDate(EITLERPGLOBAL.gCompanyID, InvoiceNo));
                             double InvoiceAmount=clsSalesInvoice.getInvoiceTotal(EITLERPGLOBAL.gCompanyID, InvoiceNo);
                             ...
                             DataModel.setValueByVariable("INVOICE_AMOUNT",Double.toString(InvoiceAmount),Table.getSelectedRow());
                             */
                        }
                        ...
                        if (col == DataModel.getColFromVariable("AGENT_SR")) {
                            ...
                            //                            String InvoiceNo=clsSalesInvoice.getInvoiceNo(AgentAlpha);
                            //                            String InvoiceDate=EITLERPGLOBAL.formatDate(clsSalesInvoice.getInvoiceDate(EITLERPGLOBAL.gCompanyID, InvoiceNo));
                            //                            double InvoiceAmount=clsSalesInvoice.getInvoiceTotal(EITLERPGLOBAL.gCompanyID, InvoiceNo);
                            //
                            //                            DataModel.setValueByVariable("INVOICE_NO",InvoiceNo,Table.getSelectedRow());
    ...
    private void GenerateCombos() {
        try {
            ...
            List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.SalesJVModuleID);

            if (EditMode == EITLERPGLOBAL.EDIT) {
                List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.SalesJVModuleID);
            }

            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (EITLERPGLOBAL.gNewUserID == ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, txtDocNo.getText())) {
                    List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.SalesJVModuleID));
                } else {
                    List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.SalesJVModuleID));
                }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, FromUserID, objVoucher.getAttribute("VOUCHER_NO").getString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10961)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10963)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10964)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Edit() {
        ...
        if (objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID, clsVoucher.SalesJVModuleID)) {
            ...
            if (ApprovalFlow.IsCreator(clsVoucher.SalesJVModuleID, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10962)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        for (int i = 0; i < Table.getRowCount(); i++) {
            ...
            String SQL = "SELECT * FROM DINESHMILLS.D_SAL_INVOICE_HEADER WHERE APPROVED=1 AND CANCELLED=0 "
                    + "AND PARTY_CODE='" + PartyCode + "' AND INVOICE_NO='" + InvNo + "' AND INVOICE_DATE='" + EITLERPGLOBAL.formatDateDB(InvDate) + "' ";
            if (!data.IsRecordExist(SQL)) {
                JOptionPane.showMessageDialog(null, "Wrong invoice or party at line no.: " + (i + 1));
                return;
            }
        ...
        for (int i = 0; i <= Table.getRowCount() - 1; i++) {
            ...
            if (Amount <= 0) {
                JOptionPane.showMessageDialog(null, "Please enter amount in row " + (i + 1));
                return;
            }

            String AgentAlpha = DataModel.getValueByVariable("AGENT_SR", i);
            String InvNo = DataModel.getValueByVariable("INVOICE_NO", i);
            String InvDate = DataModel.getValueByVariable("INVOICE_DATE", i);
            double InvAmt = UtilFunctions.CDbl(DataModel.getValueByVariable("INVOICE_AMOUNT", i));
            String RefDocNo = DataModel.getValueByVariable("REF_DOC_NO", i);
            if (AgentAlpha.trim().equals("")) {
                JOptionPane.showMessageDialog(null, "Please enter Agent Alpha in row " + (i + 1));
                return;
                //} else if (!InvNo.trim().equals("") && !InvDate.trim().equals("") && InvAmt!=0.0) {
            } else if (!InvNo.trim().equals("") && !InvDate.trim().equals("")) {
                ...
                String SQL = "SELECT SUM(B.AMOUNT) FROM D_FIN_VOUCHER_HEADER A, D_FIN_VOUCHER_DETAIL B WHERE A.VOUCHER_NO=B.VOUCHER_NO "
                        + //"AND B.INVOICE_NO='"+InvNo+"' AND B.EFFECT='C' AND B.INVOICE_DATE='"+EITLERPGLOBAL.formatDateDB(InvDate)+"' AND A.BOOK_CODE<>'99' " +
                        "AND B.INVOICE_NO='" + InvNo + "' AND B.EFFECT='C' AND B.INVOICE_DATE='" + EITLERPGLOBAL.formatDateDB(InvDate) + "' AND A.BOOK_CODE NOT IN ('99','93') "
                        + "AND A.CANCELLED=0 AND A.VOUCHER_NO<>'" + txtDocNo.getText().trim() + "' AND A.VOUCHER_TYPE<>" + FinanceGlobal.TYPE_SALES_JOURNAL;
            ...
            int VoucherType = clsVoucher.getVoucherType(DataModel.getValueByVariable("REF_DOC_NO", i));
    ...
    private void Find() {
        ...
        if (ObjReturn.Cancelled == false) {
            if (!objVoucher.Filter(ObjReturn.strQuery + " AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_LC_JV, EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        objVoucher.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND VOUCHER_NO='" + pDocNo + "' AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_LC_JV + " ", pCompanyID);
        objVoucher.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.SalesJVModuleID, txtDocNo.getText());
    ...
    private void DisplayInvoiceDetail(int RowNo, String AgentAlpha) {
        try {
            ...
            if (rsTmp.getRow() > 0) {
                ...
                DataModel.setValueByVariable("PARTY_CODE", "", Table.getSelectedRow());
                ...
                DataModel.setValueByVariable("INVOICE_AMOUNT", Double.toString(0), Table.getSelectedRow());
            }
