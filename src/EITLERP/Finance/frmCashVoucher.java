...
public class frmCashVoucher extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if(getName().equals("Link")) {
            ...
            objVoucher.VoucherType=FinanceGlobal.TYPE_CASH_VOUCHER;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        mnuSelectJob = new javax.swing.JMenuItem();
        mnuSelectGRN = new javax.swing.JMenuItem();
        ...
        txtCashCode = new javax.swing.JTextField();
        ...
        mnuSelectPJV.setText("Select PJV for Cash Payment Voucher");
        ...
        mnuSelectExpense.setText("Select Expense Entry for Cash Payment Voucher");
        ...
        mnuSelectJob.setLabel("Select Job No");
        mnuSelectJob.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuSelectJobActionPerformed(evt);
            }
        });

        mnuSelect.add(mnuSelectJob);

        mnuSelectGRN.setText("Select GRN");
        mnuSelectGRN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuSelectGRNActionPerformed(evt);
            }
        });

        mnuSelect.add(mnuSelectGRN);
        ...
        Tab1.add(jLabel3);
        jLabel3.setBounds(365, 16, 37, 15);
        ...
        txtBookCode.setBounds(112, 41, 102, 19);
        ...
        jScrollPane4.setBounds(9, 362, 630, 50);
        ...
        jLabel11.setText("Cash A/c :");
        jPanel3.add(jLabel11);
        jLabel11.setBounds(5, 9, 95, 15);

        txtCashCode.setName("REQ_DATE");
        txtCashCode.setEnabled(false);
        txtCashCode.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtCashCodeFocusLost(evt);
            }
        });
        txtCashCode.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtCashCodeKeyPressed(evt);
            }
        });

        jPanel3.add(txtCashCode);
        txtCashCode.setBounds(105, 7, 102, 19);

        txtBankName.setName("REMARKS");
        txtBankName.setEnabled(false);
        jPanel3.add(txtBankName);
        txtBankName.setBounds(212, 7, 366, 19);

        lblEmployeeNo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblEmployeeNo.setText("Employee No :");
        jPanel3.add(lblEmployeeNo);
        lblEmployeeNo.setBounds(5, 31, 95, 15);

        txtEmployeeNo.setName("REQ_DATE");
        txtEmployeeNo.setEnabled(false);
        jPanel3.add(txtEmployeeNo);
        txtEmployeeNo.setBounds(105, 30, 102, 19);

        Tab1.add(jPanel3);
        jPanel3.setBounds(9, 95, 630, 53);

        jLabel9.setText("Remarks :");
        Tab1.add(jLabel9);
        jLabel9.setBounds(9, 344, 80, 15);
        ...
        jPanel2.add(cmdShow);
        cmdShow.setBounds(300, 133, 100, 20);
        ...
        cmdRemove.setBounds(108, 134, 86, 20);

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Net  Amount :");
        jPanel2.add(jLabel7);
        jLabel7.setBounds(415, 136, 90, 15);
        ...
        cmdSelect.setBounds(198, 133, 100, 20);

        jTabbedPane1.addTab("Payment Information", jPanel2);

        Tab1.add(jTabbedPane1);
        jTabbedPane1.setBounds(8, 150, 630, 190);

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Legacy No. :");
        Tab1.add(jLabel10);
        jLabel10.setBounds(15, 69, 90, 15);

        txtLegacyNo.setName("REQ_DATE");
        txtLegacyNo.setEnabled(false);
        Tab1.add(txtLegacyNo);
        txtLegacyNo.setBounds(112, 67, 102, 19);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Date :");
        Tab1.add(jLabel12);
        jLabel12.setBounds(220, 70, 40, 15);
        ...
        Tab1.add(jLabel13);
        jLabel13.setBounds(374, 71, 80, 15);

        txtLinkNo.setName("REQ_DATE");
        txtLinkNo.setNextFocusableComponent(txtCashCode);
        txtLinkNo.setEnabled(false);
        Tab1.add(txtLinkNo);
        txtLinkNo.setBounds(460, 69, 102, 19);
        ...
        lblStatus.setBounds(3, 521, 650, 22);

    }//GEN-END:initComponents
    
    private void mnuSelectGRNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectGRNActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
        frmSelectGRNJob objDialog=new frmSelectGRNJob();
        //frmSelectGRNJob objDialog = new frmSelectGRNJob();
        
        objDialog.DocNoLabel="GRN No.";
        objDialog.ShowDialog();
        try {
            if(!objDialog.cancelled) {
                
                String GRNNo=objDialog.DocNo;
                int RefCompanyID=objDialog.CompanyID;
                String dbURL=clsFinYear.getDBURL(RefCompanyID,EITLERPGLOBAL.FinYearFrom);
                
                
                ResultSet rsMIR=data.getResult("SELECT GRN_NO,GRN_DATE FROM D_INV_GRN_HEADER WHERE GRN_NO='"+GRNNo+"'",dbURL);
                rsMIR.first();
                
                if(rsMIR.getRow()>0) {
                    
                    String GRNDate=EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsMIR,"GRN_DATE","0000-00-00"));
                    int GRNModuleType = clsGRN.getGRNType(RefCompanyID,GRNNo);
                    int GRNModuleID = 0;
                    if(GRNModuleType==1) {
                        GRNModuleID=7;
                    } else if(GRNModuleType==2) {
                        GRNModuleID=8;
                    }
                    ...
                    DataModel.setValueByVariable("AMOUNT","0",NewRow);
                    ...
                    DataModel.setValueByVariable("REF_DOC_NO",GRNNo,NewRow);
                    DataModel.setValueByVariable("REF_DOC_DATE",GRNDate,NewRow);
                    DataModel.setValueByVariable("MODULE_ID",Integer.toString(GRNModuleID),NewRow);
                    DataModel.setValueByVariable("MODULE_NAME",clsModules.getModuleName(EITLERPGLOBAL.gCompanyID,GRNModuleID),NewRow);
                    ...
                    JOptionPane.showMessageDialog(null,"Invalid GRN No. Please correct and retry");
                    return;
                }
            }
        }
    ...
    }//GEN-LAST:event_mnuSelectGRNActionPerformed
    
    private void mnuSelectJobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectJobActionPerformed
        // TODO add your handling code here:
        try {
            
            frmSelectMIRJob objDialog=new frmSelectMIRJob();
            objDialog.DocNoLabel="Job No.";
            objDialog.ShowDialog();
            
            if(!objDialog.cancelled) {
                
                String JobNo=objDialog.DocNo;
                int RefCompanyID=objDialog.CompanyID;
                String dbURL=clsFinYear.getDBURL(RefCompanyID,EITLERPGLOBAL.FinYearFrom);
                
                ResultSet rsJob=data.getResult("SELECT JOB_NO,JOB_DATE FROM D_INV_JOB_HEADER WHERE JOB_NO='"+JobNo+"'",dbURL);
                rsJob.first();
                
                if(rsJob.getRow()>0) {
                    
                    String JobDate=EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsJob,"JOB_DATE","0000-00-00"));
                    int JobModuleID=48;
                    ...
                    DataModel.setValueByVariable("PO_NO","",NewRow);
                    DataModel.setValueByVariable("PO_DATE","0000-00-00",NewRow);
                    DataModel.setValueByVariable("REF_DOC_NO",JobNo,NewRow);
                    DataModel.setValueByVariable("REF_DOC_DATE",JobDate,NewRow);
                    DataModel.setValueByVariable("MODULE_ID",Integer.toString(JobModuleID),NewRow);
                    DataModel.setValueByVariable("MODULE_NAME",clsModules.getModuleName(EITLERPGLOBAL.gCompanyID,JobModuleID),NewRow);
                    DataModel.setValueByVariable("REF_COMPANY_ID",Integer.toString(RefCompanyID),NewRow);
                    DataModel.setValueByVariable("COMPANY_NAME",clsCompany.getCompanyName(RefCompanyID),NewRow);
                    DataModel.setValueByVariable("LINK_NO","",NewRow);
                }
                else {
                    JOptionPane.showMessageDialog(null,"Invalid Job No. Please correct and retry");
                    return;
                }
            }
        }
    ...
    }//GEN-LAST:event_mnuSelectJobActionPerformed
    ...
    private void mnuSelectMIRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectMIRActionPerformed
        ...
        try {
            ...
            if(!objDialog.cancelled) {
                ...
                rsMIR.first();
                int Type = clsMIRGen.getMIRType(RefCompanyID, MIRNo);
    ...
    private void txtCashCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCashCodeFocusLost
        // TODO add your handling code here:
        txtBankName.setText(clsAccount.getAccountName(txtCashCode.getText(),""));
    }//GEN-LAST:event_txtCashCodeFocusLost
    
    private void txtCashCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCashCodeKeyPressed
        // TODO add your handling code here:
        try {
            ...
            if(evt.getKeyCode()==112) {
                ...
                if(aList.ShowLOV()) {
                    txtCashCode.setText(aList.ReturnVal);
    ...
    }//GEN-LAST:event_txtCashCodeKeyPressed
    ...
    private void mnuSelectExpenseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuSelectExpenseActionPerformed
        ...
        try {
            frmSelectGRNJob objDialog=new frmSelectGRNJob();
            objDialog.DocNoLabel="Expense Doc No.";
            objDialog.ShowDialog();
            
            if(!objDialog.cancelled) {
                String ExpDocID=objDialog.DocNo;
                int RefCompanyID=objDialog.CompanyID;
                String dbURL=FinanceGlobal.FinURL; //clsFinYear.getDBURL(RefCompanyID,EITLERPGLOBAL.FinYearFrom);
                
                ResultSet rsExp=data.getResult("SELECT DOC_NO,DOC_DATE FROM D_FIN_EXPENSE_TRANSACTION WHERE DOC_NO='"+ExpDocID+"'",dbURL);
                rsExp.first();
                
                if(rsExp.getRow()>0) {
                    String DocDate=EITLERPGLOBAL.formatDate(UtilFunctions.getString(rsExp,"DOC_DATE","0000-00-00"));
                    ...
                    DataModel.setValueByVariable("PO_NO","",NewRow);
                    DataModel.setValueByVariable("PO_DATE","0000-00-00",NewRow);
                    DataModel.setValueByVariable("REF_DOC_NO",ExpDocID,NewRow);
                    DataModel.setValueByVariable("REF_DOC_DATE",DocDate,NewRow);
                    ...
                    JOptionPane.showMessageDialog(null,"Invalid Expense Doc No. Please correct and retry");
                    return;
                }
                UpdateTotals();
            }
...
/*        try {
    ...
    private void txtBookCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBookCodeFocusLost
        ...
        try {
            ...
            txtCashCode.setText(clsTRMapping.getMainCode(EITLERPGLOBAL.gCompanyID,txtBookCode.getText()));
            txtBankName.setText(clsAccount.getAccountName(txtCashCode.getText(),""));
    ...
    private void cmdRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRemoveActionPerformed
        ...
        try {
            if(Table.getRowCount()>0) {
                ...
                DataModel.setObjectListAfterDelete(CurrentRow);
                UpdateTotals();
            }
        }
        catch(Exception e) {
        ...
        try {
            ...
            if(evt.getKeyCode()==112) //F1 Key
            {
                ...
                if(Table.getSelectedColumn()==DataModel.getColFromVariable("DEDUCTIONS")) {
                    ...
                    objForm.PartyCode = DataModel.getValueByVariable("SUB_ACCOUNT_CODE", Table.getSelectedColumn());
                    objForm.MainCode = DataModel.getValueByVariable("MAIN_ACCOUNT_CODE", Table.getSelectedColumn());
    ...
    private javax.swing.JMenuItem mnuSelectGRN;
    private javax.swing.JMenuItem mnuSelectJob;
    ...
    private javax.swing.JTextField txtCashCode;
    ...
    private void DisplayData() {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsVoucher.CashVoucherModuleID;
        ...
        try {
            ...
            lblTitle.setText("CASH VOUCHER - "+txtDocNo.getText());
            ...
            txtCashCode.setText(objVoucher.objPayment.getAttribute("BANK_CODE").getString());
            txtBankName.setText(clsAccount.getAccountName(txtCashCode.getText(),""));
            ...
            txtEmployeeNo.setText(objVoucher.objPayment.getAttribute("EMPLOYEE_NO").getString());
            ...
            for(int i=1;i<=objVoucher.objPayment.colVoucherItems.size();i++) {
                ...
                if(ObjItem.getAttribute("IS_DEDUCTION").getInt()==0) {
                    ...
                    DataModel.setValueByVariable("ACCOUNT_NAME",clsPartyMaster.getAccountName(ObjItem.getAttribute("MAIN_ACCOUNT_CODE").getString(),ObjItem.getAttribute("SUB_ACCOUNT_CODE").getString() ) ,NewRow);
                    DataModel.setValueByVariable("INVOICE_NO",ObjItem.getAttribute("INVOICE_NO").getString(),NewRow);
                    DataModel.setValueByVariable("INVOICE_DATE",ObjItem.getAttribute("INVOICE_DATE").getString(),NewRow);
                    ...
                    DataModel.setValueByVariable("DEDUCTIONS",Double.toString(ObjItem.getAttribute("DEDUCTION_AMOUNT").getDouble()), NewRow);
                    DataModel.setValueByVariable("PO_NO",ObjItem.getAttribute("PO_NO").getString(),NewRow);
                    DataModel.setValueByVariable("PO_DATE",ObjItem.getAttribute("PO_DATE").getString(),NewRow);
                    DataModel.setValueByVariable("REF_DOC_NO",ObjItem.getAttribute("GRN_NO").getString(),NewRow);
                    DataModel.setValueByVariable("REF_DOC_DATE",ObjItem.getAttribute("GRN_DATE").getString(),NewRow);
            ...
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID, DocNo);
    ...
    private void SetData() {
        ...
        objVoucher.setAttribute("VOUCHER_TYPE",FinanceGlobal.TYPE_CASH_VOUCHER);
        ...
        if(Table.getRowCount()>0) {
            ...
            objItem.setAttribute("ACCOUNT_ID",1); //Default Value
            objItem.setAttribute("MAIN_ACCOUNT_CODE",txtCashCode.getText());
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.addColumn("Deductions"); //3
            ...
            DataModel.SetVariable(1,"MAIN_ACCOUNT_CODE"); //0 - Read Only
            DataModel.SetVariable(2,"SUB_ACCOUNT_CODE"); //0 - Read Only
            DataModel.SetVariable(3,"ACCOUNT_NAME"); //0 - Read Only
            ...
            DataModel.SetVariable(10,"REF_DOC_NO");
            DataModel.SetVariable(11,"REF_DOC_DATE");
            DataModel.SetVariable(12,"MODULE_NAME");
            DataModel.SetVariable(13,"COMPANY_NAME");
            DataModel.SetVariable(14,"MODULE_ID");
            DataModel.SetVariable(15,"REF_COMPANY_ID");
            ...
            DataModel.SetNumeric(7,true); //-- new
            DataModel.SetNumeric(14,true);
            DataModel.SetNumeric(15,true); //-- new
                    ...
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        if(col==DataModel.getColFromVariable("MAIN_ACCOUNT_CODE")){
                            try {
                                ...
                                System.out.println(PartyCode.length());
                                if(PartyCode.equals("")||PartyCode.length()<6) {
                                    PartyCode="";
                                }
                        ...
                        if(col==DataModel.getColFromVariable("SUB_ACCOUNT_CODE")){
                            try {
                                String MainCode=DataModel.getValueByVariable("MAIN_ACCOUNT_CODE", Table.getSelectedRow());
                                if(!MainCode.equals("")) {
                                    String PartyCode=DataModel.getValueByVariable("SUB_ACCOUNT_CODE", Table.getSelectedRow());
                        ...
                        if(col==DataModel.getColFromVariable("PO_NO")) {
                            ...
                            if(EITLERPGLOBAL.gCompanyID==2) {
                                if(data.IsRecordExist("SELECT PO_NO FROM D_PUR_PO_HEADER WHERE PO_NO='"+PONo+"'",BarodaURL)) {
                                    String PODate=data.getStringValueFromDB("SELECT PO_DATE FROM D_PUR_PO_HEADER WHERE PO_NO='"+PONo+"' AND PO_DATE >='"+EITLERPGLOBAL.FinFromDateDB+"'",BarodaURL);
                                    DoNotEvaluate=true;
                            ...
                            if(EITLERPGLOBAL.gCompanyID==3) {
                                if(data.IsRecordExist("SELECT PO_NO FROM D_PUR_PO_HEADER WHERE PO_NO='"+PONo+"'",AnkURL)) {
                                    String PODate=data.getStringValueFromDB("SELECT PO_DATE FROM D_PUR_PO_HEADER WHERE PO_NO='"+PONo+"' AND PO_DATE >='"+EITLERPGLOBAL.FinFromDateDB+"'",AnkURL);
                                    DoNotEvaluate=true;
                                    DataModel.setValueByVariable("PO_DATE",EITLERPGLOBAL.formatDate(PODate),Table.getSelectedRow());
                        ...
                        if(col==DataModel.getColFromVariable("DEDUCTIONS")) {
                            DoNotEvaluate=true;
                            double InvoiceAmount=UtilFunctions.CDbl(DataModel.getValueByVariable("AMOUNT", Table.getSelectedRow()));
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsVoucher.CashVoucherModuleID);
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsVoucher.CashVoucherModuleID);
        }
        
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            if(EITLERPGLOBAL.gNewUserID==ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID ,txtDocNo.getText())) {
                List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+(clsVoucher.CashVoucherModuleID));
            }
            else {
                List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+(clsVoucher.CashVoucherModuleID));
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID ,objVoucher.getAttribute("VOUCHER_NO").getString());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10742)) {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID ,objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsVoucher.CashVoucherModuleID ,FromUserID,objVoucher.getAttribute("VOUCHER_NO").getString());
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            if(data.IsRecordExist("SELECT FINAL_APPROVER FROM D_COM_HIERARCHY_RIGHTS WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND HIERARCHY_ID="+SelHierarchyID+" AND USER_ID="+EITLERPGLOBAL.gNewUserID+" AND FINAL_APPROVER=1")) {
                OpgFinal.setEnabled(true);
            } else {
                OpgFinal.setEnabled(false);
                OpgFinal.setSelected(false);
        ...
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10745)) {
            cmdAddBlank.setEnabled(true);
        } else {
            cmdAddBlank.setEnabled(false);
        }
        if(EditMode==0) {
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10741)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10743)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10744)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void Add() {
        ...
        aList.ModuleID=clsVoucher.CashVoucherModuleID;
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID , FFNo,  false));
            ...
            txtDocNo.setText(clsVoucher.getNextVoucherNo(EITLERPGLOBAL.gCompanyID, txtBookCode.getText(), SelPrefix));
            txtBookName.setText(clsBook.getBookName(EITLERPGLOBAL.gCompanyID, txtBookCode.getText()));
            txtCashCode.setText(clsTRMapping.getMainCode(EITLERPGLOBAL.gCompanyID,txtBookCode.getText()));
            txtBankName.setText(clsAccount.getAccountName(txtCashCode.getText(),""));
    ...
    private void Edit() {
        ...
        if(objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID,clsVoucher.CashVoucherModuleID)) {
            ...
            if(ApprovalFlow.IsCreator(clsVoucher.CashVoucherModuleID ,lDocNo)) {
                SetFields(true);
                int Records = data.getIntValueFromDB("SELECT COUNT(*) FROM D_COM_DOC_DATA WHERE DOC_NO='"+txtDocNo.getText().trim()+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID+" ");
                if(Records > 1) {
                    int SrNo = data.getIntValueFromDB("SELECT SR_NO FROM D_COM_DOC_DATA WHERE DOC_NO='"+txtDocNo.getText().trim()+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID+" AND STATUS='W'");
                    if(SrNo>1) {
                        OpgFinal.setEnabled(true);
                        SetFields(false);
            ...
            txtDocDate.requestFocus();
            //            if(ApprovalFlow.IsCreator(clsVoucher.CashVoucherModuleID ,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10522)) {
            //                SetFields(true);
            //            }
            //            else {
            //                EnableApproval();
...
//                        return false;
    ...
    private void Find() {
        ...
        if(ObjReturn.Cancelled==false) {
            if(!objVoucher.Filter(ObjReturn.strQuery+" AND VOUCHER_TYPE="+FinanceGlobal.TYPE_CASH_VOUCHER,EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID,String pDocNo) {
        objVoucher.Filter(" WHERE COMPANY_ID="+Integer.toString(pCompanyID)+" AND VOUCHER_NO='"+pDocNo+"' AND VOUCHER_TYPE="+ FinanceGlobal.TYPE_CASH_VOUCHER+" ",pCompanyID);
        objVoucher.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID , txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.CashVoucherModuleID ,txtDocNo.getText());
                    ...
                    if(rsTmp.getRow() > 0 ) {
                        while(!rsTmp.isAfterLast()) {
                            if(rsTmp.getString("MAIN_ACCOUNT_CODE").trim().equals("127176")) {
                                RemarkTDS = "Rs. " + rsTmp.getString("AMOUNT") + " TDS ON Rs. " + rsTmp.getString("APPLICABLE_AMOUNT") + " @ " + rsTmp.getString("PERCENTAGE");
                            } else if(rsTmp.getString("MAIN_ACCOUNT_CODE").equals("127035")) {
                                RemarkESI = "Rs. " + rsTmp.getString("AMOUNT") + " ESI ON Rs. " + rsTmp.getString("APPLICABLE_AMOUNT") + " @ " + rsTmp.getString("PERCENTAGE");
                            }
                            rsTmp.next();
                        }
                    }
