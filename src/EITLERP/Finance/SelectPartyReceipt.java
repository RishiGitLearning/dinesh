...
public class SelectPartyReceipt extends javax.swing.JApplet {
    ...
    public SelectPartyReceipt(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn) {
        initComponents();
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Maturity Date");//5
        DataModel.addColumn("Main Account Code");//6
        DataModel.addColumn("Amount");//7
    ...
    private void GenerateGrid() {
        ...
        if(!PartyCode.equals("")) {
            List=clsDepositMaster.getLiveReceiptList(PartyCode);
            for(int i=1;i<=List.size();i++) {
                clsDepositDeathItems ObjItem=(clsDepositDeathItems)List.get(Integer.toString(i));
                ...
                rowData[3]=EITLERPGLOBAL.formatDate(ObjItem.getAttribute("RECEIPT_DATE").getString());
                rowData[4]=EITLERPGLOBAL.formatDate(ObjItem.getAttribute("EFFECTIVE_DATE").getString());
                rowData[5]=EITLERPGLOBAL.formatDate(ObjItem.getAttribute("MATURITY_DATE").getString());
                rowData[6]=ObjItem.getAttribute("MAIN_ACCOUNT_CODE").getString();
