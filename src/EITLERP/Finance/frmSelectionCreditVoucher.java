...
public class frmSelectionCreditVoucher extends javax.swing.JApplet {
    ...
    public frmSelectionCreditVoucher() {
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText(" SELECT CREDIT NOTE FOR RECEIPT VOUCHER");
        ...
        txtPartyCode.setBounds(100, 40, 130, 19);

        txtPartyName.setEnabled(false);
        jPanel1.add(txtPartyName);
        txtPartyName.setBounds(100, 70, 500, 19);
        ...
        txtMainCode.setBounds(100, 10, 130, 19);
        ...
        Tab.addTab("Select Credit Note", jPanel2);
    ...
    private void GenerateGridDebit() {
        try {
            ...
            List = clsAccount.getPartyCreditNotes(EITLERPGLOBAL.gCompanyID,txtMainCode.getText().trim(), txtPartyCode.getText().trim(), InvoiceNo , "", "",FinanceGlobal.TYPE_CREDIT_NOTE);
