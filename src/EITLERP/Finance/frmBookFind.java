...
public class frmBookFind extends javax.swing.JApplet {
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
         strQuery=strQuery+" AND BOOK_CODE='"+txtMainCode.getText()+"' ";
       }
       
       if(!txtName.getText().equals(""))
       {
         strQuery=strQuery+" AND BOOK_NAME LIKE '%"+txtName.getText()+"%' ";
       }
