...
public class frmGroupMasterFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtMainCode.setBounds(98, 14, 132, 20);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel13.setText("Name");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(10, 40, 80, 20);
        ...
        jPanel1.add(txtName);
        txtName.setBounds(100, 40, 340, 20);

        jLabel3.setDisplayedMnemonic('G');
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setLabelFor(txtMainCode);
        ...
        txtGroupCode.setBounds(100, 70, 50, 20);

        jPanel1.add(lblGroupName);
        lblGroupName.setBounds(160, 70, 300, 20);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 39, 470, 160);
    ...
    private void txtGroupCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGroupCodeKeyPressed
      ...
      if(evt.getKeyCode()==112) {
            ...
            if(aList.ShowLOV()) {
                ...
                lblGroupName.setText(aList.SecondVal);
            }
        }  
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
         strQuery=strQuery+" AND GROUP_CODE='"+txtGroupCode.getText()+"' ";
       }
