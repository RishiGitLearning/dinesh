...
public class frmDepositFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblMaturityDateFrom = new javax.swing.JLabel();
        txtMaturityDateFrom = new javax.swing.JTextField();
        lblMaturityDateTo = new javax.swing.JLabel();
        txtMaturityDateTo = new javax.swing.JTextField();
        ...
        llblOldReceiptCode = new javax.swing.JLabel();
        ...
        txtReceiptDateTo.setBounds(425, 47, 132, 19);
        ...
        txtEffDateTo.setNextFocusableComponent(txtMaturityDateFrom);
        ...
        txtEffDateTo.setBounds(425, 80, 132, 19);

        lblMaturityDateFrom.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblMaturityDateFrom.setText("Maturity Date From :");
        jPanel1.add(lblMaturityDateFrom);
        lblMaturityDateFrom.setBounds(10, 110, 133, 15);

        txtMaturityDateFrom.setNextFocusableComponent(txtMaturityDateTo);
        txtMaturityDateFrom.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtMaturityDateFromFocusLost(evt);
            }
        });

        jPanel1.add(txtMaturityDateFrom);
        txtMaturityDateFrom.setBounds(155, 110, 132, 19);

        lblMaturityDateTo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblMaturityDateTo.setText("Maturity Date To :");
        jPanel1.add(lblMaturityDateTo);
        lblMaturityDateTo.setBounds(294, 110, 124, 15);

        txtMaturityDateTo.setNextFocusableComponent(txtApplicanctName);
        txtMaturityDateTo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtMaturityDateToFocusLost(evt);
            }
        });

        jPanel1.add(txtMaturityDateTo);
        txtMaturityDateTo.setBounds(425, 109, 132, 19);
        ...
        lblPartyCode.setBounds(32, 170, 110, 15);

        llblOldReceiptCode.setText("Old Receipt No :");
        jPanel1.add(llblOldReceiptCode);
        llblOldReceiptCode.setBounds(318, 171, 102, 15);

        jPanel1.add(txtOldReceiptNo);
        txtOldReceiptNo.setBounds(430, 170, 120, 19);

        lblLegacyNo.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblLegacyNo.setText("Legacy No  :");
        jPanel1.add(lblLegacyNo);
        lblLegacyNo.setBounds(294, 13, 124, 15);

        txtLegacyNo.setNextFocusableComponent(txtEffDateFrom);
        jPanel1.add(txtLegacyNo);
        txtLegacyNo.setBounds(425, 10, 132, 19);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 39, 564, 210);

        lblShowMessage.setDisplayedMnemonic('G');
        lblShowMessage.setText("  ...");
        getContentPane().add(lblShowMessage);
        lblShowMessage.setBounds(10, 260, 510, 20);

    }//GEN-END:initComponents

    private void txtMaturityDateToFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMaturityDateToFocusLost
        // TODO add your handling code here:
        Validate_MaturityDate();
    }//GEN-LAST:event_txtMaturityDateToFocusLost

    private void txtMaturityDateFromFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtMaturityDateFromFocusLost
        // TODO add your handling code here:
        Validate_MaturityDate();
    }//GEN-LAST:event_txtMaturityDateFromFocusLost
    ...
    private void txtReceiptNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtReceiptNoKeyPressed
        ...
        if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            aList.SQL="SELECT RECEIPT_NO,RECEIPT_DATE FROM D_FD_DEPOSIT_MASTER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" ORDER BY RECEIPT_NO";
            aList.ReturnCol=1;
            aList.SecondCol=2;
    ...
    private void txtReceiptNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtReceiptNoFocusLost
        ...
        try {
            if(!txtReceiptNo.getText().equals("")) {
                ...
                if(data.IsRecordExist("SELECT COUNT(*) FROM D_FD_DEPOSIT_MASTER WHERE COMPANY_ID='"+ EITLERPGLOBAL.gCompanyID +"' AND RECEIPT_NO='"+txtReceiptNo.getText().trim()+"'",FinanceGlobal.FinURL)) {
                    String SQL = "SELECT RECEIPT_NO,RECEIPT_DATE,APPLICANT_NAME,EFFECTIVE_DATE,MATURITY_DATE,PARTY_CODE "+
                            " FROM D_FD_DEPOSIT_MASTER WHERE COMPANY_ID = '"+ EITLERPGLOBAL.gCompanyID + 
                    ...
                    if (rsTmp.getRow() > 0) {
                        ...
                        lblMaturityDateFrom.setText("Maturity Date :");
                        txtMaturityDateTo.setEnabled(false);
                        lblMaturityDateTo.setEnabled(false);
                        txtMaturityDateFrom.setText(EITLERPGLOBAL.formatDate(rsTmp.getString("MATURITY_DATE")));
                        txtMaturityDateTo.setText("");
                    ...
                    lblMaturityDateFrom.setText("Maturity From Date :");
                    txtMaturityDateTo.setEnabled(true);
                    lblMaturityDateTo.setEnabled(true);
                    txtMaturityDateFrom.setText("");
                    txtMaturityDateTo.setText("");
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!txtLegacyNo.getText().equals("")) {
            strQuery=strQuery+" AND LEGACY_NO='"+txtLegacyNo.getText()+"' ";
        }
        ...
        if (lblMaturityDateFrom.getText().equals("Maturity Date :")) {
            strQuery=strQuery+" AND MATURITY_DATE='"+EITLERPGLOBAL.formatDateDB(txtMaturityDateFrom.getText())+"' ";
        } else if (!txtMaturityDateFrom.getText().equals("")) {
            strQuery=strQuery+" AND MATURITY_DATE>='"+EITLERPGLOBAL.formatDateDB(txtMaturityDateFrom.getText())+"' AND MATURITY_DATE<='"+ EITLERPGLOBAL.formatDateDB(txtMaturityDateTo.getText()) +"' ";
        }
        
        if(!txtOldReceiptNo.getText().equals("")) {
            strQuery=strQuery+" AND OLD_RECEIPT_NO='"+txtOldReceiptNo.getText()+"' ";
        }  
    ...
    private void Validate_MaturityDate() {
        
        if(txtMaturityDateTo.isEnabled()){
            if(!txtMaturityDateFrom.equals("")){
                if(!EITLERPGLOBAL.isDate(txtMaturityDateFrom.getText())) {
                    lblShowMessage.setText("Wrong Maturity From Date...");
                    txtMaturityDateFrom.requestFocus();
                    return;
                }
                lblShowMessage.setText("  ...");
                return;
        ...
        if(txtMaturityDateTo.isEnabled()) {
            if(!txtMaturityDateTo.equals("")){
                if(!EITLERPGLOBAL.isDate(txtMaturityDateTo.getText())) {
                    lblShowMessage.setText("Wrong Maturity To Date...");
                    txtMaturityDateTo.requestFocus();
                    return;
                }
                lblShowMessage.setText("  ...");
                return;
    ...
    private javax.swing.JLabel lblMaturityDateFrom;
    private javax.swing.JLabel lblMaturityDateTo;
    ...
    private javax.swing.JLabel llblOldReceiptCode;
    ...
    private javax.swing.JTextField txtMaturityDateFrom;
    private javax.swing.JTextField txtMaturityDateTo;
