...
public class frmCashReceiptVoucher extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if (getName().equals("Link")) {
            ...
            objVoucher.VoucherType = FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblEmployeeNo1 = new javax.swing.JLabel();
        ...
        lblTitle.setText(" CASH RECEIPT VOUCHER");
        ...
        jScrollPane4.setBounds(9, 395, 630, 50);
        ...
        lblEmployeeNo.setBounds(5, 32, 90, 15);
        ...
        txtEmployeeName.setCaretColor(new java.awt.Color(255, 204, 204));
        ...
        jPanel3.add(txtEmployeeName);
        txtEmployeeName.setBounds(310, 30, 310, 19);

        lblEmployeeNo1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblEmployeeNo1.setText("Emp Name :");
        jPanel3.add(lblEmployeeNo1);
        lblEmployeeNo1.setBounds(210, 30, 90, 15);

        Tab1.add(jPanel3);
        jPanel3.setBounds(9, 96, 630, 54);

        jLabel9.setText("Remarks :");
        Tab1.add(jLabel9);
        jLabel9.setBounds(9, 375, 80, 15);
        ...
        cmdRemove.setBounds(110, 135, 86, 20);
        ...
        cmdAddBlank.setBounds(7, 135, 100, 20);
        ...
        cmdSelect.setBounds(202, 135, 100, 20);
        ...
        jPanel2.add(cmdShow);
        cmdShow.setBounds(308, 135, 100, 20);

        jTabbedPane1.addTab("Receipt Information", jPanel2);

        Tab1.add(jTabbedPane1);
        jTabbedPane1.setBounds(8, 175, 630, 190);
        ...
        Tab1.add(jLabel13);
        jLabel13.setBounds(375, 71, 80, 15);
        ...
        Tab1.add(chkAutoAdj);
        chkAutoAdj.setBounds(10, 155, 334, 15);
        ...
        lblStatus.setBounds(3, 550, 650, 22);
...
//            ObjDoc.FindByCompany(CompanyID,DocNo,DocDate);
    ...
    private javax.swing.JLabel lblEmployeeNo1;
    ...
    private void SetFields(boolean pStat) {
        ...
        txtEmployeeName.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            int ModuleID = clsVoucher.CashReceiptVoucherModuleID;
        ...
        try {
            ...
            lblTitle.setText("CASH RECEIPT VOUCHER - " + txtDocNo.getText());
            ...
            txtEmployeeName.setText(objVoucher.objPayment.getAttribute("EMP_NAME").getString());
            txtEmployeeName.setText(objVoucher.getAttribute("EMP_NAME").getString());
            ...
            for (int i = 1; i <= objVoucher.objPayment.colVoucherItems.size(); i++) {
                ...
                if (ObjItem.getAttribute("IS_DEDUCTION").getInt() == 0) {
                    ...
                    DataModel.setValueByVariable("REMARKS", ObjItem.getAttribute("REMARKS").getString(), NewRow);// added on 13 july -- mrugesh
            ...
            List = ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, DocNo);
    ...
    private void SetData() {
        ...
        objVoucher.setAttribute("VOUCHER_TYPE", FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER);
        ...
        /*String LegacyNo = data.getStringValueFromDB("SELECT LEGACY_NO FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO= '"+txtDocNo.getText()+"'",FinanceGlobal.FinURL);
         if(EditMode==EITLERPGLOBAL.EDIT && LegacyNo.equals("")) {
         generateNextLegacyNo(txtDocNo.getText());
         }*/
        ...
        objVoucher.setAttribute("EMP_NAME", txtEmployeeName.getText().trim());
        ...
        if (Table.getRowCount() > 0) {
            ...
            if (Table.getRowCount() >= 1) {
                ...
                objItem.setAttribute("REMARKS", DataModel.getValueByVariable("REMARKS", 0));
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.addColumn("Sub Code"); //2

            DataModel.addColumn("Account Name"); //3
            //   DataModel.addColumn("Employee Name"); //3
            DataModel.addColumn("Invoice No."); //4
            DataModel.addColumn("Invoice Date");//5
            DataModel.addColumn("Amount"); //6
            DataModel.addColumn("Value Date"); //7
            DataModel.addColumn("Remarks"); //8
            DataModel.addColumn("Ref. Doc. No."); //9
            DataModel.addColumn("Date"); //10
            ...
            DataModel.SetVariable(1, "MAIN_ACCOUNT_CODE"); //1 - Read Only
            DataModel.SetVariable(2, "SUB_ACCOUNT_CODE"); //2 - Read Only

            DataModel.SetVariable(3, "ACCOUNT_NAME"); //3 - Read Only
            //   DataModel.SetVariable(4,"EMP_NAME"); //3 - Read Only
            DataModel.SetVariable(4, "INVOICE_NO"); //4
            DataModel.SetVariable(5, "INVOICE_DATE"); //5 //Read Only
            DataModel.SetVariable(6, "AMOUNT"); //6 //Read Only
            DataModel.SetVariable(7, "VALUE_DATE"); //7 //Read Only
            DataModel.SetVariable(8, "REMARKS"); //8 //Read Only
            DataModel.SetVariable(9, "REF_DOC_NO");//9
            DataModel.SetVariable(10, "REF_DOC_DATE");//10
            DataModel.SetVariable(11, "MODULE_NAME");//11
            DataModel.SetVariable(12, "COMPANY_NAME");//12
            DataModel.SetVariable(13, "MODULE_ID");//13
            DataModel.SetVariable(14, "REF_COMPANY_ID");//14
            DataModel.SetVariable(15, "LINK_NO");//15
                ...
                public void tableChanged(TableModelEvent e) {
                    if (e.getType() == TableModelEvent.UPDATE) {
                        ...
                        if (col == DataModel.getColFromVariable("MAIN_ACCOUNT_CODE")) {
                            try {
                                String MainCode = DataModel.getValueByVariable("MAIN_ACCOUNT_CODE", Table.getSelectedRow());
                                String AccountName = clsPartyMaster.getAccountName(MainCode, "");
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.CashReceiptVoucherModuleID);

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsVoucher.CashReceiptVoucherModuleID);
        }

        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (EITLERPGLOBAL.gNewUserID == ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, txtDocNo.getText())) {
                List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.CashReceiptVoucherModuleID));
            } else {
                List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (clsVoucher.CashReceiptVoucherModuleID));
            }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = ApprovalFlow.getRemainingUsers((int) EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        /*if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10802)) {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID((int) EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks((int) EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, FromUserID, objVoucher.getAttribute("VOUCHER_NO").getString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10801)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10803)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10804)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        aList.ModuleID = clsVoucher.CashReceiptVoucherModuleID;
        ...
        if (aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, FFNo, false));
    ...
    private void Edit() {
        ...
        if (objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID, clsVoucher.CashReceiptVoucherModuleID)) {
            ...
            if (ApprovalFlow.IsCreator(clsVoucher.CashReceiptVoucherModuleID, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 10522)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (txtLegacyNo.getText().trim().equals("") || txtLegacyDate.getText().trim().equals("")) {
                JOptionPane.showMessageDialog(null, "Legacy number and Legacy Date not generated.");
                return;
            }
        }
    ...
    private void Find() {
        ...
        if (ObjReturn.Cancelled == false) {
            if (!objVoucher.Filter(ObjReturn.strQuery + " AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER, EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        objVoucher.Filter(" WHERE COMPANY_ID=" + Integer.toString(pCompanyID) + " AND VOUCHER_NO='" + pDocNo + "' AND VOUCHER_TYPE=" + FinanceGlobal.TYPE_CASH_RECEIPT_VOUCHER + " ", pCompanyID);
        objVoucher.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.CashReceiptVoucherModuleID, txtDocNo.getText());
    ...
    private String generateNextLegacyNo(String cVoucherNo) {
        ...
        return Integer.toString(nextLegacyNo);
