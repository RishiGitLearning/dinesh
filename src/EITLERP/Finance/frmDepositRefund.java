...
public class frmDepositRefund extends javax.swing.JApplet {
    
    private int EditMode=0;
    private clsDepositRefund objDepositRefund;
    ...
    public frmDepositRefund() {
        ...
        objDepositRefund = new clsDepositRefund();
        ...
        if(getName().equals("Link")) {
            ...
            if(objDepositRefund.LoadData(EITLERPGLOBAL.gCompanyID)) {
                objDepositRefund.MoveLast();
                DisplayData();
                SetMenuForRights();
            }
            else {
                JOptionPane.showMessageDialog(null,"Error occured while loading data. Error is "+objDepositRefund.LastError);
            }
        }
        ShowMessage("Ready...");
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText(" Deposit Refund");
        ...
        txtReceiptNo.setNextFocusableComponent(txtBookCode);
        ...
        lblRefundDate.setBounds(300, 200, 120, 15);

        txtRefundDate.setName("PARTY_CODE");
        txtRefundDate.setEnabled(false);
        txtRefundDate.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtRefundDateFocusLost(evt);
            }
        });

        Panel1.add(txtRefundDate);
        txtRefundDate.setBounds(430, 200, 120, 19);
        ...
        lblBookCode.setBounds(25, 170, 135, 15);

        txtBookCode.setName("PARTY_CODE");
        txtBookCode.setNextFocusableComponent(txtRefundDate);
        ...
        txtChequeNo.setBounds(170, 230, 120, 19);
        ...
        lblChequeDate.setBounds(300, 230, 120, 15);

        txtChequeDate.setName("PARTY_CODE");
        txtChequeDate.setNextFocusableComponent(cmdNext1);
        txtChequeDate.setEnabled(false);
        txtChequeDate.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtChequeDateFocusLost(evt);
            }
        });

        Panel1.add(txtChequeDate);
        txtChequeDate.setBounds(430, 230, 120, 19);
    ...
    private void txtChequeDateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtChequeDateFocusLost
        //requirement by account to fd premature activities start
        if(java.sql.Date.valueOf(EITLERPGLOBAL.formatDateDB(txtChequeDate.getText().trim())).after(java.sql.Date.valueOf(EITLERPGLOBAL.formatDateDB("31/03/2015")))){
         txtChequeDate.setText("31/03/2015");   
        }
        //requirement by account to fd premature activities end
    }//GEN-LAST:event_txtChequeDateFocusLost

    private void txtRefundDateFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtRefundDateFocusLost
//requirement by account to fd premature activities start
        if(java.sql.Date.valueOf(EITLERPGLOBAL.formatDateDB(txtRefundDate.getText().trim())).after(java.sql.Date.valueOf(EITLERPGLOBAL.formatDateDB("31/03/2015")))){
         txtRefundDate.setText("31/03/2015");   
        }
    //requirement by account to fd premature activities end
    }//GEN-LAST:event_txtRefundDateFocusLost
    ...
    private void txtBookCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBookCodeFocusLost
        ...
        if(!txtBookCode.getText().trim().equals("")) {
            if(data.IsRecordExist("SELECT BOOK_NAME FROM D_FIN_BOOK_MASTER WHERE BOOK_CODE='"+txtBookCode.getText().trim()+"' ",FinanceGlobal.FinURL)) {
                txtBankName.setText(data.getStringValueFromDB("SELECT BOOK_NAME FROM D_FIN_BOOK_MASTER WHERE BOOK_CODE='"+txtBookCode.getText().trim()+"' ",FinanceGlobal.FinURL));
            } else {
                txtBankName.setText("");
            }
        } else {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD || EditMode==EITLERPGLOBAL.EDIT) {
                if(evt.getKeyCode()==112) //F1 Key pressed
                {
                    ...
                    aList.SQL="SELECT RECEIPT_NO,RECEIPT_DATE,APPLICANT_NAME FROM D_FD_DEPOSIT_MASTER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND DEPOSIT_STATUS=0 ORDER BY RECEIPT_NO";
                    aList.ReturnCol=1;
                    aList.ShowReturnCol=true;
                    aList.DefaultSearchOn=2;
                    aList.UseSpecifiedConn=true;
    ...
    private void cmdNormalViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNormalViewActionPerformed
        // TODO add your handling code here:
        objDepositRefund.LoadData(EITLERPGLOBAL.gCompanyID);
        MoveFirst();
    }//GEN-LAST:event_cmdNormalViewActionPerformed
    
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        // TODO add your handling code here:
        objDepositRefund.ShowHistory(EITLERPGLOBAL.gCompanyID, objDepositRefund.getAttribute("DOC_NO").toString());
        MoveFirst();
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            GenerateRejectedUserCombo();
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,clsDepositRefund.ModuleID , txtDocNo.getText())) {
                //objDepositRefund.getAttribute("DOC_NO").toString()
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private void DisplayData() {
        ...
        try {
            if(EditMode==0) {
                if(objDepositRefund.getAttribute("APPROVED").getInt()==1) {
                ...
                if(objDepositRefund.getAttribute("CANCELLED").getInt()==1) {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsDepositRefund.ModuleID;
        ...
        txtDocNo.setText(objDepositRefund.getAttribute("DOC_NO").getString());
        txtDocDate.setText(EITLERPGLOBAL.formatDate(objDepositRefund.getAttribute("DOC_DATE").getString()));
        txtReceiptNo.setText(objDepositRefund.getAttribute("RECEIPT_NO").getString());
        txtReceiptDate.setText(EITLERPGLOBAL.formatDate(objDepositRefund.getAttribute("RECEIPT_DATE").getString()));
        txtApplicantName.setText(objDepositRefund.getAttribute("APPLICANT_NAME").getString());
        txtEffectiveDate.setText(EITLERPGLOBAL.formatDate(objDepositRefund.getAttribute("EFFECTIVE_DATE").getString()));
        txtMaturityDate.setText(EITLERPGLOBAL.formatDate(objDepositRefund.getAttribute("MATURITY_DATE").getString()));
        txtMainAccountCode.setText(objDepositRefund.getAttribute("MAIN_ACCOUNT_CODE").getString());
        txtSubAccountCode.setText(objDepositRefund.getAttribute("SUB_ACCOUNT_CODE").getString());
        txtBookCode.setText(objDepositRefund.getAttribute("BOOK_CODE").getString());
        txtBankName.setText(objDepositRefund.getAttribute("BANK_NAME").getString());
        txtAmount.setText(Double.toString(objDepositRefund.getAttribute("AMOUNT").getDouble()));
        txtRefundDate.setText(EITLERPGLOBAL.formatDate(objDepositRefund.getAttribute("REFUND_DATE").getString()));
        txtChequeNo.setText(objDepositRefund.getAttribute("CHEQUE_NO").getString());
        txtChequeDate.setText(EITLERPGLOBAL.formatDate(objDepositRefund.getAttribute("CHEQUE_DATE").getString()));
        
        SetupApproval();
        
        EITLERPGLOBAL.setComboIndex(cmbHierarchy,objDepositRefund.getAttribute("HIERARCHY_ID").getString());
        
        //======== Generating Grid for Document Approval Flow ========//
        FormatGridA();
        HashMap List=new HashMap();
        String DocNo=objDepositRefund.getAttribute("DOC_NO").getString();
        List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID , DocNo);
        ...
        HashMap History=clsDepositRefund.getHistoryList(EITLERPGLOBAL.gCompanyID, objDepositRefund.getAttribute("DOC_NO").getString());
        for(int i=1;i<=History.size();i++) {
            clsDepositRefund ObjHistory=(clsDepositRefund)History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        objDepositRefund.setAttribute("FFNO",FFNo);
        objDepositRefund.setAttribute("DOC_NO",txtDocNo.getText());
        objDepositRefund.setAttribute("DOC_DATE",txtDocDate.getText());
        
        objDepositRefund.setAttribute("RECEIPT_NO",txtReceiptNo.getText());
        objDepositRefund.setAttribute("RECEIPT_DATE",txtReceiptDate.getText());
        objDepositRefund.setAttribute("APPLICANT_NAME",txtApplicantName.getText());
        objDepositRefund.setAttribute("EFFECTIVE_DATE",txtEffectiveDate.getText());
        objDepositRefund.setAttribute("MATURITY_DATE",txtMaturityDate.getText());
        objDepositRefund.setAttribute("MAIN_ACCOUNT_CODE",txtMainAccountCode.getText());
        objDepositRefund.setAttribute("SUB_ACCOUNT_CODE",txtSubAccountCode.getText());
        objDepositRefund.setAttribute("BOOK_CODE",txtBookCode.getText().trim());
        objDepositRefund.setAttribute("BANK_NAME",txtBankName.getText());
        objDepositRefund.setAttribute("AMOUNT",Double.parseDouble(txtAmount.getText()));
        objDepositRefund.setAttribute("REFUND_DATE",txtRefundDate.getText());
        objDepositRefund.setAttribute("CHEQUE_NO",txtChequeNo.getText());
        objDepositRefund.setAttribute("CHEQUE_DATE",txtChequeDate.getText());
        
        //----- Update Approval Specific Fields -----------//
        objDepositRefund.setAttribute("HIERARCHY_ID",EITLERPGLOBAL.getComboCode(cmbHierarchy));
        objDepositRefund.setAttribute("FROM",EITLERPGLOBAL.gNewUserID);
        objDepositRefund.setAttribute("TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        objDepositRefund.setAttribute("FROM_REMARKS",txtToRemarks.getText());
        
        if(OpgApprove.isSelected()) {
            objDepositRefund.setAttribute("APPROVAL_STATUS","A");
        }
        
        if(OpgFinal.isSelected()) {
            objDepositRefund.setAttribute("APPROVAL_STATUS","F");
        }
        
        if(OpgReject.isSelected()) {
            objDepositRefund.setAttribute("APPROVAL_STATUS","R");
            objDepositRefund.setAttribute("SEND_DOC_TO",EITLERPGLOBAL.getComboCode(cmbSendTo));
        }
        
        if(OpgHold.isSelected()) {
            objDepositRefund.setAttribute("APPROVAL_STATUS","H");
        }
        //-------------------------------------------------//
    }
    ...
    private void SetMenuForRights() {
        ...
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,11041)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Edit Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,11042)) {
            cmdEdit.setEnabled(true);
        }
        else {
            cmdEdit.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,11043)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
    ...
    private void Add() {
        ...
        aList.ModuleID=clsDepositRefund.ModuleID;
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID , FFNo,  false));
    ...
    private void Edit() {
        ...
        if(objDepositRefund.IsEditable(EITLERPGLOBAL.gCompanyID, DocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if(ApprovalFlow.IsCreator(clsDepositRefund.ModuleID ,DocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 1104,11042)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Delete() {
        ...
        if(objDepositRefund.Delete(EITLERPGLOBAL.gNewUserID)) {
            MoveLast();
        }
    }
    ...
    private void Save() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            if(objDepositRefund.Insert()) {
                MoveLast();
                DisplayData();
            }
            else {
                JOptionPane.showMessageDialog(null,"Error occured while saving. Error is "+objDepositRefund.LastError);
                EITLERPGLOBAL.ChangeCursorToDefault(this);
                return;
            }
        }
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Finance.frmDepositRefundFind",true);
        frmDepositRefundFind ObjReturn= (frmDepositRefundFind) ObjLoader.getObj();
        
        if(ObjReturn.Cancelled==false) {
            if(!objDepositRefund.Filter(ObjReturn.strQuery,EITLERPGLOBAL.gCompanyID)) {
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        objDepositRefund.Filter(" WHERE COMPANY_ID="+pCompanyID+" AND DOC_NO='"+pDocNo+"' ", pCompanyID);
        objDepositRefund.MoveFirst();
        DisplayData();
    }
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID , objDepositRefund.getAttribute("DOC_NO").toString());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsDepositRefund.ModuleID ,FromUserID,objDepositRefund.getAttribute("DOC_NO").toString());
            EITLERPGLOBAL.setComboIndex(cmbHierarchy,objDepositRefund.getAttribute("HIERARCHY_ID").getInt());
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID ,objDepositRefund.getAttribute("DOC_NO").toString());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID , objDepositRefund.getAttribute("DOC_NO").getString(), ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID, objDepositRefund.getAttribute("DOC_NO").getString(), ObjUser.getAttribute("USER_ID").getInt() , EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsDepositRefund.ModuleID , objDepositRefund.getAttribute("DOC_NO").getString());
    ...
    private void GenerateCombos() {
        try {
            ...
            List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsDepositRefund.ModuleID);
            
            if(EditMode==EITLERPGLOBAL.EDIT) {
                List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsDepositRefund.ModuleID );
            }
            for(int i=1;i<=List.size();i++) {
    ...
    private boolean Validate() {
        ...
        //requirement by account to fd premature activities end
        if(txtBookCode.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null,"Please Enter The Book Code.");
            return false;
        }
