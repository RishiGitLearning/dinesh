...
public class frmPaymentVoucher2 extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if(getName().equals("Link")) {
            ...
            objVoucher.VoucherType=FinanceGlobal.TYPE_PAYMENT_2;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText(" PAYMENT VOUCHER (2)");
        ...
        Tab1.add(txtDocNo);
        txtDocNo.setBounds(110, 14, 160, 19);

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Date :");
        Tab1.add(jLabel3);
        jLabel3.setBounds(364, 16, 38, 15);
        ...
        txtBookCode.setBounds(110, 37, 102, 19);
        ...
        jScrollPane4.setBounds(10, 378, 630, 50);
        ...
        Tab1.add(jLabel9);
        jLabel9.setBounds(10, 360, 80, 15);
        ...
        lblAdvancePaid.setBounds(18, 53, 240, 15);
        ...
        lblRealizationDate.setBounds(382, 32, 120, 15);

        txtRealizationDate.setName("REQ_DATE");
        txtRealizationDate.setEnabled(false);
        jPanel4.add(txtRealizationDate);
        txtRealizationDate.setBounds(510, 30, 102, 19);

        Tab1.add(jPanel4);
        jPanel4.setBounds(7, 87, 630, 72);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(429, 135, 80, 15);
        ...
        jTabbedPane1.addTab("Pay to", jPanel2);

        Tab1.add(jTabbedPane1);
        jTabbedPane1.setBounds(8, 160, 630, 190);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel13.setText("Legacy No. :");
        Tab1.add(jLabel13);
        jLabel13.setBounds(20, 63, 85, 15);
        ...
        txtLegacyNo.setBounds(110, 61, 102, 19);

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel14.setText("Date :");
        Tab1.add(jLabel14);
        jLabel14.setBounds(217, 65, 40, 15);
        ...
        txtLegacyDate.setBounds(262, 63, 102, 19);
        ...
        lblStatus.setBounds(3, 531, 650, 22);
        ...
        try {
            ...
            if(!objSelect.Cancelled) {
                ...
                for(int r=1;r<=objSelect.SelectedItems.size();r++) {
                    ...
                    DataModel.setValueByVariable("LINK_NO",clsSalesInvoice.getAgentAlphaSrNo(objItem.getAttribute("INVOICE_NO").getString(),objItem.getAttribute("INVOICE_DATE").getString()),NewRow);
                }
        ...
        try {
            ...
            if(evt.getKeyCode()==112) { //F1 Key
                ...
                if(Table.getSelectedColumn() == DataModel.getColFromVariable("DEDUCTIONS")) {
                    ...
                    objForm.vType = FinanceGlobal.TYPE_PAYMENT_2;
                    
                    objForm.MainCode = DataModel.getValueByVariable("MAIN_ACCOUNT_CODE",Table.getSelectedRow());//Table.getValueAt(Table.getSelectedRow(),1).toString();
                    objForm.PartyCode= DataModel.getValueByVariable("SUB_ACCOUNT_CODE",Table.getSelectedRow()); //Table.getValueAt(Table.getSelectedRow(),2).toString();
            ...
            if(EditMode!=0) { //Only Process keys when in editing mode
                if(evt.getKeyCode()==112) {//F1 Key pressed
                    ...
                    if(Table.getSelectedColumn()==DataModel.getColFromVariable("SUB_ACCOUNT_CODE")) {
                        ...
                        aList.SQL="SELECT PARTY_CODE,PARTY_NAME FROM D_FIN_PARTY_MASTER WHERE MAIN_ACCOUNT_CODE = '"+Table.getValueAt(Table.getSelectedRow(),1).toString()+"' AND APPROVED=1 AND CANCELLED=0 ORDER BY PARTY_NAME";
                        aList.ReturnCol=1;
                        aList.ShowReturnCol=true;
                        aList.DefaultSearchOn=2;
                        aList.UseSpecifiedConn=true;
    ...
    private void DisplayData() {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsVoucher.Payment2ModuleID;
        ...
        try {
            ...
            lblTitle.setText("PAYMENT VOUCHER (2) - "+txtDocNo.getText());
            ...
            txtNetAmount.setText(EITLERPGLOBAL.formatNumber(objVoucher.objPayment.getAttribute("CHEQUE_AMOUNT").getDouble()));
            ...
            for(int i=1;i<=objVoucher.objPayment.colVoucherItems.size();i++) {
                ...
                if(ObjItem.getAttribute("IS_DEDUCTION").getInt()==0) {
                    ...
                    DataModel.setValueByVariable("INVOICE_NO",ObjItem.getAttribute("INVOICE_NO").getString(),NewRow);
                    DataModel.setValueByVariable("INVOICE_DATE",ObjItem.getAttribute("INVOICE_DATE").getString(),NewRow);
                    DataModel.setValueByVariable("INVOICE_AMOUNT", EITLERPGLOBAL.formatNumber(ObjItem.getAttribute("AMOUNT").getDouble()+ObjItem.getAttribute("DEDUCTION_AMOUNT").getDouble() ),NewRow);
                    ...
                    DataModel.setValueByVariable("AMOUNT",EITLERPGLOBAL.formatNumber(ObjItem.getAttribute("AMOUNT").getVal()),NewRow);
                    DataModel.setValueByVariable("PO_NO",ObjItem.getAttribute("PO_NO").getString(),NewRow);
                    DataModel.setValueByVariable("PO_DATE",ObjItem.getAttribute("PO_DATE").getString(),NewRow);
            ...
            List=ApprovalFlow.getDocumentFlow(EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID, DocNo);
    ...
    private void SetData() {
        ...
        //objVoucher.objPayment.setAttribute("COMPANY_ID",2);
        objVoucher.objPayment.setAttribute("VOUCHER_NO",txtDocNo.getText());
        objVoucher.objPayment.setAttribute("VOUCHER_TYPE",FinanceGlobal.TYPE_PAYMENT_2);
        ...
        objVoucher.objPayment.setAttribute("CHEQUE_DATE",txtChequeDate.getText());
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.SetVariable(4,"INVOICE_AMOUNT"); //2 //Read Only
            DataModel.SetVariable(5,"DEDUCTIONS"); //2 //Read Only
            DataModel.SetVariable(6,"AMOUNT"); //2 //Read Only
            DataModel.SetVariable(7,"LINK_NO"); //1
            DataModel.SetVariable(8,"INVOICE_NO"); //1
            DataModel.SetVariable(9,"INVOICE_DATE"); //2 //Read Only
            DataModel.SetVariable(10,"PO_NO");
            DataModel.SetVariable(11,"PO_DATE");
            DataModel.SetVariable(12,"REF_DOC_NO");
            DataModel.SetVariable(13,"REF_DOC_DATE");
            ...
            Table.getColumnModel().getColumn(10).setCellRenderer(POColor);
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    try {
                        ...
                        if(last==DataModel.getColFromVariable("MAIN_ACCOUNT_CODE")||last==DataModel.getColFromVariable("SUB_ACCOUNT_CODE")) {
                            ...
                            double AdvancePaid=clsAccount.getAdvancePaymentAmount(EITLERPGLOBAL.gCompanyID, MainCode,SubCode);
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsVoucher.Payment2ModuleID);
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsVoucher.Payment2ModuleID);
        }
        
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            if(EITLERPGLOBAL.gNewUserID==ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID ,txtDocNo.getText())) {
                List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+(clsVoucher.Payment2ModuleID));
            }
            else {
                List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+(clsVoucher.Payment2ModuleID));
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID ,objVoucher.getAttribute("VOUCHER_NO").getString());
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID ,objVoucher.getAttribute("VOUCHER_NO").getString());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsVoucher.Payment2ModuleID ,FromUserID,objVoucher.getAttribute("VOUCHER_NO").getString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10911)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
    ...
    private void Add() {
        ...
        aList.ModuleID=clsVoucher.Payment2ModuleID;
        ...
        if(aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID , FFNo,  false));
    ...
    private void Edit() {
        ...
        if(objVoucher.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID,clsVoucher.Payment2ModuleID)) {
            ...
            if(ApprovalFlow.IsCreator(clsVoucher.Payment2ModuleID ,lDocNo)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,10522)) {
                SetFields(true);
            }
            else {
                EnableApproval();
    ...
    private void Save() {
        ...
        for(int i=0;i<=Table.getRowCount()-1;i++) {
            ...
            if(MainCode.equals("125019")) {
                ...
                if(Balance>0) {
                    String Msg = "Party : " + PartyCode + " has debit balance Rs."+ Balance + "\nDo you want to continue ?";
    ...
    private void Find() {
        ...
        ObjReturn.VoucherType=FinanceGlobal.TYPE_PAYMENT_2;
        
        if(ObjReturn.Cancelled==false) {
            if(!objVoucher.Filter(ObjReturn.strQuery+" AND VOUCHER_TYPE="+FinanceGlobal.TYPE_PAYMENT_2,EITLERPGLOBAL.gCompanyID)) {
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID , txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsVoucher.Payment2ModuleID ,txtDocNo.getText());
    ...
    private void UpdateTotals() {
        ...
        try {
            ...
            txtNetAmount.setText(EITLERPGLOBAL.formatNumber(NetAmount));
