...
public class frmLedgeroldrajpal extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmdShowVoucher.setBounds(8, 455, 140, 25);

        cmdPrint.setText("Print Ledger");
        ...
        cmdPrint.setBounds(157, 455, 140, 25);
        ...
        cmdShow.setText("Generate Ledger");
        ...
        jPanel1.add(cmdShow);
        cmdShow.setBounds(122, 231, 160, 25);
        ...
        cmdNewLedger.setText("Generate New Ledger");
        ...
        cmdNewLedger.setBounds(310, 230, 180, 25);

        cmdNewPrintLedger.setForeground(new java.awt.Color(255, 51, 102));
        cmdNewPrintLedger.setText("Print New Ledger");
        ...
        cmdNewPrintLedger.setBounds(310, 270, 180, 25);
        ...
        cmdPrintSummary.setBounds(308, 455, 173, 25);
        ...
        cmdAdvReceipt.setBounds(490, 455, 120, 25);
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModel.SetVariable(5,"CHEQUE_NO"); //5
            DataModel.SetVariable(6,"DEBIT_AMOUNT"); //6
            DataModel.SetVariable(7,"CREDIT_AMOUNT"); //7
            DataModel.SetVariable(8,"CLOSING_BALANCE"); //8
            DataModel.SetVariable(9,"LINK_NO"); //9
            DataModel.SetVariable(10,"INVOICE_NO"); //10
            DataModel.SetVariable(11,"INVOICE_DATE"); //11
            DataModel.SetVariable(12,"GRN_NO"); //12
            DataModel.SetVariable(13,"GRN_DATE"); //13
            DataModel.SetVariable(14,"PO_NO"); //14
            DataModel.SetVariable(15,"PO_DATE"); //15
    ...
    private void GenerateGrid() {
        try {
            ...
            for(int i=1;i<=(List.size()-1);i++) {
                ...
                rowData[5]=objItem.getAttribute("CHEQUE_NO").getString();
                if(objItem.getAttribute("DEBIT_AMOUNT").getDouble()==0) {
                    rowData[6]="";
                } else {
                    rowData[6]=dFormat.format(objItem.getAttribute("DEBIT_AMOUNT").getDouble());
                ...
                if(objItem.getAttribute("CREDIT_AMOUNT").getDouble()==0) {
                    ...
                    rowData[7]=dFormat.format(objItem.getAttribute("CREDIT_AMOUNT").getDouble());
                    CreditTotal+=objItem.getAttribute("CREDIT_AMOUNT").getDouble();
                }
                
                if(objItem.getAttribute("CLOSING_BALANCE").getDouble()<0) {
                    rowData[8]=dFormat.format(Math.abs(objItem.getAttribute("CLOSING_BALANCE").getDouble()))+" Cr";
                }
                else {
                    rowData[8]=dFormat.format(objItem.getAttribute("CLOSING_BALANCE").getDouble())+" Dr";
                }
                if((MainAccountCode.equals("210027") || MainAccountCode.equals("210010") || MainAccountCode.equals("210072")) && (!objItem.getAttribute("INVOICE_NO").getString().equals("")) && (objItem.getAttribute("LINK_NO").getString().equals(""))) {
                    rowData[9]=EITLERP.Sales.clsSalesInvoice.getAgentAlphaSrNo(objItem.getAttribute("INVOICE_NO").getString(), EITLERPGLOBAL.formatDateDB(objItem.getAttribute("INVOICE_DATE").getString()));
                } else {
                    rowData[9]=objItem.getAttribute("LINK_NO").getString();
                }
                
                rowData[10]=objItem.getAttribute("INVOICE_NO").getString();
                rowData[11]=objItem.getAttribute("INVOICE_DATE").getString();
                rowData[12]=objItem.getAttribute("GRN_NO").getString();
                rowData[13]=objItem.getAttribute("GRN_DATE").getString();
                rowData[14]=objItem.getAttribute("PO_NO").getString();
                rowData[15]=objItem.getAttribute("PO_DATE").getString();
    ...
    public static void advReceiptDetail(String MainCode, String FromSubCode ,String AsOnDate) {
        ...
        try {
            ...
            "WHERE A.VOUCHER_NO = B.VOUCHER_NO AND A.VOUCHER_DATE<='"+AsOnDate+"' AND A.VOUCHER_TYPE IN (6,7,8,9)  AND B.MAIN_ACCOUNT_CODE='"+MainCode+"' " + Condition + " " +
