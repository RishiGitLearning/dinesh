...
public class frmRptDueReceipts extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel6.setText("DUE RECEIPT REPORT");
        jPanel3.add(jLabel6);
    ...
    private void GenerateReport() {
        try {
            ...
            "AND DMST.COMPANY_ID = SMST.COMPANY_ID AND DMST.SCHEME_ID = SMST.SCHEME_ID AND SMST.SCHEME_TYPE='" + ReceiptType + "' AND DEPOSIT_STATUS IN (0,1) "+
            "AND DMST.MATURITY_DATE >= '"+ EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"' "+
            "AND DMST.MATURITY_DATE <= '"+ EITLERPGLOBAL.formatDateDB(txtToDate.getText()) +"' ORDER BY DMST.MATURITY_DATE";
            ...
            //FD Due Receipt
            if (ReceiptType == 1) {
                objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/finance/rptFDDueReceipt.rpt",Parameters,objReportData);
            }
            
            //CD Due Receipt
            if (ReceiptType == 2) {
                objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/finance/rptCDDueReceipt.rpt",Parameters,objReportData);
            }
            
            //LD Due Receipt
            if (ReceiptType == 3) {
                objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/finance/rptLDDueReceipt.rpt",Parameters,objReportData);
            }
    ...
    private void GenerateSummary() {
        try {
            ...
            String strSQL = "";
                ...
                "WHERE DEPOSITMST.COMPANY_ID =" + EITLERPGLOBAL.gCompanyID + " AND DEPOSITMST.DEPOSIT_STATUS IN (0,1) "+
                "AND DEPOSITMST.CANCELLED=0  AND DEPOSITMST.APPROVED=1 "+
                "AND DEPOSITMST.MATURITY_DATE >= '"+ EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"' AND DEPOSITMST.MATURITY_DATE <= '"+ EITLERPGLOBAL.formatDateDB(txtToDate.getText()) +"' "+
            ...
            //FD Due Receipt
            if (ReceiptType == 1) {
                objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/finance/rptFDDueReceiptSummary.rpt",Parameters,objReportData);
            }
            
            //CD Due Receipt
            if (ReceiptType == 2) {
                objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/finance/rptCDDueReceiptSummary.rpt",Parameters,objReportData);
            }
            
            //LD Due Receipt
            if (ReceiptType == 3) {
                objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/finance/rptLDDueReceiptSummary.rpt",Parameters,objReportData);
            }
