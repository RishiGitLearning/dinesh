...
import EITLERP.Production.ReportUI.clsExcelExporter;
import java.io.File;

public class frmRptPreMaturityReceiptsWithExcel extends javax.swing.JApplet {
    
    private clsExcelExporter exp = new clsExcelExporter();
    private EITLComboModel cmbReceiptTypeModel;
    private EITLTableModel DataModelForExcel = new EITLTableModel();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        TableForExcel = new javax.swing.JTable();
        ...
        cmdPreview.setBounds(70, 140, 130, 25);
        ...
        cmdPreviewSummary.setBounds(220, 140, 160, 25);
        ...
        TableForExcel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(TableForExcel);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(10, 20, 660, 300);

        jTabbedPane1.addTab("tab1", jPanel1);

        getContentPane().add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 260, 680, 330);
        ...
        jButton1.setBounds(70, 170, 88, 25);
        ...
        jButton2.setBounds(20, 600, 88, 25);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
                     ...
                     exp.fillData(TableForExcel,new File("/root/Desktop/ExcelTable.xls"));
                    //exp.fillData(TableI,new File("C://ProductionProcess.xls"));
                     exp.fillData(TableForExcel,new File("D://ExcelTable.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            //"'C: \\ result.xls' successfully", "Message",
                            "'/root/Desktop/ExcelTable.xls' successfully in Linux PC or 'D://ExcelTable.xls' successfully in Windows PC    ", "Message",
    ...
    private javax.swing.JTable TableForExcel;
    ...
    private void FormatGridExcelTable() {
       DataModelForExcel=new EITLTableModel();
        TableForExcel.removeAll();
        TableForExcel.setModel(DataModelForExcel);
        
        TableForExcel.setAutoResizeMode(TableForExcel.AUTO_RESIZE_OFF);
        DataModelForExcel.addColumn("Sr.");
        DataModelForExcel.addColumn("Company ID");
        DataModelForExcel.addColumn("Receipt No");
        DataModelForExcel.addColumn("Legacy No");
        DataModelForExcel.addColumn("Receipt Date");
        DataModelForExcel.addColumn("Applicant Name");
        DataModelForExcel.addColumn("Address1");
        DataModelForExcel.addColumn("Address2");
        DataModelForExcel.addColumn("Address3");
        DataModelForExcel.addColumn("City");        
        DataModelForExcel.addColumn("Effective Date");
        DataModelForExcel.addColumn("Maturity Date");
        DataModelForExcel.addColumn("Party code");
        DataModelForExcel.addColumn("Amount");
        DataModelForExcel.addColumn("Deposit Period");
        DataModelForExcel.addColumn("Interest Rate");       
        DataModelForExcel.addColumn("PM Date");
         DataModelForExcel.addColumn("Old Receipt No");
        DataModelForExcel.addColumn("Depositor Catagory");
        DataModelForExcel.addColumn("Broker Code");
        DataModelForExcel.addColumn("Scheme Type");
        DataModelForExcel.TableReadOnly(true); 
        TableForExcel.getColumnModel().getColumn(0).setMaxWidth(50);
    }
    
    private void GenerateTable(){
        try{
        FormatGridExcelTable();  //clear existing content of table          
        ResultSet rsTmp,rsBuyer,rsIndent,rsRIA;
        String strSQL= "";                
        strSQL+="SELECT DMST.COMPANY_ID, DMST.RECEIPT_NO,DMST.LEGACY_NO, DMST.RECEIPT_DATE, DMST.APPLICANT_NAME,ADDRESS1,ADDRESS2,ADDRESS3,CITY,DMST.EFFECTIVE_DATE, DMST.MATURITY_DATE, DMST.PARTY_CODE, DMST.AMOUNT, DMST.DEPOSIT_PERIOD, DMST.INTEREST_RATE, DMST.PM_DATE,DMST.OLD_RECEIPT_NO, CASE WHEN DMST.DEPOSITER_CATEGORY = 1 THEN 'E' WHEN DMST.DEPOSITER_CATEGORY = 2 THEN 'S' WHEN DMST.DEPOSITER_CATEGORY = 3 THEN 'C'  WHEN DMST.DEPOSITER_CATEGORY = 4 THEN 'D' WHEN DMST.DEPOSITER_CATEGORY = 5 THEN 'I' ELSE '' END DEPOSITER_CATEGORY, DMST.BROKER_CODE , CASE WHEN SMST.SCHEME_TYPE = 1 THEN 'FD' WHEN SMST.SCHEME_TYPE = 2 THEN 'LD' WHEN SMST.SCHEME_TYPE = 3 THEN 'CD' ELSE '' END SCHEME_TYPE FROM FINANCE.D_FD_DEPOSIT_MASTER DMST, FINANCE.D_FD_SCHEME_MASTER SMST WHERE DMST.COMPANY_ID =2 AND DMST.DEPOSIT_STATUS=2 AND DMST.PREMATURE=1 AND DMST.APPROVED=1 AND DMST.CANCELLED=0  AND DMST.COMPANY_ID = SMST.COMPANY_ID AND DMST.SCHEME_ID = SMST.SCHEME_ID AND DMST.PM_DATE >= '"+ EITLERPGLOBAL.formatDateDB(txtFromDate.getText().trim()) +"' AND DMST.PM_DATE <= '"+ EITLERPGLOBAL.formatDateDB(txtToDate.getText().trim()) +"' ORDER BY PM_DATE";                     
        System.out.println(strSQL);
        ...
        if(rsTmp.getRow()>0) {
                ...
                while(!rsTmp.isAfterLast()) {
                    ...
                    rowData[1]=rsTmp.getString("DMST.COMPANY_ID");
                    rowData[2]=rsTmp.getString("DMST.RECEIPT_NO");
                    rowData[3]=rsTmp.getString("DMST.LEGACY_NO");
                    rowData[4]=EITLERPGLOBAL.formatDate(rsTmp.getString("DMST.RECEIPT_DATE"));
                    rowData[5]=rsTmp.getString("DMST.APPLICANT_NAME");
                    rowData[6]=rsTmp.getString("ADDRESS1");
                    rowData[7]=rsTmp.getString("ADDRESS2");
                    rowData[8]=rsTmp.getString("ADDRESS3");
                    rowData[9]=rsTmp.getString("CITY");                    
                    rowData[10]=EITLERPGLOBAL.formatDate(rsTmp.getString("DMST.EFFECTIVE_DATE"));
                    rowData[11]=EITLERPGLOBAL.formatDate(rsTmp.getString("DMST.MATURITY_DATE"));
                    rowData[12]=rsTmp.getString("DMST.PARTY_CODE");
                    rowData[13]=rsTmp.getString("DMST.AMOUNT");
                    rowData[14]=rsTmp.getString("DMST.DEPOSIT_PERIOD");
                    rowData[15]=rsTmp.getString("DMST.INTEREST_RATE");
                    rowData[16]=EITLERPGLOBAL.formatDate(rsTmp.getString("DMST.PM_DATE"));
                    rowData[17]=rsTmp.getString("DMST.OLD_RECEIPT_NO");
                    rowData[18]=rsTmp.getString("DEPOSITER_CATEGORY");
                    rowData[19]=rsTmp.getString("DMST.BROKER_CODE");                    
                    rowData[20]=rsTmp.getString("SCHEME_TYPE");                                        
                    DataModelForExcel.addRow(rowData);
                    rsTmp.next();
                }
         }
      }
