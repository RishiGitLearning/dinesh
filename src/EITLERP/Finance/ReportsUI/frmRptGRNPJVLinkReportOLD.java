...
public class frmRptGRNPJVLinkReportOLD extends javax.swing.JApplet {
                ...
                while(!rsTmp.isAfterLast()) {
                    ...
                    if (!SupplierCode.trim().equals("888888") && !SupplierCode.trim().equals("999999")) {
                        ...
                        if(GRNValue>0) {
                            ...
                            "AND A.COMPANY_ID=B.COMPANY_ID AND EFFECT='C' AND MAIN_ACCOUNT_CODE<>'' AND SUB_ACCOUNT_CODE<>'' AND A.VOUCHER_TYPE=1 " +
                            "AND B.MODULE_ID=8 AND A.CANCELLED=0 AND B.GRN_NO='"+GRNNo+"' AND A.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" ";
                            ...
                            for(int n=0;n<sMIRList.length;n++) {
                                ...
                                " AND A.VOUCHER_NO=B.VOUCHER_NO AND B.GRN_NO='"+sMIRList[n]+"' AND B.MODULE_ID=6 AND B.EFFECT='C' ";
                            ...
                            if(rsVoucher.getRow()>0) {
                                ...
                                while(!rsVoucher.isAfterLast()) {
                                    ...
                                    "WHERE VOUCHER_NO='"+VoucherNo+"' AND EFFECT='C' AND MAIN_ACCOUNT_CODE<>'' AND SUB_ACCOUNT_CODE<>'' ",FinanceGlobal.FinURL);
                                ...
                                for(int n=0;n<sMIRList.length;n++) {
                                    ...
                                    strQry = "SELECT SUM(B.AMOUNT) FROM D_FIN_VOUCHER_HEADER A, D_FIN_VOUCHER_DETAIL B "+
                                    " WHERE A.CANCELLED=0 AND A.APPROVED=1  " +
                                    " AND A.VOUCHER_NO=B.VOUCHER_NO AND B.GRN_NO='"+sMIRList[n]+"' AND B.MODULE_ID=6 AND EFFECT='C' ";
                                    FinanceFreightAmount  = FinanceFreightAmount + data.getDoubleValueFromDB(strQry,FinanceGlobal.FinURL);
                                }
