...
public class frmDMwithoutDNCancellationFind extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        lblPartyCode.setBounds(5, 100, 80, 16);
    ...
    private void txtPartyCodeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPartyCodeFocusLost
        ...
        txtPartyName.setText(clsAccount.getAccountName(txtMainCode.getText().trim(),txtPartyCode.getText()));
    ...
    private void txtPartyCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPartyCodeKeyPressed
        ...
        try {
            ...
            if(evt.getKeyCode()==112) {
                ...
                LOV aList=new LOV();
                Condition = txtMainCode.getText().trim();
                if(!Condition.equals("")) {
                    Condition = " AND MAIN_ACCOUNT_CODE='"+Condition+"' ";
                } else {
                    Condition = "";
                }
                aList.SQL="SELECT PARTY_CODE,PARTY_NAME FROM D_FIN_PARTY_MASTER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND APPROVED=1 " + Condition +
                "ORDER BY PARTY_NAME";
                aList.ReturnCol=1;
                ...
                if(aList.ShowLOV()) {
                    ...
                    txtPartyName.setText(clsAccount.getAccountName(txtMainCode.getText().trim(),txtPartyCode.getText().trim()));
                }
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!txtFromDate.getText().equals("")) {
            strQuery=strQuery+" AND DOC_DATE>='"+EITLERPGLOBAL.formatDateDB(txtFromDate.getText().trim())+"' ";
        }
        
        if(!txtToDate.getText().equals("")) {
            strQuery=strQuery+" AND DOC_DATE<='"+EITLERPGLOBAL.formatDateDB(txtToDate.getText().trim())+"' ";
        }
        
        if(!txtMainCode.getText().equals("")) {
            strQuery=strQuery+" AND MAIN_ACCOUNT_CODE='"+txtMainCode.getText().trim()+"' ";
        }
        
        if(!txtPartyCode.getText().equals("")) {
            strQuery=strQuery+" AND PARTY_CODE='"+txtPartyCode.getText().trim()+"' ";
        }
