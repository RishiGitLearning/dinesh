...
public class frmInvoiceFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtDateTo.setNextFocusableComponent(cmbInvoiceType);
        jPanel1.add(txtDateTo);
        txtDateTo.setBounds(282, 50, 130, 19);

        jLabel5.setText("Invoice Type");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(8, 91, 80, 15);

        jPanel1.add(cmbInvoiceType);
        cmbInvoiceType.setBounds(99, 87, 228, 24);

        jLabel6.setDisplayedMnemonic('G');
        jLabel6.setLabelFor(txtDocNo);
        jLabel6.setText("Party Code");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(22, 129, 80, 15);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
           strQuery=strQuery+" AND INVOICE_TYPE="+EITLERPGLOBAL.getComboCode(cmbInvoiceType)+" ";  
       }
    ...
    private void GenerateCombos()
    {
        ...
        cmbInvoiceType.setModel(cmbInvoiceModel);
        
        ComboData objData=new ComboData();
        objData.Code=1;
        objData.Text="Suiting";
        cmbInvoiceModel.addElement(objData);
