 ...
 */
public class clsSalesSeasonImport {
    ...
    public boolean ImportSalesOrders(String InitialDir) {
        try {
            ...
            String FileName="Summer2011_Final";
            ...
            while(true) {
                ...
                try {
                    ...
                    rsPriceListDtl.updateString("PRICE_LIST_NO", "PLS11");
			...
			rsPriceListRate.moveToInsertRow();
                        ...
                        rsPriceListRate.updateString("PRICE_LIST_NO", "PLS11");
                        ...
                        rsPriceListRate.updateInt("PRICE_LIST_SR_NO", Integer.parseInt(LineCol[2].toString().trim()));
                        rsPriceListRate.updateInt("SR_NO", 1);
                        rsPriceListRate.updateString("EFFECTIVE_DATE", "2010-12-27");// Xmill First Rate from (Rate from Starting  of Season)
                        rsPriceListRate.updateDouble("EX_MILL_RATE", Double.parseDouble(LineCol[5].toString().trim()));
                        rsPriceListRate.updateString("CREATED_BY", "1");
                        rsPriceListRate.updateString("CREATED_DATE", EITLERPGLOBAL.getCurrentDateDB());
                        rsPriceListRate.updateString("MODIFIED_BY", "");
                        ...
                        rsPriceListRate.updateString("EFFECTIVE_DATE", "2011-03-01");// Xmill Second Rate from (Rate for end of Season from specific date)
                ...
                try {
                    ...
                    rsQualityMst.updateString("SEASON_ID", "S11");
