...
public class FrmTransporterMaster extends javax.swing.JApplet {
    ...
    public int ModuleId = clsTransporterMaster.ModuleID; 
    ...
    private clsTransporterMaster objTM;
    ...
    public void init() {
        ...
        objTM = new clsTransporterMaster();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("TRANSPORTER MASTER");
        ...
        txtTransporterId.setDisabledTextColor(java.awt.Color.black);
        txtTransporterId.setEnabled(false);
        ...
        txtTransporterId.setBounds(170, 20, 130, 27);

        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(310, 20, 34, 30);
        ...
        txtTransporterName.setBounds(170, 60, 220, 27);
        ...
        Tab1.add(txtAddress);
        txtAddress.setBounds(170, 100, 220, 27);
        ...
        Tab1.add(txtCity);
        txtCity.setBounds(170, 140, 220, 27);

        jLabel8.setText("City");
        Tab1.add(jLabel8);
        jLabel8.setBounds(110, 150, 60, 17);

        jLabel9.setText("Pincode");
        Tab1.add(jLabel9);
        jLabel9.setBounds(90, 190, 80, 17);
        ...
        Tab1.add(txtPincode);
        txtPincode.setBounds(170, 180, 220, 27);
        ...
        Tab1.add(txtPhoneNo);
        txtPhoneNo.setBounds(170, 220, 220, 27);

        jLabel5.setText("Phone No");
        Tab1.add(jLabel5);
        jLabel5.setBounds(80, 230, 80, 17);

        jLabel14.setText("Contact Person");
        Tab1.add(jLabel14);
        jLabel14.setBounds(40, 260, 120, 30);
        ...
        txtContactPerson.setBounds(170, 260, 220, 27);

        jLabel6.setText("Email");
        Tab1.add(jLabel6);
        jLabel6.setBounds(100, 290, 60, 30);
        ...
        Tab1.add(txtEmail);
        txtEmail.setBounds(170, 300, 220, 27);

        jLabel13.setText("State GST Code");
        Tab1.add(jLabel13);
        jLabel13.setBounds(410, 280, 130, 17);
        ...
        Tab1.add(jLabel12);
        jLabel12.setBounds(440, 230, 100, 20);

        jLabel4.setText("GSTIN No");
        Tab1.add(jLabel4);
        jLabel4.setBounds(450, 190, 90, 17);
        ...
        Tab1.add(jLabel15);
        jLabel15.setBounds(480, 150, 50, 17);
        ...
        Tab1.add(jLabel11);
        jLabel11.setBounds(470, 110, 80, 17);
        ...
        Tab1.add(jLabel10);
        jLabel10.setBounds(440, 60, 100, 30);
        ...
        Tab1.add(jLabel7);
        jLabel7.setBounds(460, 30, 70, 20);
        ...
        Tab.addTab("Transporter Master", Tab1);
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
       ...
       // SelHierarchyID = EITLERPGLOBAL.getComboCode(cmbHierarchy);
        ...
        DOC_NO = txtTransporterId.getText();
        cmbSendTo.setEnabled(true);
    ...
    private void txtTransporterIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTransporterIdFocusLost
        ...
        {
            String id = data.getStringValueFromDB("SELECT TRANSPORTER_ID FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER WHERE TRANSPORTER_ID='"+txtTransporterId.getText()+"'");
        
            if(!"".equals(id))
            {
                JOptionPane.showMessageDialog(null, "TRANSPORTER ID : "+id+" is already exist!");
...
//        txtTransporterId.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("TRANSPORTER MASTER : "+objTM.getAttribute("TRANSPORTER_ID").getString());
            ...
            String DocNo = objTM.getAttribute("TRANSPORTER_ID").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsTransporterMaster ObjHistory = (clsTransporterMaster) History.get(Integer.toString(i));
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, ModuleId, txtTransporterId.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, ModuleId, txtTransporterId.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, ModuleId, txtTransporterId.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = ApprovalFlow.getFromID(EITLERPGLOBAL.gCompanyID, ModuleId, objTM.getAttribute("TRANSPORTER_ID").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = ApprovalFlow.getFromRemarks(EITLERPGLOBAL.gCompanyID,  ModuleId, FromUserID, objTM.getAttribute("TRANSPORTER_ID").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if(ApprovalFlow.IsCreator( ModuleId, txtTransporterId.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 4025, 40251)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 4025, 40252)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 4025, 40253)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 4025, 40254)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
...
//        lblTitle.setBackground(Color.GRAY);
        ...
        aList.ModuleID=clsTransporterMaster.ModuleID;
        ...
        if(aList.ShowList()) {
            ...
            txtTransporterId.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsTransporterMaster.ModuleID , FFNo,  false));
            
            lblTitle.setText("TRANSPORTER MASTER : "+txtTransporterId.getText());
            lblTitle.setBackground(Color.GRAY);
        }
        else {
    ...
    private void Edit() {
        String productionDocumentNo = (String) objTM.getAttribute("TRANSPORTER_ID").getObj();
...
//                    clsHierarchy.sendMailToAllUsers((int) EITLERPGLOBAL.gCompanyID, SelHierarchyID, EITLERPGLOBAL.gNewUserID, Subject, Message, "sdmlerp@dineshmills.com");
    ...
    private void SetData() {
        ...
        objTM.setAttribute("TRANSPORTER_ID", DOC_NO);
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.Sales.TransporterMaster.frmFindTM",true);
        frmFindTM ObjFind = (frmFindTM)ObjLoader.getObj();
    ...
    public void Find(String AmendID) {
        objTM.Filter(" AND TRANSPORTER_ID='"+AmendID+"'");
        SetMenuForRights();
        DisplayData();
    }
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                if (txtTransporterId.getText().equals("")) {
                    ...
                    hmSendToList = ApprovalFlow.getRemainingUsers(EITLERPGLOBAL.gCompanyID, ModuleId, txtTransporterId.getText());
                    for (int i = 1; i <= hmSendToList.size(); i++) {
                        clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                        ComboData aData = new ComboData();
                        aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
