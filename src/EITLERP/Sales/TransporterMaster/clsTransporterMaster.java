...
package EITLERP.Sales.TransporterMaster;
...
public class clsTransporterMaster {
    ...
    //        resultSet = statement.executeQuery("SELECT * FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER where TRANSPORTER_ID like 'DM%'  ORDER BY TRANSPORTER_ID");
            resultSet = statement.executeQuery("SELECT * FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER  ORDER BY TRANSPORTER_ID");
...
//            }
    ...
    public boolean setHistoryData(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID='" + pDocNo + "'");
    ...
    public static HashMap getHistoryList(String stringProductionDate, String DocumentNo) {
        ...
        try {
            ...
            System.out.println("SELECT * FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID='" + DocumentNo + "'");
            rsTmp = stTmp.executeQuery("SELECT * FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID='" + DocumentNo + "'");
            while (rsTmp.next()) {
                clsTransporterMaster objTM = new clsTransporterMaster();
     ...
     public boolean IsEditable(String DocumentNo, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER WHERE TRANSPORTER_ID='" + DocumentNo + "' AND APPROVED=1";
     ...
     public boolean Insert() {
        ...
        try {
            ...
            rsHeader = stHeader.executeQuery("SELECT * FROM  DINESHMILLS.D_SAL_TRANSPORTER_MASTER WHERE TRANSPORTER_ID=''");

            stHeaderH = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            rsHeaderH = stHeaderH.executeQuery("SELECT * FROM  DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID=''");

            rsHeader.first();
            rsHeader.moveToInsertRow();
            String new_doc_number  = clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, ModuleID, clsFirstFree.getDefaultFirstFreeNo(EITLERPGLOBAL.gCompanyID, ModuleID), true);
            rsHeader.updateString("TRANSPORTER_ID", new_doc_number);
            ...
            rsHeaderH.updateString("TRANSPORTER_ID", new_doc_number);
            ...
            ObjApprovalFlow.TableName = "DINESHMILLS.D_SAL_TRANSPORTER_MASTER";
            ...
            ObjApprovalFlow.FieldName = "TRANSPORTER_ID";
...
//                    }
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID='1'");
            ...
            stHeaderH = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            rsHeaderH = stHeaderH.executeQuery("SELECT * FROM  DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID='1'");
            ...
            int RevNo = EITLERPGLOBAL.GetQueryResult("SELECT MAX(REVISION_NO) FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER_H WHERE TRANSPORTER_ID='" + getAttribute("TRANSPORTER_ID").getString()+ "'");
            ...
            ObjApprovalFlow.DocNo = getAttribute("TRANSPORTER_ID").getString()+ "";
            ObjApprovalFlow.DocDate = EITLERPGLOBAL.getCurrentDateDB();
            ObjApprovalFlow.From = (int) getAttribute("FROM").getVal();
            ObjApprovalFlow.To = (int) getAttribute("TO").getVal();
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE DINESHMILLS.D_SAL_TRANSPORTER_MASTER SET REJECTED=0,CHANGED=1 WHERE TRANSPORTER_ID ='" + getAttribute("TRANSPORTER_ID").getString() + "'");
                ObjApprovalFlow.IsCreator = true;
            }
            //==========================================//
    ...
    public boolean Filter(String stringFindQuery) {
        ...
        try {
            ...
            String strSql = "SELECT * FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER WHERE TRANSPORTER_ID!='' " + stringFindQuery + "";
    ...
    public static HashMap getPendingApprovals(int pCompanyID,int pUserID,int pOrder,int FinYearFrom) {
        ...
        try {
            ...
            if(pOrder==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID,DINESHMILLS.D_SAL_TRANSPORTER_MASTER.CREATED_DATE,RECEIVED_DATE,0 AS DEPT_ID FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER,D_COM_DOC_DATA WHERE DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID=D_COM_DOC_DATA.DOC_NO AND DINESHMILLS.D_SAL_TRANSPORTER_MASTER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND DINESHMILLS.D_SAL_TRANSPORTER_MASTER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND MODULE_ID=71 ORDER BY D_COM_DOC_DATA.RECEIVED_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocDate) {
                strSQL="SELECT DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID,DINESHMILLS.D_SAL_TRANSPORTER_MASTER.CREATED_DATE,RECEIVED_DATE,0 AS DEPT_ID FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER,D_COM_DOC_DATA WHERE DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID=D_COM_DOC_DATA.DOC_NO AND DINESHMILLS.D_SAL_TRANSPORTER_MASTER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND DINESHMILLS.D_SAL_TRANSPORTER_MASTER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND MODULE_ID=71 ORDER BY DINESHMILLS.D_SAL_TRANSPORTER_MASTER.CREATED_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocNo) {
                strSQL="SELECT DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID,DINESHMILLS.D_SAL_TRANSPORTER_MASTER.CREATED_DATE,RECEIVED_DATE,0 AS DEPT_ID FROM DINESHMILLS.D_SAL_TRANSPORTER_MASTER,D_COM_DOC_DATA WHERE DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID=D_COM_DOC_DATA.DOC_NO AND DINESHMILLS.D_SAL_TRANSPORTER_MASTER.COMPANY_ID=D_COM_DOC_DATA.COMPANY_ID AND DINESHMILLS.D_SAL_TRANSPORTER_MASTER.COMPANY_ID="+Integer.toString(pCompanyID)+" AND D_COM_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND D_COM_DOC_DATA.STATUS='W' AND MODULE_ID=71 ORDER BY DINESHMILLS.D_SAL_TRANSPORTER_MASTER.TRANSPORTER_ID";
            }
            ...
            while(!rsTmp.isAfterLast()&&rsTmp.getRow()>0) {
                if(EITLERPGLOBAL.isWithinDate(rsTmp.getString("CREATED_DATE"),FinYearFrom)) {
                    Counter=Counter+1;
                    clsTransporterMaster ObjDoc=new clsTransporterMaster();
                    
                    //------------- Header Fields --------------------//
                    ObjDoc.setAttribute("TRANSPORTER_ID",rsTmp.getString("TRANSPORTER_ID"));
