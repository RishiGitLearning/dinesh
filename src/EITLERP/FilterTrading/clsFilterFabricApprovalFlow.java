...
public class clsFilterFabricApprovalFlow {
    ...
    public static void AppendUsers(HashMap pUsers) {
        ...
        try {
            ...
            rsDocData=stDocData.executeQuery("SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE DOC_NO='1'");
            rsDocData.first();
            ...
            for(int i=1;i<=pUsers.size();i++) {
                ...
                strSQL="SELECT MAX(SR_NO) AS SRNO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"'";
                ...
                rsTmp=data.getResult("SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+UserID);
                rsTmp.first();
    ...
    public static int getFromID(int pModuleID,String pDocNo) {
        ...
        try {
            ...
            strSQL="SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='W'";
    ...
    public static int getNextUser(int pModuleID,String pDocNo) {
        ...
        try {
            ...
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' ORDER BY SR_NO";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            ...
            if(SrNo!=0){ //We got Sr. No. of current user id. Get Next no.
                //Get Next No.
                stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                strSQL="SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND SR_NO="+(SrNo+1);
                rsTmp=stTmp.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static int getCreator(int pModuleID,String pDocNo) {
        ...
        try {
            ...
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND TYPE='C'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
    ...
    public static HashMap getDocumentList(int pModuleID,int pDeptID) {
        ...
        try {
            ...
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT DISTINCT(DOC_NO),DOC_DATE FROM FILTERFABRIC.FF_TRD_DOC_DATA,D_COM_USER_MASTER WHERE FILTERFABRIC.FF_TRD_DOC_DATA.USER_ID=D_COM_USER_MASTER.USER_ID AND STATUS<>'F' AND D_COM_USER_MASTER.DEPT_ID="+pDeptID+" AND FILTERFABRIC.FF_TRD_DOC_DATA.MODULE_ID="+pModuleID+" AND FILTERFABRIC.FF_TRD_DOC_DATA.TYPE='C' ";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
    ...
    public static HashMap getRemainingUsers(int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE  MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='W'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                SrNo=rsTmp.getInt("SR_NO");
                ...
                stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
                strSQL="SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE  MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND SR_NO>"+SrNo+" ORDER BY SR_NO";
                rsTmp=stTmp.executeQuery(strSQL);
                rsTmp.first();
                if(rsTmp.getRow()>0){
                    while(!rsTmp.isAfterLast()) {
    ...
    public static HashMap getUserList(int pModuleID,String pDocNo) {
        ...
        try {
            ...
            strSQL="SELECT USER_ID FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
    ...
    public static int getFinalApprover(int pModuleID,String pDocNo) {
        ...
        try {
            ...
            strSQL="SELECT USER_ID FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='F'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                UserID=rsTmp.getInt("USER_ID");
    ...
    public static String getCreatorStatus(int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT STATUS FROM FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND TYPE='C'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
    ...
    public static boolean IsCreator(int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT STATUS FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND TYPE='C' AND USER_ID="+EITLERPGLOBAL.gUserID;
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                Creator=true;
    ...
    public static int getRecordCount(int pModuleID,String pDocNo) {
        ...
        try {
            Conn=data.getConn();
            stTmp=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            strSQL="SELECT COUNT(*) AS RECCOUNT FROM FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ pModuleID+ " AND DOC_NO='"+pDocNo+"'";
            rsTmp=stTmp.executeQuery(strSQL);
            rsTmp.first();
    ...
    public static void RemoveRecords(int pModuleID,String pDocNo) {
        try {
            data.Execute("DELETE FROM FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"'");
        }catch(Exception e) {
        }
    }
    ...
    public boolean UpdateFlow() {
        ...
        try {
            ...
            rsDocData=stDocData.executeQuery("SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA LIMIT 1");
            rsDocData.first();
            
            //If User is creator of the document
            if(IsCreator && rsHierarchy.getRow()>0) {
                String str = "SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID
                ...
                if (!data.IsRecordExist(str)) {
                    //Insert Records into FILTERFABRIC.FF_TRD_DOC_DATA from the Hierarchy
            ...
            stDocData=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            rsDocData=stDocData.executeQuery("SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' ORDER BY SR_NO ");
            ...
            rsTmp=data.getResult("SELECT SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID);
            rsTmp.first();
            ...
            if(Status.equals("A")) { //Approve and Forward
                ...
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='A',REMARKS='"+Remarks+"',ACTION_DATE=CURRENT_TIMESTAMP,CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO="+FromSrNo;
                data.Execute(strSQL);
                
                //Set the W Flag for To User ID
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='W',FROM_USER_ID="+From+", FROM_REMARKS='"+Remarks+"',RECEIVED_DATE=CURRENT_TIMESTAMP,CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO="+ToSrNo;
                data.Execute(strSQL);
                
                //Set Completed for users between From and To
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='C',CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO>"+FromSrNo+" AND SR_NO<"+ToSrNo;
                data.Execute(strSQL);
                
                //Set Pending for users greater than To
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='P',CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO>"+ToSrNo;
                data.Execute(strSQL);
                
                
                
                //Now check whether document sent successfully to recipient. If not set it to current user only
                rsTmp=data.getResult("SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND STATUS='W'");
                rsTmp.first();
                ...
                if(rsTmp.getRow()>0) {
                    ...
                    data.Execute("UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='W' WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO="+CurrentUserSrNo);
                }
                //============== Check Completed =======================//
            }
            ...
            if(Status.equals("F")){ //Final Approval
                //Set the A Flag for From User ID
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='F',REMARKS='"+Remarks+"',ACTION_DATE=CURRENT_TIMESTAMP,CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+EITLERPGLOBAL.gNewUserID;
                data.Execute(strSQL);
            ...
            if(Status.equals("R")){ //Rejected
                ...
                rsTmp=data.getResult("SELECT SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+getCreator(ModuleID,DocNo));
                rsTmp.first();
                ...
                if(ExplicitSendTo) {
                    ...
                    rsTmp=data.getResult("SELECT SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+To);
                    rsTmp.first();
                ...
                if(ExplicitSendTo) {
                    ...
                    rsTmp=data.getResult("SELECT * FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND USER_ID="+To);
                    rsTmp.first();
                ...
                */
                ...
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='W',RECEIVED_DATE=CURRENT_TIMESTAMP,ACTION_DATE='0000-00-00 00:00:00',FROM_USER_ID="+From+", FROM_REMARKS='"+Remarks+" - Rejected Document"+"',CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO="+CreatorSrNo;
                data.Execute(strSQL);
                
                //Set the P Flag for all other users
                strSQL="UPDATE FILTERFABRIC.FF_TRD_DOC_DATA SET STATUS='V',CHANGED=1,CHANGED_DATE=CURRENT_TIMESTAMP,REMARKS='',RECEIVED_DATE='',ACTION_DATE='' WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND SR_NO<>"+CreatorSrNo+" AND SR_NO<="+FromSrNo;
                data.Execute(strSQL);
                ...
                //Now check whether document sent successfully to recipient. If not set it to current user only
                rsTmp=data.getResult("SELECT COUNT(*) FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+ModuleID+" AND DOC_NO='"+DocNo+"' AND STATUS='W'");
                rsTmp.first();
    ...
    public static boolean IncludeUserInApproval(int pModuleID,String pDocNo,int pUserID,int pFromUserID) {
        ...
        try {
            ...
            ResultSet rsTmp=data.getResult("SELECT SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND USER_ID="+pFromUserID);
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                FromSrNo=rsTmp.getInt("SR_NO");
                
                rsTmp=data.getResult("SELECT SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND USER_ID="+pUserID);
                rsTmp.first();
                ...
                if(IsOnceRejectedDoc(pModuleID,pDocNo)) {
                    rsTmp=data.getResult("SELECT MAX(SR_NO) AS MAX_SR_NO FROM FILTERFABRIC.FF_TRD_DOC_DATA WHERE MODULE_ID="+pModuleID+" AND DOC_NO='"+pDocNo+"' AND STATUS='V'");
                    rsTmp.first();
