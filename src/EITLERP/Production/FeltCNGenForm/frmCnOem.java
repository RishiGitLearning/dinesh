...
public class frmCnOem extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("CREDIT NOTE for OEM");
        ...
        jLabel2.setText("OEM Data Process");
        ...
        jButton3.setText("2. CN OEM DETAIL");
        ...
        jButton5.setText("3.OEM CREDIT NOTE ");
        ...
        jButton4.setText("1. CN OEM SUMMARY");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            if(data.IsRecordExist("SELECT VOUCHER_NO FROM D_FIN_VOUCHER_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+"  AND LEFT(VOUCHER_NO,2) = 'CN'",FinanceGlobal.FinURL)) {
                ...
                int counter=1;
                String t=txtInterval.getText().substring(0,9);
                ResultSet rsSchemeHeader =Stmt.executeQuery("SELECT CNH_SUB_ACCOUNT_CODE FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID ='"+t+"' AND CNH_TYPE ='OEM' ORDER BY CNH_SUB_ACCOUNT_CODE");
                ...
                if(rsSchemeHeader.getRow()>0){
                    while(!rsSchemeHeader.isAfterLast()){
                        ...
                        String SQL1 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_DRAFT_CR_NOTE_NO='"+draftNo+(draftSrNo+counter)+"',CNH_DRAFT_CR_NOTE_DATE='"+draftDate+"' WHERE CNH_TYPE ='OEM' AND CNH_YEAR_MON_ID ='"+t+"' AND  CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"'";//AND CNH_PERCENT='"+rsSchemeHeader.getString("CNH_PERCENT")+"'
                        ...
                        //String SQL2 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_FIN_VOUCHER_NO = CONCAT('CN',161700000 +ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))),CNH_LEGACY_NO = ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))  WHERE CNH_TYPE ='OEM' AND CNH_YEAR_MON_ID ='"+t+"' AND CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' ";//AND CNH_PERCENT='"+rsSchemeHeader.getString("CNH_PERCENT")+"'
                        ...
                        String SQL3 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_LINK_NO = CONCAT(CNH_LEGACY_NO,RIGHT(CNH_LINK_NO,10)) WHERE CNH_TYPE ='OEM' AND CNH_YEAR_MON_ID ='"+t+"' AND CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' ";//AND CNH_PERCENT='"+rsSchemeHeader.getString("CNH_PERCENT")+"'
    ...
    private void cmbIntervalComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbIntervalComboActionPerformed
        if(EITLERPGLOBAL.getComboCode(cmbIntervalCombo)!=1){
            ...
            FormatGrid1();
            try{
                //ResultSet rs=data.getResult("SELECT CN_INVOICE_NO,CN_INVOICE_DATE,CN_PARTY_CODE,CN_PARTY_NAME,CN_INV_PIECE_NO,CN_INV_PRODUCT_CODE,CN_PRODUCT_GRUP,CN_INV_WI_SQMTR,CN_GROSS_VALUE,CN_DISC_BILL,CN_YEAR_END_DISC,CN_YEAR_END_DISC_RS,CN_UNADJUSTED_RS,CN_NET_BASIC,CN_OEM,CN_OEM_VALUE FROM PRODUCTION.FELT_CN_TEMP_DETAIL WHERE CN_TYPE=3 ORDER BY CN_INVOICE_NO");
                ResultSet rs=data.getResult("SELECT A.CND_INVOICE_NO,A.CND_INVOICE_DATE,A.CND_QUALITY,A.CND_SHADE,A.CND_PIECE_NO,A.CND_GROSS_QTY,A.CND_RATE,A.CND_NET_AMOUNT,A.CND_CATG,A.CND_PERCENT,A.CND_CREDIT_AMOUNT,B.CNH_ID,B.CNH_NO,B.CNH_TYPE,B.CNH_MAIN_ACCOUNT_CODE,B.CNH_MAIN_CODE,B.CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME FROM PRODUCTION.D_CREDIT_NOTE_DETAIL A,PRODUCTION.D_CREDIT_NOTE_HEADER B WHERE A.CND_YEAR_MON_ID =SUBSTRING('" +txtInterval.getText()+"',1,9) AND A.CND_TYPE='OEM' AND A.CND_NO=B.CNH_NO AND A.CND_NO=B.CNH_NO AND A.CND_SUB_ACCOUNT_CODE=B.CNH_SUB_ACCOUNT_CODE ORDER BY CND_SUB_ACCOUNT_CODE");
                while(!rs.isAfterLast()){
                    Object[] rowData=new Object[21];
                    // rowData[0]=rs.getString("");
//                    rowData[0]=rs.getString("CN_INVOICE_NO");
//                    rowData[1]=rs.getString("CN_INVOICE_DATE");
//                    rowData[2]=rs.getString("CN_PARTY_CODE");
//                    rowData[3]=rs.getString("CN_PARTY_NAME");
//                    rowData[4]=rs.getString("CN_INV_PIECE_NO");
//                    rowData[5]=rs.getString("CN_INV_PRODUCT_CODE");
//                    rowData[6]=rs.getString("CN_PRODUCT_GRUP");
//                    rowData[7]=rs.getString("CN_INV_WI_SQMTR");
//                    rowData[8]=rs.getString("CN_GROSS_VALUE");
//                    rowData[9]=rs.getString("CN_DISC_BILL");
//                    rowData[10]=rs.getString("CN_YEAR_END_DISC");
//                    rowData[11]=rs.getString("CN_YEAR_END_DISC_RS");
//                    rowData[12]=rs.getString("CN_UNADJUSTED_RS");  
//                    rowData[13]=rs.getString("CN_NET_BASIC");
//                    rowData[14]=rs.getString("CN_OEM");
//                    rowData[15]=rs.getString("CN_OEM_VALUE");
    ...
    */
    ...
    private void GenerateCreditNoteDetail() {
        String str=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(0,9);
        String strfrom=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(17,27);
        String strto=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(31,41);
        try {            
            ...
            String strSQL="SELECT * FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE='OEM' AND CND_YEAR_MON_ID='"+str+"' ORDER BY CND_SUB_ACCOUNT_CODE";
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/Production/rptOEMCNDetail.rpt",Parameters,objData);                       
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void GenerateCreditNote() {
       String str=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(0,9);
        ...
        try {            
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/Production/rptOEMCNDraft.rpt",Parameters,objData);                       
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void GenerateCreditNoteSummary() {
       ...
       String strto=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(31,41);
        ...
        try {            
            ...
            Parameters.put("FROM_DATE",strfrom);
            Parameters.put("TO_DATE",strto);
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/Production/rptOEMCNSummary.rpt",Parameters,objData);                       
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void generateIntervalCombo(){
        ...
        try{
            ...
            ResultSet rs=data.getResult("SELECT DISTINCT CND_YEAR_MON_ID,CND_INTERVAL_CAPTION FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE ='OEM' ORDER BY CND_YEAR_MON_ID DESC ");
            while(!rs.isAfterLast()){
    ...
    */
    ...
    private void FormatGrid() {
        try{
         ...
         //DataModelDesc.addColumn("Sr.");    //0
            ...
            DataModel.SetVariable(6,"CN_PRODUCT_GRUP");    //7
    ...
    private void GenerateOEMCN(){
        ...
        try{
            ...
            stmt.execute("UPDATE PRODUCTION.TMP_LC_CREDITNOTETEST SET LCN_YEAR_MON_ID=CONCAT('OEM','"+fyr+"','"+tyr+"','"+lstno+"')"); //WHERE LCN_INVOICE_DATE>='" + frmdt + "' AND LCN_INVOICE_DATE<='" + todt + "'");
            ...
            stmt.execute("DELETE FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_YEAR_MON_ID = CONCAT('OEM','"+fyr+"','"+tyr+"','"+lstno+"')");
            ...
            stmt.execute("UPDATE DINESHMILLS.D_SAL_PARTY_MASTER,PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_PARTY_NAME = PARTY_NAME,CNH_CITY = CITY_ID WHERE CNH_SUB_ACCOUNT_CODE = PARTY_CODE AND CNH_YEAR_MON_ID = CONCAT('OEM','"+fyr+"','"+tyr+"','"+lstno+"') ");
    ...
    */
    ...
    public String getNextNo(String toyr,String frmyr) {
        ...
        try {
            ...
            strSQL="SELECT MAX(CND_YEAR_MON_ID) AS L_NO FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE='OEM' AND CND_LINK_YEAR=CONCAT('"+frmyr+"','/','"+toyr+"')";
