...
public class frmCnUnadj extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("CREDIT NOTE for UNADJUSTED");
        ...
        jLabel2.setText("Unadjusted Data Process");
        ...
        jButton3.setText("2. CN UNADJ DETAIL");
        ...
        jButton5.setText("3. UNADJ CREDIT NOTE ");
        ...
        jButton4.setText("1. CN UNADJ SUMMARY");
        ...
        txtDraftDate.setNextFocusableComponent(txtToDate);
        ...
        txtLinkNo.setNextFocusableComponent(txtToDate);
    ...
    //        String draftDate="2014-2015";
      ...
      //     int reasonCode=36;
            ...
            //ResultSet rsSchemeHeader =Stmt.executeQuery("SELECT CNH_SUB_ACCOUNT_CODE,CNH_PERCENT FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID ='"+t+"' AND CNH_TYPE ='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE");
            ResultSet rsSchemeHeader =Stmt.executeQuery("SELECT CNH_SUB_ACCOUNT_CODE FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID ='"+t+"' AND CNH_TYPE ='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE");
          ...
          //  ResultSet rsSchemeHeader=stmt.executeQuery("SELECT SCH_PARTY_CODE FROM SALES.D_SAL_SCHEME_HEADER WHERE SCH_SCHEME_ID="+schemeId+" AND SCH_SEASON_ID='"+seasonId+"' ORDER BY SCH_PARTY_CODE");
            ...
            if(rsSchemeHeader.getRow()>0){
                while(!rsSchemeHeader.isAfterLast()){
                    ...
                    //String SQL1 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_DRAFT_CR_NOTE_NO='"+draftNo+(draftSrNo+counter)+"',CNH_DRAFT_CR_NOTE_DATE='"+draftDate+"',CNH_LINK_NO=CONCAT('"+lnk+"',RIGHT(CNH_LINK_NO,10)) WHERE CNH_TYPE ='UNADJ' AND CNH_YEAR_MON_ID ='"+t+"' AND  CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' AND CNH_PERCENT='"+rsSchemeHeader.getString("CNH_PERCENT")+"'"; 
                    String SQL1 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_DRAFT_CR_NOTE_NO='"+draftNo+(draftSrNo+counter)+"',CNH_DRAFT_CR_NOTE_DATE='"+draftDate+"',CNH_LINK_NO=CONCAT('"+lnk+"',RIGHT(CNH_LINK_NO,10)) WHERE CNH_TYPE ='UNADJ' AND CNH_YEAR_MON_ID ='"+t+"' AND  CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' "; 
		    ...
		    //String SQL2 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_FIN_VOUCHER_NO = CONCAT('CN',161700000 +ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))),CNH_LEGACY_NO = ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))  WHERE CNH_TYPE ='UNADJ' AND CNH_YEAR_MON_ID ='"+t+"' AND CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' AND CNH_PERCENT='"+rsSchemeHeader.getString("CNH_PERCENT")+"'";
                    //String SQL2 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_FIN_VOUCHER_NO = CONCAT('CN',171700000 +ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))),CNH_LEGACY_NO = ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))  WHERE CNH_TYPE ='UNADJ' AND CNH_YEAR_MON_ID ='"+t+"' AND CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' ";
                    String SQL2 ="UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_FIN_VOUCHER_NO = CONCAT('CN','"+frmYr+"',1700000 +ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))),CNH_LEGACY_NO = ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))  WHERE CNH_TYPE ='UNADJ' AND CNH_YEAR_MON_ID ='"+t+"' AND CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"' ";
    ...
    */
    ...
    private void GenerateCreditNoteDetail() {
        ...
        try {            
            ...
            String strSQL="SELECT * FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE='UNADJ' AND CND_YEAR_MON_ID='"+str+"' ORDER BY CND_SUB_ACCOUNT_CODE,CND_INVOICE_NO";
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/Production/rptUnadjCNDetail.rpt",Parameters,objData);                       
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void GenerateCreditNote() {
       String str=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(0,11);
        ...
        try {            
            ...
            String strSQL="SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT,ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT,CNH_DRAFT_CR_NOTE_NO,CNH_DRAFT_CR_NOTE_DATE,CNH_FIN_VOUCHER_NO,CNH_REMARKS FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID='"+str+"' AND CNH_TYPE='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE";
            ResultSet  rsTemp =data.getResult(strSQL);                    
            rsTemp.first();            
            if(rsTemp.getRow()>0){
                while(!rsTemp.isAfterLast()){
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/Production/rptUnadjCNDraft.rpt",Parameters,objData);                       
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void GenerateCreditNoteOLD() {
       String str=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(0,11);
        System.out.println(str);
        ...
        try {            
            ...
            objData.AddColumn("CNH_DRAFT_CR_NOTE_DATE");
            objData.AddColumn("CNH_FIN_VOUCHER_NO");
            objData.AddColumn("CNH_EXT11");
            objData.AddColumn("CNH_GROUP");
            
            //String strSQL="SELECT * FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID='"+str+"' AND CNH_TYPE='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE";
            String strSQL="SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT,ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT,CNH_DRAFT_CR_NOTE_DATE,CNH_EXT11,CNH_FIN_VOUCHER_NO,CONCAT(CNH_SUB_ACCOUNT_CODE,CNH_PERCENT) AS CNH_GROUP FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID='"+str+"' AND CNH_TYPE='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE,CNH_PERCENT";
            ResultSet  rsTemp =data.getResult(strSQL);                    
            rsTemp.first();            
            if(rsTemp.getRow()>0){
                while(!rsTemp.isAfterLast()){
                ...
                objRow.setValue("CNH_DRAFT_CR_NOTE_DATE", EITLERPGLOBAL.formatDate(rsTemp.getString("CNH_DRAFT_CR_NOTE_DATE")));   
                objRow.setValue("CNH_FIN_VOUCHER_NO", rsTemp.getString("CNH_FIN_VOUCHER_NO"));  
                objRow.setValue("CNH_EXT11", rsTemp.getString("CNH_EXT11"));   
                objRow.setValue("CNH_GROUP", rsTemp.getString("CNH_GROUP"));   
                objData.AddRow(objRow);                
                rsTemp.next(); 
                }
            }                            
    ...
    private void GenerateCreditNoteSummary() {
       ...
       String strto=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(33,43);
        ...
        try {            
            ...
            String strSQL="SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT,ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID='"+str+"' AND CNH_TYPE='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE";
            ResultSet  rsTemp =data.getResult(strSQL);                    
            rsTemp.first();            
            if(rsTemp.getRow()>0){
                while(!rsTemp.isAfterLast()){
            ...
            Parameters.put("FROM_DATE",strfrom);
            Parameters.put("TO_DATE",strto);
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/Production/rptUnadjCNSummary.rpt",Parameters,objData);                       
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void GenerateCreditNoteSummaryOLD() {
       String str=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(0,11);
       String strfrom=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(19,29);
       String strto=IntervalComboModel.getText(cmbIntervalCombo.getSelectedIndex()).substring(33,43);
        System.out.println(str);
        ...
        try {            
            ...
            String strSQL="SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT,ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID='"+str+"' AND CNH_TYPE='UNADJ' ORDER BY CNH_SUB_ACCOUNT_CODE,CNH_PERCENT";
            ResultSet  rsTemp =data.getResult(strSQL);                    
            rsTemp.first();            
            if(rsTemp.getRow()>0){
                while(!rsTemp.isAfterLast()){
    ...
    private void generateIntervalCombo(){
        ...
        try{
            ...
            ResultSet rs=data.getResult("SELECT DISTINCT CND_YEAR_MON_ID,CND_INTERVAL_CAPTION FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE ='UNADJ' ORDER BY CND_YEAR_MON_ID DESC ");
            while(!rs.isAfterLast()){
    ...
    */
    ...
    private void GenerateUnadjCN(){
        ...
        try{
            ...
            //stmt.execute("INSERT INTO PRODUCTION.TMP_LC_CREDITNOTETEST (LCN_VOUCHER_NO,LCN_SUB_ACCOUNT_CODE,EXT1,LCN_RC_VOUCHER,LCN_INVOICE_NO,LCN_INVOICE_DATE,LCN_AMOUNT,LCN_PER,LCN_CREDIT_AMOUNT,EXT2,LCN_MAIN_ACCOUNT_CODE) SELECT H.UNADJ_ID,PARTY_CODE,PARTY_NAME,PRODUCT_CODE,INVOICE_NO,INVOICE_DATE,INV_BASIC_AMT,WORK_DISC_PER+SEAM_PER,DISC_AMT,PIECE_NO,210010 FROM PRODUCTION.FELT_UNADJUSTED_TRN_D D,PRODUCTION.FELT_UNADJUSTED_TRN_H H WHERE D.UNADJ_ID = H.UNADJ_ID AND CANCELLED =0 AND APPROVED =1 AND INVOICE_DATE >= '2015-04-01' AND INVOICE_DATE <= '2016-03-31' ");
            stmt.execute("INSERT INTO PRODUCTION.TMP_LC_CREDITNOTETEST (LCN_VOUCHER_NO,LCN_SUB_ACCOUNT_CODE,EXT1,LCN_RC_VOUCHER,LCN_INVOICE_NO,LCN_INVOICE_DATE,LCN_AMOUNT,LCN_PER,LCN_CREDIT_AMOUNT,EXT2,LCN_MAIN_ACCOUNT_CODE) SELECT H.UNADJ_ID,PARTY_CODE,PARTY_NAME,PRODUCT_CODE,INVOICE_NO,INVOICE_DATE,INV_BASIC_AMT,CASE WHEN WORK_DISC_PER>0 THEN WORK_DISC_PER ELSE SANC_SEAM_CHARGES END AS DISC_PER,DISC_AMT,PIECE_NO,210010 FROM PRODUCTION.FELT_UNADJUSTED_TRN_D D,PRODUCTION.FELT_UNADJUSTED_TRN_H H WHERE D.UNADJ_ID = H.UNADJ_ID AND CANCELLED =0 AND APPROVED =1 AND INVOICE_DATE >= '" + frmdt + "' AND INVOICE_DATE <= '" + todt + "' AND INVOICE_NO NOT IN (SELECT CND_INVOICE_NO FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE='UNADJ' AND CND_INVOICE_DATE BETWEEN '" + frmdt + "' AND '" + todt + "') ");
            
            //stmt.execute("UPDATE PRODUCTION.TMP_LC_CREDITNOTETEST SET LCN_YEAR_MON_ID='UNADJ151601' WHERE LCN_INVOICE_DATE>='2015-04-01' AND LCN_INVOICE_DATE<='2016-03-31'");
            stmt.execute("UPDATE PRODUCTION.TMP_LC_CREDITNOTETEST SET LCN_YEAR_MON_ID=CONCAT('UNADJ','"+fyr+"','"+tyr+"','"+lstno+"') WHERE LCN_INVOICE_DATE>='" + frmdt + "' AND LCN_INVOICE_DATE<='" + todt + "'");
            ...
            //stmt.execute("UPDATE DINESHMILLS.D_SAL_PARTY_MASTER,PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_PARTY_NAME = PARTY_NAME,CNH_CITY = CITY_ID WHERE CNH_SUB_ACCOUNT_CODE = PARTY_CODE AND CNH_YEAR_MON_ID = 'UNADJ151601' ");
            stmt.execute("UPDATE DINESHMILLS.D_SAL_PARTY_MASTER,PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_PARTY_NAME = PARTY_NAME,CNH_CITY = CITY_ID WHERE CNH_SUB_ACCOUNT_CODE = PARTY_CODE AND CNH_YEAR_MON_ID = CONCAT('UNADJ','"+fyr+"','"+tyr+"','"+lstno+"') ");
            
            //stmt.execute("UPDATE PRODUCTION.D_CREDIT_NOTE_HEADER SET CNH_EXT11 = CONCAT(CNH_SUB_ACCOUNT_CODE,CNH_PERCENT) WHERE CNH_YEAR_MON_ID = CONCAT('UNADJ','"+fyr+"','"+tyr+"','"+lstno+"') ");
    ...
    private void GenerateUnadjCNOLD(){
        String frmdt=EITLERPGLOBAL.formatDateDB(txtFromDate.getText().trim());
        String frmyr=txtFromDate.getText().trim().substring(6,10);
        String fyr=frmyr.substring(2,4);
        System.out.println(frmdt);
        ...
        try{
            ...
            //stmt.execute("INSERT INTO PRODUCTION.D_CREDIT_NOTE_HEADER (CNH_ID,CNH_NO,CNH_TYPE,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_PARTY_NAME,CNH_EFFECT,CNH_INVOICE_AMOUNT,CNH_PERCENT,CNH_CREDIT_AMOUNT,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_BOOK_CODE) SELECT CND_ID,CND_NO,CND_TYPE,435132,210010,CND_SUB_ACCOUNT_CODE,CND_MAIN_ACCOUNT_NAME,'D',SUM(CND_INVOICE_AMOUNT),CND_PERCENT,SUM(CND_CREDIT_AMOUNT),CND_YEAR_MON_ID,CND_INTERVAL_CAPTION,'TR-17' FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_YEAR_MON_ID  ='UNADJ151601' GROUP BY CND_ID,CND_NO,CND_TYPE,CND_LC_OPENER,CND_MAIN_ACCOUNT_NAME,CND_YEAR_MON_ID,CND_INTERVAL_CAPTION,CND_PERCENT LIMIT 1000000000000");
            stmt.execute("INSERT INTO PRODUCTION.D_CREDIT_NOTE_HEADER (CNH_ID,CNH_NO,CNH_TYPE,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_PARTY_NAME,CNH_EFFECT,CNH_INVOICE_AMOUNT,CNH_PERCENT,CNH_CREDIT_AMOUNT,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_BOOK_CODE,CNH_LINK_NO,CNH_REASON_CODE) SELECT CND_ID,CND_NO,CND_TYPE,435132,210010,CND_SUB_ACCOUNT_CODE,CND_MAIN_ACCOUNT_NAME,'D',SUM(CND_INVOICE_AMOUNT),CND_PERCENT,SUM(CND_CREDIT_AMOUNT),CND_YEAR_MON_ID,CND_INTERVAL_CAPTION,'TR-17',CND_LINK_NO,10 FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_YEAR_MON_ID  =CONCAT('UNADJ','"+fyr+"','"+tyr+"','"+lstno+"') GROUP BY CND_ID,CND_NO,CND_TYPE,CND_LC_OPENER,CND_MAIN_ACCOUNT_NAME,CND_YEAR_MON_ID,CND_INTERVAL_CAPTION,CND_PERCENT LIMIT 1000000000000");
    ...
    */
    ...
    public String getNextNo(String toyr,String frmyr) {
        ...
        try {
            ...
            strSQL="SELECT MAX(CND_YEAR_MON_ID) AS L_NO FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE='UNADJ' AND CND_LINK_YEAR=CONCAT('"+frmyr+"','/','"+toyr+"')";
            rsTmp=tmpStmt.executeQuery(strSQL);
            
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                
                lno=rsTmp.getString("L_NO").substring(9,11);
