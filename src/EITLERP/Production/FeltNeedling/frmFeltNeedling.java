...
public class frmFeltNeedling extends javax.swing.JApplet {
    ...
    private clsFeltNeedling ObjFeltNeedling;
    ...
    public void init() {
        ...
        ObjFeltNeedling = new clsFeltNeedling();

        SetMenuForRights();
        GenerateHierarchyCombo();
        GenerateSendToCombo();
        GenerateUserNameCombo();
        if (ObjFeltNeedling.LoadData()) {
            DisplayData();
        } else {
            JOptionPane.showMessageDialog(this, "Error occured while Loading Data. Error is " + ObjFeltNeedling.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        jMenuItemWeaving.setText("BEAM ORDER");
        ...
        lblTitle.setText(" FELT PRODUCTION NEEDLING DETAILS - ");
        ...
        Tab1.add(jLabel3);
        jLabel3.setBounds(20, 12, 100, 15);
        ...
        txtFeltProductionDate.setBounds(125, 10, 102, 21);
        ...
        Tab1.add(jLabel4);
        jLabel4.setBounds(408, 12, 60, 15);
        ...
        Tab1.add(txtFormNo);
        txtFormNo.setBounds(480, 10, 102, 21);

        jLabel5.setText("Document No.");
        Tab1.add(jLabel5);
        jLabel5.setBounds(20, 42, 90, 15);
        ...
        txtProductionDocumentNo.setBounds(125, 40, 102, 21);
        ...
        Tab1.add(jLabel12);
        jLabel12.setBounds(408, 43, 67, 15);
        ...
        Tab.addTab("Needling Details", Tab1);
...
//                }
    ...
    private void cmdOpenDocumentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOpenDocumentActionPerformed
        if (Table.getSelectedRow() != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Select a row from Needling Details.", "WARNING", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
        new TReportWriter.TReportEngine().PreviewReport("http://" + EITLERPGLOBAL.HostIP + "/EITLERP/Reports/Production/rptFeltNeedling.rpt", new HashMap(), ObjFeltNeedling.getReportData(EITLERPGLOBAL.formatDateDB(txtFeltProductionDate.getText().trim())));
    ...
    private void cmdBackToNormalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdBackToNormalActionPerformed
        ObjFeltNeedling.HistoryView = false;
        ObjFeltNeedling.LoadData();
        MoveLast();
    ...
    private void cmdViewRevisionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewRevisionsActionPerformed
        ObjFeltNeedling.ShowHistory(EITLERPGLOBAL.formatDateDB(txtFeltProductionDate.getText()), txtProductionDocumentNo.getText());
        MoveLast();
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(710, txtProductionDocumentNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
            ...
            if ((EditMode == 1) || (EditMode == 2 && clsHierarchy.IsCreator(EITLERPGLOBAL.gCompanyID, SelHierarchyID, EITLERPGLOBAL.gUserID))) {
                if (Table.getSelectedColumn() == 1) {
                    ...
                    aList.SQL = "SELECT WIP_EXT_PIECE_NO AS PIECE_NO,WIP_PIECE_NO AS PIECE,WIP_PARTY_CODE AS PARTY_CODE,PARTY_NAME,"
                            ...
                            + "AND COALESCE(WIP_REJECTED_FLAG,0)=0 AND ((WIP_PRIORITY_HOLD_CAN_FLAG=3 AND COALESCE(WIP_PIECE_AB_FLAG,'')='AB') OR (WIP_PRIORITY_HOLD_CAN_FLAG=0 AND COALESCE(WIP_PIECE_AB_FLAG,'')='')) "
...
//                            JOptionPane.showMessageDialog(this, "Piece is Under Approval in WIP Piece Amend", "ERROR", JOptionPane.ERROR_MESSAGE);
                            ...
                            try {
                                ...
                                Table.setValueAt(ocYearMonth, Table.getSelectedRow(), 5);
                                ...
                                if (trs.getRow() > 0) {
                                    ...
                                    Table.setValueAt(trs.getString("WIP_PRODUCT_CODE"), Table.getSelectedRow(), 7);  //6
                                    Table.setValueAt(trs.getString("WIP_GROUP"), Table.getSelectedRow(), 8);  //7
                                    Table.setValueAt(trs.getString("WIP_GSM"), Table.getSelectedRow(), 9);  //8
                                    Table.setValueAt(trs.getString("WIP_STYLE"), Table.getSelectedRow(), 10);  //9
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 710)) {
        ...
        try {
            if (EditMode == 0) {
                if (ObjFeltNeedling.getAttribute("APPROVED").getInt() == 1) {
                    lblTitle.setBackground(Color.BLUE);
                } else {
                    lblTitle.setBackground(Color.GRAY);
                }

                /*if(ObjFeltNeedling.getAttribute("CANCELED").getInt()==1) {
                 lblTitle.setBackground(Color.RED);
                 }*/
            }
            //============================================//

            String productionDate = EITLERPGLOBAL.formatDate(ObjFeltNeedling.getAttribute("PRODUCTION_DATE").getString());
            String documentNo = ObjFeltNeedling.getAttribute("PRODUCTION_DOCUMENT_NO").getString();
            lblTitle.setText(" FELT PRODUCTION NEEDLING DETAILS - " + productionDate);
            lblRevNo.setText(Integer.toString((int) ObjFeltNeedling.getAttribute("REVISION_NO").getVal()));
            txtMonthWeight.setText(Double.toString(EITLERPGLOBAL.round(ObjFeltNeedling.getAttribute("TOTAL_WEIGHT").getVal(), 2)));
            txtPreviousWeight.setText(Double.toString(EITLERPGLOBAL.round(ObjFeltNeedling.getAttribute("PREVIOUS_WEIGHT").getVal(), 2)));
            EITLERPGLOBAL.setComboIndex(cmbHierarchy, (int) ObjFeltNeedling.getAttribute("HIERARCHY_ID").getVal());
            DoNotEvaluate = true;

            txtFeltProductionDate.setText(productionDate);
            txtProductionDocumentNo.setText(documentNo);
            txtFormNo.setText(ObjFeltNeedling.getAttribute("PRODUCTION_FORM_NO").getString());

            FormatGrid();
            //Now Generate Table
            for (int i = 1; i <= ObjFeltNeedling.hmFeltNeedlingDetails.size(); i++) {
                clsFeltNeedlingDetails ObjFeltNeedlingDetails = (clsFeltNeedlingDetails) ObjFeltNeedling.hmFeltNeedlingDetails.get(Integer.toString(i));

                Object[] rowData = new Object[15];
                rowData[0] = Integer.toString(i);
                String PieceNo = ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString();
                rowData[1] = ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString();
                rowData[2] = ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PARTY_CODE").getString();
                rowData[3] = Double.toString(EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2));
                rowData[4] = ObjFeltNeedlingDetails.getAttribute("REMARKS").getString();

                //String ocYearMonth=data.getStringValueFromDB("SELECT PR_OC_MONTHYEAR FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='"+PieceNo+"'");
                String ocYearMonth = data.getStringValueFromDB("SELECT WIP_OC_MONTHYEAR FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + PieceNo + "'");
                rowData[5] = ocYearMonth;

                rowData[6] = Integer.toString((int) ObjFeltNeedlingDetails.getAttribute("LOOM_NO").getVal()); //5

                rowData[7] = data.getStringValueFromDB("SELECT WIP_PRODUCT_CODE FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'"); //6
                rowData[8] = data.getStringValueFromDB("SELECT WIP_GROUP FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'"); //7
                rowData[9] = data.getStringValueFromDB("SELECT WIP_GSM FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");  //8
                rowData[10] = data.getStringValueFromDB("SELECT WIP_STYLE FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");  //9

                if (ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_OUT_DATE").getString().equals("")) {
                    rowData[11] = "";  //10
                } else {
                    rowData[11] = EITLERPGLOBAL.formatDate(ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_OUT_DATE").getString());  //10
                }

                if (ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_IN_DATE").getString().equals("")) {
                    rowData[12] = "";  //11
                } else {
                    rowData[12] = EITLERPGLOBAL.formatDate(ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_IN_DATE").getString());  //11
                }
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(710, documentNo);
            ...
            FormatGridUpdateHistory();
            HashMap hmApprovalHistory = clsFeltNeedling.getHistoryList(ObjFeltNeedling.getAttribute("PRODUCTION_DATE").getString(), txtProductionDocumentNo.getText());
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltNeedling ObjFeltNeedling = (clsFeltNeedling) hmApprovalHistory.get(Integer.toString(i));
                Object[] rowData = new Object[6];

                rowData[0] = Integer.toString((int) ObjFeltNeedling.getAttribute("REVISION_NO").getVal());
                rowData[1] = FeltUser.getUserName((int) ObjFeltNeedling.getAttribute("UPDATED_BY").getVal());
                rowData[2] = EITLERPGLOBAL.formatDate(ObjFeltNeedling.getAttribute("ENTRY_DATE").getString()) + ObjFeltNeedling.getAttribute("ENTRY_DATE").getString().substring(10, 19);

                String ApprovalStatus = "";

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("H")) {
                    ApprovalStatus = "Hold";
                }

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("A")) {
                    ApprovalStatus = "Approved";
                }

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("F")) {
                    ApprovalStatus = "Final Approved";
                }

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("W")) {
                    ApprovalStatus = "Waiting";
                }

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("R")) {
                    ApprovalStatus = "Rejected";
                }

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("P")) {
                    ApprovalStatus = "Pending";
                }

                if ((ObjFeltNeedling.getAttribute("APPROVAL_STATUS").getString()).equals("C")) {
                    ApprovalStatus = "Skiped";
                }

                rowData[3] = ApprovalStatus;
                rowData[4] = ObjFeltNeedling.getAttribute("APPROVER_REMARKS").getString();
                rowData[5] = ObjFeltNeedling.getAttribute("FROM_IP").getString();
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Heat Setting Out Date");
            DataModel.addColumn("Heat Setting In Date");

            DataModel.SetReadOnly(0);
            DataModel.SetReadOnly(1);
            DataModel.SetReadOnly(2);

            DataModel.SetReadOnly(7); //6
            DataModel.SetReadOnly(8); //7
            DataModel.SetReadOnly(9); //8
            DataModel.SetReadOnly(10); //9
            ...
            Table.getColumnModel().getColumn(6).setCellEditor(new DefaultCellEditor(cmbCopyType));  //5
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=710 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=710 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(710, ObjFeltNeedling.getAttribute("PRODUCTION_DOCUMENT_NO").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(710, txtProductionDocumentNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(710, txtProductionDocumentNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(710, txtProductionDocumentNo.getText());
    ...
    private void GenerateUserNameCombo() {
        ...
        hmUserNameList = ObjFeltNeedling.getUserNameList(EITLERPGLOBAL.getComboCode(cmbHierarchy), EITLERPGLOBAL.gNewUserID, "NEEDLING");
    ...
    private void SetupApproval() {
        /*// --- Hierarchy Change Rights Check --------
         if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6072,75)) {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(710, ObjFeltNeedling.getAttribute("PRODUCTION_DOCUMENT_NO").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(710, FromUserID, ObjFeltNeedling.getAttribute("PRODUCTION_DOCUMENT_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(710, txtProductionDocumentNo.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6072, 60721)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6072, 60722)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6072, 60723)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6072, 60725)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Edit() {
        String productionDocumentNo = (String) ObjFeltNeedling.getAttribute("PRODUCTION_DOCUMENT_NO").getObj();
        if (ObjFeltNeedling.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(710, productionDocumentNo)) {
                SetFields(true);
                txtFeltProductionDate.setEnabled(false);
                txtFormNo.setEnabled(false);
            } else {
    ...
    private void Delete() {
        if (ObjFeltNeedling.CanDelete(txtProductionDocumentNo.getText(), txtFeltProductionDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            DisplayData();
        } else {
            JOptionPane.showMessageDialog(this, ObjFeltNeedling.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Save() {
        ...
        productionDocumentNo = "FN" + productionDate.substring(6, 10) + productionDate.substring(3, 5) + productionDate.substring(0, 2);

        // CHECK Production Needling Date already exist in database?
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltNeedling.checkProductionDateInDB(EITLERPGLOBAL.formatDateDB(productionDate))) {
                JOptionPane.showMessageDialog(frmFeltNeedling.this, "Production Date " + productionDate + " already Exists.", "Production Date Already Exists", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        try {
            ...
            ObjFeltNeedling.hmFeltNeedlingDetails.clear();
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                remarks = ((String) Table.getValueAt(i, 4)).trim();

                loomNoString = Table.getValueAt(i, 6).toString().trim();  //5
                if (loomNoString.equals("") || loomNoString.equals(null)) {
                    JOptionPane.showMessageDialog(this, "Select Loom No.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                } else {
                    loomNo = Integer.parseInt(loomNoString);
                }

                heatOutDt = Table.getValueAt(i, 11).toString().trim();  //10
                ...
                heatInDt = Table.getValueAt(i, 12).toString().trim();   //11
                ...
                if (EditMode == EITLERPGLOBAL.ADD) {
                    if (ObjFeltNeedling.checkPieceNoInDB(pieceNo)) {
                        JOptionPane.showMessageDialog(frmFeltNeedling.this, "Piece No." + pieceNo + " already Needled", " Piece No Already Exists", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                ...
                // check piece no is already needled?
                if (EditMode == EITLERPGLOBAL.EDIT) {
                    if (ObjFeltNeedling.checkPieceNoInDB(pieceNo, productionDate)) {
                        JOptionPane.showMessageDialog(frmFeltNeedling.this, "Piece No." + pieceNo + " already Needled.", " Piece No Already Exists", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                ...
                ObjFeltNeedlingDetails.setAttribute("PRODUCTION_PIECE_NO", pieceNo);
                ObjFeltNeedlingDetails.setAttribute("PRODUCTION_PARTY_CODE", partyCode);
                ObjFeltNeedlingDetails.setAttribute("WEIGHT", weight);
                ObjFeltNeedlingDetails.setAttribute("REMARKS", remarks);
                ObjFeltNeedlingDetails.setAttribute("LOOM_NO", loomNo);
                ObjFeltNeedlingDetails.setAttribute("HEAT_SETTING_OUT_DATE", heatOutDt);
                ObjFeltNeedlingDetails.setAttribute("HEAT_SETTING_IN_DATE", heatInDt);

                ObjFeltNeedling.hmFeltNeedlingDetails.put(Integer.toString(ObjFeltNeedling.hmFeltNeedlingDetails.size() + 1), ObjFeltNeedlingDetails);
            }
        ...
        ObjFeltNeedling.setAttribute("PRODUCTION_DATE", productionDate);
        ObjFeltNeedling.setAttribute("PRODUCTION_DOCUMENT_NO", productionDocumentNo);
        ObjFeltNeedling.setAttribute("PRODUCTION_FORM_NO", formNo);
        SetData();

        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltNeedling.Insert()) {
                DisplayData();
                ...
                if (OpgFinal.isSelected()) {
                    try {
                        ...
                        String responce = JavaMail.sendNotificationMailOfDetail(710, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, EITLERPGLOBAL.getComboCode(cmbHierarchy), false);
                ...
                JOptionPane.showMessageDialog(this, "Error occured while saving. Error is " + ObjFeltNeedling.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }

        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltNeedling.Update()) {
                DisplayData();
                ...
                JOptionPane.showMessageDialog(this, "Error occured while saving editing. Error is " + ObjFeltNeedling.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void SetData() {
        ...
        ObjFeltNeedling.setAttribute("HIERARCHY_ID", EITLERPGLOBAL.getComboCode(cmbHierarchy));
        ObjFeltNeedling.setAttribute("FROM", EITLERPGLOBAL.gNewUserID);
        ObjFeltNeedling.setAttribute("TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        ObjFeltNeedling.setAttribute("FROM_REMARKS", txtToRemarks.getText().trim());
        ObjFeltNeedling.setAttribute("UPDATED_BY", EITLERPGLOBAL.getComboCode(cmbUserName));

        if (OpgApprove.isSelected()) {
            ObjFeltNeedling.setAttribute("APPROVAL_STATUS", "A");
        }

        if (OpgFinal.isSelected()) {
            ObjFeltNeedling.setAttribute("APPROVAL_STATUS", "F");
        }

        if (OpgReject.isSelected()) {
            ObjFeltNeedling.setAttribute("APPROVAL_STATUS", "R");
            ObjFeltNeedling.setAttribute("SEND_DOC_TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        }

        if (OpgHold.isSelected()) {
            ObjFeltNeedling.setAttribute("APPROVAL_STATUS", "H");
        }
        //-------------------------------------------------//

        if (EditMode == EITLERPGLOBAL.ADD) {
            ObjFeltNeedling.setAttribute("CREATED_BY", EITLERPGLOBAL.gNewUserID);
        } else {
            ObjFeltNeedling.setAttribute("CREATED_BY", (int) ObjFeltNeedling.getAttribute("CREATED_BY").getVal());
            ObjFeltNeedling.setAttribute("CREATED_DATE", ObjFeltNeedling.getAttribute("CREATED_DATE").getString());
            ObjFeltNeedling.setAttribute("MODIFIED_BY", EITLERPGLOBAL.gNewUserID);
        }
    }
    ...
    private void Find() {
        ...
        frmFindFeltNeedling ObjFindFeltNeedling = (frmFindFeltNeedling) ObjLoader.getObj();

        if (ObjFindFeltNeedling.Cancelled == false) {
            if (!ObjFeltNeedling.Filter(ObjFindFeltNeedling.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltNeedling.this, " No records found.", "Find Felt Needling Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void Find(String prodDate) {
        ObjFeltNeedling.Filter("AND PROD_DATE='" + prodDate + "'");
        SetMenuForRights();
        DisplayData();
    }
    ...
    public void Find(String pieceNo, String prodDate) {
        ObjFeltNeedling.Filter("AND PROD_PIECE_NO='" + pieceNo + "'");
        SetMenuForRights();
        DisplayData();
    }
    ...
    public void FindWaiting() {
        ObjFeltNeedling.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=710 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }

    private void MoveFirst() {
        ObjFeltNeedling.MoveFirst();
        DisplayData();
    }

    private void MovePrevious() {
        ObjFeltNeedling.MovePrevious();
        DisplayData();
    }

    private void MoveNext() {
        ObjFeltNeedling.MoveNext();
        DisplayData();
    }

    private void MoveLast() {
        ObjFeltNeedling.MoveLast();
        DisplayData();
    }
