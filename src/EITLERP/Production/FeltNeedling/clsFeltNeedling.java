...
public class clsFeltNeedling {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT PROD_DATE FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND PROD_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND PROD_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY PROD_DATE");
            HistoryView = false;
            MoveLast();
            return true;
        } catch (Exception e) {
    ...
    public boolean Insert() {
        ...
        try {
            ...
            for (int i = 1; i <= hmFeltNeedlingDetails.size(); i++) {
                clsFeltNeedlingDetails ObjFeltNeedlingDetails = (clsFeltNeedlingDetails) hmFeltNeedlingDetails.get(Integer.toString(i));
                ...
                resultSetTemp.updateString("PROD_DEPT", "NEEDLING");
                ...
                resultSetTemp.updateInt("LOOM_NO", (int) ObjFeltNeedlingDetails.getAttribute("LOOM_NO").getVal());
                
                if (ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_OUT_DATE").getString().equals("")) {
                    resultSetTemp.updateString("HEAT_SETTING_OUT_DATE", "");
                } else {
                    resultSetTemp.updateString("HEAT_SETTING_OUT_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_OUT_DATE").getString()));
                }
                
                if (ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_IN_DATE").getString().equals("")) {
                    resultSetTemp.updateString("HEAT_SETTING_IN_DATE", "");
                } else {
                    resultSetTemp.updateString("HEAT_SETTING_IN_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_IN_DATE").getString()));
                }
                ...
                resultSetHistory.updateString("PROD_DEPT", "NEEDLING");
                ...
                resultSetHistory.updateInt("LOOM_NO", (int) ObjFeltNeedlingDetails.getAttribute("LOOM_NO").getVal());
                
                if (ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_OUT_DATE").getString().equals("")) {
                    resultSetHistory.updateString("HEAT_SETTING_OUT_DATE", "");
                } else {
                    resultSetHistory.updateString("HEAT_SETTING_OUT_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_OUT_DATE").getString()));
                }
                
                if (ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_IN_DATE").getString().equals("")) {
                    resultSetHistory.updateString("HEAT_SETTING_IN_DATE", "");
                } else {
                    resultSetHistory.updateString("HEAT_SETTING_IN_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltNeedlingDetails.getAttribute("HEAT_SETTING_IN_DATE").getString()));
                }
...
//                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE PR_PIECE_NO+0=" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
...
//                            // data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT=PR_NEEDLING_WEIGHT_A+PR_NEEDLING_WEIGHT_B WHERE PR_PIECE_NO+0="+ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString()+"+0");
//                        } else if (ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString().contains("A")) {
//                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "',PR_NEEDLING_WEIGHT_A='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE PR_PIECE_NO+0=" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
//                            data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER SET WIP_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "',WIP_NEEDLING_WEIGHT_A='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");
//                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT=PR_NEEDLING_WEIGHT_A+PR_NEEDLING_WEIGHT_B WHERE PR_PIECE_NO+0=" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
//
//                        } else if (ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString().contains("B")) {
//                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "',PR_NEEDLING_WEIGHT_B='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE PR_PIECE_NO+0=" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
//                            data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER SET WIP_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "',WIP_NEEDLING_WEIGHT_B='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");
//                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT=PR_NEEDLING_WEIGHT_A+PR_NEEDLING_WEIGHT_B WHERE PR_PIECE_NO+0=" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
//                        } else {
//                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE PR_PIECE_NO+0=" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
//                            data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER SET WIP_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "',WIP_NEEDLING_WEIGHT_A='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' WHERE WIP_EXT_PIECE_NO='" + ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");
...
//                }
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 710; //Felt Needling Entry
            ...
            if (ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ...
                updateNeedlingDate(getAttribute("PRODUCTION_DOCUMENT_NO").getString());
            }
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_PROD_DATA_H WHERE PROD_DEPT = 'NEEDLING' AND PROD_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "' AND PROD_DOC_NO='" + getAttribute("PRODUCTION_DOCUMENT_NO").getString() + "'");
                    ...
                    if ("F".equals(getAttribute("APPROVAL_STATUS").getString())) {
                        if (ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString().contains("A") && ObjFeltNeedlingDetails.getAttribute("PRODUCTION_PIECE_NO").getString().contains("B")) {
                            ...
                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER R,PRODUCTION.FELT_WIP_PIECE_REGISTER W  "
                                    + "SET PR_NEEDLING_WEIGHT='" + EITLERPGLOBAL.round(ObjFeltNeedlingDetails.getAttribute("WEIGHT").getVal(), 2) + "' "
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.`FELT_PROD_DATA` SET REJECTED=0,CHANGED=1 WHERE PROD_DEPT='NEEDLING' AND PROD_DOC_NO='" + getAttribute("PRODUCTION_DOCUMENT_NO").getString() + "'");
                //Remove Old Records from FELT DOCUMENT APPROVAL TABLE
                //data.Execute("DELETE FROM PRODUCTION.`FELT_PROD_DOC_DATA` WHERE MODULE_ID=710 AND DOC_NO='"+getAttribute("PRODUCTION_DOCUMENT_NO").getString()+"'");
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.`FELT_PROD_DOC_DATA` WHERE MODULE_ID=710 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING'"
    ...
    public boolean IsEditable(String weavingDocumentNo, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND PROD_DOC_NO='" + weavingDocumentNo + "' AND APPROVED=1";
            rsTmp = tmpStmt.executeQuery(strSQL);
            rsTmp.first();
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.`FELT_PROD_DOC_DATA` WHERE MODULE_ID=710 AND USER_ID=" + Integer.toString(userID) + " AND DOC_NO='" + weavingDocumentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT DISTINCT PROD_DATE FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' " + stringFindQuery + "ORDER BY PROD_DATE";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            totalWeight = data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('" + resultSet.getString("PROD_DATE") + "') AND YEAR(PROD_DATE)=YEAR('" + resultSet.getString("PROD_DATE") + "') AND APPROVED=1");
            setAttribute("TOTAL_WEIGHT", totalWeight);

            previousWeight = data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('" + resultSet.getString("PROD_DATE") + "') AND YEAR(PROD_DATE)=YEAR('" + resultSet.getString("PROD_DATE") + "') AND PROD_DATE<'" + resultSet.getString("PROD_DATE") + "' AND APPROVED=1");
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING'  AND PROD_DATE='" + resultSet.getString("PROD_DATE") + "' ORDER BY SR_NO");
            ...
            while (resultSetTemp.next()) {
                ...
                clsFeltNeedlingDetails ObjFeltNeedlingDetails = new clsFeltNeedlingDetails();
                ...
                ObjFeltNeedlingDetails.setAttribute("LOOM_NO", resultSetTemp.getInt("LOOM_NO"));                
                ObjFeltNeedlingDetails.setAttribute("HEAT_SETTING_OUT_DATE", resultSetTemp.getString("HEAT_SETTING_OUT_DATE"));
                ObjFeltNeedlingDetails.setAttribute("HEAT_SETTING_IN_DATE", resultSetTemp.getString("HEAT_SETTING_IN_DATE"));
    ...
    public boolean setHistoryData(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.`FELT_PROD_DATA_H` WHERE PROD_DEPT = 'NEEDLING' AND PROD_DATE='" + pProductionDate + "' AND PROD_DOC_NO='" + pDocNo + "' AND REVISION_NO='" + resultSet.getInt("REVISION_NO") + "' ORDER BY REVISION_NO");
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_PROD_DATA_H WHERE PROD_DEPT = 'NEEDLING' AND PROD_DATE='" + stringProductionDate + "' AND PROD_DOC_NO='" + productionDocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltNeedling ObjFeltNeedling = new clsFeltNeedling();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_PROD_DATA_H WHERE PROD_DEPT='NEEDLING' AND PROD_DATE='" + pProductionDate + "' AND PROD_DOC_NO='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=710 AND CANCELED=0 ORDER BY RECEIVED_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=710 AND CANCELED=0 ORDER BY PROD_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocNo) {
                strSQL = "SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=710 AND CANCELED=0 ORDER BY PROD_DOC_NO";
            }
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltNeedling ObjDoc = new clsFeltNeedling();
    ...
    // Updates Needling Date in Order Master Table To confirm that Needling has completed
    private void updateNeedlingDate(String documentNo) {
        //String strQry="UPDATE PRODUCTION.FELT_ORDER_MASTER,PRODUCTION.FELT_PROD_DATA SET NDL_DATE=PROD_DATE WHERE PIECE_NO+0=PROD_PIECE_NO+0 AND PARTY_CD=PROD_PARTY_CODE AND PROD_DEPT='NEEDLING' AND PROD_DOC_NO='"+documentNo+"' AND APPROVED=1";
        ...
        data.Execute("CREATE TABLE PRODUCTION.TMP_UPDATE_FLAG_NEEDLING "
                ...
                + "WHERE PROD_DEPT='NEEDLING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=1 AND COALESCE(CANCELED,0)=0)  AND COALESCE(WIP_REJECTED_FLAG,0)=0 AND WIP_PRIORITY_HOLD_CAN_FLAG='3' ");
...
//                + "WHERE WIP_EXT_PIECE_NO = PROD_PIECE_NO AND PROD_DEPT ='NEEDLING' AND CANCELED =0 AND APPROVED =1 "
//                + "AND PROD_DOC_NO='" + getAttribute("PRODUCTION_DOCUMENT_NO").getString() + "' "
//                + "GROUP BY WIP_PIECE_NO "
//                + ") AS A "
//                + "SET WIP_NDL_DATE = MAXDATE, WIP_NEEDLING_WEIGHT = SUMWEIGHT "
...
//                + "WHERE W.WIP_PRIORITY_HOLD_CAN_FLAG IN (0) AND A.PIECE = W.WIP_PIECE_NO AND COALESCE(WIP_PIECE_AB_FLAG,'') !='AB'");
        String strQry = "";
        //strQry="UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER,PRODUCTION.FELT_PROD_DATA SET PR_NDL_DATE=PROD_DATE,PR_PIECE_STAGE='FINISHING',PR_WIP_STATUS='NEEDLED' WHERE PR_PIECE_NO+0=PROD_PIECE_NO+0 AND PR_PIECE_STAGE!='DIVERTED' AND PR_PARTY_CODE=PROD_PARTY_CODE AND PROD_DEPT='NEEDLING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=1";
        //data.Execute(strQry);
        strQry = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER,PRODUCTION.FELT_PROD_DATA SET WIP_NDL_DATE=PROD_DATE,WIP_PIECE_STAGE='FINISHING',WIP_STATUS='NEEDLED',WIP_PRIORITY_HOLD_CAN_FLAG=0 WHERE WIP_EXT_PIECE_NO=PROD_PIECE_NO AND WIP_PIECE_STAGE!='DIVERTED' AND WIP_PARTY_CODE=PROD_PARTY_CODE AND PROD_DEPT='NEEDLING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=1";
        data.Execute(strQry);
        data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER W, "
                + "( "
        ...
        data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER W, "
                ...
                + "GROUP BY TRIM(WIP_PIECE_NO) "
                + ") AS A "
                + "SET PR_NDL_DATE = MAXDATE, PR_NEEDLING_WEIGHT = SUMWEIGHT "
                + "WHERE A.PIECE = TRIM(W.PR_PIECE_NO)");

        data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER "
                + "SET WIP_PIECE_STAGE = 'FINISHING' , WIP_STATUS = 'NEEDLED' "
                + "WHERE WIP_PRIORITY_HOLD_CAN_FLAG IN (0)  AND WIP_WVG_DATE !='0000-00-00'  AND WIP_MND_DATE !='0000-00-00' AND WIP_NDL_DATE !='0000-00-00' AND WIP_FNSG_DATE ='0000-00-00' AND  WIP_SEAM_DATE ='0000-00-00' AND WIP_PIECE_STAGE IN ('BOOKING','PLANNING','WEAVING','MENDING','NEEDLING','FINISHING') AND WIP_PIECE_NO NOT LIKE ('%V%')");

        data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER "
                + "SET WIP_PIECE_STAGE = 'FINISHING' , WIP_STATUS = 'RE-PROCESS' "
                + "WHERE WIP_PRIORITY_HOLD_CAN_FLAG IN (0)  AND WIP_WVG_DATE !='0000-00-00'  AND WIP_MND_DATE !='0000-00-00' AND WIP_NDL_DATE !='0000-00-00' AND WIP_FNSG_DATE ='0000-00-00' AND  WIP_SEAM_DATE ='0000-00-00' AND WIP_PIECE_STAGE IN ('BOOKING','PLANNING','WEAVING','MENDING','NEEDLING','FINISHING') AND WIP_PIECE_NO LIKE ('%V%')");

    }

    // checks piece no already exist in db
    public boolean checkPieceNoInDB(String pPieceNo) {
        int count = data.getIntValueFromDB("SELECT COUNT(PROD_PIECE_NO) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND PROD_PIECE_NO='" + pPieceNo + "' AND PROD_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND PROD_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
    ...
    public boolean checkPieceNoInDB(String pPieceNo, String pProdDate) {
        ...
        if (count >= 1) {
            ...
            try {
                ...
                ResultSet rsTmp = stTmp.executeQuery("SELECT PROD_DATE FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT='NEEDLING' AND PROD_PIECE_NO='" + pPieceNo + "' AND PROD_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND PROD_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
                while (rsTmp.next()) {
    ...
    public boolean checkProductionDateInDB(String pProdDate) {
        int count = data.getIntValueFromDB("SELECT COUNT(PROD_DATE) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND PROD_DATE='" + pProdDate + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
    ...
    public TReportWriter.SimpleDataProvider.TTable getReportData(String prodDate) {
        ...
        try {
            ...
            //String str ="SELECT PROD_DATE,PROD_FORM_NO,REPLACE(PROD_PIECE_NO,' ','') PROD_PIECE_NO,COALESCE(PARTY_NAME,'') PARTY_NAME, WEIGHT,LNGTH,WIDTH,GSQ,GRUP,PREVIOUS_WEIGHT,DAY_WEIGHT,TOTAL_WEIGHT FROM (SELECT PROD_DATE,PROD_FORM_NO,PROD_PIECE_NO,PROD_PARTY_CODE,WEIGHT FROM PRODUCTION.FELT_PROD_DATA A WHERE PROD_DATE = '"+prodDate+"' AND PROD_DEPT='NEEDLING') D LEFT JOIN (SELECT GRUP, GSQ,LNGTH,WIDTH,PIECE_NO,PARTY_CD FROM PRODUCTION.FELT_ORDER_MASTER) O ON O.PARTY_CD = D.PROD_PARTY_CODE AND O.PIECE_NO +0 = D.PROD_PIECE_NO +0 LEFT JOIN (SELECT PARTY_CODE,TRIM(PARTY_NAME) PARTY_NAME FROM D_SAL_PARTY_MASTER) AS P ON P.PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS PREVIOUS_WEIGHT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('"+prodDate+"') AND YEAR(PROD_DATE)=YEAR('"+prodDate+"') AND PROD_DATE<'"+prodDate+"' AND APPROVED=1) AS W ON O.PARTY_CD = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS DAY_WEIGHT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('"+prodDate+"') AND YEAR(PROD_DATE)=YEAR('"+prodDate+"') AND PROD_DATE='"+prodDate+"' AND APPROVED=1) AS DW ON O.PARTY_CD = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS TOTAL_WEIGHT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('"+prodDate+"') AND YEAR(PROD_DATE)=YEAR('"+prodDate+"') AND PROD_DATE<='"+prodDate+"' AND APPROVED=1) AS T ON O.PARTY_CD = D.PROD_PARTY_CODE";
            //String str ="SELECT PROD_DATE,PROD_FORM_NO,REPLACE(PROD_PIECE_NO,' ','') PROD_PIECE_NO,COALESCE(PARTY_NAME,'') PARTY_NAME, WEIGHT,LNGTH,WIDTH,GSQ,GRUP,PREVIOUS_WEIGHT,DAY_WEIGHT,TOTAL_WEIGHT FROM (SELECT PROD_DATE,PROD_FORM_NO,PROD_PIECE_NO,PROD_PARTY_CODE,WEIGHT FROM PRODUCTION.FELT_PROD_DATA A WHERE PROD_DATE = '"+prodDate+"' AND PROD_DEPT='NEEDLING') D LEFT JOIN (SELECT PR_GROUP AS GRUP, PR_GSM AS GSQ, PR_LENGTH AS LNGTH,PR_WIDTH AS WIDTH,PR_PIECE_NO AS PIECE_NO,PR_PARTY_CODE AS PARTY_CD FROM PRODUCTION.FELT_SALES_PIECE_REGISTER) O ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE AND O.PR_PIECE_NO = D.PROD_PIECE_NO LEFT JOIN (SELECT PARTY_CODE,TRIM(PARTY_NAME) PARTY_NAME FROM D_SAL_PARTY_MASTER) AS P ON P.PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS PREVIOUS_WEIGHT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('"+prodDate+"') AND YEAR(PROD_DATE)=YEAR('"+prodDate+"') AND PROD_DATE<'"+prodDate+"' AND APPROVED=1) AS W ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS DAY_WEIGHT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('"+prodDate+"') AND YEAR(PROD_DATE)=YEAR('"+prodDate+"') AND PROD_DATE='"+prodDate+"' AND APPROVED=1) AS DW ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS TOTAL_WEIGHT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('"+prodDate+"') AND YEAR(PROD_DATE)=YEAR('"+prodDate+"') AND PROD_DATE<='"+prodDate+"' AND APPROVED=1) AS T ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE";
