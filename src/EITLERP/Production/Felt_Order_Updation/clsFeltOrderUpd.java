...
public class clsFeltOrderUpd {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet=statement.executeQuery("SELECT FLT_AMEND_ID,FLT_AMEND_DATE,FLT_AMEND_REASON FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE FLT_AMEND_DATE >= '"+EITLERPGLOBAL.FinFromDateDB+"' AND FLT_AMEND_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ORDER BY FLT_AMEND_DATE");
            HistoryView=false;
            Ready=true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_ORDER_AMENDMENT WHERE FLT_AMEND_DATE=''");
            
            // Felt order Updation data history connection
            statementHistory=connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            resultSetHistory=statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_DATE=''");
            
          

          // Felt order Updation Last Free No, 
             setAttribute("FLT_AMEND_ID",getNextFreeNo(720,true));
            ...
            for(int i=1;i<=hmFeltOrderUpdDetails.size();i++) {
                ...
                resultSetTemp.updateString("FLT_AMEND_DATE", EITLERPGLOBAL.formatDateDB(getAttribute("FLT_AMEND_DATE").getString()));
                resultSetTemp.updateString("FLT_AMEND_ID", getAttribute("FLT_AMEND_ID").getString());
                resultSetTemp.updateString("FLT_AMEND_REASON", getAttribute("FLT_AMEND_REASON").getString());
                resultSetTemp.updateString("FLT_PIECE_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_PIECE_NO").getString());
                resultSetTemp.updateString("FLT_PARTY_CODE",ObjFeltOrderUpdDetails.getAttribute("FLT_PARTY_CODE").getString());
                resultSetTemp.updateString("FLT_ORDER_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_ORDER_DATE").getString());
                resultSetTemp.updateString("FLT_PRODUCT_CODE",ObjFeltOrderUpdDetails.getAttribute("FLT_PRODUCT_CODE").getString());
                resultSetTemp.updateString("FLT_GROUP",ObjFeltOrderUpdDetails.getAttribute("FLT_GROUP").getString());
                resultSetTemp.updateString("FLT_STYLE",ObjFeltOrderUpdDetails.getAttribute("FLT_STYLE").getString());
                resultSetTemp.updateString("FLT_LENGTH",ObjFeltOrderUpdDetails.getAttribute("FLT_LENGTH").getString());
                resultSetTemp.updateString("FLT_WIDTH",ObjFeltOrderUpdDetails.getAttribute("FLT_WIDTH").getString());
                resultSetTemp.updateString("FLT_GSQ",ObjFeltOrderUpdDetails.getAttribute("FLT_GSQ").getString());
                resultSetTemp.updateString("FLT_WIEGHT",ObjFeltOrderUpdDetails.getAttribute("FLT_WIEGHT").getString());
                resultSetTemp.updateString("FLT_REQ_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REQ_DATE").getString());
                resultSetTemp.updateString("FLT_COMM_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_COMM_DATE").getString());
                resultSetTemp.updateString("FLT_WVG_AGREED_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_WVG_AGREED_DATE").getString());
                resultSetTemp.updateString("FLT_REV_REQ_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_REQ_DATE").getString());
                resultSetTemp.updateString("FLT_REV_COMM_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_COMM_DATE").getString());
                resultSetTemp.updateString("FLT_REV_AGREED_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_AGREED_DATE").getString());
                resultSetTemp.updateString("FLT_REV_REQ_REASON",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_REQ_REASON").getString());
                resultSetTemp.updateString("FLT_REV_COMM_REASON",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_COMM_REASON").getString());
                resultSetTemp.updateString("FLT_MACHINE_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_MACHINE_NO").getString());
                resultSetTemp.updateString("FLT_POSITION",ObjFeltOrderUpdDetails.getAttribute("FLT_POSITION").getString());
                resultSetTemp.updateString("FLT_REF_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_REF_NO").getString());
                resultSetTemp.updateString("FLT_CONF_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_CONF_NO").getString());
                resultSetTemp.updateString("FLT_PO_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_PO_NO").getString());
                resultSetTemp.updateString("FLT_PO_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_PO_DATE").getString());
                resultSetTemp.updateString("FLT_PO_REMARK",ObjFeltOrderUpdDetails.getAttribute("FLT_PO_REMARK").getString());
                resultSetTemp.updateString("FLT_WVG_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_WVG_DATE").getString());
                resultSetTemp.updateString("FLT_MND_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_MND_DATE").getString());
                resultSetTemp.updateString("FLT_NDL_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_NDL_DATE").getString());
                resultSetTemp.updateString("FLT_AGREED_IND",ObjFeltOrderUpdDetails.getAttribute("FLT_AGREED_IND").getString());
                resultSetTemp.updateString("FLT_PROD_IND",ObjFeltOrderUpdDetails.getAttribute("FLT_PROD_IND").getString());
                resultSetTemp.updateString("FLT_AMEND_REMARK",ObjFeltOrderUpdDetails.getAttribute("FLT_AMEND_REMARK").getString());
                resultSetTemp.updateString("FLT_MFG_STATUS",ObjFeltOrderUpdDetails.getAttribute("FLT_MFG_STATUS").getString());
                ...
                resultSetHistory.updateString("FLT_AMEND_DATE", EITLERPGLOBAL.formatDateDB(getAttribute("FLT_AMEND_DATE").getString()));
                resultSetHistory.updateString("FLT_AMEND_ID", getAttribute("FLT_AMEND_ID").getString());
                resultSetHistory.updateString("FLT_AMEND_REASON", getAttribute("FLT_AMEND_REASON").getString());
                resultSetHistory.updateString("FLT_PIECE_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_PIECE_NO").getString());
                resultSetHistory.updateString("FLT_PARTY_CODE",ObjFeltOrderUpdDetails.getAttribute("FLT_PARTY_CODE").getString());
                resultSetHistory.updateString("FLT_ORDER_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_ORDER_DATE").getString());
                resultSetHistory.updateString("FLT_PRODUCT_CODE",ObjFeltOrderUpdDetails.getAttribute("FLT_PRODUCT_CODE").getString());
                resultSetHistory.updateString("FLT_GROUP",ObjFeltOrderUpdDetails.getAttribute("FLT_GROUP").getString());
                resultSetHistory.updateString("FLT_STYLE",ObjFeltOrderUpdDetails.getAttribute("FLT_STYLE").getString());
                resultSetHistory.updateString("FLT_LENGTH",ObjFeltOrderUpdDetails.getAttribute("FLT_LENGTH").getString());
                resultSetHistory.updateString("FLT_WIDTH",ObjFeltOrderUpdDetails.getAttribute("FLT_WIDTH").getString());
                resultSetHistory.updateString("FLT_GSQ",ObjFeltOrderUpdDetails.getAttribute("FLT_GSQ").getString());
                resultSetHistory.updateString("FLT_WIEGHT",ObjFeltOrderUpdDetails.getAttribute("FLT_WIEGHT").getString());
                resultSetHistory.updateString("FLT_REQ_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REQ_DATE").getString());
                resultSetHistory.updateString("FLT_COMM_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_COMM_DATE").getString());
                resultSetHistory.updateString("FLT_WVG_AGREED_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_WVG_AGREED_DATE").getString());
                resultSetHistory.updateString("FLT_REV_REQ_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_REQ_DATE").getString());
                resultSetHistory.updateString("FLT_REV_COMM_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_COMM_DATE").getString());
                resultSetHistory.updateString("FLT_REV_AGREED_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_AGREED_DATE").getString());
                resultSetHistory.updateString("FLT_REV_REQ_REASON",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_REQ_REASON").getString());
                resultSetHistory.updateString("FLT_REV_COMM_REASON",ObjFeltOrderUpdDetails.getAttribute("FLT_REV_COMM_REASON").getString());
                resultSetHistory.updateString("FLT_MACHINE_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_MACHINE_NO").getString());
                resultSetHistory.updateString("FLT_POSITION",ObjFeltOrderUpdDetails.getAttribute("FLT_POSITION").getString());
                resultSetHistory.updateString("FLT_REF_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_REF_NO").getString());
                resultSetHistory.updateString("FLT_CONF_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_CONF_NO").getString());
                resultSetHistory.updateString("FLT_PO_NO",ObjFeltOrderUpdDetails.getAttribute("FLT_PO_NO").getString());
                resultSetHistory.updateString("FLT_PO_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_PO_DATE").getString());
                resultSetHistory.updateString("FLT_PO_REMARK",ObjFeltOrderUpdDetails.getAttribute("FLT_PO_REMARK").getString());
                resultSetHistory.updateString("FLT_WVG_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_WVG_DATE").getString());
                resultSetHistory.updateString("FLT_MND_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_MND_DATE").getString());
                resultSetHistory.updateString("FLT_NDL_DATE",ObjFeltOrderUpdDetails.getAttribute("FLT_NDL_DATE").getString());
                resultSetHistory.updateString("FLT_AGREED_IND",ObjFeltOrderUpdDetails.getAttribute("FLT_AGREED_IND").getString());
                resultSetHistory.updateString("FLT_PROD_IND",ObjFeltOrderUpdDetails.getAttribute("FLT_PROD_IND").getString());
                resultSetHistory.updateString("FLT_AMEND_REMARK",ObjFeltOrderUpdDetails.getAttribute("FLT_AMEND_REMARK").getString());
                resultSetHistory.updateString("FLT_MFG_STATUS",ObjFeltOrderUpdDetails.getAttribute("FLT_MFG_STATUS").getString());
            ...
            ObjFeltProductionApprovalFlow.ModuleID=720; //Felt Weaving Entry
            ObjFeltProductionApprovalFlow.DocNo=getAttribute("FLT_AMEND_ID").getString();
            ...
            ObjFeltProductionApprovalFlow.TableName="FELT_ORDER_AMENDMENT";
            ...
            ObjFeltProductionApprovalFlow.FieldName="FLT_AMEND_ID";
            ...
            if(ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ...
                updatefeltorder(getAttribute("FLT_AMEND_ID").getString(),getAttribute("FLT_AMEND_REASON").getString());
     //         updateWeavingDate(getAttribute("FLT_AMEND_ID").getString(),getAttribute("FLT_AMEND_REASON").getString());
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory=statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("FLT_AMEND_DATE").getString())+"' AND FLT_AMEND_ID='"+getAttribute("FLT_AMEND_ID").getString()+"'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE FLT_AMEND_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("FLT_AMEND_DATE").getString())+"' AND FLT_AMEND_ID='"+getAttribute("FLT_AMEND_ID").getString()+"'");
            
            resultSetHistory=statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("FLT_AMEND_DATE").getString())+"' AND FLT_AMEND_ID='"+getAttribute("FLT_AMEND_ID").getString()+"'");
           ...
           resultSetTemp.moveToInsertRow();
            ...
            //======== Update the Approval Flow =========
            clsFeltProductionApprovalFlow ObjFeltProductionApprovalFlow = new clsFeltProductionApprovalFlow();
            ObjFeltProductionApprovalFlow.ModuleID=720; //Felt Order Updation Module
            ObjFeltProductionApprovalFlow.DocNo=getAttribute("FLT_AMEND_ID").getString();
            ObjFeltProductionApprovalFlow.DocDate=EITLERPGLOBAL.getCurrentDateDB();
            ObjFeltProductionApprovalFlow.From=(int)getAttribute("FROM").getVal();
            ObjFeltProductionApprovalFlow.To=(int)getAttribute("TO").getVal();
            ObjFeltProductionApprovalFlow.Status=getAttribute("APPROVAL_STATUS").getString();
            ObjFeltProductionApprovalFlow.TableName="PRODUCTION.FELT_ORDER_AMENDMENT";
            ...
            if(IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT SET REJECTED=0,CHANGED=1 WHERE FLT_AMEND_ID ='"+getAttribute("FLT_AMEND_ID").getString()+"'");
                //Remove Old Records from FELT DOCUMET APPROVAL TABLE
                //data.Execute("DELETE FROM PRODUCTION.`FELT_PROD_DOC_DATA` WHERE MODULE_ID=720 AND DOC_NO='"+getAttribute("PRODUCTION_DOCUMENT_NO").getString()+"'");
    ...
    public boolean CanDelete(String documentNo,String stringProductionDate,int userID) {
        ...
        try {
            ...
            strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE  FELT_AMEND_ID='"+documentNo +"' AND APPROVED="+1;
            ...
            if(rsTmp.getInt("COUNT")>0){  //Item is Approved
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=720 AND USER_ID="+userID+" AND DOC_NO='"+ documentNo +"' AND STATUS='W'";
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
                
                if(rsTmp.getInt("COUNT")>0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE "
                    + " AND FLT_AMEND_DATE= '"+ EITLERPGLOBAL.formatDateDB(stringProductionDate) +"'"
                    + " AND FLT_AMEND_ID='" + documentNo + "'";
    ...
    public boolean IsEditable(String orderupdDocumentNo,int userID) {
        ...
        try {
            ...
            strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE FLT_AMEND_ID='"+ orderupdDocumentNo +"' AND APPROVED=1";
            rsTmp=tmpStmt.executeQuery(strSQL);
            rsTmp.first();
            ...
            if(rsTmp.getInt("COUNT")>0){  //Item is Approved
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=720 AND USER_ID="+userID+" AND DOC_NO='"+ orderupdDocumentNo +"' AND STATUS='W'";
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean Filter(String stringFindQuery) {
        Ready=false;
        try {
           // String strSql = "SELECT DISTINCT AMEND_DATE FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE  " + stringFindQuery + " ORDER BY FLT_AMEND_DATE";
            String strSql = "SELECT DISTINCT FLT_AMEND_ID,FLT_AMEND_DATE,FLT_AMEND_REASON FROM PRODUCTION.FELT_ORDER_AMENDMENT WHERE  " + stringFindQuery + "";
            connection=data.getConn();
            statement=connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("FLT_AMEND_DATE",resultSet.getDate("FLT_AMEND_DATE"));
            setAttribute("FLT_AMEND_ID",resultSet.getString("FLT_AMEND_ID"));
            setAttribute("FLT_AMEND_REASON",resultSet.getString("FLT_AMEND_REASON"));
  
  
            hmFeltOrderUpdDetails.clear();
            
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_ORDER_AMENDMENT WHERE FLT_AMEND_ID = '"+ resultSet.getString("FLT_AMEND_ID") +"' AND FLT_AMEND_DATE='"+ resultSet.getDate("FLT_AMEND_DATE") +"' ORDER BY FLT_AMEND_ID");
  ...
  //              setAttribute("PRODUCTION_FORM_NO",resultSetTemp.getString("PROD_FORM_NO"));
                ...
                ObjFeltOrderUpdDetails.setAttribute("FLT_WVG_AGREED_DATE",resultSetTemp.getString("FLT_WVG_AGREED_DATE"));
                ...
                ObjFeltOrderUpdDetails.setAttribute("FLT_AGREED_IND",resultSetTemp.getString("FLT_AGREED_IND"));
                ObjFeltOrderUpdDetails.setAttribute("FLT_PROD_IND",resultSetTemp.getString("FLT_PROD_IND"));
                ObjFeltOrderUpdDetails.setAttribute("FLT_AMEND_REMARK",resultSetTemp.getString("FLT_AMEND_REMARK"));
                ObjFeltOrderUpdDetails.setAttribute("FLT_MFG_STATUS",resultSetTemp.getString("FLT_MFG_STATUS"));
    ...
    public boolean setHistoryData(String pProductionDate,String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_DATE='"+ pProductionDate+"' AND FLT_AMEND_ID='"+pDocNo+"' AND REVISION_NO='"+ resultSet.getInt("REVISION_NO") +"' ORDER BY REVISION_NO");
            
            while(resultSetTemp.next()) {
                serialNoCounter++;
                setAttribute("FLT_AMEND_ID",resultSetTemp.getString("FLT_AMEND_ID"));
      //          setAttribute("PRODUCTION_FORM_NO",resultSetTemp.getString("PROD_FORM_NO"));
...
//            rsTmp=stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_DATE='"+ stringProductionDate1+"' AND FLT_AMEND_ID='"+productionDocumentNo+"' GROUP BY REVISION_NO");
            rsTmp=stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_ID='"+productionDocumentNo+"' GROUP BY REVISION_NO");
            
            while(rsTmp.next()) {
                clsFeltOrderUpd ObjFeltOrderUpd = new clsFeltOrderUpd();
    ...
    public boolean ShowHistory(String pProductionDate,String pDocNo) {
        ...
        try {
            ...
            resultSet=statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_ORDER_AMENDMENT_H WHERE FLT_AMEND_DATE='"+ pProductionDate+"' AND FLT_AMEND_ID ='"+pDocNo+"'");
            Ready=true;
    ...
    public static HashMap getPendingApprovals(int pUserID,int pOrder) {
        ...
        try {
            ...
            if(pOrder==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT DISTINCT FLT_AMEND_ID,FLT_AMEND_DATE,RECEIVED_DATE,PARA_DESC FROM PRODUCTION.FELT_ORDER_AMENDMENT, PRODUCTION.FELT_PROD_DOC_DATA ,PRODUCTION.FELT_PARAMETER_MASTER  WHERE FLT_AMEND_ID=DOC_NO AND STATUS='W' AND MODULE_ID=720 AND CANCELED=0  AND USER_ID="+pUserID+"  AND PARA_ID ='ORDER_UPD_REASON' AND PARA_CODE = FLT_AMEND_REASON ORDER BY RECEIVED_DATE,FLT_AMEND_ID";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocDate) {
                strSQL="SELECT DISTINCT FLT_AMEND_ID,FLT_AMEND_DATE,RECEIVED_DATE,PARA_DESC FROM PRODUCTION.FELT_ORDER_AMENDMENT, PRODUCTION.FELT_PROD_DOC_DATA ,PRODUCTION.FELT_PARAMETER_MASTER  WHERE FLT_AMEND_ID=DOC_NO AND STATUS='W' AND MODULE_ID=720 AND CANCELED=0  AND USER_ID="+pUserID+"  AND PARA_ID ='ORDER_UPD_REASON' AND PARA_CODE = FLT_AMEND_REASON ORDER BY FLT_AMEND_DATE,FLT_AMEND_ID";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocNo) {
                strSQL="SELECT DISTINCT FLT_AMEND_ID,FLT_AMEND_DATE,RECEIVED_DATE,PARA_DESC FROM PRODUCTION.FELT_ORDER_AMENDMENT, PRODUCTION.FELT_PROD_DOC_DATA ,PRODUCTION.FELT_PARAMETER_MASTER  WHERE FLT_AMEND_ID=DOC_NO AND STATUS='W' AND MODULE_ID=720 AND CANCELED=0  AND USER_ID="+pUserID+"  AND PARA_ID ='ORDER_UPD_REASON' AND PARA_CODE = FLT_AMEND_REASON ORDER BY FLT_AMEND_ID";
            }
            ...
            while(rsTmp.next()) {
                ...
                Counter=Counter+1;
                clsFeltOrderUpd ObjDoc=new clsFeltOrderUpd();
                
                //------------- Header Fields --------------------//
                ObjDoc.setAttribute("DOC_NO",rsTmp.getString("FLT_AMEND_ID"));
                ObjDoc.setAttribute("DOC_DATE",rsTmp.getString("FLT_AMEND_DATE"));
    ...
    public String getPartyCode(String pPieceNo) {
       ...
       public String getGroupCD(String pPieceNo) {
        ...
        return data.getStringValueFromDB("SELECT GRUP FROM PRODUCTION.FELT_RATE_MASTER WHERE SUBSTRING(ITEM_CODE,1,6)='"+pProductNo+"'");
       ...
       public String getAgreedDate(String pPieceNo) {
        return data.getStringValueFromDB("SELECT WVG_AGREED_DATE FROM PRODUCTION.FELT_ORDER_MASTER WHERE PIECE_NO+0='"+pPieceNo+"'");
    ...
    }public String getprodind(String pPieceNo) {
        return data.getStringValueFromDB("SELECT PROD_IND_A DATE FROM PRODUCTION.FELT_ORDER_MASTER WHERE PIECE_NO+0='"+pPieceNo+"'");
       
    }public String getagreedind(String pPieceNo) {
        return data.getStringValueFromDB("SELECT AGREED_IND FROM PRODUCTION.FELT_ORDER_MASTER WHERE PIECE_NO+0='"+pPieceNo+"'");
 
    }public String getmfgstatus(String pPieceNo) {
        return data.getStringValueFromDB("SELECT PARA_DESC FROM PRODUCTION.FELT_ORDER_MASTER,PRODUCTION.FELT_PARAMETER_MASTER  WHERE PARA_ID = 'FELT_MFG_STATUS' AND PARA_CODE = PRIORITY AND PIECE_NO+0='"+pPieceNo+"'");
...
private void updatefeltorder(String documentNo, String Reason){
    if (Reason.equals("1"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET DELIV_DATE = FLT_REQ_DATE,COMM_DATE=FLT_REQ_DATE,AGREED_DATE=FLT_AGREED_DATE WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON = 1 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("2"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET REV_REQ_DATE = FLT_REV_REQ_DATE,REV_COMM_DATE=FLT_REV_REQ_DATE,WVG_AGREED_DATE=FLT_REV_AGREED_DATE WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON = 2 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("3"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET LNGTH = FLT_LENGTH,WIDTH=FLT_WIDTH,GSQ=FLT_GSQ,WEIGHT= ROUND((LNGTH*WIDTH*GSQ)/1000,2) WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =3 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("4"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET MACHINE_NO = FLT_MACHINE_NO,POSITION =FLT_POSITION WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =4 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("5"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PO_NO = FLT_PO_NO, PO_DATE =FLT_PO_DATE,PO_REMARK = FLT_PO_REMARK,CONF_NO = FLT_CONF_NO,REF_NO = FLT_REF_NO WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =5 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("6"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PARTY_CD = FLT_PARTY_CODE WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON = 6 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
     if (Reason.equals("7"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRODUCT_CODE = FLT_PRODUCT_CODE WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON = 7 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("8"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 9  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =8 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("9"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 10  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =9 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
     if (Reason.equals("10"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 11  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =10 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
      if (Reason.equals("11"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 12  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =11 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
     if (Reason.equals("12"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 7  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =12 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    if (Reason.equals("13"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 8  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =13 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
     if (Reason.equals("14"))  
    {
    data.Execute("UPDATE PRODUCTION.FELT_ORDER_AMENDMENT,PRODUCTION.FELT_ORDER_MASTER SET PRIORITY = 1  WHERE PIECE_NO+0 = FLT_PIECE_NO+0 AND APPROVED =1 AND FLT_AMEND_REASON =14 AND FLT_AMEND_ID ='"+documentNo+"'");
    }
    ...
    public HashMap getUserNameList(int pHierarchyId, int pUserId, String pModule){
       ...
       public static HashMap getAmendReasonList() {
        ...
        try{
            ...
            Statement stTmp=Conn.createStatement();
            int counter=1;
            ResultSet rsTmp=stTmp.executeQuery("SELECT 0 AS PARA_CODE,'SELECT REASON CODE' AS PARA_DESC UNION ALL SELECT PARA_CODE,PARA_DESC FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID = 'ORDER_UPD_REASON' ORDER BY PARA_CODE");
            while(rsTmp.next()){
                ComboData aData=new ComboData();
   ...
   public static HashMap getAmendReasonList(int pCompanyID,int pUserID) {
        ...
        try {
            ...
            while(!rsTmp.isAfterLast()) {
                Counter=Counter+1;
                clsFeltOrderUpd ObjReason=new clsFeltOrderUpd();
  ...
  //              Piecedetail[30]=rsTmp.getString("INCHARGE_NAME");
    ...
    public static String getNextFreeNo(int pModuleID,boolean UpdateLastNo) {
        ...
        try {
            ...
            strSQL="SELECT LAST_USED_NO,PADDING_BY,NO_LENGTH,PREFIX_CHARS,SUFFIX_CHARS FROM D_COM_FIRSTFREE WHERE COMPANY_ID=2 AND MODULE_ID=720 AND FIRSTFREE_NO=173";
            rsTmp=tmpStmt.executeQuery(strSQL);
            ...
            if(rsTmp.getRow()>0) {
                ...
                if(UpdateLastNo) {
                    ...
                    data.Execute("UPDATE D_COM_FIRSTFREE SET LAST_USED_NO='"+strNewNo.trim()+"',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID=2 AND MODULE_ID=720 AND FIRSTFREE_NO=173");
                }
