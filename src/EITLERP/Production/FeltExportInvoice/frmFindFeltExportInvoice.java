/*
 * frmFindFeltExportInvoice.java
 * This form is used for searching  the details of Felt Export Invoice
 * 
 * Created on June 21, 2013, 3:40 PM
 */
...
public class frmFindFeltExportInvoice extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Find Felt Export Invoice Details");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 7, 200, 15);

        cmdFind.setMnemonic('F');
        cmdFind.setText("Find");
        cmdFind.setToolTipText("Find Export Invoice Details by press ALT+F");
