...
public class frmmachinesurveyFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("Find Felt Machine Survey Details");
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!partycode.equals("")) {
            stringFindQuery+=" AA.MM_PARTY_CODE ='"+ partycode +"'";
        }  
