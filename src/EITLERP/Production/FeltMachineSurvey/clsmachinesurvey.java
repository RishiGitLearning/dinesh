...
public class clsmachinesurvey {
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            rsResultSet=Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER ORDER BY MM_DOC_NO");
             //    rsResultSet=Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER A JOIN PRODUCTION.FELT_MACHINE_MASTER_DETAIL B ON A.MM_PARTY_CODE=B.MM_PARTY_CODE ORDER BY A.MM_DOC_NO,B.SR_NO");
    ...
    public boolean Insert() {
        ...
        try {
            ...
            frmmachinesurvey fms=new frmmachinesurvey();
            ...
            rsHistory=stHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER_H WHERE MM_DOC_NO=''"); // '1' for restricting all data retrieval
            rsHistory.first();
            rsHDetail=stHDetail.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL_H WHERE MM_DOC_NO=''");
            rsHDetail.first();
            ...
            System.out.println();
            setAttribute("MM_DOC_NO",getAttribute("MM_PARTY_CODE").getString()+getAttribute("MM_MACHINE_NO").getString());
        ...
        //    rsHistory.updateString("UPDATE_BY",EITLERPGLOBAL.gLoginID);
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MM_DOC_NO='' order by sr_no*1");
            ...
            for(int i=1;i<=colMRItems.size();i++) {
                ...
                clsmachinesurveyitem ObjMRItems=(clsmachinesurveyitem) colMRItems.get(Integer.toString(i));
                
                
                rsTmp.moveToInsertRow();
               
                rsTmp.updateString("MM_DOC_NO",getAttribute("MM_PARTY_CODE").getString()+getAttribute("MM_MACHINE_NO").getString());
                ...
                rsHDetail.updateString("MM_DOC_NO",getAttribute("MM_PARTY_CODE").getString()+getAttribute("MM_MACHINE_NO").getString());
            ...
            ObjFlow.ModuleID=clsmachinesurvey.ModuleID;
            ...
            ObjFlow.TableName="PRODUCTION.FELT_MACHINE_MASTER_HEADER";
    ...
    public boolean Update() {
        ...
        try {
            ...
            rsHistory=stHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER_H WHERE MM_DOC_NO='1'"); // '1' for restricting all data retrieval
            rsHistory.first();
            rsHDetail=stHDetail.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL_H WHERE MM_DOC_NO='1' order by sr_no*1");
            rsHDetail.first();
           
            //------------------------------------//
           
            String theDocNo=getAttribute("MM_DOC_NO").getString();
            ...
            int RevNo=EITLERPGLOBAL.GetQueryResult("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER_H WHERE MM_DOC_NO='"+(String)getAttribute("MM_DOC_NO").getObj()+"'");
            RevNo++;
            ...
            //rsHistory.updateInt("UPDATE_BY",(int)getAttribute("MODIFIED_BY").getVal());
           // rsHistory.updateInt("UPDATE_BY",(int)getAttribute("UPDATE_BY").getVal());
            rsHistory.updateString("APPROVAL_STATUS",getAttribute("APPROVAL_STATUS").getString());
            rsHistory.updateString("ENTRY_DATE",EITLERPGLOBAL.getCurrentDateDB());
            rsHistory.updateString("APPROVER_REMARKS",getAttribute("APPROVER_REMARKS").getString());
            rsHistory.updateString("MM_DOC_NO", getAttribute("MM_DOC_NO").getString());
            ...
            /*for(int i=1;i<=colMRItems.size();i++) {
                ...
                msurvydt=(String)ObjMRItems.getAttribute("MM_SURVEY_DATE").getObj();
                if(!EITLERPGLOBAL.isDate(msurvydt)) {
                    LastError= "Survey Data is Not Valid Date...";
                    return false;
                }
                tmpmachinests=(String)ObjMRItems.getAttribute("MM_MCH_ACTIVE").getObj();
                ...
                String mconsumption=(String)ObjMRItems.getAttribute("MM_LIFE_OF_FELT").getObj();;
            ...
            data.Execute("DELETE FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MM_DOC_NO='"+mdocno+"'");
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MM_DOC_NO='1'");
            ...
            for(int i=1;i<=colMRItems.size();i++) {
                ...
                //  msurvydt=(String)ObjMRItems.getAttribute("MM_DATE_OF_UPDATE").getObj();
                rsTmp.moveToInsertRow();
                rsTmp.updateString("SR_NO",(String)ObjMRItems.getAttribute("SR_NO").getString());
                rsTmp.updateString("MM_DOC_NO",(String)ObjMRItems.getAttribute("MM_DOC_NO").getString());
                rsTmp.updateString("MM_PARTY_CODE",getAttribute("MM_PARTY_CODE").getString());
                rsTmp.updateString("MM_MACHINE_NO",getAttribute("MM_MACHINE_NO").getString());
                rsTmp.updateString("MM_MACHINE_POSITION",(String)ObjMRItems.getAttribute("MM_MACHINE_POSITION").getString());
                rsTmp.updateString("MM_MACHINE_POSITION_DESC",(String)ObjMRItems.getAttribute("MM_MACHINE_POSITION_DESC").getString());
             ...
             //   stHDetail=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
             //   rsHDetail=stHDetail.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL_H WHERE MM_DOC_NO='1'");
            //   rsHDetail.first();
                
                rsHDetail.moveToInsertRow();
                rsHDetail.updateInt("REVISION_NO",RevNo);
                rsHDetail.updateString("SR_NO",(String)ObjMRItems.getAttribute("SR_NO").getString());
                rsHDetail.updateString("MM_DOC_NO",(String)ObjMRItems.getAttribute("MM_DOC_NO").getString());
                rsHDetail.updateString("MM_MACHINE_POSITION",(String)ObjMRItems.getAttribute("MM_MACHINE_POSITION").getString());
                rsHDetail.updateString("MM_MACHINE_POSITION_DESC",(String)ObjMRItems.getAttribute("MM_MACHINE_POSITION_DESC").getString());
                rsHDetail.updateString("MM_COMBINATION_CODE", (String)ObjMRItems.getAttribute("MM_COMBINATION_CODE").getString());
                rsHDetail.updateString("MM_PRESS_TYPE",(String)ObjMRItems.getAttribute("MM_PRESS_TYPE").getString());
            ...
            if(IsRejected) {
                //Remove the Rejected Flag First
                data.Execute("UPDATE PRODUCTION.FELT_MACHINE_MASTER_HEADER SET REJECTED=0,CHANGED=1,CHANGED_DATE=CURDATE() WHERE MM_DOC_NO='"+ObjFlow.DocNo+"' ");
                
                //Remove Old Records from FELT_DOC_DATA
                data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID="+clsmachinesurvey.ModuleID+" AND DOC_NO='"+ObjFlow.DocNo+"'");
    ...
    public boolean setData() {
        ...
        try {
            ...
            */
            ...
            if(HistoryView) {
                rsTmp=tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL_H WHERE MM_DOC_NO='"+mdocno+"' AND REVISION_NO="+RevNo+" ORDER BY MM_DOC_NO,SR_NO*1");
            }
            else {
                rsTmp=tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MM_DOC_NO='"+mdocno+"' ORDER BY MM_DOC_NO,SR_NO*1");
            }
            
            /*if(HistoryView) {
                rsTmp=tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER_H AS AA WHERE MM_DOC_NO='"+mdocno+"' AND REVISION_NO="+RevNo+" ORDER BY AA.MM_DOC_NO");
            }
            else {
                rsTmp=tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER AS AA WHERE MM_DOC_NO='"+mdocno+"' ORDER BY AA.MM_DOC_NO");
            }*/
            rsTmp.first();
            ...
            while(!rsTmp.isAfterLast() && rsTmp.getRow()>0) {
                Counter=Counter+1;
                clsmachinesurveyitem ObjMRItems = new clsmachinesurveyitem();
              ...
              //  ObjMRItems.setAttribute("MM_SR_NO",rsTmp.getString("MM_SR_NO"));
                ...
                if(HistoryView) {
                    ObjMRItems.setAttribute("POSITION_CLOSE_IND","");
                    ObjMRItems.setAttribute("POSITION_MILL_CLOSED_IND","");
                }
                else {
                    ObjMRItems.setAttribute("POSITION_CLOSE_IND",rsTmp.getString("POSITION_CLOSE_IND"));
                    ObjMRItems.setAttribute("POSITION_MILL_CLOSED_IND",rsTmp.getString("POSITION_MILL_CLOSED_IND"));
                }
    ...
    public boolean IsEditable(int pCompanyID,String pDocNo,int pUserID) {
        ...
        try {
            ...
            strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MM_DOC_NO='"+pDocNo+"' AND (APPROVED=1)";
            ...
            if(rsTmp.getInt("COUNT")>0)  //Item is Approved
            {
                ...
                //System.out.println("Authority : SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=724 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND STATUS='W'");
                strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=724 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND STATUS='W'";
                tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getHistoryList(int CompanyID,String Docno) {
        ...
        try {
            String strSQL="SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER_H WHERE MM_DOC_NO='"+Docno+"'";
            rsTmp=data.getResult(strSQL);
            rsTmp.first();
            
            if(rsTmp.getRow()>0) {
                while(!rsTmp.isAfterLast()) {
                    clsmachinesurvey objParty=new clsmachinesurvey();
    ...
    public boolean Filter(String Condition) {
        ...
        try {
            String strSQL="";
            strSQL+= "SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER AS AA LEFT JOIN (SELECT PARTY_CODE,PARTY_NAME,DISPATCH_STATION FROM DINESHMILLS.D_SAL_PARTY_MASTER) AS BB ON AA.MM_PARTY_CODE=BB.PARTY_CODE WHERE " + Condition ;
            Conn=data.getConn();
            Stmt=Conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean CanDelete(int pCompanyID,String pDocNo,int pUserID) {
        ...
        try {
            ...
            if(rsTmp.getInt("COUNT")>0)  //Item is Approved
            {
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=724 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND TYPE='C' AND STATUS='W'";
                tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getPendingApprovals(int pUserID,int pOrder) {
        ...
        try {
            ...
            if(pOrder==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT DISTINCT(PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO),MM_PARTY_CODE,RECEIVED_DATE FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO=PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID="+pUserID+" AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=724 ORDER BY PRODUCTION.FELT_PROD_DOC_DATA.RECEIVED_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocDate) {
                strSQL="SELECT DISTINCT(PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO),MM_PARTY_CODE,RECEIVED_DATE FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO=PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID="+pUserID+" AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=724 ORDER BY PRODUCTION.FELT_MACHINE_MASTER_HEADER.CREATED_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocNo) {
                strSQL="SELECT DISTINCT(PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO),MM_PARTY_CODE,RECEIVED_DATE FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO=PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID="+pUserID+" AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=724 ORDER BY PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO";
            }
            ...
            while(rsTmp.next()) {
                ...
                Counter=Counter+1;
                clsmachinesurvey ObjDoc=new clsmachinesurvey();
                
                //------------- Header Fields --------------------//
                ObjDoc.setAttribute("MM_DOC_NO",rsTmp.getString("MM_DOC_NO"));
    ...
    public static HashMap getPendingApprovals(int pCompanyID,int pUserID,int pOrder) {
        ...
        try {
            if(pOrder==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO,PRODUCTION.FELT_MACHINE_MASTER_HEADER.CREATED_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO=PRODUCTION.FELT_MACHINE_MASTER_HEADER.MM_DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID="+Integer.toString(pUserID)+" AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=724 ORDER BY PRODUCTION.FELT_PROD_DOC_DATA.RECEIVED_DATE";
            }
            ...
            while(!rsTmp.isAfterLast()&&rsTmp.getRow()>0) {
                ...
                clsmachinesurvey ObjItem = new clsmachinesurvey();
    ...
    public boolean ShowHistory(int pCompanyID,String pdocno) {
        ...
        try {
            ...
            rsResultSet=Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER_H WHERE MM_DOC_NO='"+pdocno+"' ORDER BY REVISION_NO");
            Ready=true;
            HistoryView=true;
            MoveFirst();
            return true;
    ...
    */
    ...
    public static void CancelDoc(String pDocNo) {
        ...
        if(CanCancel(pDocNo)) {
            ...
            try {
                rsTmp=data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MM_DOC_NO='"+pDocNo+"' ");
                rsTmp.first();
                ...
                if(!Approved) {
                    data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE DOC_NO='"+pDocNo+"' AND MODULE_ID=724");
                }
                data.Execute("UPDATE PRODUCTION.FELT_MACHINE_MASTER_HEADER SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE MM_DOC_NO='"+pDocNo+"'");
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public static boolean CanCancel(String pDocNo) {
        ...
        try {
            tmpConn=data.getConn();
            stTmp=tmpConn.createStatement();
//            System.out.println("SELECT MM_DOC_NO FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MM_DOC_NO='"+pDocNo+"'  AND APPROVED=0 AND CANCELED=0");
            rsTmp=stTmp.executeQuery("SELECT MM_DOC_NO FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MM_DOC_NO='"+pDocNo+"'  AND APPROVED=0 AND CANCELED=0");
