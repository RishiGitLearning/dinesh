...
public class clsmachinesurveyitem {
    ...
    public clsmachinesurveyitem() {
        ...
        props.put("MM_BASE_GSM",new Variant(""));
        props.put("MM_WEB_GSM",new Variant(""));
        props.put("MM_TOTAL_GSM",new Variant(""));
        ...
        //
        props.put("MM_MIN_CIRCUIT_LENGTH",new Variant(""));
        props.put("MM_MAX_CIRCUIT_LENGTH",new Variant(""));
