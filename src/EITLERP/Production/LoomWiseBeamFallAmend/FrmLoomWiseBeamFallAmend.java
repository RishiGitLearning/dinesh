...
public class FrmLoomWiseBeamFallAmend extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private final int ModuleId = 841;
    private String DOC_NO = "";
    private clsLoomWiseBeamFallAmend objDM;
    ...
    public void init() {
        ...
        try {
            ...
            dateMask.install(txtDocDateAmend);

        } catch (ParseException ex) {
            System.out.println("Error on Mask : " + ex.getLocalizedMessage());
        }
        txtDocDateAmend.setText(df.format(new Date()));

        objDM = new clsLoomWiseBeamFallAmend();
    ...
    private void DisplayData() {
        ...
        clearFields();
        try {
           // txtDocNo.setText(objDM.getAttribute("LBF_AMEND_DOC_NO").getString());
            lblTitle.setText("Felt Loom Wise Beam Fall, Warping and Warp Master Amend "+objDM.getAttribute("LBF_AMEND_DOC_NO").getString());
            //txtDocDate.setText(EITLERPGLOBAL.formatDate(objDM.getAttribute("LBF_AMEND_DOC_DATE").getString()));
...
//            FormatGrid_OTHER();
            ...
            txtDocNoAmend.setText(objDM.getAttribute("LBF_AMEND_DOC_NO").getString());
            lblTitle.setText("Felt Loom Wise Beam Fall, Warping and Warp Master Amend - " + objDM.getAttribute("LBF_AMEND_DOC_NO").getString());
            txtDocDateAmend.setText(EITLERPGLOBAL.formatDate(objDM.getAttribute("LBF_AMEND_DOC_DATE").getString()));
            lblRevNo.setText(Integer.toString((int) objDM.getAttribute("REVISION_NO").getVal()));
            
            int NewRow = 0;
            int NewRow2 = 0;
            for (int i = 1; i <= objDM.hmFeltPerformanceTrackingDetails.size(); i++) {
                clsLoomWiseBeamFallAmendDetails ObjItem = (clsLoomWiseBeamFallAmendDetails) objDM.hmFeltPerformanceTrackingDetails.get(Integer.toString(i));
...
//                {
                    ...
                    DataModel.setValueByVariable("LOOM_PICK_PER_PIECE", ObjItem.getAttribute("LOOM_PICK_PER_PIECE").getString(), NewRow);
                    DataModel.setValueByVariable("LOOM_PICK_PER_10CM", ObjItem.getAttribute("LOOM_PICK_PER_10CM").getString(), NewRow);
                    DataModel.setValueByVariable("PICK_PRODUCTION_PER_DAY", ObjItem.getAttribute("PICK_PRODUCTION_PER_DAY").getString(), NewRow);
                    DataModel.setValueByVariable("WARPING_DAYS", ObjItem.getAttribute("WARPING_DAYS").getString(), NewRow);
                    DataModel.setValueByVariable("WARP_QTY", ObjItem.getAttribute("WARP_QTY").getString(), NewRow);
                    DataModel.setValueByVariable("WARP_PREPARATION_DAYS", ObjItem.getAttribute("WARP_PREPARATION_DAYS").getString(), NewRow);
                    DataModel.setValueByVariable("BEAM_GAITING_DAYS", ObjItem.getAttribute("BEAM_GAITING_DAYS").getString(), NewRow);
                    //BEAM_GAITING_DAYS
            ...
            String DocNo = objDM.getAttribute("LBF_AMEND_DOC_NO").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsLoomWiseBeamFallAmend ObjHistory = (clsLoomWiseBeamFallAmend) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7058, 70581)) {
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7058, 70582)) {
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7058, 70583)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7058, 70585)) {
    ...
    private void initComponents() {
        ...
        txtDocNoAmend = new javax.swing.JTextField();
        txtDocDateAmend = new javax.swing.JFormattedTextField();
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(240, 20, 120, 20);

        jLabel3.setText("Amend Doc No");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 20, 110, 20);

        txtDocNoAmend.setEditable(false);
        txtDocNoAmend.setBackground(new java.awt.Color(254, 242, 230));
        txtDocNoAmend.setText("PD000001");
        txtDocNoAmend.setEnabled(false);
        jPanel1.add(txtDocNoAmend);
        txtDocNoAmend.setBounds(110, 10, 110, 30);

        txtDocDateAmend.setEditable(false);
        jPanel1.add(txtDocDateAmend);
        txtDocDateAmend.setBounds(350, 10, 90, 30);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(450, 20, 70, 20);
        jPanel1.add(txtRemark);
        txtRemark.setBounds(510, 17, 440, 20);

        Tab.addTab("Felt Loom Wise Beam Fall, Warping and Warp Master Amend", jPanel1);
        ...
        lblTitle.setText("Felt Loom Wise Beam Fall, Warping and Warp Master Amend");
    ...
    private void cmdViewHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewHistoryActionPerformed
        String DocNo1 = txtDocNoAmend.getText();
    ...
    private void Add() {
        ...
        aList.FirstFreeNo = 351;

        txtDocDateAmend.setText(df.format(new Date()));
        FFNo = aList.FirstFreeNo;
        txtDocNoAmend.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, ModuleId, FFNo, false));
        lblTitle.setText("Felt Design Master - " + txtDocNoAmend.getText());
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.Production.LoomWiseBeamFall.frmFindLoomWiseBeamFallAmend", true);
        frmFindLoomWiseBeamFallAmend ObjFindobjDM = (frmFindLoomWiseBeamFallAmend) ObjLoader.getObj();
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (objDM.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                    ...
                    try{
                            data.Execute("DELETE FROM PRODUCTION.LOOMWISE_PICK_WARP_MASTER");
                            data.Execute("INSERT INTO PRODUCTION.LOOMWISE_PICK_WARP_MASTER " +
                                        "(SR_NO,LOOM_NO, LOOM_PICK_PER_PIECE, LOOM_PICK_PER_10CM, PICK_PRODUCTION_PER_DAY,  " +
                                        "WARPING_DAYS, WARP_QTY, WARP_PREPARATION_DAYS,BEAM_GAITING_DAYS) " +
                                        "SELECT  SR_NO,LOOM_NO, LOOM_PICK_PER_PIECE, LOOM_PICK_PER_10CM, PICK_PRODUCTION_PER_DAY,  " +
                                        "WARPING_DAYS, WARP_QTY, WARP_PREPARATION_DAYS,BEAM_GAITING_DAYS " +
                                        " FROM PRODUCTION.LOOMWISE_PICK_WARP_MASTER_AMEND_DETAIL WHERE LBF_AMEND_DOC_NO='"+txtDocNoAmend.getText()+"'");
                            sendUpdatedData();
                        }catch(Exception e)
                        {
                            e.printStackTrace();
    ...
    private void sendUpdatedData()
    {
        String pMessage = "";
         try {
                    ...
                    rsData1 = stmt1.executeQuery("SELECT * FROM PRODUCTION.LOOMWISE_PICK_WARP_MASTER");
                   
                    pMessage = pMessage + "<div style='min-width:1000px;'>\n" +
                    "    <div>Loom wise beam fall master updated on "+EITLERPGLOBAL.getCurrentDate()+"</div>\n" +
                    "    <br><br>\n" +
                    "    \n" ;
                   
                    pMessage = pMessage + "";
                    pMessage = pMessage + "<table border='1' width='100%'>";
                    pMessage = pMessage + "<tr>";
                    pMessage = pMessage + "<td>LOOM NO</td>";
                    pMessage = pMessage + "<td>LOOM PICK PER PIECE</td>";
                    pMessage = pMessage + "<td>LOOM PICK PER 10CM</td>";
                    pMessage = pMessage + "<td>PICK PRODUCTION PER DAY</td>";
                    pMessage = pMessage + "<td>WARPING DAYS</td>";
                    pMessage = pMessage + "<td>WARP QTY</td>";
                    pMessage = pMessage + "<td>WARP PREPARATION DAYS</td>";
                    pMessage = pMessage + "</tr>";
                    rsData1.first();
                    int i=0;
                    if (rsData1.getRow() > 0) {
                        while (!rsData1.isAfterLast()){
                            ...
                            {
                                pMessage = pMessage +  "<tr bgcolor= '#D3D3D3'>" ;
                            }
                           
                            pMessage = pMessage + "<td> "+rsData1.getString("LOOM_NO")+" </td>\n" +
                            "<td> "+rsData1.getString("LOOM_PICK_PER_PIECE")+" </td>\n" +
                            "<td> "+rsData1.getString("LOOM_PICK_PER_10CM")+" </td>\n" +
                            "<td> "+rsData1.getString("PICK_PRODUCTION_PER_DAY")+" </td>\n" +
                            "<td> "+rsData1.getString("WARPING_DAYS")+" </td>\n" +
                            "<td> "+rsData1.getString("WARP_QTY")+" </td>\n" +
                            "<td> "+rsData1.getString("WARP_PREPARATION_DAYS")+" </td>\n" +
                    ...
                    String Subject = "Loom wise beam fall - UPDATED";
                    ...
                    JavaMail.SendMail(recievers, pMessage, Subject, pcc);
         } catch (Exception e) {
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) objDM.getAttribute("LBF_AMEND_DOC_NO").getObj();
    ...
    private void Delete() {
        if (objDM.CanDelete(txtDocNoAmend.getText() + "", txtDocDateAmend.getText(), EITLERPGLOBAL.gNewUserID)) {
            DisplayData();
        } else {
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(ModuleId, txtDocNoAmend.getText() + "");
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetFields(boolean pStat) {
        txtDocDateAmend.setEnabled(pStat);
        txtDocNoAmend.setEnabled(pStat);
    ...
    private void SetData() {
        ...
        objDM.setAttribute("LBF_AMEND_DOC_NO", txtDocNoAmend.getText());
        objDM.setAttribute("LBF_AMEND_DOC_DATE", txtDocDateAmend.getText());
   
        DOC_NO = txtDocNoAmend.getText();
        objDM.setAttribute("DOC_NO", txtDocNoAmend.getText());
        objDM.setAttribute("DOC_DATE", txtDocDateAmend.getText());
        ...
        try {
            ...
            for (int i = 0; i <= tblSDML.getRowCount() - 1; i++) {
                ...
                clsLoomWiseBeamFallAmendDetails objDMDetails = new clsLoomWiseBeamFallAmendDetails();

                //objobjDMDetails.setAttribute("S_ORDER_DETAIL_CODE","");
                objDMDetails.setAttribute("LBF_AMEND_DOC_NO", txtDocNoAmend.getText());
                objDMDetails.setAttribute("SR_NO", (i+1)+"");//SR_NO
                
                objDMDetails.setAttribute("LOOM_NO", DataModel.getValueByVariable("LOOM_NO", i)+"");//SR_NO
                objDMDetails.setAttribute("LOOM_PICK_PER_PIECE", DataModel.getValueByVariable("LOOM_PICK_PER_PIECE", i)+"");//SR_NO
                objDMDetails.setAttribute("LOOM_PICK_PER_10CM", DataModel.getValueByVariable("LOOM_PICK_PER_10CM", i)+"");//SR_NO
                objDMDetails.setAttribute("PICK_PRODUCTION_PER_DAY", DataModel.getValueByVariable("PICK_PRODUCTION_PER_DAY", i)+"");//SR_NO
                objDMDetails.setAttribute("WARPING_DAYS", DataModel.getValueByVariable("WARPING_DAYS", i)+"");//SR_NO
                objDMDetails.setAttribute("WARP_QTY", DataModel.getValueByVariable("WARP_QTY", i)+"");//SR_NO
                objDMDetails.setAttribute("WARP_PREPARATION_DAYS", DataModel.getValueByVariable("WARP_PREPARATION_DAYS", i)+"");//SR_NO
                objDMDetails.setAttribute("BEAM_GAITING_DAYS", DataModel.getValueByVariable("BEAM_GAITING_DAYS", i)+"");//SR_NO
    ...
    private javax.swing.JFormattedTextField txtDocDateAmend;
    private javax.swing.JTextField txtDocNoAmend;
