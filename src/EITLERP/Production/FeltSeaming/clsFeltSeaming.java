...
public class clsFeltSeaming {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' AND PROD_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND PROD_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY PROD_DATE");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT * FROM PRODUCTION.`FELT_PROD_DATA_H` WHERE PROD_DATE=''");
             ...
             setAttribute("PRODUCTION_DOCUMENT_NO", getNextFreeNo(EITLERPGLOBAL.gCompanyID, 785, 290, true));

            // Now Insert records into production tables
            for (int i = 1; i <= hmDetails.size(); i++) {
                clsFeltSeamingDetails ObjFeltDetails = (clsFeltSeamingDetails) hmDetails.get(Integer.toString(i));
                ...
                resultSetTemp.updateString("PROD_DEPT", "SEAMING");
                resultSetTemp.updateInt("SR_NO", i);
                resultSetTemp.updateString("PROD_PIECE_NO", ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString());
                resultSetTemp.updateString("PROD_PARTY_CODE", ObjFeltDetails.getAttribute("PRODUCTION_PARTY_CODE").getString());
                resultSetTemp.updateString("PROD_PARTY_NAME", ObjFeltDetails.getAttribute("PRODUCTION_PARTY_NAME").getString());
                resultSetTemp.updateString("STYLE_CODE", ObjFeltDetails.getAttribute("STYLE_CODE").getString());
                resultSetTemp.updateFloat("LENGTH", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("LENGTH").getObj().toString()), 2));
                resultSetTemp.updateFloat("WIDTH", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("WIDTH").getObj().toString()), 2));
                resultSetTemp.updateFloat("WEIGHT", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("THORITICAL_WEIGHT").getObj().toString()), 2));
                resultSetTemp.updateFloat("SEAM_LENGTH", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("SEAM_LENGTH").getObj().toString()), 2));
                resultSetTemp.updateString("SEAM_START_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltDetails.getAttribute("SEAM_START_DATE").getString()));
                resultSetTemp.updateString("SEAM_COMPLETE_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltDetails.getAttribute("SEAM_COMPLETE_DATE").getString()));
                resultSetTemp.updateFloat("SEAM_HOURS", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("SEAM_HOURS").getObj().toString()), 2));
                resultSetTemp.updateString("GROUP", ObjFeltDetails.getAttribute("GROUP").getString());
                resultSetTemp.updateString("REMARKS", ObjFeltDetails.getAttribute("REMARKS").getString());
                ...
                resultSetHistory.updateString("PROD_DEPT", "SEAMING");
                resultSetHistory.updateInt("SR_NO", i);
                resultSetHistory.updateString("PROD_PIECE_NO", ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString());
                resultSetHistory.updateString("PROD_PARTY_CODE", ObjFeltDetails.getAttribute("PRODUCTION_PARTY_CODE").getString());
                resultSetHistory.updateString("PROD_PARTY_NAME", ObjFeltDetails.getAttribute("PRODUCTION_PARTY_NAME").getString());
                resultSetHistory.updateString("STYLE_CODE", ObjFeltDetails.getAttribute("STYLE_CODE").getString());
                resultSetHistory.updateFloat("LENGTH", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("LENGTH").getObj().toString()), 2));
                resultSetHistory.updateFloat("WIDTH", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("WIDTH").getObj().toString()), 2));
                resultSetHistory.updateFloat("WEIGHT", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("THORITICAL_WEIGHT").getObj().toString()), 2));
                resultSetHistory.updateFloat("SEAM_LENGTH", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("SEAM_LENGTH").getObj().toString()), 2));
                resultSetHistory.updateString("SEAM_START_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltDetails.getAttribute("SEAM_START_DATE").getString()));
                resultSetHistory.updateString("SEAM_COMPLETE_DATE", EITLERPGLOBAL.formatDateDB(ObjFeltDetails.getAttribute("SEAM_COMPLETE_DATE").getString()));
                resultSetHistory.updateFloat("SEAM_HOURS", (float) EITLERPGLOBAL.round(Double.parseDouble(ObjFeltDetails.getAttribute("SEAM_HOURS").getObj().toString()), 2));
                resultSetHistory.updateString("GROUP", ObjFeltDetails.getAttribute("GROUP").getString());
                resultSetHistory.updateString("GROUP", ObjFeltDetails.getAttribute("GROUP").getString());
                resultSetHistory.updateString("REMARKS", ObjFeltDetails.getAttribute("REMARKS").getString());
                ...
                try {
                    if ("F".equals(getAttribute("APPROVAL_STATUS").getString())) {
                        if (ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString().contains("B")) {
                            //data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_SEAM_B_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "',PR_SEAM_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "' WHERE PR_PIECE_NO+0=" + ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
                        } else {
                            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_SEAM_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "' WHERE PR_PIECE_NO+0=" + ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
                            data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER SET WIP_SEAM_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "' WHERE WIP_EXT_PIECE_NO='" + ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");
                        }
                    }
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 785; //Felt Seaming Entry
            ...
            if (ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ...
                updateSeamingDate(getAttribute("PRODUCTION_DOCUMENT_NO").getString());
            }
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_PROD_DATA_H WHERE PROD_DEPT = 'SEAMING' AND PROD_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "' AND PROD_DOC_NO='" + getAttribute("PRODUCTION_DOCUMENT_NO").getString() + "'");
                ...
                try {
                    if ("F".equals(getAttribute("APPROVAL_STATUS").getString())) {
                        if (ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString().contains("B")) {
                            ...
                            //data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_SEAM_A_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "',PR_SEAM_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("PRODUCTION_DATE").getString()) + "' WHERE PR_PIECE_NO+0=" + ObjFeltDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "+0");
                        }
                    }
            ...
            //======== Update the Approval Flow =========
            clsFeltProductionApprovalFlow ObjFeltProductionApprovalFlow = new clsFeltProductionApprovalFlow();
            ObjFeltProductionApprovalFlow.ModuleID = 785; //Felt Mending Entry
            ObjFeltProductionApprovalFlow.DocNo = getAttribute("PRODUCTION_DOCUMENT_NO").getString();
            ObjFeltProductionApprovalFlow.DocDate = EITLERPGLOBAL.getCurrentDateDB();
            ObjFeltProductionApprovalFlow.From = (int) getAttribute("FROM").getVal();
            ObjFeltProductionApprovalFlow.To = (int) getAttribute("TO").getVal();
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.`FELT_PROD_DATA` SET REJECTED=0,CHANGED=1 WHERE PROD_DEPT='SEAMING' AND PROD_DOC_NO='" + getAttribute("PRODUCTION_DOCUMENT_NO").getString() + "'");
                //Remove Old Records from FELT DOCUMENT APPROVAL TABLE
                //data.Execute("DELETE FROM PRODUCTION.`FELT_PROD_DOC_DATA` WHERE MODULE_ID=785 AND DOC_NO='"+getAttribute("PRODUCTION_DOCUMENT_NO").getString()+"'");
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.`FELT_PROD_DOC_DATA` WHERE MODULE_ID=785 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING'"
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' " + stringFindQuery + "ORDER BY PROD_DATE";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            totalWeight = data.getDoubleValueFromDB("SELECT SUM(COALESCE(SEAM_LENGTH,0)) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' AND MONTH(PROD_DATE)=" + documentNo.substring(7, 9) + " AND YEAR(PROD_DATE)=" + documentNo.substring(3, 7) + " AND APPROVED=1");
            setAttribute("TOTAL_WEIGHT", totalWeight);

            previousWeight = data.getDoubleValueFromDB("SELECT SUM(COALESCE(SEAM_LENGTH,0)) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' AND MONTH(PROD_DATE)=" + documentNo.substring(7, 9) + " AND YEAR(PROD_DATE)=" + documentNo.substring(3, 7) + " AND SUBSTRING(PROD_DOC_NO,4,8)<'" + documentNo.substring(3) + "' AND APPROVED=1");
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING'  AND PROD_DOC_NO='" + documentNo + "' ORDER BY SR_NO");
            ...
            while (resultSetTemp.next()) {
                ...
                clsFeltSeamingDetails ObjFeltDetails = new clsFeltSeamingDetails();

                ObjFeltDetails.setAttribute("PRODUCTION_PIECE_NO", resultSetTemp.getString("PROD_PIECE_NO"));
                ObjFeltDetails.setAttribute("PRODUCTION_PARTY_CODE", resultSetTemp.getString("PROD_PARTY_CODE"));
                ObjFeltDetails.setAttribute("PRODUCTION_PARTY_NAME", resultSetTemp.getString("PROD_PARTY_NAME"));
                ObjFeltDetails.setAttribute("STYLE_CODE", resultSetTemp.getString("STYLE_CODE"));
                ObjFeltDetails.setAttribute("LENGTH", resultSetTemp.getFloat("LENGTH"));
                ObjFeltDetails.setAttribute("WIDTH", resultSetTemp.getFloat("WIDTH"));
                ObjFeltDetails.setAttribute("THORITICAL_WEIGHT", resultSetTemp.getFloat("WEIGHT"));
                ObjFeltDetails.setAttribute("SEAM_LENGTH", resultSetTemp.getFloat("SEAM_LENGTH"));
                ObjFeltDetails.setAttribute("SEAM_START_DATE", resultSetTemp.getString("SEAM_START_DATE"));
                ObjFeltDetails.setAttribute("SEAM_COMPLETE_DATE", resultSetTemp.getString("SEAM_COMPLETE_DATE"));
                ObjFeltDetails.setAttribute("SEAM_HOURS", resultSetTemp.getFloat("SEAM_HOURS"));
                ObjFeltDetails.setAttribute("GROUP", resultSetTemp.getString("GROUP"));
                ObjFeltDetails.setAttribute("REMARKS", resultSetTemp.getString("REMARKS"));

                hmDetails.put(Integer.toString(serialNoCounter), ObjFeltDetails);
            }
            resultSetTemp.close();
            statementTemp.close();
            return true;
    ...
    public boolean setHistoryData(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.`FELT_PROD_DATA_H` WHERE PROD_DEPT = 'SEAMING' AND PROD_DATE='" + pProductionDate + "' AND PROD_DOC_NO='" + pDocNo + "' AND REVISION_NO='" + resultSet.getInt("REVISION_NO") + "' ORDER BY REVISION_NO");
            ...
            while (resultSetTemp.next()) {
                ...
                ObjFeltDetails.setAttribute("LENGTH", resultSetTemp.getFloat("LENGTH"));
                ObjFeltDetails.setAttribute("WIDTH", resultSetTemp.getFloat("WIDTH"));
                ObjFeltDetails.setAttribute("THORITICAL_WEIGHT", resultSetTemp.getFloat("THORITICAL_WEIGHT"));
                ObjFeltDetails.setAttribute("SEAM_LENGTH", resultSetTemp.getFloat("SEAM_LENGTH"));
                ObjFeltDetails.setAttribute("SEAM_START_DATE", resultSetTemp.getString("SEAM_START_DATE"));
                ObjFeltDetails.setAttribute("SEAM_COMPLETE_DATE", resultSetTemp.getString("SEAM_COMPLETE_DATE"));
                ObjFeltDetails.setAttribute("SEAM_HOURS", resultSetTemp.getFloat("SEAM_HOURS"));
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_PROD_DATA_H WHERE PROD_DEPT = 'SEAMING' AND PROD_DATE='" + stringProductionDate + "' AND PROD_DOC_NO='" + productionDocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltSeaming ObjFeltMending = new clsFeltSeaming();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_PROD_DATA_H WHERE PROD_DEPT='SEAMING' AND PROD_DATE='" + pProductionDate + "' AND PROD_DOC_NO='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=785 AND CANCELED=0 ORDER BY RECEIVED_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=785 AND CANCELED=0 ORDER BY PROD_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocNo) {
                strSQL = "SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=785 AND CANCELED=0 ORDER BY PROD_DOC_NO";
            }
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltSeaming ObjDoc = new clsFeltSeaming();
    ...
    public String[] getPartyCodeAndGroup(String pPieceNo) {
        ...
        Statement Stmt;
        ResultSet rsTmp;
        String[] partyCodeAndGroup = new String[6];
        ...
        try {
            ...
            rsTmp = Stmt.executeQuery("SELECT PR_PARTY_CODE,PR_GROUP,PR_STYLE,PR_LENGTH,PR_WIDTH,PR_THORITICAL_WEIGHT,PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + pPieceNo + "'");
            rsTmp.first();
            ...
            if (rsTmp.getRow() > 0) {
                ...
                partyCodeAndGroup[2] = rsTmp.getString("PR_STYLE");
                partyCodeAndGroup[3] = rsTmp.getString("PR_LENGTH");
                partyCodeAndGroup[4] = rsTmp.getString("PR_WIDTH");
                partyCodeAndGroup[5] = rsTmp.getString("PR_THORITICAL_WEIGHT");
            }
    ...
    private void updateSeamingDate(String documentNo) {
        ...
        data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER, PRODUCTION.FELT_PROD_DATA SET PR_SEAM_DATE=PROD_DATE,PR_PIECE_STAGE='FINISHING',PR_WIP_STATUS='SEAMED' WHERE PR_PIECE_NO=PROD_PIECE_NO AND PR_PIECE_STAGE!='DIVERTED' AND PR_PARTY_CODE=PROD_PARTY_CODE AND PROD_DEPT='SEAMING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=1 ");
        data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER, PRODUCTION.FELT_PROD_DATA SET WIP_SEAM_DATE=PROD_DATE,WIP_PIECE_STAGE='FINISHING',WIP_STATUS='SEAMED' WHERE WIP_EXT_PIECE_NO=PROD_PIECE_NO AND WIP_PIECE_STAGE!='DIVERTED' AND WIP_PARTY_CODE=PROD_PARTY_CODE AND PROD_DEPT='SEAMING' AND PROD_DOC_NO='" + documentNo + "' AND APPROVED=1 ");
        data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER W,"
                ...
                + "WHERE WIP_EXT_PIECE_NO = PROD_PIECE_NO AND PROD_DEPT ='SEAMING' AND CANCELED =0 AND APPROVED =1 "
                + "AND PROD_DOC_NO='" + getAttribute("PRODUCTION_DOCUMENT_NO").getString() + "' "
                + "GROUP BY WIP_PIECE_NO "
                + ") AS A "
                + "SET WIP_SEAM_DATE = MAXDATE, WIP_SEAM_WEIGHT = SUMWEIGHT "
    ...
    public boolean checkPieceNoInDB(String pPieceNo) {
        int count = data.getIntValueFromDB("SELECT COUNT(PROD_PIECE_NO) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' AND PROD_PIECE_NO='" + pPieceNo + "' AND PROD_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND PROD_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
    ...
    public boolean checkPieceNoInDB(String pPieceNo, String pProdDate) {
        ...
        if (count >= 1) {
            ...
            try {
                ...
                ResultSet rsTmp = stTmp.executeQuery("SELECT PROD_DATE FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT='SEAMING' AND PROD_PIECE_NO='" + pPieceNo + "' AND PROD_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND PROD_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
                while (rsTmp.next()) {
    ...
    public boolean checkProductionDocumentNoInDB(String pProdDocNo) {
        int count = data.getIntValueFromDB("SELECT COUNT(PROD_DOC_NO) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'SEAMING' AND PROD_DOC_NO='" + pProdDocNo + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
    ...
    public TReportWriter.SimpleDataProvider.TTable getReportData(String docNo) {
        ...
        try {
            ...
            String str = "SELECT PROD_DATE,PROD_FORM_NO,PROD_DOC_NO,PROD_PIECE_NO,STYLE,GRP,SYN_PER,COALESCE(PARTY_NAME,'') PARTY_NAME, WEIGHT,LNGTH,WIDTH,GSQ,GRUP,PREVIOUS_WEIGHT,DAY_WEIGHT,TOTAL_WEIGHT,BASE_WEIGHT,CLOTH_WEIGHT FROM (SELECT PROD_DATE,PROD_FORM_NO,PROD_DOC_NO,REPLACE(PROD_PIECE_NO,' ','') PROD_PIECE_NO,PROD_PARTY_CODE,WEIGHT,A.GROUP GRP FROM PRODUCTION.FELT_PROD_DATA A WHERE PROD_DOC_NO = '" + docNo + "' AND PROD_DEPT='SEAMING') D LEFT JOIN (SELECT PR_STYLE AS STYLE,PR_GROUP AS GRUP,PR_GSM AS GSQ,PR_LENGTH AS LNGTH,PR_WIDTH AS WIDTH,PR_PRODUCT_CODE AS PRODUCT_CODE ,PR_PIECE_NO,PR_PARTY_CODE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER) O ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE AND O.PR_PIECE_NO +0 = D.PROD_PIECE_NO +0 LEFT JOIN (SELECT PARTY_CODE, TRIM(CONCAT(PARTY_CODE,',',PARTY_NAME)) AS PARTY_NAME FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE MAIN_ACCOUNT_CODE=210010) AS P ON P.PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS PREVIOUS_WEIGHT FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'SEAMING' AND MONTH(PROD_DATE)=SUBSTRING('" + docNo + "',8,2) AND YEAR(PROD_DATE)=SUBSTRING('" + docNo + "',4,4) AND SUBSTRING(PROD_DOC_NO,4,8)<SUBSTRING('" + docNo + "',4,8) AND APPROVED=1) AS PW ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS DAY_WEIGHT FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'SEAMING' AND PROD_DOC_NO='" + docNo + "' AND APPROVED=1) AS DW ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(WEIGHT),0) AS TOTAL_WEIGHT FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'SEAMING' AND MONTH(PROD_DATE)=SUBSTRING('" + docNo + "',8,2) AND YEAR(PROD_DATE)=SUBSTRING('" + docNo + "',4,4) AND SUBSTRING(PROD_DOC_NO,4,8)<=SUBSTRING('" + docNo + "',4,8) AND APPROVED=1) AS TW ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(A.WEIGHT),0) AS BASE_WEIGHT FROM PRODUCTION.FELT_PROD_DATA A, PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO  = PROD_PIECE_NO AND PROD_DEPT='SEAMING' AND MONTH(PROD_DATE)=SUBSTRING('" + docNo + "',8,2) AND YEAR(PROD_DATE)=SUBSTRING('" + docNo + "',4,4) AND SUBSTRING(PROD_DOC_NO,4,8)<=SUBSTRING('" + docNo + "',4,8) AND APPROVED=1 AND SUBSTRING(PROD_DOC_NO,1,3)='FMB')  AS BW ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT COALESCE(SUM(A.WEIGHT),0) AS CLOTH_WEIGHT FROM PRODUCTION.FELT_PROD_DATA A, PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO = PROD_PIECE_NO AND PROD_DEPT='SEAMING' AND MONTH(PROD_DATE)=SUBSTRING('" + docNo + "',8,2) AND YEAR(PROD_DATE)=SUBSTRING('" + docNo + "',4,4) AND SUBSTRING(PROD_DOC_NO,4,8)<=SUBSTRING('" + docNo + "',4,8) AND APPROVED=1 AND SUBSTRING(PROD_DOC_NO,1,3)='FMC') AS CW ON O.PR_PARTY_CODE = D.PROD_PARTY_CODE LEFT JOIN (SELECT PRODUCT_CODE AS ITEM_CODE,SYN_PER FROM PRODUCTION.FELT_QLT_RATE_MASTER WHERE APPROVED=1 AND (EFFECTIVE_TO='0000-00-00') OR EFFECTIVE_TO IS NULL) AS R ON SUBSTRING(ITEM_CODE,1,6)=SUBSTRING(PRODUCT_CODE,1,6)";
