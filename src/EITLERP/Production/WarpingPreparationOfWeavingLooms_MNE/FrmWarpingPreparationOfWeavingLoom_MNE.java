 ...
 *
 */
public class FrmWarpingPreparationOfWeavingLoom_MNE extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private final int ModuleId = 848;
    private String DOC_NO = "";
    private clsWarpingPreparationOfWeavingLoom_MNE objDM;
    ...
    public void init() {
        ...
        objDM = new clsWarpingPreparationOfWeavingLoom_MNE();
    ...
    private void DisplayData() {
        ...
        clearFields();
        try {
            // txtDocNo.setText(objDM.getAttribute("WP_MNE_NO").getString());
            lblTitle.setText("Felt Warping Preparation Status of Weaving Looms (MNE) " + objDM.getAttribute("WP_MNE_NO").getString());
            //txtDocDate.setText(EITLERPGLOBAL.formatDate(objDM.getAttribute("WP_MNE_DATE").getString()));
...
//            FormatGrid_OTHER();
            ...
            for (int i = 1; i <= objDM.hmFeltPerformanceTrackingDetails.size(); i++) {
                clsWarpingPreparationOfWeavingLoom_MNEDetails ObjItem = (clsWarpingPreparationOfWeavingLoom_MNEDetails) objDM.hmFeltPerformanceTrackingDetails.get(Integer.toString(i));
...
//                {
                ...
                DataModel.setValueByVariable("WARP_PREP_DATE_AS_PLAN", EITLERPGLOBAL.formatDate(ObjItem.getAttribute("WARP_PREP_DATE_AS_PLAN").getString()), NewRow);
                ...
                DataModel.setValueByVariable("PHASE_1_PRIMARY_DOUBLING_TWISTING_JMW", ObjItem.getAttribute("PHASE_1_PRIMARY_DOUBLING_TWISTING_JMW").getString(), NewRow);
                DataModel.setValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL", ObjItem.getAttribute("PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL").getString(), NewRow);
                DataModel.setValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF", ObjItem.getAttribute("PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF").getString(), NewRow);
                DataModel.setValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING", ObjItem.getAttribute("PHASE_2_SECONDARY_DOUBLING_TWISTING").getString(), NewRow);
                DataModel.setValueByVariable("PHASE_3_PRIMARY_TWISTING", ObjItem.getAttribute("PHASE_3_PRIMARY_TWISTING").getString(), NewRow);
                DataModel.setValueByVariable("PHASE_4_WINDING_PRIMARY_ON_CONE", ObjItem.getAttribute("PHASE_4_WINDING_PRIMARY_ON_CONE").getString(), NewRow);
                DataModel.setValueByVariable("PHASE_5_STREAMING_OF_CONES", ObjItem.getAttribute("PHASE_5_STREAMING_OF_CONES").getString(), NewRow);
            ...
            String DocNo = objDM.getAttribute("WP_MNE_NO").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsWarpingPreparationOfWeavingLoom_MNE ObjHistory = (clsWarpingPreparationOfWeavingLoom_MNE) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7064, 70641)) {
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7064, 70642)) {
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7064, 70643)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7064, 70645)) {
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Warp Prep Status (YES/NO)"); //1
            DataModel.addColumn("Warp Prep Started Actual (DD/MM/YYYY)");//22
            DataModel.addColumn("Warp Prep date as per plan (DD/MM/YYYY)"); //2
            DataModel.addColumn("Targetted Warp Prep Complete (DD/MM/YYYY)"); //3
            DataModel.addColumn("Actual Warp prep completion Date as on todays status (DD/MM/YYYY)"); //4
            DataModel.addColumn("PHASE I : Primary Doubling & Twisting (JMW) (DD/MM/YYYY)"); //4
            DataModel.addColumn("PHASE II : Secondary Doubling and Twisting (ACTUAL KG)"); //4
            DataModel.addColumn("PHASE II : Secondary Doubling and Twisting (OUT OF KG)"); //4
            DataModel.addColumn("PHASE II : Secondary Doubling and Twisting"); //4
            DataModel.addColumn("Phase III: Primary Twisting"); //4
            DataModel.addColumn("Phase IV: Winding Primary on Cone"); //4
            DataModel.addColumn("Phase V : Steaming of flange spools"); //4
            ...
            DataModel.SetVariable(5, "WARP_PREP_DATE_AS_PLAN"); //2
            DataModel.SetVariable(6, "TARGETTED_WARP_PREP_COMPLETE"); //3
            DataModel.SetVariable(7, "ACTUAL_WARP_PREP_COMPLETION_DATE"); //4
            DataModel.SetVariable(8, "PHASE_1_PRIMARY_DOUBLING_TWISTING_JMW"); //4
            DataModel.SetVariable(9, "PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL"); //4
            DataModel.SetVariable(10, "PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF"); //4
            DataModel.SetVariable(11, "PHASE_2_SECONDARY_DOUBLING_TWISTING"); //4
            DataModel.SetVariable(12, "PHASE_3_PRIMARY_TWISTING"); //4
            DataModel.SetVariable(13, "PHASE_4_WINDING_PRIMARY_ON_CONE"); //4
            DataModel.SetVariable(14, "PHASE_5_STREAMING_OF_CONES"); //4
            ...
            tblSDML.getTableHeader().setPreferredSize(new Dimension(tblSDML.getColumnModel().getTotalColumnWidth(), 90));
    ...
    private void initComponents() {
        ...
        txtDocDate.setBounds(290, 10, 120, 30);
        ...
        Tab.addTab("Felt Warping Preparation status  of Weaving Loom (MNE)", jPanel1);
        ...
        lblTitle.setText("Felt Warping Preparation status of Weaving Loom (MNE)");
    ...
    private void tblSDMLKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblSDMLKeyReleased
        ...
        for (int i = 0; i < tblSDML.getRowCount(); i++) {
            ...
            if(WARP_PREP_STATUS.equals("YES"))
            {
                ...
                String PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL = DataModel.getValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL", i);
                String PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF = DataModel.getValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF", i);
                DataModel.setValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING",  PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL+ " KGS out of " + PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF + " KGS", i);
...
//        }
    ...
    private void Add() {
        ...
        lblTitle.setText("Felt Warping Preparation of Weaving Loom (MNE) - " + txtDocNo.getText());

        try {
            Object[] rowData = new Object[1];
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "1", 0);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 0);
            DataModel.setValueByVariable("LOOM_NO", "81", 0);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 0);
            
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "2", 1);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 1);
            DataModel.setValueByVariable("LOOM_NO", "82", 1);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 1);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "3", 2);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 2);
            DataModel.setValueByVariable("LOOM_NO", "83", 2);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 2);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "4", 3);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 3);
            DataModel.setValueByVariable("LOOM_NO", "84", 3);
            ...
            DataModel.setValueByVariable("LOOM_NO", "85", 4);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 4);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "6", 5);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 5);
            DataModel.setValueByVariable("LOOM_NO", "87", 5);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 5);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "7", 6);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 6);
            DataModel.setValueByVariable("LOOM_NO", "89", 6);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 6);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "8", 7);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 7);
            DataModel.setValueByVariable("LOOM_NO", "91", 7);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 7);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "9", 8);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 8);
            DataModel.setValueByVariable("LOOM_NO", "92", 8);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 8);
            
            DataModel.addRow(rowData);
            DataModel.setValueByVariable("SR_NO", "10", 9);
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 9);
            DataModel.setValueByVariable("LOOM_NO", "93", 9);
            DataModel.setValueByVariable("WARP_PREP_STATUS", "NO", 9);
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EEITLERP.Production.WarpingPreparationOfWeavingLooms_MNE.frmFindWarpingPreparationOfWeavingLoom_MNE", true);
        frmFindWarpingPreparationOfWeavingLoom_MNE ObjFindobjDM = (frmFindWarpingPreparationOfWeavingLoom_MNE) ObjLoader.getObj();
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) objDM.getAttribute("WP_MNE_NO").getObj();
    ...
    private void SetData() {
        ...
        objDM.setAttribute("WP_MNE_NO", txtDocNo.getText());
        objDM.setAttribute("WP_MNE_DATE", txtDocDate.getText());
        ...
        try {
            ...
            for (int i = 0; i <= tblSDML.getRowCount() - 1; i++) {
                ...
                clsWarpingPreparationOfWeavingLoom_MNEDetails objDMDetails = new clsWarpingPreparationOfWeavingLoom_MNEDetails();

                //objobjDMDetails.setAttribute("S_ORDER_DETAIL_CODE","");
                objDMDetails.setAttribute("WP_MNE_NO", txtDocNo.getText());
                objDMDetails.setAttribute("SR_NO", (i + 1) + "");//SR_NO

                objDMDetails.setAttribute("WP_MNE_DATE", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("WP_MNE_DATE", i)) + "");//SR_NO
                ...
                objDMDetails.setAttribute("WARP_PREP_DATE_AS_PLAN", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("WARP_PREP_DATE_AS_PLAN", i)) + "");//SR_NO=
                ...
                objDMDetails.setAttribute("ACTUAL_WARP_PREP_COMPLETION_DATE", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("ACTUAL_WARP_PREP_COMPLETION_DATE", i)) + "");//SR_NO=
                ...
                objDMDetails.setAttribute("PHASE_1_PRIMARY_DOUBLING_TWISTING_JMW", DataModel.getValueByVariable("PHASE_1_PRIMARY_DOUBLING_TWISTING_JMW", i) + "");//
                objDMDetails.setAttribute("WARP_PREP_STATUS", DataModel.getValueByVariable("WARP_PREP_STATUS", i) + "");//
                objDMDetails.setAttribute("PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL", DataModel.getValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING_ACTUAL", i) + "");//
                objDMDetails.setAttribute("PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF", DataModel.getValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING_OUT_OF", i) + "");//
                objDMDetails.setAttribute("PHASE_2_SECONDARY_DOUBLING_TWISTING", DataModel.getValueByVariable("PHASE_2_SECONDARY_DOUBLING_TWISTING", i) + "");//
                objDMDetails.setAttribute("PHASE_3_PRIMARY_TWISTING", DataModel.getValueByVariable("PHASE_3_PRIMARY_TWISTING", i) + "");//
                objDMDetails.setAttribute("PHASE_4_WINDING_PRIMARY_ON_CONE", DataModel.getValueByVariable("PHASE_4_WINDING_PRIMARY_ON_CONE", i) + "");//
                objDMDetails.setAttribute("PHASE_5_STREAMING_OF_CONES", DataModel.getValueByVariable("PHASE_5_STREAMING_OF_CONES", i) + "");//
