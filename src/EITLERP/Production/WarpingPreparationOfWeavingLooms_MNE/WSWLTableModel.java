 ...
 * EITLTableModel.java
 *
 * Created on April 8, 2004, 8:44 AM
 */
 ...
 * @version
 */
public class WSWLTableModel extends DefaultTableModel {
    ...
    public void setValueAt(Object aValue,int row, int column) {
        try {
            if(aValue instanceof String) {
                if(getNumeric(column)) {
                    if(!EITLERPGLOBAL.IsNumber(aValue.toString())) {
        ...
        try {
            ...
            if(ReadOnlyTable==true) {
                ...
                for(int i=0;i<colReadOnly.size();i++) {
                    ...
                    if (O.toString().equalsIgnoreCase("Not Applicable")) {
                        return false;
                    }
                    
                    O = getValueAt(row, column+2);
                    if (O.toString().equalsIgnoreCase("Not Applicable")) {
                        return false;
                    }
