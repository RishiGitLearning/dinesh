...
public class frmFeltGRCreditNote extends javax.swing.JApplet {
    ...
    private clsFeltGRCreditNote ObjFeltCreditNote;
    ...
    public void init() {
        ...
        ObjFeltCreditNote = new clsFeltGRCreditNote();
        ...
        chkwithGST.setEnabled(false);
        if (ObjFeltCreditNote.LoadData()) {
            DisplayData();
        } else {
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Error occured while Loading Data. Error is " + ObjFeltCreditNote.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        chkwithGST = new javax.swing.JCheckBox();
        btnCRNote = new javax.swing.JButton();
        ...
        lblTitle.setText(" FELT GR CREDIT NOTE ENTRY FORM - ");
        ...
        Tab1.add(txtCnDate);
        txtCnDate.setBounds(140, 10, 102, 21);
        ...
        cmdNextToTab1.setBounds(670, 370, 90, 25);
        ...
        Tab1.add(txtCnID);
        txtCnID.setBounds(140, 40, 102, 21);
        ...
        cmbOrderReason.setBounds(480, 40, 250, 24);
        ...
        txtamendreasonname.setBounds(480, 10, 250, 19);

        jLabel1.setText("Period : ");
        Tab1.add(jLabel1);
        jLabel1.setBounds(10, 70, 50, 15);
        ...
        txtfromdate.setBounds(60, 90, 130, 19);

        jLabel4.setText("To :");
        Tab1.add(jLabel4);
        jLabel4.setBounds(200, 90, 30, 15);

        txttodate.setEnabled(false);
        Tab1.add(txttodate);
        txttodate.setBounds(230, 90, 140, 19);
        ...
        Tab1.add(cmbReport);
        cmbReport.setBounds(180, 370, 130, 25);
        ...
        Tab1.add(jButton1);
        jButton1.setBounds(10, 370, 160, 25);
        ...
        Tab1.add(cmbShow);
        cmbShow.setBounds(390, 90, 120, 25);
        ...
        Tab1.add(jButton2);
        jButton2.setBounds(330, 370, 120, 25);

        btnCNSumm.setText("GR CN SUMMARY");
        btnCNSumm.setEnabled(false);
        ...
        Tab1.add(btnCNSumm);
        btnCNSumm.setBounds(30, 410, 150, 25);

        btnCNDetail.setText("GR CN DETAIL");
        ...
        btnCNDetail.setBounds(190, 410, 150, 25);

        btnCNDraft.setText("GR CN DRAFT");
        ...
        Tab1.add(btnCNDraft);
        btnCNDraft.setBounds(350, 410, 150, 25);

        chkwithGST.setText("GST Apply");
        chkwithGST.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chkwithGSTItemStateChanged(evt);
            }
        });
        Tab1.add(chkwithGST);
        chkwithGST.setBounds(550, 90, 140, 23);

        btnCRNote.setText("GR CR NOTE");
        btnCRNote.setMargin(new java.awt.Insets(2, 7, 2, 7));
        btnCRNote.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCRNoteActionPerformed(evt);
            }
        });
        Tab1.add(btnCRNote);
        btnCRNote.setBounds(510, 410, 150, 25);
...
//            }
            ...
            if (evt.getKeyCode() == 112) {
                //if (cmbOrderReason.getSelectedItem().equals("GOODS RETURN")) {
                if (cmbOrderReason.getSelectedItem().equals("GOODS RETURN WITH GST ITC")) {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT D.PIECE_NO,D.INVOICE_NO,D.INVOICE_DATE,D.PARTY_CODE,D.PARTY_NAME FROM PRODUCTION.FELT_SALES_RETURNS_HEADER H, PRODUCTION.FELT_SALES_RETURNS_DETAIL D WHERE H.DOC_NO=D.DOC_NO AND H.APPROVED=1 AND H.CANCELED=0 AND D.PIECE_NO NOT IN ( SELECT D.CN_INV_PIECE_NO FROM PRODUCTION.FELT_CN_TEMP_HEADER H, PRODUCTION.FELT_CN_TEMP_DETAIL D WHERE H.CN_ID=D.CN_ID AND H.CN_DATE=D.CN_DATE AND H.CN_TYPE IN (7,9) AND H.CANCELED=0) ";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        aList.DefaultSearchOn = 1;
                ...
                if (cmbOrderReason.getSelectedItem().equals("GOODS RETURN WITH GST PAYABLE")) {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
                        //String strSQL = "SELECT D.PIECE_NO,D.INVOICE_NO,D.INVOICE_DATE,D.PARTY_CODE,D.PARTY_NAME FROM PRODUCTION.FELT_SALES_RETURNS_HEADER H, PRODUCTION.FELT_SALES_RETURNS_DETAIL D WHERE H.DOC_NO=D.DOC_NO AND H.APPROVED=1 AND H.CANCELED=0 AND D.PIECE_NO NOT IN ( SELECT D.CN_INV_PIECE_NO FROM PRODUCTION.FELT_CN_TEMP_HEADER H, PRODUCTION.FELT_CN_TEMP_DETAIL D WHERE H.CN_ID=D.CN_ID AND H.CN_DATE=D.CN_DATE AND H.CN_TYPE=7 AND H.CANCELED=0) ";
                        String strSQL = "SELECT D.PIECE_NO,D.INVOICE_NO,D.INVOICE_DATE,D.PARTY_CODE,D.PARTY_NAME FROM PRODUCTION.FELT_SALES_RETURNS_HEADER H, PRODUCTION.FELT_SALES_RETURNS_DETAIL D WHERE H.DOC_NO=D.DOC_NO AND H.APPROVED=1 AND H.CANCELED=0 AND D.PIECE_NO NOT IN ( SELECT D.CN_INV_PIECE_NO FROM PRODUCTION.FELT_CN_TEMP_HEADER H, PRODUCTION.FELT_CN_TEMP_DETAIL D WHERE H.CN_ID=D.CN_ID AND H.CN_DATE=D.CN_DATE AND H.CN_TYPE IN (7,9) AND H.CANCELED=0) ";
    ...
    private void cmbOrderReasonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbOrderReasonItemStateChanged
        ...
        txtamendreasoncode.setText(Integer.toString(appliedReason));
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                if (cmbOrderReason.getSelectedItem().toString().equalsIgnoreCase("GOODS RETURN WITH GST ITC")) {
                    ...
                    txtCnID.setText(clsFeltGRCreditNote.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 735, FFNo, false));
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                //if (cmbOrderReason.getSelectedItem().toString().equalsIgnoreCase("GOODS RETURN")) {
                if (cmbOrderReason.getSelectedItem().toString().equalsIgnoreCase("GOODS RETURN WITH GST PAYABLE")) {

                    SelectFirstFree aList = new SelectFirstFree();
                    aList.ModuleID = 735;
                    aList.FirstFreeNo = 343; 
        ...
        try{
            if (EditMode == EITLERPGLOBAL.ADD) {
                if (cmbOrderReason.getSelectedItem().toString().equalsIgnoreCase("GOODS RETURN WITH GST ITC") || cmbOrderReason.getSelectedItem().toString().equalsIgnoreCase("GOODS RETURN WITH GST PAYABLE")) {
                   chkwithGST.setSelected(true); 
                   chkwithGST.setEnabled(false);
                } else{
                   chkwithGST.setSelected(false); 
                   chkwithGST.setEnabled(true);
                }                
            }            
        }catch(Exception e){
            e.printStackTrace();
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Select a row from Document Update History");
        }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmFeltGRCreditNote.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
...
if(Table.getRowCount()>0){
           JOptionPane.showMessageDialog(null, "Only one record is allowed to add");             
        }else{        
        Object[] rowData = new Object[65];
    ...
    private void btnCNDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCNDetailActionPerformed
        // TODO add your handling code here:
        String Title = "", strSQL = "";
        String fileName = "/EITLERP/Production/FeltCreditNote/CreditNoteGRDetail.jrxml";
        ...
        if (txtCnID.getText().startsWith("GR")) {
            ...
            strSQL = "SELECT CND_SUB_ACCOUNT_CODE,CND_MAIN_ACCOUNT_NAME,CND_INVOICE_NO,CND_QUALITY,CND_INVOICE_DATE,CND_INVOICE_AMOUNT,0 AS CND_PERCENT,CND_CREDIT_AMOUNT,CND_EXT4+0.0 AS CND_EXT4,CND_EXT5+0.0 AS CND_EXT5,CND_EXT11+0.0 AS CND_EXT11,CND_EXT12+0.0 AS CND_EXT12,CND_EXT13+0.0 AS CND_EXT13,CND_EXT6+0.0 AS CND_EXT6,CND_EXT14+0.0 AS CND_EXT14 FROM PRODUCTION.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE='GOODSRTN' AND CND_YEAR_MON_ID LIKE ('%" + txtCnID.getText() + "%') ORDER BY CND_SUB_ACCOUNT_CODE";
        }/*
        if (txtCnID.getText().startsWith("CM")) {
    ...
    private void btnCNDraftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCNDraftActionPerformed
        ...
        if (txtCnID.getText().startsWith("GR")) {
            ...
            /*strSQL = "SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_EFFECT,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE, "
                    + "CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT, "
                    + "ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID, "
                    + "CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT,CNH_DRAFT_CR_NOTE_NO,CNH_DRAFT_CR_NOTE_DATE,CNH_EXT11, "
                    + "CNH_FIN_VOUCHER_NO,CNH_REMARKS,CND_ID,CND_NO,CND_TYPE,CND_SUB_ACCOUNT_CODE,CND_INVOICE_NO, "
                    + "CND_INVOICE_DATE,CND_EXT4,CND_EXT8,CND_EXT9,CND_EXT10,CND_EXT11,CND_EXT12,CND_EXT13,CND_EXT14, "
                    + "CND_YEAR_MON_ID,CND_REMARKS,GSTIN_NO FROM "
                    + "(SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_EFFECT,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE, "
                    + "CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT, "
                    + "ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID, "
                    + "CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT,CNH_DRAFT_CR_NOTE_NO,CNH_DRAFT_CR_NOTE_DATE,CNH_EXT11, "
                    + "CNH_FIN_VOUCHER_NO,CNH_REMARKS,CND_ID,CND_NO,CND_TYPE,CND_SUB_ACCOUNT_CODE,CND_INVOICE_NO, "
                    + "CND_INVOICE_DATE,CND_EXT4,CND_EXT8,CND_EXT9,CND_EXT10,CND_EXT11,CND_EXT12,CND_EXT13,CND_EXT14, "
                    + "CND_YEAR_MON_ID,CND_REMARKS FROM PRODUCTION.D_CREDIT_NOTE_HEADER H,PRODUCTION.D_CREDIT_NOTE_DETAIL D WHERE CNH_YEAR_MON_ID=CND_YEAR_MON_ID AND "
                    + "CNH_NO=CND_NO AND CNH_TYPE='GOODSRTN' AND CNH_YEAR_MON_ID LIKE ('%" + txtCnID.getText() + "%')) A "
                    + "LEFT JOIN "
                    + "(SELECT PARTY_CODE,GSTIN_NO FROM DINESHMILLS.D_SAL_PARTY_MASTER) B"
                    + " ON B.PARTY_CODE=A.CNH_SUB_ACCOUNT_CODE";
            */
        }
        /*if (txtCnID.getText().startsWith("CM")) {
        ...
        */
          ...
          //PrintCNDraft(strSQL);
        strVoucher=data.getStringValueFromDB("SELECT CNH_FIN_VOUCHER_NO FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID LIKE ('%" + txtCnID.getText() + "%') AND CNH_TYPE='GOODSRTN' ORDER BY CNH_SUB_ACCOUNT_CODE");
        if(txtCnID.getText().startsWith("GRP")){
            PrintGRPCN(strVoucher, txtCnID.getText(), strSQL);
        }else{
            PrintGRICN(strVoucher, txtCnID.getText(), strSQL);
        }
          //PrintGRCNDraft(strSQL);
    ...
    private void ShowSRGRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShowSRGRActionPerformed
        // TODO add your handling code here:
        if (txtamendreasoncode.getText().matches("7") || txtamendreasoncode.getText().matches("9")) {
            if (Table.getSelectedRowCount() == 0) {
                JOptionPane.showMessageDialog(null, "Select Piece Detail to Show Document");
            } else {
                try {
                    String DocNo = DataModel.getValueAt(Table.getSelectedRow(), 45).toString();
    ...
    private void chkwithGSTItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkwithGSTItemStateChanged
        if (EditMode == EITLERPGLOBAL.ADD) {
            FormatGrid();
        }
    }//GEN-LAST:event_chkwithGSTItemStateChanged

    private void btnCRNoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCRNoteActionPerformed
String strSQL = "";
...
//            strSQL = "SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_EFFECT,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE,CNH_SUB_ACCOUNT_CODE,CNH_CITY,CNH_PARTY_NAME,CNH_REASON_CODE,CNH_BOOK_CODE,CNH_PERCENT,ROUND(CNH_CREDIT_AMOUNT,0) AS CNH_CREDIT_AMOUNT,CNH_LINK_NO,CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT,CNH_DRAFT_CR_NOTE_NO,CNH_DRAFT_CR_NOTE_DATE,CNH_EXT11,CNH_FIN_VOUCHER_NO,CNH_REMARKS FROM PRODUCTION.D_CREDIT_NOTE_HEADER WHERE CNH_YEAR_MON_ID LIKE ('%" + txtCnID.getText() + "%') AND CNH_TYPE='GOODSRTN' ORDER BY CNH_SUB_ACCOUNT_CODE";
            strSQL = "SELECT CNH_ID,CNH_NO,CNH_TYPE,CNH_EFFECT,CNH_MAIN_ACCOUNT_CODE,CNH_MAIN_CODE, "
                    ...
                    + "CNH_INTERVAL_CAPTION,CNH_INVOICE_AMOUNT,CNH_DRAFT_CR_NOTE_NO,CNH_DRAFT_CR_NOTE_DATE,CNH_EXT11, "
                    + "CNH_FIN_VOUCHER_NO,CNH_REMARKS,CND_ID,CND_NO,CND_TYPE,CND_SUB_ACCOUNT_CODE,CND_INVOICE_NO, "
                    + "CND_INVOICE_DATE,CND_EXT4,CND_EXT8,CND_EXT9,CND_EXT10,CND_EXT11,CND_EXT12,CND_EXT13,CASE WHEN CND_EXT5=1 THEN CND_EXT6+CND_EXT14+0.0 ELSE CND_EXT14+0.0 END AS CND_EXT14, "
                    + "CND_YEAR_MON_ID,CND_REMARKS FROM PRODUCTION.D_CREDIT_NOTE_HEADER H,PRODUCTION.D_CREDIT_NOTE_DETAIL D WHERE CNH_YEAR_MON_ID=CND_YEAR_MON_ID AND "
                    + "CNH_NO=CND_NO AND CNH_TYPE='GOODSRTN' AND CNH_YEAR_MON_ID LIKE ('%" + txtCnID.getText() + "%')) A "
                    + "LEFT JOIN "
                    + "(SELECT PARTY_CODE,GSTIN_NO FROM DINESHMILLS.D_SAL_PARTY_MASTER) B"
          ...
          PrintGRCNDraft(txtCnID.getText(),strSQL);
    }//GEN-LAST:event_btnCRNoteActionPerformed
    ...
    private javax.swing.JButton btnCRNote;
    private javax.swing.ButtonGroup buttonGroup1;
    private javax.swing.JCheckBox chkwithGST;
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("FELT GR CREDIT NOTE ENTRY FORM - " + AmendID);
            ...
            chkwithGST.setSelected(ObjFeltCreditNote.getAttribute("WITH_GST").getBool());
            ...
            for (int i = 1; i <= ObjFeltCreditNote.hmFeltCreditNoteDetails.size(); i++) {
                ...
                if (ObjFeltCreditNoteDetails.getAttribute("INSURANCE_CHECK").getString().equalsIgnoreCase("1")) {
                    rowData[32] = true;
                } else {
                    rowData[32] = false;
                }
                rowData[33] = ObjFeltCreditNoteDetails.getAttribute("INSURANCE").getString(); //32
                rowData[34] = ObjFeltCreditNoteDetails.getAttribute("CST").getString(); //33
                rowData[35] = ObjFeltCreditNoteDetails.getAttribute("EXCISE_DUTY").getString(); //34
                rowData[36] = ObjFeltCreditNoteDetails.getAttribute("COM_YEAR_DISC").getString(); //35
                rowData[37] = ObjFeltCreditNoteDetails.getAttribute("COM_YEAR_AMT").getString(); //36
                rowData[38] = ObjFeltCreditNoteDetails.getAttribute("COM_UDJ_DISC").getString(); //37
                rowData[39] = ObjFeltCreditNoteDetails.getAttribute("COM_UDJ_AMT").getString(); //38
                rowData[40] = ObjFeltCreditNoteDetails.getAttribute("COM_OEM_AMT").getString(); //39
                rowData[41] = ObjFeltCreditNoteDetails.getAttribute("COMPENSATION_AMT").getString(); //40
                rowData[42] = ObjFeltCreditNoteDetails.getAttribute("GOODS_RETURN_AMT").getString(); //41
                rowData[43] = ObjFeltCreditNoteDetails.getAttribute("INSURANCE_CLAIM_AMT").getString(); //42
                rowData[44] = ObjFeltCreditNoteDetails.getAttribute("DAYS1").getString(); //43

                //Added on 15/05/2019 by GAURANG based on Change Request dated 08/05/2019
                rowData[45] = ObjFeltCreditNote.getSalesReturnDoc(ObjFeltCreditNoteDetails.getAttribute("CN_INV_PIECE_NO").getString()); //44
                rowData[46] = EITLERPGLOBAL.formatDate(ObjFeltCreditNote.getSalesReturnDate(ObjFeltCreditNoteDetails.getAttribute("CN_INV_PIECE_NO").getString())); //45

                rowData[47] = ObjFeltCreditNoteDetails.getAttribute("CGST_PER").getString(); 
                rowData[48] = ObjFeltCreditNoteDetails.getAttribute("CGST_AMT").getString(); 
                rowData[49] = ObjFeltCreditNoteDetails.getAttribute("SGST_PER").getString(); 
                rowData[50] = ObjFeltCreditNoteDetails.getAttribute("SGST_AMT").getString(); 
                rowData[51] = ObjFeltCreditNoteDetails.getAttribute("IGST_PER").getString(); 
                rowData[52] = ObjFeltCreditNoteDetails.getAttribute("IGST_AMT").getString(); 
                
                rowData[53] = ObjFeltCreditNoteDetails.getAttribute("CGST_ITC_PER").getString(); 
                rowData[54] = ObjFeltCreditNoteDetails.getAttribute("CGST_ITC_AMT").getString(); 
                rowData[55] = ObjFeltCreditNoteDetails.getAttribute("SGST_ITC_PER").getString(); 
                rowData[56] = ObjFeltCreditNoteDetails.getAttribute("SGST_ITC_AMT").getString(); 
                rowData[57] = ObjFeltCreditNoteDetails.getAttribute("IGST_ITC_PER").getString(); 
                rowData[58] = ObjFeltCreditNoteDetails.getAttribute("IGST_ITC_AMT").getString();                                 
            
                rowData[59] = ObjFeltCreditNoteDetails.getAttribute("PARTY_REF_DOC_NO").getString();
                rowData[60] = EITLERPGLOBAL.formatDate(ObjFeltCreditNoteDetails.getAttribute("PARTY_REF_DOC_DATE").getString());
            ...
            HashMap hmApprovalHistory = clsFeltGRCreditNote.getHistoryList(AmendDate, AmendID);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltGRCreditNote ObjFeltCreditNote = (clsFeltGRCreditNote) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Insurance Check");//32
            DataModel.addColumn("Insurance");//33
            DataModel.addColumn("CST");//34
            DataModel.addColumn("Excise");//35
            DataModel.addColumn("Year End Dis%");//36
            DataModel.addColumn("Year End Dis Rs");//37
            DataModel.addColumn("Undjested Dis%");//38
            DataModel.addColumn("Undjested Dis Rs");//39
            DataModel.addColumn("Oem Dis Rs");//40
            DataModel.addColumn("Compensation Amount");//41
            DataModel.addColumn("Goods Return Amount");//42
            DataModel.addColumn("Insurance Claim Amount");//43
            DataModel.addColumn("Days");//44                                  
            

            //Added on 15/05/2019 by GAURANG based on Change Request dated 08/05/2019
            DataModel.addColumn("Doc No of Sales/Goods Return");//45
            DataModel.addColumn("Date of Sales/Goods Return");//46
            
            DataModel.addColumn("CGST %");//47
            DataModel.addColumn("CGST Amt");//48
            DataModel.addColumn("SGST %");//49
            DataModel.addColumn("SGST Amt");//50
            DataModel.addColumn("IGST %");//51
            DataModel.addColumn("IGST Amt");//52

            DataModel.addColumn("ITC CGST %");//53
            DataModel.addColumn("ITC CGST Amt");//54
            DataModel.addColumn("ITC SGST %");//55
            DataModel.addColumn("ITC SGST Amt");//56
            DataModel.addColumn("ITC IGST %");//57
            DataModel.addColumn("ITC IGST Amt");//58
            DataModel.addColumn("Party Ref No %");//57
            DataModel.addColumn("Party Ref Date");//58
            
            /*
            DataModel.SetVariable(0,"SR_NO"); // 0
            DataModel.SetVariable(1,"CN_INV_PIECE_NO"); // 1
            DataModel.SetVariable(2,"CN_INVOICE_NO"); // 2
            DataModel.SetVariable(3,"CN_INVOICE_DATE"); // 3
            DataModel.SetVariable(4,"CN_PARTY_CODE");// 4
            DataModel.SetVariable(5,"CN_PARTY_NAME");// 5
            DataModel.SetVariable(6,"CN_INV_PRODUCT_CODE"); //6
            DataModel.SetVariable(7,"CN_PRODUCT_GRUP"); //7
            DataModel.SetVariable(8,"CN_INV_WI_SQMTR"); //8
            DataModel.SetVariable(7,"CN_GROSS_VALUE");
            DataModel.SetVariable(9,"CN_DISC_BILL"); //9
            DataModel.SetVariable(10,"CN_YEAR_END_DISC");//10
            DataModel.SetVariable(11,"CN_YEAR_END_DISC_RS");//11
            DataModel.SetVariable(12,"CN_UNADJUSTED_DISC");//12
            DataModel.SetVariable(13,"CN_UNADJUSTED_RS");//13
            DataModel.SetVariable(14,"CN_INVOICE_AMT");//14
            DataModel.SetVariable(15,"CN_RATE");//15
            DataModel.SetVariable(16,"CN_BASIC_VALUE");//16
            DataModel.SetVariable(17,"CN_NET_BASIC");//17
            DataModel.SetVariable(18,"CN_OEM");//18
            
            DataModel.SetVariable(0,"CN_OEM_VALUE"); // 0
            DataModel.SetVariable(1,"CN_RECD_AMT"); // 1
            DataModel.SetVariable(2,"CN_EXT1"); // 2
            DataModel.SetVariable(3,"CN_EXT2"); // 3
            DataModel.SetVariable(4,"CN_EXT3");// 4
            DataModel.SetVariable(5,"TOTAL_NET_AMOUNT");// 5
            DataModel.SetVariable(6,"VALUE_DATE"); //6
            DataModel.SetVariable(7,"AMOUNT"); //7
            DataModel.SetVariable(8,"VOUCHER"); //8
            DataModel.SetVariable(7,"F6");
            DataModel.SetVariable(9,"SALES_REMARKS  "); //9
            DataModel.SetVariable(10,"AUDIT_REMARKS");//10
            DataModel.SetVariable(11,"INSURANCE");//11
            DataModel.SetVariable(12,"CST");//12
            DataModel.SetVariable(13,"EXCISE_DUTY");//13
            DataModel.SetVariable(14,"COM_YEAR_DISC");//14
            DataModel.SetVariable(15,"COM_YEAR_AMT");//15
            DataModel.SetVariable(16,"COM_UDJ_DISC");//16
            DataModel.SetVariable(17,"COM_UDJ_AMT");//17
            DataModel.SetVariable(18,"COM_OEM_AMT");//18
            
            DataModel.SetVariable(18,"COMPENSATION_AMT");//18
                DataModel.SetVariable(18,"GOODS_RETURN_AMT");//18
                DataModel.SetVariable(18,"INSURANCE_CLAIM_AMT");//18
                DataModel.SetVariable(18,"DAYS1");//18
                
                DataModel.SetVariable(18,"CGST_PER");//18
                DataModel.SetVariable(18,"CGST_AMT");//18
                DataModel.SetVariable(18,"SGST_PER");//18
                DataModel.SetVariable(18,"SGST_AMT");//18
                DataModel.SetVariable(18,"IGST_PER");//18
                DataModel.SetVariable(18,"IGST_AMT");//18
                DataModel.SetVariable(18,"CGST_ITC_PER");//18
                DataModel.SetVariable(18,"CGST_ITC_AMT");//18
                DataModel.SetVariable(18,"SGST_ITC_PER");//18
                DataModel.SetVariable(18,"SGST_ITC_AMT");//18
                DataModel.SetVariable(18,"IGST_ITC_PER");//18
                DataModel.SetVariable(18,"IGST_ITC_AMT");//18
                DataModel.SetVariable(18,"INSURANCE_CHECK");//18
*/
        ...
        Table.getColumnModel().getColumn(ImportCol).setCellRenderer(Renderer);
            ...
            //Render.setCustomComponent(32,"CheckBox");
            //Table.getColumnModel().getColumn(32).setCellRenderer(Render);
            //Table.getColumnModel().getColumn(32).setCellEditor(new DefaultCellEditor(new JCheckBox()));
           ...
           /* if (txtamendreasoncode.getText().matches("7")) {
            ...
            // ReasonResetReadonly();
            if (txtamendreasoncode.getText().matches("1") || txtamendreasoncode.getText().matches("2")) {
                ...
                Table.getColumnModel().getColumn(43).setMinWidth(0);
                Table.getColumnModel().getColumn(43).setMaxWidth(0);
                //Added on 15/05/2019 by GAURANG based on Change Request dated 08/05/2019
                ...
                Table.getColumnModel().getColumn(46).setMinWidth(0);
                Table.getColumnModel().getColumn(46).setMaxWidth(0);
            }

            if ((txtamendreasoncode.getText().matches("3") || txtamendreasoncode.getText().matches("4") || txtamendreasoncode.getText().matches("5")) && chkwithGST.isSelected()) {
                ...
                Table.getColumnModel().getColumn(53).setMinWidth(0);
                Table.getColumnModel().getColumn(53).setMaxWidth(0);
                Table.getColumnModel().getColumn(54).setMinWidth(0);
                Table.getColumnModel().getColumn(54).setMaxWidth(0);
                Table.getColumnModel().getColumn(55).setMinWidth(0);
                Table.getColumnModel().getColumn(55).setMaxWidth(0);
                Table.getColumnModel().getColumn(56).setMinWidth(0);
                Table.getColumnModel().getColumn(56).setMaxWidth(0);
                Table.getColumnModel().getColumn(57).setMinWidth(0);
                Table.getColumnModel().getColumn(57).setMaxWidth(0);
                Table.getColumnModel().getColumn(58).setMinWidth(0);
                Table.getColumnModel().getColumn(58).setMaxWidth(0);
            ...
            if ((txtamendreasoncode.getText().matches("3") || txtamendreasoncode.getText().matches("4") || txtamendreasoncode.getText().matches("5")) && !chkwithGST.isSelected()) {
                ...
                Table.getColumnModel().getColumn(48).setMinWidth(0);
                Table.getColumnModel().getColumn(48).setMaxWidth(0);
                Table.getColumnModel().getColumn(49).setMinWidth(0);
                Table.getColumnModel().getColumn(49).setMaxWidth(0);
                Table.getColumnModel().getColumn(50).setMinWidth(0);
                Table.getColumnModel().getColumn(50).setMaxWidth(0);
                Table.getColumnModel().getColumn(51).setMinWidth(0);
                Table.getColumnModel().getColumn(51).setMaxWidth(0);
                Table.getColumnModel().getColumn(52).setMinWidth(0);
                Table.getColumnModel().getColumn(52).setMaxWidth(0);
            ...
            if (txtamendreasoncode.getText().matches("7")) {
                ...
                Table.getColumnModel().getColumn(41).setMinWidth(0); //40
                Table.getColumnModel().getColumn(41).setMaxWidth(0);  //40
                Table.getColumnModel().getColumn(43).setMinWidth(0);  //42
                 Table.getColumnModel().getColumn(43).setMaxWidth(0); //42
                //Added on 15/05/2019 by GAURANG based on Change Request dated 08/05/2019
                Table.getColumnModel().getColumn(45).setMinWidth(100); //44
                Table.getColumnModel().getColumn(45).setMaxWidth(150); //44 
                Table.getColumnModel().getColumn(46).setMinWidth(100); //45
                Table.getColumnModel().getColumn(46).setMaxWidth(150); //45
                ...
                /*Table.removeColumn(Table.getColumnModel().getColumn(47));
                Table.removeColumn(Table.getColumnModel().getColumn(48));
                Table.removeColumn(Table.getColumnModel().getColumn(49));
                Table.removeColumn(Table.getColumnModel().getColumn(50));
                Table.removeColumn(Table.getColumnModel().getColumn(51));
                Table.removeColumn(Table.getColumnModel().getColumn(52));*/
            }
           ...
           if (txtamendreasoncode.getText().matches("9")) {
                Table.getColumnModel().getColumn(11).setMinWidth(0);
                Table.getColumnModel().getColumn(11).setMaxWidth(0);
                Table.getColumnModel().getColumn(12).setMinWidth(0);
                Table.getColumnModel().getColumn(12).setMaxWidth(0);
...
//                                else{
                                ...
                                Table.setValueAt(ObjFeltCreditNote.getInsuranceRs(PieceNo), row, 33);  //32
                                Table.setValueAt(ObjFeltCreditNote.getCST(PieceNo), row, 34);  //33
                                Table.setValueAt(ObjFeltCreditNote.getExc(PieceNo), row, 35);  //34
//                                Table.setValueAt(ObjFeltCreditNote.getYearEndd(PieceNo), row, 35);
                                Table.setValueAt(ObjFeltCreditNote.getYearEndd(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)), row, 36);   //35  
//                                Table.setValueAt(ObjFeltCreditNote.getYearEndDiscRs(PieceNo), row, 36);
                                Table.setValueAt(ObjFeltCreditNote.getYearEndDiscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)), row, 37); //36
//                                Table.setValueAt(ObjFeltCreditNote.getUndjested(PieceNo), row, 37);
                                Table.setValueAt(ObjFeltCreditNote.getUndjested(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)), row, 38);  //37
//                                Table.setValueAt(ObjFeltCreditNote.getUndjestediscRs(PieceNo), row, 38);
                                Table.setValueAt(ObjFeltCreditNote.getUndjestediscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)), row, 39); //38
//                                Table.setValueAt(ObjFeltCreditNote.getOemDiscRs(PieceNo), row, 39);
                                Table.setValueAt(ObjFeltCreditNote.getOemDiscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)), row, 40);  //39

                                Table.setValueAt(Boolean.TRUE, row, 32);  //32
                                double grAmt=0.00;
                                String invAmt=ObjFeltCreditNote.getInvoiceAmount(PieceNo);
                                String yearEndDiscRs=ObjFeltCreditNote.getYearEndDiscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo));
                                String unAdjustedDiscRs=ObjFeltCreditNote.getUndjestediscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo));
                                String oemDiscRs=ObjFeltCreditNote.getOemDiscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo));
                                grAmt=Double.parseDouble(invAmt);
                                if(!yearEndDiscRs.equals("")){
                                    grAmt = grAmt-Double.parseDouble(yearEndDiscRs);
                                }else{
                                    grAmt = grAmt;
                                }
                                if(!unAdjustedDiscRs.equals("")){
                                    grAmt = grAmt-Double.parseDouble(unAdjustedDiscRs);
                                }else{
                                    grAmt = grAmt;
                                }
                                if(!oemDiscRs.equals("")){
                                    grAmt = grAmt-Double.parseDouble(oemDiscRs);
                                }else{
                                    grAmt = grAmt;
                                }
                                
                                System.out.println(grAmt);
                                //Table.setValueAt(Double.toString(Double.parseDouble(ObjFeltCreditNote.getInvoiceAmount(PieceNo))-Double.parseDouble(ObjFeltCreditNote.getYearEndDiscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)))-Double.parseDouble(ObjFeltCreditNote.getUndjestediscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)))-Double.parseDouble(ObjFeltCreditNote.getOemDiscRs(ObjFeltCreditNote.getInvoiceNo(PieceNo), ObjFeltCreditNote.getInvoiceDate(PieceNo)))), row, 41);  
                                Table.setValueAt(Double.toString(grAmt), row, 42);  
                                ...
                                if (txtamendreasoncode.getText().matches("7")) {
                                    Table.setValueAt(ObjFeltCreditNote.getSalesReturnDoc(PieceNo), row, 45);      //44                                                                         
                                    Table.setValueAt(EITLERPGLOBAL.formatDate(ObjFeltCreditNote.getSalesReturnDate(PieceNo)), row, 46);  //45
                                    
                                    HashMap List = new HashMap();
                                    List = ObjFeltCreditNote.getGSTData(PieceNo);
                                    int SizeCount = List.size();
                                    
                                        for (int i = 1; i <= List.size(); i++) {
                                            EITLERP.Sales.clsSalesInvoice ObjDoc = (EITLERP.Sales.clsSalesInvoice) List.get(Integer.toString(i));
                                            /*Table.setValueAt(ObjDoc.getAttribute("CGST_PER").getString(), row, 47);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("CGST_AMT").getString(), row, 48);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("SGST_PER").getString(), row, 49);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("SGST_AMT").getString(), row, 50);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("IGST_PER").getString(), row, 51);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("IGST_AMT").getString(), row, 52);                                                                                                                           
                                            */
                                            
                                            Table.setValueAt(ObjDoc.getAttribute("CGST_PER").getString(), row, 53);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("CGST_AMT").getString(), row, 54);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("SGST_PER").getString(), row, 55);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("SGST_AMT").getString(), row, 56);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("IGST_PER").getString(), row, 57);                                                                               
                                            Table.setValueAt(ObjDoc.getAttribute("IGST_AMT").getString(), row, 58);                                                                                                                           
                                        }                                    
                                }
...
////                            }
    ...
    private void Edit() {
        ...
        if (ObjFeltCreditNote.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltCreditNote.CanDelete(txtCnID.getText(), txtCnDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, ObjFeltCreditNote.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Save() {
        ...
        String cgstper = "", sgstper = "", igstper = "", cgstamt = "", sgstamt = "", igstamt = "", insurancecheck = "";
        String cgstitcper = "", sgstitcper = "", igstitcper = "", cgstitcamt = "", sgstitcamt = "", igstitcamt = "";
        String partyRefNo="" , partyRefDate="";
        ...
        Cn_Type=txtamendreasoncode.getText().trim();
...
//        }
        ...
        for (int row = 0; row <= Table.getRowCount() - 1; row++) {
            String GSTIN = data.getStringValueFromDB("SELECT GSTIN_NO FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE='"+Table.getValueAt(row,4).toString()+"'");
            if(GSTIN.equals("")){
                JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "GSTIN No of party "+Table.getValueAt(row,4).toString()+" is mandatory to raise Cr note.", "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                j++;
                insurancecheck= String.valueOf(Table.getValueAt(i, 32));
                insurancecheck.toLowerCase();
                j++;
                insString = ((String) Table.getValueAt(i, 33)).trim(); //32                
                j++;
                cstString = ((String) Table.getValueAt(i, 34)).trim(); //33
                j++;
                excString = ((String) Table.getValueAt(i, 35)).trim();  //34
                j++;
                yeardString = ((String) Table.getValueAt(i, 36)).trim();  //35
                j++;
                yearString = ((String) Table.getValueAt(i, 37)).trim();   //36
                j++;
                udjdString = ((String) Table.getValueAt(i, 38)).trim();  //37 
                j++;
                udjString = ((String) Table.getValueAt(i, 39)).trim();   //38
                j++;
                oemAString = ((String) Table.getValueAt(i, 40)).trim();   //39
                j++;
                CompString = ((String) Table.getValueAt(i, 41)).trim();  //40 
                j++;
                GraString = ((String) Table.getValueAt(i, 42)).trim();   //41
                j++;
                unsclString = ((String) Table.getValueAt(i, 43)).trim();  //42 
                j++;
                Days1String = ((String) Table.getValueAt(i, 44)).trim();  //43
                j++;j++;
                cgstper = ((String) Table.getValueAt(i, 47)).trim();
                j++;
                cgstamt = ((String) Table.getValueAt(i, 48)).trim();
                j++;
                sgstper = ((String) Table.getValueAt(i, 49)).trim();
                j++;
                sgstamt = ((String) Table.getValueAt(i, 50)).trim();
                j++;
                igstper = ((String) Table.getValueAt(i, 51)).trim();
                j++;
                igstamt = ((String) Table.getValueAt(i, 52)).trim();
                j++;
                cgstitcper = ((String) Table.getValueAt(i, 53)).trim();
                j++;
                cgstitcamt = ((String) Table.getValueAt(i, 54)).trim();
                j++;
                sgstitcper = ((String) Table.getValueAt(i, 55)).trim();
                j++;
                sgstitcamt = ((String) Table.getValueAt(i, 56)).trim();
                j++;
                igstitcper = ((String) Table.getValueAt(i, 57)).trim();
                j++;
                igstitcamt = ((String) Table.getValueAt(i, 58)).trim();
                j++;
                partyRefNo=((String) Table.getValueAt(i, 59)).trim();
                j++;
                partyRefDate=((String) Table.getValueAt(i, 60)).trim();
                

                
                if (Cn_Type.equals("6") && CompString.equals("")) {
                    JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Please Enter Compensation Amount.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (Cn_Type.equals("7") && GraString.equals("")) {
                    JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Please Enter GoodsReturn Amount.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                
                if (Cn_Type.equals("9") && GraString.equals("")) {
                    JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Please Enter GoodsReturn Amount.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (Cn_Type.equals("8") && unsclString.equals("")) {
                    JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Please Enter Insurance Amount.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                ObjFeltCreditNoteDetails.setAttribute("CGST_PER", cgstper);//41
                ObjFeltCreditNoteDetails.setAttribute("CGST_AMT", cgstamt);//41
                ObjFeltCreditNoteDetails.setAttribute("SGST_PER", sgstper);//41
                ObjFeltCreditNoteDetails.setAttribute("SGST_AMT", sgstamt);//41
                ObjFeltCreditNoteDetails.setAttribute("IGST_PER", igstper);//41
                ObjFeltCreditNoteDetails.setAttribute("IGST_AMT", igstamt);//41
                ObjFeltCreditNoteDetails.setAttribute("CGST_ITC_PER", cgstitcper);//41
                ObjFeltCreditNoteDetails.setAttribute("CGST_ITC_AMT", cgstitcamt);//41
                ObjFeltCreditNoteDetails.setAttribute("SGST_ITC_PER", sgstitcper);//41
                ObjFeltCreditNoteDetails.setAttribute("SGST_ITC_AMT", sgstitcamt);//41
                ObjFeltCreditNoteDetails.setAttribute("IGST_ITC_PER", igstitcper);//41
                ObjFeltCreditNoteDetails.setAttribute("IGST_ITC_AMT", igstitcamt);//41
                if (insurancecheck.equals("true")) {
                    ObjFeltCreditNoteDetails.setAttribute("INSURANCE_CHECK", "1"); //3
                } else {
                    ObjFeltCreditNoteDetails.setAttribute("INSURANCE_CHECK", "0"); //3
                }                
                ObjFeltCreditNoteDetails.setAttribute("PARTY_REF_DOC_DATE", EITLERPGLOBAL.formatDateDB(partyRefDate));//3
                ObjFeltCreditNoteDetails.setAttribute("PARTY_REF_DOC_NO", partyRefNo);//4
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if(chkwithGST.isSelected()) {
            ObjFeltCreditNote.setAttribute("WITH_GST",true);
        }
        else {
            ObjFeltCreditNote.setAttribute("WITH_GST",false);
        }
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltCreditNote.Insert()) {
                ...
                JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Error occured while saving. Error is " + ObjFeltCreditNote.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltCreditNote.Update()) {
                ...
                JOptionPane.showMessageDialog(frmFeltGRCreditNote.this, "Error occured while saving editing. Error is " + ObjFeltCreditNote.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void GenerateCreditNoteCombo() {
        ...
        hmAmendList = clsFeltGRCreditNote.getCreditNoteList();
    ...
    private void Notification() {
        if (OpgApprove.isSelected() || OpgFinal.isSelected()) {
            try {
                ...
                if (cnReasonCd.equals("1") || cnReasonCd.equals("2")) {
                ...
                HashMap hmApprovalHistory = clsFeltGRCreditNote.getHistoryList(cnDate, cnNo);
                for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                    pMessage += "<tr>";

                    clsFeltGRCreditNote ObjHistory = (clsFeltGRCreditNote) hmApprovalHistory.get(Integer.toString(i));
