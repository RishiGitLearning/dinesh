 ...
 * @version
 */
public class clsFeltGRCreditNote extends clsFeltCNAutoPosting {
    ...
    public clsFeltGRCreditNote() {
        ...
        props.put("WITH_GST", new Variant(0));
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM PRODUCTION.FELT_CN_TEMP_HEADER WHERE CN_TYPE IN (7,9) ORDER BY CN_DATE");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            if (cnid.matches("GR")) {
                String cnid1 = getAttribute("CN_ID").getString().substring(0, 3);
                if (cnid1.matches("GRI")) {
                setAttribute("CN_ID", getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 735, 193, true));
                }
                if (cnid1.matches("GRP")) {
                setAttribute("CN_ID", getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 735, 343, true));
                }
            }
            if (cnid.matches("IC")) {
            ...
            resultSet.updateBoolean("WITH_GST",(boolean)getAttribute("WITH_GST").getBool());
            ...
            rsHeader.updateBoolean("WITH_GST",(boolean)getAttribute("WITH_GST").getBool());
            ...
            for (int i = 1; i <= hmFeltCreditNoteDetails.size(); i++) {
                ...
                resultSetTemp.updateString("CGST_PER", ObjFeltCreditNoteDetails.getAttribute("CGST_PER").getString());
                resultSetTemp.updateString("CGST_AMT", ObjFeltCreditNoteDetails.getAttribute("CGST_AMT").getString());
                resultSetTemp.updateString("SGST_PER", ObjFeltCreditNoteDetails.getAttribute("SGST_PER").getString());
                resultSetTemp.updateString("SGST_AMT", ObjFeltCreditNoteDetails.getAttribute("SGST_AMT").getString());
                resultSetTemp.updateString("IGST_PER", ObjFeltCreditNoteDetails.getAttribute("IGST_PER").getString());
                resultSetTemp.updateString("IGST_AMT", ObjFeltCreditNoteDetails.getAttribute("IGST_AMT").getString());
                
                resultSetTemp.updateString("CGST_ITC_PER", ObjFeltCreditNoteDetails.getAttribute("CGST_ITC_PER").getString());
                resultSetTemp.updateString("CGST_ITC_AMT", ObjFeltCreditNoteDetails.getAttribute("CGST_ITC_AMT").getString());
                resultSetTemp.updateString("SGST_ITC_PER", ObjFeltCreditNoteDetails.getAttribute("SGST_ITC_PER").getString());
                resultSetTemp.updateString("SGST_ITC_AMT", ObjFeltCreditNoteDetails.getAttribute("SGST_ITC_AMT").getString());
                resultSetTemp.updateString("IGST_ITC_PER", ObjFeltCreditNoteDetails.getAttribute("IGST_ITC_PER").getString());
                resultSetTemp.updateString("IGST_ITC_AMT", ObjFeltCreditNoteDetails.getAttribute("IGST_ITC_AMT").getString());
                
                resultSetTemp.updateString("INSURANCE_CHECK", ObjFeltCreditNoteDetails.getAttribute("INSURANCE_CHECK").getString());
                
                resultSetTemp.updateString("PARTY_REF_DOC_NO", ObjFeltCreditNoteDetails.getAttribute("PARTY_REF_DOC_NO").getString());
                resultSetTemp.updateString("PARTY_REF_DOC_DATE", ObjFeltCreditNoteDetails.getAttribute("PARTY_REF_DOC_DATE").getString());
                ...
                resultSetHistory.updateString("CGST_PER", ObjFeltCreditNoteDetails.getAttribute("CGST_PER").getString());
                resultSetHistory.updateString("CGST_AMT", ObjFeltCreditNoteDetails.getAttribute("CGST_AMT").getString());
                resultSetHistory.updateString("SGST_PER", ObjFeltCreditNoteDetails.getAttribute("SGST_PER").getString());
                resultSetHistory.updateString("SGST_AMT", ObjFeltCreditNoteDetails.getAttribute("SGST_AMT").getString());
                resultSetHistory.updateString("IGST_PER", ObjFeltCreditNoteDetails.getAttribute("IGST_PER").getString());
                resultSetHistory.updateString("IGST_AMT", ObjFeltCreditNoteDetails.getAttribute("IGST_AMT").getString());
                
                resultSetHistory.updateString("CGST_ITC_PER", ObjFeltCreditNoteDetails.getAttribute("CGST_ITC_PER").getString());
                resultSetHistory.updateString("CGST_ITC_AMT", ObjFeltCreditNoteDetails.getAttribute("CGST_ITC_AMT").getString());
                resultSetHistory.updateString("SGST_ITC_PER", ObjFeltCreditNoteDetails.getAttribute("SGST_ITC_PER").getString());
                resultSetHistory.updateString("SGST_ITC_AMT", ObjFeltCreditNoteDetails.getAttribute("SGST_ITC_AMT").getString());
                resultSetHistory.updateString("IGST_ITC_PER", ObjFeltCreditNoteDetails.getAttribute("IGST_ITC_PER").getString());
                resultSetHistory.updateString("IGST_ITC_AMT", ObjFeltCreditNoteDetails.getAttribute("IGST_ITC_AMT").getString());
                
                resultSetHistory.updateString("INSURANCE_CHECK", ObjFeltCreditNoteDetails.getAttribute("INSURANCE_CHECK").getString());
                
                resultSetHistory.updateString("PARTY_REF_DOC_NO", ObjFeltCreditNoteDetails.getAttribute("PARTY_REF_DOC_NO").getString());
                resultSetHistory.updateString("PARTY_REF_DOC_DATE", ObjFeltCreditNoteDetails.getAttribute("PARTY_REF_DOC_DATE").getString());
    ...
    public boolean Update() {
        ...
        try {
            ...
            if (ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ...
                if (getAttribute("CN_ID").getString().startsWith("GRI")) {
                    //GenerateGRCN(getAttribute("CN_ID").getString());
                    //GRCNVoucherPosting(getAttribute("CN_ID").getString());
                    GenerateGRICN(getAttribute("CN_ID").getString());
                    GRICNVoucherPosting(getAttribute("CN_ID").getString());
                }
                
                if (getAttribute("CN_ID").getString().startsWith("GRP")) {
//                    GenerateGRCN(getAttribute("CN_ID").getString());
//                    GRCNVoucherPosting(getAttribute("CN_ID").getString());
                    GenerateGRPCN(getAttribute("CN_ID").getString());
                    GRPCNVoucherPosting(getAttribute("CN_ID").getString());
                }
...
//            }
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("WITH_GST",resultSet.getBoolean("WITH_GST"));
            ...
            while (resultSetTemp.next()) {
                ...
                ObjFeltCreditNoteDetails.setAttribute("CGST_PER", resultSetTemp.getString("CGST_PER"));
                ObjFeltCreditNoteDetails.setAttribute("CGST_AMT", resultSetTemp.getString("CGST_AMT"));
                ObjFeltCreditNoteDetails.setAttribute("SGST_PER", resultSetTemp.getString("SGST_PER"));
                ObjFeltCreditNoteDetails.setAttribute("SGST_AMT", resultSetTemp.getString("SGST_AMT"));
                ObjFeltCreditNoteDetails.setAttribute("IGST_PER", resultSetTemp.getString("IGST_PER"));
                ObjFeltCreditNoteDetails.setAttribute("IGST_AMT", resultSetTemp.getString("IGST_AMT"));
                
                ObjFeltCreditNoteDetails.setAttribute("CGST_ITC_PER", resultSetTemp.getString("CGST_ITC_PER"));
                ObjFeltCreditNoteDetails.setAttribute("CGST_ITC_AMT", resultSetTemp.getString("CGST_ITC_AMT"));
                ObjFeltCreditNoteDetails.setAttribute("SGST_ITC_PER", resultSetTemp.getString("SGST_ITC_PER"));
                ObjFeltCreditNoteDetails.setAttribute("SGST_ITC_AMT", resultSetTemp.getString("SGST_ITC_AMT"));
                ObjFeltCreditNoteDetails.setAttribute("IGST_ITC_PER", resultSetTemp.getString("IGST_ITC_PER"));
                ObjFeltCreditNoteDetails.setAttribute("IGST_ITC_AMT", resultSetTemp.getString("IGST_ITC_AMT"));
                
                ObjFeltCreditNoteDetails.setAttribute("INSURANCE_CHECK", resultSetTemp.getString("INSURANCE_CHECK"));
                
                ObjFeltCreditNoteDetails.setAttribute("PARTY_REF_DOC_NO", resultSetTemp.getString("PARTY_REF_DOC_NO"));
                ObjFeltCreditNoteDetails.setAttribute("PARTY_REF_DOC_DATE", resultSetTemp.getString("PARTY_REF_DOC_DATE"));
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            while (rsTmp.next()) {
                clsFeltGRCreditNote ObjFeltCreditNote = new clsFeltGRCreditNote();
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltGRCreditNote ObjDoc = new clsFeltGRCreditNote();
...
//        return data.getStringValueFromDB("SELECT INVOICE_NO FROM PRODUCTION.FELT_INVOICE_DATA WHERE PR_PIECE_NO='"+pPieceNo+"'");
    ...
    public static HashMap getGSTData(String pPieceNo) {
        String strSQL = "";
        Connection tmpConn;
        ...
        try {            
                strSQL = "SELECT D.IGST_PER,D.IGST_AMT,D.CGST_PER,D.CGST_AMT,D.SGST_PER,D.SGST_AMT FROM PRODUCTION.FELT_SAL_INVOICE_HEADER H, "
                        + "PRODUCTION.FELT_SAL_INVOICE_DETAIL D WHERE H.INVOICE_NO=D.INVOICE_NO "
                        + "AND H.INVOICE_DATE=SUBSTRING(D.INVOICE_DATE,1,10) AND D.PIECE_NO='" + pPieceNo + "' AND H.APPROVED=1 AND H.CANCELLED=0";
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                Counter = Counter + 1;
               EITLERP.Sales.clsSalesInvoice ObjItem = new EITLERP.Sales.clsSalesInvoice();

                //------------- Header Fields --------------------//                
                ObjItem.setAttribute("IGST_PER", rsTmp.getString("IGST_PER"));
                ObjItem.setAttribute("IGST_AMT", rsTmp.getString("IGST_AMT"));
                ObjItem.setAttribute("CGST_PER", rsTmp.getString("CGST_PER"));
                ObjItem.setAttribute("CGST_AMT", rsTmp.getString("CGST_AMT"));
                ObjItem.setAttribute("SGST_PER", rsTmp.getString("SGST_PER"));
                ObjItem.setAttribute("SGST_AMT", rsTmp.getString("SGST_AMT"));
                // ----------------- End of Header Fields ------------------------------------//
...
//         return data.getStringValueFromDB("SELECT TOTAL_NET_AMOUNT FROM PRODUCTION.FELT_INVOICE_DATA WHERE PR_PIECE_NO='"+pPieceNo+"'");
    ...
    public static HashMap getCreditNoteList() {
        ...
        try {
            ...
            ResultSet rsTmp = stTmp.executeQuery("SELECT 0 AS PARA_CODE,'SELECT GR CREDIT NOTE' AS PARA_DESC UNION ALL SELECT PARA_CODE,PARA_DESC FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID = 'CREDIT_NOTE' AND PARA_CODE IN (7,9) ORDER BY PARA_CODE");
            while (rsTmp.next()) {
                ComboData aData = new ComboData();
