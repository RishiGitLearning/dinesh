...
public class frmfeltOrder1 extends javax.swing.JApplet {
    ...
    private clsOrder_1 ObjSalesParty;
   ...
   /* private void ChargeCodeCombos(String strCon) {
    ...
    private void GenerateCombos() {
        ...
        List=clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsOrder_1.ModuleID);
        
        if(EditMode==EITLERPGLOBAL.EDIT) {
            List=clsHierarchy.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND MODULE_ID="+clsOrder_1.ModuleID);
        }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtBalnk = new javax.swing.JTextField();
        jLabel58 = new javax.swing.JLabel();
        jLabel59 = new javax.swing.JLabel();
        txtWvgDate = new javax.swing.JTextField();
        txtNdlDate = new javax.swing.JTextField();
        jLabel61 = new javax.swing.JLabel();
        txtMndDate = new javax.swing.JTextField();
        ...
        Tab1.add(jLabel2);
        jLabel2.setBounds(50, 10, 60, 20);

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Party code ");
        Tab1.add(jLabel5);
        jLabel5.setBounds(30, 40, 80, 20);
        ...
        txtPartyCode.setBounds(120, 40, 130, 20);
        ...
        Tab1.add(cmdNext1);
        cmdNext1.setBounds(660, 410, 90, 25);
        ...
        Tab1.add(txtPieceNo);
        txtPieceNo.setBounds(120, 10, 130, 20);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Product Code ");
        Tab1.add(jLabel4);
        jLabel4.setBounds(320, 40, 100, 20);
        ...
        txtProductCode.setBounds(430, 40, 130, 19);
        ...
        Tab1.add(jLabel53);
        jLabel53.setBounds(50, 190, 60, 20);

        txtRemarks.setEnabled(false);
        Tab1.add(txtRemarks);
        txtRemarks.setBounds(120, 190, 440, 19);

        txtLastPriority.setEnabled(false);
        Tab1.add(txtLastPriority);
        txtLastPriority.setBounds(610, 160, 120, 20);
        ...
        cmdRemarksBig.setBounds(570, 190, 20, 25);
        ...
        cmdLastUsrBig.setBounds(570, 390, 30, 20);

        txtSetPriority.setEnabled(false);
        Tab1.add(txtSetPriority);
        txtSetPriority.setBounds(610, 190, 120, 19);

        txtPrevRemarks.setEnabled(false);
        Tab1.add(txtPrevRemarks);
        txtPrevRemarks.setBounds(120, 220, 520, 19);

        jLabel54.setText("Prev. Remarks");
        Tab1.add(jLabel54);
        jLabel54.setBounds(20, 220, 90, 20);

        jLabel55.setText(".");
        jLabel55.setEnabled(false);
        Tab1.add(jLabel55);
        jLabel55.setBounds(710, 10, 10, 10);

        txtOrderNo.setEditable(false);
        txtOrderNo.setEnabled(false);
        txtOrderNo.setOpaque(false);
        Tab1.add(txtOrderNo);
        txtOrderNo.setBounds(730, 10, 10, 10);

        Tab1.add(lblPartyName);
        lblPartyName.setBounds(120, 70, 300, 20);
        ...
        Tab3.add(jLabel26);
        jLabel26.setBounds(410, 70, 40, 20);

        jLabel23.setText("Other");
        Tab3.add(jLabel23);
        jLabel23.setBounds(110, 100, 40, 20);
        ...
        txtOrdDDMMA.setBounds(470, 210, 140, 21);
        ...
        txtOrdDDMMB.setBounds(470, 240, 140, 21);
        ...
        lblDiscount.setBounds(390, 100, 60, 20);
        ...
        lblOrderDDMMB.setBounds(350, 240, 100, 20);
        ...
        Tab3.add(jLabel40);
        jLabel40.setBounds(330, 270, 120, 20);
        ...
        lblOrdDDMMA.setBounds(370, 210, 90, 20);
        ...
        jLabel56.setText("Prod Code");
        Tab3.add(jLabel56);
        jLabel56.setBounds(386, 300, 64, 20);

        Tab3.add(txtProdCode);
        txtProdCode.setBounds(470, 300, 140, 19);

        jLabel57.setText("Balnk");
        Tab3.add(jLabel57);
        jLabel57.setBounds(410, 160, 40, 20);

        txtBalnk.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtBalnkActionPerformed(evt);
            }
        });

        Tab3.add(txtBalnk);
        txtBalnk.setBounds(460, 160, 150, 19);

        jLabel58.setText("Weaving Date");
        Tab3.add(jLabel58);
        jLabel58.setBounds(63, 360, 90, 20);

        jLabel59.setText("Needle Date");
        Tab3.add(jLabel59);
        jLabel59.setBounds(380, 360, 80, 20);

        Tab3.add(txtWvgDate);
        txtWvgDate.setBounds(160, 360, 150, 19);

        Tab3.add(txtNdlDate);
        txtNdlDate.setBounds(470, 360, 150, 19);

        jLabel61.setText("Mending Date");
        Tab3.add(jLabel61);
        jLabel61.setBounds(370, 330, 90, 20);

        Tab3.add(txtMndDate);
        txtMndDate.setBounds(470, 330, 150, 19);
        ...
        jTabbedPane1.setBounds(5, 70, 780, 470);
    ...
    private void txtPieceNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPieceNoFocusLost
        ...
        if(!txtPieceNo.getText().trim().equals("")) {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                if (data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_ORDER_MASTER WHERE PIECE_NO='"+txtPieceNo.getText().trim()+"'")) {
                    JOptionPane.showMessageDialog(null,"Piece Number already exists!!");
                    txtPieceNo.setText("");
                    txtPieceNo.requestFocus(true);
                    return;
                }         
            }
            if(EditMode==EITLERPGLOBAL.EDIT) {
                ...
                if(!data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_ORDER_MASTER WHERE PIECE_NO='"+txtPieceNo.getText().trim()+"' AND CANCELLED = 0 AND APPROVED = 0 ")) {
                    JOptionPane.showMessageDialog(null,"Piece Number already exists!!");
                    txtPieceNo.setText("");
                    txtPieceNo.requestFocus(true);
                    return;
    ...
    private void txtPartyCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPartyCodeKeyPressed
         if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            if(aList.ShowLOV()) {
               ...
               lblPartyName.setText(clsFeltparty.getParyName(EITLERPGLOBAL.gCompanyID,aList.ReturnVal)); 
        }
        }
    ...
    private void txtProductCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtProductCodeKeyPressed
         if(evt.getKeyCode()==112) //F1 Key pressed
        {
            ...
            aList.SQL="SELECT ITEM_CODE,GRUP,ITEM_DESC FROM PRODUCTION.FELT_RATE_MASTER ORDER BY ITEM_CODE";
            aList.ReturnCol=1;
            aList.SecondCol=2; 
            aList.ShowReturnCol=true;
            aList.DefaultSearchOn=1;
            ...
            if(aList.ShowLOV()) {
               ...
               txtGroup.setText(aList.SecondVal); 
        }
        }
    }//GEN-LAST:event_txtProductCodeKeyPressed
    
    private void txtBalnkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBalnkActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBalnkActionPerformed
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            ...
            if(ApprovalFlow.IsOnceRejectedDoc(EITLERPGLOBAL.gCompanyID,clsOrder_1.ModuleID,PartyID)) {
                cmbSendTo.setEnabled(true);
            }
            else {
                cmbSendTo.setEnabled(false);
    ...
    private javax.swing.JTextField txtBalnk;
    ...
    private javax.swing.JTextField txtMndDate;
    private javax.swing.JTextField txtNdlDate;
    ...
    private javax.swing.JTextField txtWvgDate;
    ...
    private void Add() {
        ...
        //aList.ModuleID=clsOrder_1.ModuleID;
        ...
        //if(aList.ShowList()) {
            ...
            //txtOrderNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsOrder_1.ModuleID, FFNo,  false));
            
            txtOrderDate.setText(EITLERPGLOBAL.getCurrentDate());
            txtOrderNo.requestFocus();
            //txtOrderDate.requestFocus();
            
            //lblTitle.setText("FELT ORDER - "+txtOrderNo.getText());
            lblTitle.setText("FELT ORDER - " +txtOrderNo.getText()+ "  ON  " +txtOrderDate.getText());
    ...
    private void SetupApproval() {
        ...
        if(EditMode==EITLERPGLOBAL.ADD) {
            ...
            int FromUserID=ApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, clsOrder_1.ModuleID,(String)ObjSalesParty.getAttribute("PARTY_CODE").getObj());
            lnFromID=FromUserID;
            String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks=ApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,clsOrder_1.ModuleID,FromUserID,(String)ObjSalesParty.getAttribute("PARTY_CODE").getObj());
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if(EditMode==EITLERPGLOBAL.ADD) {
                ...
                List=ApprovalFlow.getRemainingUsers((int)EITLERPGLOBAL.gCompanyID, clsOrder_1.ModuleID,DocNo);
                for(int i=1;i<=List.size();i++) {
                    clsUser ObjUser=(clsUser) List.get(Integer.toString(i));
                    ComboData aData=new ComboData();
                    aData.Code=(int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetFields(boolean pStat) {
        ...
        txtBalnk.setEnabled(pStat);
        txtNdlDate.setEnabled(pStat);
        txtMndDate.setEnabled(pStat);
        txtWvgDate.setEnabled(pStat);
    ...
    private boolean Validate() {
        ...
        if(txtPieceNo.getText().trim().equals("")&&OpgFinal.isSelected()) {
            JOptionPane.showMessageDialog(null,"Please enter Piece Number");
    ...
    private void Edit() {
        ...
        DisplayData();
        //----------------//
        // if(ApprovalFlow.IsCreator(clsOrder_1.ModuleID,sPartyCode)||clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0,70102)) {
        SetFields(true);
        // }
        // else {
        //     EnableApproval();
    ...
    private void DisplayData() {
        ...
        if(EITLERPGLOBAL.gAuthorityUserID!=EITLERPGLOBAL.gUserID) {
            int ModuleID=clsOrder_1.ModuleID;
        ...
        try {
            ...
            //String st;
            lblTitle.setText("FELT ORDER - " + (String)ObjSalesParty.getAttribute("PIECE_NO").getObj() + " ON " +EITLERPGLOBAL.formatDate(ObjSalesParty.getAttribute("ORDER_DATE").getString()));
            //txtOrderNo.setText((String)ObjSalesParty.getAttribute("ORDER_NO").getObj());
            ...
            txtLength.setText(Double.toString(ObjSalesParty.getAttribute("LNGTH").getDouble()));
            txtWidth.setText(Double.toString(ObjSalesParty.getAttribute("WIDTH").getDouble()));
            txtGSQ.setText(Integer.toString(ObjSalesParty.getAttribute("GSQ").getInt()));
            ...
            txtProdCode.setText(ObjSalesParty.getAttribute("PROD_CODE").getString());
            txtPrevRemarks.setText(ObjSalesParty.getAttribute("REMARKS").getString());
            txtBalnk.setText(ObjSalesParty.getAttribute("BALNK").getString());
            txtWeight.setText(Double.toString(ObjSalesParty.getAttribute("WEIGHT").getDouble()));
            ...
            txtWvgDate.setText(EITLERPGLOBAL.formatDate(ObjSalesParty.getAttribute("WVG_DATE").getString()));
            txtMndDate.setText(EITLERPGLOBAL.formatDate(ObjSalesParty.getAttribute("MND_DATE").getString()));
            txtNdlDate.setText(EITLERPGLOBAL.formatDate(ObjSalesParty.getAttribute("NDL_DATE").getString()));
            ...
            String OrderNo=ObjSalesParty.getAttribute("PIECE_NO").getString();
            List=clsFeltProductionApprovalFlow.getDocumentFlow(clsOrder_1.ModuleID, OrderNo);
            for(int i=1;i<=List.size();i++) {
            ...
            FormatGridHS();
            //String OrderNo=(String)ObjSalesParty.getAttribute("PIECE_NO").getObj();
            HashMap History=clsOrder_1.getHistoryList(OrderNo);
            for(int i=1;i<=History.size();i++) {
                clsOrder_1 ObjHistory=(clsOrder_1)History.get(Integer.toString(i));
                Object[] rowData=new Object[5];
                
                rowData[0]=Integer.toString((int)ObjHistory.getAttribute("REVISION_NO").getVal());
                rowData[1]=clsUser.getUserName(EITLERPGLOBAL.gCompanyID,ObjHistory.getAttribute("UPDATED_BY").getInt());
    ...
    private void SetData() {
        ...
        //ObjSalesParty.setAttribute("ORDER_NO",txtOrderNo.getText());
        ObjSalesParty.setAttribute("PIECE_NO",txtPieceNo.getText());
        ObjSalesParty.setAttribute("ORDER_DATE",EITLERPGLOBAL.formatDateDB(txtOrderDate.getText()));
        ObjSalesParty.setAttribute("PRODUCT_CODE",txtProductCode.getText());
        ObjSalesParty.setAttribute("PARTY_CD",txtPartyCode.getText());
        ObjSalesParty.setAttribute("LNGTH",Double.parseDouble(txtLength.getText()));
        ObjSalesParty.setAttribute("WIDTH",Double.parseDouble(txtWidth.getText()));
        ObjSalesParty.setAttribute("GSQ",Integer.parseInt(txtGSQ.getText()));
        ...
        ObjSalesParty.setAttribute("PROD_CODE",txtProdCode.getText());
        ...
        ObjSalesParty.setAttribute("BALNK",txtBalnk.getText());
        ObjSalesParty.setAttribute("WEIGHT",Double.parseDouble(txtWeight.getText()));
        ...
        ObjSalesParty.setAttribute("WVG_DATE",EITLERPGLOBAL.formatDateDB(txtWvgDate.getText()));
        ObjSalesParty.setAttribute("MND_DATE",EITLERPGLOBAL.formatDateDB(txtMndDate.getText()));
        ObjSalesParty.setAttribute("NDL_DATE",EITLERPGLOBAL.formatDateDB(txtNdlDate.getText()));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7010,70101)) {
            cmdNew.setEnabled(true);
        }
        else {
            cmdNew.setEnabled(false);
        ...
        // --- Delete Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7010,70103)) {
            cmdDelete.setEnabled(true);
        }
        else {
            cmdDelete.setEnabled(false);
        ...
        // --- Print Rights --
        if(clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7010,70104)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        }
        else {
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            if(EditMode==EITLERPGLOBAL.EDIT) {
                if(OpgApprove.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInApproval(EITLERPGLOBAL.gCompanyID, clsOrder_1.ModuleID, PartyCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
                
                if(OpgReject.isSelected()) {
                    IncludeUser=ApprovalFlow.IncludeUserInRejection(EITLERPGLOBAL.gCompanyID, clsOrder_1.ModuleID, PartyCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if(EditMode==EITLERPGLOBAL.EDIT) {
            String DocNo=(String)ObjSalesParty.getAttribute("PARTY_CODE").getObj();
            int Creator=ApprovalFlow.getCreator(EITLERPGLOBAL.gCompanyID, clsOrder_1.ModuleID, DocNo);
