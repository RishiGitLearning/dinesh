...
public class frmComplaintFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtComplaintNo = new javax.swing.JTextField();
        ...
        cmdClear.setNextFocusableComponent(txtComplaintNo);
        ...
        jLabel2.setLabelFor(txtComplaintNo);
        jLabel2.setText("Complaint No");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(15, 11, 90, 15);

        jPanel1.add(txtComplaintNo);
        txtComplaintNo.setBounds(110, 10, 130, 19);

        jLabel4.setText("Complaint Date");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(15, 41, 90, 15);

        jPanel1.add(txtComplaintDate);
        txtComplaintDate.setBounds(110, 40, 130, 19);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        String ComplaintDate = txtComplaintDate.getText();       
        String ComplaintNo = txtComplaintNo.getText();        
        
        if(!ComplaintDate.equals("")) {
            stringFindQuery+=" CPNT_DATE='"+EITLERPGLOBAL.formatDateDB(ComplaintDate)+"' ";
        }
        
        if(!ComplaintNo.equals("")) {
            stringFindQuery+=" CPNT_NO ='"+ ComplaintNo +"'";
        }  
        
        if(!ComplaintNo.equals("") && !ComplaintDate.equals("")) {
            stringFindQuery=" CPNT_NO ='"+ ComplaintNo +"' AND CPNT_DATE='"+EITLERPGLOBAL.formatDateDB(ComplaintDate)+"'";
        }
    ...
    private javax.swing.JTextField txtComplaintNo;
