...
public class LOV extends javax.swing.JApplet {
    ...
    public LOV(String pSQL,int pReturnCol,boolean pShowReturnCol,int pDefaultSearchOn) {
        System.gc();
        initComponents();
        DataModel=new EITLTableModel();
        SQL=pSQL;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 50, 480, 230);
    ...
    private void GenerateLOV() {
        try {
            ...
            if(ShowReturnCol==false) {
                ColModel.getColumn(ReturnCol-1).setMinWidth(100);
                ColModel.getColumn(ReturnCol-1).setPreferredWidth(100);
            }
