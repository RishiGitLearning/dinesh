...
public class FrmLoomWiseBeamFallPlanning extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private final int ModuleId = 843;
    private String DOC_NO = "";
    private clsLoomWiseBeamFallPlanning objDM;
    ...
    public void init() {
        ...
        objDM = new clsLoomWiseBeamFallPlanning();
    ...
    private void DisplayData() {
        ...
        clearFields();
        try {
            // txtDocNo.setText(objDM.getAttribute("LPP_DOC_NO").getString());
            lblTitle.setText("Felt Loom Wise Beam Fall, Warping and Warp Preparation Planning Amend " + objDM.getAttribute("LPP_DOC_NO").getString());
            //txtDocDate.setText(EITLERPGLOBAL.formatDate(objDM.getAttribute("LPP_DOC_DATE").getString()));
...
//            FormatGrid_OTHER();
            ...
            for (int i = 1; i <= objDM.hmFeltPerformanceTrackingDetails.size(); i++) {
                clsLoomWiseBeamFallPlanningDetails ObjItem = (clsLoomWiseBeamFallPlanningDetails) objDM.hmFeltPerformanceTrackingDetails.get(Integer.toString(i));
...
//                {
                ...
                DataModel.setValueByVariable("NO_OF_PIECE", ObjItem.getAttribute("NO_OF_PIECE").getString(), NewRow);
                DataModel.setValueByVariable("LOOM_PICKS", ObjItem.getAttribute("LOOM_PICKS").getString(), NewRow);
                DataModel.setValueByVariable("WARP_TO_BE_ALLOTED_MTS", ObjItem.getAttribute("WARP_TO_BE_ALLOTED_MTS").getString(), NewRow);
                DataModel.setValueByVariable("WARP_TO_BE_ALLOTED_LOOM_PICKS", ObjItem.getAttribute("WARP_TO_BE_ALLOTED_LOOM_PICKS").getString(), NewRow);
                DataModel.setValueByVariable("TOTAL_PICK_PENDING", ObjItem.getAttribute("TOTAL_PICK_PENDING").getString(), NewRow);
                DataModel.setValueByVariable("DAY_PENDING_FOR_BEAM_FALL", ObjItem.getAttribute("DAY_PENDING_FOR_BEAM_FALL").getString(), NewRow);
                DataModel.setValueByVariable("EXPECTED_DATE_OF_BEAM_FALL", EITLERPGLOBAL.formatDate(ObjItem.getAttribute("EXPECTED_DATE_OF_BEAM_FALL").getString()), NewRow);
                DataModel.setValueByVariable("DAYS_REQUIRED_FOR_WARPING", ObjItem.getAttribute("DAYS_REQUIRED_FOR_WARPING").getString(), NewRow);
                DataModel.setValueByVariable("EXPECTED_DATE_TO_START_WARPING", EITLERPGLOBAL.formatDate(ObjItem.getAttribute("EXPECTED_DATE_TO_START_WARPING").getString()), NewRow);
                DataModel.setValueByVariable("APPOX_WARP_QUANTITY_REQUIRED", ObjItem.getAttribute("APPOX_WARP_QUANTITY_REQUIRED").getString(), NewRow);
                DataModel.setValueByVariable("DAYS_REQUIRED_TO_MAKE_THIS_WARP_QUANTITY", ObjItem.getAttribute("DAYS_REQUIRED_TO_MAKE_THIS_WARP_QUANTITY").getString(), NewRow);
                DataModel.setValueByVariable("EXPECTED_DATE_TO_START_FOR_WARP_YARN", EITLERPGLOBAL.formatDate(ObjItem.getAttribute("EXPECTED_DATE_TO_START_FOR_WARP_YARN").getString()), NewRow);
            ...
            String DocNo = objDM.getAttribute("LPP_DOC_NO").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsLoomWiseBeamFallPlanning ObjHistory = (clsLoomWiseBeamFallPlanning) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7059, 70591)) {
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7059, 70592)) {
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7059, 70593)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7059, 70595)) {
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("NO OF PIECE"); //1
            DataModel.addColumn("LOOM PICKS");//22
            DataModel.addColumn("WARP TO BE ALLOTED MTS"); //2
            DataModel.addColumn("WARP TO BE ALLOTED LOOM PICKS"); //3
            DataModel.addColumn("TOTAL PICK PENDING"); //4
            DataModel.addColumn("DAY PENDING FOR BEAM FALL"); //4
            DataModel.addColumn("EXPECTED DATE OF BEAM FALL"); //4
            DataModel.addColumn("DAYS REQUIRED FOR WARPING"); //4
            DataModel.addColumn("EXPECTED DATE TO START WARPING"); //4
            DataModel.addColumn("APPOX WARP QUANTITY REQUIRED"); //4
            DataModel.addColumn("DAYS REQUIRED TO MAKE THIS WARP QUANTITY"); //4
            DataModel.addColumn("EXPECTED DATE TO START FOR WARP YARN"); //4
            ...
            DataModel.SetVariable(3, "NO_OF_PIECE"); //1
            DataModel.SetVariable(4, "LOOM_PICKS");//22
            DataModel.SetVariable(5, "WARP_TO_BE_ALLOTED_MTS"); //2
            DataModel.SetVariable(6, "WARP_TO_BE_ALLOTED_LOOM_PICKS"); //3
            DataModel.SetVariable(7, "TOTAL_PICK_PENDING"); //4
            DataModel.SetVariable(8, "DAY_PENDING_FOR_BEAM_FALL"); //4
            DataModel.SetVariable(9, "EXPECTED_DATE_OF_BEAM_FALL"); //4
            DataModel.SetVariable(10, "DAYS_REQUIRED_FOR_WARPING"); //4
            DataModel.SetVariable(11, "EXPECTED_DATE_TO_START_WARPING"); //4
            DataModel.SetVariable(12, "APPOX_WARP_QUANTITY_REQUIRED"); //4
            DataModel.SetVariable(13, "DAYS_REQUIRED_TO_MAKE_THIS_WARP_QUANTITY"); //4
            DataModel.SetVariable(14, "EXPECTED_DATE_TO_START_FOR_WARP_YARN"); //4
            ...
            tblSDML.getColumnModel().getColumn(5).setMaxWidth(180);

            tblSDML.getColumnModel().getColumn(6).setMinWidth(220);
            tblSDML.getColumnModel().getColumn(6).setMaxWidth(220);

            tblSDML.getColumnModel().getColumn(7).setMinWidth(150);
            tblSDML.getColumnModel().getColumn(7).setMaxWidth(150);

            tblSDML.getColumnModel().getColumn(11).setMinWidth(250);
            tblSDML.getColumnModel().getColumn(11).setMaxWidth(250);

            tblSDML.getColumnModel().getColumn(12).setMinWidth(220);
            tblSDML.getColumnModel().getColumn(12).setMaxWidth(220);

            tblSDML.getColumnModel().getColumn(13).setMinWidth(320);
            tblSDML.getColumnModel().getColumn(13).setMaxWidth(320);

            tblSDML.getColumnModel().getColumn(14).setMinWidth(300);
            tblSDML.getColumnModel().getColumn(14).setMaxWidth(300);
    ...
    private void initComponents() {
        ...
        txtDocDate.setBounds(280, 10, 110, 30);
        ...
        jScrollPane3.setBounds(10, 50, 1110, 410);
        ...
        Tab.addTab("Felt Loom Wise Beam Fall, Warping and Warp Preparation Planning", jPanel1);
        ...
        lblTitle.setText("Felt Loom Wise Beam Fall, Warping and Warp Preparation Planning");
    ...
    private void tblSDMLKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblSDMLKeyReleased
        ...
        for (int i = 0; i < tblSDML.getRowCount(); i++) {
            ...
            if(NO_OF_PIECE>0 || WARP_TO_BE_ALLOTED_MTS>0)
            {
...
//            exp.fillData(Table_Diversion, new File("/root/Desktop/DIVERSION_REPORT.xls"));
            exp.fillData(tblSDML, new File("D://LOOM_BEAM_FALL_PLANNING.xls"));
...
//                    JOptionPane.INFORMATION_MESSAGE);
            ...
            exp.fillData(tblSDML, new File(System.getProperty("user.home") + "/Desktop/LOOM_BEAM_FALL_PLANNING.xls"));
            JOptionPane.showMessageDialog(null, "Data saved at "
                    + "'" + System.getProperty("user.home") + "/Desktop/LOOM_BEAM_FALL_PLANNING.xls' or 'D://LOOM_BEAM_FALL_PLANNING.xls' successfully in PC    ", "Message",
                    JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void Add() {
        ...
        try {
            ...
            DataModel.setValueByVariable("PRODUCT_GROUP", "ACNE", 7);
            ...
            DataModel.setValueByVariable("PRODUCT_GROUP", "ACNE", 9);
            ...
            DataModel.setValueByVariable("PRODUCT_GROUP", "HDS", 11);
            ...
            DataModel.setValueByVariable("PRODUCT_GROUP", "MNE", 14);
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.Production.LoomWiseBeamFallPlanning.frmFindLoomWiseBeamFallPlanning", true);
...
//                        "where H.LPP_DOC_NO='"+txtDocNo.getText()+"' AND D.LPP_DOC_NO=H.LPP_DOC_NO";
...
//        }
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) objDM.getAttribute("LPP_DOC_NO").getObj();
    ...
    private void SetData() {
        ...
        objDM.setAttribute("LPP_DOC_NO", txtDocNo.getText());
        objDM.setAttribute("LPP_DOC_DATE", txtDocDate.getText());
        objDM.setAttribute("AS_ON_DATE", txtDocDate.getText());
        ...
        try {
            ...
            for (int i = 0; i <= tblSDML.getRowCount() - 1; i++) {
                ...
                clsLoomWiseBeamFallPlanningDetails objDMDetails = new clsLoomWiseBeamFallPlanningDetails();

                //objobjDMDetails.setAttribute("S_ORDER_DETAIL_CODE","");
                objDMDetails.setAttribute("LPP_DOC_NO", txtDocNo.getText());
                objDMDetails.setAttribute("SR_NO", (i + 1) + "");//SR_NO

                objDMDetails.setAttribute("LPP_DOC_DATE", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("LPP_DOC_DATE", i)) + "");//SR_NO
                objDMDetails.setAttribute("EXPECTED_DATE_OF_BEAM_FALL", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("EXPECTED_DATE_OF_BEAM_FALL", i)) + "");//SR_NO
                objDMDetails.setAttribute("EXPECTED_DATE_TO_START_WARPING", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("EXPECTED_DATE_TO_START_WARPING", i)) + "");//SR_NO
                objDMDetails.setAttribute("EXPECTED_DATE_TO_START_FOR_WARP_YARN", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("EXPECTED_DATE_TO_START_FOR_WARP_YARN", i)) + "");//SR_NO
                ...
                objDMDetails.setAttribute("NO_OF_PIECE", DataModel.getValueByVariable("NO_OF_PIECE", i) + "");//
                objDMDetails.setAttribute("LOOM_PICKS", DataModel.getValueByVariable("LOOM_PICKS", i) + "");//
                objDMDetails.setAttribute("WARP_TO_BE_ALLOTED_MTS", DataModel.getValueByVariable("WARP_TO_BE_ALLOTED_MTS", i) + "");//
                objDMDetails.setAttribute("WARP_TO_BE_ALLOTED_LOOM_PICKS", DataModel.getValueByVariable("WARP_TO_BE_ALLOTED_LOOM_PICKS", i) + "");//
                objDMDetails.setAttribute("TOTAL_PICK_PENDING", DataModel.getValueByVariable("TOTAL_PICK_PENDING", i) + "");//
                objDMDetails.setAttribute("DAY_PENDING_FOR_BEAM_FALL", DataModel.getValueByVariable("DAY_PENDING_FOR_BEAM_FALL", i) + "");//
                objDMDetails.setAttribute("DAYS_REQUIRED_FOR_WARPING", DataModel.getValueByVariable("DAYS_REQUIRED_FOR_WARPING", i) + "");//
                objDMDetails.setAttribute("APPOX_WARP_QUANTITY_REQUIRED", DataModel.getValueByVariable("APPOX_WARP_QUANTITY_REQUIRED", i) + "");//
                objDMDetails.setAttribute("DAYS_REQUIRED_TO_MAKE_THIS_WARP_QUANTITY", DataModel.getValueByVariable("DAYS_REQUIRED_TO_MAKE_THIS_WARP_QUANTITY", i) + "");//
