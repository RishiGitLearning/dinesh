...
public class frmFeltMending_New extends javax.swing.JApplet {

    private int EditMode = 0;
    private int SelHierarchyID = 0; //Selected Hierarchy
    private int lnFromUserId = 0;
    private char feltType = ' ';
    public boolean PENDING_DOCUMENT = false; //for refresh pending document module
    private boolean DoNotEvaluate = false;

    private clsFeltMending ObjFeltMending;
    ...
    public void init() {
        ...
        ObjFeltMending = new clsFeltMending();

        SetMenuForRights();
        GenerateHierarchyCombo();
        GenerateSendToCombo();
        GenerateUserNameCombo();
        if (ObjFeltMending.LoadData()) {
            DisplayData();
        } else {
            JOptionPane.showMessageDialog(this, "Error occured while loading data. Error is " + ObjFeltMending.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        jMenuItemCloth = new javax.swing.JMenuItem();
        ...
        jMenuItemBase.setText("BASE");
        jMenuItemBase.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemBaseActionPerformed(evt);
            }
        });
        jPopupMenu.add(jMenuItemBase);

        jMenuItemCloth.setText("CLOTH");
        jMenuItemCloth.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemClothActionPerformed(evt);
            }
        });
        jPopupMenu.add(jMenuItemCloth);
        ...
        lblTitle.setText(" FELT PRODUCTION MENDING DETAILS - ");
        ...
        Tab.addTab("Mending Details", Tab1);
    ...
    private void cmdOpenDocumentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOpenDocumentActionPerformed
        if (Table.getSelectedRow() != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Select a row from Mending Details.", "WARNING", JOptionPane.INFORMATION_MESSAGE);
        }
    }//GEN-LAST:event_cmdOpenDocumentActionPerformed

    private void jMenuItemClothActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemClothActionPerformed
    ...
    }//GEN-LAST:event_jMenuItemClothActionPerformed

    private void jMenuItemBaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemBaseActionPerformed
        lblType.setText("BASE");
        EditMode = EITLERPGLOBAL.ADD;
        feltType = 'B';
        SetFields(true);
        DisableToolbar();
        ...
        SetupApproval();
        lblTitle.setBackground(Color.GRAY);
    }//GEN-LAST:event_jMenuItemBaseActionPerformed

    private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
        new TReportWriter.TReportEngine().PreviewReport("http://" + EITLERPGLOBAL.HostIP + "/EITLERP/Reports/Production/rptFeltMending.rpt", new HashMap(), ObjFeltMending.getReportData(txtProductionDocumentNo.getText().trim()));
    ...
    private void cmdBackToNormalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdBackToNormalActionPerformed
        ObjFeltMending.HistoryView = false;
        ObjFeltMending.LoadData();
        MoveLast();
    ...
    private void cmdViewRevisionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewRevisionsActionPerformed
        ObjFeltMending.ShowHistory(EITLERPGLOBAL.formatDateDB(txtFeltProductionDate.getText()), txtProductionDocumentNo.getText());
        MoveLast();
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(711, txtProductionDocumentNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
            ...
            if ((EditMode == 1) || (EditMode == 2 && clsHierarchy.IsCreator(EITLERPGLOBAL.gCompanyID, SelHierarchyID, EITLERPGLOBAL.gUserID))) {
                if (Table.getSelectedColumn() == 1) {
                    ...
                    aList.SQL = "SELECT DISTINCT WIP_EXT_PIECE_NO AS PIECE_NO,WIP_PIECE_NO AS PIECE,WIP_PARTY_CODE AS PARTY_CODE,PARTY_NAME,WIP_GROUP AS \"GROUP\","
                            ...
                            + "AND WIP_PIECE_NO IN (SELECT PR_PIECE_NO FROM PRODUCTION.FELT_SALES_PIECE_REGISTER "
                            ...
                            + " WHERE PROD_DEPT='MENDING' AND APPROVED=0 AND COALESCE(CANCELED,0)=0)";
                    aList.ReturnCol = 1;
...
//                            JOptionPane.showMessageDialog(this, "Piece is Under Approval in WIP Piece Amend", "ERROR", JOptionPane.ERROR_MESSAGE);
                            ...
                            try {
                                ...
                                Table.setValueAt(ocYearMonth, Table.getSelectedRow(), 6);
                                ...
                                if (trs.getRow() > 0) {
                                    ...
                                    Table.setValueAt(trs.getString("WIP_GROUP"), Table.getSelectedRow(), 4);
                                    Table.setValueAt(trs.getString("WIP_PRODUCT_CODE"), Table.getSelectedRow(), 7);  //6
                                    Table.setValueAt(trs.getString("WIP_GSM"), Table.getSelectedRow(), 8);  //7
                                    Table.setValueAt(trs.getString("WIP_STYLE"), Table.getSelectedRow(), 9); //8
    ...
    private javax.swing.JMenuItem jMenuItemCloth;
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 711)) {
        ...
        try {
            if (EditMode == 0) {
                if (ObjFeltMending.getAttribute("APPROVED").getInt() == 1) {
                    lblTitle.setBackground(Color.BLUE);
                } else {
                    lblTitle.setBackground(Color.GRAY);
                }

                /*if(ObjFeltMending.getAttribute("CANCELED").getInt()==1) {
                 lblTitle.setBackground(Color.RED);
                 }*/
            }
            //============================================//

            String productionDate = EITLERPGLOBAL.formatDate(ObjFeltMending.getAttribute("PRODUCTION_DATE").getString());
            String documentNo = ObjFeltMending.getAttribute("PRODUCTION_DOCUMENT_NO").getString();
            lblTitle.setText(" FELT PRODUCTION MENDING DETAILS - " + productionDate);
            lblRevNo.setText(Integer.toString((int) ObjFeltMending.getAttribute("REVISION_NO").getVal()));
            txtMonthWeight.setText(Double.toString(EITLERPGLOBAL.round(ObjFeltMending.getAttribute("TOTAL_WEIGHT").getVal(), 2)));
            txtPreviousWeight.setText(Double.toString(EITLERPGLOBAL.round(ObjFeltMending.getAttribute("PREVIOUS_WEIGHT").getVal(), 2)));
            EITLERPGLOBAL.setComboIndex(cmbHierarchy, (int) ObjFeltMending.getAttribute("HIERARCHY_ID").getVal());
            DoNotEvaluate = true;

            FormatGrid();
            txtFeltProductionDate.setText(productionDate);
            txtProductionDocumentNo.setText(documentNo);
            txtFormNo.setText(ObjFeltMending.getAttribute("PRODUCTION_FORM_NO").getString());

            //Now Generate Table
            for (int i = 1; i <= ObjFeltMending.hmFeltMendingDetails.size(); i++) {
                clsFeltMendingDetails ObjFeltMendingDetails = (clsFeltMendingDetails) ObjFeltMending.hmFeltMendingDetails.get(Integer.toString(i));

                Object[] rowData = new Object[10];
                rowData[0] = Integer.toString(i);
                String PieceNo=ObjFeltMendingDetails.getAttribute("PRODUCTION_PIECE_NO").getString();
                rowData[1] = ObjFeltMendingDetails.getAttribute("PRODUCTION_PIECE_NO").getString();
                rowData[2] = ObjFeltMendingDetails.getAttribute("PRODUCTION_PARTY_CODE").getString();
                rowData[3] = Double.toString(EITLERPGLOBAL.round(ObjFeltMendingDetails.getAttribute("WEIGHT").getVal(), 2));
                rowData[4] = ObjFeltMendingDetails.getAttribute("GROUP").getString();
                rowData[5] = ObjFeltMendingDetails.getAttribute("REMARKS").getString();
                
                String ocYearMonth=data.getStringValueFromDB("SELECT WIP_OC_MONTHYEAR FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='"+PieceNo+"'");
                rowData[6] = ocYearMonth;
                
                rowData[7] = data.getStringValueFromDB("SELECT WIP_PRODUCT_CODE FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltMendingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'"); //6
                rowData[8] = data.getStringValueFromDB("SELECT WIP_GSM FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltMendingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");  //7
                rowData[9] = data.getStringValueFromDB("SELECT WIP_STYLE FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + ObjFeltMendingDetails.getAttribute("PRODUCTION_PIECE_NO").getString() + "'");  //8
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(711, documentNo);
            ...
            FormatGridUpdateHistory();
            HashMap hmApprovalHistory = clsFeltMending.getHistoryList(ObjFeltMending.getAttribute("PRODUCTION_DATE").getString(), txtProductionDocumentNo.getText());
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltMending ObjFeltMending = (clsFeltMending) hmApprovalHistory.get(Integer.toString(i));
                Object[] rowData = new Object[6];

                rowData[0] = Integer.toString((int) ObjFeltMending.getAttribute("REVISION_NO").getVal());
                rowData[1] = FeltUser.getUserName((int) ObjFeltMending.getAttribute("UPDATED_BY").getVal());
                rowData[2] = EITLERPGLOBAL.formatDate(ObjFeltMending.getAttribute("ENTRY_DATE").getString()) + ObjFeltMending.getAttribute("ENTRY_DATE").getString().substring(10, 19);

                String ApprovalStatus = "";

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("H")) {
                    ApprovalStatus = "Hold";
                }

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("A")) {
                    ApprovalStatus = "Approved";
                }

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("F")) {
                    ApprovalStatus = "Final Approved";
                }

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("W")) {
                    ApprovalStatus = "Waiting";
                }

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("R")) {
                    ApprovalStatus = "Rejected";
                }

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("P")) {
                    ApprovalStatus = "Pending";
                }

                if ((ObjFeltMending.getAttribute("APPROVAL_STATUS").getString()).equals("C")) {
                    ApprovalStatus = "Skiped";
                }

                rowData[3] = ApprovalStatus;
                rowData[4] = ObjFeltMending.getAttribute("APPROVER_REMARKS").getString();
                rowData[5] = ObjFeltMending.getAttribute("FROM_IP").getString();
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=711 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=711 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(711, ObjFeltMending.getAttribute("PRODUCTION_DOCUMENT_NO").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(711, txtProductionDocumentNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(711, txtProductionDocumentNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(711, txtProductionDocumentNo.getText());
    ...
    private void GenerateUserNameCombo() {
        ...
        hmUserNameList = ObjFeltMending.getUserNameList(EITLERPGLOBAL.getComboCode(cmbHierarchy), EITLERPGLOBAL.gNewUserID, "MENDING");
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(711, ObjFeltMending.getAttribute("PRODUCTION_DOCUMENT_NO").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(711, FromUserID, ObjFeltMending.getAttribute("PRODUCTION_DOCUMENT_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(711, txtProductionDocumentNo.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6074, 60741)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6074, 60742)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6074, 60743)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6074, 60745)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Edit() {
        String productionDocumentNo = (String) ObjFeltMending.getAttribute("PRODUCTION_DOCUMENT_NO").getObj();
        if (ObjFeltMending.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(711, productionDocumentNo)) {
                SetFields(true);
                txtFeltProductionDate.setEnabled(false);
                txtFormNo.setEnabled(false);
            } else {
    ...
    private void Delete() {
        if (ObjFeltMending.CanDelete(txtProductionDocumentNo.getText(), txtFeltProductionDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            DisplayData();
        } else {
            JOptionPane.showMessageDialog(this, ObjFeltMending.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Save() {
        ...
        productionDocumentNo = "FM" + feltType + productionDate.substring(6, 10) + productionDate.substring(3, 5) + productionDate.substring(0, 2);
        if (EditMode == EITLERPGLOBAL.EDIT) {
            productionDocumentNo = ObjFeltMending.getAttribute("PRODUCTION_DOCUMENT_NO").getString();
        }

        // CHECK Document No already exist in database?
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltMending.checkProductionDocumentNoInDB(productionDocumentNo)) {
                JOptionPane.showMessageDialog(frmFeltMending_New.this, "Production Date " + productionDate + " is Already Exists", "Production Date Already Exists", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (Table.getRowCount() <= 0) {
            JOptionPane.showMessageDialog(this, "Enter Mending Details Before Saving.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            for (int k = 0; k <= Table.getRowCount() - 1; k++) {
                ...
                String piece1 = Table.getValueAt(k, 1).toString().trim().toUpperCase();
                piece1 = piece1.replace("R", "");
                String piece1Pref="";
                String piece1Suf="";
                if(piece1.contains("-")){
                    boolean exist=false;
                    int iend = piece1.indexOf("-");
                    if (iend != -1) {
                         piece1Pref= piece1.substring(0, iend); 
                    }                    
                    piece1Suf=piece1.substring(piece1.lastIndexOf("-") + 1);                    
                    if(piece1Suf.equals("A")){
                        for (int l = 0; l <= Table.getRowCount() - 1; l++) {
                            String piece2 =Table.getValueAt(l, 1).toString().trim().toUpperCase();
                            piece2 = piece2.replace("R", "");
                            if(l!= k && piece2.contains("-")){
                                String piece2Pref = "", piece2Suf = "";
                                piece2Pref = piece2.substring(0, iend);
                                piece2Suf = piece2.substring(piece2.lastIndexOf("-") + 1);
                                if (piece1Pref.equals(piece2Pref)) {
                                    if (piece2Suf.equals("B")) {
                                        exist=true;
                                    } 
                                    //else {
                                    //    JOptionPane.showMessageDialog(this, "Piece No "+piece1+" at Row " + (k + 1) + " does not have Piece with prefix B  ", "ERROR", JOptionPane.ERROR_MESSAGE);
                                    //    return;
                                    //}
                                }                                
                            }                           
                    ...
                    if(piece1Pref.equals("43195R") || piece1Pref.equals("43195") || piece1Pref.equals("42624") || piece1Pref.equals("42416R") || piece1Pref.equals("42634R") || piece1Pref.equals("43432") || piece1Pref.equals("41252") || piece1Pref.equals("43241") || piece1Pref.equals("43242") || piece1Pref.equals("43243")){
                       exist=true;                        
                    }
                    if(!exist){
                           JOptionPane.showMessageDialog(this, "Piece No "+piece1+" at Row " + (k + 1) + " does not have another Piece with suffix A or B", "ERROR", JOptionPane.ERROR_MESSAGE);
                           return; 
                    }
                }
            ...
            ObjFeltMending.hmFeltMendingDetails.clear();
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                group = ((String) Table.getValueAt(i, 4)).trim();
                if (group == "" || group == null) {
                    JOptionPane.showMessageDialog(this, "Enter Group.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                j = 0;
                remarks = ((String) Table.getValueAt(i, 5)).trim();

                // check piece no already mended?
                if (EditMode == EITLERPGLOBAL.ADD) {
                    if (ObjFeltMending.checkPieceNoInDB(pieceNo)) {
                        JOptionPane.showMessageDialog(frmFeltMending_New.this, "Piece No." + pieceNo + " Already Mended.", " Piece No Already Exists", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                ...
                if (EditMode == EITLERPGLOBAL.EDIT) {
                    if (ObjFeltMending.checkPieceNoInDB(pieceNo, productionDate)) {
                        JOptionPane.showMessageDialog(frmFeltMending_New.this, "Piece No." + pieceNo + " Already Mended.", " Piece No Already Exists", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }

                String machineNo = data.getStringValueFromDB("SELECT PR_WIP_MACHINE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER  WHERE PR_WIP_EXT_PIECE_NO='" + pieceNo + "' ");
                String positionNo = data.getStringValueFromDB("SELECT PR_WIP_POSITION_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER  WHERE PR_WIP_EXT_PIECE_NO='" + pieceNo + "' ");
                ...
                ObjFeltMendingDetails.setAttribute("PRODUCTION_PIECE_NO", pieceNo);
                ObjFeltMendingDetails.setAttribute("PRODUCTION_PARTY_CODE", partyCode);
                ObjFeltMendingDetails.setAttribute("WEIGHT", weight);
                ObjFeltMendingDetails.setAttribute("GROUP", group);
                ObjFeltMendingDetails.setAttribute("REMARKS", remarks);

                ObjFeltMending.hmFeltMendingDetails.put(Integer.toString(ObjFeltMending.hmFeltMendingDetails.size() + 1), ObjFeltMendingDetails);
            }
        ...
        ObjFeltMending.setAttribute("PRODUCTION_DATE", productionDate);
        ObjFeltMending.setAttribute("PRODUCTION_DOCUMENT_NO", productionDocumentNo);
        ObjFeltMending.setAttribute("PRODUCTION_FORM_NO", formNo);
        SetData();
        lblType.setText("");

        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltMending.Insert()) {
                DisplayData();
            } else {
                JOptionPane.showMessageDialog(this, "Error occured while saving. Error is " + ObjFeltMending.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }

        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltMending.Update()) {
                DisplayData();
            } else {
                JOptionPane.showMessageDialog(this, "Error occured while saving editing. Error is " + ObjFeltMending.LastError, "ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void SetData() {
        ...
        ObjFeltMending.setAttribute("HIERARCHY_ID", EITLERPGLOBAL.getComboCode(cmbHierarchy));
        ObjFeltMending.setAttribute("FROM", EITLERPGLOBAL.gNewUserID);
        ObjFeltMending.setAttribute("TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        ObjFeltMending.setAttribute("FROM_REMARKS", txtToRemarks.getText().trim());
        ObjFeltMending.setAttribute("UPDATED_BY", EITLERPGLOBAL.getComboCode(cmbUserName));

        if (OpgApprove.isSelected()) {
            ObjFeltMending.setAttribute("APPROVAL_STATUS", "A");
        }

        if (OpgFinal.isSelected()) {
            ObjFeltMending.setAttribute("APPROVAL_STATUS", "F");
        }

        if (OpgReject.isSelected()) {
            ObjFeltMending.setAttribute("APPROVAL_STATUS", "R");
            ObjFeltMending.setAttribute("SEND_DOC_TO", EITLERPGLOBAL.getComboCode(cmbSendTo));
        }

        if (OpgHold.isSelected()) {
            ObjFeltMending.setAttribute("APPROVAL_STATUS", "H");
        }
        //-------------------------------------------------//

        if (EditMode == EITLERPGLOBAL.ADD) {
            ObjFeltMending.setAttribute("CREATED_BY", EITLERPGLOBAL.gNewUserID);
        } else {
            ObjFeltMending.setAttribute("CREATED_BY", (int) ObjFeltMending.getAttribute("CREATED_BY").getVal());
            ObjFeltMending.setAttribute("CREATED_DATE", ObjFeltMending.getAttribute("CREATED_DATE").getString());
            ObjFeltMending.setAttribute("MODIFIED_BY", EITLERPGLOBAL.gNewUserID);
        }
    }
    ...
    private void Find() {
        ...
        if (ObjFindFeltMending.Cancelled == false) {
            if (!ObjFeltMending.Filter(ObjFindFeltMending.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltMending_New.this, " No records found.", "Find Felt Mending Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void Find(String docNo) {
        ObjFeltMending.Filter("AND PROD_DOC_NO='" + docNo + "'");
        SetMenuForRights();
        DisplayData();
    }
    ...
    public void Find(String pieceNo, String prodDate) {
        ObjFeltMending.Filter("AND PROD_PIECE_NO='" + pieceNo + "'");
        SetMenuForRights();
        DisplayData();
    }
    ...
    public void FindWaiting() {
        ObjFeltMending.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=711 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }

    private void MoveFirst() {
        ObjFeltMending.MoveFirst();
        DisplayData();
    }

    private void MovePrevious() {
        ObjFeltMending.MovePrevious();
        DisplayData();
    }

    private void MoveNext() {
        ObjFeltMending.MoveNext();
        DisplayData();
    }

    private void MoveLast() {
        ObjFeltMending.MoveLast();
        DisplayData();
    }
