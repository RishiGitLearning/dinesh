...
public class EITLTableCellRenderer_New extends DefaultTableCellRenderer  {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,boolean isSelected, boolean hasFocus,int row, int column) {
        ...
        if(getCustomComponent(column).equals("Cell")) {
            ...
            cell.setBackground(getBackColor(String.valueOf(row),String.valueOf(column)));
            return cell;
        }
    ...
    public EITLTableCellRenderer_New() {
    }
    ...
    public void setForeColor(String row,String col,Color pColor) {
        Dimension theCell=new Dimension(Integer.parseInt(col),Integer.parseInt(row));
        String theKey="0000"+row+"0000"+col;
        colCellForeColor.put(theKey,pColor);
    }
    ...
    public void setBackColor(String row,String col,Color pColor) {
        Dimension theCell=new Dimension(Integer.parseInt(col),Integer.parseInt(row));
        String theKey="0000"+row+"0000"+col;
        colCellBackColor.put(theKey,pColor);
    }
    ...
    public Color getForeColor(String row,String col) {
        Dimension theCell=new Dimension(Integer.parseInt(col),Integer.parseInt(row));
...
public Color getBackColor(String row,String col) {
        Dimension theCell=new Dimension(Integer.parseInt(col),Integer.parseInt(row));
