...
public class frmHierarchyFeltSalesFind extends javax.swing.JApplet {
   ...
   String strCondition="";
        ...
        List=ObjUser.getList(" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND DEPT_ID=29 ");
        for(int i=1;i<=List.size();i++) {
