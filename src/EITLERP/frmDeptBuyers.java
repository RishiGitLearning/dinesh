...
public class frmDeptBuyers extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("DEPARTMENTWISE BUYERS ENTRY");
        jPanel1.add(jLabel1);
        ...
        jPanel2.add(jLabel2);
        jLabel2.setBounds(4, 18, 91, 15);
        
        jPanel2.add(cmbBuyer);
        cmbBuyer.setBounds(93, 47, 278, 24);
        
        jLabel3.setText("Buyer");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(4, 52, 91, 15);
        
        jPanel2.add(cmbDept);
        cmbDept.setBounds(92, 13, 278, 24);
    ...
    private void cmdRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRemoveActionPerformed
        ...
        if(Table.getRowCount()>0&&Table.getSelectedRow()>=0)
        {
           if(JOptionPane.showConfirmDialog(null,"Are you sure you wat to delete selected record ?","Confirmation",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) 
           {
             ...
             clsDeptBuyers.Delete(EITLERPGLOBAL.gCompanyID,SrNo);
             GenerateGrid();
           }
        }
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        ObjItem.setAttribute("DEPT_ID",EITLERPGLOBAL.getComboCode(cmbDept));
        ObjItem.setAttribute("BUYER",EITLERPGLOBAL.getComboCode(cmbBuyer));
        
        if(clsDeptBuyers.Insert(ObjItem)) {
            GenerateGrid();
        }
        else {
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Dept ID"); //1
        DataModel.addColumn("Department Name"); //2
        DataModel.addColumn("Buyer ID"); //3
    ...
    private void GenerateGrid() {
        ...
        List=clsDeptBuyers.getList();
        
        for(int i=1;i<=List.size();i++) {
            clsDeptBuyers ObjItem=(clsDeptBuyers)List.get(Integer.toString(i));
            Object[] rowData=new Object[5];
            
            rowData[0]=Integer.toString((int)ObjItem.getAttribute("SR_NO").getVal());
            rowData[1]=Integer.toString((int)ObjItem.getAttribute("DEPT_ID").getVal());
            rowData[2]=clsDepartment.getDeptName(EITLERPGLOBAL.gCompanyID,(int)ObjItem.getAttribute("DEPT_ID").getVal());
            rowData[3]=Integer.toString((int)ObjItem.getAttribute("BUYER").getVal());
            rowData[4]=clsUser.getUserName(EITLERPGLOBAL.gCompanyID,(int)ObjItem.getAttribute("BUYER").getVal());
    ...
    private void GenerateCombo()
    {
      ...
      for(int i=1;i<=List.size();i++)
      {
        clsDepartment ObjItem=(clsDepartment)List.get(Integer.toString(i));
        
        ComboData aData=new ComboData();
        aData.Code=(int)ObjItem.getAttribute("DEPT_ID").getVal();
        aData.Text=(String)ObjItem.getAttribute("DEPT_DESC").getObj();
