...
public class clsDocMailer {
    ...
    public long Insert() {
        try {
            ...
            Statement stHeader=tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            Statement stEMail=tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            ...
            long MaxNo=data.getMaxID(EITLERPGLOBAL.gCompanyID, "D_COM_MAIL", "DOC_NO")+1;
            ...
            for(int i=1;i<=colEmail.size();i++) {
                ...
                rsEMail.updateInt("COMPANY_ID",EITLERPGLOBAL.gCompanyID);
