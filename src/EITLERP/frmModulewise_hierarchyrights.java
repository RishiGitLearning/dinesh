...
public class frmModulewise_hierarchyrights extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmdClearSelection.setBounds(125, 371, 150, 25);

        jLabel1.setText("For mulitiple selection Hold CTRL key.....");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 400, 300, 15);

        jLabel2.setText("Department ");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 20, 100, 15);
        ...
        jButton1.setBounds(21, 371, 96, 25);
        ...
        cmdPrint.setBounds(50, 440, 88, 25);
    ...
    private void GenerateList() {
        ...
        //String Condition = " WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+"   AND MODULE_ID IN (SELECT MODULE_ID FROM D_COM_DEPT_MODULES WHERE DEPT_ID = "+ EITLERPGLOBAL.getComboCode(cmbDepartment) +"  )";
        String Condition = " WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " ORDER BY MODULE_DESC"; 
    ...
    private void PreviewReport() {
        ...
        try {
            String DeptName = clsDepartment.getDeptName(EITLERPGLOBAL.gCompanyID,EITLERPGLOBAL.getComboCode(cmbDepartment));
            URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptmodulewise_hierarchyrights.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+qry+"&DeptName="+DeptName);
            System.out.println("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptmodulewise_hierarchyrights.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&DocNo="+qry+"&DeptName="+DeptName);
    ...
    private void GenerateCombo() {
        ...
        //List=clsDepartment.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND DEPT_ID IN (SELECT DEPT_ID FROM D_COM_USER_MASTER WHERE USER_ID = "+9+" )");
        System.out.println("User ID=" + EITLERPGLOBAL.gUserID);
        if(EITLERPGLOBAL.gUserID == 1 || EITLERPGLOBAL.gUserID == 11) {
            List=clsDepartment.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" ");
        }
        else {
            List=clsDepartment.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND DEPT_ID IN (SELECT DEPT_ID FROM D_COM_USER_MASTER WHERE USER_ID = "+EITLERPGLOBAL.gUserID+" )");
        }
