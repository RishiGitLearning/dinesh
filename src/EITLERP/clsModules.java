...
public class clsModules {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            strSql = "SELECT * FROM D_COM_MODULES WHERE COMPANY_ID="+Integer.toString(EITLERPGLOBAL.gCompanyID)+" ORDER BY MODULE_ID";
    ...
    public static HashMap getList(String pCondition) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM D_COM_MODULES "+pCondition);
            rsTmp.first();
            Counter=0;
    ...
    public static String getModuleName(long pCompanyID,long pModuleID) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT MODULE_DESC FROM D_COM_MODULES WHERE COMPANY_ID="+Long.toString(pCompanyID)+" AND MODULE_ID="+Long.toString(pModuleID));
            rsTmp.first();
    ...
    public static String getHeaderTableName(long pCompanyID,long pModuleID) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT HEADER_TABLE_NAME FROM D_COM_MODULES WHERE COMPANY_ID="+Long.toString(pCompanyID)+" AND MODULE_ID="+Long.toString(pModuleID));
            rsTmp.first();
    ...
    public static String getDocNoFieldName(long pCompanyID,long pModuleID) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT DOC_NO_FIELD FROM D_COM_MODULES WHERE COMPANY_ID="+Long.toString(pCompanyID)+" AND MODULE_ID="+Long.toString(pModuleID));
            rsTmp.first();
    ...
    public static String getDocDateFieldName(long pCompanyID,long pModuleID) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT DOC_DATE_FIELD FROM D_COM_MODULES WHERE COMPANY_ID="+Long.toString(pCompanyID)+" AND MODULE_ID="+Long.toString(pModuleID));
            rsTmp.first();
