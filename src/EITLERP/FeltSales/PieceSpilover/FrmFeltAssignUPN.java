 ...
 *
 */
public class FrmFeltAssignUPN extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private int ModuleId = 807;
    private String DOC_NO = "";
    private clsFeltAssignUPN feltOrder;
    private EITLComboModel cmbSendToModel;
    private TReportEngine objEngine = new TReportEngine();
    private frmFindFeltAssignUPN ObjFindFeltorder;
    ...
    public void init() {
        ...
        feltOrder = new clsFeltAssignUPN();
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText("Felt Sales Assign UPN to Spilover Piece - " + feltOrder.getAttribute("DOC_NO").getString());
            txtDocDate.setText(EITLERPGLOBAL.formatDate(feltOrder.getAttribute("DOC_DATE").getString()));
            txtForMonth.setText(feltOrder.getAttribute("FOR_MONTH").getString());
            ...
            for (int i = 1; i <= feltOrder.hmFeltSalesOrderDetails.size(); i++) {
                clsFeltAssignUPNDetails ObjItem = (clsFeltAssignUPNDetails) feltOrder.hmFeltSalesOrderDetails.get(Integer.toString(i));
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsFeltAssignUPN ObjHistory = (clsFeltAssignUPN) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6245, 62451)) { //7008,70081
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6245, 62452)) { //7008,70082
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6245, 62453)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6245, 62455)) {
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Style"); //9
            DataModel.addColumn("DIVISION POSSIBILITY"); //10
            DataModel.addColumn("UPN1"); //11
            ...
            DataModel.SetVariable(11, "UPN1"); //4
            DataModel.SetVariable(12, "UPN2"); //5
            DataModel.SetVariable(13, "UPN3"); //6
            DataModel.SetVariable(14, "UPN4"); //7
            DataModel.SetVariable(15, "UPN5"); //8
            DataModel.SetVariable(16, "UPN6"); //9
            DataModel.SetVariable(17, "UPN7"); //10
            DataModel.SetVariable(18, "UPN8"); //11
            DataModel.SetVariable(19, "UPN9"); //12
            DataModel.SetVariable(20, "UPN10"); //13
            DataModel.SetVariable(21, "UPN11"); //14
            DataModel.SetVariable(22, "UPN12"); //15
            DataModel.SetVariable(23, "UPN13"); //16
            DataModel.SetVariable(24, "UPN14"); //17
            DataModel.SetVariable(25, "UPN15"); //18
            DataModel.SetVariable(26, "UPN16"); //19
            DataModel.SetVariable(27, "UPN17"); //20
            DataModel.SetVariable(28, "UPN18"); //21
            DataModel.SetVariable(29, "UPN19"); //22
            DataModel.SetVariable(30, "UPN20"); //22
...
//        tcm.getColumn(5).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        txtForMonth = new javax.swing.JTextField();
        ...
        jScrollPane1.setBounds(10, 91, 910, 400);
        ...
        jLabel1.setText("For Month ");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(550, 10, 110, 30);

        txtForMonth.setEnabled(false);
        jPanel1.add(txtForMonth);
        txtForMonth.setBounds(630, 10, 160, 30);
        ...
        jPanel1.add(file1);
        file1.setBounds(390, 100, 517, 326);
...
//        }
    ...
    private void Add() {
        ...
        lblTitle.setText("Felt Sales Order - " + txtDocNo.getText());
        
    }

    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.PieceSpilover.frmFindFeltAssignUPN", true);
...
//                if(!UPN1.equals(""))
//                {
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN1+"',1,6) AND  coalesce(PARTY_MILL_CLOSED_IND,0)=0");
...
//                if(!UPN2.equals(""))
//                {
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN2+"',1,6) AND  coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN3.equals(""))
//                {
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN3+"',1,6) AND  coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN4.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN4+"',1,6) AND  coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN5.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN5+"',1,6) AND  coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN6.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN6+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN7.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN7+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN8.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN8+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN9.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN9+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN10.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN10+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN11.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN11+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN12.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN12+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN13.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN13+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN14.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN14+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN15.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN15+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN16.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN16+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN17.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN17+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN18.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN18+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN19.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN19+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                if(!UPN20.equals(""))
//                { 
//                   String ActiveParty=data.getStringValueFromDB("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE=substr('"+UPN20+"',1,6)   AND coalesce(PARTY_MILL_CLOSED_IND,0)=0");
//                   if(ActiveParty.equals(""))
//                   {
...
//                }
    ...
    private void Edit() {
        ...
        if (feltOrder.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(807, productionDocumentNo)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void SetData() {
        ...
        feltOrder.setAttribute("FOR_MONTH", txtForMonth.getText());
        ...
        try {
            ...
            for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                if (!DataModel.getValueByVariable("PIECE_NO", i).equals("")) {
                    clsFeltAssignUPNDetails objFeltOrderDetails = new clsFeltAssignUPNDetails();
    ...
    private javax.swing.JTextField txtForMonth;
