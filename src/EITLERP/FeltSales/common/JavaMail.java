...
public class JavaMail {
    public static void SendMail(String to, String pMessage, String pSubject, String cc)
        ...
        PHPMail mail = new PHPMail();
                    
        System.out.println("SEND TO : "+pSubject);
        
        //mail.to_mailid = "sdmlerp@dineshmills.com";
        mail.to_mailid = to;
        mail.subject = pSubject;
        if(pMessage.contains("This is an auto-generated email"))
        {
            pMessage = pMessage.replace("This is an auto-generated email", "This is an auto-generated email using SDML ERP SERVER");
        }
        else
        {
            pMessage = pMessage + "<br><br><br><br>**** This is an auto-generated email using SDML ERP SERVER, please do not reply ****";    
        }
        mail.message = pMessage;
        mail.cc = cc;
        
        mail.SendMail_usingPHP();
    }
    
    public static void SendMailwithAttachment(String to, String pMessage, String pSubject, String cc,String file_path,String file_name)
            throws Exception {
        ...
        mail.message = pMessage;
        mail.cc = cc;
        //mail.attachment_name = "/root/Desktop/proforma.pdf";
        //mail.attachment_path = "proforma.pdf";
        mail.attachment_name = file_name;
        mail.attachment_path = file_path;
        System.out.println("Mail Path : "+mail.attachment_path);
        String output = mail.SendMail_usingPHP();
        System.out.println("RESPONSE : "+output);
        /*
        String from = "sdmlerp@dineshmills.com";
        String Password = "Sdml@390020";
//        String Password = "sdml390020";
           ...
           pMessage = pMessage + "<br><br>";
            ...
            if(MODULE_ID == 707)
            {
                ...
                try {
                        ...
                        if (rsData1.getRow() > 0) {
                            while (!rsData1.isAfterLast()){
                                ...
                                pMessage = pMessage + ""
                                    ...
                                    + "<td align='center'> "+rsData1.getDouble("PICK")+" </td>"
                                    + "<td align='center'> "+rsData1.getDouble("PICKMTR")+" </td>"
                                    + "<td align='center'> "+rsData1.getString("REMARKS")+" </td>"
                    ...
                    pMessage = pMessage + "<table border='1'>"
                            + "<tr>"
                            + "<th align='center'> DAY WEIGHT </th>"
                            + "<th align='center'> DAY PICK</th>"
                            + "<th align='center'> DAY PICK MTR </th>"
                            + "</tr>";
                    pMessage = pMessage + ""
                            + "<tr>"
                            + "<td align='center'>" + data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'WEAVING' AND PROD_DOC_NO='" + DOC_NO + "'") + "</td>"
                            + "<td align='center'> " + data.getDoubleValueFromDB("SELECT SUM(PICK) FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'WEAVING' AND PROD_DOC_NO='" + DOC_NO + "'") + " </td>"
                            + "<td align='center'> " + data.getDoubleValueFromDB("SELECT SUM(PICKMTR) FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'WEAVING' AND PROD_DOC_NO='" + DOC_NO + "'") + " </td>"
                            + "</tr></table>";
                    
                    pMessage = pMessage + "<br>";
                    pMessage = pMessage + "<table border='1'>"
                            + "<tr>"
                            + "<th align='center'> MONTH WEIGHT </th>"
                            + "<th align='center'> MONTH PICK</th>"
                            + "<th align='center'> MONTH PICK MTR </th>"
                            + "</tr>";
                    pMessage = pMessage + ""
                            + "<tr>"
                            + "<td align='center'>" + data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'WEAVING' AND MONTH(PROD_DATE)=MONTH('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND YEAR(PROD_DATE)=YEAR('"+EITLERPGLOBAL.formatDateDB(DOC_DATE)+"') AND APPROVED=1") + "</td>"
                            + "<td align='center'> " + data.getDoubleValueFromDB("SELECT ROUND(SUM(PICK),2) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'WEAVING' AND MONTH(PROD_DATE)=MONTH('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND YEAR(PROD_DATE)=YEAR('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND APPROVED=1;") + " </td>"
                            + "<td align='center'> " + data.getDoubleValueFromDB("SELECT ROUND(SUM(PICKMTR),2) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'WEAVING' AND MONTH(PROD_DATE)=MONTH('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND YEAR(PROD_DATE)=YEAR('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND APPROVED=1") + " </td>"
                            + "</tr></table>";
            ...
            if(MODULE_ID == 710)
            {
                ...
                try {                    
                    ...
                    pMessage = pMessage + ""
                            + "<tr>"
                            + "<td align='center'>" + data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.FELT_PROD_DATA WHERE PROD_DEPT = 'NEEDLING' AND PROD_DOC_NO='" + DOC_NO + "'") + "</td>"
                            + "</tr></table>";
                    ...
                    pMessage = pMessage + ""
                            + "<tr>"
                            + "<td align='center'>" + data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.`FELT_PROD_DATA` WHERE PROD_DEPT = 'NEEDLING' AND MONTH(PROD_DATE)=MONTH('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND YEAR(PROD_DATE)=YEAR('" + EITLERPGLOBAL.formatDateDB(DOC_DATE) + "') AND APPROVED=1") + "</td>"                            
                            + "</tr></table>";
...
//                }
                ...
                recievers = recievers+ "," + "vdshanbhag@dineshmills.com,atulshah@dineshmills.com,sunil@dineshmills.com,hcpatel@dineshmills.com,mva@dineshmills.com,aditya@dineshmills.com";
...
//                pMessage = pMessage + "</table></body></html>";
            ...
            if(MODULE_ID==754){
                ...
                //Remove manoj@dineshmills.com by Dharmendra on 17-05-2019
                recievers = recievers+ "," + "vdshanbhag@dineshmills.com,atulshah@dineshmills.com,sunil@dineshmills.com,aditya@dineshmills.com";
...
//                pMessage = pMessage + "ashutosh@dineshmills.com<br>"; 
            ...
            if (MODULE_ID == 72 || MODULE_ID==149) {
                ...
                //Remove manoj@dineshmills.com by Dharmendra on 17-05-2019
                recievers = recievers +"," + "vdshanbhag@dineshmills.com,atulshah@dineshmills.com,aditya@dineshmills.com";
...
//                pMessage = pMessage + "ashutosh@dineshmills.com<br>"; 
            ...
            if(MODULE_ID==740){
                ...
                //New notification send to excise and audit  on 15/05/2019 by Dharmendra
                recievers = recievers+ "," + "vdshanbhag@dineshmills.com,atulshah@dineshmills.com,excise@dineshmills.com,bansi_audit@dineshmills.com";
                pMessage = pMessage + "vdshanbhag@dineshmills.com<br>";                
                //pMessage = pMessage + "manoj@dineshmills.com<br>"; 
                pMessage = pMessage + "atulshah@dineshmills.com<br>";
                pMessage = pMessage + "excise@dineshmills.com<br>";
                pMessage = pMessage + "bansi_audit@dineshmills.com<br>";
...
//                pMessage = pMessage + "</table></body></html>";
            ...
            {
                recievers = recievers + "," + "brdfltdesign@dineshmills.com,abhishekyadav@dineshmills.com";
                pMessage = pMessage + "<br>" + "brdfltdesign@dineshmills.com";
                pMessage = pMessage + "<br>" + "abhishekyadav@dineshmills.com";
            }
            if (MODULE_ID == 604) {
                if (!"".equals(clsUser.getExternalEMail(EITLERPGLOBAL.gCompanyID, 57))) {
                    recievers = recievers + "," + clsUser.getExternalEMail(EITLERPGLOBAL.gCompanyID, 57);
                ...
                recievers = recievers + ",ketan_audit@dineshmills.com,excise@dineshmills.com";
                pMessage = pMessage + "<br>ketan_audit@dineshmills.com<br>excise@dineshmills.com";
            }
            if (MODULE_ID == 712) {
                if (!"".equals(clsUser.getExternalEMail(EITLERPGLOBAL.gCompanyID, 60))) {
                    recievers = recievers + "," + clsUser.getExternalEMail(EITLERPGLOBAL.gCompanyID, 60);
    ...
    public static void SendMailFeltOC(String to, String pMessage, String pSubject, String cc) throws Exception {
        ...
        mail.SendMailFeltOC_usingPHP();
    }
    public static void SendMailFeltOA(String to, String pMessage, String pSubject, String cc) throws Exception {
        ...
        mail.SendMailFeltOA_usingPHP();
    }
    
    public static void SendMailwithAttachment_Felts(String to, String pMessage, String pSubject, String cc,String file_path,String file_name) throws Exception {
        ...
        mail.attachment_name = file_name;
        mail.attachment_path = file_path;
        String output = mail.SendMailFelts_usingPHP();
        System.out.println("RESPONSE : "+output);
    }
    
    public static void SendMail_Felts(String to, String pMessage, String pSubject, String cc) throws Exception {
