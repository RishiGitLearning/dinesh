 ...
 * @author root
 */
public class clsDocSalesOrderPOAttachment {
    ...
    public void saveDocumentFile(int length) {
        try {
            ...
            PreparedStatement statement = data.getConn().prepareStatement("INSERT INTO DOC_MGMT.SALES_ORDER_PO_ATTACHMENT "
    ...
    public ArrayList<clsDocSalesOrderPOAttachment> getStatus(String DOC_NO) {
        ArrayList<clsDocSalesOrderPOAttachment> dataList = new ArrayList<clsDocSalesOrderPOAttachment>();
        try {
            ResultSet rs;
            rs = data.getResult("SELECT * FROM DOC_MGMT.SALES_ORDER_PO_ATTACHMENT where DOCUMENT_DOC_NO='" + DOC_NO + "'");
