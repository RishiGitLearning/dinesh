 ...
 */
package EITLERP.FeltSales.common.DatePicker;
...
public class DateTextFieldAdvanceSearch extends JTextField {
    ...
    public DateTextFieldAdvanceSearch() {
        this(new Date());
    }

    public DateTextFieldAdvanceSearch(String dateFormatPattern, Date date) {
        this(date);
        DEFAULT_DATE_FORMAT = dateFormatPattern;
    }

    public DateTextFieldAdvanceSearch(Date date) {
        setDate(date);
        setEditable(false);
    ...
    public void showDateDialog(DatePanel dateChooser, Point position) {
        Frame owner = (Frame) SwingUtilities
                .getWindowAncestor(DateTextFieldAdvanceSearch.this);
