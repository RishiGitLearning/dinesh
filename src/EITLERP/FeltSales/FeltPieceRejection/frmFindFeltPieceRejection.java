...
public class frmFindFeltPieceRejection extends javax.swing.JApplet {
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!amendDate.equals("")) {
            stringFindQuery=stringFindQuery+" FELT_AMEND_DATE='"+EITLERPGLOBAL.formatDateDB(amendDate)+"' ";
        }
        
        if(!pieceNo.equals("")) {
            stringFindQuery=stringFindQuery+" FELT_AMEND_PIECE_NO+0 ='"+ pieceNo +"'";
        }
        
        if(!amendID.equals("")) {
            stringFindQuery=stringFindQuery+" FELT_AMEND_ID ='"+ amendID +"'";
        }
        getParent().getParent().getParent().getParent().show(false);
