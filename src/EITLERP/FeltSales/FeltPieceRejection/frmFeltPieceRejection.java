...
public class frmFeltPieceRejection extends javax.swing.JApplet {
    ...
    private clsFeltPieceRejection ObjFeltOrderUpd;
    ...
    /**
     * Creates new form frmFeltPieceRejection
     */
    public void init() {
        System.gc();
        setSize(830, 590);
  ...
  //      txtamendreasoncode.setVisible(false);
        ...
        ObjFeltOrderUpd = new clsFeltPieceRejection();
        //    DeptID = 40 ;
        SetMenuForRights();
        ...
        if (ObjFeltOrderUpd.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Error occured while Loading Data. Error is " + ObjFeltOrderUpd.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" FELT PIECE REJECTION ENTRY FORM - ");
        ...
        jLabel12.setText("Rejection Reason");
        Tab1.add(jLabel12);
        ...
        Tab.addTab("Rejection Details", Tab1);
...
//       
    ...
    private void cmdPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPreviewActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "File error " + e.getMessage(), "FILE ERROR", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Select a row from Document Update History");
        }
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(712, txtAmendID.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmFeltPieceRejection.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 712)) {
...
//            String AmendReasoncode =  ObjFeltOrderUpd.getAttribute("FELT_AMEND_REASON").getString();
            ...
            lblTitle.setText(" FELT PIECE REJECTION- " + AmendID);
     ...
     //       txtamendreasoncode.setText(AmendReasoncode);
            ...
            for (int i = 1; i <= ObjFeltOrderUpd.hmFeltOrderUpdDetails.size(); i++) {
                clsFeltPieceRejectionDetails ObjFeltOrderUpdDetails = (clsFeltPieceRejectionDetails) ObjFeltOrderUpd.hmFeltOrderUpdDetails.get(Integer.toString(i));
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(712, AmendID);
            ...
            FormatGridUpdateHistory();
//            HashMap hmApprovalHistory=clsFeltPieceRejection.getHistoryList(ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString(), txtAmendID.getText());
            HashMap hmApprovalHistory = clsFeltPieceRejection.getHistoryList(AmendDate, AmendID);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltPieceRejection ObjFeltOrderUpd = (clsFeltPieceRejection) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=712 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=712 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(712, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(712, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(712, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(712, txtAmendID.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(712, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(712, FromUserID, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(712, txtAmendID.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7012, 70121)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7012, 70122)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7012, 70123)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7012, 70124)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
      //  EditMode=EITLERPGLOBAL.ADD;
        ...
        if (aList.ShowList()) {
            ...
            txtAmendID.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 712, FFNo, false));
    ...
    private void Edit() {
        ...
        if (ObjFeltOrderUpd.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            DisplayData();
            cmbAmendReason.setEnabled(true);
            if (clsFeltProductionApprovalFlow.IsCreator(712, productionDocumentNo)) {
                SetFields(true);
                txtAmendDate.setEnabled(false);
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltOrderUpd.CanDelete(txtAmendID.getText(), txtAmendDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, ObjFeltOrderUpd.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//        int DeptID =  EITLERPGLOBAL.gUserDeptID;
        ...
        if (AmendDate.equals("") || !EITLERPGLOBAL.isDate(AmendDate)) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Valid UpdationDate.", "Wrong Updation Date", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if ((Amend_Date.after(FinFromDate) || Amend_Date.compareTo(FinFromDate) == 0) && (Amend_Date.before(FinToDate) || Amend_Date.compareTo(FinToDate) == 0)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Updation Date is Not Within Financial Year.", "FINANCIAL YEAR ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (Amend_Date.compareTo(java.sql.Date.valueOf(EITLERPGLOBAL.getCurrentDateDB())) > 0) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Updation Date Must be Before or the Same Date as Today.", "Wrong Production Date", JOptionPane.ERROR_MESSAGE);
            return;
        }

        //Check the no. of items in table
        if (Table.getRowCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Piece Updation Details Before Saving.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                if (pieceNo.equals("") || pieceNo.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Piece No.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Party Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Party Name", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                /*
                 ...
                 JOptionPane.showMessageDialog(frmFeltPieceRejection.this,"Enter Weight of Felt.","ERROR",JOptionPane.ERROR_MESSAGE);
                 return;
                ...
                if (productcode.equals("") || productcode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Product Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                /*
                 if(picksPer10CMS.equals("") || picksPer10CMS.equals(null)){
                 JOptionPane.showMessageDialog(frmFeltPieceRejection.this,"Enter Pics Per 10 CMS","ERROR",JOptionPane.ERROR_MESSAGE);
                 return;
                 }
                 */
                j++;
                ...
                /*
                 ...
                 JOptionPane.showMessageDialog(frmFeltPieceRejection.this,"Enter Reed Space.","ERROR",JOptionPane.ERROR_MESSAGE);
                 return;
                ...
                /*
                 ...
                 JOptionPane.showMessageDialog(frmFeltPieceRejection.this,"Enter Length of Felt.","ERROR",JOptionPane.ERROR_MESSAGE);
                 return;
                ...
                /*
                 ...
                 JOptionPane.showMessageDialog(frmFeltPieceRejection.this,"Enter Loom No.","ERROR",JOptionPane.ERROR_MESSAGE);
                 return;
                ...
                if (Amend_Reason.equals("3")) {
                    if (widthString.equals("") || widthString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Width of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (Amend_Reason.equals("3")) {
                    if (gsmString.equals("") || gsmString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter GSM of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (amendremarkstring.equals("") || amendremarkstring.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Compulsorily Updation Remark for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (mfgstatusstring.equals("CANCELLED") || mfgstatusstring.equals("HOLD-FNG") || mfgstatusstring.equals("HOLD-NDL") || mfgstatusstring.equals("HOLD-MFG") || mfgstatusstring.equals("HOLD-WVG") || mfgstatusstring.equals("HOLD-WRP") || mfgstatusstring.equals("HOLD-MND")) {
                    if (!Amend_Reason.equals("14")) {
                        JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "YOU CANNOT UPDATE CANCELLED FELTS/HOLD FELTS, FIRST RELEASE THE FELTS for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                if (mfgstatusstring.equals("LOW") || mfgstatusstring.equals("MEDIUM 1") || mfgstatusstring.equals("MEDIUM 2") || mfgstatusstring.equals("HIGH") || mfgstatusstring.equals("EX. HIGH")) {
                    if (Amend_Reason.equals("14")) {
                        JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "YOU CANNOT UPDATE REGULAR FELTS for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                ...
                if (Amend_Reason.equals("6")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkPartyCodeInDB(partyCode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "PARTY CODE " + partyCode + " is Not Existed Sales Party Master.", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                ...
                if (Amend_Reason.equals("7")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkProductCodeInDB(productcode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "PRODUCT CODE " + productcode + " is Not Existed Felts Product Master .", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
            ...
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter Correct Details at Row " + (i + 1) + " and Column " + (j + 1) + ". Error is " + nfe.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
            j = 0;
            nfe.printStackTrace();
            return;
        }
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
            ...
            if (ObjFeltOrderUpd.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                        try{
                            ...
                            String responce = JavaMail.sendFinalApprovalMail(712, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, SelHierarchyID, true);
                ...
                JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Error occured while saving. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltOrderUpd.Update()) {
                 ...
                 if (OpgFinal.isSelected()) {
                       ...
                       if(txtamendreasoncode.getText().equals("0"))
                       {
                            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                JOptionPane.showMessageDialog(frmFeltPieceRejection.this, "Error occured while saving editing. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.FeltPieceAmend.frmFindFeltPieceRejection", true);
        frmFindFeltPieceRejection ObjFindFeltOrderUpd = (frmFindFeltPieceRejection) ObjLoader.getObj();

        if (ObjFindFeltOrderUpd.Cancelled == false) {
            if (!ObjFeltOrderUpd.Filter(ObjFindFeltOrderUpd.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltPieceRejection.this, " No records found.", "Find Felt Weaving Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        ObjFeltOrderUpd.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=712 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    ...
    /*
     ...
     HashMap List=clsFeltPieceRejection.getAmendReasonList(EITLERPGLOBAL.gCompanyID,EITLERPGLOBAL.gNewUserID);
        
     for(int i=1;i<=List.size();i++) {
     clsFeltPieceRejection ObjReason=(clsFeltPieceRejection) List.get(Integer.toString(i));
     ComboData aData=new ComboData();
    ...
    private void GenerateAmendReasonCombo() {
        ...
        hmAmendList = clsFeltPieceRejection.getAmendReasonList();
