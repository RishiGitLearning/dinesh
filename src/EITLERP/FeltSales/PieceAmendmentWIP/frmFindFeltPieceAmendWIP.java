...
public class frmFindFeltPieceAmendWIP extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Felt Sales Piece Amendment");
        ...
        cmdFind.setBounds(310, 70, 70, 25);
        ...
        cmdCancel.setBounds(310, 100, 70, 25);
        ...
        PARTY_CODE.setBounds(110, 50, 160, 30);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" PIECE_AMEND_NO ='"+ docNo +"'";
            flag=true;
        }
//        boolean flag2=false;
//        if(!"".equals(txtPieceNo.getText()))
//        {
//            if(flag)
//            {
//                stringFindQuery = stringFindQuery+" AND PIECE_NO like '"+txtPieceNo.getText()+"%' ";
//            }
//            else
//            {
//                stringFindQuery = " PIECE_NO like '"+txtPieceNo.getText()+"%' ";
//            }
//            flag2 = true;
//        }
        ...
        if(!PARTY_CODE.getText().trim().equals(""))
        {
            if(flag)
            {
                stringFindQuery = stringFindQuery+" AND MM_PARTY_CODE = "+PARTY_CODE.getText();
            }
            else
            {
                stringFindQuery = " MM_PARTY_CODE ='"+PARTY_CODE.getText()+"'";
            }
        }
        getParent().getParent().getParent().getParent().show(false);
