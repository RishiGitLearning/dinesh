...
public class frmPieceAmendWIP extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        objPieceAmendApproval = new clsPieceAmendWIP();
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" Position WIP Piece Review");
        ...
        Tab1.add(jPanel3);
        jPanel3.setBounds(0, 190, 820, 5);

        jLabel1.setText("Party Code ");
        Tab1.add(jLabel1);
        jLabel1.setBounds(20, 40, 80, 30);
        Tab1.add(PARTY_CODE);
        PARTY_CODE.setBounds(110, 40, 120, 19);

        jLabel2.setText("Machine No");
        Tab1.add(jLabel2);
        jLabel2.setBounds(240, 40, 90, 30);
        Tab1.add(MACHINE_NO);
        MACHINE_NO.setBounds(320, 40, 60, 19);

        jLabel3.setText("POSITION");
        Tab1.add(jLabel3);
        jLabel3.setBounds(390, 40, 80, 30);
        Tab1.add(POSITION);
        POSITION.setBounds(460, 40, 50, 19);
        ...
        Tab1.add(SHOW_LIST);
        SHOW_LIST.setBounds(520, 40, 110, 25);
        ...
        PIECE_AMEND_NO.setBounds(80, 10, 100, 19);

        jLabel5.setText("Date");
        Tab1.add(jLabel5);
        jLabel5.setBounds(240, 10, 40, 30);
        ...
        lblPartyName.setBounds(110, 70, 300, 20);
        Tab1.add(lblPositionDesc);
        lblPositionDesc.setBounds(460, 70, 180, 20);

        jLabel6.setText(":: Important Note ::");
        Tab1.add(jLabel6);
        jLabel6.setBounds(20, 130, 160, 15);
        ...
        Tab1.add(jPanel9);
        jPanel9.setBounds(0, 120, 820, 5);

        jLabel7.setText("CHANGE POSIBILITY CAN ONLY APPLY CHANGE");
        Tab1.add(jLabel7);
        jLabel7.setBounds(160, 170, 314, 15);

        jLabel8.setText("CHANGE POSIBILITY CAN NOT OBSOLETE");
        Tab1.add(jLabel8);
        jLabel8.setBounds(160, 150, 320, 15);

        jLabel9.setText("DESIGN CAN ONLY SET CHANGE POSIBILITY (Style will not change)*");
        Tab1.add(jLabel9);
        jLabel9.setBounds(160, 130, 650, 15);

        jLabel10.setText("Position Design No ");
        Tab1.add(jLabel10);
        jLabel10.setBounds(20, 100, 130, 20);

        lblPositionDesignNo.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        Tab1.add(lblPositionDesignNo);
        lblPositionDesignNo.setBounds(140, 100, 70, 20);

        jLabel11.setText("UPN");
        Tab1.add(jLabel11);
        jLabel11.setBounds(220, 100, 40, 20);

        lblUPN.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        Tab1.add(lblUPN);
        lblUPN.setBounds(260, 100, 140, 20);

        jLabel12.setText("ENTRY REASON");
        Tab1.add(jLabel12);
        jLabel12.setBounds(410, 100, 110, 15);

        txtEntryReason.setEnabled(false);
        Tab1.add(txtEntryReason);
        txtEntryReason.setBounds(520, 97, 170, 20);
        Tab1.add(lblRefDocNo);
        lblRefDocNo.setBounds(695, 95, 110, 20);
        ...
        jScrollPane4.setBounds(2, 2, 820, 430);
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmPieceAmendWIP.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmPieceAmendWIP.this, "Select a row from Document Update History");
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT || EditMode == EITLERPGLOBAL.ADD) {
            ...
            if (Table.getSelectedColumn() == 4) {
                if (tick_delink && tick_posibility) {
                    JOptionPane.showMessageDialog(this, "Change Posibility is true, so this Piece can not OBSOLETE");
                    Table.setValueAt(false, Table.getSelectedRow(), 4);
                }
            }
            ...
            if (Table.getSelectedColumn() == 5) {
                ...
                if (tick_actualchange && !tick_posibility) {
                    JOptionPane.showMessageDialog(this, "Change Posibility is true, so this Piece can not APPLY CHANGE");
                    Table.setValueAt(false, Table.getSelectedRow(), 5);
                }
            }

            if (EITLERPGLOBAL.gUserID == 28) {
                boolean ABP_FLAG = false;
                for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                    if (!DataModel.getValueAt(i, 1).toString().equals("")) {
                        if (Table.getValueAt(i, 5).equals(false)) {
                            ABP_FLAG = true;
                        }
                    }
                }
...
//        }
    ...
    public void setData_toTable() {
        ...
        if (hmPieceList.isEmpty()) {
            ...
            for (int j = 1; j <= hmPieceList.size(); j++) {
                ...
                rowData[17] = (String) piece.getAttribute("PRODUCTCODE").getObj();
                rowData[18] = (String) piece.getAttribute("PRODUCTCODE_UPDATED").getObj();
                rowData[19] = (String) piece.getAttribute("PIECE_STAGE").getObj();
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle.setText(" Position WIP Piece Review -  " + PIECE_AMEND_NO.getText());
...
//            if(objPieceAmendApproval.getAttribute("ENTRY_REASON").getString().equals("AUTO_EXPECTED_MONTH"))
//            {
//                Renderer1.setEnabled(false);
//                Renderer2.setEnabled(false);
//                Renderer3.setEnabled(false);
//                
//            }
            ...
            for (int i = 1; i <= objPieceAmendApproval.hmPieceAmendApprovalDetail.size(); i++) {
                clsPieceAmendWIPDetail ObjItem = (clsPieceAmendWIPDetail) objPieceAmendApproval.hmPieceAmendApprovalDetail.get(Integer.toString(i));
                ...
                if (ObjItem.getAttribute("CHANGE_POSIBILITY").getInt() == 1) {
                    DataModel.setValueByVariable("CHANGE_POSIBILITY", true, NewRow);
                } else {
                    DataModel.setValueByVariable("CHANGE_POSIBILITY", false, NewRow);
                }

                if (ObjItem.getAttribute("DELINK").getInt() == 1) {
                    DataModel.setValueByVariable("DELINK", true, NewRow);
                } else {
                    DataModel.setValueByVariable("DELINK", false, NewRow);
                }

                if (ObjItem.getAttribute("ACTUAL_CHANGE").getInt() == 1) {
                    DataModel.setValueByVariable("ACTUAL_CHANGE", true, NewRow);
                } else {
                    DataModel.setValueByVariable("ACTUAL_CHANGE", false, NewRow);
                }
                ...
                DataModel.setValueByVariable("PRODUCTCODE", ObjItem.getAttribute("PRODUCTCODE").getString(), NewRow); //18
                DataModel.setValueByVariable("PRODUCTCODE_UPDATED", ObjItem.getAttribute("PRODUCTCODE_UPDATED").getString(), NewRow); //19
                DataModel.setValueByVariable("PIECE_STAGE", ObjItem.getAttribute("PIECE_STAGE").getString(), NewRow); //19
                DataModel.setValueByVariable("PROD_REMARKS", ObjItem.getAttribute("PROD_REMARKS").getString(), NewRow); //19
                DataModel.setValueByVariable("REMARKS", ObjItem.getAttribute("REMARKS").getString(), NewRow); //19
                DataModel.setValueByVariable("ACTION_TAKEN", ObjItem.getAttribute("ACTION_TAKEN").getString(), NewRow); //
                DataModel.setValueByVariable("EXPECTED_DISPATCH", ObjItem.getAttribute("EXPECTED_DISPATCH").getString(), NewRow);
                ...
                String Product_Code = ObjItem.getAttribute("PRODUCTCODE").getString();
                String Product_Code_updated = ObjItem.getAttribute("PRODUCTCODE_UPDATED").getString();
                ...
                if (!Product_Code.equals(Product_Code_updated)) {
                    //DataModel.setValueByVariable("STYLE_UPDATED","",NewRow);
                    Renderer.setBackColor(NewRow, DataModel.getColFromVariable("PRODUCTCODE_UPDATED"), Color.LIGHT_GRAY);
                }

                //ObjItem.getAttribute("PIECE_NO").getString()
                ResultSet rs_history = data.getResult("SELECT distinct PIECE_NO,EXPECTED_DISPATCH FROM PRODUCTION.FELT_SALES_PIECE_AMENDMENT_DETAIL_WIP_H where PIECE_NO='" + ObjItem.getAttribute("PIECE_NO").getString() + "' AND EXPECTED_DISPATCH!='" + ObjItem.getAttribute("PIECE_NO").getString() + "'");
                System.out.println("SELECT distinct PIECE_NO,EXPECTED_DISPATCH FROM PRODUCTION.FELT_SALES_PIECE_AMENDMENT_DETAIL_WIP_H where PIECE_NO='" + ObjItem.getAttribute("PIECE_NO").getString() + "' AND EXPECTED_DISPATCH!=''");
                try {
                    ...
                    while (rs_history.next()) {
                        ...
                        srNo = srNo + 1;
                        String PIECE_AMEND_NO = data.getStringValueFromDB("SELECT PIECE_AMEND_NO FROM PRODUCTION.FELT_SALES_PIECE_AMENDMENT_DETAIL_WIP_H WHERE PIECE_NO='" + rs_history.getString("PIECE_NO") + "' AND EXPECTED_DISPATCH='" + rs_history.getString("EXPECTED_DISPATCH") + "'");
                        String PIECE_AMEND_DATE = data.getStringValueFromDB("SELECT PIECE_AMEND_DATE FROM PRODUCTION.FELT_SALES_PIECE_AMENDMENT_HEADER_WIP WHERE PIECE_AMEND_NO='" + PIECE_AMEND_NO + "'");
                        DataModel_Revision.setValueByVariable("SRNO", srNo + "", (srNo - 1));
                        DataModel_Revision.setValueByVariable("PIECE_NO", rs_history.getString("PIECE_NO"), (srNo - 1));
                        DataModel_Revision.setValueByVariable("REVIEW_NO", PIECE_AMEND_NO, (srNo - 1));
                        DataModel_Revision.setValueByVariable("REVIEW_DATE", PIECE_AMEND_DATE, (srNo - 1));
                        DataModel_Revision.setValueByVariable("REVISION_MONTH", rs_history.getString("EXPECTED_DISPATCH"), (srNo - 1));
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsPieceAmendWIP ObjHistory = (clsPieceAmendWIP) History.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("CHANGE POSIBILITY"); //2 -
            DataModel.addColumn("PROD. REMARKS"); //2 -
            DataModel.addColumn("OBSOLETE"); //3 - 
            DataModel.addColumn("APPLY CHANGE"); //4 - 
            DataModel.addColumn("ACTION TAKEN"); //5 - 
            DataModel.addColumn("GROUP"); //6
            DataModel.addColumn("GROUP_UPDATED"); //7 
            ...
            DataModel.addColumn("PRODUCTCODE"); //14
            DataModel.addColumn("PRODUCTCODE_UPDATED"); //15
            DataModel.addColumn("PIECE STAGE"); //16
            DataModel.addColumn("REMARKS"); //17
            ...
            DataModel.SetVariable(2, "CHANGE_POSIBILITY");
            DataModel.SetVariable(3, "PROD_REMARKS");
            DataModel.SetVariable(4, "DELINK");
            DataModel.SetVariable(5, "ACTUAL_CHANGE");
            DataModel.SetVariable(6, "ACTION_TAKEN");
            DataModel.SetVariable(7, "GROUP"); //
            DataModel.SetVariable(8, "GROUP_UPDATED"); //
            DataModel.SetVariable(9, "STYLE"); //
            ...
            DataModel.SetVariable(15, "GSM"); //
            DataModel.SetVariable(16, "GSM_UPDATED"); //
            DataModel.SetVariable(17, "PRODUCTCODE"); //
            DataModel.SetVariable(18, "PRODUCTCODE_UPDATED"); //
            DataModel.SetVariable(19, "PIECE_STAGE"); //
            DataModel.SetVariable(20, "REMARKS"); //
            ...
            int ImportCol3 = 4;
            Renderer2.setCustomComponent(ImportCol3, "CheckBox");
            ...
            Table.getColumnModel().getColumn(ImportCol3).setCellRenderer(Renderer2);

            int ImportCol4 = 5;
            Renderer3.setCustomComponent(ImportCol4, "CheckBox");
            ...
            if (clsUser.getDeptID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID) == 29) {
                ...
                aCheckBox4.setEnabled(false);
            }

            Table.getColumnModel().getColumn(ImportCol4).setCellEditor(new DefaultCellEditor(aCheckBox4));
            Table.getColumnModel().getColumn(ImportCol4).setCellRenderer(Renderer3);
            ...
            Table.getColumnModel().getColumn(17).setMinWidth(110);
            Table.getColumnModel().getColumn(18).setMinWidth(170);
            Table.getColumnModel().getColumn(19).setMinWidth(100);
            Table.getColumnModel().getColumn(20).setMinWidth(170);
            Table.getColumnModel().getColumn(21).setMinWidth(170);
            ...
            Table.getColumnModel().getColumn(DataModel.getColFromVariable("PRODUCTCODE_UPDATED")).setCellRenderer(Renderer);
...
//    }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6092, 60921)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6092, 60922)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6092, 60923)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6092, 60924)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Save() {
        ...
        for (int i = 0; i < Table.getRowCount(); i++) {
            if (clsUser.getDeptID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID) == 29) {
                if (!OpgReject.isSelected()) {
                    if (DataModel.getValueAt(i, 21).toString().equals("") && Table.getValueAt(i, 5).equals(false) && Table.getValueAt(i, 4).equals(false)) {
            ...
            if (objPieceAmendApproval.Update()) {
                ...
                if (OpgFinal.isSelected()) {
                    try {
                        ...
                        //System.out.println("Send Mail Responce : " + responce);
                        // WIP Review START 
                        String pMessage = "WIP Piece Review No : " + DOC_NO + ",<br>Review Entry Date : " + DOC_DATE + ",<br><br><br> Document has been final approved by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID) + "<br>";
...
//                                      
                            ...
                            HashMap hmApprovalHistory = clsPieceAmendWIP.getHistoryList(EITLERPGLOBAL.gCompanyID + "", DOC_NO);
                            for (int ij = 1; ij <= hmApprovalHistory.size(); ij++) {
                                pMessage += "<tr>";

                                clsPieceAmendWIP ObjHistory = (clsPieceAmendWIP) hmApprovalHistory.get(Integer.toString(ij));
                            ...
                            String recievers = "sdmlerp@dineshmills.com,vdshanbhag@dineshmills.com,brdfltdesign@dineshmills.com";
                            ...
                            String responce1 = MailNotification.sendNotificationMail(ModuleId, pSubject, pMessage, recievers, "sdmlerp@dineshmills.com", SelHierarchyID);
        ...
        try {
            ...
            for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                if (!DataModel.getValueAt(i, 1).toString().equals("")) {
                    ...
                    objFeltOrderDetails.setAttribute("ACTION_TAKEN", Table.getValueAt(i, 6));
                    ...
                    objFeltOrderDetails.setAttribute("PRODUCTCODE", DataModel.getValueByVariable("PRODUCTCODE", i));
                    objFeltOrderDetails.setAttribute("PRODUCTCODE_UPDATED", DataModel.getValueByVariable("PRODUCTCODE_UPDATED", i));
                    ...
                    objFeltOrderDetails.setAttribute("EXPECTED_DISPATCH", DataModel.getValueByVariable("EXPECTED_DISPATCH", i));
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.PieceAmendmentWIP.frmFindFeltPieceAmendWIP", true);
    ...
    public void FindWaiting() {
        objPieceAmendApproval.Filter(" AND PIECE_AMEND_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
    ...
    private void ReasonReadOnly() {
        ...
        if (clsUser.getDeptID(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID) != 40) {
