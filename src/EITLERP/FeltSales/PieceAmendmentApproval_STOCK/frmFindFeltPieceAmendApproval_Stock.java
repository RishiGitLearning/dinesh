...
public class frmFindFeltPieceAmendApproval_Stock extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Felt Sales Piece Amendment STOCK");
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" PIECE_AMEND_STOCK_NO ='"+ docNo +"'";
            flag=true;
        }
//        boolean flag2=false;
