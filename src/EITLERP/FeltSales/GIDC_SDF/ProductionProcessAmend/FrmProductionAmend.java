...
public class FrmProductionAmend extends javax.swing.JApplet {
    ...
    private void DisplayData() {
        ...
        try {
            ...
            lblTitle1.setText("Production Process Amend - " + DOC_NO);
...
//    }
    ...
    {
        TO_STAGE.removeAllItems();
        TO_STAGE.addItem("YET_TO_MFG");
        TO_STAGE.addItem("SPIRALED");
        TO_STAGE.addItem("ASSEMBLED");
        TO_STAGE.addItem("READY_TO_DESPATCH");
    ...
    private void initComponents() {
        ...
        PIECE_NO.setBackground(java.awt.Color.white);
        ...
        ORDER_VALUE.setBounds(750, 480, 170, 37);
        ...
        jPanel1.add(REMOVE);
        REMOVE.setBounds(550, 480, 100, 30);
        ...
        lblTitle1.setText("Production Process Amend");
    ...
    private void PIECE_NOKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PIECE_NOKeyPressed
        ...
        if (evt.getKeyCode() == 112) {
            try {
                ...
                aList.SQL = "SELECT GIDC_PIECE_NO,GIDC_PARTY_CODE,GIDC_STAGE FROM PRODUCTION.GIDC_FELT_PIECE_REGISTER WHERE GIDC_STAGE NOT IN ('YET_TO_MFG','GIDC_TO_SDML','CANCELED')";
                aList.ReturnCol = 1;
                ...
                if (aList.ShowLOV()) {
                    ...
                    System.out.println("SELECT GIDC_STAGE FROM PRODUCTION.GIDC_FELT_PIECE_REGISTER where GIDC_PIECE_NO='"+PIECE_NO.getText()+"'");
                    txtFromStage.setText(data.getStringValueFromDB("SELECT GIDC_STAGE FROM PRODUCTION.GIDC_FELT_PIECE_REGISTER where GIDC_PIECE_NO='"+PIECE_NO.getText()+"'"));
                    if(!txtFromStage.getText().equals(""))
                    {
                        if(txtFromStage.getText().equals("READY_TO_DESPATCH"))
                        {
                            TO_STAGE.removeAllItems();
                            TO_STAGE.addItem("YET_TO_MFG");
                            TO_STAGE.addItem("SPIRALED");
                        ...
                        else if(txtFromStage.getText().equals("ASSEMBLED"))
                        {
                        ...
                        else if(txtFromStage.getText().equals("SPIRALED"))
                        {
...
//                P_O_NO.requestFocus();
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.GIDC_SDF.ProductionProcessAmend.frmFindProductionAmend", true);
    ...
    private void Add() {
        ...
        lblTitle1.setText("Felt Production Process Amend - " + PA_DOC_NO.getText());
            ...
            if (ObjProductionAmend.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                    try {
                        ...
                        String Party_Code = "";
                        data.Execute("UPDATE PRODUCTION.GIDC_FELT_PIECE_REGISTER SET GIDC_STAGE='"+TO_STAGE.getSelectedItem()+"' where GIDC_PIECE_NO='"+PIECE_NO.getText()+"'");
                        data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_GIDC_STATUS='"+TO_STAGE.getSelectedItem()+"' WHERE PR_PIECE_NO='"+PIECE_NO.getText()+"'");
                        data.Execute("UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER SET WIP_GIDC_STATUS='"+TO_STAGE.getSelectedItem()+"' WHERE WIP_PIECE_NO='"+PIECE_NO.getText()+"'");
...
//        
//      ObjProductionAmend.setAttribute("S_ORDER_NO",Order_No_Conversion.Order_No_Only(S_O_NO.getText()));
//      ObjProductionAmend.setAttribute("S_ORDER_DATE",S_O_DATE.getText());
//      ObjProductionAmend.setAttribute("REGION",REGION.getText());
//      ObjProductionAmend.setAttribute("SALES_ENGINEER",S_ENGINEER.getText());
//      ObjProductionAmend.setAttribute("PARTY_CODE",PARTY_CODE.getText());
//      ObjProductionAmend.setAttribute("PARTY_NAME",PARTY_NAME.getText());
//      ObjProductionAmend.setAttribute("REFERENCE",REFERENCE.getSelectedItem());
//      ObjProductionAmend.setAttribute("REFERENCE_DATE",REF_DATE.getText());
//      ObjProductionAmend.setAttribute("P_O_NO",P_O_NO.getText());
//      ObjProductionAmend.setAttribute("P_O_DATE",P_O_DATE.getText());
//      ObjProductionAmend.setAttribute("REMARK",REMARK.getText());
//      DOC_NO = Order_No_Conversion.Order_No_Only(S_O_NO.getText());
//      ObjProductionAmend.setAttribute("DOC_NO",S_O_NO.getText());
//      ObjProductionAmend.setAttribute("DOC_DATE",S_O_DATE.getText());
