...
public class frmNRGPFind_GIDC extends javax.swing.JApplet {
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!gpDate.equals("")) {
            stringFindQuery=stringFindQuery+" WHERE GATEPASS_TYPE='MKP' AND GATEPASS_DATE='"+EITLERPGLOBAL.formatDateDB(gpDate)+"' ";
        }
        
        if(!gpNo.equals("")) {
            stringFindQuery=stringFindQuery+" WHERE GATEPASS_TYPE='MKP' AND GATEPASS_NO ='"+ gpNo +"'";
        }
        
        if(!pieceNo.equals("")) {
            stringFindQuery=stringFindQuery+" WHERE GATEPASS_TYPE='MKP' AND PIECE_NO ='"+ pieceNo +"'";
        }
        getParent().getParent().getParent().getParent().show(false);
