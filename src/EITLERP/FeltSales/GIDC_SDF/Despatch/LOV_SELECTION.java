...
public class LOV_SELECTION extends javax.swing.JApplet {
    ...
    public LOV_SELECTION(String pSQL,int pReturnCol,boolean pShowReturnCol,int pDefaultSearchOn) {
        System.gc();
        initComponents();
        DataModel=new EITLTableModel();
        SQL=pSQL;
...
//                rowData[4]=rsData.getString("RCVD_WIDTH");
    ...
    private void FormatGrid() {
        ...
        DataModel.SetVariable(1,"GIDC_PIECE_NO"); 
        DataModel.SetVariable(2,"GIDC_PARTY_CODE");
        DataModel.SetVariable(3,"GIDC_LENGTH"); 
        DataModel.SetVariable(4,"GIDC_WIDTH"); 
        DataModel.SetVariable(5,"GIDC_THORITICAL_WEIGHT"); 
