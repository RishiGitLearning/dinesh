...
public class searchkey_previous_order_req_month extends javax.swing.JApplet {
    ...
    public searchkey_previous_order_req_month() {
        System.gc();
        initComponents();
    ...
    public searchkey_previous_order_req_month(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn) {
        System.gc();
        initComponents();
        DataModel = new EITLTableModel();
        SQL = pSQL;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(0, 30, 1020, 300);

        cmdOK.setText("CONTINUE ORDER");
        ...
        cmdOK.setBounds(820, 340, 190, 30);

        jLabel1.setBackground(new java.awt.Color(0, 102, 153));
        jLabel1.setText("Existing Piece Available for same Party , Machine, Position and Requested Month is blank");
