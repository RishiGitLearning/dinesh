...
public class searchkey extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 70, 1130, 240);
        ...
        cmdCancel.setBounds(1060, 320, 70, 30);
    ...
    private void txtSearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyTyped
        ...
        SQL = "SELECT D.MM_MACHINE_NO,D.MM_MACHINE_POSITION,D.MM_MACHINE_POSITION_DESC,D.MM_ITEM_CODE,D.MM_GRUP,(D.MM_FELT_LENGTH+D.MM_FABRIC_LENGTH),(D.MM_FELT_WIDTH+D.MM_FABRIC_WIDTH),D.MM_FELT_GSM,concat(D.MM_FELT_STYLE,D.MM_STYLE_DRY) as MM_FELT_STYLE FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER H,PRODUCTION.FELT_MACHINE_MASTER_DETAIL D where CONCAT(D.MM_COMBINATION_CODE,D.MM_FELT_LENGTH,D.MM_FELT_WIDTH,D.MM_FELT_GSM) like '"+mscrhtxt+"%' AND D.MM_PARTY_CODE='"+Party_Code+"'  AND (D.MM_MACHINE_NO!='' AND D.MM_MACHINE_POSITION!='' AND (D.MM_FELT_LENGTH != '' OR D.MM_FABRIC_LENGTH != '') AND (D.MM_FELT_WIDTH != '' OR D.MM_FABRIC_WIDTH != '') AND D.MM_FELT_GSM!='')   AND H.APPROVED=1 AND H.CANCELED=0 AND H.MM_DOC_NO=D.MM_DOC_NO     ORDER BY  D.MM_MACHINE_NO,D.MM_MACHINE_POSITION";
        tempSQL = SQL;
        System.out.println("SELECT D.MM_MACHINE_NO,D.MM_MACHINE_POSITION,D.MM_MACHINE_POSITION_DESC,D.MM_ITEM_CODE,D.MM_GRUP,(D.MM_FELT_LENGTH+D.MM_FABRIC_LENGTH),(D.MM_FELT_WIDTH+D.MM_FABRIC_WIDTH),D.MM_FELT_GSM,concat(D.MM_FELT_STYLE,D.MM_STYLE_DRY) as MM_FELT_STYLE FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER H,PRODUCTION.FELT_MACHINE_MASTER_DETAIL D where CONCAT(D.MM_COMBINATION_CODE,D.MM_FELT_LENGTH,D.MM_FELT_WIDTH,D.MM_FELT_GSM) like '"+mscrhtxt+"%' AND D.MM_PARTY_CODE='"+Party_Code+"'  AND (D.MM_MACHINE_NO!='' AND D.MM_MACHINE_POSITION!='' AND (D.MM_FELT_LENGTH != '' OR D.MM_FABRIC_LENGTH != '') AND (D.MM_FELT_WIDTH != '' OR D.MM_FABRIC_WIDTH != '') AND D.MM_FELT_GSM!='')   AND H.APPROVED=1 AND H.CANCELED=0 AND H.MM_DOC_NO=D.MM_DOC_NO     ORDER BY  D.MM_MACHINE_NO,D.MM_MACHINE_POSITION");
        QueryCode = mnwtxt;
