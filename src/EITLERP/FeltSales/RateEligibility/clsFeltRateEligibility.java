 ...
 * @author Vivek Kumar
 */
public class clsFeltRateEligibility {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY GROUP BY DOC_NO ORDER BY DOC_NO");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
...
//            else setData();
    ...
    public boolean Insert() {
        ...
        try {
            ...
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='1'");

            // Production data history connection
            statementHistory = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetHistory = statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY_H WHERE DOC_NO='1'");

            setAttribute("DOC_NO", getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 631, 304, true));

            //Now Insert records into production tables
            for (int i = 1; i <= hmFeltFinishingDetails.size(); i++) {
                clsFeltRateEligibilityDetails ObjFeltFinishingDetails = (clsFeltRateEligibilityDetails) hmFeltFinishingDetails.get(Integer.toString(i));
                ...
                resultSetTemp.updateString("PIECE_NO_HEADER", getAttribute("PIECE_NO_HEADER").getString());
                resultSetTemp.updateString("PARTY_CODE_HEADER", getAttribute("PARTY_CODE_HEADER").getString());
                resultSetTemp.updateString("PARTY_NAME_HEADER", getAttribute("PARTY_NAME_HEADER").getString());                
                resultSetTemp.updateString("UPN_HEADER", getAttribute("UPN_HEADER").getString());
                resultSetTemp.updateString("GROUP_CODE_HEADER", getAttribute("GROUP_CODE_HEADER").getString());
                resultSetTemp.updateString("GROUP_NAME_HEADER", getAttribute("GROUP_NAME_HEADER").getString());
                resultSetTemp.updateString("BOOKING_DATE_FROM", EITLERPGLOBAL.formatDateDB(getAttribute("BOOKING_DATE_FROM").getString()));
                resultSetTemp.updateString("BOOKING_DATE_TO", EITLERPGLOBAL.formatDateDB(getAttribute("BOOKING_DATE_TO").getString()));
                resultSetTemp.updateString("DESPATCH_DATE", EITLERPGLOBAL.formatDateDB(getAttribute("DESPATCH_DATE").getString()));
                
                
                resultSetTemp.updateString("SELECTED_FLAG",ObjFeltFinishingDetails.getAttribute("SELECTED_FLAG").getString());
                resultSetTemp.updateString("PIECE_NO", ObjFeltFinishingDetails.getAttribute("PIECE_NO").getString());
                ...
                resultSetTemp.updateString("UPN", ObjFeltFinishingDetails.getAttribute("UPN").getString());
                ...
                resultSetTemp.updateString("MACHINE_NO", ObjFeltFinishingDetails.getAttribute("MACHINE_NO").getString());
                resultSetTemp.updateString("POSITION_NO", ObjFeltFinishingDetails.getAttribute("POSITION_NO").getString());
                resultSetTemp.updateString("POSITION_DESC", ObjFeltFinishingDetails.getAttribute("POSITION_DESC").getString());                
                resultSetTemp.updateString("PRODUCT_CODE", ObjFeltFinishingDetails.getAttribute("PRODUCT_CODE").getString());
                resultSetTemp.updateString("PRODUCT_GROUP", ObjFeltFinishingDetails.getAttribute("PRODUCT_GROUP").getString());
                ...
                resultSetHistory.updateString("PIECE_NO_HEADER", getAttribute("PIECE_NO_HEADER").getString());
                resultSetHistory.updateString("PARTY_CODE_HEADER", getAttribute("PARTY_CODE_HEADER").getString());
                resultSetHistory.updateString("PARTY_NAME_HEADER", getAttribute("PARTY_NAME_HEADER").getString());                
                resultSetHistory.updateString("UPN_HEADER", getAttribute("UPN_HEADER").getString());
                resultSetHistory.updateString("GROUP_CODE_HEADER", getAttribute("GROUP_CODE_HEADER").getString());
                resultSetHistory.updateString("GROUP_NAME_HEADER", getAttribute("GROUP_NAME_HEADER").getString());
                resultSetHistory.updateString("BOOKING_DATE_FROM", EITLERPGLOBAL.formatDateDB(getAttribute("BOOKING_DATE_FROM").getString()));
                resultSetHistory.updateString("BOOKING_DATE_TO", EITLERPGLOBAL.formatDateDB(getAttribute("BOOKING_DATE_TO").getString()));
                resultSetHistory.updateString("DESPATCH_DATE", EITLERPGLOBAL.formatDateDB(getAttribute("DESPATCH_DATE").getString()));
                
                resultSetHistory.updateString("SELECTED_FLAG",ObjFeltFinishingDetails.getAttribute("SELECTED_FLAG").getString());
                resultSetHistory.updateString("PIECE_NO", ObjFeltFinishingDetails.getAttribute("PIECE_NO").getString());
                ...
                resultSetHistory.updateString("UPN", ObjFeltFinishingDetails.getAttribute("UPN").getString());
                ...
                resultSetHistory.updateString("MACHINE_NO", ObjFeltFinishingDetails.getAttribute("MACHINE_NO").getString());
                resultSetHistory.updateString("POSITION_NO", ObjFeltFinishingDetails.getAttribute("POSITION_NO").getString());
                resultSetHistory.updateString("POSITION_DESC", ObjFeltFinishingDetails.getAttribute("POSITION_DESC").getString());                
                resultSetHistory.updateString("PRODUCT_CODE", ObjFeltFinishingDetails.getAttribute("PRODUCT_CODE").getString());
                resultSetHistory.updateString("PRODUCT_GROUP", ObjFeltFinishingDetails.getAttribute("PRODUCT_GROUP").getString());
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 631; 
            ...
            ObjFeltProductionApprovalFlow.TableName = "PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY";
            ...
            if (ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER,PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY SET PR_RATE_INDICATOR = 'OLD', PR_RATE_IND_DESPATCH_DATE = DESPATCH_DATE WHERE PR_PIECE_NO = PIECE_NO AND APPROVED =1 AND SELECTED_FLAG =1 AND DOC_NO ='" + getAttribute("DOC_NO").getString() + "'");
            }
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY_H WHERE DOC_NO='" + getAttribute("DOC_NO").getString() + "'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='" + getAttribute("DOC_NO").getString() + "'");
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY SET REJECTED=0,CHANGED=1 WHERE DOC_NO='" + getAttribute("DOC_NO").getString() + "'");
            ...
            // Update Table To confirm updation has completed
            if (ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ObjFeltProductionApprovalFlow.finalApproved = false;
                data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER,PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY SET PR_RATE_INDICATOR = 'OLD', PR_RATE_IND_DESPATCH_DATE = DESPATCH_DATE WHERE PR_PIECE_NO = PIECE_NO AND APPROVED =1 AND SELECTED_FLAG =1 AND DOC_NO ='" + getAttribute("DOC_NO").getString() + "'");
            }
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=631 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='" + documentNo + "'";
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT * FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE 1=1 " + stringFindQuery + " GROUP BY DOC_NO ORDER BY DOC_NO ";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            String str = "SELECT * FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO = '" + docNo + "' AND DOC_DATE = '" + docDate + "' ORDER BY GROUP_CODE,PARTY_CODE,PIECE_NO";
            ...
            while (!resultSetTemp.isAfterLast()) {
                ...
                setAttribute("PIECE_NO_HEADER", resultSetTemp.getString("PIECE_NO_HEADER"));
                setAttribute("PARTY_CODE_HEADER", resultSetTemp.getString("PARTY_CODE_HEADER"));
                setAttribute("PARTY_NAME_HEADER", resultSetTemp.getString("PARTY_NAME_HEADER"));
                setAttribute("UPN_HEADER", resultSetTemp.getString("UPN_HEADER"));
                setAttribute("GROUP_CODE_HEADER", resultSetTemp.getString("GROUP_CODE_HEADER"));
                setAttribute("GROUP_NAME_HEADER", resultSetTemp.getString("GROUP_NAME_HEADER"));
                setAttribute("BOOKING_DATE_FROM", resultSetTemp.getString("BOOKING_DATE_FROM"));
                setAttribute("BOOKING_DATE_TO", resultSetTemp.getString("BOOKING_DATE_TO"));
                setAttribute("DESPATCH_DATE", resultSetTemp.getString("DESPATCH_DATE"));
                
                ObjFeltFinishingDetails.setAttribute("SELECTED_FLAG", resultSetTemp.getString("SELECTED_FLAG"));
                ObjFeltFinishingDetails.setAttribute("PIECE_NO", resultSetTemp.getString("PIECE_NO"));
                ...
                ObjFeltFinishingDetails.setAttribute("UPN", resultSetTemp.getString("UPN"));
                ...
                ObjFeltFinishingDetails.setAttribute("MACHINE_NO", resultSetTemp.getString("MACHINE_NO"));
                ObjFeltFinishingDetails.setAttribute("POSITION_NO", resultSetTemp.getString("POSITION_NO"));
                ObjFeltFinishingDetails.setAttribute("POSITION_DESC", resultSetTemp.getString("POSITION_DESC"));
                ObjFeltFinishingDetails.setAttribute("PRODUCT_CODE", resultSetTemp.getString("PRODUCT_CODE"));
                ObjFeltFinishingDetails.setAttribute("PRODUCT_GROUP", resultSetTemp.getString("PRODUCT_GROUP"));
    ...
    public static HashMap getHistoryList(String DocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY_H WHERE DOC_NO='" + DocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltRateEligibility ObjFeltFinishing = new clsFeltRateEligibility();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY_H WHERE DOC_NO='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT DISTINCT PI.DOC_NO,PI.DOC_DATE,SUBSTRING(RECEIVED_DATE,1,10) AS RECEIVED_DATE,CONCAT(PARTY_CODE_HEADER,GROUP_CODE_HEADER,UPN_HEADER,PIECE_NO_HEADER) AS SANCTION_ON,CONCAT(PARTY_NAME_HEADER,GROUP_NAME_HEADER) AS SANCTION_NAME FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY PI,PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=631 AND PI.CANCELED=0 ORDER BY RECEIVED_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT DISTINCT PI.DOC_NO,PI.DOC_DATE,SUBSTRING(RECEIVED_DATE,1,10) AS RECEIVED_DATE,CONCAT(PARTY_CODE_HEADER,GROUP_CODE_HEADER,UPN_HEADER,PIECE_NO_HEADER) AS SANCTION_ON,CONCAT(PARTY_NAME_HEADER,GROUP_NAME_HEADER) AS SANCTION_NAME FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY PI,PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=631 AND PI.CANCELED=0 ORDER BY PI.DOC_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocNo) {
                strSQL = "SELECT DISTINCT PI.DOC_NO,PI.DOC_DATE,SUBSTRING(RECEIVED_DATE,1,10) AS RECEIVED_DATE,CONCAT(PARTY_CODE_HEADER,GROUP_CODE_HEADER,UPN_HEADER,PIECE_NO_HEADER) AS SANCTION_ON,CONCAT(PARTY_NAME_HEADER,GROUP_NAME_HEADER) AS SANCTION_NAME FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY PI,PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=631 AND PI.CANCELED=0 ORDER BY PI.DOC_NO";
            }
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltRateEligibility ObjDoc = new clsFeltRateEligibility();

                //------------- Header Fields --------------------//
                ObjDoc.setAttribute("DOC_NO", rsTmp.getString("DOC_NO"));
                ObjDoc.setAttribute("DOC_DATE", rsTmp.getString("DOC_DATE"));
                ObjDoc.setAttribute("RECEIVED_DATE", rsTmp.getString("RECEIVED_DATE"));
                ObjDoc.setAttribute("SANCTION_ON", rsTmp.getString("SANCTION_ON"));
                ObjDoc.setAttribute("SANCTION_NAME", rsTmp.getString("SANCTION_NAME"));
    ...
    public static void CancelDoc(String pDocNo) {
        ...
        if (CanCancel(pDocNo)) {
            ...
            try {
                rsTmp = data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='" + pDocNo + "' ");
                rsTmp.first();
                ...
                if (!Approved) {
                    data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE DOC_NO='" + pDocNo + "' AND MODULE_ID=631");
                }
                data.Execute("UPDATE PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE DOC_NO='" + pDocNo + "'");
    ...
    public static boolean CanCancel(String pDocNo) {
        ...
        try {
            ...
            System.out.println("SELECT DOC_NO FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='" + pDocNo + "'  AND APPROVED=0 AND CANCELED=0");
            rsTmp = stTmp.executeQuery("SELECT DOC_NO FROM PRODUCTION.FELT_SPECIAL_RATE_SANCTION_ELIGIBILITY WHERE DOC_NO='" + pDocNo + "'  AND APPROVED=0 AND CANCELED=0");
