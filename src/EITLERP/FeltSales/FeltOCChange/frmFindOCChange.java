...
public class frmFindOCChange extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        PieceNo = new javax.swing.JTextField();

        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setText("Find :: Felt Sales OC Month Update");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 7, 370, 15);
        ...
        PARTY_CODE.setBounds(110, 60, 160, 30);

        jLabel9.setText("Party Code");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(10, 60, 100, 30);

        jLabel10.setText("Piece No");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(10, 100, 100, 30);

        PieceNo.setToolTipText("Press F1 key for search Party Code");
        PieceNo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                PieceNoFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                PieceNoFocusLost(evt);
            }
        });
        PieceNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                PieceNoKeyTyped(evt);
            }
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PieceNoKeyPressed(evt);
            }
        });
        jPanel1.add(PieceNo);
        PieceNo.setBounds(110, 100, 160, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(10, 30, 290, 150);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" OC_DOC_NO ='"+ docNo +"'";
            flag=true;
        }
        boolean flag2=false;
        ...
        if(!PieceNo.getText().trim().equals(""))
        {
            if(flag || flag2)
            {
                stringFindQuery = stringFindQuery+" AND PIECE_NO = "+PieceNo.getText();
            }
            else
            {
                stringFindQuery = " PIECE_NO ='"+PieceNo.getText()+"'";
            }
        }
        getParent().getParent().getParent().getParent().show(false);
    ...
    private void PieceNoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_PieceNoFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_PieceNoFocusGained

    private void PieceNoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_PieceNoFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_PieceNoFocusLost

    private void PieceNoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PieceNoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_PieceNoKeyTyped

    private void PieceNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PieceNoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PieceNoKeyPressed
        
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField PARTY_CODE;
    private javax.swing.JTextField PieceNo;
