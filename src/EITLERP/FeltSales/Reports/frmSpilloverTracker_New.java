 ...
 * @author Dharmendra
 */
public class frmSpilloverTracker_New extends javax.swing.JApplet {
...
//        setSize(scrwidth, scrheight);
    ...
    private void GenerateCombo() {
        ...
        try {
            ResultSet rs = data.getResult("SELECT DISTINCT OC_MONTH FROM PRODUCTION.SPILLOVER_OC_REPORT_NEW WHERE SP_MONTH_DATE<=LAST_DAY(CURDATE()) ORDER BY OC_MONTH_DATE DESC");
            rs.first();
    ...
    private void GenerateData() {
        ...
        try {
            ...
            String str = "SELECT DISTINCT OC_MONTH FROM PRODUCTION.SPILLOVER_OC_REPORT_NEW "
...
//            System.out.println(str);
            ...
            if (rsTmp.getRow() > 0) {
                while (!rsTmp.isAfterLast()) {
                    ...
                    String str1 = "SELECT * FROM PRODUCTION.SPILLOVER_OC_REPORT_NEW "
...
//                            DataModel.addRow(rowData);
                            ...
                            rowData[0] = "";
                            rowData[1] = "Diff";
                            rowData[2] = UtilFunctions.getInt(rsTmpD, "RSC_TOTAL", 0) - UtilFunctions.getInt(rsTmpD, "ASC_TOTAL", 0);
                            if (cmbOCMonth.getSelectedItem().toString().equalsIgnoreCase("Mar - 2021")) {
                                rowData[3] = "";
                            } else {
                                rowData[3] = UtilFunctions.getInt(rsTmpD, "RSC_MAR_P", 0) - UtilFunctions.getInt(rsTmpD, "ASC_MAR_P", 0);
                            }
                            rowData[4] = UtilFunctions.getInt(rsTmpD, "RSC_APR", 0) - UtilFunctions.getInt(rsTmpD, "ASC_APR", 0);
                            rowData[5] = UtilFunctions.getInt(rsTmpD, "RSC_MAY", 0) - UtilFunctions.getInt(rsTmpD, "ASC_MAY", 0);
                            rowData[6] = UtilFunctions.getInt(rsTmpD, "RSC_JUN", 0) - UtilFunctions.getInt(rsTmpD, "ASC_JUN", 0);
                            rowData[7] = UtilFunctions.getInt(rsTmpD, "RSC_JUL", 0) - UtilFunctions.getInt(rsTmpD, "ASC_JUL", 0);
                            rowData[8] = UtilFunctions.getInt(rsTmpD, "RSC_AUG", 0) - UtilFunctions.getInt(rsTmpD, "ASC_AUG", 0);
                            rowData[9] = UtilFunctions.getInt(rsTmpD, "RSC_SEP", 0) - UtilFunctions.getInt(rsTmpD, "ASC_SEP", 0);
                            rowData[10] = UtilFunctions.getInt(rsTmpD, "RSC_OCT", 0) - UtilFunctions.getInt(rsTmpD, "ASC_OCT", 0);
                            rowData[11] = UtilFunctions.getInt(rsTmpD, "RSC_NOV", 0) - UtilFunctions.getInt(rsTmpD, "ASC_NOV", 0);
                            rowData[12] = UtilFunctions.getInt(rsTmpD, "RSC_DEC", 0) - UtilFunctions.getInt(rsTmpD, "ASC_DEC", 0);
                            rowData[13] = UtilFunctions.getInt(rsTmpD, "RSC_JAN", 0) - UtilFunctions.getInt(rsTmpD, "ASC_JAN", 0);
                            rowData[14] = UtilFunctions.getInt(rsTmpD, "RSC_FEB", 0) - UtilFunctions.getInt(rsTmpD, "ASC_FEB", 0);
                            rowData[15] = UtilFunctions.getInt(rsTmpD, "RSC_MAR", 0) - UtilFunctions.getInt(rsTmpD, "ASC_MAR", 0);
                            rowData[16] = UtilFunctions.getInt(rsTmpD, "RSC_NEXT_YEAR", 0) - UtilFunctions.getInt(rsTmpD, "ASC_NEXT_YEAR", 0);
                            rowData[17] = EITLERPGLOBAL.getCurrentDateTimeDB();
