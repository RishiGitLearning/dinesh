...
public class frmFeltInvReasonRpt extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Felt Post Invoice Process Report (with Rejection Remark)");
        jPanel1.add(jLabel3);
    ...
    private void PreviewReport() {
        ...
        try {
            ...
            strSQL += "COALESCE(DATE_FORMAT(SUBSTRING(PROCESSING_TIME,1,10),'%d/%m/%Y'),'') AS PROCESS_DATE, ";
            ...
            rpt.setReportName("/EITLERP/FeltSales/Reports/FeltPostInvReason.jrxml", 1, strSQL); //productlist is the name of my jasper file.
            rpt.callReport();
