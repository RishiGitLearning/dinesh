...
public class frmInvoiceParameterCancel extends javax.swing.JApplet {

    private int EditMode = 0;
    private clsParameterCancel ObjDoc;
    ...
    public frmInvoiceParameterCancel() {
    ...
    public void init() {
        ...
        if (getName().equals("Link")) {
            ...
            if (ObjDoc.LoadData(EITLERPGLOBAL.gCompanyID, 754)) {
                ObjDoc.MoveLast();
                DisplayData();
            } else {
            }
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" INVOICE PARAMETER MODIFICATION CANCELLATION REQUISITION");
        ...
        Tab1.add(txtDocNo);
        txtDocNo.setBounds(120, 10, 104, 27);
    ...
    private void cmdOpenDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOpenDocActionPerformed
        ...
        if ((!txtInvoiceNo.getText().equals(""))) {
            ...
            AppletFrame aFrame = new AppletFrame("Felt Invoice Parameter Cancel");
            aFrame.startAppletEx("EITLERP.FeltSales.FeltGSTAdvancePaymentEntryForm.frmFeltGSTAdvancePaymentEntryForm", "Felt Invoice Parameter Cancel");
    ...
    private void cmdNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNewActionPerformed
        // TODO add your handling code here:
        Add();
         lblStatus.setText("Press F1 for Doc No");  
    ...
    private void txtInvoiceNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtInvoiceNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            //aList.SQL = "SELECT DOC_NO,BALE_NO,PARTY_CODE,PARTY_NAME FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE APPROVED=1 AND CANCELED=0";
            aList.SQL = "SELECT A.DOC_NO,A.BALE_NO,A.PARTY_CODE,A.PARTY_NAME FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST A,PRODUCTION.FELT_PKG_SLIP_HEADER B WHERE A.APPROVED=1 AND A.CANCELED=0 AND A.PROCESSING_DATE>=CURDATE() AND PKG_BALE_NO=BALE_NO";
            // aList.SQL = "SELECT A.DOC_NO,A.BALE_NO,A.PARTY_CODE,A.PARTY_NAME FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST A,PRODUCTION.FELT_PKG_SLIP_HEADER B WHERE PKG_BALE_NO=BALE_NO";
            aList.ReturnCol = 1;
            ...
            if (aList.ShowLOV()) {
                ...
                //}
                txtInvoiceDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT DOC_DATE FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE DOC_NO='" + aList.ReturnVal + "' ORDER BY DOC_DATE DESC")));
                txtPartyCode.setText(data.getStringValueFromDB("SELECT PARTY_CODE FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE DOC_NO='" + aList.ReturnVal + "' ORDER BY DOC_DATE DESC"));
                txtPartyName.setText(data.getStringValueFromDB("SELECT PARTY_NAME FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE DOC_NO='" + aList.ReturnVal + "' ORDER BY DOC_DATE DESC"));
                txtBaleNo.setText(data.getStringValueFromDB("SELECT BALE_NO FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE DOC_NO='" + aList.ReturnVal + "' ORDER BY DOC_DATE DESC"));
//            txtBaleDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PACKING_DATE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+aList.ReturnVal+"' ORDER BY INVOICE_DATE DESC")));
    ...
    lblStatus.setText("Press F1 for Doc No");        // TODO add your handling code here:
    ...
    private void DisplayData() {
        ...
        lblTitle.setText("INVOICE PARAMETER MODIFICATION CANCELLATION REQUISITION - " + txtDocNo.getText());
        ...
        txtPartyCode.setText(data.getStringValueFromDB("SELECT PARTY_CODE FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE DOC_NO='" + (String) ObjDoc.getAttribute("DOC_NO").getObj() + "'"));
        ...
        txtBaleNo.setText(data.getStringValueFromDB("SELECT BALE_NO FROM PRODUCTION.FELT_INV_PROCESS_VAR_GST WHERE DOC_NO='" + (String) ObjDoc.getAttribute("DOC_NO").getObj() + "'"));
        //txtBaleDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PACKING_DATE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+(String)ObjDoc.getAttribute("DOC_NO").getObj()+"'")));
        ...
        List = clsFeltProductionApprovalFlow.getDocumentFlow(761, DocNo);
        ...
        FormatGridHS();
        HashMap History = clsParameterCancel.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
        for (int i = 1; i <= History.size(); i++) {
            clsParameterCancel ObjHistory = (clsParameterCancel) History.get(Integer.toString(i));
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=761 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=761 ");
        }
        for (int i = 1; i <= List.size(); i++) {
        ...
        strCondition = " WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID) + " AND MODULE_ID=" + clsFeltGSTAdvancePaymentEntryForm.ModuleID + " ORDER BY MODULE_ID";
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = clsFeltProductionApprovalFlow.getRemainingUsers(761, (String) ObjDoc.getAttribute("REQ_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(clsFeltGSTAdvancePaymentEntryForm.ModuleID, (String) ObjDoc.getAttribute("REQ_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(clsFeltGSTAdvancePaymentEntryForm.ModuleID, FromUserID, (String) ObjDoc.getAttribute("REQ_NO").getObj());
    ...
    //            else {
    //
    //                int FromUserID=clsFeltProductionApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, 761 ,(String)ObjDoc.getAttribute("REQ_NO").getObj());
    //                lnFromID=FromUserID;
    //                String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
    //                String strFromRemarks=clsFeltProductionApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,761,FromUserID,(String)ObjDoc.getAttribute("REQ_NO").getObj());
    //
    //                txtFrom.setText(strFromUser);
    //                txtFromRemarks.setText(strFromRemarks);
    //            }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6106, 61061)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6106, 61063)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6106, 61065)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        if (aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 761, FFNo, false));
    ...
    private void Edit() {
        ...
        if (ObjDoc.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(761, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 61062)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        if (!clsFeltGSTAdvancePaymentEntryForm.IsFinalDocExist(txtInvoiceNo.getText().trim())) {
            JOptionPane.showMessageDialog(null, "Doc No.not exists.");
            return;
        }

        boolean CanCancel = false;

        if (EITLERPGLOBAL.getComboCode(cmbModule) == clsFeltGSTAdvancePaymentEntryForm.ModuleID) {
            CanCancel = clsFeltGSTAdvancePaymentEntryForm.CanCancel(EITLERPGLOBAL.gCompanyID, txtInvoiceNo.getText().trim());
        }

        if (!CanCancel) {
            JOptionPane.showMessageDialog(null, "Doc no. you entered is invalid. Please verify");
            return;
        }
    ...
    private void Find() {
        ...
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.FeltGSTAdvancePaymentEntryForm.frmInvoiceParameterCancelFind", true);
        frmInvoiceParameterCancelFind ObjReturn = (frmInvoiceParameterCancelFind) ObjLoader.getObj();
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(761, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(761, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            String DocNo = (String) ObjDoc.getAttribute("REQ_NO").getObj();
            int Creator = clsFeltProductionApprovalFlow.getCreator(761, DocNo);
