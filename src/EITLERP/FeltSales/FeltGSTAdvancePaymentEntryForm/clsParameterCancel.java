...
public class clsParameterCancel {

    public static HashMap getPendingApprovals(int i, int SorOn) {
    ...
    public static HashMap getHistoryList(int pCompanyID,String pDocNo) {
        ...
        try {
            ...
            while(rsTmp.next()) {
                clsParameterCancel ObjDoc=new clsParameterCancel();
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("REQ_NO",clsFirstFree.getNextFreeNo((int)EITLERPGLOBAL.gCompanyID,761, (int)getAttribute("FFNO").getVal(),true));
            //-------------------------------------------------
            ...
            rsResultSet.updateString("REJECTED_DATE",EITLERPGLOBAL.getCurrentDateDB());
            ...
            rsHistory.updateString("REJECTED_DATE",EITLERPGLOBAL.getCurrentDateDB());
            ...
            ObjFlow.ModuleID=761; //Doc. Cancel Request
...
//          }
            ...
            if(AppStatus.equals("F")) {
                if ((int)getAttribute("MODULE_ID").getVal() == clsFeltGSTAdvancePaymentEntryForm.ModuleID) {
                    clsFeltGSTAdvancePaymentEntryForm.CancelDoc(EITLERPGLOBAL.gCompanyID,(String)getAttribute("DOC_NO").getObj());
                }
            }
    ...
    public boolean Update() {
        ...
        try {
            ...
            if(IsRejected) {
                ...
                //Remove Old Records from PRODUCTION.FELT_PROD_DOC_DATA
                data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=761 AND DOC_NO='"+ObjFlow.DocNo+"'");
            ...
            if(AppStatus.equals("F")) {
                if (getAttribute("MODULE_ID").getInt() == clsFeltGSTAdvancePaymentEntryForm.ModuleID) {
                    clsFeltGSTAdvancePaymentEntryForm.CancelDoc(EITLERPGLOBAL.gCompanyID, (String)getAttribute("DOC_NO").getObj());
                }
            }
            //===============================//
    ...
    public boolean CanDelete(int pCompanyID,String pDocNo,int pUserID) {
        ...
        try {
            ...
            if(rsTmp.getInt("COUNT")>0)  //Item is Approved
            {
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=761 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND TYPE='C' AND STATUS='W'";
                tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean IsEditable(int pCompanyID,String pDocNo,int pUserID) {
        ...
        try {
            ...
            if(rsTmp.getInt("COUNT")>0)  //Item is Approved
            {
                ...
                strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=761 AND DOC_NO='"+pDocNo+"' AND USER_ID="+Integer.toString(pUserID)+" AND STATUS='W'";
                tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                rsTmp=tmpStmt.executeQuery(strSQL);
                rsTmp.first();
