...
public class searchkey extends javax.swing.JApplet {
    ...
    private void txtSearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyTyped
        ...
        SQL = "SELECT MM_MACHINE_NO,MM_MACHINE_POSITION,MM_MACHINE_POSITION_DESC FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL where CONCAT(MM_COMBINATION_CODE,MM_FELT_LENGTH,MM_FELT_WIDTH,MM_FELT_GSM) like '"+mscrhtxt+"%' AND MM_MACHINE_NO!='' GROUP BY  MM_MACHINE_NO,MM_MACHINE_POSITION";
        tempSQL = SQL;
        System.out.println("SELECT MM_MACHINE_NO,MM_MACHINE_POSITION,MM_MACHINE_POSITION_DESC FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL where CONCAT(MM_COMBINATION_CODE,MM_FELT_LENGTH,MM_FELT_WIDTH,MM_FELT_GSM) like '"+mscrhtxt+"%'  AND MM_MACHINE_NO!='' GROUP BY  MM_MACHINE_NO,MM_MACHINE_POSITION");
        QueryCode = mnwtxt;
        ...
        try {
            if (evt.getKeyCode() == 10) //Enter key pressed
            {
                if (Table.getRowCount() <= 0) {
                    ...
                    ThirdVal = (String) DataModel.getValueAt(Table.getSelectedRow(), 2); 
                    ...
                    try {
                        if (SecondCol >= 0) {
                            ...
                            SecondVal = (String) DataModel.getValueAt(Table.getSelectedRow(), SecondCol - 1);
                            ThirdVal = (String) DataModel.getValueAt(Table.getSelectedRow(), SecondCol); 
                        }
                    } catch (Exception e) {
