...
public class frmInvoiceCancel extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        if (getName().equals("Link")) {
            ...
            if (ObjDoc.LoadData(EITLERPGLOBAL.gCompanyID, 80)) {
                ObjDoc.MoveLast();
                DisplayData();
            } else {
            }
    ...
    private void initComponents() {
        ...
        txtInvoiceNo = new JTextFieldHint(new JTextField(),"Search by F1");
        ...
        lblTitle.setText(" INVOICE CANCELLATION REQUISITION");
        ...
        Tab1.add(cmbForDept);
        cmbForDept.setBounds(115, 88, 212, 27);

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Dept. :");
        jLabel5.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        Tab1.add(jLabel5);
        jLabel5.setBounds(5, 91, 105, 17);
        ...
        Tab1.add(cmdNext1);
        cmdNext1.setBounds(536, 356, 102, 29);

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("User :");
        jLabel7.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        Tab1.add(jLabel7);
        jLabel7.setBounds(5, 127, 105, 17);

        cmbUser.setEnabled(false);
        cmbUser.setName("USER_ID"); // NOI18N
        Tab1.add(cmbUser);
        cmbUser.setBounds(115, 120, 214, 27);

        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(240, 15, 44, 17);
        ...
        cmdPurposeBig.setBounds(470, 260, 33, 21);
        ...
        cmdRemarksBig.setBounds(470, 310, 33, 21);

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("Invoice No. :");
        Tab1.add(jLabel1);
        jLabel1.setBounds(0, 160, 105, 17);

        txtInvoiceNo.setEnabled(false);
        txtInvoiceNo.setName("DOC_NO"); // NOI18N
        ...
        txtInvoiceNo.setBounds(110, 160, 100, 20);
        ...
        Tab1.add(cmdOpenDoc);
        cmdOpenDoc.setBounds(460, 150, 138, 29);

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Invoice Date :");
        Tab1.add(jLabel10);
        jLabel10.setBounds(210, 160, 100, 17);
        jLabel10.getAccessibleContext().setAccessibleName("Doc. Date");

        txtInvoiceDate.setEditable(false);
        txtInvoiceDate.setEnabled(false);
        txtInvoiceDate.setName("DOC_NO"); // NOI18N
        Tab1.add(txtInvoiceDate);
        txtInvoiceDate.setBounds(320, 160, 100, 20);

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Bale No. :");
        Tab1.add(jLabel11);
        jLabel11.setBounds(0, 220, 105, 17);

        txtBaleNo.setEditable(false);
        txtBaleNo.setEnabled(false);
        txtBaleNo.setName("DOC_NO"); // NOI18N
        Tab1.add(txtBaleNo);
        txtBaleNo.setBounds(110, 220, 100, 20);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Packing Date :");
        Tab1.add(jLabel12);
        jLabel12.setBounds(210, 220, 100, 17);

        txtBaleDate.setEditable(false);
        txtBaleDate.setEnabled(false);
        txtBaleDate.setName("DOC_NO"); // NOI18N
    ...
    private void cmdOpenDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOpenDocActionPerformed
        // TODO add your handling code here:
        if ((!txtInvoiceNo.getText().equals("")) && (!txtInvoiceDate.getText().equals(""))) {
            String DocNo = txtInvoiceNo.getText().trim();
            String DocDate = EITLERPGLOBAL.formatDateDB(txtInvoiceDate.getText().trim());
            ...
            frmFeltSalesInvoice ObjItem = (frmFeltSalesInvoice) aFrame.ObjApplet;
    ...
    private void txtInvoiceNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtInvoiceNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            //aList.SQL="SELECT INVOICE_NO,H.PARTY_CODE,PARTY_NAME,BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER H, DINESHMILLS.D_SAL_PARTY_MASTER P WHERE H.PARTY_CODE=P.PARTY_CODE AND H.APPROVED=1 AND H.CANCELLED=0 AND SUBSTRING(H.INVOICE_DATE,1,10)>=DATE(CURDATE()-2) AND SUBSTRING(H.INVOICE_DATE,1,10)<=CURDATE() AND P.MAIN_ACCOUNT_CODE=210010 AND P.APPROVED=1 AND P.CANCELLED=0";
//            aList.SQL="SELECT INVOICE_NO,SUBSTRING(H.INVOICE_DATE,1,10) AS INVOICE_DATE,H.PARTY_CODE,H.PARTY_NAME,BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER H, DINESHMILLS.D_SAL_PARTY_MASTER P WHERE H.PARTY_CODE=P.PARTY_CODE AND H.APPROVED=1 AND H.CANCELLED=0 AND H.APPROVED_DATE=CURDATE() AND P.MAIN_ACCOUNT_CODE=210010 AND P.APPROVED=1 AND P.CANCELLED=0";
//            aList.SQL="SELECT INVOICE_NO,INVOICE_DATE,PARTY_CODE,PARTY_NAME,BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE APPROVED=1 AND CANCELLED=0 AND APPROVED_DATE=CURDATE()";
//            aList.SQL="SELECT INVOICE_NO,INVOICE_DATE,PARTY_CODE,PARTY_NAME,BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE APPROVED=1 AND CANCELLED=0 AND APPROVED_DATE=CURDATE() UNION ALL SELECT INV.INVOICE_NO,INV.INVOICE_DATE,INV.PARTY_CODE,INV.PARTY_NAME,INV.BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER INV,PRODUCTION.FELT_SALES_INVOICE_EXCEPTION EXP WHERE APPROVED=1 AND CANCELLED=0 AND EXP.INVOICE_NO=INV.INVOICE_NO AND EXP.INVOICE_DATE = INV.INVOICE_DATE AND EXP.PARTY_CODE = INV.PARTY_CODE";
            aList.SQL = "SELECT INVOICE_NO,INVOICE_DATE,PARTY_CODE,PARTY_NAME,BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE APPROVED=1 AND CANCELLED=0 AND INVOICE_DATE>=CURDATE() + INTERVAL -8 DAY UNION ALL SELECT INV.INVOICE_NO,INV.INVOICE_DATE,INV.PARTY_CODE,INV.PARTY_NAME,INV.BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER INV,PRODUCTION.FELT_SALES_INVOICE_EXCEPTION EXP WHERE APPROVED=1 AND CANCELLED=0 AND EXP.INVOICE_NO=INV.INVOICE_NO AND EXP.INVOICE_DATE = INV.INVOICE_DATE AND EXP.PARTY_CODE = INV.PARTY_CODE";
            aList.ReturnCol = 1;
            aList.SecondCol = 2;
...
//            //}
//            txtInvoiceDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT INVOICE_DATE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+aList.ReturnVal+"' ORDER BY INVOICE_DATE DESC")));
//            txtPartyCode.setText(data.getStringValueFromDB("SELECT PARTY_CODE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+aList.ReturnVal+"' ORDER BY INVOICE_DATE DESC"));
//            txtPartyName.setText(data.getStringValueFromDB("SELECT PARTY_NAME FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+aList.ReturnVal+"' ORDER BY INVOICE_DATE DESC"));
//            txtBaleNo.setText(data.getStringValueFromDB("SELECT BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+aList.ReturnVal+"' ORDER BY INVOICE_DATE DESC"));
//            txtBaleDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PACKING_DATE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='"+aList.ReturnVal+"' ORDER BY INVOICE_DATE DESC")));

                txtInvoiceDate.setText(aList.SecondVal);
                txtPartyCode.setText(data.getStringValueFromDB("SELECT PARTY_CODE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + aList.ReturnVal + "' AND INVOICE_DATE='" + EITLERPGLOBAL.formatDateDB(aList.SecondVal) + "'"));
                txtPartyName.setText(data.getStringValueFromDB("SELECT PARTY_NAME FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + aList.ReturnVal + "' AND INVOICE_DATE='" + EITLERPGLOBAL.formatDateDB(aList.SecondVal) + "'"));
                txtBaleNo.setText(data.getStringValueFromDB("SELECT BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + aList.ReturnVal + "' AND INVOICE_DATE='" + EITLERPGLOBAL.formatDateDB(aList.SecondVal) + "'"));
                txtBaleDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PACKING_DATE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + aList.ReturnVal + "' AND INVOICE_DATE='" + EITLERPGLOBAL.formatDateDB(aList.SecondVal) + "'")));
            }
        }
    ...
    private void DisplayData() {
        ...
        lblTitle.setText("INVOICE CANCELLATION REQUISITION - " + txtDocNo.getText());
        lblRevNo.setText(Integer.toString((int) ObjDoc.getAttribute("REVISION_NO").getVal()));
        txtInvoiceNo.setText((String) ObjDoc.getAttribute("DOC_NO").getObj());
        txtInvoiceDate.setText(EITLERPGLOBAL.formatDate((String) ObjDoc.getAttribute("DOC_DATE").getObj()));
        ...
        txtPartyCode.setText(data.getStringValueFromDB("SELECT PARTY_CODE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + (String) ObjDoc.getAttribute("DOC_NO").getObj() + "' AND INVOICE_DATE='" + (String) ObjDoc.getAttribute("DOC_DATE").getObj() + "'"));
        txtPartyName.setText(data.getStringValueFromDB("SELECT PARTY_NAME FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE='" + txtPartyCode.getText().trim() + "' AND MAIN_ACCOUNT_CODE=210010 AND APPROVED=1 AND CANCELLED=0"));
        txtBaleNo.setText(data.getStringValueFromDB("SELECT BALE_NO FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + (String) ObjDoc.getAttribute("DOC_NO").getObj() + "' AND INVOICE_DATE='" + (String) ObjDoc.getAttribute("DOC_DATE").getObj() + "'"));
        txtBaleDate.setText(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PACKING_DATE FROM PRODUCTION.FELT_SAL_INVOICE_HEADER WHERE INVOICE_NO='" + (String) ObjDoc.getAttribute("DOC_NO").getObj() + "' AND INVOICE_DATE='" + (String) ObjDoc.getAttribute("DOC_DATE").getObj() + "'")));
        ...
        List = clsFeltProductionApprovalFlow.getDocumentFlow(610, DocNo);
    ...
    private void SetData() {
        ...
        ObjDoc.setAttribute("DOC_NO", txtInvoiceNo.getText());
        ObjDoc.setAttribute("DOC_DATE", EITLERPGLOBAL.formatDateDB(txtInvoiceDate.getText()));
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=610 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=610 ");
        }
        for (int i = 1; i <= List.size(); i++) {
        ...
        strCondition = " WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID) + " AND MODULE_ID=" + clsFeltSalesInvoice.ModuleID + " ORDER BY MODULE_ID";
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = clsFeltProductionApprovalFlow.getRemainingUsers(610, (String) ObjDoc.getAttribute("REQ_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(clsFeltSalesInvoice.ModuleID, (String) ObjDoc.getAttribute("REQ_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(clsFeltSalesInvoice.ModuleID, FromUserID, (String) ObjDoc.getAttribute("REQ_NO").getObj());
    ...
    //            else {
    //
    //                int FromUserID=clsFeltProductionApprovalFlow.getFromID((int)EITLERPGLOBAL.gCompanyID, 610 ,(String)ObjDoc.getAttribute("REQ_NO").getObj());
    //                lnFromID=FromUserID;
    //                String strFromUser=clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
    //                String strFromRemarks=clsFeltProductionApprovalFlow.getFromRemarks( (int)EITLERPGLOBAL.gCompanyID,610,FromUserID,(String)ObjDoc.getAttribute("REQ_NO").getObj());
    //
    //                txtFrom.setText(strFromUser);
    //                txtFromRemarks.setText(strFromRemarks);
    //            }
    ...
    //
    //            if(EditMode!=EITLERPGLOBAL.ADD) {
    //                int FinalApprover=clsFeltProductionApprovalFlow.getFinalApprover(EITLERPGLOBAL.gCompanyID, SelModule, txtDoc.getText());
    ...
    //                else {
    //                    if(FinalApprover==0) {
    //                        int WaitingUser=clsFeltProductionApprovalFlow.getWaitingUser(EITLERPGLOBAL.gCompanyID, SelModule,txtDoc.getText());
    //                        clsUser objUser=new clsUser();
    //
    //                        SelHierarchyID=EITLERPGLOBAL.getComboCode(cmbHierarchy);
    //
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6105, 61051)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6105, 61053)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6105, 61055)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        if (aList.ShowList()) {
            ...
            txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 610, FFNo, false));
            ...
            GenerateDeptCombo();
            GenerateUserCombo();
            EITLERPGLOBAL.setComboIndex(cmbUser, EITLERPGLOBAL.gNewUserID);
        } else {
    ...
    private void Edit() {
        ...
        if (ObjDoc.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(610, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 61052)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        //Check that Invoice no. is entered and is valid no.
        if (txtInvoiceNo.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter the Invoice no. to be cancelled");
            return;
        }

        if (txtInvoiceDate.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter the Invoice Date to be cancelled");
            return;
        }
        ...
        if (!clsFeltSalesInvoice.IsFinalDocExist(EITLERPGLOBAL.gCompanyID, txtInvoiceNo.getText().trim(), EITLERPGLOBAL.formatDateDB(txtInvoiceDate.getText().trim()))) {
        ...
        if (EITLERPGLOBAL.getComboCode(cmbModule) == clsFeltSalesInvoice.ModuleID) {
        ...
        if (!CanCancel) {
            JOptionPane.showMessageDialog(null, "Invoice no. you entered is invalid. Please verify");
            return;
        }
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            String DocDate = txtInvoiceDate.getText();

            try {
                ResultSet rsTmp = data.getResult("SELECT * FROM PRODUCTION.FELT_PROD_DOC_CANCEL_REQUEST WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + ModuleID + " AND DOC_NO='" + DocNo + "' AND DOC_DATE='" + EITLERPGLOBAL.formatDateDB(DocDate) + "' AND APPROVED=0 AND CANCELLED=0");
                rsTmp.first();
    ...
    private void Find() {
        ...
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.FeltInvReport.frmInvoiceCancelFind", true);
    ...
    public void FindWaiting() {
        ObjDoc.Filter(" WHERE REQ_NO IN(SELECT PRODUCTION.FELT_PROD_DOC_CANCEL_REQUEST.REQ_NO FROM PRODUCTION.FELT_PROD_DOC_CANCEL_REQUEST,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_CANCEL_REQUEST.REQ_NO=PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO AND PRODUCTION.FELT_PROD_DOC_CANCEL_REQUEST.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND PRODUCTION.FELT_PROD_DOC_DATA.MODULE_ID=610)", EITLERPGLOBAL.gCompanyID);
        ObjDoc.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(610, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(610, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            String DocNo = (String) ObjDoc.getAttribute("REQ_NO").getObj();
            int Creator = clsFeltProductionApprovalFlow.getCreator(610, DocNo);
    ...
    private void Notification() {
        if (OpgApprove.isSelected() || OpgFinal.isSelected()) {
            try {
                ...
                String invDate = txtInvoiceDate.getText();
                ...
                String pSubject = "Notification : Felt Invoice Cancellation Doc No : " + docNo;
                String pMessage = "";
                String cc = "";

                if (!OpgFinal.isSelected()) {
                    pMessage = "<br>Invoice Cancellation Doc No : " + docNo + " has been approve and forward by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, userId) + ".<br><br>";
                } else {
                    pMessage = "<br>Invoice Cancellation Doc No : " + docNo + " has been final approved by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, userId) + ".<br><br>";
                }

                pMessage = pMessage + "<br>Doc Date : " + docDate + "";
                pMessage = pMessage + "<br>Invoice No : " + invNo + "";
                pMessage = pMessage + "<br>Invoice Date : " + invDate + "";
                pMessage = pMessage + "<br>Party Code : " + partyCode + "";
                pMessage = pMessage + "<br>Party Name : " + partyName + "";
                pMessage = pMessage + "<br>Bale No : " + baleNo + "";
                pMessage = pMessage + "<br>Bale Date : " + baleDate + "";
                pMessage = pMessage + "<br><br>Purpose : " + purpose + "";
                pMessage = pMessage + "<br><br>Remark : " + remark + "";
                ...
                //recievers = recievers + "pramod@dineshmills.com,hcpatel@dineshmills.com,taxation1@dineshmills.com,bansi_audit@dineshmills.com,manoj@dineshmills.com,atulshah@dineshmills.com,vdshanbhag@dineshmills.com,rakeshdalal@dineshmills.com,feltsalesnotification@dineshmills.com";
                //Remove manoj@dineshmills.com by Dharmendra on 17-05-2019
                recievers = recievers + "pramod@dineshmills.com,excise@dineshmills.com,hcpatel@dineshmills.com,taxation1@dineshmills.com,bansi_audit@dineshmills.com,atulshah@dineshmills.com,vdshanbhag@dineshmills.com,rakeshdalal@dineshmills.com,feltwh@dineshmills.com,feltsalesnotification@dineshmills.com,hemantprajapati@dineshmills.com";
                cc = cc + "aditya@dineshmills.com";
