 ...
 */
public class frmFeltObsoleteStatus1 extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        cmbFinYear.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2019-2020", "2020-2021" }));
...
//                    + "SUM(CASE WHEN OPENING_DATE <= '"+fromYear+"-04-01' AND PIECE_STAGE NOT IN ('DIVERTED','DIVIDED','INVOICED','EXP-INVOICE') AND COALESCE(NEW_OBSOLETE_STATUS,'') != '' THEN 1 ELSE 0 END) + "
                    ...
                    + "SUM(CASE WHEN PIECE_STAGE IN ('DIVERTED','DIVIDED') AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' THEN 1 ELSE 0 END)- "
...
//                    + "ROUND(SUM(CASE WHEN OPENING_DATE <= '"+fromYear+"-04-01' AND PIECE_STAGE NOT IN ('DIVERTED','DIVIDED','INVOICED','EXP-INVOICE') AND COALESCE(NEW_OBSOLETE_STATUS,'') != '' THEN VALUE ELSE 0 END)/100000,2) + "
                    ...
                    + "ROUND(SUM(CASE WHEN PIECE_STAGE IN ('DIVERTED','DIVIDED') AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' THEN VALUE ELSE 0 END)/100000,2) - "
...
//                    + "SUM(CASE WHEN OPENING_DATE <= '"+fromYear+"-04-01' AND PIECE_STAGE NOT IN ('DIVERTED','DIVIDED','INVOICED','EXP-INVOICE','RETURN') AND COALESCE(NEW_OBSOLETE_STATUS,'') != '' THEN 1 ELSE 0 END) AS OPENING, "
//                    + "ROUND(SUM(CASE WHEN OPENING_DATE <= '"+fromYear+"-04-01' AND PIECE_STAGE NOT IN ('DIVERTED','DIVIDED','INVOICED','EXP-INVOICE','RETURN') AND COALESCE(NEW_OBSOLETE_STATUS,'') != '' THEN VALUE ELSE 0 END)/100000,2) AS OPENING_VALUE, "
                    + "SUM(CASE WHEN OBS_DIVERTED_DATE >= '"+fromYear+"-04-01' AND OBS_DIVERTED_DATE <= '"+toYear+"-03-31' AND OPENING_DATE != '2019-04-01'  THEN 1 ELSE 0 END) AS ADDITION, "
                    + "ROUND(SUM(CASE WHEN OBS_DIVERTED_DATE >= '"+fromYear+"-04-01' AND OBS_DIVERTED_DATE <= '"+toYear+"-03-31' AND OPENING_DATE != '2019-04-01'  THEN VALUE ELSE 0 END)/100000,2) AS ADDITION_VALUE, "
...
//                    + "SUM(CASE WHEN PIECE_STAGE IN ('DIVIDED')   AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE'  THEN 1 ELSE 0 END) AS DIVIDED_TO_WIP, "
//                    + "ROUND(SUM(CASE WHEN PIECE_STAGE IN ('DIVIDED')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' THEN VALUE ELSE 0 END)/100000,2) AS DIVIDED_TO_WIP_VALUE, "
                    + "SUM(CASE WHEN PIECE_STAGE IN ('INVOICED','EXP-INVOICE','RETURN')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' THEN 1 ELSE 0 END) AS INVOICED, "
                    + "ROUND(SUM(CASE WHEN PIECE_STAGE IN ('INVOICED','EXP-INVOICE','RETURN')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' THEN VALUE ELSE 0 END)/100000,2) AS INVOICED_VALUE, "
...
//                    + "SUM(CASE WHEN OPENING_DATE <= '"+fromYear+"-04-01' AND PIECE_STAGE NOT IN ('DIVERTED','DIVIDED','INVOICED','EXP-INVOICE','RETURN') AND COALESCE(NEW_OBSOLETE_STATUS,'') != '' THEN 1 ELSE 0 END) + "
                    + "SUM(CASE WHEN OBS_DIVERTED_DATE >= '"+fromYear+"-04-01' AND OBS_DIVERTED_DATE <= '"+toYear+"-03-31' AND OPENING_DATE != '2019-04-01'  THEN 1 ELSE 0 END) - "
                    ...
                    + "SUM(CASE WHEN PIECE_STAGE IN ('INVOICED','EXP-INVOICE','RETURN')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' THEN 1 ELSE 0 END) - "
...
//                    + "ROUND(SUM(CASE WHEN OPENING_DATE <= '"+fromYear+"-04-01' AND PIECE_STAGE NOT IN ('DIVERTED','DIVIDED','INVOICED','EXP-INVOICE','RETURN') AND COALESCE(NEW_OBSOLETE_STATUS,'') != '' THEN VALUE ELSE 0 END)/100000,2) + "
                    + "ROUND(SUM(CASE WHEN OBS_DIVERTED_DATE >= '"+fromYear+"-04-01' AND OBS_DIVERTED_DATE <= '"+toYear+"-03-31' AND OPENING_DATE != '2019-04-01'  THEN VALUE ELSE 0 END)/100000,2) - "
                    ...
                    + "ROUND(SUM(CASE WHEN PIECE_STAGE IN ('INVOICED','EXP-INVOICE','RETURN')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' THEN VALUE ELSE 0 END)/100000,2) - "
...
//                    + "ROUND(SUM(CASE WHEN PIECE_STAGE NOT IN ('INVOICED','EXP-INVOICE','DIVERTED','DIVIDED','RETURN')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' THEN VALUE ELSE 0 END)/100000,2) AS OBSOLETE_VALUE "
    ...
    private void GenerateDetailStockFin() {
        ...
        try {
            int FilterBy = EITLERPGLOBAL.getComboCode(cmbFilterStock);
            if (FilterBy == 0)
                filterBy += " WHERE OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            ...
            if (FilterBy == 2)
                filterBy += " WHERE OBSOLETE_DATE >= '"+fromYear+"-04-01' AND OBSOLETE_DATE <= '"+toYear+"-03-31' AND OPENING_DATE != '2019-04-01' ";
            if (FilterBy == 3)
                filterBy += " WHERE PIECE_STAGE IN ('DIVERTED')  AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 4)
                filterBy += " WHERE PIECE_STAGE IN ('DIVIDED')  AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 5)
                filterBy += " WHERE PIECE_STAGE IN ('INVOICED','EXP-INVOICE') AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 6)
                filterBy += " WHERE COALESCE(NEW_OBSOLETE_STATUS,'') = '' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
    ...
    private void GenerateDetailWIPFin() {
        ...
        try {
            ...
            if (FilterBy == 4)
                filterBy += " WHERE PIECE_STAGE IN ('DIVIDED')  AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 5)
                filterBy += " WHERE PIECE_STAGE IN ('JOINED')  AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 6)
                filterBy += " WHERE PIECE_STAGE IN ('CANCELED','SCRAP')  AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 7)
                filterBy += " WHERE PIECE_STAGE IN ('IN STOCK','BSR','INVOICED','EXP-INVOICE') AND NEW_OBSOLETE_STATUS = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 8)
                filterBy += " WHERE COALESCE(NEW_OBSOLETE_STATUS,'') = '' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
    ...
    private void GenerateDetailCSFin() {
        ...
        try {
            ...
            if (FilterBy == 2)
                filterBy += " WHERE OBS_DIVERTED_DATE >= '"+fromYear+"-04-01' AND OBS_DIVERTED_DATE <= '"+toYear+"-03-31' AND OPENING_DATE != '2019-04-01' ";
            if (FilterBy == 3)
                filterBy += " WHERE PIECE_STAGE IN ('DIVERTED')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 4)
                filterBy += " WHERE PIECE_STAGE IN ('DIVIDED')   AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 5)
                filterBy += " WHERE PIECE_STAGE IN ('INVOICED','EXP-INVOICE','RETURN')  AND COALESCE(NEW_OBSOLETE_STATUS,'') !='OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
            if (FilterBy == 6)
                filterBy += " WHERE COALESCE(NEW_OBSOLETE_STATUS,'') = 'OBSOLETE' AND OPENING_DATE >= '"+fromYear+"-04-01' AND OPENING_DATE <= '"+toYear+"-03-31' ";
