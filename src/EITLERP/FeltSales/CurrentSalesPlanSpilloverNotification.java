 ...
 * @author Dharmendra
 */
public class CurrentSalesPlanSpilloverNotification {
...
//        if (EITLERPGLOBAL.getCurrentDay() == 30) {
        if (EITLERPGLOBAL.getCurrentDay() == 1) {
            ...
            String mntFor = data.getStringValueFromDB("SELECT CONCAT(DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 1 MONTH),'%b'),'-',YEAR(DATE_SUB(NOW(), INTERVAL 1 MONTH))) FROM DUAL");
            
            String pMessage = "Respected Sir, <br><br> These files contains current sales plan spillover pieces of WIP, IN Stock, BSR, OSG Stock <br> Please find attached document herewith <br><br>";
...
//            String pCC = "sdmlerp@dineshmills.com";
            ...
            exprt.fillData(sql3+"#"+sql2+"#"+sql1+"#"+sql, new File("/Email_Attachment/CurrentSalesPlanSpilloverPieces_"+mntFor+".xls"), "OSG Stock#IN Stock,BSR#WIP#All");            
            String responce = sendNotificationMailWithAttachement("Current Sales Plan Spillover for Month of "+mntFor+"", pMessage, recievers, pCC, "/Email_Attachment/CurrentSalesPlanSpilloverPieces_"+mntFor+".xls", "CurrentSalesPlanSpilloverPieces_"+mntFor+".xls");
