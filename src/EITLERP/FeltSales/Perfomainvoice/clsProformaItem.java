...
public class clsProformaItem {
    ...
    public clsProformaItem() {
        ...
        props.put("VAT",new Variant(0.00)); 
        props.put("CST",new Variant(0.00)); 
        props.put("SD_AMT",new Variant(0.00)); 
        props.put("AOSD_PER",new Variant(0.00)); 
        props.put("AOSD_AMT",new Variant(0.00)); 
        props.put("INV_VAL",new Variant(0.00)); 
        props.put("CREATED_BY",new Variant(0));
        props.put("CREATED_DATE",new Variant(""));
        props.put("MODIFIED_BY",new Variant(0));
        props.put("MODIFIED_DATE",new Variant(""));
        
        props.put("SURCHARGE_PER",new Variant(0.00));
        props.put("SURCHARGE_RATE",new Variant(0.00));
        props.put("GROSS_RATE",new Variant(0.00));
