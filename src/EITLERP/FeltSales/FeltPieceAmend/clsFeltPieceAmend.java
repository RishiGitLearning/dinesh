 ...
 * @version
 */
public class clsFeltPieceAmend {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT FELT_AMEND_ID,FELT_AMEND_DATE,FELT_AMEND_REASON FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_AMEND_DATE >= '" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY FELT_AMEND_DATE");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("FELT_AMEND_ID", getNextFreeNo(759, true));
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 759; //Felt Weaving Entry
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");

            resultSetHistory = statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");
            ...
            //======== Update the Approval Flow =========
            clsFeltProductionApprovalFlow ObjFeltProductionApprovalFlow = new clsFeltProductionApprovalFlow();
            ObjFeltProductionApprovalFlow.ModuleID = 759; //Felt Order Updation Module
            ObjFeltProductionApprovalFlow.DocNo = getAttribute("FELT_AMEND_ID").getString();
            ObjFeltProductionApprovalFlow.DocDate = EITLERPGLOBAL.getCurrentDateDB();
            ObjFeltProductionApprovalFlow.From = (int) getAttribute("FROM").getVal();
            ObjFeltProductionApprovalFlow.To = (int) getAttribute("TO").getVal();
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND SET REJECTED=0,CHANGED=1 WHERE FELT_AMEND_ID ='" + getAttribute("FELT_AMEND_ID").getString() + "'");
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PIECE_AMEND WHERE  FELT_AMEND_ID='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=759 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_PIECE_AMEND WHERE "
    ...
    public boolean IsEditable(String orderupdDocumentNo, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_AMEND_ID='" + orderupdDocumentNo + "' AND APPROVED=1";
            rsTmp = tmpStmt.executeQuery(strSQL);
            rsTmp.first();
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=759 AND USER_ID=" + userID + " AND DOC_NO='" + orderupdDocumentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT DISTINCT FELT_AMEND_ID,FELT_AMEND_DATE,FELT_AMEND_REASON FROM PRODUCTION.FELT_PIECE_AMEND WHERE  " + stringFindQuery + "";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_PIECE_AMEND WHERE FELT_AMEND_ID = '" + resultSet.getString("FELT_AMEND_ID") + "' AND FELT_AMEND_DATE='" + resultSet.getDate("FELT_AMEND_DATE") + "' ORDER BY FELT_AMEND_ID");
    ...
    public boolean setHistoryData(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_AMEND_DATE='" + pProductionDate + "' AND FELT_AMEND_ID='" + pDocNo + "' AND REVISION_NO='" + resultSet.getInt("REVISION_NO") + "' ORDER BY REVISION_NO");
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_AMEND_ID='" + productionDocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltPieceAmend ObjFeltOrderUpd = new clsFeltPieceAmend();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_AMEND_DATE='" + pProductionDate + "' AND FELT_AMEND_ID ='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltPieceAmend ObjDoc = new clsFeltPieceAmend();
    ...
    private void updatefeltorder(String documentNo, String Reason) {
        ...
        if (Reason.equals("2")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 9  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =2 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("3")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 11,PR_PIECE_STAGE='HOLD-WVG'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =3 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("4")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 12,PR_PIECE_STAGE='HOLD-MND'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =4 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("5")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 7,PR_PIECE_STAGE='HOLD-NDL'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =5 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("6")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 8,PR_PIECE_STAGE='HOLD-FNG'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =6 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("7")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='WEAVING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-WVG' AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='MENDING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-MND' AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='NEEDLING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-NDL' AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='FINISHING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-FNG' AND FELT_AMEND_ID ='" + documentNo + "'");
            
            
        }
        if (Reason.equals("8")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PIECE_STAGE = 'EXP-INVOICE'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =8 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("9")) {
            String s;
        ...
        if (Reason.equals("10")) {
            String r;
            r = "UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRODUCT_CODE=FELT_AMEND_PRODUCT_CODE,PR_GROUP=FELT_AMEND_GROUP,PR_BILL_PRODUCT_CODE=FELT_AMEND_PRODUCT_CODE WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND APPROVED =1 AND FELT_AMEND_REASON =10 AND FELT_AMEND_ID ='" + documentNo + "'";
...
//        }
   ...
   // }
    ...
    public boolean checkPieceNoInDB1(String pPieceNo, String pAmend_Reason, String pProdindstring, String pAgreedindstring) {
        ...
        if (count >= 1) {
            ...
            try {
                ...
                ResultSet rsTmp = stTmp.executeQuery("SELECT FELT_AMEND_DATE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_PIECE_NO='" + pPieceNo + "' AND FELT_AMEND_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
                while (rsTmp.next()) {
    ...
    public boolean checkProductionDateInDB(String pProdDate) {
        int count = data.getIntValueFromDB("SELECT COUNT(FELT_AMEND_DATE) FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_AMEND_DATE='" + pProdDate + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
    ...
    public static HashMap getAmendReasonList() {
        ...
        try {
            ...
            Statement stTmp = Conn.createStatement();
            int counter = 1;
            ResultSet rsTmp = stTmp.executeQuery("SELECT 0 AS PARA_CODE,'SELECT REASON CODE' AS PARA_DESC UNION ALL SELECT PARA_CODE,PARA_DESC FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID = 'PIECE_AMEND' ORDER BY PARA_CODE");
            while (rsTmp.next()) {
                ComboData aData = new ComboData();
  ...
  //              Piecedetail[30]=rsTmp.getString("INCHARGE_NAME");
    ...
    public static String getNextFreeNo(int pModuleID, boolean UpdateLastNo) {
        ...
        try {
            ...
            strSQL = "SELECT LAST_USED_NO,PADDING_BY,NO_LENGTH,PREFIX_CHARS,SUFFIX_CHARS FROM D_COM_FIRSTFREE WHERE COMPANY_ID=2 AND MODULE_ID=759 AND FIRSTFREE_NO=221";
            rsTmp = tmpStmt.executeQuery(strSQL);
            ...
            if (rsTmp.getRow() > 0) {
                ...
                if (UpdateLastNo) {
                    ...
                    data.Execute("UPDATE D_COM_FIRSTFREE SET LAST_USED_NO='" + strNewNo.trim() + "',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID=2 AND MODULE_ID=759 AND FIRSTFREE_NO=221");
                }
