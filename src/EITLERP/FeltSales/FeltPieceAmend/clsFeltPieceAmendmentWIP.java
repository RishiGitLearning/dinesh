 ...
 * @version
 */
public class clsFeltPieceAmendmentWIP {
     ...
     */
    public clsFeltPieceAmendmentWIP() {
        LastError = "";
        props = new HashMap();
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT FELT_AMEND_ID,FELT_AMEND_DATE,FELT_AMEND_REASON FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE >= '" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY FELT_AMEND_DATE ");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("FELT_AMEND_ID", getNextFreeNo(621, true));
            ...
            for (int i = 1; i <= hmFeltOrderUpdDetails.size(); i++) {
                ...
                resultSetTemp.updateInt("FELT_MODULE_ID", 621);
                ...
                resultSetHistory.updateInt("FELT_MODULE_ID", 621);
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 621; //Felt Weaving Entry
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");

            resultSetHistory = statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");
            ...
            //======== Update the Approval Flow =========
            clsFeltProductionApprovalFlow ObjFeltProductionApprovalFlow = new clsFeltProductionApprovalFlow();
            ObjFeltProductionApprovalFlow.ModuleID = 621; //Felt Order Updation Module
            ObjFeltProductionApprovalFlow.DocNo = getAttribute("FELT_AMEND_ID").getString();
            ObjFeltProductionApprovalFlow.DocDate = EITLERPGLOBAL.getCurrentDateDB();
            ObjFeltProductionApprovalFlow.From = (int) getAttribute("FROM").getVal();
            ObjFeltProductionApprovalFlow.To = (int) getAttribute("TO").getVal();
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND SET REJECTED=0,CHANGED=1 WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID ='" + getAttribute("FELT_AMEND_ID").getString() + "'");
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PIECE_AMEND WHERE  FELT_MODULE_ID=621 AND FELT_AMEND_ID='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=621 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 "
    ...
    public boolean IsEditable(String orderupdDocumentNo, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID='" + orderupdDocumentNo + "' AND APPROVED=1";
            rsTmp = tmpStmt.executeQuery(strSQL);
            rsTmp.first();
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=621 AND USER_ID=" + userID + " AND DOC_NO='" + orderupdDocumentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT DISTINCT FELT_AMEND_ID,FELT_AMEND_DATE,FELT_AMEND_REASON FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND " + stringFindQuery + "";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID = '" + resultSet.getString("FELT_AMEND_ID") + "' AND FELT_AMEND_DATE='" + resultSet.getDate("FELT_AMEND_DATE") + "' ORDER BY FELT_AMEND_ID");
    ...
    public boolean setHistoryData(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE='" + pProductionDate + "' AND FELT_AMEND_ID='" + pDocNo + "' AND REVISION_NO='" + resultSet.getInt("REVISION_NO") + "' ORDER BY REVISION_NO");
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID='" + productionDocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltPieceAmendmentWIP ObjFeltOrderUpd = new clsFeltPieceAmendmentWIP();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE='" + pProductionDate + "' AND FELT_AMEND_ID ='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltPieceAmendmentWIP ObjDoc = new clsFeltPieceAmendmentWIP();
    ...
    private void updatefeltorder(String documentNo, String Reason) {
        if (Reason.equals("1")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_BILL_LENGTH = FELT_AMEND_BILL_LENGTH,PR_BILL_WIDTH=FELT_AMEND_BILL_WIDTH,PR_BILL_GSM=FELT_AMEND_BILL_GSM,PR_BILL_WEIGHT=FELT_AMEND_BILL_WEIGHT,PR_BILL_SQMTR=ROUND((FELT_AMEND_BILL_LENGTH*FELT_AMEND_BILL_WIDTH),2) WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =1 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("2")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 9,PR_WIP_STATUS='CANCELED',PR_PIECE_STAGE='CANCELED'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =2 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("3")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 11,PR_PIECE_STAGE='HOLD-WVG'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =3 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("4")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 12,PR_PIECE_STAGE='HOLD-MND'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =4 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("5")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 7,PR_PIECE_STAGE='HOLD-NDL'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =5 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("6")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 8,PR_PIECE_STAGE='HOLD-FNG'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =6 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("7")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='WEAVING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-WVG' AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='MENDING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-MND' AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='NEEDLING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-NDL' AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRIORITY_HOLD_CAN_FLAG = 1,PR_PIECE_STAGE='FINISHING' WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =7 AND FELT_AMEND_MFG_STATUS='HOLD-FNG' AND FELT_AMEND_ID ='" + documentNo + "'");
            
            
        }
        if (Reason.equals("8")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PIECE_STAGE = 'EXP-INVOICE'  WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =8 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
        if (Reason.equals("9")) {
            String s;
            s = "UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_LENGTH = FELT_AMEND_LENGTH,PR_WIDTH=FELT_AMEND_WIDTH,PR_GSM=FELT_AMEND_GSM,PR_THORITICAL_WEIGHT=ROUND((FELT_AMEND_LENGTH*FELT_AMEND_WIDTH*FELT_AMEND_GSM)/1000,1),PR_SQMTR=ROUND((FELT_AMEND_LENGTH*FELT_AMEND_WIDTH),2),PR_BILL_LENGTH = FELT_AMEND_LENGTH,PR_BILL_WIDTH=FELT_AMEND_WIDTH,PR_BILL_GSM=FELT_AMEND_GSM,PR_BILL_SQMTR=ROUND((FELT_AMEND_LENGTH*FELT_AMEND_WIDTH),2) WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =9 AND FELT_AMEND_ID ='" + documentNo + "'";
            System.out.println(s);
            data.Execute(s);
        }
        if (Reason.equals("10")) {
            String r;
            r = "UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PRODUCT_CODE=FELT_AMEND_PRODUCT_CODE,PR_GROUP=FELT_AMEND_GROUP,PR_BILL_PRODUCT_CODE=FELT_AMEND_PRODUCT_CODE WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =10 AND FELT_AMEND_ID ='" + documentNo + "'";
            System.out.println(r);
            data.Execute(r);
        }
        if (Reason.equals("11")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_BILL_PRODUCT_CODE = FELT_AMEND_BILL_PRODUCT_CODE WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=621 AND APPROVED =1 AND FELT_AMEND_REASON =11 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
...
//        }
   ...
   // }
    ...
    public boolean checkPieceNoInDB1(String pPieceNo, String pAmend_Reason, String pProdindstring, String pAgreedindstring) {
        int count = data.getIntValueFromDB("SELECT COUNT(FELT_PIECE_NO) FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_PIECE_NO='" + pPieceNo + "' AND FELT_AMEND_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
        if (count >= 1) {
            ...
            try {
                ...
                ResultSet rsTmp = stTmp.executeQuery("SELECT FELT_AMEND_DATE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_PIECE_NO='" + pPieceNo + "' AND FELT_AMEND_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
                while (rsTmp.next()) {
    ...
    public boolean checkProductionDateInDB(String pProdDate) {
        int count = data.getIntValueFromDB("SELECT COUNT(FELT_AMEND_DATE) FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_DATE='" + pProdDate + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
    ...
    public static HashMap getAmendReasonList() {
        ...
        try {
            ...
            Statement stTmp = Conn.createStatement();
            int counter = 1;
            ResultSet rsTmp = stTmp.executeQuery("SELECT 0 AS PARA_CODE,'SELECT REASON CODE' AS PARA_DESC UNION ALL SELECT PARA_CODE,PARA_DESC FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID = 'PIECE_AMEND' AND PARA_CODE IN (9,10) ORDER BY PARA_CODE");
            while (rsTmp.next()) {
                ComboData aData = new ComboData();
  ...
  //              Piecedetail[30]=rsTmp.getString("INCHARGE_NAME");
    ...
    public static String getNextFreeNo(int pModuleID, boolean UpdateLastNo) {
        ...
        try {
            ...
            strSQL = "SELECT LAST_USED_NO,PADDING_BY,NO_LENGTH,PREFIX_CHARS,SUFFIX_CHARS FROM D_COM_FIRSTFREE WHERE COMPANY_ID=2 AND MODULE_ID=621 AND FIRSTFREE_NO=264";
            rsTmp = tmpStmt.executeQuery(strSQL);
            ...
            if (rsTmp.getRow() > 0) {
                ...
                if (UpdateLastNo) {
                    ...
                    data.Execute("UPDATE D_COM_FIRSTFREE SET LAST_USED_NO='" + strNewNo.trim() + "',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID=2 AND MODULE_ID=621 AND FIRSTFREE_NO=264");
                }
    ...
    public static boolean CanCancel(int pCompanyID,String pDocNo) {
        ...
        try {
            rsTmp=data.getResult("SELECT FELT_AMEND_ID,APPROVED FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID='"+pDocNo+"' AND CANCELED=0");
            rsTmp.first();
    ...
    public static boolean CancelDoc(int pCompanyID,String pDocNo) {
        ...
        try {
            if(CanCancel(pCompanyID,pDocNo)) {
                ...
                rsTmp=data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID='"+pDocNo+"' ");
                rsTmp.first();
                ...
                data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE FELT_MODULE_ID=621 AND FELT_AMEND_ID='"+pDocNo+"' ");
