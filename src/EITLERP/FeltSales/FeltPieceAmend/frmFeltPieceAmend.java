...
public class frmFeltPieceAmend extends javax.swing.JApplet {
    ...
    private clsFeltPieceAmend ObjFeltOrderUpd;
  ...
  //      txtamendreasoncode.setVisible(false);
        ...
        ObjFeltOrderUpd = new clsFeltPieceAmend();
        //    DeptID = 40 ;
        SetMenuForRights();
        ...
        if (ObjFeltOrderUpd.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Error occured while Loading Data. Error is " + ObjFeltOrderUpd.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" FELT PIECE AMENDMENT ENTRY FORM - ");
        ...
        txtAmendDate.setBounds(140, 10, 102, 27);
        ...
        Tab1.add(txtAmendID);
        txtAmendID.setBounds(140, 40, 102, 27);
        ...
        Tab1.add(jLabel12);
        jLabel12.setBounds(330, 50, 140, 17);
        ...
        cmbAmendReason.setBounds(480, 40, 250, 25);
    ...
    private void TableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyPressed
        if (EditMode == EITLERPGLOBAL.ADD || EditMode == EITLERPGLOBAL.EDIT) {
            if (cmbAmendReason.getSelectedIndex() == 1) {
                ...
                else if (cmbAmendReason.getSelectedIndex() == 1) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
            ...
            }else if (cmbAmendReason.getSelectedIndex() == 2) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            } else if (cmbAmendReason.getSelectedIndex() == 3) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            }else if (cmbAmendReason.getSelectedIndex() == 4) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
...
//                }
//            }
            else if (cmbAmendReason.getSelectedIndex() == 5) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
             ...
             else if (cmbAmendReason.getSelectedIndex() == 6) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            if (cmbAmendReason.getSelectedIndex() == 7) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            }if (cmbAmendReason.getSelectedIndex() == 8) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            if (cmbAmendReason.getSelectedIndex() == 9) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            if (cmbAmendReason.getSelectedIndex() == 10) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
            ...
            if (cmbAmendReason.getSelectedIndex() == 11) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        LOV aList = new LOV();
...
//       
    ...
    private void cmdPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPreviewActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "File error " + e.getMessage(), "FILE ERROR", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Select a row from Document Update History");
        }
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(759, txtAmendID.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmFeltPieceAmend.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 759)) {
...
//            String AmendReasoncode =  ObjFeltOrderUpd.getAttribute("FELT_AMEND_REASON").getString();
            ...
            lblTitle.setText(" FELT PIECE AMENDMENT- " + AmendID);
     ...
     //       txtamendreasoncode.setText(AmendReasoncode);
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(759, AmendID);
            ...
            FormatGridUpdateHistory();
//            HashMap hmApprovalHistory=clsFeltPieceAmend.getHistoryList(ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString(), txtAmendID.getText());
            HashMap hmApprovalHistory = clsFeltPieceAmend.getHistoryList(AmendDate, AmendID);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltPieceAmend ObjFeltOrderUpd = (clsFeltPieceAmend) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=759 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=759 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(759, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(759, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(759, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(759, txtAmendID.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(759, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(759, FromUserID, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(759, txtAmendID.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void Add() {
      //  EditMode=EITLERPGLOBAL.ADD;
        ...
        if (aList.ShowList()) {
            ...
            txtAmendID.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 759, FFNo, false));
            EITLERPGLOBAL.setComboIndex(cmbAmendReason, 0);
            cmbAmendReason.setEnabled(true);
            txtAmendDate.requestFocus();

            lblTitle.setText("FELT PIECE AMENDMENT - " + txtAmendID.getText());
            lblTitle.setBackground(Color.BLUE);
        } else {
    ...
    private void Edit() {
        ...
        if (ObjFeltOrderUpd.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            DisplayData();
            cmbAmendReason.setEnabled(true);
            if (clsFeltProductionApprovalFlow.IsCreator(759, productionDocumentNo)) {
                SetFields(true);
                txtAmendDate.setEnabled(false);
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltOrderUpd.CanDelete(txtAmendID.getText(), txtAmendDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, ObjFeltOrderUpd.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//        int DeptID =  EITLERPGLOBAL.gUserDeptID;
        ...
        if (AmendDate.equals("") || !EITLERPGLOBAL.isDate(AmendDate)) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Valid UpdationDate.", "Wrong Updation Date", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if ((Amend_Date.after(FinFromDate) || Amend_Date.compareTo(FinFromDate) == 0) && (Amend_Date.before(FinToDate) || Amend_Date.compareTo(FinToDate) == 0)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Updation Date is Not Within Financial Year.", "FINANCIAL YEAR ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (Amend_Date.compareTo(java.sql.Date.valueOf(EITLERPGLOBAL.getCurrentDateDB())) > 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Updation Date Must be Before or the Same Date as Today.", "Wrong Production Date", JOptionPane.ERROR_MESSAGE);
            return;
        }

        //Check the no. of items in table
        if (Table.getRowCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Piece Updation Details Before Saving.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                if (pieceNo.equals("") || pieceNo.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Piece No.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Party Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Party Name", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (productcode.equals("") || productcode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Product Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (Amend_Reason.equals("3")) {
                    if (widthString.equals("") || widthString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Width of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (Amend_Reason.equals("3")) {
                    if (gsmString.equals("") || gsmString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter GSM of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (amendremarkstring.equals("") || amendremarkstring.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Compulsorily Updation Remark for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
...
//                }
                ...
                if (Amend_Reason.equals("6")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkPartyCodeInDB(partyCode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "PARTY CODE " + partyCode + " is Not Existed Sales Party Master.", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                ...
                if (Amend_Reason.equals("7")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkProductCodeInDB(productcode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "PRODUCT CODE " + productcode + " is Not Existed Felts Product Master .", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter Correct Details at Row " + (i + 1) + " and Column " + (j + 1) + ". Error is " + nfe.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
            j = 0;
            nfe.printStackTrace();
            return;
        }
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
            ...
            if (ObjFeltOrderUpd.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                        try{
                            ...
                            String responce = JavaMail.sendFinalApprovalMail(759, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, SelHierarchyID, true);
                ...
                JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Error occured while saving. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltOrderUpd.Update()) {
                ...
                JOptionPane.showMessageDialog(frmFeltPieceAmend.this, "Error occured while saving editing. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Find() {
        ...
        if (ObjFindFeltOrderUpd.Cancelled == false) {
            if (!ObjFeltOrderUpd.Filter(ObjFindFeltOrderUpd.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltPieceAmend.this, " No records found.", "Find Felt Weaving Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        ObjFeltOrderUpd.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=759 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    ...
    private void GenerateAmendReasonCombo() {
        ...
        hmAmendList = clsFeltPieceAmend.getAmendReasonList();
