...
public class frmFeltPieceAmendmentWIP extends javax.swing.JApplet {
    ...
    private clsFeltPieceAmendmentWIP ObjFeltOrderUpd;
  ...
  //      txtamendreasoncode.setVisible(false);
        ...
        ObjFeltOrderUpd = new clsFeltPieceAmendmentWIP();
        ...
        if (ObjFeltOrderUpd.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Error occured while Loading Data. Error is " + ObjFeltOrderUpd.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("WIP Piece Amendment - ");
        ...
        jLabel12.setText("Amend Reason");
        Tab1.add(jLabel12);
        jLabel12.setBounds(10, 36, 120, 30);
            ...
            if (tAmendCode == 1) {
                ...
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE='PLANNING' AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE ";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
                ...
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE='WEAVING' AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE ";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
                ...
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE='MENDING' AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE ";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
...
//            }
                ...
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE='NEEDLING' AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE ";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
                ...
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE='FINISHING' AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE ";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
            ...
            if (tAmendCode == 7) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE IN('HOLD-WVG','HOLD-MND','HOLD-NDL','HOLD-FNG') AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
                ...
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT  A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE='IN STOCK' AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
            ...
            if (tAmendCode == 9) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE,A.PR_PRODUCT_CODE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE IN ('MENDING','WEAVING','NEEDLING','FINISHING','PLANNING','SPLICING','SEAMING') AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE";//AND (A.PR_DOC_NO IN ('0','') OR A.PR_DOC_NO IS NULL) 
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
            ...
            if (tAmendCode == 10) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    if (Table.getSelectedColumn() == 1) {
                        ...
                        String strSQL = "SELECT A.PR_PIECE_NO,A.PR_PARTY_CODE,B.PARTY_NAME,A.PR_ORDER_DATE,A.PR_PIECE_STAGE,A.PR_PRODUCT_CODE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER A,DINESHMILLS.D_SAL_PARTY_MASTER B WHERE A.PR_PIECE_STAGE IN ('MENDING','WEAVING','NEEDLING','FINISHING','PLANNING','SPLICING','SEAMING') AND A.PR_PARTY_CODE=B.PARTY_CODE ORDER BY A.PR_ORDER_DATE";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
                        //aList.DefaultSearchOn=2;
                ...
                if (Table.getSelectedColumn() == 5) {
                       ...
                       String Product_Code = Table.getValueAt(Table.getSelectedRow(), 5).toString();
                        String strSQL = "SELECT DISTINCT A.PRODUCT_CODE,A.PRODUCT_DESC,A.GROUP_NAME " +
                                        "FROM PRODUCTION.FELT_QLT_RATE_MASTER  A " +
                                        "WHERE A.APPROVED=1 AND A.CANCELED=0 AND  " +
                                        "A.PRODUCT_CODE IN (SELECT DISTINCT PRODUCT_CODE FROM PRODUCTION.FELT_SALES_CATEGORY_WISE_POSITION " +
                                        "WHERE POSITION_CATEGORY IN  " +
                                        "(SELECT POSITION_CATEGORY FROM PRODUCTION.FELT_SALES_CATEGORY_WISE_POSITION " +
    ...
    private void TableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyReleased
        ...
        double exist_r1 = data.getDoubleValueFromDB("SELECT PR_LENGTH FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='"+Piece_No+"'");
        double exist_r2 = data.getDoubleValueFromDB("SELECT PR_WIDTH FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='"+Piece_No+"'");
        
        double exist_gsm = data.getDoubleValueFromDB("SELECT PR_GSM FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='"+Piece_No+"'");
        ...
        double updated_gsm = Double.parseDouble(Table.getValueAt(Table.getSelectedRow(), 10).toString());
        ...
        if((r1 < exist_r1) && !"PLANNING".equals(Piece_Stage))
        {
            JOptionPane.showMessageDialog(null, "Piece length cannot reduce.");
            Table.setValueAt(exist_r1, Table.getSelectedRow(), 8);
            return;
        }
        if((r2 < exist_r2) && !"PLANNING".equals(Piece_Stage))
        {
            JOptionPane.showMessageDialog(null, "Piece width cannot reduce.");
            Table.setValueAt(exist_r2, Table.getSelectedRow(), 9);
            return;
        }
        if((updated_gsm < exist_gsm) && !"PLANNING".equals(Piece_Stage))
        {
            JOptionPane.showMessageDialog(null, "Piece GSM cannot reduce.");
            Table.setValueAt(exist_gsm, Table.getSelectedRow(), 10);
            return;
        }
...
//        txtamendreasoncode.setText(Integer.toString(cmbAmendReason.getSelectedIndex()));
    ...
    private void cmdPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPreviewActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "File error " + e.getMessage(), "FILE ERROR", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Select a row from Document Update History");
        }
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(621, txtAmendID.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmFeltPieceAmendmentWIP.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
...
//        Table.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 621)) {
...
//            String AmendReasoncode =  ObjFeltOrderUpd.getAttribute("FELT_AMEND_REASON").getString();
            ...
            lblTitle.setText("WIP Piece Amendment - " + AmendID);
     ...
     //       txtamendreasoncode.setText(AmendReasoncode);
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(621, AmendID);
            ...
            FormatGridUpdateHistory();
//            HashMap hmApprovalHistory=clsFeltPieceAmendmentWIP.getHistoryList(ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString(), txtAmendID.getText());
            HashMap hmApprovalHistory = clsFeltPieceAmendmentWIP.getHistoryList(AmendDate, AmendID);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltPieceAmendmentWIP ObjFeltOrderUpd = (clsFeltPieceAmendmentWIP) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Amend Remark");//19
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=621 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=621 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(621, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(621, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(621, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(621, txtAmendID.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(621, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(621, FromUserID, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(621, txtAmendID.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6121, 61211)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6121, 61212)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6121, 61213)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6121, 61214)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
      //  EditMode=EITLERPGLOBAL.ADD;
        ...
        if (aList.ShowList()) {
            ...
            txtAmendID.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 621, FFNo, false));
            EITLERPGLOBAL.setComboIndex(cmbAmendReason, 0);
            cmbAmendReason.setEnabled(true);
            txtAmendDate.requestFocus();

            lblTitle.setText("WIP Piece Amendment - " + txtAmendID.getText());
            lblTitle.setBackground(Color.BLUE);
        } else {
    ...
    private void Edit() {
        ...
        if (ObjFeltOrderUpd.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            DisplayData();
//            cmbAmendReason.setEnabled(true);
            if (clsFeltProductionApprovalFlow.IsCreator(621, productionDocumentNo)) {
                SetFields(true);
                txtAmendDate.setEnabled(false);
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltOrderUpd.CanDelete(txtAmendID.getText(), txtAmendDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, ObjFeltOrderUpd.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//        Amend_Reason = Integer.toString(cmbAmendReason.getSelectedIndex());
        ...
        if (AmendDate.equals("") || !EITLERPGLOBAL.isDate(AmendDate)) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Valid UpdationDate.", "Wrong Updation Date", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if ((Amend_Date.after(FinFromDate) || Amend_Date.compareTo(FinFromDate) == 0) && (Amend_Date.before(FinToDate) || Amend_Date.compareTo(FinToDate) == 0)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Updation Date is Not Within Financial Year.", "FINANCIAL YEAR ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (Amend_Date.compareTo(java.sql.Date.valueOf(EITLERPGLOBAL.getCurrentDateDB())) > 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Updation Date Must be Before or the Same Date as Today.", "Wrong Production Date", JOptionPane.ERROR_MESSAGE);
            return;
        }

        //Check the no. of items in table
        if (Table.getRowCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Piece Updation Details Before Saving.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                if (pieceNo.equals("") || pieceNo.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Piece No.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Party Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Party Name", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (productcode.equals("") || productcode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Product Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (Amend_Reason.equals("3")) {
                    if (lengthString.equals("") || lengthString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Length of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (Amend_Reason.equals("3")) {
                    if (widthString.equals("") || widthString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Width of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (Amend_Reason.equals("3")) {
                    if (gsmString.equals("") || gsmString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter GSM of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                if (amendremarkstring.equals("") || amendremarkstring.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Compulsorily Updation Remark for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
...
//                }
                ...
                if (Amend_Reason.equals("6")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkPartyCodeInDB(partyCode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "PARTY CODE " + partyCode + " is Not Existed Sales Party Master.", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                ...
                if (Amend_Reason.equals("7")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkProductCodeInDB(productcode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "PRODUCT CODE " + productcode + " is Not Existed Felts Product Master .", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter Correct Details at Row " + (i + 1) + " and Column " + (j + 1) + ". Error is " + nfe.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
            j = 0;
            nfe.printStackTrace();
            return;
        }
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
            ...
            if (ObjFeltOrderUpd.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                        try{
                            ...
                            String responce = JavaMail.sendFinalApprovalMail(621, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, SelHierarchyID, true);
                ...
                JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Error occured while saving. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltOrderUpd.Update()) {
                ...
                JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, "Error occured while saving editing. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Find() {
        ...
        if (ObjFindFeltOrderUpd.Cancelled == false) {
            if (!ObjFeltOrderUpd.Filter(ObjFindFeltOrderUpd.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltPieceAmendmentWIP.this, " No records found.", "Find Felt Weaving Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        ObjFeltOrderUpd.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=621 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    ...
    private void GenerateAmendReasonCombo() {
        ...
        hmAmendList = clsFeltPieceAmendmentWIP.getAmendReasonList();
