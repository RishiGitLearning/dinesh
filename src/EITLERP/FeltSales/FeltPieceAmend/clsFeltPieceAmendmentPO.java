 ...
 * @version
 */
public class clsFeltPieceAmendmentPO {
     ...
     */
    public clsFeltPieceAmendmentPO() {
        LastError = "";
        props = new HashMap();
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT FELT_AMEND_ID,FELT_AMEND_DATE,FELT_AMEND_REASON FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE >= '" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY FELT_AMEND_DATE ");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("FELT_AMEND_ID", getNextFreeNo(632, true));
            ...
            for (int i = 1; i <= hmFeltOrderUpdDetails.size(); i++) {
                ...
                resultSetTemp.updateString("FELT_AMEND_PO_NO", ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PO_NO").getString());
                resultSetTemp.updateString("FELT_AMEND_PO_DATE", ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PO_DATE").getString());
                ...
                resultSetTemp.updateString("FELT_AMEND_MATERIAL_CODE", ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_MATERIAL_CODE").getString());
                resultSetTemp.updateInt("FELT_MODULE_ID", 632);
                ...
                resultSetHistory.updateString("FELT_AMEND_PO_NO", ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PO_NO").getString());
                resultSetHistory.updateString("FELT_AMEND_PO_DATE", ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PO_DATE").getString());
                ...
                resultSetHistory.updateString("FELT_AMEND_MATERIAL_CODE", ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_MATERIAL_CODE").getString());
                resultSetHistory.updateInt("FELT_MODULE_ID", 632);
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 632; //Felt Weaving Entry
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");

            resultSetHistory = statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE='" + EITLERPGLOBAL.formatDateDB(getAttribute("FELT_AMEND_DATE").getString()) + "' AND FELT_AMEND_ID='" + getAttribute("FELT_AMEND_ID").getString() + "'");
            ...
            //======== Update the Approval Flow =========
            clsFeltProductionApprovalFlow ObjFeltProductionApprovalFlow = new clsFeltProductionApprovalFlow();
            ObjFeltProductionApprovalFlow.ModuleID = 632; //Felt Order Updation Module
            ObjFeltProductionApprovalFlow.DocNo = getAttribute("FELT_AMEND_ID").getString();
            ObjFeltProductionApprovalFlow.DocDate = EITLERPGLOBAL.getCurrentDateDB();
            ObjFeltProductionApprovalFlow.From = (int) getAttribute("FROM").getVal();
            ObjFeltProductionApprovalFlow.To = (int) getAttribute("TO").getVal();
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND SET REJECTED=0,CHANGED=1 WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID ='" + getAttribute("FELT_AMEND_ID").getString() + "'");
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PIECE_AMEND WHERE  FELT_MODULE_ID=632 AND FELT_AMEND_ID='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=632 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 "
    ...
    public boolean IsEditable(String orderupdDocumentNo, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID='" + orderupdDocumentNo + "' AND APPROVED=1";
            rsTmp = tmpStmt.executeQuery(strSQL);
            rsTmp.first();
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=632 AND USER_ID=" + userID + " AND DOC_NO='" + orderupdDocumentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT DISTINCT FELT_AMEND_ID,FELT_AMEND_DATE,FELT_AMEND_REASON FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND " + stringFindQuery + "";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID = '" + resultSet.getString("FELT_AMEND_ID") + "' AND FELT_AMEND_DATE='" + resultSet.getDate("FELT_AMEND_DATE") + "' ORDER BY FELT_AMEND_ID");
            ...
            while (resultSetTemp.next()) {
                ...
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_PO_NO", resultSetTemp.getString("FELT_AMEND_PO_NO"));
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_PO_DATE", resultSetTemp.getString("FELT_AMEND_PO_DATE"));
                ...
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_MATERIAL_CODE", resultSetTemp.getString("FELT_AMEND_MATERIAL_CODE"));
    ...
    public boolean setHistoryData(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE='" + pProductionDate + "' AND FELT_AMEND_ID='" + pDocNo + "' AND REVISION_NO='" + resultSet.getInt("REVISION_NO") + "' ORDER BY REVISION_NO");
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID='" + productionDocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltPieceAmendmentPO ObjFeltOrderUpd = new clsFeltPieceAmendmentPO();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_PIECE_AMEND_H WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE='" + pProductionDate + "' AND FELT_AMEND_ID ='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltPieceAmendmentPO ObjDoc = new clsFeltPieceAmendmentPO();
    ...
    public String getPONo(String pPieceNo) {
        return data.getStringValueFromDB("SELECT PR_PO_NO FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + pPieceNo + "'");

    }
    
    public String getPODate(String pPieceNo) {
        return data.getStringValueFromDB("SELECT PR_PO_DATE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + pPieceNo + "'");

    }

    public String getMaterialCode(String pPieceNo) {
        return data.getStringValueFromDB("SELECT PR_MATERIAL_CODE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + pPieceNo + "'");
    ...
    private void updatefeltorder(String documentNo, String Reason) {
        if (Reason.equals("12")) {
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_WIP_PIECE_REGISTER SET WIP_PO_NO = FELT_AMEND_PO_NO,WIP_PO_DATE=FELT_AMEND_PO_DATE,WIP_MATERIAL_CODE=FELT_AMEND_MATERIAL_CODE WHERE WIP_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=632 AND APPROVED =1 AND FELT_AMEND_REASON =12 AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_PO_NO = FELT_AMEND_PO_NO,PR_PO_DATE=FELT_AMEND_PO_DATE,PR_MATERIAL_CODE=FELT_AMEND_MATERIAL_CODE WHERE PR_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=632 AND APPROVED =1 AND FELT_AMEND_REASON =12 AND FELT_AMEND_ID ='" + documentNo + "'");
            data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND,PRODUCTION.FELT_PKG_SLIP_DETAIL SET PKG_PO_NO = FELT_AMEND_PO_NO,PKG_PO_DATE=FELT_AMEND_PO_DATE WHERE PKG_PIECE_NO = FELT_AMEND_PIECE_NO AND FELT_MODULE_ID=632 AND APPROVED =1 AND FELT_AMEND_REASON =12 AND FELT_AMEND_ID ='" + documentNo + "'");
        }
    }
    ...
    public boolean checkPieceNoInDB1(String pPieceNo, String pAmend_Reason, String pProdindstring, String pAgreedindstring) {
        int count = data.getIntValueFromDB("SELECT COUNT(FELT_PIECE_NO) FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_PIECE_NO='" + pPieceNo + "' AND FELT_AMEND_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
        if (count >= 1) {
            ...
            try {
                ...
                ResultSet rsTmp = stTmp.executeQuery("SELECT FELT_AMEND_DATE FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_PIECE_NO='" + pPieceNo + "' AND FELT_AMEND_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND FELT_AMEND_DATE<='" + EITLERPGLOBAL.FinToDateDB + "'");
                while (rsTmp.next()) {
    ...
    public boolean checkProductionDateInDB(String pProdDate) {
        int count = data.getIntValueFromDB("SELECT COUNT(FELT_AMEND_DATE) FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_DATE='" + pProdDate + "'");
        if (count > 0) {
            return true;
        } else {
            return false;
...
//            ResultSet rsTmp = stTmp.executeQuery("SELECT 0 AS PARA_CODE,'SELECT REASON CODE' AS PARA_DESC UNION ALL SELECT PARA_CODE,PARA_DESC FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID = 'PIECE_AMEND' AND PARA_CODE IN (2,3,4,5,6,7) ORDER BY PARA_CODE");
            ResultSet rsTmp = stTmp.executeQuery("SELECT PARA_CODE,PARA_DESC FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID = 'PIECE_AMEND' AND PARA_CODE IN (12) ORDER BY PARA_CODE");
            while (rsTmp.next()) {
                ComboData aData = new ComboData();
    ...
    public static String getNextFreeNo(int pModuleID, boolean UpdateLastNo) {
        ...
        try {
            ...
            strSQL = "SELECT LAST_USED_NO,PADDING_BY,NO_LENGTH,PREFIX_CHARS,SUFFIX_CHARS FROM D_COM_FIRSTFREE WHERE COMPANY_ID=2 AND MODULE_ID=632 AND FIRSTFREE_NO=322";
            rsTmp = tmpStmt.executeQuery(strSQL);
            ...
            if (rsTmp.getRow() > 0) {
                ...
                if (UpdateLastNo) {
                    ...
                    data.Execute("UPDATE D_COM_FIRSTFREE SET LAST_USED_NO='" + strNewNo.trim() + "',CHANGED=1,CHANGED_DATE=CURDATE() WHERE COMPANY_ID=2 AND MODULE_ID=632 AND FIRSTFREE_NO=322");
                }
    ...
    public static boolean CanCancel(int pCompanyID, String pDocNo) {
        ...
        try {
            rsTmp = data.getResult("SELECT FELT_AMEND_ID,APPROVED FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID='" + pDocNo + "' AND CANCELED=0");
            rsTmp.first();
    ...
    public static boolean CancelDoc(int pCompanyID, String pDocNo) {
        ...
        try {
            if (CanCancel(pCompanyID, pDocNo)) {
                ...
                rsTmp = data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID='" + pDocNo + "' ");
                rsTmp.first();
                ...
                data.Execute("UPDATE PRODUCTION.FELT_PIECE_AMEND SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE FELT_MODULE_ID=632 AND FELT_AMEND_ID='" + pDocNo + "' ");
