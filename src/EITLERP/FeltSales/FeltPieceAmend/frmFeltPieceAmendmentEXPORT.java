...
public class frmFeltPieceAmendmentEXPORT extends javax.swing.JApplet {
    ...
    public void init() {
        ...
        ObjFeltOrderUpd = new clsFeltPieceAmendmentEXPORT();
        ...
        if (ObjFeltOrderUpd.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Error occured while Loading Data. Error is " + ObjFeltOrderUpd.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Piece Transfer to Export - ");
        ...
        Tab1.add(jLabel3);
        jLabel3.setBounds(310, 10, 90, 30);
        ...
        txtAmendDate.setBounds(410, 10, 130, 27);
        ...
        Tab1.add(txtAmendID);
        txtAmendID.setBounds(110, 10, 160, 27);

        lblRevNo.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(560, 10, 20, 18);
        ...
        cmbAmendReason.setBounds(140, 40, 330, 25);
        ...
        txtamendreasoncode.setBounds(480, 40, 40, 27);
            ...
            if (tAmendCode == 8) {
                if (evt.getKeyCode() == 112) //F1 Key pressed
                {
                    ...
                    if (Table.getSelectedColumn() == 6) {
                        ...
                        String strSQL = "SELECT CURRENCY_CODE,COUNTRY,CURRENCY FROM PRODUCTION.FELT_SALES_CURRENCY_MASTER";
                        aList.SQL = strSQL;
                        aList.ReturnCol = 1;
                        aList.ShowReturnCol = true;
//                        aList.DefaultSearchOn=2;
    ...
    private void TableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyReleased
        ...
        if (EditMode == EITLERPGLOBAL.ADD || EditMode == EITLERPGLOBAL.EDIT) {
            if (Table.getSelectedColumn() == 7 || Table.getSelectedColumn() == 8) {
                double a1, a2, a3;
                a1 = Double.parseDouble(Table.getValueAt(Table.getSelectedRow(), 7).toString());
                a2 = Double.parseDouble(Table.getValueAt(Table.getSelectedRow(), 8).toString());
                a3 = Math.round(a1 * a2);

                Table.setValueAt(a3, Table.getSelectedRow(), 9);
                Table.requestFocus();
            }
        }
...
//        txtamendreasoncode.setText(Integer.toString(cmbAmendReason.getSelectedIndex()));
    ...
    private void cmdPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPreviewActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "File error " + e.getMessage(), "FILE ERROR", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Select a row from Document Update History");
        }
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(624, txtAmendID.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmFeltPieceAmendmentEXPORT.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
...
//        Table.setEnabled(pStat);
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 624)) {
...
//            String AmendReasoncode =  ObjFeltOrderUpd.getAttribute("FELT_AMEND_REASON").getString();
            ...
            lblTitle.setText("Piece Transfer to Export - " + AmendID);
            ...
            for (int i = 1; i <= ObjFeltOrderUpd.hmFeltOrderUpdDetails.size(); i++) {
                ...
                rowData[4] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_EXPORT_INV_NO").getString();
                rowData[5] = EITLERPGLOBAL.formatDate(ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_EXPORT_INV_DATE").getString());
                rowData[6] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_CURR_UNIT").getString();
                rowData[7] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_CURR_RATE").getVal();
                rowData[8] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_CURR_AMT").getVal();
                rowData[9] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_EXPORT_INV_AMT").getVal();
                rowData[10] = EITLERPGLOBAL.formatDate(ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_ORDER_DATE").getString());
                rowData[11] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PRODUCT_CODE").getString();
                rowData[12] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_GROUP").getString();
                rowData[13] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_STYLE").getString();
                rowData[14] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_LENGTH").getString();
                rowData[15] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_WIDTH").getString();
                rowData[16] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_GSM").getString();
                rowData[17] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_WEIGHT").getString();
                rowData[18] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_SQMTR").getString();
                rowData[19] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_BILL_LENGTH").getString();
                rowData[20] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_BILL_WIDTH").getString();
                rowData[21] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_BILL_GSM").getString();
                rowData[22] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_BILL_WEIGHT").getString();
                rowData[23] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_BILL_SQMTR").getString();
                rowData[24] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_BILL_PRODUCT_CODE").getString();
                rowData[25] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_REMARK").getString();
                rowData[26] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_MFG_STATUS").getString();
                rowData[27] = ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_INCHARGE_NAME").getString();
                rowData[28] = data.getStringValueFromDB("SELECT PR_BALE_NO FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PIECE_NO").getString() + "'");
                rowData[29] = EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PR_PACKED_DATE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + ObjFeltOrderUpdDetails.getAttribute("FELT_AMEND_PIECE_NO").getString() + "'"));
                DataModel.addRow(rowData);
            }
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(624, AmendID);
            ...
            FormatGridUpdateHistory();
//            HashMap hmApprovalHistory=clsFeltPieceAmendmentEXPORT.getHistoryList(ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString(), txtAmendID.getText());
            HashMap hmApprovalHistory = clsFeltPieceAmendmentEXPORT.getHistoryList(AmendDate, AmendID);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltPieceAmendmentEXPORT ObjFeltOrderUpd = (clsFeltPieceAmendmentEXPORT) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Exp InvNo");//4,22
            DataModel.addColumn("Exp InvDate");//5,23
            DataModel.addColumn("Unit of Currency");//6,24
            DataModel.addColumn("Rate of Currency");//7,25
            DataModel.addColumn("Amt in Currency");//8,26
            DataModel.addColumn("Exp InvAmt");//9,27
            DataModel.addColumn("Order Date");//10,4
            DataModel.addColumn("Product Code");//11,5
            DataModel.addColumn("Group");//12,6
            DataModel.addColumn("Style");//13,7
            DataModel.addColumn("Length");//14,8
            DataModel.addColumn("Width");//15,9
            DataModel.addColumn("GSM");//16,10
            DataModel.addColumn("Weight");//17,11
            DataModel.addColumn("Sqmtr");//18,12
            DataModel.addColumn("Bill Length");//19,13
            DataModel.addColumn("Bill Width");//20,14
            DataModel.addColumn("Bill GSM");//21,15
            DataModel.addColumn("Bill Weight");//22,16
            DataModel.addColumn("Bill Sqmtr");//23,17
            DataModel.addColumn("Bill Product Code");//24,18
            DataModel.addColumn("Remark");//25,19
            DataModel.addColumn("Status");//26,20
            DataModel.addColumn("Incharge Name");//27,21
            DataModel.addColumn("Bale No");//28
            DataModel.addColumn("Bale Date");//29
                    ...
                    public void tableChanged(TableModelEvent e) {
                        if (e.getType() == TableModelEvent.UPDATE) {
                            ...
                            if (column == 1) {
                                ...
                                Table.setValueAt(EITLERPGLOBAL.formatDate(ObjFeltOrderUpd.getOrderDate(pieceNo)), row, 10);
                                Table.setValueAt(ObjFeltOrderUpd.getProductCode(pieceNo), row, 11);
                                Table.setValueAt(ObjFeltOrderUpd.getGroupCD(pieceNo), row, 12);
                                Table.setValueAt(ObjFeltOrderUpd.getStyle(pieceNo), row, 13);
                                Table.setValueAt(ObjFeltOrderUpd.getLength(pieceNo), row, 14);
                                Table.setValueAt(ObjFeltOrderUpd.getWidth(pieceNo), row, 15);
                                Table.setValueAt(ObjFeltOrderUpd.getGSM(pieceNo), row, 16);
                                Table.setValueAt(ObjFeltOrderUpd.getWeight(pieceNo), row, 17);
                                Table.setValueAt(ObjFeltOrderUpd.getSqmtr(pieceNo), row, 18);
                                Table.setValueAt(ObjFeltOrderUpd.getBillLength(pieceNo), row, 19);
                                Table.setValueAt(ObjFeltOrderUpd.getBillWidth(pieceNo), row, 20);
                                Table.setValueAt(ObjFeltOrderUpd.getBillGSM(pieceNo), row, 21);
                                Table.setValueAt(ObjFeltOrderUpd.getBillWeight(pieceNo), row, 22);
                                Table.setValueAt(ObjFeltOrderUpd.getBillSqmtr(pieceNo), row, 23);
                                Table.setValueAt(ObjFeltOrderUpd.getBillProductCode(pieceNo), row, 24);
                                Table.setValueAt("Export Sales", row, 25);
                                Table.setValueAt(ObjFeltOrderUpd.getmfgstatus(pieceNo), row, 26);
                                Table.setValueAt(ObjFeltOrderUpd.getInchargeName(pieceNo), row, 27);
                                Table.setValueAt(data.getStringValueFromDB("SELECT PR_PACKED_DATE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + pieceNo + "'"), row, 28);
                                Table.setValueAt(EITLERPGLOBAL.formatDate(data.getStringValueFromDB("SELECT PR_PACKED_DATE FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='" + pieceNo + "'")), row, 29);
                            }
                            
                            if (column == 5) {
                                String expInvDt = ((String) Table.getValueAt(row, 5)).trim();
                                if (!EITLERPGLOBAL.isDate(expInvDt)) {
                                    Table.setValueAt("", row, 5);
                                    JOptionPane.showMessageDialog(null, "Please enter correct Date/Format. (i.e dd/MM/yyyy)");
                                    return;
                                }
                                if (data.getIntValueFromDB("SELECT DATEDIFF(NOW(),'"+EITLERPGLOBAL.formatDateDB(expInvDt)+"') FROM DUAL")<0) {
                                    Table.setValueAt("", row, 5);
                                    JOptionPane.showMessageDialog(null, "You cannot enter future date as Invoice Date.");
                                    return;
                                }
                            }

                            if (column == 11) {
                                String productNo = ((String) Table.getValueAt(row, 11)).trim();
                                Table.setValueAt(ObjFeltOrderUpd.getGroupID(productNo), row, 12);
                            }

                            if (column == 7 || column == 8) {
                                double a1, a2, a3;
                                a1 = Double.parseDouble(Table.getValueAt(row, 7).toString());
                                a2 = Double.parseDouble(Table.getValueAt(row, 8).toString());
                                a3 = Math.round(a1 * a2);

                                Table.setValueAt(a3, row, 9);
                            }
                        }
                    }
                });
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=624 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=624 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(624, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(624, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(624, txtAmendID.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(624, txtAmendID.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(624, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(624, FromUserID, ObjFeltOrderUpd.getAttribute("FELT_AMEND_ID").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(624, txtAmendID.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6124, 61241)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6124, 61242)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6124, 61243)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6124, 61244)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
...
//        cmbAmendReason.setEnabled(true);
        ...
        if (aList.ShowList()) {
            ...
            txtAmendID.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 624, FFNo, false));
            EITLERPGLOBAL.setComboIndex(cmbAmendReason, 0);
//            cmbAmendReason.setEnabled(true);
//            txtAmendDate.requestFocus();
            Table.requestFocus();

            lblTitle.setText("Piece Transfer to Export - " + txtAmendID.getText());
            lblTitle.setBackground(Color.BLUE);
        } else {
    ...
    private void Edit() {
        ...
        if (ObjFeltOrderUpd.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            DisplayData();
//            cmbAmendReason.setEnabled(true);
            if (clsFeltProductionApprovalFlow.IsCreator(624, productionDocumentNo)) {
                SetFields(true);
                txtAmendDate.setEnabled(false);
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltOrderUpd.CanDelete(txtAmendID.getText(), txtAmendDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, ObjFeltOrderUpd.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//        Amend_Reason = Integer.toString(cmbAmendReason.getSelectedIndex());
        ...
        if (AmendDate.equals("") || !EITLERPGLOBAL.isDate(AmendDate)) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Valid UpdationDate.", "Wrong Updation Date", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if ((Amend_Date.after(FinFromDate) || Amend_Date.compareTo(FinFromDate) == 0) && (Amend_Date.before(FinToDate) || Amend_Date.compareTo(FinToDate) == 0)) {
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Updation Date is Not Within Financial Year.", "FINANCIAL YEAR ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (Amend_Date.compareTo(java.sql.Date.valueOf(EITLERPGLOBAL.getCurrentDateDB())) > 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Updation Date Must be Before or the Same Date as Today.", "Wrong Production Date", JOptionPane.ERROR_MESSAGE);
            return;
        }

        //Check the no. of items in table
        if (Table.getRowCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Piece Updation Details Before Saving.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                if (pieceNo.equals("") || pieceNo.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Piece No.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Party Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (partyCode.equals("") || partyCode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Party Name", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                j++;
                orderdate = ((String) Table.getValueAt(i, 10)).trim();
                /*
                ...
                j++;
                productcode = ((String) Table.getValueAt(i, 11)).trim();
                if (productcode.equals("") || productcode.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Product Code.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                 ...
                 */
                j++;
                groupString = ((String) Table.getValueAt(i, 12)).trim();
                 ...
                 */
                j++;
                style = ((String) Table.getValueAt(i, 13)).trim();
                /*
                 ...
                 */
                j++;
                lengthString = ((String) Table.getValueAt(i, 14)).trim();
                if (Amend_Reason.equals("3")) {
                    if (lengthString.equals("") || lengthString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Length of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                // j=0;
                j++;
                widthString = ((String) Table.getValueAt(i, 15)).trim();
                if (Amend_Reason.equals("3")) {
                    if (widthString.equals("") || widthString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Width of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                j++;
                gsmString = ((String) Table.getValueAt(i, 16)).trim();
                if (Amend_Reason.equals("3")) {
                    if (gsmString.equals("") || gsmString.equals(null)) {
                        JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter GSM of Felt.", "ERROR", JOptionPane.ERROR_MESSAGE);
                        return;
                    } else {
                ...
                j++;
                weightString = Table.getValueAt(i, 17).toString().trim();
                j++;
                sqmtrString = Table.getValueAt(i, 18).toString().trim();
                j++;
                billlengthString = Table.getValueAt(i, 19).toString().trim();
                j++;
                billwidthString = Table.getValueAt(i, 20).toString().trim();
                j++;
                billgsmString = Table.getValueAt(i, 21).toString().trim();
                j++;
                billweightString = Table.getValueAt(i, 22).toString().trim();
                j++;
                billsqmtrString = Table.getValueAt(i, 23).toString().trim();
                j++;
                billproductcode = Table.getValueAt(i, 24).toString().trim();
                j++;
                amendremarkstring = ((String) Table.getValueAt(i, 25)).trim();
                if (amendremarkstring.equals("") || amendremarkstring.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Compulsorily Updation Remark for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                j = 0;
                mfgstatusstring = ((String) Table.getValueAt(i, 26)).trim();
...
//                }
                j++;
                inchargename = ((String) Table.getValueAt(i, 27)).trim();

                j++;
                invoiceNo = ((String) Table.getValueAt(i, 4)).trim();
                if (invoiceNo.equals("") || invoiceNo.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Invoice No for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                j++;
                invoiceDate = ((String) Table.getValueAt(i, 5)).trim();
                if (invoiceDate.equals("") || invoiceDate.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Invoice Date for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if (!EITLERPGLOBAL.isDate(invoiceDate)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Please Correct Invoice Date (i.e DD/MM/YYYY) for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                j++;
                CurrUnit = ((String) Table.getValueAt(i, 6)).trim();
                if (CurrUnit.equals("") || CurrUnit.equals(null)) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Currency Unit for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                j++;
                CurrRate = Double.parseDouble(Table.getValueAt(i, 7).toString());
                if (CurrRate == 0) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Currency Rate for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                j++;
                CurrAmt = Double.parseDouble(Table.getValueAt(i, 8).toString());
                if (CurrAmt == 0) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Currency Amount for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                j++;
                invoiceAmt = Double.parseDouble(Table.getValueAt(i, 9).toString());
                if (invoiceAmt == 0) {
                    JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Invoice Amount for Piece No: " + pieceNo + " ", "ERROR", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (Amend_Reason.equals("6")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkPartyCodeInDB(partyCode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "PARTY CODE " + partyCode + " is Not Existed Sales Party Master.", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                ...
                if (Amend_Reason.equals("7")) {
                    if (EditMode == EITLERPGLOBAL.ADD) {
                        if (ObjFeltOrderUpd.checkProductCodeInDB(productcode)) {
                            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "PRODUCT CODE " + productcode + " is Not Existed Felts Product Master .", "", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                ...
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_EXPORT_INV_NO", invoiceNo);
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_EXPORT_INV_DATE", EITLERPGLOBAL.formatDateDB(invoiceDate));
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_CURR_UNIT", CurrUnit);
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_CURR_RATE", CurrRate);
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_CURR_AMT", CurrAmt);
                ObjFeltOrderUpdDetails.setAttribute("FELT_AMEND_EXPORT_INV_AMT", invoiceAmt);
            ...
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter Correct Details at Row " + (i + 1) + " and Column " + (j + 1) + ". Error is " + nfe.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
            j = 0;
            nfe.printStackTrace();
            return;
        }
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
            ...
            if (ObjFeltOrderUpd.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                    try {
                        ...
                        String responce = JavaMail.sendFinalApprovalMail(624, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, SelHierarchyID, true);
                ...
                JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Error occured while saving. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltOrderUpd.Update()) {
                ...
                if (OpgFinal.isSelected()) {
                    ...
                    */
                                ...
                                try {
                                    ...
                                    String pSubject = "Notification : Felt Sales Piece Transfer to Export : " + docNo;
                                    String pMessage = "";

                                    if (!OpgFinal.isSelected()) {
                                        pMessage = "<br>Felt Sales Piece Transfer to Export No : " + docNo + " has been approve and forward by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, userId) + ".<br><br>";
                                    } else {
                                        pMessage = "<br>Felt Sales Piece Transfer to Export No : " + docNo + " has been final approved by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, userId) + ".<br><br>";
                                    }
                                    ...
                                    rsData1 = stmt1.executeQuery("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=624 AND FELT_AMEND_ID='" + docNo + "'");
                                    System.out.println("SELECT * FROM PRODUCTION.FELT_PIECE_AMEND WHERE FELT_MODULE_ID=624 AND FELT_AMEND_ID='" + docNo + "'");
                                    rsData1.first();
                                ...
                                String responce = MailNotification.sendNotificationMail(624, pSubject, pMessage, recievers, "", SelHierarchyID);
                                System.out.println("Send Mail Responce : " + responce);
                ...
                JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, "Error occured while saving editing. Error is " + ObjFeltOrderUpd.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Find() {
        ...
        if (ObjFindFeltOrderUpd.Cancelled == false) {
            if (!ObjFeltOrderUpd.Filter(ObjFindFeltOrderUpd.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltPieceAmendmentEXPORT.this, " No records found.", "Find Felt Weaving Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        ObjFeltOrderUpd.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=624 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    ...
    private void GenerateAmendReasonCombo() {
        ...
        hmAmendList = clsFeltPieceAmendmentEXPORT.getAmendReasonList();
...
//                DataModel.SetReadOnly(8);
        ...
        } else if (clsFeltProductionApprovalFlow.IsCreator(624, txtAmendID.getText())) {
            DataModel.SetReadOnly(1);
            DataModel.SetReadOnly(2);
            DataModel.SetReadOnly(3);
//            DataModel.SetReadOnly(4);
