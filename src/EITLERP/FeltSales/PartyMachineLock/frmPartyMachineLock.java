...
public class frmPartyMachineLock extends javax.swing.JApplet {

    private int EditMode = 0;
    private clsPartyMachineLock ObjDoc;
    ...
    public void init() {
        ...
        ObjDoc = new clsPartyMachineLock();
        GenerateCombos();
        SetMenuForRights();
        SetFields(false);
    ...
    private void initComponents() {
        ...
        mnuMachine.setText("Machine Lock");
        ...
        mnuPosition.setText("Position Lock");
        ...
        lblTitle.setText("Party Machine Position Lock");
...
//        Add();
    ...
    private void mnuPartyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuPartyActionPerformed
        ...
        aList.ModuleID = clsPartyMachineLock.ModuleID;
        ...
        txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsPartyMachineLock.ModuleID, FFNo, false));
        ...
        lblTitle.setText("Party Machine Position Lock - " + txtDocNo.getText());
    ...
    private void txtMachineNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMachineNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            aList.SQL = "SELECT MM_MACHINE_NO FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MACHINE_LOCK_IND=0 AND MM_PARTY_CODE= '" + txtPartyCode.getText().trim() + "' ";
            aList.ReturnCol = 1;
            aList.ShowReturnCol = true;
    ...
    private void txtPositionNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPositionNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            aList.SQL = "SELECT MM_MACHINE_POSITION,MM_MACHINE_POSITION_DESC FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE POSITION_LOCK_IND=0 AND MM_PARTY_CODE= '" + txtPartyCode.getText().trim() + "' AND MM_MACHINE_NO='" + txtMachineNo.getText().trim() + "' ";
            aList.ReturnCol = 1;
            aList.ShowReturnCol = true;
            aList.DefaultSearchOn = 2;
    ...
    private void btnShowPartyMstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowPartyMstActionPerformed
        // TODO add your handling code here:
        if (txtDocNo.getText().startsWith("FPL") && !data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MM_PARTY_CODE='" + txtPartyCode.getText() + "'")) {
    ...
    private void SetFields(boolean pStat) {
        ...
        if (txtDocNo.getText().startsWith("FPL")) {
            jLabel13.setVisible(false);
            txtMachineNo.setVisible(false);
            jLabel15.setVisible(false);
            txtPositionNo.setVisible(false);
        ...
        if (txtDocNo.getText().startsWith("PML")) {
            jLabel13.setVisible(true);
            txtMachineNo.setVisible(true);
            jLabel15.setVisible(false);
            txtPositionNo.setVisible(false);
    ...
    private void DisplayData() {
        ...
        if (ObjDoc.getAttribute("DOC_NO").getObj().toString().startsWith("MPL")) {
            jLabel13.setVisible(true);
            txtMachineNo.setVisible(true);
            jLabel15.setVisible(true);
            txtPositionNo.setVisible(true);
            txtPositionDesc.setVisible(true);
        } else if (ObjDoc.getAttribute("DOC_NO").getObj().toString().startsWith("PML")) {
            jLabel13.setVisible(true);
            txtMachineNo.setVisible(true);
            jLabel15.setVisible(false);
            txtPositionNo.setVisible(false);
        ...
        List = clsFeltProductionApprovalFlow.getDocumentFlow(clsPartyMachineLock.ModuleID, DocNo);
        ...
        FormatGridHS();
        HashMap History = clsPartyMachineLock.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
        for (int i = 1; i <= History.size(); i++) {
            clsPartyMachineLock ObjHistory = (clsPartyMachineLock) History.get(Integer.toString(i));
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID='" + clsPartyMachineLock.ModuleID + "' ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID='" + clsPartyMachineLock.ModuleID + "' ");
        }
        for (int i = 1; i <= List.size(); i++) {
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = clsFeltProductionApprovalFlow.getRemainingUsers(clsPartyMachineLock.ModuleID, (String) ObjDoc.getAttribute("DOC_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(clsPartyMachineLock.ModuleID, (String) ObjDoc.getAttribute("DOC_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(clsPartyMachineLock.ModuleID, FromUserID, (String) ObjDoc.getAttribute("DOC_NO").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6126, 61261)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6126, 61263)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6126, 61265)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Edit() {
        ...
        if (ObjDoc.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(clsPartyMachineLock.ModuleID, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 60942)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        if ((txtDocNo.getText().startsWith("PML") || txtDocNo.getText().startsWith("MPL")) && txtMachineNo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter Machine No");
            return;
        }

        if (txtDocNo.getText().startsWith("MPL") && txtPositionNo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter Machine Position No");
            return;
        }

        if (txtDocNo.getText().startsWith("FPL") && !txtDocNo.getText().equals("")) {
        ...
        if (txtDocNo.getText().startsWith("FPL") && !txtDocNo.getText().equals("")) {
            if (data.IsRecordExist("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_LOCK=1 AND PARTY_CODE='" + txtPartyCode.getText() + "' ")) {
                JOptionPane.showMessageDialog(null, "Party already lock in Party Master");
                return;
            }
        }

        if (txtDocNo.getText().startsWith("PML") && !txtMachineNo.getText().equals("")) {
        ...
        if (txtDocNo.getText().startsWith("PML") && !txtMachineNo.getText().equals("")) {
            if (data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MACHINE_LOCK_IND=1 AND MM_PARTY_CODE='" + txtPartyCode.getText() + "' AND MM_MACHINE_NO='" + txtMachineNo.getText() + "'")) {
                JOptionPane.showMessageDialog(null, "Party Machine already lock in Machine Master");
                return;
            }
        }

        if (txtDocNo.getText().startsWith("MPL") && !txtMachineNo.getText().equals("") && !txtPositionNo.getText().equals("")) {
        ...
        if (txtDocNo.getText().startsWith("MPL") && !txtMachineNo.getText().equals("") && !txtPositionNo.getText().equals("")) {
            if (data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE POSITION_LOCK_IND=1 AND MM_PARTY_CODE='" + txtPartyCode.getText() + "' AND MM_MACHINE_NO='" + txtMachineNo.getText() + "' AND MM_MACHINE_POSITION='" + txtPositionNo.getText() + "' ")) {
                JOptionPane.showMessageDialog(null, "Party Machine Position already lock in Machine Master");
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjDoc.Insert()) {
                ...
                if (OpgFinal.isSelected()) {
                    ...
                    String responce = JavaMail.sendFinalApprovalMail(clsPartyMachineLock.ModuleID, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, EITLERPGLOBAL.getComboCode(cmbHierarchy), true);
                        ...
                        try {
                            ...
                            if (rsData.getRow() > 0) {
                                while (!rsData.isAfterLast()) {
                                    ...
                                    if (DOC_NO.startsWith("FPL")) {
                                        data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_DIVERSION_FLAG = 'READY',PR_CLOSURE_REOPEN_IND='1',PR_CLOSURE_REMARK='PARTY CLOSED',PR_CLOSURE_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"' WHERE PR_PIECE_NO = '" + rsData.getString("PR_PIECE_NO") + "' ");
                                    }

                                    if (DOC_NO.startsWith("PML")) {
                                        data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_DIVERSION_FLAG = 'READY',PR_CLOSURE_REOPEN_IND='1',PR_CLOSURE_REMARK='PARTY MACHINE CLOSED',PR_CLOSURE_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"' WHERE PR_PIECE_NO = '" + rsData.getString("PR_PIECE_NO") + "' ");
                                    }

                                    if (DOC_NO.startsWith("MPL")) {
                                        data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_DIVERSION_FLAG = 'READY',PR_CLOSURE_REOPEN_IND='1',PR_CLOSURE_REMARK='PARTY MACHINE POSITION CLOSED',PR_CLOSURE_DATE='"+EITLERPGLOBAL.getCurrentDateDB()+"' WHERE PR_PIECE_NO = '" + rsData.getString("PR_PIECE_NO") + "' ");
                                    }
...
//                                    data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SET PR_DIVERSION_FLAG = 'READY' WHERE PR_PIECE_NO = '" + rsData.getString("PR_PIECE_NO") + "' ");
    ...
    private void Find() {
        ...
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.PartyMachineClosure.frmPartyMachineLockFind", true);
        frmPartyMachineLockFind ObjReturn = (frmPartyMachineLockFind) ObjLoader.getObj();
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(clsPartyMachineLock.ModuleID, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(clsPartyMachineLock.ModuleID, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            String DocNo = (String) ObjDoc.getAttribute("DOC_NO").getObj();
            int Creator = clsFeltProductionApprovalFlow.getCreator(clsPartyMachineLock.ModuleID, DocNo);
