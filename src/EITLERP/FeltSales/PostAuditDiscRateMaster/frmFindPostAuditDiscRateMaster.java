...
public class frmFindPostAuditDiscRateMaster extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Post Audir Disc Rate Master Details");
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!pieceNo.equals("")) {
            stringFindQuery=stringFindQuery+" AND MASTER_NO ='"+ pieceNo +"' ";
        }
