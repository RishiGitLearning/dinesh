...
public class frmPostAuditDiscRateMaster extends javax.swing.JApplet {
    ...
    private clsPostAuditDiscRateMaster ObjFeltFinishing;
    ...
    public void init() {
        ...
        ObjFeltFinishing = new clsPostAuditDiscRateMaster();
        lblTitle.setForeground(Color.WHITE);
        ...
        if (ObjFeltFinishing.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Error occured while Loading Data. Error is " + ObjFeltFinishing.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" FELT POST AUDIT DISC RATE MASTER - ");
        ...
        btnShow.setText("Show Doc");
        btnShow.setMaximumSize(new java.awt.Dimension(78, 35));
        btnShow.setMinimumSize(new java.awt.Dimension(78, 35));
        btnShow.setPreferredSize(new java.awt.Dimension(78, 35));
        ...
        Tab1.add(btnShow);
        btnShow.setBounds(480, 390, 130, 30);
...
//        EITLERPGLOBAL.PAGE_BREAK = true;
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Select a row from Document Update History");
        }
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(635, txtDocNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmPostAuditDiscRateMaster.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        // TODO add your handling code here:
        try {
            String DocNo = DataModel.getValueByVariable("MASTER_NO", Table.getSelectedRow());
...
//            e.printStackTrace();
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 635)) {
        ...
        try {
            ...
            lblTitle.setText(" FELT POST AUDIT DISC RATE MASTER - " + docNo);
            ...
            for (int i = 1; i <= ObjFeltFinishing.hmFeltFinishingDetails.size(); i++) {
                clsPostAuditDiscRateMasterDetails ObjFeltFinishingDetails = (clsPostAuditDiscRateMasterDetails) ObjFeltFinishing.hmFeltFinishingDetails.get(Integer.toString(i));
                ...
                rowData[2] = ObjFeltFinishingDetails.getAttribute("MASTER_NO").getString();
                rowData[3] = EITLERPGLOBAL.formatDate(ObjFeltFinishingDetails.getAttribute("SANCTION_DATE").getString());
                ...
                rowData[8] = EITLERPGLOBAL.formatDate(ObjFeltFinishingDetails.getAttribute("EFFECTIVE_FROM").getString());
                rowData[9] = EITLERPGLOBAL.formatDate(ObjFeltFinishingDetails.getAttribute("EFFECTIVE_TO").getString());
                rowData[10] = ObjFeltFinishingDetails.getAttribute("AUDIT_REMARK").getString();
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(635, docNo);
            ...
            FormatGridUpdateHistory();
            HashMap hmApprovalHistory = clsPostAuditDiscRateMaster.getHistoryList(txtDocNo.getText());
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsPostAuditDiscRateMaster ObjFeltFinishing = (clsPostAuditDiscRateMaster) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Master No");
            DataModel.addColumn("Sanction Date");
            DataModel.addColumn("Party Code");
            DataModel.addColumn("Party Name");
            DataModel.addColumn("Group Code");
            DataModel.addColumn("Group Name");
            DataModel.addColumn("Effective FromDate");
            DataModel.addColumn("Effective ToDate");
            ...
            DataModel.SetVariable(0, "SELECTED_FLAG"); //0
            DataModel.SetVariable(1, "SR_NO"); //1
            DataModel.SetVariable(2, "MASTER_NO"); //2
            DataModel.SetVariable(3, "SANCTION_DATE"); //3
            DataModel.SetVariable(4, "PARTY_CODE"); //4
            DataModel.SetVariable(5, "PARTY_NAME"); //5
            DataModel.SetVariable(6, "GROUP_CODE"); //6
            DataModel.SetVariable(7, "GROUP_NAME"); //7
            DataModel.SetVariable(8, "EFFECTIVE_FROM"); //8
            DataModel.SetVariable(9, "EFFECTIVE_TO"); //9
            DataModel.SetVariable(10, "AUDIT_REMARK"); //9
...
//            Table.getColumnModel().getColumn(10).setMaxWidth(120);
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=635 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=635 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(635, ObjFeltFinishing.getAttribute("DOC_NO").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(635, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(635, txtDocNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(635, txtDocNo.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(635, ObjFeltFinishing.getAttribute("DOC_NO").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(635, FromUserID, ObjFeltFinishing.getAttribute("DOC_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(635, txtDocNo.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6401, 64011)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6401, 64012)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6401, 64013)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6401, 64015)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        txtDocNo.setText(clsPostAuditDiscRateMaster.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 635, FFNo, false));
        txtDocDate.setText(EITLERPGLOBAL.getCurrentDate());

        lblTitle.setText(" FELT POST AUDIT DISC RATE MASTER - " + txtDocNo.getText());
        lblTitle.setBackground(Color.GRAY);
    ...
    private void Edit() {
        ...
        if (ObjFeltFinishing.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(635, productionDocumentNo)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
        } else {
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltFinishing.CanDelete(txtDocNo.getText(), txtDocDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, ObjFeltFinishing.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Save() {
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                ObjFeltFinishingDetails.setAttribute("MASTER_NO", DataModel.getValueByVariable("MASTER_NO", i));
                ObjFeltFinishingDetails.setAttribute("SANCTION_DATE", DataModel.getValueByVariable("SANCTION_DATE", i));
                ...
                ObjFeltFinishingDetails.setAttribute("EFFECTIVE_FROM", DataModel.getValueByVariable("EFFECTIVE_FROM", i));
                ObjFeltFinishingDetails.setAttribute("EFFECTIVE_TO", DataModel.getValueByVariable("EFFECTIVE_TO", i));
                ObjFeltFinishingDetails.setAttribute("AUDIT_REMARK", DataModel.getValueByVariable("AUDIT_REMARK", i));
            ...
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Enter Correct Details at Row " + (i + 1) + " and Column " + (j + 1) + ". Error is " + nfe.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
            j = 0;
            nfe.printStackTrace();
            return;
        }
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltFinishing.Insert()) {
                ...
                JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Error occured while saving. Error is " + ObjFeltFinishing.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltFinishing.Update()) {
                ...
                JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, "Error occured while saving editing. Error is " + ObjFeltFinishing.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
...
//        }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.PostAuditDiscRateMaster.frmFindPostAuditDiscRateMaster", true);
        frmFindPostAuditDiscRateMaster ObjFindFeltFinishing = (frmFindPostAuditDiscRateMaster) ObjLoader.getObj();

        if (ObjFindFeltFinishing.Cancelled == false) {
            if (!ObjFeltFinishing.Filter(ObjFindFeltFinishing.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmPostAuditDiscRateMaster.this, " No records found.", "Find Post Audit Disc Rate Master Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void Find(String pieceNo, String prodDate) {
        ObjFeltFinishing.Filter(" AND MASTER_NO='" + pieceNo + "' ");
        SetMenuForRights();
        DisplayData();
    }
...
//    }
    ...
    public void FindWaiting() {
        ObjFeltFinishing.Filter(" AND DOC_NO IN (SELECT DISTINCT PI.DOC_NO FROM PRODUCTION.POST_AUDIT_DISC_RATE_MASTER_DATA PI, PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=635 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
        ...
        if (OpgFinal.isSelected()) {
            ...
            try {
                ...
                if (rsData1.getRow() > 0) {
                    ...
                    JavaMail.SendMail(toemail, mbody, "Notification : Post Audit of Discount Rate Master Doc No : " + docNo, "sdmlerp@dineshmills.com");
