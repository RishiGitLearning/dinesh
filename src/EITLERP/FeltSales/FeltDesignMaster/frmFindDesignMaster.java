...
public class frmFindDesignMaster extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find :: Felt Design Master");
        ...
        jLabel2.setText("UPN");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(20, 70, 29, 15);
        jPanel1.add(txtUPN);
        txtUPN.setBounds(120, 60, 160, 30);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!txtUPN.getText().trim().equals(""))
        {
//            String DOC_NO_LIST = "''";
//            ResultSet rsData = data.getResult("SELECT DESIGN_DOC_NO FROM PRODUCTION.FELT_DESIGN_MASTER_HEADER  WHERE UPN_NO='"+txtUPN.getText()+"' ORDER BY DESIGN_DOC_NO DESC");    
//            try{
//                rsData.first();
//                while(!rsData.isAfterLast())
//                {
...
//                e.printStackTrace();
//            }
            stringFindQuery = stringFindQuery + " AND UPN_NO IN ("+txtUPN.getText().trim()+")";
        }
