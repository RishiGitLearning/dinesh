...
public class PKGLOV_LAB extends javax.swing.JApplet {
    ...
    public PKGLOV_LAB(String pSQL,int pReturnCol,boolean pShowReturnCol,int pDefaultSearchOn) {
        System.gc();
        initComponents();
        DataModel=new EITLTableModel();
        SQL=pSQL;
...
//        aDialog.dispose();
   ...
   private void GenerateLOV() {
    ...
    private void FormatGrid() {
        ...
        DataModel.addColumn("Bale No"); //6
        DataModel.addColumn("Packed Date"); //7
        ...
        DataModel.SetVariable(6,"PR_BALE_NO");
        DataModel.SetVariable(7,"PR_PACKED_DATE");
