...
public class frmFindLocationAssignment extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Felt Location Assignment Details");
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!amendDate.equals("")) {
            stringFindQuery=stringFindQuery+" DOC_DATE='"+EITLERPGLOBAL.formatDateDB(amendDate)+"' ";
        }
        
        if(!pieceNo.equals("")) {
            stringFindQuery=stringFindQuery+" PIECE_NO ='"+ pieceNo +"'";
        }
        
        if(!amendID.equals("")) {
            stringFindQuery=stringFindQuery+" DOC_NO ='"+ amendID +"'";
        }
        getParent().getParent().getParent().getParent().show(false);
