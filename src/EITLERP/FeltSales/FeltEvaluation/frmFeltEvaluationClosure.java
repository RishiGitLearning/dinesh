...
public class frmFeltEvaluationClosure extends javax.swing.JApplet {

    private clsFeltEvaluationClosure ObjFeltEvaluation;
    ...
    public void init() {
        ...
        ObjFeltEvaluation = new clsFeltEvaluationClosure();
        SetMenuForRights();
    ...
    private void initComponents() {
        ...
        lblTitle.setText(" FELT EVALUATION CLOSURE - ");
        ...
        txtPartyCode.setBounds(120, 50, 100, 28);
        Tab1.add(lblPartyName);
        lblPartyName.setBounds(230, 50, 530, 30);

        Tab.addTab("Closure Details", Tab1);
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 611)) {
        ...
        try {
            ...
            lblTitle.setText(" FELT EVALUATION CLOSURE - " + docNo);
            ...
            for (int i = 1; i <= ObjFeltEvaluation.hmFeltEvaluationDetails.size(); i++) {
                ...
                if (ObjFeltEvaluationDetails.getAttribute("CANCEL_FLAG").getString().equalsIgnoreCase("1")) {
                    rowData[0] = true;
                } else {
                    rowData[0] = false;
                }
                rowData[1] = ObjFeltEvaluationDetails.getAttribute("PIECE_NO").getString();
                rowData[2] = ObjFeltEvaluationDetails.getAttribute("PIECE_STAGE").getString();
                rowData[3] = ObjFeltEvaluationDetails.getAttribute("MACHINE_NO").getString();
                rowData[4] = ObjFeltEvaluationDetails.getAttribute("POSITION_NO").getString();
                rowData[5] = clsmachinesurvey.getpositiondesc(ObjFeltEvaluationDetails.getAttribute("POSITION_NO").getString());
                rowData[6] = ObjFeltEvaluationDetails.getAttribute("STYLE_CODE").getString();
                rowData[7] = ObjFeltEvaluationDetails.getAttribute("LENGTH").getString();
                rowData[8] = ObjFeltEvaluationDetails.getAttribute("WIDTH").getString();
                rowData[9] = ObjFeltEvaluationDetails.getAttribute("WEIGHT").getString();
                rowData[10] = ObjFeltEvaluationDetails.getAttribute("GSM").getString();
                rowData[11] = ObjFeltEvaluationDetails.getAttribute("REMARKS").getString();
            ...
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString());
            ...
            FormatGridUpdateHistory();
            HashMap hmApprovalHistory = clsFeltEvaluationClosure.getHistoryList(ObjFeltEvaluation.getAttribute("DOC_DATE").getString(), ObjFeltEvaluation.getAttribute("DOC_NO").getString());
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltEvaluationClosure ObjFeltEvaluation = (clsFeltEvaluationClosure) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=611 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=611 ");
        }
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(611, FromUserID, ObjFeltEvaluation.getAttribute("DOC_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6096, 60961)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6096, 60962)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6096, 60963)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6096, 60964)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Add() {
        ...
        txtDocNo.setText(EITLERP.clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 611, FFNo, false));
        txtDocDate.setText(EITLERPGLOBAL.getCurrentDate());

        lblTitle.setText(" FELT EVALUATION CLOSURE - " + txtDocNo.getText());
        lblTitle.setBackground(Color.GRAY);
    }
...
//                    }
    ...
    private void SetData() {
        ...
        for (int i = 0; i < Table.getRowCount(); i++) {
            ...
            if (Table.getValueAt(i, 0).equals(true)) {
                ObjFeltEvaluationDetails.setAttribute("CANCEL_FLAG", "1");
            } else {
                ObjFeltEvaluationDetails.setAttribute("CANCEL_FLAG", "0");
            }

            ObjFeltEvaluationDetails.setAttribute("PIECE_NO", Table.getValueAt(i, 1));
            ObjFeltEvaluationDetails.setAttribute("PIECE_STAGE", Table.getValueAt(i, 2));
            ObjFeltEvaluationDetails.setAttribute("MACHINE_NO", Table.getValueAt(i, 3));
            ObjFeltEvaluationDetails.setAttribute("POSITION_NO", Table.getValueAt(i, 4));
            ObjFeltEvaluationDetails.setAttribute("STYLE_CODE", Table.getValueAt(i, 6));
            ObjFeltEvaluationDetails.setAttribute("LENGTH", Table.getValueAt(i, 7));
            ObjFeltEvaluationDetails.setAttribute("WIDTH", Table.getValueAt(i, 8));
            ObjFeltEvaluationDetails.setAttribute("WEIGHT", Table.getValueAt(i, 9));
            ObjFeltEvaluationDetails.setAttribute("GSM", Table.getValueAt(i, 10));
            ObjFeltEvaluationDetails.setAttribute("REMARKS", Table.getValueAt(i, 11));
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.FeltEvaluation.frmFindFeltEvaluationClosure", true);
        ...
        if (ObjFind.Cancelled == false) {
            if (!ObjFeltEvaluation.Filter(ObjFind.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltEvaluationClosure.this, " No records found.", "Find Felt Evaluation Party.", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void FindWaiting() {
        ObjFeltEvaluation.Filter(" DOC_NO IN (SELECT E.DOC_NO FROM PRODUCTION.FELT_SALES_EVALUATION_CLOSURE E, PRODUCTION.FELT_PROD_DOC_DATA D WHERE E.DOC_NO=D.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=611 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                ...
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString(), ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString(), ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(611, ObjFeltEvaluation.getAttribute("DOC_NO").getString());
    ...
    private void FormatGrid() {
        ...
        DataModelPieceNo.addColumn("Cancelation"); //0
        ...
        DataModelPieceNo.addColumn("Remark"); //11
