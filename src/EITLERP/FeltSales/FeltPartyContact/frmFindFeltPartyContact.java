...
public class frmFindFeltPartyContact extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Felt Party Contact Detail");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 7, 270, 15);
        ...
        txtPartyCode.setBounds(110, 10, 120, 19);
        jPanel1.add(txtDocNo);
        txtDocNo.setBounds(110, 40, 120, 19);

        jLabel3.setDisplayedMnemonic('G');
        jLabel3.setLabelFor(txtPartyCode);
        jLabel3.setText("Document No");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(3, 41, 100, 15);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(10, 30, 240, 70);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!partyCode.equals("") && !docNo.equals("")) {
            stringFindQuery=" PARTY_CODE ='"+ partyCode +"' AND DOC_NO ='"+ docNo +"'";
        }
