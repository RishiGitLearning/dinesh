 ...
 */
 public class frmFindProductionAmend extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find SDF Production Process Amend Entry");
        ...
        cmdFind.setBounds(310, 20, 70, 25);
        ...
        cmdCancel.setBounds(310, 50, 70, 25);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" PIECE_NO ='"+ docNo +"'";
            flag=true;
        }
