...
public class clsProductionEntry {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            System.out.println("SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_SDF_PROD_DATA  ORDER BY PROD_DOC_NO");
            resultSet=statement.executeQuery("SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_SDF_PROD_DATA  ORDER BY PROD_DOC_NO");
            HistoryView=false;
            Ready=true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DATE=''");
            
            // Production data history connection
            statementHistory=connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            resultSetHistory=statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_SDF_PROD_DATA_H WHERE PROD_DATE=''");
            ...
            ObjFeltProductionApprovalFlow.TableName="PRODUCTION.FELT_SDF_PROD_DATA";
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory=statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_SDF_PROD_DATA_H WHERE  PROD_DOC_NO='"+getAttribute("PRODUCTION_DOCUMENT_NO").getString()+"'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DOC_NO='"+getAttribute("PRODUCTION_DOCUMENT_NO").getString()+"' AND APPROVED=0");
...
//                resultSetHistory.updateString("REMARKS",ObjPieceDetails.getAttribute("REMARKS").getString());
            ...
            if(IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_SDF_PROD_DATA SET REJECTED=0,CHANGED=1 WHERE  PROD_DOC_NO='"+getAttribute("PRODUCTION_DOCUMENT_NO").getString()+"'");
    ...
    public boolean CanDelete(String documentNo,String stringProductionDate,int userID) {
        ...
        try {
            ...
            strSQL="SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE  PROD_DOC_NO='"+documentNo +"' AND APPROVED="+1;
            ...
            if(rsTmp.getInt("COUNT")>0){  //Item is Approved
                ...
                if(rsTmp.getInt("COUNT")>0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE "
    ...
    public boolean Filter(String stringFindQuery) {
        Ready=false;
        try {
            String strSql = "SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_PIECE_NO != '' " + stringFindQuery + " ORDER BY PROD_DATE";
            connection=data.getConn();
            statement=connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            //totalWeight = data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE  MONTH(PROD_DATE)="+ documentNo.substring(7,9) +" AND YEAR(PROD_DATE)="+ documentNo.substring(3,7)+ " AND APPROVED=1");
            setAttribute("TOTAL_WEIGHT","0");
            
            //previousWeight = data.getDoubleValueFromDB("SELECT SUM(WEIGHT) FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE  MONTH(PROD_DATE)="+ documentNo.substring(7,9) +" AND YEAR(PROD_DATE)="+ documentNo.substring(3,7) +" AND SUBSTRING(PROD_DOC_NO,4,8)<'"+documentNo.substring(3)+"' AND APPROVED=1");
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_SDF_PROD_DATA WHERE  PROD_DOC_NO='"+ documentNo +"' ORDER BY SR_NO");
    ...
    public boolean setHistoryData(String pProductionDate,String pDocNo) {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_SDF_PROD_DATA_H WHERE PROD_DEPT = 'GIDC' AND PROD_DATE='"+ pProductionDate+"' AND PROD_DOC_NO='"+pDocNo+"' AND REVISION_NO='"+ resultSet.getInt("REVISION_NO") +"' ORDER BY REVISION_NO");
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            rsTmp=stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_SDF_PROD_DATA_H WHERE  PROD_DOC_NO='"+productionDocumentNo+"' GROUP BY REVISION_NO");
    ...
    public boolean ShowHistory(String pDocNo) {
        ...
        try {
            ...
            resultSet=statement.executeQuery("SELECT DISTINCT REVISION_NO FROM PRODUCTION.FELT_SDF_PROD_DATA_H WHERE PROD_DEPT='GIDC' AND PROD_DOC_NO='"+pDocNo+"'");
            Ready=true;
    ...
    public static HashMap getPendingApprovals(int pUserID,int pOrder) {
        ...
        try {
            ...
            if(pOrder==EITLERPGLOBAL.OnRecivedDate) {
                strSQL="SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_SDF_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID="+pUserID+" AND STATUS='W' AND MODULE_ID=790 AND CANCELED=0 ORDER BY RECEIVED_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocDate) {
                strSQL="SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_SDF_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID="+pUserID+" AND STATUS='W' AND MODULE_ID=790 AND CANCELED=0 ORDER BY PROD_DATE";
            }
            
            if(pOrder==EITLERPGLOBAL.OnDocNo) {
                strSQL="SELECT DISTINCT PROD_DOC_NO,PROD_DATE,RECEIVED_DATE FROM PRODUCTION.FELT_SDF_PROD_DATA,PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID="+pUserID+" AND STATUS='W' AND MODULE_ID=790 AND CANCELED=0 ORDER BY PROD_DOC_NO";
            }
    ...
    public String[] getPartyCodeAndGroup(String pPieceNo) {
        ...
        try {
            ...
            rsTmp=Stmt.executeQuery("SELECT PR_PARTY_CODE,PR_GROUP FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE PR_PIECE_NO='"+pPieceNo+"'");
            rsTmp.first();
...
//        //data.Execute("UPDATE PRODUCTION.FELT_ORDER_MASTER, PRODUCTION.FELT_SDF_PROD_DATA SET MND_DATE=PROD_DATE WHERE PIECE_NO+0=PROD_PIECE_NO+0 AND PARTY_CD=PROD_PARTY_CODE AND PROD_DEPT='GIDC' AND PROD_DOC_NO='"+documentNo+"' AND APPROVED=1");
//        //data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER, PRODUCTION.FELT_SDF_PROD_DATA SET PR_MND_DATE=PROD_DATE,PR_PIECE_STAGE='NEEDLING' WHERE PR_PIECE_NO=PROD_PIECE_NO AND PR_PARTY_CODE=PROD_PARTY_CODE AND PROD_DEPT='GIDC' AND PROD_DOC_NO='"+documentNo+"' AND APPROVED=1 AND PR_PIECE_STAGE IN ('WEAVING','GIDC','NEEDLING','FINISHING')");
//         data.Execute("UPDATE  PRODUCTION.FELT_SDF_PROD_DATA SET APPROVED=1 WHERE PR_PIECE_NO=PROD_PIECE_NO AND PR_PARTY_CODE=PROD_PARTY_CODE AND PROD_DEPT='GIDC' AND PROD_DOC_NO='"+documentNo+"' AND APPROVED=1 AND PR_PIECE_STAGE IN ('GIDC','NEEDLING','FINISHING')");
//    }
    
    // on insert checks piece no already exist in db
    public boolean checkPieceNoInDB(String pPieceNo){
        int count=data.getIntValueFromDB("SELECT COUNT(PROD_PIECE_NO) FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DEPT = 'GIDC' AND PROD_PIECE_NO='"+pPieceNo+"' AND PROD_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND PROD_DATE<='"+EITLERPGLOBAL.FinToDateDB+"'");
    ...
    public boolean checkPieceNoInDB(String pPieceNo, String pProdDate){
        ...
        if(count>=1){
            ...
            try{
                ...
                ResultSet rsTmp=stTmp.executeQuery("SELECT PROD_DATE FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DEPT='GIDC' AND PROD_PIECE_NO='"+pPieceNo+"' AND PROD_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND PROD_DATE<='"+EITLERPGLOBAL.FinToDateDB+"'");
                while(rsTmp.next()){
    ...
    public boolean checkProductionDocumentNoInDB(String pProdDocNo){
        int count=data.getIntValueFromDB("SELECT COUNT(PROD_DOC_NO) FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DEPT = 'GIDC' AND PROD_DOC_NO='"+pProdDocNo+"'");
        if(count>0) return true;
        else return false;
    }
    ...
    public static boolean CanCancel(String pDocNo) {
        ...
        try {
            ...
            System.out.println("SELECT PROD_DOC_NO FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DOC_NO='"+pDocNo+"'  AND APPROVED=0 AND CANCELED=0");
            rsTmp=stTmp.executeQuery("SELECT PROD_DOC_NO FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DOC_NO='"+pDocNo+"'  AND APPROVED=0 AND CANCELED=0");
   ...
   public static void CancelDoc(String pAmendNo) {
        ...
        if(CanCancel(pAmendNo)) {
            ...
            try {
                rsTmp=data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_SDF_PROD_DATA WHERE PROD_DOC_NO='"+pAmendNo+"' ");
                rsTmp.first();
                ...
                data.Execute("UPDATE PRODUCTION.FELT_SDF_PROD_DATA SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE PROD_DOC_NO='"+pAmendNo+"'");
