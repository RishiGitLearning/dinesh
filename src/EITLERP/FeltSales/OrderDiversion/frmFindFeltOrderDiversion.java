...
public class frmFindFeltOrderDiversion extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        txtPieceNo = new javax.swing.JFormattedTextField();
        ...
        jLabel1.setText("Find Felt Sales Order");
        ...
        txtPieceNo.setBounds(110, 40, 160, 30);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" SD_ORDER_NO ='"+ docNo +"'";
            flag=true;
        }
        boolean flag2=false;
        if(!"".equals(txtPieceNo.getText()))
        {
            if(flag)
            {
                stringFindQuery = stringFindQuery+" AND D_PIECE_NO like '"+txtPieceNo.getText()+"%' ";
            }
            else
            {
                stringFindQuery = " D_PIECE_NO like '"+txtPieceNo.getText()+"%' ";
            }
            flag2 = true;
        }
        ...
        if(!PARTY_CODE.getText().trim().equals(""))
        {
            if(flag || flag2)
            {
                stringFindQuery = stringFindQuery+" AND D_PARTY_CODE = "+PARTY_CODE.getText();
            }
            else
            {
                stringFindQuery = " D_PARTY_CODE ='"+PARTY_CODE.getText()+"'";
            }
        }
        getParent().getParent().getParent().getParent().show(false);
    ...
    private javax.swing.JFormattedTextField txtPieceNo;
