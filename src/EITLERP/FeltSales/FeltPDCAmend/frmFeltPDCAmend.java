...
public class frmFeltPDCAmend extends javax.swing.JApplet {
    ...
    private clsFeltPDCAmend ObjFeltPDC;
    private clsFeltPDCBankDetails ObjFeltPDCBank;
    private clsFeltPDCPieceAmendDetails ObjFeltPDCPiece;
    ...
    public void init() {
        ...
        ObjFeltPDC = new clsFeltPDCAmend();
        ...
        if (ObjFeltPDC.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmFeltPDCAmend.this, "Error occured while Loading Data. Error is " + ObjFeltPDC.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("PDC Amendment Form - ");
        ...
        Tab1.add(jLabel3);
        jLabel3.setBounds(310, 40, 70, 30);
        ...
        Tab1.add(txtDocDate);
        txtDocDate.setBounds(390, 40, 150, 29);
        ...
        jScrollPane1.setBounds(10, 270, 790, 70);
        ...
        Tab1.add(cmdAddBD);
        cmdAddBD.setBounds(10, 200, 100, 28);
        ...
        cmdRemoveBD.setBounds(110, 200, 90, 28);

        jPanel3.setBackground(new java.awt.Color(153, 153, 153));
        jPanel3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        Tab1.add(jPanel3);
        jPanel3.setBounds(10, 260, 790, 6);

        jLabel5.setText("Doc No");
        Tab1.add(jLabel5);
        jLabel5.setBounds(10, 40, 70, 30);
        ...
        Tab1.add(txtDocNo);
        txtDocNo.setBounds(80, 40, 190, 29);

        lblRevNo.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        lblRevNo.setText("...");
        Tab1.add(lblRevNo);
        lblRevNo.setBounds(550, 20, 20, 18);
        ...
        Tab1.add(jLabel1);
        jLabel1.setBounds(490, 190, 120, 30);
        ...
        txtTotalChequeAmt.setBounds(610, 190, 130, 28);

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Critical Limit");
        Tab1.add(jLabel2);
        jLabel2.setBounds(570, 40, 110, 30);
        ...
        txtCreditDays.setBounds(740, 70, 60, 29);

        jLabel10.setText("Credit Days (+6 Days)");
        Tab1.add(jLabel10);
        jLabel10.setBounds(580, 70, 160, 30);
        ...
        txtPartyCode.setBounds(90, 70, 130, 28);

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Unadjusted Credit");
        Tab1.add(jLabel11);
        jLabel11.setBounds(210, 190, 150, 30);
        ...
        txtCriticalLimit.setBounds(680, 40, 110, 28);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Manual Amount ");
        Tab1.add(jLabel12);
        jLabel12.setBounds(490, 220, 120, 30);
        ...
        txtCarryForwardAmt.setBounds(360, 220, 130, 28);
        ...
        txtUnadjustedCredit.setBounds(360, 190, 130, 28);

        jLabel14.setText("Amend No");
        Tab1.add(jLabel14);
        jLabel14.setBounds(10, 10, 70, 30);

        jLabel15.setText("Amend Date");
        Tab1.add(jLabel15);
        jLabel15.setBounds(290, 10, 90, 30);
        ...
        Tab1.add(txtAmendNo);
        txtAmendNo.setBounds(80, 10, 190, 29);
        ...
        txtAmendDate.setBounds(390, 10, 150, 29);
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmFeltPDCAmend.this, "Select a row from Document Update History");
        }
    ...
    private void cmdViewRevisionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdViewRevisionsActionPerformed
        ObjFeltPDC.ShowHistory(EITLERPGLOBAL.formatDateDB(txtAmendDate.getText()), txtAmendNo.getText());
        MoveLast();
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(626, txtAmendNo.getText())) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmFeltPDCAmend.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
...
//        UtilizedBalanceCal();
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            if (clsAuthority.IsAuthorityGiven(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID, EITLERPGLOBAL.gAuthorityUserID, 626)) {
        ...
        try {
            ...
            txtAmendNo.setText((String) ObjFeltPDC.getAttribute("PDC_AMEND_NO").getObj());
            txtAmendDate.setText(EITLERPGLOBAL.formatDate((String) ObjFeltPDC.getAttribute("PDC_AMEND_DATE").getObj()));
            ...
            String theTitle = "PDC Amendment Form - " + txtAmendNo.getText();
...
//            txtCreditDays.setText(data.getStringValueFromDB("SELECT CREDIT_DAYS+GRACE_CREDIT_DAYS+EXTRA_CREDIT_DAYS+6 FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE='"+(String) ObjFeltPDC.getAttribute("PDC_PARTY_CODE").getObj()+"' AND MAIN_ACCOUNT_CODE='210010' AND CHARGE_CODE IN ('08') AND APPROVED=1 AND CANCELLED=0 AND PARTY_CLOSE_IND!=1 "));
            ...
            for (int i = 1; i <= ObjFeltPDC.colPDCPieceItems.size(); i++) {
                ...
                clsFeltPDCPieceAmendDetails ObjPieceItem = (clsFeltPDCPieceAmendDetails) ObjFeltPDC.colPDCPieceItems.get(Integer.toString(i));
            ...
            String AmendNo = (String) ObjFeltPDC.getAttribute("PDC_AMEND_NO").getObj();
            String AmendDate = (String) ObjFeltPDC.getAttribute("PDC_AMEND_DATE").getObj();
            hmList = clsFeltProductionApprovalFlow.getDocumentFlow(626, AmendNo);
...
//            HashMap hmApprovalHistory=clsFeltPDC.getHistoryList(ObjFeltPDC.getAttribute("FELT_AMEND_ID").getString(), txtAmendID.getText());
            HashMap hmApprovalHistory = clsFeltPDCAmend.getHistoryList(AmendDate, AmendNo);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsFeltPDCAmend ObjFeltPDC = (clsFeltPDCAmend) hmApprovalHistory.get(Integer.toString(i));
...
//                                UtilizedBalanceCal();
    ...
    private void GenerateHierarchyCombo() {
        ...
        hmHierarchyList = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=626 ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            hmHierarchyList = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=626 ");
        }
    ...
    private void GenerateSendToCombo() {
        ...
        try {
            ...
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                hmSendToList = clsFeltProductionApprovalFlow.getRemainingUsers(626, ObjFeltPDC.getAttribute("PDC_AMEND_NO").getString());
                for (int i = 1; i <= hmSendToList.size(); i++) {
                    clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(626, txtAmendNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(626, txtAmendNo.getText(), (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(626, txtAmendNo.getText());
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(626, ObjFeltPDC.getAttribute("PDC_AMEND_NO").getString());
            lnFromUserId = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(626, FromUserID, ObjFeltPDC.getAttribute("PDC_AMEND_NO").getString());
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            cmbHierarchy.setEnabled(false);
            if (clsFeltProductionApprovalFlow.IsCreator(626, txtAmendNo.getText())) {
                OpgReject.setEnabled(false);
            }
        }
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6114, 61141)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6114, 61142)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6114, 61143)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6114, 61144)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
        ...
        // --- Preview Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6114, 61145)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
...
//            txtAmendNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 626, FFNo, false));
////            txtPartyCode.setEnabled(true);
////            txtPartyCode.requestFocus();
//            TablePS.requestFocus();
//
//            lblTitle.setText("PDC Amendment Form - " + txtAmendNo.getText());
//            lblTitle.setBackground(Color.GRAY);
//            TableBD.setEnabled(false);                
//        } else {
...
//        }
        ...
        aListA.SQL = "SELECT PDC_PARTY_CODE,PDC_PARTY_NAME,PDC_DOC_NO,DATE_FORMAT(PDC_DOC_DATE,'%d/%m/%Y') AS PDC_DOC_DATE FROM PRODUCTION.FELT_PDC_HEADER WHERE APPROVED=1 AND CANCELED=0 AND PDC_PARTY_CODE NOT IN (SELECT PDC_PARTY_CODE FROM PRODUCTION.FELT_PDC_HEADER WHERE APPROVED=0 AND CANCELED=0) ORDER BY PDC_DOC_NO DESC";
        aListA.ReturnCol = 1;
        aListA.SecondCol = 3;
        aListA.ShowReturnCol = true;
        aListA.DefaultSearchOn = 1;

        if (aListA.ShowLOV()) {
            DocNo = aListA.SecondVal;
            partyCode = aListA.ReturnVal;

            if (clsFeltPDCAmend.IsAmendmentUnderProcess(partyCode)) {
                JOptionPane.showMessageDialog(null, "One Amendment of this Party is already under process. Cannot make another Amendment");
                EditMode = 0;
                return;
            }
            ...
            //Display newly generated document no.
            txtAmendNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, 626, 275, false));
            lblTitle.setText("PDC Amendment Form - " + txtAmendNo.getText());
            lblTitle.setBackground(Color.GRAY);

            DisplayDataPDC(DocNo);
            TablePS.requestFocus();
            TableBD.setEnabled(false);
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) ObjFeltPDC.getAttribute("PDC_AMEND_NO").getObj();
        if (ObjFeltPDC.IsEditable(productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            DisplayData();
//            cmbAmendReason.setEnabled(true);
            if (clsFeltProductionApprovalFlow.IsCreator(626, productionDocumentNo)) {
                SetFields(true);
                txtAmendDate.setEnabled(false);
            } else {
                EnableApproval();
            ...
            JOptionPane.showMessageDialog(frmFeltPDCAmend.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void Delete() {
        if (ObjFeltPDC.CanDelete(txtAmendNo.getText(), txtAmendDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            DisplayData();
        } else {
            JOptionPane.showMessageDialog(frmFeltPDCAmend.this, ObjFeltPDC.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//                }
    ...
    private void SetData() {
        //Header Fields        
        ObjFeltPDC.setAttribute("PDC_AMEND_NO", txtAmendNo.getText().trim());

        if (EITLERPGLOBAL.formatDateDB(txtAmendDate.getText()).equals("")) {
            ObjFeltPDC.setAttribute("PDC_AMEND_DATE", "0000-00-00");
        } else {
            ObjFeltPDC.setAttribute("PDC_AMEND_DATE", EITLERPGLOBAL.formatDateDB(txtAmendDate.getText()));
        }
        ...
        ObjFeltPDC.setAttribute("PDC_MANUAL_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(txtManualAmt.getText()), 0));
        ObjFeltPDC.setAttribute("PDC_CRITICAL_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(txtCriticalLimit.getText()), 0));
        ObjFeltPDC.setAttribute("PDC_CARRY_FORWARD_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(txtCarryForwardAmt.getText()), 0));
        ObjFeltPDC.setAttribute("PDC_UNADJUSTED_CREDIT", EITLERPGLOBAL.round(Double.parseDouble(txtUnadjustedCredit.getText()), 0));
        ObjFeltPDC.setAttribute("PDC_TOTAL_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(txtTotalChequeAmt.getText()), 0));
        ObjFeltPDC.setAttribute("PDC_TOTAL_PIECE_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(txtTotalPieceAmt.getText()), 0));
        ObjFeltPDC.setAttribute("PDC_TOTAL_BALANCE", EITLERPGLOBAL.round(Double.parseDouble(txtBalanceAmt.getText()), 0));
...
//        //======================Completed ===========================//
        ...
        for (int i = 0; i < TablePS.getRowCount(); i++) {
            ...
            ObjPieceItem.setAttribute("PDC_PIECE_AMOUNT", EITLERPGLOBAL.round(Double.parseDouble(DataModelPS.getValueByVariable("PDC_PIECE_AMOUNT", i)), 0));
            ObjPieceItem.setAttribute("PDC_PIECE_STATUS", "");
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.FeltPDCAmend.frmFindFeltPDCAmend", true);
        frmFindFeltPDCAmend ObjFindFeltOrderUpd = (frmFindFeltPDCAmend) ObjLoader.getObj();

        if (ObjFindFeltOrderUpd.Cancelled == false) {
            if (!ObjFeltPDC.Filter(ObjFindFeltOrderUpd.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmFeltPDCAmend.this, " No records found.", "Find Felt PDC Amendment Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void Find(String AmendID) {
        ObjFeltPDC.Filter(" PDC_AMEND_NO='" + AmendID + "'");
        SetMenuForRights();
        DisplayData();
    }
...
//    }
    ...
    public void FindWaiting() {
        ObjFeltPDC.Filter(" PDC_AMEND_NO IN (SELECT DISTINCT PDC_AMEND_NO FROM PRODUCTION.FELT_PDC_AMEND_HEADER, PRODUCTION.FELT_PROD_DOC_DATA WHERE PDC_AMEND_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=626 AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    ...
    private boolean Validate() {
        ...
        if (txtAmendDate.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter Amend Date");
            return false;
        }

        if (!EITLERPGLOBAL.isDate(txtAmendDate.getText())) {
            JOptionPane.showMessageDialog(null, "Invalid Amend Date");
            return false;
        }
...
//                carryForwardAmt = Double.parseDouble(txtCarryForwardAmt.getText());
            ...
            balanceAmt = EITLERPGLOBAL.round((chkBalance - pieceAmt), 0);
        ...
        try {
            ...
            if (rsInvoice.getRow() > 0) {
                while (!rsInvoice.isAfterLast()) {
                    ...
                    TotalBalance = EITLERPGLOBAL.round(TotalBalance + EITLERPGLOBAL.round(DebitAmount - AdjustedAmount, 0), 0);
                    rsInvoice.next();
                }
            }
        } catch (Exception e) {
...
//            txtBalanceAmt.setText(String.valueOf(balanceAmt));
    ...
    private void DisplayDataPDC(String mDocNo) {
        try {
            ResultSet trs = null;
            trs = data.getResult("SELECT * FROM PRODUCTION.FELT_PDC_HEADER WHERE PDC_DOC_NO='" + mDocNo + "' ");
            trs.first();

            txtDocNo.setText(trs.getString("PDC_DOC_NO"));
            txtDocDate.setText(EITLERPGLOBAL.formatDate(trs.getString("PDC_DOC_DATE")));
            txtPartyCode.setText(trs.getString("PDC_PARTY_CODE"));
            lblPartyName.setText(trs.getString("PDC_PARTY_NAME"));
            //txtCreditDays.setText(trs.getString("PDC_PARTY_CREDIT_DAYS"));

            txtCreditDays.setText(data.getStringValueFromDB("SELECT CREDIT_DAYS+GRACE_CREDIT_DAYS+EXTRA_CREDIT_DAYS+6 FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE='" + txtPartyCode.getText() + "' AND MAIN_ACCOUNT_CODE='210010' AND CHARGE_CODE IN ('08') AND APPROVED=1 AND CANCELLED=0 AND PARTY_CLOSE_IND!=1 "));
            txtCriticalLimit.setText(data.getStringValueFromDB("SELECT AMOUNT_LIMIT FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_CODE='" + txtPartyCode.getText() + "' AND MAIN_ACCOUNT_CODE='210010' AND CHARGE_CODE IN ('08') AND APPROVED=1 AND CANCELLED=0 AND PARTY_CLOSE_IND!=1 "));
//            double pOutStandingAmt = OutStanding("210010", txtPartyCode.getText());
//            txtUnadjustedCredit.setText(String.valueOf(EITLERPGLOBAL.round(pOutStandingAmt, 2)));
            ...
            txtCarryForwardAmt.setText(data.getStringValueFromDB("SELECT ROUND(H.PDC_TOTAL_BALANCE) FROM PRODUCTION.FELT_PDC_HEADER H, PRODUCTION.FELT_PDC_BANK_DETAIL B WHERE H.PDC_DOC_NO=B.PDC_DOC_NO AND H.PDC_PARTY_CODE='" + txtPartyCode.getText() + "' AND B.PDC_CHEQUE_DATE>CURDATE() AND H.APPROVED=1 AND H.CANCELED=0 ORDER BY H.PDC_DOC_NO DESC"));

            txtManualAmt.setText("0.0");
            //txtCriticalLimit.setText(Double.toString(ObjFeltPDC.getAttribute("PDC_CRITICAL_AMOUNT").getVal()));
            //txtCarryForwardAmt.setText(Double.toString(ObjFeltPDC.getAttribute("PDC_CARRY_FORWARD_AMOUNT").getVal()));
            //txtUnadjustedCredit.setText(Double.toString(ObjFeltPDC.getAttribute("PDC_UNADJUSTED_CREDIT").getVal()));
            txtTotalChequeAmt.setText(Double.toString(trs.getDouble("PDC_TOTAL_AMOUNT")));
            txtTotalPieceAmt.setText(Double.toString(trs.getDouble("PDC_TOTAL_PIECE_AMOUNT")));

            FormatGridBD();
            //Now Generate Table
            trs = data.getResult("SELECT * FROM PRODUCTION.FELT_PDC_BANK_DETAIL WHERE PDC_DOC_NO='" + mDocNo + "' ");
            trs.first();
            int cnt = 1;
            while (!trs.isAfterLast()) {
                ...
                rowData[0] = cnt++;
                rowData[1] = trs.getString("PDC_BANK_NAME");
                rowData[2] = trs.getString("PDC_BANK_CD");
                rowData[3] = trs.getString("PDC_BANK_BRANCH");
                rowData[4] = trs.getString("PDC_CHEQUE_NO");
                rowData[5] = EITLERPGLOBAL.formatDate(trs.getString("PDC_CHEQUE_DATE"));
                rowData[6] = trs.getString("PDC_CHEQUE_AMOUNT");
                rowData[7] = trs.getString("PDC_PHYSICAL_SCANNED");
                rowData[8] = EITLERPGLOBAL.formatDate(trs.getString("PDC_BILLING_DATE"));
                DataModelBD.addRow(rowData);
                trs.next();
            }
            ...
            trs = data.getResult("SELECT * FROM PRODUCTION.FELT_PDC_PIECE_DETAIL WHERE PDC_DOC_NO='" + mDocNo + "' AND (PDC_PIECE_STATUS IS NULL OR PDC_PIECE_STATUS IN ('INSERT','ADD','')) ");
            trs.first();
            int pscnt = 1;
            while (!trs.isAfterLast()) {
                Object[] rowData = new Object[50];
                ...
                rowData[0] = pscnt++;
                rowData[1] = trs.getString("PDC_PIECE_NO");
                rowData[2] = trs.getString("PDC_PIECE_AMOUNT");

                DataModelPS.addRow(rowData);
                trs.next();
            }

            if (Double.parseDouble(txtTotalChequeAmt.getText()) < (Double.parseDouble(txtTotalPieceAmt.getText()) + Double.parseDouble(txtCarryForwardAmt.getText()))) {
                chkBalance = EITLERPGLOBAL.round(Double.parseDouble(txtTotalChequeAmt.getText()), 0);
            } else {
                chkBalance = EITLERPGLOBAL.round((Double.parseDouble(txtTotalPieceAmt.getText()) + Double.parseDouble(txtCarryForwardAmt.getText())), 0);
            }
