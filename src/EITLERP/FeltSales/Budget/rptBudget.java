 ...
 */
public class rptBudget extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        btnbudget = new javax.swing.JRadioButton();
        btnsalesprojection = new javax.swing.JRadioButton();
        ...
        jLabel1.setBounds(0, 2, 1150, 25);

        jLabel2.setBackground(new java.awt.Color(0, 102, 153));
        jLabel2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jLabel2.setOpaque(true);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(0, 120, 1150, 10);
        ...
        btnZASView.setBounds(10, 5, 100, 30);
        ...
        btnZPMView.setBounds(10, 5, 100, 30);
        ...
        btnZPMPView.setBounds(10, 5, 100, 30);
        ...
        btnZPrtView.setBounds(10, 5, 100, 30);
        ...
        btnZPPView.setBounds(10, 5, 100, 30);
        ...
        btnZPView.setBounds(10, 5, 100, 30);
        ...
        btnZGView.setBounds(10, 5, 100, 30);
        ...
        btnZGView1.setBounds(10, 5, 100, 30);
        ...
        btnGrpwiseView.setBounds(10, 5, 100, 30);
        ...
        btnGrpwiseView1.setBounds(10, 5, 100, 30);
        ...
        btnPMView.setBounds(10, 5, 100, 30);
        ...
        btnPWView.setBounds(10, 5, 100, 30);
        ...
        btnPUView.setBounds(10, 5, 100, 30);
        ...
        btnYTMView.setBounds(10, 5, 100, 30);
        ...
        btnSFUPView.setBounds(10, 5, 100, 30);
        ...
        jScrollPane25.setBounds(10, 250, 1130, 290);
        ...
        jLabel26.setBounds(300, 60, 60, 20);
        ...
        INCHARGE.setBounds(370, 60, 140, 20);
        ...
        txtproductcode.setBounds(710, 60, 170, 20);
        ...
        btnbudget.setBounds(30, 90, 90, 23);

        buttonGroup1.add(btnsalesprojection);
        btnsalesprojection.setSelected(true);
        btnsalesprojection.setText("Sales Projection");
        btnsalesprojection.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnsalesprojectionActionPerformed(evt);
            }
        });
        getContentPane().add(btnsalesprojection);
        btnsalesprojection.setBounds(130, 90, 150, 23);
    ...
    private void btnZPViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnZPViewActionPerformed
        // TODO add your handling code here:
        if (!cmbFY.getSelectedItem().equals("Select")) {
            if (btnbudget.isSelected()) {
                JOptionPane.showMessageDialog(null, "New Customer only for Sales Projection...");
            }
            if (btnsalesprojection.isSelected()) {
                GenerateZP();
            }
        } else {
            JOptionPane.showMessageDialog(null, "Select Financial Year");
    ...
    private void btnGrpwiseViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrpwiseViewActionPerformed
        ...
        if (!cmbFY.getSelectedItem().equals("Select")) {
            if (btnbudget.isSelected()) {
                JOptionPane.showMessageDialog(null, "Sales Achivement only for Sales Projection...");
            }
            if (btnsalesprojection.isSelected()) {
                GenerateGroupwise();
            }
...
//            aList.SQL = "SELECT DISTINCT PRODUCT_CODE,PRODUCT_DESC,GROUP_NAME FROM PRODUCTION.FELT_QLT_RATE_MASTER ORDER BY PRODUCT_CODE ";
            aList.SQL = "SELECT DISTINCT QUALITY_NO,GROUP_NAME FROM PRODUCTION.TMPFELTBUDGETREPORT WHERE YEAR_FROM = " + pyear + " AND YEAR_TO = " + (Integer.parseInt(pyear) + 1);
            aList.ReturnCol = 1;
...
//            aList.SQL = "SELECT PARTY_CODE,PARTY_NAME,PARTY_CLOSE_IND FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE MAIN_ACCOUNT_CODE=210010 AND APPROVED=1 AND CANCELLED=0";
            aList.SQL = "SELECT DISTINCT PARTY_CODE,PARTY_NAME FROM PRODUCTION.TMPFELTBUDGETREPORT WHERE YEAR_FROM = " + pyear + " AND YEAR_TO = " + (Integer.parseInt(pyear) + 1);
            aList.ReturnCol = 1;
            aList.ShowReturnCol = true;
            aList.DefaultSearchOn = 2;
    ...
    private void btnCANViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCANViewActionPerformed
        ...
        if (!cmbFY.getSelectedItem().equals("Select")) {
            if (cmbStatus.getSelectedIndex() < 2) {
                if (btnbudget.isSelected()) {
                    JOptionPane.showMessageDialog(null, "Cancellable only for Sales Projection...");
                }
                if (btnsalesprojection.isSelected()) {
                    GenerateCancellable();
                }
    ...
    private void btnYTMViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnYTMViewActionPerformed
        ...
        if (!cmbFY.getSelectedItem().equals("Select")) {
            if (btnbudget.isSelected()) {
                JOptionPane.showMessageDialog(null, "YTM only for Sales Projection...");
            }
            if (btnsalesprojection.isSelected()) {
                GenerateYTM();
            }
    ...
    private void btnSFUPViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSFUPViewActionPerformed
        ...
        if (!cmbFY.getSelectedItem().equals("Select")) {
            if (btnbudget.isSelected()) {
                JOptionPane.showMessageDialog(null, "Sales Follow-up only for Sales Projection...");
            }
            if (btnsalesprojection.isSelected()) {
                GenerateSFUP();
            }
    ...
    private void btnsalesprojectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalesprojectionActionPerformed
        // TODO add your handling code here:
        cmbmonth.setEnabled(true);
        cmbmonth.setSelectedIndex(data.getIntValueFromDB("SELECT MONTH(CURDATE()) FROM DUAL") - 1);
    }//GEN-LAST:event_btnsalesprojectionActionPerformed
    ...
    private javax.swing.JRadioButton btnbudget;
    private javax.swing.JRadioButton btnsalesprojection;
        ...
        try {
            ...
            if (btnbudget.isSelected()) {
                strSQL = "SELECT INCHARGE,INCHARGE_NAME,COUNT(*) AS TOTAL , "
                        ...
                        + "(SELECT DISTINCT INCHARGE,INCHARGE_NAME,DOC_NO,COALESCE(APPROVED,0) AS APPROVED ,COALESCE(CANCELED,0) AS CANCELED FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  WHERE YEAR_FROM=" + pyear + " "
                        + "AND INCHARGE = INCHARGE_CD  AND  LEFT(DOC_NO,7)=CONCAT('N" + pfinyear + "',RIGHT(100+" + cmbmonth.getSelectedItem().toString() + ",2))"
                        + ") AS V "
                        + "LEFT JOIN "
                        + "(SELECT DOC_NO, "
                        ...
                        + "FROM PRODUCTION.FELT_PROD_DOC_DATA "
                        + "WHERE MODULE_ID = 872  AND DOC_DATE >='2019-12-19' AND STATUS = 'W'  AND  LEFT(DOC_NO,7)=CONCAT('N" + pfinyear + "',RIGHT(100+" + cmbmonth.getSelectedItem().toString() + ",2)))  AS D "
                        ...
                        + "FROM "
                        + "(SELECT INCHARGE,INCHARGE_NAME,V.DOC_NO,APPROVED,CANCELED,CREATOR,FINALAPPROVER,MAC FROM "
                        + "(SELECT DISTINCT INCHARGE,INCHARGE_NAME,DOC_NO,COALESCE(APPROVED,0) AS APPROVED ,COALESCE(CANCELED,0) AS CANCELED FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  WHERE YEAR_FROM = " + pyear + " AND YEAR_TO = " + (Integer.parseInt(pyear) + 1) + " "
                        + "AND INCHARGE = INCHARGE_CD  AND  LEFT(DOC_NO,7)=CONCAT('N" + pfinyear + "',RIGHT(100+" + cmbmonth.getSelectedItem().toString() + ",2)) "
                        + ") AS V "
                        + "LEFT JOIN "
                        + "(SELECT DOC_NO, "
                        + "CASE WHEN USER_ID IN (394,318,361,352,331,280) THEN 1 ELSE 0 END AS CREATOR, "
                        + "CASE WHEN USER_ID IN (399) THEN 1 ELSE 0 END AS MAC,CASE WHEN USER_ID IN (28,36) THEN 1 ELSE 0 END AS FINALAPPROVER "
                        + "FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID = 872 AND DOC_DATE >='2019-12-19' AND STATUS = 'W'  AND  LEFT(DOC_NO,7)=CONCAT('N" + pfinyear + "',RIGHT(100+" + cmbmonth.getSelectedItem().toString() + ",2)))  AS D "
                        + "ON D.DOC_NO = V.DOC_NO) AS M ";
            }
            if (btnsalesprojection.isSelected()) {
                strSQL = "SELECT INCHARGE,INCHARGE_NAME,COUNT(*) AS TOTAL , "
                        ...
                        + "CASE WHEN USER_ID IN (399) THEN 1 ELSE 0 END AS MAC,CASE WHEN USER_ID IN (28,36) THEN 1 ELSE 0 END AS FINALAPPROVER "
                        + "FROM PRODUCTION.FELT_PROD_DOC_DATA "
                        + "WHERE MODULE_ID = 834  AND DOC_DATE >='2019-12-19' AND STATUS = 'W'  AND  LEFT(DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + cmbmonth.getSelectedItem().toString() + ",2)))  AS D "
                        + "ON D.DOC_NO = V.DOC_NO) AS M "
                        + "GROUP BY INCHARGE,INCHARGE_NAME "
                        + ""
                        + "UNION ALL "
...
//                    rowData[9] = EITLERPGLOBAL.getCurrentDate() + " " + EITLERPGLOBAL.getCurrentTime();
    ...
    private void GenerateZPM() {
        ...
        try {
            ...
            String strSQL = "";
            if (btnsalesprojection.isSelected()) {
                strSQL = "SELECT INCHARGE_NAME,CONVERT(CASE WHEN GROUP_NAME IN ('ACNE','FCNE') THEN 'ACNE' "
                ...
                strSQL = strSQL + "sum(coalesce(" + cmnth + "_budget,0)) as cbudget,"
                        ...
                        + "FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  "
            ...
            if (btnbudget.isSelected()) {
                ...
                strSQL = strSQL + "sum(coalesce(" + cmnth + "_budget,0)) as cbudget,"
                        ...
                        + "FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  "
                        + "WHERE YEAR_FROM=" + pyear + " "
                        + "AND INCHARGE = INCHARGE_CD and left(doc_no,7)=CONCAT('N" + pfinyear + "',RIGHT(100+" + curmnth + ",2)) "
                        + "AND (coalesce(ACTUAL_BUDGET,0)>0 OR ";
                if (!pmnth.equalsIgnoreCase("")) {
                    strSQL = strSQL + "coalesce(" + pmnth + "_budget,0)>0 OR ";
                }
...
//            System.out.println("Row no." + rsTmp.getRow());
            if (rsTmp.getRow() > 0) {
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    if (!p.equalsIgnoreCase(rsTmp.getString("PROD_GROUP")) || !z.equalsIgnoreCase(rsTmp.getString("INCHARGE_NAME"))) {
                        ...
                        s = 4;
                        rowData[s] = String.format("%.2f", pobqty);
                        s++;
                        rowData[s] = String.format("%.2f", pobkg);
                        s++;
                        rowData[s] = String.format("%.2f", pobval);
                        s++;
                        if (btnsalesprojection.isSelected()) {
                            rowData[s] = String.format("%.2f", pppqty);
                            s++;
                            rowData[s] = String.format("%.2f", pppkg);
                            s++;
                            rowData[s] = String.format("%.2f", pppval);
                            s++;
                            //rowData[s] = String.format("%.2f", pdppqty);
                            //s++;
                            //rowData[s] = String.format("%.2f", pdppkg);
                            //s++;
                            //rowData[s] = String.format("%.2f", pdppval);
                            //s++;
                            rowData[s] = String.format("%.2f", pcpqty);
                            s++;
                            rowData[s] = String.format("%.2f", pcpkg);
                            s++;
                            rowData[s] = String.format("%.2f", pcpval);
                            s++;
                            //rowData[s] = String.format("%.2f", pdcpqty);
                            //s++;
                            //rowData[s] = String.format("%.2f", pdcpkg);
                            //s++;
                            //rowData[s] = String.format("%.2f", pdcpval);
                            //s++;
                        }
                        DataModel.addRow(rowData);
                        rowData = new Object[100];
                    ...
                    if (!z.equalsIgnoreCase(rsTmp.getString("INCHARGE_NAME"))) {
                        ...
                        s = 4;
                        rowData[s] = String.format("%.2f", zobqty);
                        s++;
                        rowData[s] = String.format("%.2f", zobkg);
                        s++;
                        rowData[s] = String.format("%.2f", zobval);
                        s++;
                        if (btnsalesprojection.isSelected()) {
                            rowData[s] = String.format("%.2f", zppqty);
                            s++;
                            rowData[s] = String.format("%.2f", zppkg);
                            s++;
                            rowData[s] = String.format("%.2f", zppval);
                            s++;
                            //rowData[s] = String.format("%.2f", zdppqty);
                            //s++;
                            //rowData[s] = String.format("%.2f", zdppkg);
                            //s++;
                            //rowData[s] = String.format("%.2f", zdppval);
                            //s++;
                            rowData[s] = String.format("%.2f", zcpqty);
                            s++;
                            rowData[s] = String.format("%.2f", zcpkg);
                            s++;
                            rowData[s] = String.format("%.2f", zcpval);
                            s++;
                            //rowData[s] = String.format("%.2f", zdcpqty);
                            //s++;
                            //rowData[s] = String.format("%.2f", zdcpkg);
                            //s++;
                            //rowData[s] = String.format("%.2f", zdcpval);
                            //s++;
                        }
                        DataModel.addRow(rowData);
                        rowData = new Object[100];
                    ...
                    s = 0;
                    rowData[s] = Integer.toString(cnt);
                    s++;
                    rowData[s] = rsTmp.getString("INCHARGE_NAME");
                    s++;
                    rowData[s] = rsTmp.getString("PROD_GROUP");
                    s++;
                    rowData[s] = rsTmp.getString("SIZE_CRITERIA");
                    s++;
                    rowData[s] = rsTmp.getString("QTY");
                    s++;
                    rowData[s] = rsTmp.getString("weight");
                    s++;
                    rowData[s] = rsTmp.getString("value");
                    s++;
                    if (btnsalesprojection.isSelected()) {
                        rowData[s] = rsTmp.getString("pbudget");
                        s++;
                        rowData[s] = rsTmp.getString("pweight");
                        s++;
                        rowData[s] = rsTmp.getString("pvalue");
                        s++;
                        //rowData[s] = rsTmp.getString("pdbudget");
                        //s++;
                        //rowData[s] = rsTmp.getString("pdweight");
                        //s++;
                        //rowData[s] = rsTmp.getString("pdvalue");
                        //s++;
                        rowData[s] = rsTmp.getString("cbudget");
                        s++;
                        rowData[s] = rsTmp.getString("cweight");
                        s++;
                        rowData[s] = rsTmp.getString("cvalue");
                        s++;
                        //rowData[s] = rsTmp.getString("cdbudget");
                        //s++;
                        //rowData[s] = rsTmp.getString("cdweight");
                        //s++;
                        //rowData[s] = rsTmp.getString("cdvalue");
                        //s++;
                    }
                    rowData[s] = EITLERPGLOBAL.getCurrentDate() + " " + EITLERPGLOBAL.getCurrentTime();
                    s++;
                ...
                s = 4;
                rowData[s] = String.format("%.2f", gobqty);
                s++;
                rowData[s] = String.format("%.2f", gobkg);
                s++;
                rowData[s] = String.format("%.2f", gobval);
                s++;
                if (btnsalesprojection.isSelected()) {
                    rowData[s] = String.format("%.2f", gppqty);
                    s++;
                    rowData[s] = String.format("%.2f", gppkg);
                    s++;
                    rowData[s] = String.format("%.2f", gppval);
                    s++;
                    //rowData[s] = String.format("%.2f", gdppqty);
                    //s++;
                    //rowData[s] = String.format("%.2f", gdppkg);
                    //s++;
                    //rowData[s] = String.format("%.2f", gdppval);
                    //s++;
                    rowData[s] = String.format("%.2f", gcpqty);
                    s++;
                    rowData[s] = String.format("%.2f", gcpkg);
                    s++;
                    rowData[s] = String.format("%.2f", gcpval);
                    s++;
                    //rowData[s] = String.format("%.2f", gdcpqty);
                    //s++;
                    //rowData[s] = String.format("%.2f", gdcpkg);
                    //s++;
                    //rowData[s] = String.format("%.2f", gdcpval);
                    //s++;
                }
                DataModel.addRow(rowData);
    ...
    private void GenerateZPMP() {
        String cndtn = "";
        String grp_cndtn = "";
        String TableName = "PRODUCTION.TMPFELTBUDGETREPORT";
        try {
...
//            } else {
//                TableName = "PRODUCTION.TMPFELTBUDGETREPORT";
//            }
            int status = cmbStatus.getSelectedIndex();
            if (status == 0) {
                cndtn += " AND COALESCE(APPROVED,0)=1 AND COALESCE(CANCELED,0)=0 ";
            ...
            String strSQL = "";
            if (btnsalesprojection.isSelected()) {
                strSQL = "SELECT INCHARGE_NAME,sum(COALESCE(actual_budget,0)) AS QTY,"
                        + "round(sum(coalesce(actual_budget,0)*(coalesce(press_weight,0)+coalesce(dry_weight,0))),2) as weight,"
                        + "SUM(round(coalesce(actual_budget_value,0)/100000,2)) as value,";
                if (pmnth.equalsIgnoreCase("")) {
                    strSQL = strSQL + "0 as pbudget,0 as pweight,0 as pvalue,0 as pdbudget,0 as pdweight,0 as pdvalue,";
...
//            System.out.println("Row no." + rsTmp.getRow());
            if (rsTmp.getRow() > 0) {
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    if (btnsalesprojection.isSelected()) {
                        ...
                        rowData[s] = rsTmp.getString("pvalue");
                        s++;
                        //rowData[s] = rsTmp.getString("pdbudget");s++;
                        //rowData[s] = rsTmp.getString("pdweight");s++;
                        //rowData[s] = rsTmp.getString("pdvalue");s++;
                        rowData[s] = rsTmp.getString("cbudget");
                        s++;
                        rowData[s] = rsTmp.getString("cweight");
                        s++;
                        rowData[s] = rsTmp.getString("cvalue");
                        s++;
                        //rowData[s] = rsTmp.getString("cdbudget");s++;
                        //rowData[s] = rsTmp.getString("cdweight");s++;
                        //rowData[s] = rsTmp.getString("cdvalue");s++;
                    }
                    rowData[s] = EITLERPGLOBAL.getCurrentDate() + " " + EITLERPGLOBAL.getCurrentTime();
                    s++;
                ...
                if (btnsalesprojection.isSelected()) {
                    ...
                    rowData[s] = String.format("%.2f", gppval);
                    s++;
                    //rowData[s] = String.format("%.2f", gdppqty);s++;
                    //rowData[s] = String.format("%.2f", gdppkg);s++;
                    //rowData[s] = String.format("%.2f", gdppval);s++;
                    rowData[s] = String.format("%.2f", gcpqty);
                    s++;
                    rowData[s] = String.format("%.2f", gcpkg);
                    s++;
                    rowData[s] = String.format("%.2f", gcpval);
                    s++;
                    //rowData[s] = String.format("%.2f", gdcpqty);s++;
                    //rowData[s] = String.format("%.2f", gdcpkg);s++;
                    //rowData[s] = String.format("%.2f", gdcpval);s++;
                }
                DataModel.addRow(rowData);
                final TableColumnModel columnModel = Table.getColumnModel();
                for (int column = 0; column < Table.getColumnCount(); column++) {
    ...
    private void GenerateZParty() {
        ...
        try {
            ...
            String strSQL = "";
            if (btnbudget.isSelected()) {
                strSQL = "SELECT CONVERT(CASE WHEN GROUP_NAME IN ('ACNE','FCNE') THEN 'ACNE' "
                        + "WHEN GROUP_NAME IN ('HDS') THEN 'HDS' "
                        + "WHEN GROUP_NAME IN ('SDF') THEN 'SDF' "
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    if (!p.equalsIgnoreCase(rsTmp.getString("PROD_GROUP"))) {
                        ...
                        if (btnsalesprojection.isSelected()) {
                            ...
                            rowData[s] = String.format("%.2f", pppval);
                            s++;
                            //rowData[s] = String.format("%.2f", pdppqty);s++;
                            //rowData[s] = String.format("%.2f", pdppkg);s++;
                            //rowData[s] = String.format("%.2f", pdppval);s++;
                            rowData[s] = String.format("%.2f", pcpqty);
                            s++;
                            rowData[s] = String.format("%.2f", pcpkg);
                            s++;
                            rowData[s] = String.format("%.2f", pcpval);
                            s++;
                            //rowData[s] = String.format("%.2f", pdcpqty);s++;
                            //rowData[s] = String.format("%.2f", pdcpkg);s++;
                            //rowData[s] = String.format("%.2f", pdcpval);s++;
                        }
                        DataModel.addRow(rowData);
                        rowData = new Object[100];
                        DataModel.addRow(rowData);
            ...
            if (rsTmp.getRow() > 0) {
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    if (!z.equalsIgnoreCase(rsTmp.getString("INCHARGE_NAME"))) {
                        ...
                        rowData[s] = String.format("%.2f", pobval);
                        s++;
                        //rowData[s] = String.format("%.2f", pdobqty);s++;
                        //rowData[s] = String.format("%.2f", pdobkg);s++;
                        //rowData[s] = String.format("%.2f", pdobval);s++;
                    ...
                    rowData[s] = rsTmp.getString("INCHARGE_NAME");
                    s++;
                    rowData[s] = rsTmp.getString("PARTY_CODE");
                    s++;
                    rowData[s] = rsTmp.getString("PARTY_NAME");
                    s++;
                    rowData[s] = rsTmp.getString("pbudget");
                    s++;
                    rowData[s] = rsTmp.getString("pweight");
                    ...
                    //rowData[s] = rsTmp.getString("cdweight");s++;
                    //rowData[s] = rsTmp.getString("cdvalue");s++;
                    rowData[s] = rsTmp.getString("dbudget");
                    s++;
                    rowData[s] = rsTmp.getString("dweight");
                    s++;
                    rowData[s] = rsTmp.getString("dvalue");
                    s++;
                    //rowData[s] = rsTmp.getString("ddbudget");s++;
                    //rowData[s] = rsTmp.getString("ddweight");s++;
                    //rowData[s] = rsTmp.getString("ddvalue");s++;
                    rowData[s] = EITLERPGLOBAL.getCurrentDate() + " " + EITLERPGLOBAL.getCurrentTime();
                    s++;
                ...
                rowData[s] = String.format("%.2f", gobval);
                s++;
                //rowData[s] = String.format("%.2f", gdobqty);s++;
                //rowData[s] = String.format("%.2f", gdobkg);s++;
                //rowData[s] = String.format("%.2f", gdobval);s++;
                DataModel.addRow(rowData);
...
//                    + "FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  WHERE YEAR_FROM = 2020 AND YEAR_TO = 2021 "
...
//                    + "ORDER BY QUALITY_NO,GROUP_NAME ";
            strSQL = "SELECT QUALITY_NO,GROUP_NAME, "
                    ...
                    + "SUM(COALESCE(Q4,0)) AS QTY, SUM(COALESCE(TOTAL_KG,0)) AS WT_KGS, SUM(COALESCE(TOTAL_SQMTR,0)) AS SQMTR,SUM(ROUND(COALESCE(Q4NET_AMOUNT/100000,0),2)) AS AMT "
                    + "FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  WHERE YEAR_FROM=" + pyear + " "
                    + "AND INCHARGE = INCHARGE_CD "
                    + cndtn + " ";
//                    + ") AS A "
//                    + "ORDER BY QUALITY_NO,GROUP_NAME ";
...
//            System.out.println("Row no." + rsTmp.getRow());
    ...
    private void GenerateGroupwise() {
        ...
        try {
            ...
            if (pmnth.equalsIgnoreCase("")) {
                strSQL = strSQL + "round(sum(coalesce(actual_budget_value,0)),2) as pvalue,0 as pdvalue ";
            } else {
                strSQL = strSQL + " SUM(round(coalesce(" + pmnth + "_net_amount,0)/100000,2)) as pvalue,"
                        + " SUM(round(((coalesce(" + pmnth + "_budget,0)-coalesce(" + pmnth + "_DOUBTFUL_QTY,0))*COALESCE(SELLING_PRICE,0))/100000,2))  as pdvalue  ";
            }
            strSQL = strSQL + "FROM PRODUCTION.TMPFELTBUDGETREPORT,PRODUCTION.FELT_INCHARGE  "
                    + "WHERE YEAR_FROM=" + pyear + " "
                    + "AND INCHARGE = INCHARGE_CD and left(doc_no,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + curmnth + ",2)) ";
            //+ "AND (coalesce(ACTUAL_BUDGET,0)>0 OR ";
//            if (!pmnth.equalsIgnoreCase("")) {
...
//            strSQL = strSQL + "coalesce(" + cmnth + "_budget,0)>0)  ";
            ...
            strSQL = strSQL + " AND INVOICE_DATE<'2022-04-01' AND H.DOC_DATE>='2022-04-01' AND H.DOC_DATE<='2023-03-31') AS A ";
...
//            System.out.println("Row no." + rsTmp.getRow());
    ...
    private void GenerateSegmentwise() {
        ...
        try {
            ...
            String strSQL = "";
            if (btnsalesprojection.isSelected()) {
                strSQL = "SELECT SEGMENT,INCHARGE_NAME,sum(QTY) as dbudget,sum(weight) as dweight,sum(value) as dvalue,"
...
//            System.out.println("Row no." + rsTmp.getRow());
            if (rsTmp.getRow() > 0) {
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    rowData[s] = Integer.toString(cnt);
                    s++;
                    rowData[s] = rsTmp.getString("SEGMENT");
                    s++;
                    rowData[s] = rsTmp.getString("INCHARGE_NAME");
                    s++;
                    rowData[s] = rsTmp.getString("dbudget");
...
//                z = rsTmp.getString("INCHARGE_NAME");
    ...
    private void GeneratePW() {
        ...
        try {
            ...
            String strSQL = "";
            if (btnbudget.isSelected()) {
                strSQL = "SELECT PARTY_CODE,PARTY_NAME,UPN,INCHARGE_NAME,CONVERT(CASE WHEN GROUP_NAME IN ('ACNE','FCNE') THEN 'ACNE' "
                        + "WHEN GROUP_NAME IN ('HDS') THEN 'HDS' "
                        + "WHEN GROUP_NAME IN ('SDF') THEN 'SDF' "
                        + "ELSE 'MNE/MNG' END USING UTF8) AS PROD_GROUP, SIZE_CRITERIA,sum(COALESCE(actual_budget,0)) AS QTY,"
                        + "round(sum(coalesce(actual_budget,0)*(coalesce(press_weight,0)+coalesce(dry_weight,0))),2) as weight,"
...
//                z = rsTmp.getString("INCHARGE_NAME");
    ...
    private void GeneratePU() {
        ...
        try {
            ...
            String strSQL = "";
            if (btnbudget.isSelected()) {
                strSQL = "SELECT PARTY_CODE,PARTY_NAME,UPN,POSITION_DESC,INCHARGE_NAME,CONVERT(CASE WHEN GROUP_NAME IN ('ACNE','FCNE') THEN 'ACNE' "
                        + "WHEN GROUP_NAME IN ('HDS') THEN 'HDS' "
                        + "WHEN GROUP_NAME IN ('SDF') THEN 'SDF' "
                        + "ELSE 'MNE/MNG' END USING UTF8) AS PROD_GROUP, SIZE_CRITERIA,sum(COALESCE(actual_budget,0)) AS QTY,"
                        + "round(sum(coalesce(actual_budget,0)*(coalesce(press_weight,0)+coalesce(dry_weight,0))),2) as weight,"
...
//                z = rsTmp.getString("INCHARGE_NAME");
                ...
                while (!rsTmp.isAfterLast()) {
                    ...
                    rowData[s] = Integer.toString(cnt);
                    s++;
                    rowData[s] = rsTmp.getString("UPN");
                    s++;
                    rowData[s] = rsTmp.getString("PARTY_NAME");
                    s++;
                    rowData[s] = rsTmp.getString("POSITION_DESC");
                    s++;
                    rowData[s] = rsTmp.getString("QTY");
                    s++;
                    rowData[s] = rsTmp.getString("weight");
    ...
    private void GenerateCancellable() {
        ...
        try {
            ...
            strSQL = strSQL + "LEFT JOIN "
                    ...
                    + " FROM PRODUCTION.TMPFELTBUDGETREPORT D WHERE D.YEAR_FROM=" + pyear + "  AND left(D.doc_no,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + curmnth + ",2)) AND ACESS_QTY>0 GROUP BY UPN) D "
...
//                    }
    ...
    private void GenerateYTM() {
        ...
        data.Execute("UPDATE PRODUCTION.TMPFELTBUDGETREPORT  "
        ...
        data.Execute("UPDATE PRODUCTION.TMPFELTBUDGETREPORT D,"
        ...
        try {
            ...
            strSQL = "SELECT *,ROUND(YTM1*WEIGHT,2) AS YTMKG,ROUND(YTM1*SQMTR,2) AS YTMSQMTR,"
                    ...
                    + "WHEN GROUP_NAME IN ('SDF') THEN 'SDF' ELSE 'MNE/MNG' END USING UTF8) AS PROD_GROUP,INCHARGE_NAME FROM PRODUCTION.TMPFELTBUDGETREPORT D "
...
//            System.out.println("Row no." + rsTmp.getRow());
    ...
    private void GenerateSFUP() {
        ...
        try {
            ...
            strSQL = strSQL + " FROM PRODUCTION.TMPFELTBUDGETREPORT "
            ...
            strSQL = strSQL + "((PR_REQ_MTH_LAST_DDMMYY>='2022-04-01' AND PR_REQ_MTH_LAST_DDMMYY<='2023-03-31') "
                    + "OR "
                    + "(PR_CURRENT_SCH_LAST_DDMMYY>='2022-04-01' AND PR_CURRENT_SCH_LAST_DDMMYY<='2023-03-31')) ";
...
//                + "WHERE LEFT(DOC_NO,7)=CONCAT('N2122',RIGHT(100+MONTH(curdate()),2) ) "
//                + "AND CURRENT_PROJECTION!=" + mn + "_BUDGET ");
//        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL "
//                + "SET CURRENT_PROJECTION=" + nmn + "_BUDGET,CURRENT_PROJECTION_VALUE=" + nmn + "_NET_AMOUNT "
//                + "WHERE LEFT(DOC_NO,7)=CONCAT('N2122',RIGHT(100+MONTH(DATE_ADD(LAST_DAY(CURDATE()),INTERVAL 1 DAY)),2)) "
...
//        data.Execute(s);
        ...
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D, PRODUCTION.FELT_MACHINE_MASTER_DETAIL M "
                + "SET SELLING_PRICE=MM_FELT_VALUE_WITH_GST WHERE D.UPN=M.MM_UPN_NO AND D.YEAR_FROM =2022 ");
        s = "UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D,"
                + "(SELECT H.MM_PARTY_CODE,H.MM_MACHINE_NO,MM_MACHINE_POSITION,COALESCE(MM_AVG_LIFE,0) AS M,ceiling((340/COALESCE(MM_AVG_LIFE,0))) AS V,MM_FELT_VALUE_WITH_GST AS G FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL D,PRODUCTION.FELT_MACHINE_MASTER_HEADER H "
                + "WHERE H.MM_DOC_NO = D.MM_DOC_NO AND H.APPROVED =1 AND H.CANCELED =0) AS C "
...
//                + "WHERE B.YEAR_FROM=2020 AND G.PARTY_CODE = B.PARTY_CODE AND QUALITY_NO = PRODUCT_CODE");
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL B,(SELECT G.PARTY_CODE, DISC_PER,PRODUCT_CODE "
                + "FROM PRODUCTION.FELT_RATE_DISC_MASTER_DETAIL D,PRODUCTION.FELT_GROUP_MASTER_DETAIL  G "
                + "WHERE SUBSTRING(PRODUCT_CODE,1,3) IN ('729','719') AND D.GROUP_CODE = G.GROUP_CODE "
                + "AND  EFFECTIVE_FROM >='2022-04-01' AND EFFECTIVE_TO <='2023-03-31' AND APPROVED =1 AND D.PARTY_CODE ='') AS G "
                + "SET SPL_DISCOUNT = DISC_PER "
                + "WHERE B.YEAR_FROM=2022 AND G.PARTY_CODE = B.PARTY_CODE AND QUALITY_NO = PRODUCT_CODE");
...
//                + "AND R.PARTY_CODE != '' AND R.PARTY_CODE = B.PARTY_CODE");
        data.Execute("UPDATE  PRODUCTION.FELT_RATE_DISC_MASTER_DETAIL R, PRODUCTION.FELT_BUDGET_REVIEW_DETAIL B "
                ...
                + "AND  EFFECTIVE_FROM >='2022-04-01' AND EFFECTIVE_TO <='2023-03-31' AND R.APPROVED =1 AND B.APPROVED =1 "
                + "AND  B.GROUP_NAME IN ('SDF','HDS') AND PRODUCT_CODE = QUALITY_NO "
                + "AND R.PARTY_CODE != '' AND R.PARTY_CODE = B.PARTY_CODE");
...
//                + "SET 11 = DISC_PER "
//                + "WHERE B.YEAR_FROM=2020 AND SUBSTRING(PRODUCT_CODE,1,3) IN ('729','719') "
//                + "AND  EFFECTIVE_FROM >='2020-04-01' AND EFFECTIVE_TO <='2021-03-31' AND R.APPROVED =1  "
//                + "AND  B.GROUP_NAME IN ('SDF','HDS') AND PRODUCT_CODE = QUALITY_NO "
//                + "AND R.PARTY_CODE != '' AND R.PARTY_CODE = B.PARTY_CODE");
        data.Execute("UPDATE  PRODUCTION.FELT_RATE_DISC_MASTER_DETAIL R, PRODUCTION.FELT_BUDGET_REVIEW_DETAIL B "
                + "SET SPL_DISCOUNT = DISC_PER "
                + "WHERE B.YEAR_FROM=2022 AND SUBSTRING(PRODUCT_CODE,1,3) IN ('729','719') "
                + "AND  EFFECTIVE_FROM >='2022-04-01' AND EFFECTIVE_TO <='2023-03-31' AND R.APPROVED =1  "
                + "AND  B.GROUP_NAME IN ('SDF','HDS') AND PRODUCT_CODE = QUALITY_NO "
                + "AND R.PARTY_CODE != '' AND R.PARTY_CODE = B.PARTY_CODE");
        ...
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL "
                ...
                + "WHERE  GROUP_NAME IN ('SDF','HDS') AND YEAR_FROM=2022");
        ...
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D,PRODUCTION.FELT_EXPORT_RATE_MASTER M "
                + "SET SELLING_PRICE=RATE WHERE D.YEAR_FROM =2022 AND D.PARTY_CODE=M.PARTY_CODE AND D.MACHINE_NO=M.MACHINE_NO AND D.POSITION_NO=M.POSITION_NO");
...
//        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D"
//                + "SET OC_STOCK=0 "
//                + "WHERE D.UPN=OC.OCUPN  AND LEFT(D.DOC_NO,7)=CONCAT('N2122',RIGHT(100+(MONTH(CURDATE())),2))"
//                + " AND D.YEAR_FROM=2020 ");
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D"
                + "SET OC_STOCK=0 "
                + "WHERE D.UPN=OC.OCUPN  AND LEFT(D.DOC_NO,7)=CONCAT('B2223',RIGHT(100+(MONTH(CURDATE())),2))"
                + " AND D.YEAR_FROM=2022 ");        
...
//                + " AND D.YEAR_FROM=2020 AND REQ_LAST_DDMMYY<'2021-04-01'");
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D,(SELECT UPN AS OCUPN,COUNT(*) AS OCSTK,REQ_LAST_DDMMYY FROM PRODUCTION.FELT_WH_MTH_CLOSING_PIECE_STOCK F "
                ...
                + "SET OC_STOCK=OCSTK "
                + "WHERE D.UPN=OC.OCUPN  AND LEFT(D.DOC_NO,7)=CONCAT('B2223',RIGHT(100+(MONTH(CURDATE())),2)) "
                + " AND D.YEAR_FROM=2022 AND REQ_LAST_DDMMYY>='2022-04-01'");
...
//                + "WHERE  LEFT(DOC_NO,7)=CONCAT('B2021',RIGHT(100+(MONTH(CURDATE())),2))");
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL "
                + "SET ACESS_QTY=0 "
                + "WHERE ACESSD_QTY<0 AND LEFT(DOC_NO,7)=CONCAT('B2223',RIGHT(100+(MONTH(CURDATE())),2))");
        data.Execute("UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL "
                + "SET ACESS_QTY=0 "
                + "WHERE ACESSD_QTY<0 AND LEFT(DOC_NO,7)=CONCAT('B2223',RIGHT(100+MONTH(DATE_ADD(LAST_DAY(CURDATE()),INTERVAL 1 DAY)),2))");
...
//                + "WHERE LEFT(DOC_NO,7)=CONCAT('B2021',RIGHT(100+MONTH(DATE_ADD(LAST_DAY(CURDATE()),INTERVAL 1 DAY)),2))");
    ...
    private void GenerateReportTable() {
        ...
        String sql = "";
        sql="DROP TABLE PRODUCTION.TMPFELTBUDGETREPORT";
        data.Execute(sql);
        sql = "CREATE TABLE IF NOT EXISTS PRODUCTION.TMPFELTBUDGETREPORT "
                + "SELECT D.*,'-' AS USER_ID FROM PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D "
                + " LIMIT 1";
        data.Execute(sql);
        data.Execute("DELETE FROM PRODUCTION.TMPFELTBUDGETREPORT WHERE USER_ID='-' ");
        sql = "INSERT INTO PRODUCTION.TMPFELTBUDGETREPORT "
                + "SELECT D.*,'-' AS USER_ID FROM PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D "
                + "WHERE LEFT(DOC_NO,7)=CONCAT('N" + pfinyear + "',RIGHT(100+" + 1 + ",2)) ";
        data.Execute(sql);
        sql = "UPDATE PRODUCTION.TMPFELTBUDGETREPORT "
                + "SET ACTUAL_BUDGET=CURRENT_PROJECTION,ACTUAL_BUDGET_VALUE=CURRENT_PROJECTION*SELLING_PRICE "
                + "WHERE USER_ID='-' ";
        data.Execute(sql);
        sql = "UPDATE PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D "
                + "SET CURRENT_PROJECTION=";
        for (int a = 1; a <= 12; a++) {
            sql = sql + "COALESCE(" + mnth.get(a) + "_BUDGET)";
            if (a < 12) {
                sql = sql + "+";
            }
        }
        ...
        data.Execute(sql);
        for (int i = 4; i <= 12; i++) {
            data.Execute("INSERT INTO PRODUCTION.TMPFELTBUDGETREPORT "
                    + "SELECT D.*,'-' AS USER_ID FROM PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D "
                    + "WHERE LEFT(DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + i + ",2)) ");
            for (int j = 1; j <= 12; j++) {
                sql = "UPDATE PRODUCTION.TMPFELTBUDGETREPORT "
                        + "SET " + mnth.get(j) + "_BUDGET=0," + mnth.get(j) + "_NET_AMOUNT=0 "
                        + "WHERE LEFT(DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + i + ",2)) AND USER_ID='-' ";
                //System.out.println("sql:"+sql);
                data.Execute(sql);
            }
            sql = "UPDATE PRODUCTION.TMPFELTBUDGETREPORT "
                    + "SET " + mnth.get(i) + "_BUDGET=CURRENT_PROJECTION," + mnth.get(i) + "_NET_AMOUNT=CURRENT_PROJECTION*SELLING_PRICE "
                    + "WHERE LEFT(DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + i + ",2)) AND USER_ID='-' ";
            //System.out.println("SQL:"+sql);
            data.Execute(sql);
            for (int k = i; k < 4; k--) {
                data.Execute("UPDATE PRODUCTION.TMPFELTBUDGETREPORT T,,PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D "
                        + "SET T." + mnth.get(k) + "_BUDGET=D.CURRENT_PROJECTION,T." + mnth.get(k) + "_NET_AMOUNT=D.CURRENT_PROJECTION*D.SELLING_PRICE "
                        + "WHERE T.UPN=D.UPN AND LEFT(D.DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + k + ",2)) "
                        + "AND LEFT(T.DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + i + ",2)) "
                        + "AND T.USER_ID='-' ");
            }
        }
        for (int i = 1; i <= 3; i++) {
            ...
            for (int l = 1; l <= (i - 1); l++) {
                data.Execute("UPDATE PRODUCTION.TMPFELTBUDGETREPORT T,,PRODUCTION.FELT_BUDGET_REVIEW_DETAIL D "
                        + "SET T." + mnth.get(l) + "_BUDGET=D.CURRENT_PROJECTION,T." + mnth.get(l) + "_NET_AMOUNT=D.CURRENT_PROJECTION*D.SELLING_PRICE "
                        + "WHERE T.UPN=D.UPN AND LEFT(D.DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + l + ",2)) "
                        + "AND LEFT(T.DOC_NO,7)=CONCAT('B" + pfinyear + "',RIGHT(100+" + i + ",2)) "
                        + "AND T.USER_ID='-' ");
            }
        }
