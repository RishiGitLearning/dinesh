 ...
 * @version
 */
public class clsBudgetEntryItem {
    ...
    public clsBudgetEntryItem() {
        ...
        props.put("Q4NET_AMOUNT", new Variant(0.00));
        props.put("WIP_31_MAR_QTY", new Variant(0.00));
        props.put("WIP_31_MAR_VALUE", new Variant(0.00));
        props.put("STOCK_31_MAR_QTY", new Variant(0.00));
        props.put("STOCK_31_MAR_VALUE", new Variant(0.00));
        props.put("LAST_INVOICE_DATE", new Variant(""));
        props.put("AVG_LIFE", new Variant(0));
        props.put("PROJECTED_MMYYYY", new Variant(""));
