 ...
 * @author nrpithva
 */
public class BudgetLOV extends javax.swing.JApplet {
    ...
    public BudgetLOV(String pSQL, int pReturnCol, boolean pShowReturnCol, int pDefaultSearchOn) {
        System.gc();
        initComponents();
        DataModel = new EITLTableModel();
        SQL = pSQL;
