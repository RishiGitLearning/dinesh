...
public class clsBudgetEntry {
    ...
    public static int ModuleID = 768 ; //825 // //72
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_BUDGET_DETAIL WHERE  LEFT(DOC_NO,2)='B2' GROUP BY DOC_NO,YEAR_FROM  ORDER BY CREATED_DATE,DOC_NO ");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            setAttribute("DOC_NO", clsFirstFree.getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 768, (int) getAttribute("FFNO").getVal(), true));   //7
            //-------------------------------------------------
            ...
            for (int i = 1; i <= colMRItems.size(); i++) {
                clsBudgetEntryItem ObjMRItems = (clsBudgetEntryItem) colMRItems.get(Integer.toString(i));
            ...
            ObjFlow.ModuleID = clsBudgetEntry.ModuleID;
    ...
    public boolean Update() {
        ...
        try {
            ...
            sql = "UPDATE PRODUCTION.FELT_BUDGET_DETAIL "
                    +"SET Q4=?,Q4NET_AMOUNT=?,TOTAL=?,NET_AMOUNT=?,MODIFIED_BY=?,MODIFIED_DATE=? WHERE UPN=?";
            ...
            sqlh = "INSERT INTO PRODUCTION.FELT_BUDGET_DETAIL_H "
                    ...
                    + "PRESS_LENGTH,PRESS_WIDTH,PRESS_GSM,PRESS_WEIGHT,PRESS_SQMTR,DRY_LENGTH,DRY_WIDTH,DRY_SQMTR,"
                    //+ "DRY_WEIGHT,QUALITY_NO,GROUP_NAME,SELLING_PRICE,SPL_DISCOUNT,WIP,STOCK,"
                    + "DRY_WEIGHT,QUALITY_NO,GROUP_NAME,SELLING_PRICE,SPL_DISCOUNT,"
                    + "Q1,Q2,Q3,Q4,PARTY_STATUS,REMARKS,HIERARCHY_ID,CREATED_BY,CREATED_DATE,"
                    + "MODIFIED_BY,MODIFIED_DATE,APPROVED,APPROVED_DATE,REJECTED,REJECTED_DATE,REJECTED_REMARKS,"
                    + "CANCELED,CANCELED_DATE,CHANGED,CHANGED_DATE,REVISION_NO,UPDATED_BY,APPROVAL_STATUS,"
                    + "ENTRY_DATE,APPROVER_REMARKS,FROM_IP,"
                    ...
                    + "PREV_PREV_YEAR_VALUE,Q4NET_AMOUNT, "
                    + "WIP_31_MAR_QTY,WIP_31_MAR_VALUE,STOCK_31_MAR_QTY,STOCK_31_MAR_VALUE, "
                    + "LAST_INVOICE_DATE,AVG_LIFE,PROJECTED_MMYYYY,INCHARGE,SIZE_CRITERIA,PARTY_GROUP) ";
            ...
            for (int i = 1; i <= colMRItems.size(); i++) {
                ...
                setAttribute("DOC_NO", ObjMRItems.getAttribute("DOC_NO").getObj().toString());
                pstm.setDouble(1, (double) ObjMRItems.getAttribute("Q4").getVal());
                pstm.setDouble(2, (double) ObjMRItems.getAttribute("Q4NET_AMOUNT").getVal());
                pstm.setDouble(3, (double) ObjMRItems.getAttribute("Q4").getVal());
                pstm.setDouble(4, (double) ObjMRItems.getAttribute("Q4NET_AMOUNT").getVal());
                pstm.setInt(5, (int) getAttribute("MODIFIED_BY").getVal());
                pstm.setString(6, (String) getAttribute("MODIFIED_DATE").getObj());
                pstm.setString(7, (String) ObjMRItems.getAttribute("UPN").getObj());
                ...
                //pstmh.setDouble(22, (double) ObjMRItems.getAttribute("WIP").getVal());
                //pstmh.setDouble(23, (double) ObjMRItems.getAttribute("STOCK").getVal());
                pstmh.setDouble(22, (double) ObjMRItems.getAttribute("Q1").getVal());
                pstmh.setDouble(23, (double) ObjMRItems.getAttribute("Q2").getVal());
                pstmh.setDouble(24, (double) ObjMRItems.getAttribute("Q3").getVal());
                pstmh.setDouble(25, (double) ObjMRItems.getAttribute("Q4").getVal());
                pstmh.setString(26, (String) ObjMRItems.getAttribute("PARTY_STATUS").getObj());
                pstmh.setString(27, (String) ObjMRItems.getAttribute("REMARKS").getObj());
                pstmh.setInt(28, (int) getAttribute("HIERARCHY_ID").getVal());
                pstmh.setString(29, null);
                pstmh.setString(30, null);
                pstmh.setInt(31, (int) getAttribute("MODIFIED_BY").getVal());
                pstmh.setString(32, (String) getAttribute("MODIFIED_DATE").getObj());
                pstmh.setBoolean(33, false);
                pstmh.setString(34, "0000-00-00");
                pstmh.setBoolean(35, false);
                pstmh.setString(36, "0000-00-00");
                pstmh.setString(37, getAttribute("REJECTED_REMARKS").getString());
                pstmh.setBoolean(38,false);
                pstmh.setString(39, "0000-00-00");
                pstmh.setBoolean(40, true);
                pstmh.setString(41, EITLERPGLOBAL.getCurrentDateDB());
                pstmh.setInt(42, RevNo);
                pstmh.setInt(43, (int) getAttribute("MODIFIED_BY").getVal());
                pstmh.setString(44, getAttribute("APPROVAL_STATUS").getString());
                pstmh.setString(45, data.getStringValueFromDB("SELECT CURRENT_TIMESTAMP AS DATE FROM DUAL"));
                pstmh.setString(46, getAttribute("APPROVER_REMARKS").getString());
                pstmh.setString(47, str_split[1]);
                pstmh.setDouble(48, (double) ObjMRItems.getAttribute("Q1KG").getVal());
                pstmh.setDouble(49, (double) ObjMRItems.getAttribute("Q1SQMTR").getVal());
                pstmh.setDouble(50, (double) ObjMRItems.getAttribute("Q2KG").getVal());
                pstmh.setDouble(51, (double) ObjMRItems.getAttribute("Q2SQMTR").getVal());
                pstmh.setDouble(52, (double) ObjMRItems.getAttribute("Q3KG").getVal());
                pstmh.setDouble(53, (double) ObjMRItems.getAttribute("Q3SQMTR").getVal());
                pstmh.setDouble(54, (double) ObjMRItems.getAttribute("Q4KG").getVal());
                pstmh.setDouble(55, (double) ObjMRItems.getAttribute("Q4SQMTR").getVal());
                pstmh.setDouble(56, (double) ObjMRItems.getAttribute("TOTAL").getVal());
                pstmh.setDouble(57, (double) ObjMRItems.getAttribute("GST_PER").getVal());
                pstmh.setDouble(58, (double) ObjMRItems.getAttribute("GROSS_AMOUNT").getVal());
                pstmh.setDouble(59, (double) ObjMRItems.getAttribute("DISCOUNT_AMOUNT").getVal());
                pstmh.setDouble(60, (double) ObjMRItems.getAttribute("NET_AMOUNT").getVal());
                pstmh.setString(61, (String) ObjMRItems.getAttribute("PP_REMARKS").getObj());
                pstmh.setString(62, (String) ObjMRItems.getAttribute("STYLE").getObj());
                pstmh.setDouble(63, (double) ObjMRItems.getAttribute("TOTAL_KG").getVal());
                pstmh.setDouble(64, (double) ObjMRItems.getAttribute("TOTAL_SQMTR").getVal());
                pstmh.setString(65, (String) ObjMRItems.getAttribute("SYSTEM_STATUS").getObj());
                pstmh.setString(66, (String) ObjMRItems.getAttribute("UPN").getObj());
                pstmh.setDouble(67, (Double) ObjMRItems.getAttribute("POTENTIAL").getVal());
                pstmh.setDouble(68, (Double) ObjMRItems.getAttribute("PREV_YEAR_QTY").getVal());
                pstmh.setDouble(69, (Double) ObjMRItems.getAttribute("PREV_YEAR_VALUE").getVal());
                pstmh.setDouble(70, (Double) ObjMRItems.getAttribute("PREV_PREV_YEAR_QTY").getVal());
                pstmh.setDouble(71, (Double) ObjMRItems.getAttribute("PREV_PREV_YEAR_VALUE").getVal());
                pstmh.setDouble(72, (double) ObjMRItems.getAttribute("Q4NET_AMOUNT").getVal());
                pstmh.setDouble(73, (double) ObjMRItems.getAttribute("WIP_31_MAR_QTY").getVal());
                pstmh.setDouble(74, (double) ObjMRItems.getAttribute("WIP_31_MAR_VALUE").getVal());
                pstmh.setDouble(75, (double) ObjMRItems.getAttribute("STOCK_31_MAR_QTY").getVal());
                pstmh.setDouble(76, (double) ObjMRItems.getAttribute("STOCK_31_MAR_VALUE").getVal());
                pstmh.setString(77, EITLERPGLOBAL.formatDateDB((String) ObjMRItems.getAttribute("LAST_INVOICE_DATE").getObj()));
                pstmh.setDouble(78, (double) ObjMRItems.getAttribute("AVG_LIFE").getVal());
                pstmh.setString(79, EITLERPGLOBAL.formatDateDB((String) ObjMRItems.getAttribute("PROJECTED_MMYYYY").getObj()));
                pstmh.setString(80, (String) ObjMRItems.getAttribute("INCHARGE").getObj());
                pstmh.setString(81, (String) ObjMRItems.getAttribute("SIZE_CRITERIA").getObj());
                pstmh.setString(82, (String) ObjMRItems.getAttribute("PARTY_GROUP").getObj());
                pstmh.addBatch();
                if ((i + 1) % 1000 == 0) {
                    pstm.executeBatch();
                    pstmh.executeBatch();
            ...
            ObjFlow.To = (int) getAttribute("TO").getVal();
            ObjFlow.Status = (String) getAttribute("APPROVAL_STATUS").getObj();
            ObjFlow.TableName = "PRODUCTION.FELT_BUDGET_DETAIL";
            ...
            if (IsRejected) {
                ...
                data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=" + clsBudgetEntry.ModuleID + " AND DOC_NO='" + ObjFlow.DocNo + "'");
    ...
    public boolean UpdateOld() {
        ...
        try {
            ...
            sql = "INSERT INTO PRODUCTION.FELT_BUDGET_DETAIL "
                    ...
                    + "PRESS_LENGTH,PRESS_WIDTH,PRESS_GSM,PRESS_WEIGHT,PRESS_SQMTR,DRY_LENGTH,DRY_WIDTH,DRY_SQMTR,"
                    //+ "DRY_WEIGHT,QUALITY_NO,GROUP_NAME,SELLING_PRICE,SPL_DISCOUNT,WIP,STOCK,Q1,Q2,Q3,Q4,"
                    + "DRY_WEIGHT,QUALITY_NO,GROUP_NAME,SELLING_PRICE,SPL_DISCOUNT,Q1,Q2,Q3,Q4,"
                    + "PARTY_STATUS,REMARKS,HIERARCHY_ID,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,"
                    + "APPROVED,APPROVED_DATE,REJECTED,REJECTED_DATE,REJECTED_REMARKS,CANCELED,CANCELED_DATE"
                    + ",CHANGED,CHANGED_DATE,Q1KG,Q1SQMTR,Q2KG,Q2SQMTR,Q3KG,Q3SQMTR,Q4KG,Q4SQMTR,TOTAL,"
                    + "GST_PER,GROSS_AMOUNT,DISCOUNT_AMOUNT,NET_AMOUNT,PP_REMARKS,STYLE,TOTAL_KG,TOTAL_SQMTR,SYSTEM_STATUS,"
            ...
            for (int i = 1; i <= colMRItems.size(); i++) {
                ...
                //pstm.setDouble(22, (double) ObjMRItems.getAttribute("WIP").getVal());
                //pstm.setDouble(23, (double) ObjMRItems.getAttribute("STOCK").getVal());
                pstm.setDouble(22, (double) ObjMRItems.getAttribute("Q1").getVal());
                pstm.setDouble(23, (double) ObjMRItems.getAttribute("Q2").getVal());
                pstm.setDouble(24, (double) ObjMRItems.getAttribute("Q3").getVal());
                pstm.setDouble(25, (double) ObjMRItems.getAttribute("Q4").getVal());
                pstm.setString(26, (String) ObjMRItems.getAttribute("PARTY_STATUS").getObj());
                pstm.setString(27, (String) ObjMRItems.getAttribute("REMARKS").getObj());
                pstm.setInt(28, (int) getAttribute("HIERARCHY_ID").getVal());
                pstm.setString(29, null);
                pstm.setString(30, null);
                pstm.setInt(31, (int) getAttribute("MODIFIED_BY").getVal());
                pstm.setString(32, (String) getAttribute("MODIFIED_DATE").getObj());
                pstm.setBoolean(33, false);
                pstm.setString(34, "0000-00-00");
                pstm.setBoolean(35, false);
                pstm.setString(36, "0000-00-00");
                pstm.setString(37, getAttribute("REJECTED_REMARKS").getString());
                pstm.setBoolean(38, false);
                pstm.setString(39, "0000-00-00");
                pstm.setBoolean(40, true);
                pstm.setString(41, EITLERPGLOBAL.getCurrentDateDB());
                pstm.setDouble(42, (double) ObjMRItems.getAttribute("Q1KG").getVal());
                pstm.setDouble(43, (double) ObjMRItems.getAttribute("Q1SQMTR").getVal());
                pstm.setDouble(44, (double) ObjMRItems.getAttribute("Q2KG").getVal());
                pstm.setDouble(45, (double) ObjMRItems.getAttribute("Q2SQMTR").getVal());
                pstm.setDouble(46, (double) ObjMRItems.getAttribute("Q3KG").getVal());
                pstm.setDouble(47, (double) ObjMRItems.getAttribute("Q3SQMTR").getVal());
                pstm.setDouble(48, (double) ObjMRItems.getAttribute("Q4KG").getVal());
                pstm.setDouble(49, (double) ObjMRItems.getAttribute("Q4SQMTR").getVal());
                pstm.setDouble(50, (double) ObjMRItems.getAttribute("TOTAL").getVal());
                pstm.setDouble(51, (double) ObjMRItems.getAttribute("GST_PER").getVal());
                pstm.setDouble(52, (double) ObjMRItems.getAttribute("GROSS_AMOUNT").getVal());
                pstm.setDouble(53, (double) ObjMRItems.getAttribute("DISCOUNT_AMOUNT").getVal());
                pstm.setDouble(54, (double) ObjMRItems.getAttribute("NET_AMOUNT").getVal());
                pstm.setString(55, (String) ObjMRItems.getAttribute("PP_REMARKS").getObj());
                pstm.setString(56, (String) ObjMRItems.getAttribute("STYLE").getObj());
                pstm.setDouble(57, (double) ObjMRItems.getAttribute("TOTAL_KG").getVal());
                pstm.setDouble(58, (double) ObjMRItems.getAttribute("TOTAL_SQMTR").getVal());
                pstm.setString(59, (String) ObjMRItems.getAttribute("SYSTEM_STATUS").getObj());
                pstm.setString(60, (String) ObjMRItems.getAttribute("UPN").getObj());
                pstm.setDouble(61, (double) ObjMRItems.getAttribute("POTENTIAL").getVal());
                pstm.setDouble(62, (double) ObjMRItems.getAttribute("PREV_YEAR_QTY").getVal());
                pstm.setDouble(63, (double) ObjMRItems.getAttribute("PREV_YEAR_VALUE").getVal());
                pstm.setDouble(64, (double) ObjMRItems.getAttribute("PREV_PREV_YEAR_QTY").getVal());
                pstm.setDouble(65, (double) ObjMRItems.getAttribute("PREV_PREV_YEAR_VALUE").getVal());
                pstm.setDouble(66, (double) ObjMRItems.getAttribute("Q4NET_AMOUNT").getVal());
                pstm.setDouble(67, (double) ObjMRItems.getAttribute("WIP_31_MAR_QTY").getVal());
                pstm.setDouble(68, (double) ObjMRItems.getAttribute("WIP_31_MAR_VALUE").getVal());
                pstm.setDouble(69, (double) ObjMRItems.getAttribute("STOCK_31_MAR_QTY").getVal());
                pstm.setDouble(70, (double) ObjMRItems.getAttribute("STOCK_31_MAR_VALUE").getVal());
                pstm.setString(71, EITLERPGLOBAL.formatDateDB((String) ObjMRItems.getAttribute("LAST_INVOICE_DATE").getObj()));
                pstm.setDouble(72, (double) ObjMRItems.getAttribute("AVG_LIFE").getVal());
                pstm.setString(73, EITLERPGLOBAL.formatDateDB((String) ObjMRItems.getAttribute("PROJECTED_MMYYYY").getObj()));
                pstm.setString(74, (String) ObjMRItems.getAttribute("INCHARGE").getObj());
                pstm.setString(75, (String) ObjMRItems.getAttribute("SIZE_CRITERIA").getObj());
                pstm.setString(76, (String) ObjMRItems.getAttribute("PARTY_GROUP").getObj());
                pstm.addBatch();
    ...
    public boolean setData() {
        ...
        try {
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                Counter = Counter + 1;
                clsBudgetEntryItem ObjMRItems = new clsBudgetEntryItem();
                ...
                ObjMRItems.setAttribute("Q4NET_AMOUNT", rsTmp.getDouble("Q4NET_AMOUNT"));
                ObjMRItems.setAttribute("WIP_31_MAR_QTY", rsTmp.getDouble("WIP_31_MAR_QTY"));
                ObjMRItems.setAttribute("WIP_31_MAR_VALUE", rsTmp.getDouble("WIP_31_MAR_VALUE"));
                ObjMRItems.setAttribute("STOCK_31_MAR_QTY", rsTmp.getDouble("STOCK_31_MAR_QTY"));
                ObjMRItems.setAttribute("STOCK_31_MAR_VALUE", rsTmp.getDouble("STOCK_31_MAR_VALUE"));
                ObjMRItems.setAttribute("LAST_INVOICE_DATE", rsTmp.getString("LAST_INVOICE_DATE"));
                ObjMRItems.setAttribute("AVG_LIFE", rsTmp.getString("AVG_LIFE"));
                ObjMRItems.setAttribute("PROJECTED_MMYYYY", rsTmp.getString("PROJECTED_MMYYYY"));
    ...
    public boolean IsEditable(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=768 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND STATUS='W'"; //825
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
        ...
        try {
            ...
            if (rsTmp.getRow() > 0) {
                while (!rsTmp.isAfterLast()) {
                    clsBudgetEntry objParty = new clsBudgetEntry();
    ...
    public boolean Filter(String Condition) {
        ...
        try {
            String strSQL = "";
            strSQL += "SELECT * FROM PRODUCTION.FELT_BUDGET_DETAIL WHERE LEFT(DOC_NO,2)='B2' AND " + Condition + " GROUP BY DOC_NO";
    ...
    public boolean CanDelete(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=825 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND TYPE='C' AND STATUS='W'"; //825
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static void CancelDoc(String pAmendNo) {
        ...
        if (CanCancel(pAmendNo)) {
            ...
            try {
                rsTmp = data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_BUDGET_DETAIL WHERE DOC_NO='" + pAmendNo + "' ");
                rsTmp.first();
                ...
                if (!Approved) {
                    data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE DOC_NO='" + pAmendNo + "' AND MODULE_ID=768"); //825
                }
                data.Execute("UPDATE PRODUCTION.FELT_BUDGET_DETAIL SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE DOC_NO='" + pAmendNo + "'");
    ...
    public static boolean CanCancel(String pDocNo) {
        ...
        try {
            ...
            System.out.println("SELECT DOC_NO FROM PRODUCTION.FELT_BUDGET_DETAIL WHERE DOC_NO='" + pDocNo + "'  AND APPROVED=0 AND CANCELED=0");
            rsTmp = stTmp.executeQuery("SELECT DOC_NO FROM PRODUCTION.FELT_BUDGET_DETAIL WHERE DOC_NO='" + pDocNo + "'  AND APPROVED=0 AND CANCELED=0");
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT DISTINCT PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO,PRODUCTION.FELT_BUDGET_DETAIL.PARTY_NAME,PARTY_GROUP FROM PRODUCTION.FELT_BUDGET_DETAIL,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO=PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=768 ORDER BY PARTY_NAME"; // 825
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT DISTINCT PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO,PRODUCTION.FELT_BUDGET_DETAIL.PARTY_NAME,PARTY_GROUP FROM PRODUCTION.FELT_BUDGET_DETAIL,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO=PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=768 ORDER BY PRODUCTION.FELT_BUDGET_DETAIL.PARTY_GROUP"; //825
            }

            if (pOrder == EITLERPGLOBAL.OnDocNo) {
                strSQL = "SELECT DISTINCT PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO,PRODUCTION.FELT_BUDGET_DETAIL.PARTY_NAME,PARTY_GROUP FROM PRODUCTION.FELT_BUDGET_DETAIL,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO=PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=768 ORDER BY PRODUCTION.FELT_BUDGET_DETAIL.DOC_NO"; //825 
            }
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                Counter = Counter + 1;
                clsBudgetEntry ObjItem = new clsBudgetEntry();

                //------------- Header Fields --------------------//
                ObjItem.setAttribute("DOC_NO", rsTmp.getString("DOC_NO"));
                ObjItem.setAttribute("RECEIVED_DATE", rsTmp.getString("PARTY_NAME"));
                ObjItem.setAttribute("DOC_DATE", rsTmp.getString("PARTY_GROUP"));
...
//                ObjItem.setAttribute("RECEIVED_DATE", rsTmp.getString("RECEIVED_DATE"));
    ...
    public boolean ShowHistory(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_BUDGET_DETAIL_H WHERE DOC_NO='" + pDocNo + "' AND LEFT(DOC_NO,2)='MB' GROUP BY DOC_NO ORDER BY REVISION_NO");
            Ready = true;
            HistoryView = true;
            MoveFirst();
            return true;
