...
public class frmFindFeltOrderDiversionLoss extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Felt Diversion Prior Approval");
        ...
        txtDocNo.setBounds(110, 10, 160, 20);

        jLabel3.setDisplayedMnemonic('G');
        jLabel3.setText("Document No");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 10, 130, 14);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag2=false;
        if(!"".equals(S_O_DATE.getText()))
        {
            if(flag)
            {
                stringFindQuery = stringFindQuery+" AND SD_ORDER_DATE = "+EITLERPGLOBAL.formatDateDB(S_O_DATE.getText());
            }
            else
            {
                stringFindQuery = " SD_ORDER_DATE ='"+EITLERPGLOBAL.formatDateDB(S_O_DATE.getText())+"'";
            }
            flag2 = true;
        }
