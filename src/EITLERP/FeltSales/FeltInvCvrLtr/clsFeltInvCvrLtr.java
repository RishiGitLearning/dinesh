...
public class clsFeltInvCvrLtr {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA GROUP BY DOC_NO ORDER BY DOC_NO");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
...
//            else setData();
    ...
    public boolean Insert() {
        ...
        try {
            ...
            resultSetTemp = statementTemp.executeQuery("SELECT * FROM  PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='1'");

            // Production data history connection
            statementHistory = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            resultSetHistory = statementHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA_H WHERE DOC_NO='1'");

            setAttribute("DOC_NO", getNextFreeNo((int) EITLERPGLOBAL.gCompanyID, 615, 333, true));

            //Now Insert records into production tables
            for (int i = 1; i <= hmFeltFinishingDetails.size(); i++) {
                clsFeltInvCvrLtrDetails ObjFeltFinishingDetails = (clsFeltInvCvrLtrDetails) hmFeltFinishingDetails.get(Integer.toString(i));
                ...
                resultSetTemp.updateString("LR_NO", getAttribute("LR_NO").getString());
                resultSetTemp.updateString("LR_DATE", EITLERPGLOBAL.formatDateDB(getAttribute("LR_DATE").getString()));
                
                resultSetTemp.updateString("INVOICE_NO",ObjFeltFinishingDetails.getAttribute("INVOICE_NO").getString());
                resultSetTemp.updateString("INVOICE_DATE",EITLERPGLOBAL.formatDateDB(ObjFeltFinishingDetails.getAttribute("INVOICE_DATE").getString()));
                ...
                resultSetTemp.updateString("CORR_ADDRESS", ObjFeltFinishingDetails.getAttribute("CORR_ADDRESS").getString());
                resultSetTemp.updateString("STATION", ObjFeltFinishingDetails.getAttribute("STATION").getString());
                ...
                resultSetTemp.updateString("CARRIER", ObjFeltFinishingDetails.getAttribute("CARRIER").getString());
                ...
                resultSetHistory.updateString("LR_NO", getAttribute("LR_NO").getString());
                resultSetHistory.updateString("LR_DATE", EITLERPGLOBAL.formatDateDB(getAttribute("LR_DATE").getString()));
                
                resultSetHistory.updateString("INVOICE_NO",ObjFeltFinishingDetails.getAttribute("INVOICE_NO").getString());
                resultSetHistory.updateString("INVOICE_DATE",EITLERPGLOBAL.formatDateDB(ObjFeltFinishingDetails.getAttribute("INVOICE_DATE").getString()));
                ...
                resultSetHistory.updateString("CORR_ADDRESS", ObjFeltFinishingDetails.getAttribute("CORR_ADDRESS").getString());
                resultSetHistory.updateString("STATION", ObjFeltFinishingDetails.getAttribute("STATION").getString());
                ...
                resultSetHistory.updateString("CARRIER", ObjFeltFinishingDetails.getAttribute("CARRIER").getString());
            ...
            ObjFeltProductionApprovalFlow.ModuleID = 615; 
            ...
            ObjFeltProductionApprovalFlow.TableName = "PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA";
            ...
            if (ObjFeltProductionApprovalFlow.Status.equals("F") && ObjFeltProductionApprovalFlow.finalApproved) {
                ...
                try {
                    data.Execute("UPDATE PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA SET FINAL_APPROVAL_DATE='" + EITLERPGLOBAL.getCurrentDateDB() + "' WHERE DOC_NO = '" + getAttribute("DOC_NO").getString() + "'");
                } catch (Exception e) {
    ...
    public boolean Update() {
        ...
        try {
            ...
            resultSetHistory = statementHistory.executeQuery("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA_H WHERE DOC_NO='" + getAttribute("DOC_NO").getString() + "'");
            ...
            statementHistory.execute("DELETE FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='" + getAttribute("DOC_NO").getString() + "'");
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA SET REJECTED=0,CHANGED=1 WHERE DOC_NO='" + getAttribute("DOC_NO").getString() + "'");
    ...
    public boolean CanDelete(String documentNo, String stringProductionDate, int userID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='" + documentNo + "' AND APPROVED=" + 1;
            ...
            if (rsTmp.getInt("COUNT") > 0) {  //Item is Approved
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=615 AND USER_ID=" + userID + " AND DOC_NO='" + documentNo + "' AND STATUS='W'";
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();

                if (rsTmp.getInt("COUNT") > 0) {
                    strSQL = "DELETE FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='" + documentNo + "'";
    ...
    public boolean Filter(String stringFindQuery) {
        Ready = false;
        try {
            String strSql = "SELECT * FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE 1=1 " + stringFindQuery + " GROUP BY DOC_NO ORDER BY DOC_NO ";
            connection = data.getConn();
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
    ...
    public boolean setData() {
        ...
        try {
            ...
            statementTemp = connection.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            String str = "SELECT * FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO = '" + docNo + "' AND DOC_DATE = '" + docDate + "' ORDER BY INVOICE_DATE,INVOICE_NO";
            ...
            while (!resultSetTemp.isAfterLast()) {
                ...
                setAttribute("LR_NO", resultSetTemp.getString("LR_NO"));
                setAttribute("LR_DATE", resultSetTemp.getString("LR_DATE"));
                
                ObjFeltFinishingDetails.setAttribute("INVOICE_NO", resultSetTemp.getString("INVOICE_NO"));
                ObjFeltFinishingDetails.setAttribute("INVOICE_DATE", resultSetTemp.getString("INVOICE_DATE"));
                ...
                ObjFeltFinishingDetails.setAttribute("CORR_ADDRESS", resultSetTemp.getString("CORR_ADDRESS"));
                ObjFeltFinishingDetails.setAttribute("STATION", resultSetTemp.getString("STATION"));
                ...
                ObjFeltFinishingDetails.setAttribute("CARRIER", resultSetTemp.getString("CARRIER"));
    ...
    public static HashMap getHistoryList(String DocumentNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA_H WHERE DOC_NO='" + DocumentNo + "' GROUP BY REVISION_NO");

            while (rsTmp.next()) {
                clsFeltInvCvrLtr ObjFeltFinishing = new clsFeltInvCvrLtr();
    ...
    public boolean ShowHistory(String pProductionDate, String pDocNo) {
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT * FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA_H WHERE DOC_NO='" + pDocNo + "'");
            Ready = true;
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            ...
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT DISTINCT PI.DOC_NO,PI.DOC_DATE,SUBSTRING(RECEIVED_DATE,1,10) AS RECEIVED_DATE FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA PI,PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=615 AND PI.CANCELED=0 ORDER BY RECEIVED_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT DISTINCT PI.DOC_NO,PI.DOC_DATE,SUBSTRING(RECEIVED_DATE,1,10) AS RECEIVED_DATE FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA PI,PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=615 AND PI.CANCELED=0 ORDER BY PI.DOC_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocNo) {
                strSQL = "SELECT DISTINCT PI.DOC_NO,PI.DOC_DATE,SUBSTRING(RECEIVED_DATE,1,10) AS RECEIVED_DATE FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA PI,PRODUCTION.FELT_PROD_DOC_DATA D WHERE PI.DOC_NO=D.DOC_NO AND USER_ID=" + pUserID + " AND STATUS='W' AND MODULE_ID=615 AND PI.CANCELED=0 ORDER BY PI.DOC_NO";
            }
            ...
            while (rsTmp.next()) {
                ...
                Counter = Counter + 1;
                clsFeltInvCvrLtr ObjDoc = new clsFeltInvCvrLtr();
    ...
    public static void CancelDoc(String pDocNo) {
        ...
        if (CanCancel(pDocNo)) {
            ...
            try {
                rsTmp = data.getResult("SELECT APPROVED FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='" + pDocNo + "' ");
                rsTmp.first();
                ...
                if (!Approved) {
                    data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE DOC_NO='" + pDocNo + "' AND MODULE_ID=615");
                }
                data.Execute("UPDATE PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA SET CANCELED=1,CHANGED=1,CHANGED_DATE=CURDATE() WHERE DOC_NO='" + pDocNo + "'");
    ...
    public static boolean CanCancel(String pDocNo) {
        ...
        try {
            ...
            System.out.println("SELECT DOC_NO FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='" + pDocNo + "'  AND APPROVED=0 AND CANCELED=0");
            rsTmp = stTmp.executeQuery("SELECT DOC_NO FROM PRODUCTION.FELT_INVOICE_COVERING_LETTER_DATA WHERE DOC_NO='" + pDocNo + "'  AND APPROVED=0 AND CANCELED=0");
