...
public class frmFindPPRSEntry extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find :: Felt Piece PPRS MONTH");
        ...
        jLabel2.setText("Document Dt");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 47, 100, 20);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" PPRS_DOC_NO='"+ docNo +"'";
            flag=true;
        }
        boolean flag2=false;
        if(EITLERPGLOBAL.formatDateDB(S_O_DATE.getText()) != null)
        {
            if(flag)
            {
                stringFindQuery = stringFindQuery+" AND PPRS_DOC_DATE = "+EITLERPGLOBAL.formatDateDB(S_O_DATE.getText());
            }
            else
            {
                stringFindQuery = " PPRS_DOC_DATE ='"+EITLERPGLOBAL.formatDateDB(S_O_DATE.getText())+"'";
            }
            flag2 = true;
        }
