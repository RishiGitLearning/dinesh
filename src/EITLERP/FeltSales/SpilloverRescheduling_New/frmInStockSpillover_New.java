 ...
 *
 */
public class frmInStockSpillover_New extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private final int ModuleId = 867;
    private String DOC_NO = "";
    private clsInStockSpillover_New objDToF;
...
//    DecimalFormat f_double = new DecimalFormat("##.00");
    ...
    public void init() {
        ...
        objDToF = new clsInStockSpillover_New();
    ...
    private void DisplayData() {
        ...
        try {
            ...
            for (int i = 1; i <= objDToF.objDToFDetails.size(); i++) {
                clsInStockSpilloverDetails_New ObjItem = (clsInStockSpilloverDetails_New) objDToF.objDToFDetails.get(Integer.toString(i));
                ...
                //DataModel.setValueByVariable("REQ_FOLLOW_UP_DATE",EITLERPGLOBAL.formatDate(ObjItem.getAttribute("REQ_FOLLOW_UP_DATE").getString()), NewRow);
                //DataModel.setValueByVariable("UPDATE_FOLLOW_UP_DATE",EITLERPGLOBAL.formatDate(ObjItem.getAttribute("UPDATE_FOLLOW_UP_DATE").getString()), NewRow);
                ...
                DataModel.setValueByVariable("UPDATE_RE_SCH_MONTH", ObjItem.getAttribute("UPDATE_RE_SCH_MONTH").getString(), NewRow);
            }
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsInStockSpillover_New ObjHistory = (clsInStockSpillover_New) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7073, 70731)) {
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7073, 70732)) {
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7073, 70733)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7073, 70735)) {
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("UPDATE_RE_SCH_MONTH"); //1
            ...
            /*
            DataModel.addColumn("REQ FOLLOW UP DATE"); //1
            DataModel.addColumn("UPDATE FOLLOW UP DATE"); //1
            */
            DataModel.SetVariable(5, "UPDATE_RE_SCH_MONTH"); //1
            //DataModel.SetVariable(6, "UPDATE_FOLLOW_UP_DATE"); //1
            ...
            DataModel.SetVariable(11, "MACHINE_NO"); //2
            DataModel.SetVariable(12, "POSITION"); //3
            DataModel.SetVariable(13, "UPN"); //4
            DataModel.SetVariable(14, "REQUESTED_MONTH"); //5
            DataModel.SetVariable(15, "OC_MONTH"); //6
            DataModel.SetVariable(16, "CURR_SCH_MONTH"); //7
            DataModel.SetVariable(17, "PRODUCT_CODE"); //7
            DataModel.SetVariable(18, "BILL_PRODUCT_CODE"); //7
            DataModel.SetVariable(19, "PR_GROUP"); //7
            DataModel.SetVariable(20, "STYLE"); //7
            DataModel.SetVariable(21, "BILL_STYLE"); //7
            DataModel.SetVariable(22, "LENGTH"); //7
            DataModel.SetVariable(23, "ACTUAL_LENGTH"); //7
            DataModel.SetVariable(24, "BILL_LENGTH"); //7
            DataModel.SetVariable(25, "WIDTH"); //7
            DataModel.SetVariable(26, "ACTUAL_WIDTH"); //7
            DataModel.SetVariable(27, "SQMTR"); //7
            DataModel.SetVariable(28, "BILL_SQMTR"); //7
            DataModel.SetVariable(29, "GSM"); //7
            DataModel.SetVariable(30, "BILL_GSM"); //7
            DataModel.SetVariable(31, "TENDER_GSM"); //7
            DataModel.SetVariable(32, "TH_WEIGHT"); //7
            DataModel.SetVariable(33, "TENDER_WEIGHT"); //7
            DataModel.SetVariable(34, "ACTUAL_WEIGHT"); //7
            DataModel.SetVariable(35, "BILL_WEIGHT"); //7
            DataModel.SetVariable(36, "WEAVING_WEIGHT"); //7
            DataModel.SetVariable(37, "NEEDLING_WEIGHT"); //7
            DataModel.SetVariable(38, "SEAM_WEIGHT"); //7
            DataModel.SetVariable(39, "SPLICE_WEIGHT"); //7
            DataModel.SetVariable(40, "WEAVING_DATE"); //7
            DataModel.SetVariable(41, "MANDING_DATE"); //7
            DataModel.SetVariable(42, "NEEDLING_DATE"); //7
            DataModel.SetVariable(43, "INCHARGE"); //7
            DataModel.SetVariable(44, "PIECE_STAGE"); //7
            DataModel.SetVariable(45, "PIECE_OBSOLETE"); //7
            DataModel.SetVariable(46, "OBSOLETE_DATE"); //7
            DataModel.SetVariable(47, "FINISHING_DATE"); //7
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                    ...
                    DataModel.SetReadOnly(41);
                    DataModel.SetReadOnly(42);
                    DataModel.SetReadOnly(43);
                    DataModel.SetReadOnly(44);
                    DataModel.SetReadOnly(45);
                    DataModel.SetReadOnly(46);
                    DataModel.SetReadOnly(47);
                    //DataModel.SetReadOnly(48);
            }
            else
            {
                for(int i=0;i<=47;i++)
...
//        tcm.getColumn(5).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        lblTitle.setText("In Stock Spillover New");
...
//    }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.SpilloverRescheduling_New.frmFindInStockSpillover_New", true);
        frmFindInStockSpillover_New ObjFindobjDToF = (frmFindInStockSpillover_New) ObjLoader.getObj();

        if (ObjFindobjDToF.Cancelled == false) {
            if (!objDToF.Filter(ObjFindobjDToF.stringFindQuery)) {
                JOptionPane.showMessageDialog(this, "No records found.", "Find Spillover Rescheduling New", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
...
//            String UPDATE_FOLLOW_UP_DATE = DataModel.getValueByVariable("UPDATE_FOLLOW_UP_DATE", i);
//            if(!"".equals(UPDATE_FOLLOW_UP_DATE))
//            {
//                UPDATE_FOLLOW_UP_DATE = EITLERPGLOBAL.formatDateDB(UPDATE_FOLLOW_UP_DATE);
//                
//                int diff = data.getIntValueFromDB("SELECT DATEDIFF('" + UPDATE_FOLLOW_UP_DATE + "','" + EITLERPGLOBAL.getCurrentDateDB() + "')");
//                if(diff<0)
//                {
//                    JOptionPane.showMessageDialog(this, "Updated Date can not be previous date from current date");
//                    return;
//                } 
//            }
    ...
    private void SetData() {
        ...
        try {
            ...
            for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                clsInStockSpilloverDetails_New objDetail = new clsInStockSpilloverDetails_New();
                ...
                //objDetail.setAttribute("REQ_FOLLOW_UP_DATE", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("REQ_FOLLOW_UP_DATE", i)));
                //objDetail.setAttribute("UPDATE_FOLLOW_UP_DATE", EITLERPGLOBAL.formatDateDB(DataModel.getValueByVariable("UPDATE_FOLLOW_UP_DATE", i)));
                
                objDetail.setAttribute("UPDATE_RE_SCH_MONTH", DataModel.getValueByVariable("UPDATE_RE_SCH_MONTH", i));
