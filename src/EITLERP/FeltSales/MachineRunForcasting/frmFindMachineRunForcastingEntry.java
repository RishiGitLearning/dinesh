...
public class frmFindMachineRunForcastingEntry extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Machine Run Forcasting Entry");
        ...
        jPanel1.add(txtyear);
        txtyear.setBounds(150, 40, 120, 30);

        jLabel2.setText("From Year[YYYY]");
        jPanel1.add(jLabel2);
        ...
        PARTY_CODE.setBounds(110, 80, 160, 30);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if (!"".equals(txtyear.getText())) {
            if (flag) {
                stringFindQuery = stringFindQuery + " AND YEAR_FROM = " + (txtyear.getText());
            } else {
                stringFindQuery = " YEAR_FROM ='" + (txtyear.getText()) + "'";
            }
            flag2 = true;
        }
