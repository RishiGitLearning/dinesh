 ...
 *
 */
public class FrmDiversionToFinishing extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private final int ModuleId = 838;
    private String DOC_NO = "";
    private clsDiversionToFinishing objDToF;
...
//    DecimalFormat f_double = new DecimalFormat("##.00");
    ...
    public void init() {
        ...
        objDToF = new clsDiversionToFinishing();
    ...
    private void DisplayData() {
        ...
        clearFields();
        try {
            DFNo.setText(objDToF.getAttribute("DF_NO").getString());
            lblTitle.setText("Felt Piece Division - " + objDToF.getAttribute("DF_NO").getString());
            DFDate.setText(EITLERPGLOBAL.formatDate(objDToF.getAttribute("DF_DATE").getString()));
            ...
            for (int i = 1; i <= objDToF.objDToFDetails.size(); i++) {
                clsDiversionToFinishingDetails ObjItem = (clsDiversionToFinishingDetails) objDToF.objDToFDetails.get(Integer.toString(i));

                Object[] rowData = new Object[1];
                DataModel.addRow(rowData);
                int NewRow = Table.getRowCount() - 1;
                DataModel.setValueByVariable("SR_NO", (NewRow+1)+"", NewRow);
                DataModel.setValueByVariable("SELECT", true, NewRow);
            ...
            String DocNo = objDToF.getAttribute("DF_NO").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsDiversionToFinishing ObjHistory = (clsDiversionToFinishing) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7056, 70561)) {
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7056, 70562)) {
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7056, 70563)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7056, 70565)) {
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.SetVariable(1, "SELECT"); //1
            DataModel.SetVariable(2, "PIECE_NO"); //1
            DataModel.SetVariable(3, "PARTY_CODE"); //1
            DataModel.SetVariable(4, "PARTY_NAME"); //1
            DataModel.SetVariable(5, "MACHINE_NO"); //2
            DataModel.SetVariable(6, "POSITION"); //3
            DataModel.SetVariable(7, "UPN"); //4
            DataModel.SetVariable(8, "REQUESTED_MONTH"); //5
            DataModel.SetVariable(9, "OC_MONTH"); //6
            DataModel.SetVariable(10, "CURR_SCH_MONTH"); //7
            DataModel.SetVariable(11, "PRODUCT_CODE"); //7
            DataModel.SetVariable(12, "BILL_PRODUCT_CODE"); //7
            DataModel.SetVariable(13, "PR_GROUP"); //7
            DataModel.SetVariable(14, "STYLE"); //7
            DataModel.SetVariable(15, "BILL_STYLE"); //7
            DataModel.SetVariable(16, "LENGTH"); //7
            DataModel.SetVariable(17, "ACTUAL_LENGTH"); //7
            DataModel.SetVariable(18, "BILL_LENGTH"); //7
            DataModel.SetVariable(19, "WIDTH"); //7
            DataModel.SetVariable(20, "ACTUAL_WIDTH"); //7
            DataModel.SetVariable(21, "SQMTR"); //7
            DataModel.SetVariable(22, "BILL_SQMTR"); //7
            DataModel.SetVariable(23, "GSM"); //7
            DataModel.SetVariable(24, "BILL_GSM"); //7
            DataModel.SetVariable(25, "TENDER_GSM"); //7
            DataModel.SetVariable(26, "TH_WEIGHT"); //7
            DataModel.SetVariable(27, "TENDER_WEIGHT"); //7
            DataModel.SetVariable(28, "ACTUAL_WEIGHT"); //7
            DataModel.SetVariable(29, "BILL_WEIGHT"); //7
            DataModel.SetVariable(30, "WEAVING_WEIGHT"); //7
            DataModel.SetVariable(31, "NEEDLING_WEIGHT"); //7
            DataModel.SetVariable(32, "SEAM_WEIGHT"); //7
            DataModel.SetVariable(33, "SPLICE_WEIGHT"); //7
            DataModel.SetVariable(34, "WEAVING_DATE"); //7
            DataModel.SetVariable(35, "MANDING_DATE"); //7
            DataModel.SetVariable(36, "NEEDLING_DATE"); //7
            DataModel.SetVariable(37, "INCHARGE"); //7
            DataModel.SetVariable(38, "PIECE_STAGE"); //7
            DataModel.SetVariable(39, "PIECE_OBSOLETE"); //7
            DataModel.SetVariable(40, "OBSOLETE_DATE"); //7
...
//        tcm.getColumn(5).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 60, 900, 380);
        ...
        Tab.addTab("Diversion to Finishing", jPanel1);
        ...
        lblTitle.setText("Felt Diversion To Finishing");
    ...
    private void AddPieces()
    {
        try{
            ...
            " WHERE PR_PIECE_STAGE='DIVERTED_FNSG_STOCK' AND PR_PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_SALES_DIVERSION_TO_FINISHING_HEADER H, " +
            "PRODUCTION.FELT_SALES_DIVERSION_TO_FINISHING_DETAIL D " +
            "WHERE H.APPROVED=0 AND H.CANCELED=0 AND H.DF_NO=D.DF_NO)";
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.FeltDiversionToFinishing", true);
        frmFindDiversionToFinishing ObjFindobjDToF = (frmFindDiversionToFinishing) ObjLoader.getObj();

        if (ObjFindobjDToF.Cancelled == false) {
            if (!objDToF.Filter(ObjFindobjDToF.stringFindQuery)) {
                JOptionPane.showMessageDialog(this, "No records found.", "Find Felt Diversion To Finishing", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    public void Find(String docNo) {
        objDToF.Filter(" DF_NO='" + docNo + "'");
        SetMenuForRights();
        DisplayData();
    }

    public void FindWaiting() {
        objDToF.Filter(" AND PROD_DOC_NO IN (SELECT DISTINCT PROD_DOC_NO FROM PRODUCTION.FELT_PROD_DATA, PRODUCTION.FELT_PROD_DOC_DATA WHERE PROD_DOC_NO=DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
...
//        
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) objDToF.getAttribute("DF_NO").getObj();
    ...
    private void SetData() {
        ...
        objDToF.setAttribute("DF_NO", DFNo.getText());
        objDToF.setAttribute("DF_DATE", DFDate.getText());
        ...
        try {
            ...
            for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                //if(objDToF.getAttribute("SELECT").getBool())
                if(Table.getValueAt(i, 1).equals(true))
                {
                    clsDiversionToFinishingDetails objDetail = new clsDiversionToFinishingDetails();
                    objDetail.setAttribute("SR_NO", DataModel.getValueByVariable("SRNO", i));
                    //
                    objDetail.setAttribute("DF_NO", DFNo.getText());
