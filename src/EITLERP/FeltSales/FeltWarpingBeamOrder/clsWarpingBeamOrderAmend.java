 ...
 * @author
 */
public class clsWarpingBeamOrderAmend {
    ...
    public static int ModuleID = 778; //72
     ...
     */
    public clsWarpingBeamOrderAmend() {
        LastError = "";
        props = new HashMap();
    ...
    public boolean LoadData(long pCompanyID) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND  ORDER BY CREATED_DATE");
            HistoryView = false;
            Ready = true;
            MoveLast();
            return true;
    ...
    public boolean Insert() {
        ...
        try {
            ...
            rsHistory = stHistory.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND_H WHERE DOC_NO='1'"); // '1' for restricting all data retrieval
            rsHistory.first();
            rsHDetail = stHDetail.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND_H WHERE DOC_NO='1'");
            rsHDetail.first();
            //------------------------------------//
            ...
            rsTmp = tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='1'");
            ...
            ObjFlow.ModuleID = clsWarpingBeamOrderAmend.ModuleID;
            ...
            String sql1 = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
            ...
            sql1 = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER P,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
    ...
    public boolean Update() {
        ...
        try {
            ...
            int RevNo = EITLERPGLOBAL.GetQueryResult("SELECT MAX(REVISION_NO) FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND_H WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "'");
            RevNo++;
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(ModuleID, (String) getAttribute("DOC_NO").getObj())) {
                ...
                data.Execute("DELETE FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + mDocNo + "'");

                Statement tmpStmt;

                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                ResultSet rsTmp1 = tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='1'");
            ...
            if (IsRejected) {
                ...
                data.Execute("UPDATE PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND SET REJECTED=0,CHANGED=1,CHANGED_DATE=CURDATE() WHERE DOC_NO='" + ObjFlow.DocNo + "' ");

                //Remove Old Records from FELT_DOC_DATA
                data.Execute("DELETE FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=" + clsWarpingBeamOrderAmend.ModuleID + " AND DOC_NO='" + ObjFlow.DocNo + "'");
            ...
            if (ObjFlow.Status.equals("F")) {
                String sql = "UPDATE PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND "
                        + "SET APPROVED=1,APPROVED_DATE=CURDATE() "
                        + "WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' ";
                data.Execute(sql);

//                sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
...
//                data.Execute(sql);
                sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER P,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
                        + "SET WIP_PIECE_STAGE='WEAVING',WIP_STATUS='WARPED',WIP_WARP_DATE=CURDATE() "
                        + "WHERE P.WIP_EXT_PIECE_NO=D.PIECE_NO AND "
                        + "D.DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' "
                        + " AND WIP_PIECE_STAGE='PLANNING'";
                System.out.println("Final Approval Query :" + sql);
                data.Execute(sql);

//                sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,"
//                        + "(SELECT PIECE_NO,DOC_NO,WEIGHT "
//                        + " FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE PIECE_NO NOT LIKE '%A%' AND PIECE_NO NOT LIKE '%B%') AS D "
...
//                sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,"
//                        + "(SELECT PIECE_NO,DOC_NO,WEIGHT "
//                        + " FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE PIECE_NO LIKE '%A%') AS D "
//                        + "SET PR_PIECE_STAGE='WEAVING',PR_WIP_STATUS='WARPED',PR_WARP_DATE=CURDATE(),"
//                        + "PR_WARP_A_DATE=CURDATE(),"
//                        + "PR_WARPING_WEIGHT_A=D.WEIGHT,"
//                        + "PR_PIECE_AB_FLAG='AB'"
...
//                sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,"
//                        + "(SELECT PIECE_NO,DOC_NO,WEIGHT "
//                        + " FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE PIECE_NO LIKE '%B%') AS D "
//                        + "SET PR_PIECE_STAGE='WEAVING',PR_WIP_STATUS='WARPED',PR_WARP_DATE=CURDATE(),"
...
//                        + "SET PR_PIECE_STAGE='WEAVING',PR_WIP_STATUS='WARPED',PR_WARP_DATE=CURDATE() "
//                        + "WHERE PR_PIECE_NO IN (SELECT WIP_PIECE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER P,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
//                        + "WHERE P.WIP_EXT_PIECE_NO=D.PIECE_NO AND "
//                        + "D.DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' AND COALESCE(WIP_WARP_DATE,'0000-00-00')='0000-00-00') AND "
//                        + "COALESCE(PR_WARP_DATE,'0000-00-00')='0000-00-00' "
//                        + "AND COALESCE(PR_WVG_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_MND_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_NDL_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_FNSG_DATE,'0000-00-00')='0000-00-00' ";
                sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SP, "
                        + "PRODUCTION.FELT_WIP_PIECE_REGISTER WP, "
                        + "PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
...
//============================================================================================================                
                sql = "UPDATE PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
                        ...
                        + "FROM (SELECT  * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
                        + "WHERE INDICATOR NOT IN ('DELETE') AND BEAM_NO IN (SELECT DISTINCT BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
                        + "WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) AS D "
                        + "LEFT JOIN (SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
                ...
                sql = "UPDATE PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_H "
                        + "SET INDICATOR='DELETE',INDICATOR_DATE=CURDATE(),"
                        + "INDICATOR_DOC='" + (String) getAttribute("DOC_NO").getObj() + "' "
                        + "WHERE PIECE_NO IN ( SELECT D.PIECE_NO "
                        + "FROM (SELECT  * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
                ...
                data.Execute(sql);
                sql = "INSERT INTO PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
                        + "(DOC_NO,BEAM_NO,LOOM_NO,SR_NO,PIECE_NO,PARTY_CODE,PRODUCT_CODE,GRUP,STYLE,LENGTH,WIDTH,GSM,WEIGHT,"
                        + "SEQUANCE_NO,READ_SPACE,THEORICAL_LENGTH_MTR,THEORICAL_PICKS_10_CM,TOTAL_PICKS,EXPECTED_GREV_SQ_MTR,FROM_IP,"
                        + "CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE,CHANGED_DATE,CHANGED,INDICATOR,INDICATOR_DATE,INDICATOR_DOC,WEAVING_DATE,WEAVING_SEQUENCE,PP_REMARK,WIP_OC_MONTHYEAR,WIP_OC_LAST_DDMMYY,AUTO_SEQUENCE) "
                        ...
                        + "AA.WEIGHT,AA.SEQUANCE_NO,AA.READ_SPACE,AA.THEORICAL_LENGTH_MTR,AA.THEORICAL_PICKS_10_CM,"
                        + "AA.TOTAL_PICKS,AA.EXPECTED_GREV_SQ_MTR,"
                        + "'" + str_split[1] + "'," + getAttribute("MODIFIED_BY").getInt() + ",CURDATE(),"
                        + "NULL,NULL,CURDATE(),1,'ADD',CURDATE(),'" + (String) getAttribute("DOC_NO").getObj() + "',WEAVING_DATE,WEAVING_SEQUENCE,PP_REMARK,WIP_OC_MONTHYEAR,WIP_OC_LAST_DDMMYY,AUTO_SEQUENCE "
                        + " FROM ("
                        + "SELECT D.* "
                        + "FROM (SELECT  * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
                        + "WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' AND "
                        + "BEAM_NO IN (SELECT DISTINCT BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL)) AS D "
                        + "LEFT JOIN (SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL WHERE COALESCE(INDICATOR,'')!='DELETE') AS  A "
                        + "ON D.BEAM_NO=A.BEAM_NO AND D.PIECE_NO=A.PIECE_NO "
                        + "WHERE A.PIECE_NO IS NULL) AS AA "
                        + "LEFT JOIN (SELECT DISTINCT DOC_NO,BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER) AS BB "
                        + "ON AA.BEAM_NO=BB.BEAM_NO";
                System.out.println("Add Piece Query :" + sql);
                data.Execute(sql);
                sql = "INSERT INTO PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_H "
                        + "(REVISION_NO,DOC_NO,BEAM_NO,LOOM_NO,SR_NO,PIECE_NO,PARTY_CODE,PRODUCT_CODE,GRUP,STYLE,LENGTH,WIDTH,GSM,"
                        ...
                        + "INDICATOR,INDICATOR_DATE,INDICATOR_DOC,WEAVING_DATE,WEAVING_SEQUENCE,PP_REMARK,WIP_OC_MONTHYEAR,WIP_OC_LAST_DDMMYY,AUTO_SEQUENCE)"
                        ...
                        + "FROM (SELECT  * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
                        + "WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' AND "
                        + "BEAM_NO IN (SELECT DISTINCT BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_H)) AS D "
                        + "LEFT JOIN (SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL  WHERE COALESCE(INDICATOR,'')!='DELETE') AS  A "
                        + "ON D.BEAM_NO=A.BEAM_NO AND D.PIECE_NO=A.PIECE_NO "
                        + "WHERE A.PIECE_NO IS NULL) AS AA "
                        + "LEFT JOIN (SELECT DISTINCT DOC_NO,BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER) AS BB "
...
//                    sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,"
//                            + "(SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
//                            + "WHERE BEAM_NO='" + getAttribute("BEAM_NO").getString() + "' AND "
//                            + "PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) D "
...
//                    data.Execute(sql);
                sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER P,"
                        + "(SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
                        + "WHERE BEAM_NO='" + getAttribute("BEAM_NO").getString() + "' AND  INDICATOR IN ('DELETE') AND "
                        + "PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) D "
                        + "SET WIP_PIECE_STAGE='PLANNING',WIP_STATUS='CONFIRMED',WIP_WARP_DATE='0000-00-00',WIP_WARP_A_DATE='0000-00-00',WIP_WARPING_WEIGHT_A='0.00' "
                        + "WHERE P.WIP_EXT_PIECE_NO=D.PIECE_NO AND COALESCE(INDICATOR_DOC,'') IN ('','" + (String) getAttribute("DOC_NO").getObj() + "') AND "
                        + "D.PIECE_NO NOT LIKE '%A%' AND D.PIECE_NO NOT LIKE '%B%'";
                System.out.println("Final Approval Query111 :" + sql);
                data.Execute(sql);
...
//                    data.Execute(sql);
                sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER P,"
                        ...
                        + "WHERE BEAM_NO='" + getAttribute("BEAM_NO").getString() + "' AND  INDICATOR  IN ('DELETE') AND "
                        + "PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) D "
                        + "SET WIP_PIECE_STAGE='PLANNING',WIP_STATUS='CONFIRMED',WIP_WARP_DATE='0000-00-00',WIP_WARP_B_DATE='0000-00-00',WIP_WARPING_WEIGHT_B='0.00' "
                        + "WHERE P.WIP_EXT_PIECE_NO=D.PIECE_NO AND COALESCE(INDICATOR_DOC,'') IN ('','" + (String) getAttribute("DOC_NO").getObj() + "') AND "
                        + "D.PIECE_NO LIKE '%B%' ";
                System.out.println("Final Approval Query333 :" + sql);
                data.Execute(sql);
...
//                            + "WHERE P.PR_PIECE_NO=D.PIECE_NO AND "
//                            + "D.PIECE_NO NOT LIKE '%A%' AND D.PIECE_NO NOT LIKE '%B%' "
//                            + "AND COALESCE(P.PR_WVG_DATE,'0000-00-00')='0000-00-00' AND COALESCE(P.PR_MND_DATE,'0000-00-00')='0000-00-00' AND COALESCE(P.PR_NDL_DATE,'0000-00-00')='0000-00-00' AND COALESCE(P.PR_FNSG_DATE,'0000-00-00')='0000-00-00' ";
                sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER SP, PRODUCTION.FELT_WIP_PIECE_REGISTER WP,"
                        + "(SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
                        + "WHERE BEAM_NO='" + getAttribute("BEAM_NO").getString() + "' AND COALESCE(INDICATOR_DOC,'') IN ('','" + (String) getAttribute("DOC_NO").getObj() + "') AND  INDICATOR IN ('DELETE') AND "
                        + "PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) D "
...
//                    sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P "
//                            + "SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='',PR_WARP_DATE='0000-00-00',PR_WARP_A_DATE='0000-00-00',PR_WARPING_WEIGHT_A='0.00' "
//                            + "WHERE PR_PIECE_NO IN (SELECT WIP_PIECE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER P,(SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL "
//                            + "WHERE BEAM_NO='" + getAttribute("BEAM_NO").getString() + "' AND "
//                            + "PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) AS D "
//                            + "WHERE P.WIP_EXT_PIECE_NO=D.PIECE_NO AND PIECE_NO LIKE '%A%' AND "
//                            + "D.DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' ) AND "
//                            + "D.PIECE_NO LIKE '%A%' "
//                            + "AND COALESCE(P.PR_WVG_DATE,'0000-00-00')='0000-00-00' AND COALESCE(P.PR_MND_DATE,'0000-00-00')='0000-00-00' AND COALESCE(P.PR_NDL_DATE,'0000-00-00')='0000-00-00' AND COALESCE(P.PR_FNSG_DATE,'0000-00-00')='0000-00-00' ";
...
//
////                    sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P,"
////                            + "(SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
...
////                    sql = "UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER P "
////                            + "SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='',PR_WARP_DATE='0000-00-00',PR_WARP_A_DATE='0000-00-00',PR_WARPING_WEIGHT_A='0.00' "
////                            + "WHERE PR_PIECE_NO IN (SELECT WIP_PIECE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER P,(SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
////                            + "WHERE DOC_NO='" + prevdoc + "' AND "
////                            + "PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "')) AS D "
////                            + "WHERE P.WIP_EXT_PIECE_NO=D.PIECE_NO AND PIECE_NO LIKE '%A%' AND "
////                            + "D.DOC_NO='" + (String) getAttribute("DOC_NO").getObj() + "' ) AND "
...
//
//                }
                updatebeamheader(getAttribute("BEAM_NO").getString(), (String) getAttribute("DOC_NO").getObj());
    ...
    public boolean setData() {
        ...
        try {
            ...
            if (HistoryView) {
               // if (clsFeltProductionApprovalFlow.IsCreator(ModuleID, (String) getAttribute("DOC_NO").getObj())) {
               //     rsTmp = tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND_H WHERE DOC_NO='" + mDocNo + "' AND REVISION_NO=" + RevNo + " ORDER BY SR_NO");
              //  } else {
                    rsTmp = tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND_H WHERE DOC_NO='" + mDocNo + "' AND REVISION_NO=" + RevNo + " ORDER BY SEQUANCE_NO");
             //   }
            } else {
                //if (clsFeltProductionApprovalFlow.IsCreator(ModuleID, (String) getAttribute("DOC_NO").getObj())) {
                //    rsTmp = tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + mDocNo + "' ORDER BY SR_NO");
               // } else {
                    rsTmp = tmpStmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + mDocNo + "' ORDER BY SEQUANCE_NO");
              //  }
            }
            rsTmp.first();
    ...
    public boolean IsEditable(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE DOC_NO='" + pDocNo + "' AND (APPROVED=1)";
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=778 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getHistoryList(int CompanyID, String DocNo) {
        ...
        try {
            String strSQL = "SELECT DOC_NO,CREATED_DATE,REVISION_NO,UPDATED_BY,APPROVAL_STATUS,DATE_FORMAT(ENTRY_DATE,'%d/%m/%Y %H:%i:%S') AS ENTRY_DATE,REJECTED_REMARKS AS APPROVER_REMARKS,FROM_IP FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND_H WHERE DOC_NO='" + DocNo + "'";
            rsTmp = data.getResult(strSQL);
            rsTmp.first();

            if (rsTmp.getRow() > 0) {
                while (!rsTmp.isAfterLast()) {
                    clsWarpingBeamOrderAmend objParty = new clsWarpingBeamOrderAmend();
    ...
    public boolean Filter(String Condition) {
        ...
        try {
            String strSQL = "";
            strSQL += "SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE " + Condition;
            Conn = data.getConn();
            Stmt = Conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            rsResultSet = Stmt.executeQuery(strSQL);

            if (!rsResultSet.first()) {
                strSQL = "SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE CREATED_DATE>='" + EITLERPGLOBAL.FinFromDateDB + "' AND CREATED_DATE<='" + EITLERPGLOBAL.FinToDateDB + "' ORDER BY DOC_NO";
                rsResultSet = Stmt.executeQuery(strSQL);
                Ready = true;
                MoveLast();
                return false;
    ...
    public boolean CanDelete(int pCompanyID, String pDocNo, int pUserID) {
        ...
        try {
            ...
            if (rsTmp.getInt("COUNT") > 0) //Item is Approved
            {
                ...
                strSQL = "SELECT COUNT(*) AS COUNT FROM PRODUCTION.FELT_PROD_DOC_DATA WHERE MODULE_ID=778 AND DOC_NO='" + pDocNo + "' AND USER_ID=" + Integer.toString(pUserID) + " AND TYPE='C' AND STATUS='W'";
                tmpStmt = Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                rsTmp = tmpStmt.executeQuery(strSQL);
                rsTmp.first();
    ...
    public static HashMap getPendingApprovals(int pUserID, int pOrder) {
        ...
        try {
            if (pOrder == EITLERPGLOBAL.OnRecivedDate) {
                strSQL = "SELECT PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.DOC_NO,PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.CREATED_DATE,RECEIVED_DATE,BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO=PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=778 ORDER BY PRODUCTION.FELT_PROD_DOC_DATA.RECEIVED_DATE";
            }

            if (pOrder == EITLERPGLOBAL.OnDocDate) {
                strSQL = "SELECT PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.DOC_NO,PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.CREATED_DATE,RECEIVED_DATE,BEAM_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO=PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + Integer.toString(pUserID) + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND MODULE_ID=778 ORDER BY PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND.CREATED_DATE";
            }
            ...
            while (!rsTmp.isAfterLast() && rsTmp.getRow() > 0) {
                ...
                Counter = Counter + 1;
                clsWarpingBeamOrderAmend ObjItem = new clsWarpingBeamOrderAmend();
    ...
    public boolean ShowHistory(int pCompanyID, String pDocNo) {
        ...
        try {
            ...
            rsResultSet = Stmt.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND_H WHERE DOC_NO='" + pDocNo + "' ORDER BY REVISION_NO");
            Ready = true;
            HistoryView = true;
            MoveFirst();
            return true;
    ...
    public static boolean IsAmendmentUnderProcess(String pBeamNo) {
        ...
        try {
            ...
            rsTmp = stTmp.executeQuery("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE BEAM_NO='" + pBeamNo + "' AND APPROVED=0 AND CANCELED=0");
            rsTmp.first();
    ...
    private void updatebeamheader(String mbeam, String mdoc) {
        try {
            ResultSet tbmrs, tbmrsh;
            tbmrs = data.getResult("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL WHERE BEAM_NO='" + mbeam + "' AND (INDICATOR IS NULL OR INDICATOR IN ('ADD','INSERT',''))");
            tbmrsh = data.getResult("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER WHERE BEAM_NO='" + mbeam + "'");
            tbmrs.first();
            tbmrsh.first();
            if (tbmrsh.getRow() > 0) {
                ...
                String sql = "UPDATE PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER "
                        + "SET "
                        //+ "WARP_LENGTH=" + mtotlen+ ","
            ...
            String sql;
            sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER R,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D "
                    + " SET WIP_PIECE_STAGE='PLANNING',WIP_STATUS='CONFIRMED',WIP_WARP_DATE='0000-00-00',WIP_WARP_A_DATE='0000-00-00',WIP_WARPING_WEIGHT_A=0 "
                    + " WHERE D.PIECE_NO=R.WIP_EXT_PIECE_NO AND D.INDICATOR='DELETE' AND "
                    + "D.INDICATOR_DOC='" + mdoc + "' AND D.PIECE_NO NOT LIKE '%A' AND D.PIECE_NO NOT LIKE '%B'";
            data.Execute(sql);
            sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER R,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D "
                    + " SET WIP_PIECE_STAGE='PLANNING',WIP_STATUS='CONFIRMED',WIP_WARP_DATE='0000-00-00',WIP_WARP_A_DATE='0000-00-00',WIP_WARPING_WEIGHT_A=0 "
                    + " WHERE D.PIECE_NO=R.WIP_EXT_PIECE_NO AND D.INDICATOR='DELETE' AND "
                    + "D.INDICATOR_DOC='" + mdoc + "' AND D.PIECE_NO  LIKE '%A' ";
            data.Execute(sql);
            sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER R,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D "
                    + " SET WIP_PIECE_STAGE='PLANNING',WIP_STATUS='CONFIRMED',WIP_WARP_DATE='0000-00-00',WIP_WARP_B_DATE='0000-00-00',WIP_WARPING_WEIGHT_B=0 "
                    + " WHERE D.PIECE_NO=R.WIP_EXT_PIECE_NO AND D.INDICATOR='DELETE' AND "
                    + "D.INDICATOR_DOC='" + mdoc + "' AND  D.PIECE_NO LIKE '%B'";
            data.Execute(sql);
            sql = "UPDATE PRODUCTION.FELT_WIP_PIECE_REGISTER R,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D,"
                    + "PRODUCTION.FELT_SALES_PIECE_REGISTER P "
                    + " SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='CONFIRMED',PR_WARP_DATE='0000-00-00',PR_WARP_A_DATE='0000-00-00',PR_WARPING_WEIGHT_A=0.0 "
                    + " WHERE D.PIECE_NO=R.WIP_EXT_PIECE_NO AND D.INDICATOR='DELETE' AND "
                    + " R.WIP_PIECE_NO=P.PR_PIECE_NO AND "
                    + "D.INDICATOR_DOC='" + mdoc + "'  ";
            data.Execute(sql);

//            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER "
//                    + "SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='',PR_WARP_DATE=NULL,PR_WARP_A_DATE=NULL,PR_WARPING_WEIGHT_A=NULL "
//                    + "WHERE LEFT(PR_PIECE_NO,5) IN (SELECT LEFT(PIECE_NO,5) FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL  GROUP BY PIECE_NO HAVING COUNT(PIECE_NO)=1 AND COALESCE(INDICATOR,'')='DELETE') "
...
//            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER "
//                    + "SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='',PR_WARP_DATE='0000-00-00',PR_WARP_A_DATE='0000-00-00',PR_WARPING_WEIGHT_A='0.00' "
//                    + "WHERE PR_PIECE_NO IN (SELECT WIP_PIECE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER W,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D WHERE COALESCE(D.INDICATOR,'')='DELETE' AND D.PIECE_NO=W.WIP_EXT_PIECE_NO AND W.WIP_EXT_PIECE_NO NOT LIKE '%A' AND W.WIP_EXT_PIECE_NO NOT LIKE '%B' GROUP BY D.PIECE_NO HAVING COUNT(D.PIECE_NO)=1 ) "
//                    + "AND COALESCE(PR_REJECTED_FLAG,0)=0 AND PR_PIECE_NO NOT LIKE '%A' AND PR_PIECE_NO NOT LIKE '%B' "
//                    + "AND COALESCE(PR_WVG_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_MND_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_NDL_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_FNSG_DATE,'0000-00-00')='0000-00-00' ");
//            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER "
//                    + "SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='',PR_WARP_DATE='0000-00-00',PR_WARP_B_DATE='0000-00-00',PR_WARPING_WEIGHT_B='0.00' "
//                    + "WHERE PR_PIECE_NO IN (SELECT WIP_PIECE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER W,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D WHERE COALESCE(D.INDICATOR,'')='DELETE' AND D.PIECE_NO=W.WIP_EXT_PIECE_NO AND W.WIP_EXT_PIECE_NO LIKE '%B' GROUP BY D.PIECE_NO HAVING COUNT(D.PIECE_NO)=1  ) "
//                    + "AND COALESCE(PR_REJECTED_FLAG,0)=0 AND PR_PIECE_NO LIKE '%B'  "
//                    + "AND COALESCE(PR_WVG_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_MND_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_NDL_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_FNSG_DATE,'0000-00-00')='0000-00-00' ");
//            data.Execute("UPDATE PRODUCTION.FELT_SALES_PIECE_REGISTER "
//                    + "SET PR_PIECE_STAGE='PLANNING',PR_WIP_STATUS='',PR_WARP_DATE='0000-00-00',PR_WARP_A_DATE='0000-00-00',PR_WARPING_WEIGHT_A='0.00' "
//                    + "WHERE PR_PIECE_NO IN (SELECT WIP_PIECE_NO FROM PRODUCTION.FELT_WIP_PIECE_REGISTER W,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D WHERE COALESCE(D.INDICATOR,'')='DELETE' AND D.PIECE_NO=W.WIP_EXT_PIECE_NO AND W.WIP_EXT_PIECE_NO LIKE '%A' GROUP BY D.PIECE_NO HAVING COUNT(D.PIECE_NO)=1  ) "
//                    + "AND COALESCE(PR_REJECTED_FLAG,0)=0 AND PR_PIECE_NO LIKE '%A' "
//                    + "AND COALESCE(PR_WVG_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_MND_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_NDL_DATE,'0000-00-00')='0000-00-00' AND COALESCE(PR_FNSG_DATE,'0000-00-00')='0000-00-00' ");
        } catch (Exception e) {
            e.printStackTrace();
