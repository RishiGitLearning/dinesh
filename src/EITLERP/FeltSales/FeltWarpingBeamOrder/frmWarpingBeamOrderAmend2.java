...
public class frmWarpingBeamOrderAmend2 extends javax.swing.JApplet {

    private int EditMode = 0;

    //private clsWarpingBeamOrderAmend Obj;
    private clsWarpingBeamOrderAmend Obj;
...
//    private static PieChart pieChart;
     ...
     */
    public frmWarpingBeamOrderAmend2() {
        // this.requestFocus();
...
//        //chart1.add(dataPaneel);
        ...
        Obj = new clsWarpingBeamOrderAmend();
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsWarpingBeamOrderAmend.ModuleID + "");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + clsWarpingBeamOrderAmend.ModuleID + "");
        }
    ...
    private void initComponents() {
        ...
        cmdAutoSquance = new javax.swing.JButton();
        ...
        txtreasonpanel = new javax.swing.JScrollPane();
        txtreason = new javax.swing.JTextArea();
        jLabel25 = new javax.swing.JLabel();
        jLabel26 = new javax.swing.JLabel();
        txtwvglen = new javax.swing.JTextField();
        jLabel23 = new javax.swing.JLabel();
        jLabel24 = new javax.swing.JLabel();
        txtrwvglen = new javax.swing.JTextField();
        ...
        lblTitle.setText("Felt Warping Beam Order Amend");
        ...
        jLabel5.setText("Press F1 For Piece Selection");
        Tab1.add(jLabel5);
        jLabel5.setBounds(10, 14, 270, 30);

        cmdAutoSquance.setText("Generate Auto Sequance");
        cmdAutoSquance.setEnabled(false);
        cmdAutoSquance.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdAutoSquanceActionPerformed(evt);
            }
        });
        Tab1.add(cmdAutoSquance);
        cmdAutoSquance.setBounds(363, 10, 200, 30);

        jTabbedPane1.addTab("Warping Beam Order Entry", Tab1);
        ...
        history.add(jScrollPane4);
        jScrollPane4.setBounds(8, 5, 610, 350);
        ...
        Formula.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                {"Fabric Realisation Per%", "((sum of Expected_Grev_sq_mtr)/(Reed Space*Achivable Woven Length))*100"},
        ...
        jTabbedPane1.setBounds(5, 290, 750, 360);
        ...
        lblStatus.setBounds(10, 660, 750, 20);
        ...
        txtreedspace.setEditable(false);
        ...
        txtactlwarpreali.setEditable(false);
        ...
        jLabel3.setBounds(520, 100, 80, 14);

        jLabel4.setText("Reason For Amend");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(10, 230, 130, 14);

        txtreason.setColumns(20);
        txtreason.setRows(5);
        txtreasonpanel.setViewportView(txtreason);

        getContentPane().add(txtreasonpanel);
        txtreasonpanel.setBounds(130, 220, 380, 60);

        jLabel25.setText("Weaving");
        getContentPane().add(jLabel25);
        jLabel25.setBounds(530, 250, 90, 20);

        jLabel26.setText("Length");
        getContentPane().add(jLabel26);
        jLabel26.setBounds(530, 260, 70, 20);

        txtwvglen.setEditable(false);
        txtwvglen.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtwvglen.setForeground(new java.awt.Color(0, 0, 255));
        txtwvglen.setDisabledTextColor(new java.awt.Color(0, 0, 255));
        getContentPane().add(txtwvglen);
        txtwvglen.setBounds(620, 250, 110, 30);

        jLabel23.setText("Remaing Weaving");
        getContentPane().add(jLabel23);
        jLabel23.setBounds(740, 220, 110, 20);

        jLabel24.setText("Length");
        getContentPane().add(jLabel24);
        jLabel24.setBounds(740, 230, 90, 20);

        txtrwvglen.setEditable(false);
        txtrwvglen.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txtrwvglen.setForeground(new java.awt.Color(0, 0, 255));
        txtrwvglen.setDisabledTextColor(new java.awt.Color(0, 0, 255));
        getContentPane().add(txtrwvglen);
        txtrwvglen.setBounds(730, 250, 120, 30);
    ...
    private void TableDescKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableDescKeyReleased
        ...
        try {
                ...
                if (TableDesc.getSelectedColumn() == 2) {
                    try {
                        sql = "SELECT * FROM PRODUCTION.FELT_WIP_PIECE_REGISTER "
                                + "WHERE WIP_EXT_PIECE_NO = '" + PieceNo + "'  AND COALESCE(WIP_REJECTED_FLAG,0)=0 AND "
                                ...
                                + "WHERE WIP_EXT_PIECE_NO IN "
                                + "(SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL WHERE BEAM_NO='" + txtbeam.getText() + "' AND PIECE_NO='" + PieceNo + "')";

                        trs = data.getResult(sql);

                        //trs = data.getResult("SELECT * FROM PRODUCTION.FELT_SALES_PIECE_REGISTER WHERE SUBSTRING(PR_PIECE_NO,1,5) = '" + PieceNo.substring(0, 5) + "' AND PR_PIECE_STAGE='PLANNING' AND (PR_WARP_DATE='0000-00-00' OR PR_WARP_DATE IS NULL) AND PR_PIECE_NO NOT IN (SELECT LEFT(PIECE_NO,5) FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND)");
                    } catch (Exception a) {
                    ...
                    if (trs.getRow() > 0) {
                        ...
                        TableDesc.setValueAt(trs.getString("WIP_OC_MONTHYEAR"), TableDesc.getSelectedRow(), 15);
                        TableDesc.setValueAt(trs.getString("WIP_OC_LAST_DDMMYY"), TableDesc.getSelectedRow(), 21);

                        TableDesc.changeSelection(TableDesc.getSelectedRow(), 12, false, false);

                    } else {
                        if (PieceNo.contains("A") || PieceNo.contains("a")) {

                            sql = "SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND "
                                    ...
                                    + "PROD_DEPT NOT IN ('FELT FINISHING','FINISHING','NEEDLING')";
                            trs = data.getResult(sql);
            ...
            try {
                mtpclen = Double.parseDouble(TableDesc.getValueAt(TableDesc.getSelectedRow(), 17).toString());
            } catch (Exception a) {
                mtpclen = 0.0;
            }
            try {
            ...
            try {
                mreedspc = Double.parseDouble(TableDesc.getValueAt(TableDesc.getSelectedRow(), 16).toString());
            } catch (Exception c) {
                mreedspc = 0.0;
            }
    ...
    private void cmdItemdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdItemdeleteActionPerformed
        if (TableDesc.getRowCount() > 0) {
            try {
                if (TableDesc.getValueAt(TableDesc.getSelectedRow(), 1).toString().equalsIgnoreCase("")) {
                    DataModelDesc.removeRow(TableDesc.getSelectedRow());
                    UpdateSrNo();
                    UpdateWovenLength();
                } else {
                    ResultSet trs = data.getResult("SELECT WIP_PIECE_STAGE,COALESCE(WIP_WVG_DATE,'0000-00-00') AS WVG_DATE FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + TableDesc.getValueAt(TableDesc.getSelectedRow(), 1).toString() + "'");
                    trs.first();
                    if (trs.getRow() > 0) {
                        if ((trs.getString("WIP_PIECE_STAGE").equalsIgnoreCase("WEAVING") || trs.getString("WIP_PIECE_STAGE").equalsIgnoreCase("PLANNING")) && trs.getString("WVG_DATE").equalsIgnoreCase("0000-00-00")) {
                            DataModelDesc.removeRow(TableDesc.getSelectedRow());
                            UpdateSrNo();
                            UpdateWovenLength();
                        } else {
                            JOptionPane.showMessageDialog(null, "You cannot Remove this Piece, Piece is in " + data.getStringValueFromDB("SELECT WIP_PIECE_STAGE FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + TableDesc.getValueAt(TableDesc.getSelectedRow(), 1).toString() + "'") + " Stage...");
                        }
                    } else {
                        DataModelDesc.removeRow(TableDesc.getSelectedRow());
                        UpdateSrNo();
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            ...
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(clsWarpingBeamOrderAmend.ModuleID, DocNo)) {
                cmbSendTo.setEnabled(true);
            } else {
                cmbSendTo.setEnabled(false);
            }
    ...
    private void txtreedspaceFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtreedspaceFocusLost
        ...
        txtwarpendtot.setText(String.valueOf((mrspc * mend10) * 10));
    ...
    private void txtloomKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtloomKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            aList.SQL = "SELECT PARA_CODE AS LOOM FROM PRODUCTION.FELT_PARAMETER_MASTER WHERE PARA_ID='LOOM'";
            aList.ReturnCol = 1;
            ...
            if ((EditMode == 1) || (EditMode == 2 && clsHierarchy.IsCreator(EITLERPGLOBAL.gCompanyID, SelHierarchyID, EITLERPGLOBAL.gUserID))) {
                if (TableDesc.getSelectedColumn() == 1) {
                    ...
                    aList.SQL = "SELECT WIP_EXT_PIECE_NO AS PIECE_NO,WIP_PIECE_NO AS PIECE,DATE_FORMAT(WIP_ORDER_DATE,'%d/%m/%Y') AS ORDER_DATE,WIP_UPN AS UPN,WIP_MACHINE_NO AS MACHINE_NO,"
                            ...
                            + " WHERE WIP_PIECE_STAGE='PLANNING' AND WIP_PRIORITY_HOLD_CAN_FLAG=0 AND COALESCE(WIP_REJECTED_FLAG,0)=0 AND "
                            + " WIP_EXT_PIECE_NO NOT IN (SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL WHERE COALESCE(INDICATOR,'')!='DELETE' ) "
                            + "UNION ALL "
                            + "SELECT WIP_EXT_PIECE_NO AS PIECE_NO,WIP_PIECE_NO AS PIECE,DATE_FORMAT(WIP_ORDER_DATE,'%d/%m/%Y') AS ORDER_DATE,WIP_UPN AS UPN,WIP_MACHINE_NO AS MACHINE_NO,"
                            + " WIP_POSITION_NO AS POSITION_NO,WIP_PARTY_CODE AS PARTY_CODE,M.PARTY_NAME,WIP_GROUP AS PRODUCT_GROUP,WIP_PRODUCT_CODE AS PRODUCT_CODE,"
                            + " WIP_STYLE AS STYLE,"
                            + "COALESCE(AMEND_WIP.PIECE_AMEND_NO,'') AS PENDING_WIP_AMEND "
                            + ",CASE WHEN PARTY_LOCK=1 THEN 'LOCKED' ELSE '' END AS PARTY_LOCK "
                            ...
                            + " ON R.WIP_PARTY_CODE=M.PARTY_CODE "
                            + "WHERE WIP_EXT_PIECE_NO IN "
                            + "(SELECT PIECE_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL WHERE BEAM_NO='" + txtbeam.getText() + "' )"
    ...
    private void cmdAutoSquanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAutoSquanceActionPerformed
        // TODO add your handling code here:

        for (int i = 0; i < TableDesc.getRowCount(); i++) {
            TableDesc.setValueAt(Double.toString(Double.parseDouble(TableDesc.getValueAt(i, 16).toString())+10000).substring(1), i, 16);
        }

        TableRowSorter<TableModel> sorter = new TableRowSorter<>(TableDesc.getModel());
        TableDesc.setRowSorter(sorter);
        java.util.List<RowSorter.SortKey> sortKeys = new ArrayList<>();

        int columnIndexToSortOC = 21;
        sortKeys.add(new RowSorter.SortKey(columnIndexToSortOC, SortOrder.ASCENDING));

        int columnIndexForReedspace = 16;
        sortKeys.add(new RowSorter.SortKey(columnIndexForReedspace, SortOrder.DESCENDING));

        sorter.setSortKeys(sortKeys);
        sorter.sort();
        //        WarpingSort wp = new WarpingSort();
        //        wp.WarpSort(TableDesc);
        for (int i = 0; i < TableDesc.getRowCount(); i++) {
            TableDesc.setValueAt(Integer.toString(i + 1), i, 11);
            TableDesc.setValueAt(Double.toString(Double.parseDouble(TableDesc.getValueAt(i, 16).toString())), i, 16);
        }
    }//GEN-LAST:event_cmdAutoSquanceActionPerformed
    ...
    private javax.swing.JButton cmdAutoSquance;
    ...
    private javax.swing.JTextField txtwvglen;
    ...
    private void Add() {
        ...
        aList.SQL = "SELECT BEAM_NO,DOC_NO,DATE_FORMAT(CREATED_DATE,'%d/%m/%Y') AS DOC_DATE FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER WHERE APPROVED=1 AND CANCELED=0  AND COALESCE(BEAM_CLOSURE_IND,0)=0 ";
        aList.ReturnCol = 1;
        aList.ShowReturnCol = true;
        aList.DefaultSearchOn = 1;

        if (aList.ShowLOV()) {
            BeamNo = aList.ReturnVal;

            if (clsWarpingBeamOrderAmend.IsAmendmentUnderProcess(BeamNo)) {
                JOptionPane.showMessageDialog(null, "One amendment of this Warping Beam Order is already under process. Cannot make another amendment");
                EditMode = 0;
                return;
            }
            ...
            int MaxNo = data.getIntValueFromDB("SELECT COALESCE(MAX(SUBSTR(doc_no,locate('/',doc_no)+1)*1),0) FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE BEAM_NO='" + BeamNo + "'") + 1;
            DOC_NO.setText(BeamNo + "/" + MaxNo);
            DisplayDataBeam(BeamNo, MaxNo - 1);
            txtreason.requestFocus();

        } else {
            JOptionPane.showMessageDialog(null, "You must select Beam No.");
            EditMode = 0;
            Cancel();
        }
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(clsWarpingBeamOrderAmend.ModuleID, (String) Obj.getAttribute("PROFORMA_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(clsWarpingBeamOrderAmend.ModuleID, FromUserID, (String) Obj.getAttribute("PROFORMA_NO").getObj());
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = clsFeltProductionApprovalFlow.getRemainingUsers(clsWarpingBeamOrderAmend.ModuleID, DocNo);
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void Edit() {
        ...
        if (Obj.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(clsWarpingBeamOrderAmend.ModuleID, lDocNo)) {  // || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6098, 60982)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        for (int k = 0; k <= TableDesc.getRowCount() - 1; k++) {
            ...
            if (TableDesc.getValueAt(k, 12).toString().equalsIgnoreCase("")) {
                ...
                err = err + "\n Enter Sequence No at Row " + (k + 1);
                //return;
            }
            if (TableDesc.getValueAt(k, 16).toString().equalsIgnoreCase("")) {
                //JOptionPane.showMessageDialog(this, "Enter R.Space on Loom at Row " + (k + 1), "ERROR", JOptionPane.ERROR_MESSAGE);
                err = err + "\n Enter R.Space on Loom at Row " + (k + 1);
                //return;
            }
            if (TableDesc.getValueAt(k, 17).toString().equalsIgnoreCase("")) {
                //JOptionPane.showMessageDialog(this, "Enter Theo PC Length Mtr at Row " + (k + 1), "ERROR", JOptionPane.ERROR_MESSAGE);
                err = err + "\n Enter Theo PC Length Mtr at Row " + (k + 1);
                //return;
            }
            if (TableDesc.getValueAt(k, 18).toString().equalsIgnoreCase("")) {
                ...
                err = err + "\n Enter Theo Picks/10 cm at Row " + (k + 1);
                //return;
            }
            if (data.getStringValueFromDB("SELECT WIP_STATUS FROM PRODUCTION.FELT_WIP_PIECE_REGISTER WHERE WIP_EXT_PIECE_NO='" + TableDesc.getValueAt(k, 1).toString() + "'").equalsIgnoreCase("CANCELED")) {
                ...
                err = err + "\n Piece is Canceled at Row " + (k + 1);
                //return;
            }
            if (!TableDesc.getValueAt(k, 11).toString().equalsIgnoreCase(TableDesc.getValueAt(k, 12).toString())) {
                if (TableDesc.getValueAt(k, 14).toString().length() <= 0) {
                    err = err + "\n PP Remarks Compulsory at Row " + (k + 1);
                }
            }
        ...
        for (int k = 0; k <= TableDesc.getRowCount() - 1; k++) {
            for (int l = k; l <= TableDesc.getRowCount() - 1; l++) {
                ...
                if (l != k && (TableDesc.getValueAt(k, 12).toString().trim().equals(TableDesc.getValueAt(l, 12).toString().trim()))) {
...
//                        String Party_Code = "";
//
//                        String responce = JavaMail.sendFinalApprovalMail(clsWarpingBeamOrderAmend.ModuleID, DOC_NO, DOC_DATE, Party_Code, EITLERPGLOBAL.gNewUserID, SelHierarchyID, true);
...
//                DisplayData();
        ...
        data.Execute("UPDATE  PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL A,PRODUCTION.FELT_PROD_DATA B "
                + "SET WEAVING_DATE = PROD_DATE,WEAVING_WEIGHT = B.WEIGHT "
                + "WHERE PROD_PIECE_NO = PIECE_NO AND PROD_DEPT= 'WEAVING' AND B.APPROVED =1 AND B.CANCELED =0 "
                + "AND INDICATOR != 'DELETE'");
        data.Execute("UPDATE  PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL A,PRODUCTION.FELT_PROD_DATA B "
                + "SET WEAVING_DATE = PROD_DATE,WEAVING_WEIGHT = B.WEIGHT "
                + "WHERE PROD_PIECE_NO = PIECE_NO AND PROD_DEPT= 'MENDING' AND WEAVING_DATE ='0000-00-00' "
                + "AND INDICATOR != 'DELETE' AND B.APPROVED =1 AND B.CANCELED =0");
        data.Execute("UPDATE  PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL A SET WEAVING_SEQUENCE =0 "
                + "WHERE WEAVING_DATE >'0000-00-00' AND WEAVING_SEQUENCE !=0");
        data.Execute("UPDATE  PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL A SET WEAVING_SEQUENCE =0 "
                + "WHERE WEAVING_DATE >'0000-00-00' AND WEAVING_SEQUENCE IS NULL");
        data.Execute("UPDATE PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL D,("
                + "SELECT     SEQUANCE_NO,PIECE_NO,"
                + "            CASE BEAM_NO"
                ...
                + "FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL p "
                + "JOIN (SELECT @curRow := 0,  @curType := '') r "
                + "WHERE  INDICATOR != 'DELETE' AND WEAVING_DATE ='0000-00-00' "
    ...
    private void DisplayData() {
        ...
        if (EITLERPGLOBAL.gAuthorityUserID != EITLERPGLOBAL.gUserID) {
            int ModuleID = clsWarpingBeamOrderAmend.ModuleID;
        ...
        try {
            ...
            txtreason.setText(Obj.getAttribute("REASON").getObj().toString());
            try {
            ...
            for (int i = 1; i <= Obj.colMRItems.size(); i++) {
                ...
                clsWarpingBeamOrderItemAmend ObjItem = (clsWarpingBeamOrderItemAmend) Obj.colMRItems.get(Integer.toString(i));
                ...
                rowData[11] = Integer.toString(ObjItem.getAttribute("AUTO_SEQUENCE").getInt());
                rowData[12] = Integer.toString(ObjItem.getAttribute("SEQUANCE_NO").getInt());
                if (ObjItem.getAttribute("WEAVING_SEQUENCE").getInt() > 0) {
                    rowData[13] = Integer.toString(ObjItem.getAttribute("WEAVING_SEQUENCE").getInt());
                } else {
                    rowData[13] = EITLERPGLOBAL.formatDate(ObjItem.getAttribute("WEAVING_DATE").getString());
                }
                rowData[14] = (String) ObjItem.getAttribute("PP_REMARK").getObj();
                rowData[15] = (String) ObjItem.getAttribute("WIP_OC_MONTHYEAR").getObj();
                rowData[16] = df.format(EITLERPGLOBAL.round(ObjItem.getAttribute("READ_SPACE").getDouble(), 2));
                rowData[17] = df.format(EITLERPGLOBAL.round(ObjItem.getAttribute("THEORICAL_LENGTH_MTR").getDouble(), 2));
                ...
                rowData[21] = (String) ObjItem.getAttribute("WIP_OC_LAST_DDMMYY").getObj();
                mtottpick = mtottpick + Double.parseDouble(rowData[17].toString());
                try {
                    if (ObjItem.getAttribute("WEAVING_DATE").getObj().toString().length() == 10) {
                        mtotwvg = mtotwvg + Double.parseDouble(rowData[17].toString());
                    }
                } catch (Exception e) {
                }
                DataModelDesc.addRow(rowData);
            ...
            UpdateWovenLength();
            txtwvglen.setText(df.format(EITLERPGLOBAL.round(mtotwvg, 2)));
            txtrwvglen.setText(df.format(EITLERPGLOBAL.round(mtottpick - mtotwvg, 2)));
            DoNotEvaluate = false;
            //======== Generating Grid for History ========//
            FormatGridH();
            String MBeamNo = Obj.getAttribute("BEAM_NO").getString();
            String msql = "SELECT H.DOC_NO,ACTUAL_WARP_RELISATION,WARP_LENGTH,FABRIC_REALISATION_PER,SUM(THEORICAL_LENGTH_MTR) AS TOTAL_PC_LEN "
                    ...
                    + "UNION ALL "
                    + "SELECT H.DOC_NO,ACTUAL_WARP_RELISATION,WARP_LENGTH,FABRIC_REALISATION_PER,SUM(THEORICAL_LENGTH_MTR) AS TOTAL_PC_LEN "
                    + "FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND H,PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D "
                    + "WHERE H.DOC_NO=D.DOC_NO AND H.BEAM_NO='" + MBeamNo + "' "
                    + "AND RIGHT(TRIM(H.DOC_NO),1)*1<" + Obj.getAttribute("DOC_NO").getString().trim().substring(Obj.getAttribute("DOC_NO").getString().trim().length() - 1, Obj.getAttribute("DOC_NO").getString().trim().length())
                    + " GROUP BY H.DOC_NO";
            ...
            List = clsFeltProductionApprovalFlow.getDocumentFlow(clsWarpingBeamOrderAmend.ModuleID, DocNo);
            for (int i = 1; i <= List.size(); i++) {
            ...
            FormatGridHS();
            HashMap History = clsWarpingBeamOrderAmend.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
            for (int i = 1; i <= History.size(); i++) {
                clsWarpingBeamOrderAmend ObjHistory = (clsWarpingBeamOrderAmend) History.get(Integer.toString(i));
    ...
    private void SetData() {
        ...
        Obj.setAttribute("REASON", txtreason.getText());
        ...
        for (int i = 0; i < TableDesc.getRowCount(); i++) {
            clsWarpingBeamOrderItemAmend ObjItem = new clsWarpingBeamOrderItemAmend();
            ...
            ObjItem.setAttribute("AUTO_SEQUENCE", Integer.parseInt(TableDesc.getValueAt(i, 11).toString()));
            ObjItem.setAttribute("SEQUANCE_NO", Integer.parseInt(TableDesc.getValueAt(i, 12).toString()));
            ObjItem.setAttribute("PP_REMARK", TableDesc.getValueAt(i, 14).toString());
            ObjItem.setAttribute("WIP_OC_MONTHYEAR", TableDesc.getValueAt(i, 15).toString());
            ObjItem.setAttribute("READ_SPACE", Double.parseDouble(TableDesc.getValueAt(i, 16).toString()));
            ObjItem.setAttribute("THEORICAL_LENGTH_MTR", Double.parseDouble(TableDesc.getValueAt(i, 17).toString()));
            ...
            ObjItem.setAttribute("WIP_OC_LAST_DDMMYY", TableDesc.getValueAt(i, 21).toString());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --        
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6098, 60981)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Edit Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6098, 60982)) {
            cmdEdit.setEnabled(true);
        } else {
            cmdEdit.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6098, 60983)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6098, 60985)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    public void FindWaiting() {
        Obj.Filter(" DOC_NO IN (SELECT H.DOC_NO FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND H,PRODUCTION.FELT_PROD_DOC_DATA D WHERE H.DOC_NO=D.DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=778 AND CANCELED=0)");
        Obj.MoveFirst();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(clsWarpingBeamOrderAmend.ModuleID, DocNo, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(clsWarpingBeamOrderAmend.ModuleID, DocNo, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            ...
            int Creator = clsFeltProductionApprovalFlow.getCreator(clsWarpingBeamOrderAmend.ModuleID, DocNo);
    ...
    private void UpdateWovenLength() {
        double mtotlen = 0, mexp_grev = 0, mreedspc, mwrplen, mtotwvg = 0;
        for (int i = 0; i < TableDesc.getRowCount(); i++) {
            try {
            ...
            try {
                if (TableDesc.getValueAt(i, 13).toString().trim().length() == 10) {
                    mtotwvg = mtotwvg + Double.parseDouble(TableDesc.getValueAt(i, 13).toString());
                }
            } catch (Exception e) {
            }
        ...
        txtwvglen.setText(df.format(EITLERPGLOBAL.round(mtotwvg, 2)));
        txtrwvglen.setText(df.format(EITLERPGLOBAL.round(mtotlen - mtotwvg, 2)));
    }
    ...
    private void FormatGrid() {
        ...
        try {
            ...
            DataModelDesc.addColumn("PP Seq No.");   //12
            DataModelDesc.addColumn("Wvg Date/Seq.No.");   //13
            DataModelDesc.addColumn("PP Remarks");   //14
            DataModelDesc.addColumn("OC Month");   //15
            DataModelDesc.addColumn("R.Space on Loom"); //16
            DataModelDesc.addColumn("Theo PC Len Mtr");  //17
            ...
            DataModelDesc.addColumn("OC Month Date");   //21
            ...
            TableDesc.getColumnModel().getColumn(21).setMaxWidth(0);
            TableDesc.getColumnModel().getColumn(21).setMinWidth(0);
            TableDesc.getColumnModel().getColumn(21).setPreferredWidth(0);
    ...
    private void PreviewReport() {
        ...
        try {
            ...
            String strSQL = "SELECT * FROM (SELECT H.DOC_NO,H.BEAM_NO,H.LOOM_NO,H.REED_SPACE,H.WARP_DETAIL,H.WARP_TEX,(H.REED_SPACE*H.ENDS_10_CM)*10 AS WARP_END_TOTAL,H.ENDS_10_CM,H.ACTUAL_WARP_RELISATION,H.WARP_LENGTH,H.REED_COUNT, "
                    + "SR_NO,PIECE_NO,PARTY_CODE,PRODUCT_CODE,GRUP,STYLE,LENGTH,WIDTH,GSM,WEIGHT,READ_SPACE,THEORICAL_LENGTH_MTR,THEORICAL_PICKS_10_CM,TOTAL_PICKS,EXPECTED_GREV_SQ_MTR "
                    + " FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D,PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND H "
                    + "WHERE H.DOC_NO=D.DOC_NO AND "
                    + "H.DOC_NO='" + DOC_NO.getText() + "') AS A "
                    + "LEFT JOIN (SELECT DOC_NO,SUM(THEORICAL_LENGTH_MTR) AS TOTAL_PC_LENGTH FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE DOC_NO='" + DOC_NO.getText() + "') AS B "
    ...
    private boolean chkbeamno() {
        int a = data.getIntValueFromDB("SELECT COUNT(*) FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE BEAM_NO='" + txtbeam.getText() + "'");
        if (a > 0) {
    ...
    private void DisplayDataBeam(String mBeamno, int mRevisionNo) {
        try {
            ResultSet trs = null;
//            if (mRevisionNo == 0) {
            trs = data.getResult("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER WHERE BEAM_NO='" + mBeamno + "'");
//            } 
//            else {
//                trs = data.getResult("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_HEADER_AMEND WHERE BEAM_NO='" + mBeamno + "' AND SUBSTR(doc_no,locate('/',doc_no)+1)*1=" + mRevisionNo);
//            }
            trs.first();
            txtbeam.setText(trs.getString("BEAM_NO"));
            txtloom.setText(trs.getString("LOOM_NO"));
            txtreedspace.setText(df.format(Double.parseDouble(trs.getString("REED_SPACE"))));
            txtwarpdtl.setText(trs.getString("WARP_DETAIL"));
            txtwarptex.setText(trs.getString("WARP_TEX"));
            txtend10cm.setText(df.format(trs.getDouble("ENDS_10_CM")));
            txtactlwarpreali.setText(df.format(trs.getDouble("ACTUAL_WARP_RELISATION")));
            txtwarplen.setText(df.format(trs.getDouble("WARP_LENGTH")));
            txtreedcnt.setText(trs.getString("REED_COUNT"));
            txtfabrealper.setText(df.format(trs.getDouble("FABRIC_REALISATION_PER")));
            try {
                txtwarpendtot.setText(df.format(Double.parseDouble(String.valueOf((Double.parseDouble(txtreedspace.getText()) * Double.parseDouble(txtend10cm.getText())) * 10))));
            } catch (Exception e) {
                txtwarpendtot.setText("0.00");
            ...
            //Now Generate Table
            if (mRevisionNo == 0) {
                trs = data.getResult("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL WHERE BEAM_NO='" + mBeamno + "'");
            } else {
                trs = data.getResult("SELECT * FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND WHERE BEAM_NO='" + mBeamno + "' AND SUBSTR(doc_no,locate('/',doc_no)+1)*1=" + mRevisionNo);
            }
            trs.first();
            double mtottpick = 0, mtotwvg = 0;
            while (!trs.isAfterLast()) {
                ...
                rowData[0] = trs.getInt("SR_NO");
                rowData[1] = trs.getString("PIECE_NO");
                rowData[2] = trs.getString("PARTY_CODE");
                rowData[3] = clsSales_Party.getPartyName(EITLERPGLOBAL.gCompanyID, rowData[2].toString());
                rowData[4] = trs.getString("PRODUCT_CODE");
                rowData[5] = trs.getString("GRUP");
                rowData[6] = trs.getString("STYLE");
                rowData[7] = df.format(EITLERPGLOBAL.round(trs.getDouble("LENGTH"), 2));
                rowData[8] = df.format(EITLERPGLOBAL.round(trs.getDouble("WIDTH"), 2));
                rowData[9] = trs.getInt("GSM");
                rowData[10] = df.format(EITLERPGLOBAL.round(trs.getDouble("WEIGHT"), 2));
                rowData[11] = trs.getInt("AUTO_SEQUENCE");
                rowData[12] = trs.getInt("SEQUANCE_NO");
                if (trs.getInt("WEAVING_SEQUENCE") > 0) {
                    rowData[13] = trs.getInt("WEAVING_SEQUENCE");
                } else {
                    rowData[13] = EITLERPGLOBAL.formatDate(trs.getString("WEAVING_DATE"));
                }
                if (trs.getString("PP_REMARK").equalsIgnoreCase("")) {
                    rowData[14] = "-";
                } else {
                    rowData[14] = trs.getString("PP_REMARK");
                }
                rowData[15] = trs.getString("WIP_OC_MONTHYEAR");
                rowData[16] = df.format(EITLERPGLOBAL.round(trs.getDouble("READ_SPACE"), 2));
                rowData[17] = df.format(EITLERPGLOBAL.round(trs.getDouble("THEORICAL_LENGTH_MTR"), 2));
                rowData[18] = df.format(EITLERPGLOBAL.round(trs.getDouble("THEORICAL_PICKS_10_CM"), 2));
                rowData[19] = df.format(EITLERPGLOBAL.round(trs.getDouble("TOTAL_PICKS"), 2));
                rowData[20] = df.format(EITLERPGLOBAL.round(trs.getDouble("EXPECTED_GREV_SQ_MTR"), 2));
                rowData[21] = trs.getString("WIP_OC_LAST_DDMMYY");
                mtottpick = mtottpick + Double.parseDouble(rowData[17].toString());
                try {
                    if (trs.getString("WEAVING_DATE").length() == 10) {
                        mtotwvg = mtotwvg + Double.parseDouble(rowData[17].toString());
                    }
                } catch (Exception e) {
                }
    ...
    private void Mail() {
        System.out.println("Felt Warping Beam Order Amend approved = " + Obj.getAttribute("APPROVAL_STATUS").getString());
        ...
        if (Obj.getAttribute("APPROVAL_STATUS").getString().equalsIgnoreCase("F")) {
            if (Obj.getAttribute("APPROVAL_STATUS").getString().equalsIgnoreCase("A")) {
                pSubject = "Notification : Felt Warping Beam Order Amendment No. " + DOC_NO.getText() + ".";
                pBody = "Felt Warping Beam Order Amendment No." + DOC_NO.getText() + " has been approved and forward  by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID) + "<br><br><br>";
            }
            if (Obj.getAttribute("APPROVAL_STATUS").getString().equalsIgnoreCase("F")) {
                pSubject = "Notification : Felt Warping Beam Order Amendment No. :" + DOC_NO.getText() + " Final Approved";
                pBody = "Felt Warping Beam Order Amendment No. " + DOC_NO.getText() + " has been final approved  by " + clsUser.getUserName((int) EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gUserID) + "<br><br><br>";
            }
            try {
                pBody += "Document Name : Felt Warping Beam Order Amendment <br>";
                ...
                pBody += "Reason For Amendment   : " + txtreason.getText() + " <br>";
                ...
                tmrsData = tmstmt.executeQuery("SELECT  D.*,PARTY_NAME FROM PRODUCTION.FELT_WARPING_BEAM_ORDER_DETAIL_AMEND D LEFT JOIN DINESHMILLS.D_SAL_PARTY_MASTER P ON D.PARTY_CODE=P.PARTY_CODE WHERE DOC_NO='" + DOC_NO.getText() + "' ORDER BY SEQUANCE_NO ");
                tmrsData.first();
                pBody += "<br>";
                ...
                HashMap hmApprovalHistory = clsWarpingBeamOrderAmend.getHistoryList(EITLERPGLOBAL.gCompanyID, DOC_NO.getText());
                for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                    pBody += "<tr>";

                    clsWarpingBeamOrderAmend ObjWarping = (clsWarpingBeamOrderAmend) hmApprovalHistory.get(Integer.toString(i));
                    Object[] rowData = new Object[6];
                ...
                String responce = MailNotification.sendNotificationMail(778, pSubject, pBody, recievers, pcc, EITLERPGLOBAL.getComboCode(cmbHierarchy));
                System.out.println("Send Mail Responce : " + responce);
