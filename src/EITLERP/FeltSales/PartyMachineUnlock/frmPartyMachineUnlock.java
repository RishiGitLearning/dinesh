...
public class frmPartyMachineUnlock extends javax.swing.JApplet {

    private int EditMode = 0;
    private clsPartyMachineUnlock ObjDoc;
    ...
    public void init() {
        ...
        ObjDoc = new clsPartyMachineUnlock();
        GenerateCombos();
        SetMenuForRights();
        SetFields(false);
    ...
    private void initComponents() {
        ...
        mnuMachine.setText("Machine Unlock");
        ...
        mnuPosition.setText("Position Unlock");
        ...
        lblTitle.setText("Party Machine Position Unlock");
...
//        Add();
    ...
    private void mnuPartyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuPartyActionPerformed
        ...
        aList.ModuleID = clsPartyMachineUnlock.ModuleID;
        ...
        txtDocNo.setText(clsFirstFree.getNextFreeNo(EITLERPGLOBAL.gCompanyID, clsPartyMachineUnlock.ModuleID, FFNo, false));
        ...
        lblTitle.setText("Party Machine Position Unlock- " + txtDocNo.getText());
    ...
    private void txtPartyCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPartyCodeKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            if (txtDocNo.getText().startsWith("FPU")) {  //FPA
                aList.SQL = "SELECT DISTINCT C.PARTY_CODE,C.PARTY_NAME FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,DINESHMILLS.D_SAL_PARTY_MASTER P WHERE C.PARTY_CODE=P.PARTY_CODE AND PARTY_LOCK=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'FPL%' ";
            }
            if (txtDocNo.getText().startsWith("PMU")) {    //PMA
                aList.SQL = "SELECT DISTINCT C.PARTY_CODE,C.PARTY_NAME FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_HEADER H WHERE C.PARTY_CODE=H.MM_PARTY_CODE AND C.MACHINE_NO=H.MM_MACHINE_NO AND MACHINE_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'PML%' ";
            }
            if (txtDocNo.getText().startsWith("MPU")) {  //MPA
                aList.SQL = "SELECT DISTINCT C.PARTY_CODE,C.PARTY_NAME FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_DETAIL D WHERE C.PARTY_CODE=D.MM_PARTY_CODE AND C.MACHINE_NO=D.MM_MACHINE_NO AND C.POSITION_NO=D.MM_MACHINE_POSITION AND POSITION_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'MPL%' ";
            }
            aList.ReturnCol = 1;
    ...
    private void txtMachineNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMachineNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            //aList.SQL = "SELECT MM_MACHINE_NO FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MACHINE_LOCK_IND=1 AND MM_PARTY_CODE= '" + txtPartyCode.getText().trim() + "' ";
            //aList.SQL = "SELECT C.MACHINE_NO FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_HEADER H WHERE C.PARTY_CODE=H.MM_PARTY_CODE AND C.MACHINE_NO=H.MM_MACHINE_NO AND MACHINE_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'PMC%' ";
            if (txtDocNo.getText().startsWith("PMU")) {
                aList.SQL = "SELECT DISTINCT C.MACHINE_NO FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_HEADER H WHERE C.PARTY_CODE=H.MM_PARTY_CODE AND C.MACHINE_NO=H.MM_MACHINE_NO AND C.PARTY_CODE='" + txtPartyCode.getText() + "' AND MACHINE_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'PMC%' ";
            }
            if (txtDocNo.getText().startsWith("MPU")) {
                aList.SQL = "SELECT DISTINCT C.MACHINE_NO FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_DETAIL D WHERE C.PARTY_CODE=D.MM_PARTY_CODE AND C.MACHINE_NO=D.MM_MACHINE_NO AND C.POSITION_NO=D.MM_MACHINE_POSITION AND C.PARTY_CODE='" + txtPartyCode.getText() + "' AND POSITION_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'MPL%' ";
            }
    ...
    private void txtPositionNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPositionNoKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            //aList.SQL = "SELECT MM_MACHINE_POSITION FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MACHINE_LOCK_IND=0 AND MM_PARTY_CODE= '" + txtPartyCode.getText().trim() + "' AND MM_MACHINE_NO='" + txtMachineNo.getText().trim() + "' ";
            //aList.SQL = "SELECT C.POSITION_NO FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_DETAIL D WHERE C.PARTY_CODE=D.MM_PARTY_CODE AND C.MACHINE_NO=D.MM_MACHINE_NO AND C.POSITION_NO=D.MM_MACHINE_POSITION AND MACHINE_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'MPL%' ";
            aList.SQL = "SELECT DISTINCT C.POSITION_NO,D.MM_MACHINE_POSITION_DESC FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE C,PRODUCTION.FELT_MACHINE_MASTER_DETAIL D WHERE C.PARTY_CODE=D.MM_PARTY_CODE AND C.MACHINE_NO=D.MM_MACHINE_NO AND C.POSITION_NO=D.MM_MACHINE_POSITION AND C.PARTY_CODE='" + txtPartyCode.getText() + "' AND C.MACHINE_NO='" + txtMachineNo.getText() + "' AND POSITION_LOCK_IND=1 AND C.STATUS_TYPE='LOCK' AND DOC_NO LIKE 'MPL%' ";
            aList.ReturnCol = 1;
            aList.ShowReturnCol = true;
            aList.DefaultSearchOn = 2;
    ...
    private void btnShowPartyMstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowPartyMstActionPerformed
        // TODO add your handling code here:
        if (txtDocNo.getText().startsWith("FPU") && !data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE MACHINE_LOCK_IND=1 AND MM_PARTY_CODE='" + txtPartyCode.getText() + "'")) {
            JOptionPane.showMessageDialog(null, "Machine Master not locked.");
            return;
        } else {
    ...
    private void SetFields(boolean pStat) {
        ...
        if (txtDocNo.getText().startsWith("FPU")) {
            jLabel13.setVisible(false);
            txtMachineNo.setVisible(false);
            jLabel15.setVisible(false);
            txtPositionNo.setVisible(false);
    ...
    private void DisplayData() {
        ...
        if (ObjDoc.getAttribute("DOC_NO").getObj().toString().startsWith("MPU")) {
            jLabel13.setVisible(true);
            txtMachineNo.setVisible(true);
            jLabel15.setVisible(true);
            txtPositionNo.setVisible(true);
            txtPositionDesc.setVisible(true);
        } else if (ObjDoc.getAttribute("DOC_NO").getObj().toString().startsWith("PMU")) {
            jLabel13.setVisible(true);
            txtMachineNo.setVisible(true);
            jLabel15.setVisible(false);
            txtPositionNo.setVisible(false);
        ...
        List = clsFeltProductionApprovalFlow.getDocumentFlow(clsPartyMachineUnlock.ModuleID, DocNo);
        ...
        FormatGridHS();
        HashMap History = clsPartyMachineUnlock.getHistoryList(EITLERPGLOBAL.gCompanyID, DocNo);
        for (int i = 1; i <= History.size(); i++) {
            clsPartyMachineUnlock ObjHistory = (clsPartyMachineUnlock) History.get(Integer.toString(i));
    ...
    private void GenerateCombos() {
        ...
        List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID='" + clsPartyMachineUnlock.ModuleID + "' ");

        if (EditMode == EITLERPGLOBAL.EDIT) {
            List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID='" + clsPartyMachineUnlock.ModuleID + "' ");
        }
        for (int i = 1; i <= List.size(); i++) {
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = clsFeltProductionApprovalFlow.getRemainingUsers(clsPartyMachineUnlock.ModuleID, (String) ObjDoc.getAttribute("DOC_NO").getObj());
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
    ...
    private void SetupApproval() {
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            ...
            int FromUserID = clsFeltProductionApprovalFlow.getFromID(clsPartyMachineUnlock.ModuleID, (String) ObjDoc.getAttribute("DOC_NO").getObj());
            lnFromID = FromUserID;
            String strFromUser = clsUser.getUserName(EITLERPGLOBAL.gCompanyID, FromUserID);
            String strFromRemarks = clsFeltProductionApprovalFlow.getFromRemarks(clsPartyMachineUnlock.ModuleID, FromUserID, (String) ObjDoc.getAttribute("DOC_NO").getObj());
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6127, 61271)) {
            cmdNew.setEnabled(true);
        } else {
            cmdNew.setEnabled(false);
        }
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6127, 61273)) {
            cmdDelete.setEnabled(true);
        } else {
            cmdDelete.setEnabled(false);
        }
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 6127, 61275)) {
            cmdPreview.setEnabled(true);
            cmdPrint.setEnabled(true);
        } else {
            cmdPreview.setEnabled(false);
    ...
    private void Edit() {
        ...
        if (ObjDoc.IsEditable(EITLERPGLOBAL.gCompanyID, lDocNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            if (clsFeltProductionApprovalFlow.IsCreator(clsPartyMachineUnlock.ModuleID, lDocNo) || clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 0, 60952)) {
                SetFields(true);
            } else {
                EnableApproval();
            }
    ...
    private void Save() {
        ...
        if ((txtDocNo.getText().startsWith("PMU") || txtDocNo.getText().startsWith("MPU")) && txtMachineNo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter Machine No");
            return;
        }

        if (txtDocNo.getText().startsWith("MPU") && txtPositionNo.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter Machine Position No");
            return;
        }

        if (txtDocNo.getText().startsWith("FPU") && !txtDocNo.getText().equals("")) {
            if (!data.IsRecordExist("SELECT * FROM DINESHMILLS.D_SAL_PARTY_MASTER WHERE PARTY_LOCK=1 AND PARTY_CODE='" + txtPartyCode.getText() + "' ")) {
                JOptionPane.showMessageDialog(null, "Party not lock in Party Master");
                return;
            }
        }

        if (txtDocNo.getText().startsWith("PMU") && !txtMachineNo.getText().equals("")) {
            if (!data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_HEADER WHERE MACHINE_LOCK_IND=1 AND MM_PARTY_CODE='" + txtPartyCode.getText() + "' AND MM_MACHINE_NO='" + txtMachineNo.getText() + "'")) {
                JOptionPane.showMessageDialog(null, "Party Machine not lock in Machine Master");
                return;
            }
        }

        if (txtDocNo.getText().startsWith("MPU") && !txtMachineNo.getText().equals("") && !txtPositionNo.getText().equals("")) {
            if (!data.IsRecordExist("SELECT * FROM PRODUCTION.FELT_MACHINE_MASTER_DETAIL WHERE POSITION_LOCK_IND=1 AND MM_PARTY_CODE='" + txtPartyCode.getText() + "' AND MM_MACHINE_NO='" + txtMachineNo.getText() + "' AND MM_MACHINE_POSITION='" + txtPositionNo.getText() + "' ")) {
                JOptionPane.showMessageDialog(null, "Party Machine Position not lock in Machine Master");
                return;
            }
        }
    ...
    public void FindEx(int pCompanyID, String pDocNo) {
        ObjDoc.Filter(" WHERE STATUS_TYPE='UNLOCK' AND DOC_NO='" + pDocNo + "'", pCompanyID);
        ObjDoc.MoveLast();
        DisplayData();
    }

    public void FindWaiting() {
        ObjDoc.Filter(" WHERE STATUS_TYPE='UNLOCK' AND DOC_NO IN (SELECT PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE.DOC_NO FROM PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE,PRODUCTION.FELT_PROD_DOC_DATA WHERE PRODUCTION.FELT_PARTY_MACHINE_POSITION_CLOSURE.DOC_NO=PRODUCTION.FELT_PROD_DOC_DATA.DOC_NO AND PRODUCTION.FELT_PROD_DOC_DATA.USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND PRODUCTION.FELT_PROD_DOC_DATA.STATUS='W' AND PRODUCTION.FELT_PROD_DOC_DATA.MODULE_ID='" + clsPartyMachineUnlock.ModuleID + "')", EITLERPGLOBAL.gCompanyID);
        ObjDoc.MoveLast();
        DisplayData();
    }
    ...
    private void GenerateRejectedUserCombo() {
        ...
        for (int i = 1; i <= List.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(clsPartyMachineUnlock.ModuleID, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }

                if (OpgReject.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(clsPartyMachineUnlock.ModuleID, DocCode, (int) ObjUser.getAttribute("USER_ID").getVal(), EITLERPGLOBAL.gNewUserID);
                }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            String DocNo = (String) ObjDoc.getAttribute("DOC_NO").getObj();
            int Creator = clsFeltProductionApprovalFlow.getCreator(clsPartyMachineUnlock.ModuleID, DocNo);
