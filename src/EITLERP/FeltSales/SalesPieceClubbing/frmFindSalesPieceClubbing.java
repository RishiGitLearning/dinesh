...
public class frmFindSalesPieceClubbing extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find :: Piece Clubbing");
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        boolean flag=false;
        if(!docNo.equals("")) {
            stringFindQuery=" PC_DOC_NO ='"+ docNo +"' ";
            flag=true;
        }
        boolean flag2=false;
        if(!txtPieceNo.getText().trim().equals(""))
        {
            if(flag || flag2)
            {
                stringFindQuery = stringFindQuery+" AND PC_DOC_NO IN (SELECT PC_DOC_NO FROM PRODUCTION.FELT_SALES_PIECE_CLUBBING_DETAIL WHERE PIECE_NO = '"+txtPieceNo.getText()+"') ";
            }
            else
            {
                stringFindQuery = " PC_DOC_NO IN (SELECT PC_DOC_NO FROM PRODUCTION.FELT_SALES_PIECE_CLUBBING_DETAIL WHERE PIECE_NO = '"+txtPieceNo.getText()+"') ";
            }
        }
        getParent().getParent().getParent().getParent().show(false);
