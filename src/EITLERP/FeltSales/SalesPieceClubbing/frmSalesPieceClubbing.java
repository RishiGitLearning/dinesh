 ...
 *
 */
public class frmSalesPieceClubbing extends javax.swing.JApplet {
    ...
    private int FFNo = 0;
    private final int ModuleId = 870;
    private String PC_DOC_NO = "";
    private clsSalesPieceClubbing objDToF;
...
//    DecimalFormat f_double = new DecimalFormat("##.00");
    ...
    public void init() {
        ...
        objDToF = new clsSalesPieceClubbing();
    ...
    private void DisplayData() {
        ...
        clearFields();
        try {
            DFNo.setText(objDToF.getAttribute("PC_DOC_NO").getString());
            lblTitle.setText("Sales Piece Clubbing - " + objDToF.getAttribute("PC_DOC_NO").getString());
            DFDate.setText(EITLERPGLOBAL.formatDate(objDToF.getAttribute("PC_DOC_DATE").getString()));
            ...
            for (int i = 1; i <= objDToF.objDToFDetails.size(); i++) {
                clsSalesPieceClibbingDetails ObjItem = (clsSalesPieceClibbingDetails) objDToF.objDToFDetails.get(Integer.toString(i));
            ...
            String DocNo = objDToF.getAttribute("PC_DOC_NO").getString();
            ...
            for (int i = 1; i <= History.size(); i++) {
                clsSalesPieceClubbing ObjHistory = (clsSalesPieceClubbing) History.get(Integer.toString(i));
    ...
    private void SetMenuForRights() {
        // --- Add Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7074, 70741)) {
        ...
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7074, 70742)) {
            cmdEdit.setEnabled(true);
        } else {
        ...
        // --- Delete Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7074, 70743)) {
        ...
        // --- Print Rights --
        if (clsUser.IsFunctionGranted(EITLERPGLOBAL.gCompanyID, EITLERPGLOBAL.gNewUserID, 7074, 70745)) {
    ...
    private void GenerateCombos() {
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (EITLERPGLOBAL.gNewUserID == clsFeltProductionApprovalFlow.getCreator(ModuleId, PC_DOC_NO + "")) {
                List = clsHierarchy.getListEx(" WHERE D_COM_HIERARCHY.COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + (ModuleId));
            } else {
                List = clsHierarchy.getList(" WHERE COMPANY_ID=" + EITLERPGLOBAL.gCompanyID + " AND MODULE_ID=" + ModuleId);
            }
    ...
    private void GenerateFromCombo() {
        ...
        try {
            if (EditMode == EITLERPGLOBAL.ADD) {
                ...
                List = clsFeltProductionApprovalFlow.getRemainingUsers(ModuleId, PC_DOC_NO + "");
                for (int i = 1; i <= List.size(); i++) {
                    clsUser ObjUser = (clsUser) List.get(Integer.toString(i));
                    ComboData aData = new ComboData();
                    aData.Code = (int) ObjUser.getAttribute("USER_ID").getVal();
...
//        tcm.getColumn(5).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Sales Piece Clubbing");
    ...
    private void GenerateRejectedSendToCombo() {
        ...
        for (int i = 1; i <= hmRejectedSendToList.size(); i++) {
            ...
            if (EditMode == EITLERPGLOBAL.EDIT) {
                ...
                if (OpgApprove.isSelected()) {
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInApproval(ModuleId, PC_DOC_NO + "", ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
                }
                ...
                if (OpgReject.isSelected()) {
                    ...
                    IncludeUser = clsFeltProductionApprovalFlow.IncludeUserInRejection(ModuleId, PC_DOC_NO + "", ObjUser.getAttribute("USER_ID").getInt(), EITLERPGLOBAL.gNewUserID);
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            int Creator = clsFeltProductionApprovalFlow.getCreator(ModuleId, PC_DOC_NO + "");
    ...
    private void OpgApproveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OpgApproveMouseClicked
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            GenerateRejectedSendToCombo();
            if (clsFeltProductionApprovalFlow.IsOnceRejectedDoc(ModuleId, PC_DOC_NO + "")) {
                cmbSendTo.setEnabled(true);
...
//        }
    ...
    private void Find() {
        Loader ObjLoader = new Loader(this, "EITLERP.FeltSales.SalesPieceClubbing.frmFindSalesPieceClubbing", true);
        frmFindSalesPieceClubbing ObjFindobjDToF = (frmFindSalesPieceClubbing) ObjLoader.getObj();
    ...
    public void FindEx(int pCompanyID, String AmendID) {
        objDToF.Filter(" PC_DOC_NO='" + AmendID + "'");
        objDToF.MoveFirst();
        DisplayData();
    }
    ...
    public void Find(String docNo) {
        objDToF.Filter(" PC_DOC_NO='" + docNo + "'");
        SetMenuForRights();
        DisplayData();
    }

    public void FindWaiting() {
        objDToF.Filter(" PC_DOC_NO IN (SELECT DISTINCT S.PC_DOC_NO FROM PRODUCTION.SPILLOVER_RESCHEDULING_HEADER S, PRODUCTION.FELT_PROD_DOC_DATA D WHERE S.PC_DOC_NO=D.PC_DOC_NO AND USER_ID=" + EITLERPGLOBAL.gNewUserID + " AND STATUS='W' AND MODULE_ID=" + ModuleId + " AND CANCELED=0) ");
        SetMenuForRights();
        DisplayData();
    }
...
//            if(!data.IsRecordExist("SELECT * FROM PRODUCTION.SPILLOVER_RESCHEDULING_DETAIL where PIECE_NO='"+PIECE_NO+"' AND  RE_SCH_MONTH='"+ResMonth+"' AND PC_DOC_NO='"+DFNo.getText()+"'"))
//            {
//             
...
//        
    ...
    private void Edit() {
        ...
        String productionDocumentNo = (String) objDToF.getAttribute("PC_DOC_NO").getObj();
...
//        }
    ...
    private void SetData() {
        ...
        objDToF.setAttribute("PC_DOC_NO", DFNo.getText());
        objDToF.setAttribute("PC_DOC_DATE", DFDate.getText());
        ...
        try {
            ...
            for (int i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                clsSalesPieceClibbingDetails objDetail = new clsSalesPieceClibbingDetails();
                objDetail.setAttribute("PC_DOC_NO", DFNo.getText());
