 ...
 * @author  nrpithva
 */
public class frmChangePassword extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel2.setBounds(12, 50, 32, 15);

        jLabel3.setText("Enter new password");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(14, 108, 184, 15);

        lblUser.setBorder(new javax.swing.border.EtchedBorder());
        ...
        cmdCancel.setBounds(314, 72, 78, 25);

        jLabel4.setText("Confirm new password");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(14, 165, 184, 15);

        getContentPane().add(txtPassword);
        txtPassword.setBounds(14, 130, 220, 19);

        getContentPane().add(txtConfirmPassword);
        txtConfirmPassword.setBounds(14, 190, 220, 19);
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOKActionPerformed
        ...
        String CurrentPassword=data.getStringValueFromDB("SELECT PASSWORD FROM D_COM_USER_MASTER WHERE USER_ID="+EITLERPGLOBAL.gNewUserID);
        ...
        try {
            String ExpiryDate=EITLERPGLOBAL.addDaysToDate(EITLERPGLOBAL.getCurrentDateDB(),60,"yyyy-MM-dd");
            data.Execute("UPDATE D_COM_USER_MASTER SET PASSWORD='"+MBMencode.MBMen(txtPassword.getText().trim().getBytes())+"',CHANGED=1,CHANGED_DATE=CURDATE(),PASSWORD_EXPIRY_DATE='"+ExpiryDate+"' WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND USER_ID="+EITLERPGLOBAL.gUserID);
