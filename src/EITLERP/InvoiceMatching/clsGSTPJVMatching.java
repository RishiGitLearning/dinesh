 ...
 * @author root
 */
public class clsGSTPJVMatching {
    ...
    public boolean Insert() {
        ...
        try {
            ...
            rsListItem=stListItem.executeQuery("SELECT * FROM FINANCE.D_FIN_GST_UPLOADED_DETAIL WHERE VOUCHER_NO='1'");
            rsListItem.first();
...
//            }
            ...
            for (int i = 1; i <= hmListItems.size(); i++) {                
                ...
                clsGSTPJVMatching Obj=(clsGSTPJVMatching)hmListItems.get(Integer.toString(i));
                rsListItem.moveToInsertRow();
                rsListItem.updateString("VOUCHER_NO", (String) Obj.getAttribute("VOUCHER_NO").getObj());
                rsListItem.updateString("VOUCHER_DATE", EITLERPGLOBAL.formatDateDB((String) Obj.getAttribute("VOUCHER_DATE").getObj()));
                rsListItem.updateInt("COMPANY_ID", (int)Obj.getAttribute("COMPANY_ID").getVal());
                rsListItem.updateInt("VOUCHER_SR_NO", (int)Obj.getAttribute("VOUCHER_SR_NO").getVal());
                ...
                rsListItem.updateInt("VOUCHER_TYPE", (int)Obj.getAttribute("VOUCHER_TYPE").getVal());
