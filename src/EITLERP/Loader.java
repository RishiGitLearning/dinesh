 ...
 * Loader.java
 *
 * Created on April 3, 2004, 9:08 AM
 */
...
== Example of using this class ==
 ...
 Loader ObjLoader=new Loader(this,"EITLERP.frmChild",true);
 frmChild ObjReturn= (frmChild) ObjLoader.getObj();
  
== Code of Hiding the Applet Window ==
        try
        {
