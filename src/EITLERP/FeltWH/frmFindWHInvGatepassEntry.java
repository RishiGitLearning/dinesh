...
public class frmFindWHInvGatepassEntry extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        txtInvoiceNo.setBounds(120, 70, 130, 19);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!gpDate.equals("")) {
            stringFindQuery=stringFindQuery+" WHERE GATEPASS_TYPE='FGP' AND GATEPASS_DATE='"+EITLERPGLOBAL.formatDateDB(gpDate)+"' ";
        }
        
        if(!gpNo.equals("")) {
            stringFindQuery=stringFindQuery+" WHERE GATEPASS_TYPE='FGP' AND GATEPASS_NO ='"+ gpNo +"'";
        }
        
        if(!invNo.equals("")) {
            stringFindQuery=stringFindQuery+" WHERE GATEPASS_TYPE='FGP' AND GATEPASS_NO IN (SELECT GATEPASS_NO FROM D_INV_NRGP_DETAIL WHERE WH_INVOICE_NO = '" + invNo + "') ";
        }
        getParent().getParent().getParent().getParent().show(false);
