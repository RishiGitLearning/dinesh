...
public class clsCompany {
    ...
    public static HashMap getList(String pCondition) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM D_COM_COMPANY_MASTER "+pCondition+" ORDER BY DISPLAY_ORDER");
            ...
            while(rsTmp.next()) {
                ...
                ObjCompany.setAttribute("RANGE",rsTmp.getString("RANGE"));
    ...
    boolean populateprops() {
        try {
            ...
            setAttribute("RANGE",rsCompany.getString("RANGE"));
