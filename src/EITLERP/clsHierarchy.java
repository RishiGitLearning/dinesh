...
public class clsHierarchy {
    ...
    public boolean LoadData() {
        ...
        try {
            ...
            rsHierarchy=Stmt.executeQuery("SELECT * FROM D_COM_HIERARCHY WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID));
            Ready=true;
            MoveFirst();
            return true;
        }
    ...
    public boolean Insert() {
        try {
            ...
            rsHierarchy.first();
            setAttribute("HIERARCHY_ID", data.getMaxID(EITLERPGLOBAL.gCompanyID,"D_COM_HIERARCHY","HIERARCHY_ID"));
            ...
            rsHierarchy.updateString("CREATED_DATE",EITLERPGLOBAL.getCurrentDateDB());
            ...
            rsHierarchy.updateString("CHANGED_DATE",EITLERPGLOBAL.getCurrentDateDB());
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM D_COM_HIERARCHY_RIGHTS WHERE COMPANY_ID=" + Long.toString(EITLERPGLOBAL.gCompanyID));
            ...
            for(int i=1;i<=colRights.size();i++) {
                ...
                for(int c=1;c<=ObjRights.colFieldAccess.size();c++) {
                    ...
                    rsFA.updateString("CHANGED_DATE",EITLERPGLOBAL.getCurrentDateDB());
                    rsFA.insertRow();
                }
        ...
        try {
         ...
         //   rsHierarchy.updateLong("CREATED_BY",(int) getAttribute("CREATED_BY").getVal());
           // rsHierarchy.updateString("CREATED_DATE",(String)getAttribute("CREATED_DATE").getObj());
            ...
            rsHierarchy.updateString("MODIFIED_DATE",EITLERPGLOBAL.getCurrentDateDB());
            rsHierarchy.updateBoolean("CHANGED",true);
            rsHierarchy.updateString("CHANGED_DATE",EITLERPGLOBAL.getCurrentDateDB());
            ...
            tmpStmt=Conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            rsTmp=tmpStmt.executeQuery("SELECT * FROM D_COM_HIERARCHY_RIGHTS WHERE COMPANY_ID="+Integer.toString(EITLERPGLOBAL.gCompanyID));
            ...
            for(int i=1;i<=colRights.size();i++) {
             ...
             //   rsTmp.updateString("CREATED_DATE",(String)ObjRights.getAttribute("CREATED_DATE").getObj());
                ...
                for(int c=1;c<=ObjRights.colFieldAccess.size();c++) {
                    ...
                    rsFA.moveToInsertRow();
                    rsFA.updateInt("COMPANY_ID",EITLERPGLOBAL.gCompanyID);
                    rsFA.updateInt("HIERARCHY_ID",(int)nHierarchyID);
                    rsFA.updateInt("USER_ID",(int) ObjRights.getAttribute("USER_ID").getVal());
                    rsFA.updateInt("SR_NO",c);
                    rsFA.updateString("FIELD_TYPE",(String)ObjFA.getAttribute("FIELD_TYPE").getObj());
    ...
    public Object getObject(long pCompanyID,long pHierarchyID) {
    ...
    public static HashMap getList(String pCondition) {
        ...
        try {
            ...
            rsTmp=tmpStmt.executeQuery("SELECT * FROM D_COM_HIERARCHY "+pCondition+" ORDER BY MODULE_ID");
    ...
    public static HashMap getListEx(String pCondition) {
        ...
        try {
            ...
            strSQL="SELECT COUNT(*) AS THECOUNT FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND SR_NO=1 ORDER BY MODULE_ID";
            //strSQL="SELECT COUNT(*) AS THECOUNT FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" ORDER BY MODULE_ID";
            ...
            if(rsTmp.getInt("THECOUNT")>=1) //Hierarchies found starting with logged in user
            {
                ...
                //strSQL="SELECT D_COM_HIERARCHY.*  FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" ORDER BY IS_DEFAULT DESC";
            }
            ...
            if(rsTmp.getInt("THECOUNT")<=0) //No hierarchy found starting with logged in user
            {
               ...
               strSQL="SELECT D_COM_HIERARCHY.*  FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" ORDER BY MODULE_ID";
            }
    ...
    public static HashMap getList09(String pCondition) {
        Connection tmpConn;
        ResultSet rsTmp;
        Statement tmpStmt;
        ...
        try {
            ...
            //First find the hierarchy starting with logged in user
            strSQL="SELECT COUNT(*) AS THECOUNT FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND SR_NO=1 AND D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=3) ORDER BY MODULE_ID";
            ...
            {
                //Retain the Query as it is
                strSQL="SELECT D_COM_HIERARCHY.*  FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND SR_NO=1 AND D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=3) ORDER BY IS_DEFAULT DESC";
            }
            ...
            if(rsTmp.getInt("THECOUNT")<=0) //No hierarchy found starting with logged in user
            {
                //return List;
                //Another check
               strSQL="SELECT COUNT(*) AS THECOUNT FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=3) ORDER BY MODULE_ID";
               tmpStmt=tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
               rsTmp=tmpStmt.executeQuery(strSQL);
               rsTmp.first();
    ...
    public static HashMap getListOtherthan09(String pCondition) {
        Connection tmpConn;
        ResultSet rsTmp;
        Statement tmpStmt;
        ...
        try {
            ...
            //First find the hierarchy starting with logged in user
            strSQL="SELECT COUNT(*) AS THECOUNT FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND SR_NO=4 AND D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=4) ORDER BY MODULE_ID";
            //strSQL="SELECT COUNT(*) AS THECOUNT FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND SR_NO=1 AND D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=4) ORDER BY MODULE_ID";
            //COM-DX
            tmpStmt=tmpConn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
            rsTmp=tmpStmt.executeQuery(strSQL);
            ...
            {
                //Retain the Query as it is
                strSQL="SELECT D_COM_HIERARCHY.*  FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND  D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=4) ORDER BY IS_DEFAULT DESC";
                //strSQL="SELECT D_COM_HIERARCHY.*  FROM D_COM_HIERARCHY,D_COM_HIERARCHY_RIGHTS "+pCondition+" AND D_COM_HIERARCHY.COMPANY_ID=D_COM_HIERARCHY_RIGHTS.COMPANY_ID AND D_COM_HIERARCHY.HIERARCHY_ID=D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID AND D_COM_HIERARCHY_RIGHTS.USER_ID="+EITLERPGLOBAL.gUserID+" AND SR_NO=1 AND D_COM_HIERARCHY_RIGHTS.HIERARCHY_ID IN (SELECT DISTINCT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS GROUP BY HIERARCHY_ID HAVING COUNT(SR_NO)=4) ORDER BY IS_DEFAULT DESC";
                //COM-DX
            }
        ...
        try {
            ...
            while(!rsTmp.isAfterLast()) {
                ...
                if(rsTmp.getBoolean("GRANT_OTHER")) {
                    ...
                    if(EITLERPGLOBAL.isDate(rsTmp.getString("FROM_DATE"))&&EITLERPGLOBAL.isDate(rsTmp.getString("TO_DATE"))) {
                        java.sql.Date FromDate=rsTmp.getDate("FROM_DATE");
                        java.sql.Date ToDate=rsTmp.getDate("TO_DATE");
                        java.sql.Date CurrentDate=java.sql.Date.valueOf(EITLERPGLOBAL.getCurrentDateDB());
    ...
    public static boolean canSendDirectly(int pCompanyID,int pHierarchyID,int pUserID,String pDocNo) {
        ...
        try {
            ...
            rsTmp=data.getResult("SELECT USER_ID FROM D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+ModuleID+" AND USER_ID="+pUserID+" AND TYPE='C' AND DOC_NO='"+pDocNo+"'");
            rsTmp.first();
            if(rsTmp.getRow()>0) {
                ...
                rsTmp=data.getResult("SELECT USER_ID FROM D_COM_DOC_DATA WHERE COMPANY_ID="+pCompanyID+" AND MODULE_ID="+ModuleID+" AND USER_ID<>"+pUserID+" AND STATUS<>'P' AND DOC_NO='"+pDocNo+"'");
                rsTmp.first();
                if(rsTmp.getRow()>0) {
    ...
    public static void sendMailToAllUsers(int COMPANY_ID,int SelHierarchyID,int CURRENT_USER,String SUBJECT,String MESSAGE,String cc)
    {
        HashMap hmSendToList;
        hmSendToList = clsHierarchy.getUserList(COMPANY_ID, SelHierarchyID, CURRENT_USER,true);
        for (int i = 1; i <= hmSendToList.size(); i++) {
            clsUser ObjUser = (clsUser) hmSendToList.get(Integer.toString(i));
            int USER_ID = ObjUser.getAttribute("USER_ID").getInt();
            String send_to = clsUser.getExternalEMail(EITLERPGLOBAL.gCompanyID, USER_ID);

            System.out.println("USERID : "+USER_ID+", send_to : "+send_to);
            try{
                JMail.SendMail(EITLERPGLOBAL.SMTPHostIP, "sdmlerp@dineshmills.com", send_to, MESSAGE, SUBJECT, cc);
            }catch(Exception e)
            {
                e.printStackTrace();
            }
    ...
    public static HashMap getHirarchy(String UserID){
        HashMap List = new HashMap(); 
        long i = 0;
        ResultSet rsGetHirarchy;
        try {
            String strSQL = "";
            strSQL = "SELECT * FROM D_COM_HIERARCHY H,D_COM_HIERARCHY_RIGHTS HR WHERE H.HIERARCHY_ID=HR.HIERARCHY_ID "
//                    + "AND MODULE_ID IN (SELECT MODULE_ID FROM D_COM_MENU_MASTER WHERE MODULE_ID!=0 AND (PARENT_ID LIKE '60%' OR PARENT_ID LIKE '70%') ORDER BY MODULE_ID) "
                    + "AND HR.HIERARCHY_ID IN (SELECT HIERARCHY_ID FROM D_COM_HIERARCHY_RIGHTS WHERE USER_ID=" + UserID + " ) ORDER BY HR.HIERARCHY_ID,SR_NO";//AND HIERARCHY_ID>5075
            rsGetHirarchy = data.getResult(strSQL);
            rsGetHirarchy.first();
            if (rsGetHirarchy.getRow() > 0) {
                while(!rsGetHirarchy.isAfterLast()) {
                    i++;
                    clsHierarchyUsersList objgetHirarchy = new clsHierarchyUsersList();
                    
                    //objgetHirarchy.setAttribute("COMPANY_ID", rsGetHirarchy.getLong("COMPANY_ID"));
                    objgetHirarchy.setAttribute("HIERARCHY_ID", rsGetHirarchy.getLong("HIERARCHY_ID"));
                    objgetHirarchy.setAttribute("HIERARCHY_NAME", rsGetHirarchy.getString("HIERARCHY_NAME"));
                    objgetHirarchy.setAttribute("MODULE_ID", rsGetHirarchy.getLong("MODULE_ID"));
                    objgetHirarchy.setAttribute("IS_DEFAULT", rsGetHirarchy.getBoolean("IS_DEFAULT"));
                    //objgetHirarchy.setAttribute("CREATED_BY", rsGetHirarchy.getLong("CREATED_BY"));
                    //objgetHirarchy.setAttribute("CREATED_DATE", rsGetHirarchy.getString("CREATED_DATE"));
                    //objgetHirarchy.setAttribute("MODIFIED_BY", rsGetHirarchy.getLong("MODIFIED_BY"));
                    //objgetHirarchy.setAttribute("MODIFIED_DATE", rsGetHirarchy.getString("MODIFIED_DATE"));
                    
                  //objgetHirarchyUser.setAttribute("COMPANY_ID", rsGetHirarchy.getLong("COMPANY_ID"));
                    objgetHirarchy.setAttribute("USER_ID", rsGetHirarchy.getLong("USER_ID"));
                    objgetHirarchy.setAttribute("SR_NO", rsGetHirarchy.getLong("SR_NO"));
                    //objgetHirarchy.setAttribute("HIERARCHY_ID", rsGetHirarchy.getLong("HIERARCHY_ID"));
                    objgetHirarchy.setAttribute("APPROVER", rsGetHirarchy.getBoolean("APPROVER"));
                    objgetHirarchy.setAttribute("FINAL_APPROVER", rsGetHirarchy.getBoolean("FINAL_APPROVER"));
                    objgetHirarchy.setAttribute("CREATOR", rsGetHirarchy.getBoolean("CREATOR"));
                    objgetHirarchy.setAttribute("APPROVAL_SEQUENCE", rsGetHirarchy.getLong("APPROVAL_SEQUENCE"));
                    objgetHirarchy.setAttribute("SKIP_SEQUENCE", rsGetHirarchy.getBoolean("SKIP_SEQUENCE"));
                    objgetHirarchy.setAttribute("GRANT_OTHER", rsGetHirarchy.getBoolean("GRANT_OTHER"));
                    objgetHirarchy.setAttribute("FROM_DATE", rsGetHirarchy.getString("FROM_DATE"));
                    objgetHirarchy.setAttribute("TO_DATE", rsGetHirarchy.getString("TO_DATE"));
                    objgetHirarchy.setAttribute("GRANT_USER_ID", rsGetHirarchy.getLong("GRANT_USER_ID"));
                    objgetHirarchy.setAttribute("RESTORE", rsGetHirarchy.getBoolean("RESTORE"));
                    //objgetHirarchyUser.setAttribute("CREATED_BY", rsGetHirarchy.getLong("CREATED_BY"));
                    //objgetHirarchyUser.setAttribute("CREATED_DATE", rsGetHirarchy.getString("CREATED_DATE"));
                    //objgetHirarchyUser.setAttribute("MODIFIED_BY", rsGetHirarchy.getLong("MODIFIED_BY"));
                    //objgetHirarchyUser.setAttribute("MODIFIED_DATE", rsGetHirarchy.getString("MODIFIED_DATE"));
                    
                    List.put(Long.toString(List.size()+1), objgetHirarchy);
                    rsGetHirarchy.next();
                }
            }
