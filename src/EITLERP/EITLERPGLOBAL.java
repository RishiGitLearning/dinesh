  ...
  * EITLERPGLOBAL.java
  *
  * Created on March 30, 2004, 4:04 PM
  */
...
public class EITLERPGLOBAL
{
    ...
    //public static String DBUserName="?user=eitlerpsync;password=EitlerpSync";
    //public static String DBUserName="?user=root";
    ...
    public static int FinYearFrom=2021; //2020  //2019 as on 24/06/2020
    public static int FinYearTo=2023; //2022 as on 01/04/2022 //2021
    public static String FinFromDate="01/04/2021"; //2020 //Financial Year From Date. in DD/MM/YYYY
    public static String FinToDate="31/03/2023"; //31/03/2022 as on 01/04/2022//2021 //Financial Year To Date. in DD/MM/YYYY
    ...
    public static String FinFromDateDB="2021-04-01"; //2020 //Financial Year From Date. in YYYY-MM-DD
    public static String FinToDateDB="2023-03-31"; //2022-03-31 as on 01/04/2022 //2021 //Financial To From Date. in YYYY-MM-DD
         
    
    public static String SMTPHostIP="34.206.245.89";
...
//   public static String DatabaseURL="jdbc:mysql://200.0.0.227:3306/DINESHMILLS"+EITLERPGLOBAL.DBUserName; //Database URL for current financial year
    //public static String DatabaseURL="jdbc:mysql://200.0.0.227:3306/DINESHMILLS?zeroDateTimeBehavior=convertToNull&"+EITLERPGLOBAL.DBUserName; //Database URL for current financial year
    public static String DatabaseURL="jdbc:mysql://200.0.0.227:3306/DINESHMILLS?zeroDateTimeBehavior=convertToNull";//?zeroDateTimeBehavior=convertToNull&"+EITLERPGLOBAL.DBUserName; 
    //public static String DatabaseURL="jdbc:mysql://200.0.0.227:3306/DINESHMILLS?zeroDateTimeBehavior=convertToNull";//?zeroDateTimeBehavior=convertToNull&"+EITLERPGLOBAL.DBUserName; 
    
    
//    public static String DatabaseURL_Production="jdbc:mysql://200.0.0.227:3306/PRODUCTION"+EITLERPGLOBAL.DBUserName;//?zeroDateTimeBehavior=convertToNull&"+EITLERPGLOBAL.DBUserName; 
    public static String DatabaseURL_Production="jdbc:mysql://200.0.0.227:3306/PRODUCTION";//?zeroDateTimeBehavior=convertToNull&"+EITLERPGLOBAL.DBUserName; 
    
    
//    public static String SystemLogURL="jdbc:mysql://200.0.0.227:3306/SYSTEMLOG"+EITLERPGLOBAL.DBUserName; //Database URL for current financial year
    public static String SystemLogURL="jdbc:mysql://200.0.0.227:3306/SYSTEMLOG"; //Database URL for current financial year
    ...
    public static String HostIP="200.0.0.227:8080/SDMLERP";
    public static String HostIP1="200.0.0.227:8080/SDMLERP/";
    public static String HostIP2="200.0.0.227:8080/";
    ...
    public static void LoadImages(String pPath) {
        ImageIcon img;
        ...
        try {
            ...
            tlbImages.put("LOGO",new ImageIcon(new java.net.URL(pPath+"eitllogo.jpg")));
            ...
            //tlbImages.put("RIGHTPANE",new ImageIcon(new java.net.URL(pPath+"ERP_CUBES.jpg")));
            ...
            if (mbirthday > 0) {
                tlbImages.put("RIGHTPANE", new ImageIcon(new java.net.URL(pPath + "HappyBirthday.gif")));
            } else {
                tlbImages.put("RIGHTPANE", new ImageIcon(new java.net.URL(pPath + "ERP_CUBES.jpg")));
            }
            tlbImages.put("BULLET",new ImageIcon(new java.net.URL(pPath+"Bullet.gif")));
            tlbImages.put("FELTIMAGE",new ImageIcon(new java.net.URL(pPath+"FeltImage")));
    ...
    //Usage Sample
    //txtECCDate.setText(EITLERPGLOBAL.formatDate((Date) ObjCompany.getAttribute("ECC_DATE").getObj()));
    ...
    public static String formatDate(String pDate) {
        ...
        try {
            if(pDate.equals("")) {
                ...
                String formatedDate=pDate.substring(8,10)+"/"+pDate.substring(5,7)+"/"+pDate.substring(0,4)+" "+pDate.substring(11,19);
                
                if(isDate(formatedDate.substring(0,10))) {
    ...
    public static String formatDateDB(String pDate) {
        ...
        public static String formatDateTimeDB(String pDateTime) {
        
        if (pDateTime.length()<19) {
            return "";
        }
        else {
            if(isDate(pDateTime.substring(0, 10))) {
                return pDateTime.substring(6,10) + "-" + pDateTime.substring(3,5) + "-" + pDateTime.substring(0,2)+" "+pDateTime.substring(11,19);
            }
            else {
                return "";
            }
    ...
    public static String getCurrentDateTimeDB() {
        ...
        String strDate=data.getStringValueFromDB("SELECT NOW() AS DATE FROM DUAL");
    ...
    public static int getComboCode(JComboBox pCombo) {
        ...
        try {
            EITLComboModel aModel=(EITLComboModel) pCombo.getModel();
    ...
    public static void setComboIndex(JComboBox pCombo,int pValue) {
        try {
            ...
            for(int i=0;i<aModel.getSize();i++) {
                //System.out.println("Model String"+aModel.getCode(i)+" "+aModel.getText(i));
                if(aModel.getCode(i)==pValue) {
                    //System.out.println("Model Code "+aModel.getCode(i));
                    //System.out.println("Model Pvalue"+pValue);                    
                    pCombo.setSelectedIndex(i);                    
                    //System.out.println("Combo Index"+pCombo.getSelectedIndex());
                    return;
                }
            }
        }
    ...
    public static String padRight(int pMaxLen,String pString,String pPadChar) {
        return pString+EITLERPGLOBAL.makeString(pMaxLen-pString.trim().length(),pPadChar);
    }
    
    
    public static String padLeft(int pMaxLen,String pString,String pPadChar) {
        return EITLERPGLOBAL.makeString(pMaxLen-pString.trim().length(),pPadChar)+pString;
    }
    ...
    public static String addDaysToDate(String sdate1, int Days, String fmt) {
        ...
        Year=EITLERPGLOBAL.Replicate("0",4-Year.length())+Year;
        
        String Month=Integer.toString((cal1.getTime().getMonth()+1));
        Month=EITLERPGLOBAL.Replicate("0", 2-Month.length())+Month;
        
        String Day=Integer.toString(cal1.get(Calendar.DAY_OF_MONTH));
        Day=EITLERPGLOBAL.Replicate("0",2-Day.length())+Day;
    ...
    public static String addMonthToDate(String Date) {
        ...
        int Month=EITLERPGLOBAL.getMonth(Date);
        int Year=EITLERPGLOBAL.getYear(Date);
        ToDate = EITLERPGLOBAL.addDaysToDate(Date, EITLERPGLOBAL.getDaysInMonth(Month,Year)-1,"yyyy-MM-dd");
    ...
    public static String padRightEx(String pString,String padChar,int Length) {
        try {
            ...
            if(pString.length()<Length) {
                return pString+EITLERPGLOBAL.Replicate(padChar, Length-pString.length());
            }
    ...
    public static String padLeftEx(String pString,String padChar,int Length) {
        try {
            ...
            if(pString.length()<Length) {
                return EITLERPGLOBAL.Replicate(padChar, Length-pString.length())+pString;
            }
    ...
    public static boolean isDateFromOpenYear(String strDate) {
        int Year = 0;
        strDate = EITLERPGLOBAL.formatDateDB(strDate);
        Year = Integer.parseInt(EITLERPGLOBAL.getFinYearStartDate(strDate).substring(0,4));
         if(data.IsRecordExist("SELECT * FROM D_COM_FIN_YEAR WHERE YEAR_FROM="+Year+" AND OPEN_STATUS='O' AND COMPANY_ID="+EITLERPGLOBAL.gCompanyID)) {
             return true;
         } else {
             return false;
         }
