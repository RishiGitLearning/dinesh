 ...
 * @author  
 */
public class frmGSTRAdvSearch extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GSTR 1 Advance Search");
        ...
        Export_B2B.setBounds(10, 360, 170, 33);
        jPanel10.add(file1);
...
//        }
    ...
    public void GenerateB2BData(String ORDER_BY) {
        ...
        try {
            String strSQL = "SELECT * FROM TEMP_DATABASE.D_SAL_GSTR_INVOICE WHERE INVOICE_DATE>='"+ EITLERPGLOBAL.formatDateDB(txtFromDate.getText()) +"' AND INVOICE_DATE <= '"+ EITLERPGLOBAL.formatDateDB(txtToDate.getText()) +"' AND APPROVED=1 AND CANCELLED=0 "+ORDER_BY;
            ...
            while (!rs.isAfterLast()) {
                ...
                rowData[13] = pName;
                rowData[14] = rs.getString("SGST_PER");
                rowData[15] = rs.getString("SGST_AMT");
                rowData[16] = rs.getString("CGST_PER");
                rowData[17] = rs.getString("CGST_AMT");
                rowData[18] = rs.getString("IGST_PER");
                rowData[19] = rs.getString("IGST_AMT");
                rowData[20] = rs.getString("HSN_CODE");
