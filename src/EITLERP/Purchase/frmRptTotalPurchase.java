...
public class frmRptTotalPurchase extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("TOTAL PURCHASE REPORT");
    ...
    private void cmdPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPreviewActionPerformed
        ...
        if(chkSupp.isSelected()&&chkFromDate.isSelected()) {
            try {
                ...
                //TDATE
                //SUPPLIER
                URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptTotalPurchaseBoth.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FDATE="+FromDate+"&TDATE="+ToDate+"&SUPPLIER="+SuppCode);
        ...
        if(chkSupp.isSelected()&&(!chkFromDate.isSelected())) {
            try {
                //CompanyID
                //SUPPLIER
                URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptTotalPurchaseSupp.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&SUPPLIER="+SuppCode);
                EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
            }
            catch(Exception e) {
                JOptionPane.showMessageDialog(null,"Error Previwing "+e.getMessage());
        ...
        if(chkFromDate.isSelected()&&(!chkSupp.isSelected())) {
            try {
                ...
                URL ReportFile=new URL("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/rptTotalPurchaseDate.jsp?dbURL="+EITLERPGLOBAL.DatabaseURL+"&CompanyID="+EITLERPGLOBAL.gCompanyID+"&FDATE="+FromDate+"&TDATE="+ToDate+"");
                EITLERPGLOBAL.loginContext.showDocument(ReportFile,"_blank");
            }
            catch(Exception e) {
                JOptionPane.showMessageDialog(null,"Error Previwing "+e.getMessage());
