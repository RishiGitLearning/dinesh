...
/*<APPLET CODE=frmRateApprovalFind.class HEIGHT=382 WIDTH=560></APPLET>*/

public class frmRateApprovalFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtItemID.setBounds(100, 132, 121, 19);

        jLabel11.setText("Item");
        jPanel1.add(jLabel11);
        jLabel11.setBounds(35, 132, 52, 15);

        txtItemName.setEditable(false);
        jPanel1.add(txtItemName);
        txtItemName.setBounds(101, 153, 309, 19);

        jLabel5.setText("Inquiry No.");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(22, 88, 73, 15);

        jPanel1.add(txtInquiryNo);
        txtInquiryNo.setBounds(99, 86, 132, 19);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 38, 458, 184);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       if(!txtItemID.getText().trim().equals(""))
       {
         strQuery=strQuery+" AND APPROVAL_NO IN (SELECT APPROVAL_NO FROM D_PUR_RATE_APPROVAL_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND ITEM_ID='"+txtItemID.getText().trim()+"') ";
       }
