...
/*<APPLET CODE=frmPOTerms.class WIDTH=765 HEIGHT=420></APPLET>*/
 ...
 * @author  nrpithva
 */
public class frmPOTerms extends javax.swing.JApplet {
    ...
    private void ShowInformation(String pPONo,int pSrNo) {
        try {
            ...
            rsTmp=stTmp.executeQuery("SELECT * FROM D_PUR_PO_HEADER WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" AND PO_NO='"+pPONo+"'");
            rsTmp.first();
            ...
            clsPOGen ObjPO=(clsPOGen)tmpObj.getObject(EITLERPGLOBAL.gCompanyID,pPONo,EITLERPGLOBAL.DatabaseURL,POType);
            
            txtQuotNo.setText((String)ObjPO.getAttribute("PO_NO").getObj());
            txtSuppID.setText((String)ObjPO.getAttribute("SUPP_ID").getObj());
            ...
            for(int i=1;i<=ObjPO.colPOItems.size();i++) {
                    ...
                    for(int t=1;t<=10;t++) {
                        int TaxID=(int)ObjPO.getAttribute("COLUMN_"+t+"_ID").getVal();
                        if(TaxID>0) {
                            Object[] rowData=new Object[3];
                            rowData[0]=(String)ObjPO.getAttribute("COLUMN_"+t+"_CAPTION").getObj();
                            rowData[1]=Double.toString(ObjPO.getAttribute("COLUMN_"+t+"_PER").getVal());
                            rowData[2]=Double.toString(ObjPO.getAttribute("COLUMN_"+t+"_AMT").getVal());
...
private void ShowInformation(String pPONo,String pItemID) {
        try {
    ...
    private void ShowInformation(String pPONo) {
        try {
    ...
    public boolean ShowForm(String pQuotID,int pSrNo) {
        try {
            ...
            aDialog=new JDialog(f,"PO Terms",true);
    ...
    public boolean ShowForm(String pQuotID,String pItemID) {
        try {
            
            ShowInformation(pQuotID,pItemID);
            ...
            //Place it to center of the screen
            aDialog.setLocation((int)(800-appletSize.getWidth())/2,(int)(600-appletSize.getHeight())/2);
