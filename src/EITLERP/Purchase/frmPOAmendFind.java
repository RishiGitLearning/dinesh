...
/*<APPLET CODE=frmPOAmendFind.class HEIGHT=450 WIDTH=564></APPLET>*/
...
public class frmPOAmendFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(54, 118, 52, 15);
        ...
        txtItemID.setBounds(115, 358, 121, 19);
        
        jLabel19.setText("Item");
        jPanel1.add(jLabel19);
        jLabel19.setBounds(50, 358, 52, 15);
        
        txtItemName.setEditable(false);
        jPanel1.add(txtItemName);
        txtItemName.setBounds(116, 379, 309, 19);
        
        jLabel20.setText("Our Quot. No.");
        jPanel1.add(jLabel20);
        jLabel20.setBounds(18, 416, 93, 15);
        
        jPanel1.add(txtQuotID);
        txtQuotID.setBounds(118, 412, 114, 19);
        
        jLabel21.setText("Indent No.");
        jPanel1.add(jLabel21);
        jLabel21.setBounds(249, 413, 80, 15);
        
        jPanel1.add(txtIndentNo);
        txtIndentNo.setBounds(332, 411, 114, 19);
        
        getContentPane().add(jPanel1);
        jPanel1.setBounds(4, 32, 462, 447);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       //strQuery=" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" AND AMEND_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND AMEND_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ";
       strQuery=" WHERE COMPANY_ID="+Long.toString(EITLERPGLOBAL.gCompanyID)+" ";
       
       if(!txtDocNo.getText().trim().equals(""))
       {
         strQuery=strQuery+" AND AMEND_NO='"+txtDocNo.getText()+"' ";
       }
       ...
       {
         strQuery=strQuery+" AND AMEND_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
       ...
       {
        subQuery=" AND AMEND_NO IN (SELECT AMEND_NO FROM D_PUR_AMEND_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" "+subQuery+")";
       }
