...
public class frmFreightCalculationFind extends javax.swing.JApplet {
    ...
    public frmFreightCalculationFind() 
    {
         setSize(571, 271);
         System.gc();
         initComponents();        
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(22, 79, 70, 15);

        jPanel1.add(txtDateFrom);
        txtDateFrom.setBounds(100, 79, 130, 19);

        jLabel4.setText(" To");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(250, 79, 20, 15);

        jPanel1.add(txtDateTo);
        txtDateTo.setBounds(284, 79, 130, 19);

        jLabel10.setText("Supplier");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(37, 115, 52, 15);
        ...
        txtSuppCode.setBounds(102, 115, 127, 19);

        txtSuppName.setEditable(false);
        jPanel1.add(txtSuppName);
        txtSuppName.setBounds(103, 138, 307, 19);

        jLabel5.setText("P.O. No.");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(31, 45, 64, 15);

        jPanel1.add(txtPONo);
        txtPONo.setBounds(99, 43, 132, 19);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(5, 38, 458, 170);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
         strQuery=strQuery+" AND DOC_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
       }

       if(!txtDateTo.getText().equals(""))
       {
         strQuery=strQuery+" AND DOC_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
      
       if(!txtPONo.getText().equals(""))
       {
         strQuery=strQuery+" AND PO_NO<='"+EITLERPGLOBAL.formatDateDB(txtPONo.getText())+"' ";
       }
