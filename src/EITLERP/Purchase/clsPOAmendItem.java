...
public class clsPOAmendItem {
    ...
    public void setAttribute(String PropName,boolean Value)
 {
    ...
    public clsPOAmendItem() {
        ...
        props.put("EXCISE_TARRIF_NO",new Variant(""));
