...
public class frmQuoteFind extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtSuppCode.setBounds(100, 86, 62, 19);

        txtSuppName.setEditable(false);
        jPanel1.add(txtSuppName);
        txtSuppName.setBounds(170, 86, 242, 19);
        ...
        txtItemID.setBounds(112, 133, 121, 19);

        jLabel13.setText("Item");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(66, 135, 37, 15);

        txtItemName.setEditable(false);
        jPanel1.add(txtItemName);
        txtItemName.setBounds(113, 154, 309, 19);

        jLabel14.setText("Inquiry No.");
        jPanel1.add(jLabel14);
        jLabel14.setBounds(31, 193, 78, 15);

        jPanel1.add(txtInquiryNo);
        txtInquiryNo.setBounds(115, 190, 114, 19);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(6, 38, 458, 225);
    ...
    private void cmdClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdClearActionPerformed
        // TODO add your handling code here:
         strQuery=" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID ;   //+" AND QUOT_DATE>='"+EITLERPGLOBAL.FinFromDateDB+"' AND QUOT_DATE<='"+EITLERPGLOBAL.FinToDateDB+"' ";
         Cancelled=false;
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
       ...
       {
         strQuery=strQuery+" AND QUOT_ID='"+txtDocNo.getText()+"' ";
       }
       
       if(!txtDateFrom.getText().equals(""))
       {
         strQuery=strQuery+" AND QUOT_DATE>='"+EITLERPGLOBAL.formatDateDB(txtDateFrom.getText())+"' ";
       }

       if(!txtDateTo.getText().equals(""))
       {
         strQuery=strQuery+" AND QUOT_DATE<='"+EITLERPGLOBAL.formatDateDB(txtDateTo.getText())+"' ";
       }
       ...
       {
        subQuery=subQuery+" AND INQUIRY_NO='"+txtInquiryNo.getText()+"' ";   
       }
       
       if(!subQuery.trim().equals(""))
       {
        subQuery=" AND QUOT_ID IN (SELECT QUOT_ID FROM D_PUR_QUOT_DETAIL WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID+" "+subQuery+")";
       }
