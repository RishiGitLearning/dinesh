...
public class MessageClient {
    ...
    public void Connect() {
        try {
            ...
            sendMessage("##USER.INFO##       "+EITLERPGLOBAL.padRight(20, EITLERPGLOBAL.gLoginID," ")+EITLERPGLOBAL.padRight(20, clsDepartment.getDeptName(EITLERPGLOBAL.gCompanyID,EITLERPGLOBAL.gUserDeptID)," "));
                    ...
                    while(!Done) {
                        try {
                            ...
                            if(!newMessage.equals("###PingTest###")) {
                                ...
                                String finalMessage=EITLERPGLOBAL.padRight(20, FromUser.trim(), " ")+"Message received from "+FromUser.trim()+" on "+EITLERPGLOBAL.getCurrentDate()+" "+EITLERPGLOBAL.getCurrentTime()+"\n\n"+theMessage;
        ...
        new Thread() {
            public void run() {
                ...
                while(true) {
                    ...
                    try {
                        String newMessage="##USER.INFO##       "+EITLERPGLOBAL.padRight(20, EITLERPGLOBAL.gLoginID," ")+EITLERPGLOBAL.padRight(20, clsDepartment.getDeptName(EITLERPGLOBAL.gCompanyID,EITLERPGLOBAL.gUserDeptID)," ");
