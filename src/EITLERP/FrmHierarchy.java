...
//        GenerateTree();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cmbModule.setBounds(130, 12, 262, 24);
        ...
        jPanel1.add(cmdAdd);
        cmdAdd.setBounds(496, 279, 80, 25);
        ...
        cmdRemove.setBounds(496, 339, 83, 25);
        ...
        jPanel1.add(txtDesc);
        txtDesc.setBounds(130, 40, 260, 19);
        ...
        chkDefault.setBounds(498, 10, 80, 23);
        ...
        cmdEdit1.setBounds(496, 309, 80, 25);
        ...
        chkApprover.setBounds(7, 7, 106, 23);
        ...
        chkFinalApprover.setBounds(111, 7, 140, 23);
        ...
        chkCreator.setBounds(249, 7, 104, 23);
        ...
        chkSequence.setBounds(353, 7, 144, 23);
        ...
        chkGrantOther.setBounds(7, 43, 298, 23);
        ...
        txtUserID1.setBounds(77, 71, 80, 19);
        ...
        txtToDate.setBounds(243, 96, 80, 19);
        ...
        txtFromDate.setBounds(78, 96, 80, 19);
        ...
        chkRestore.setBounds(447, 41, 80, 23);
        ...
        cmbLFields.setFont(new java.awt.Font("Dialog", 0, 10));
        cmbLFields.setEnabled(false);
        jPanel6.add(cmbLFields);
        cmbLFields.setBounds(296, 18, 252, 20);

        cmbHFields.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        cmdHAdd.setFont(new java.awt.Font("Dialog", 0, 10));
        cmdHAdd.setText("Add");
        ...
        jPanel6.add(cmdHAdd);
        cmdHAdd.setBounds(124, 42, 53, 20);

        cmdHRemove.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        cmdHRemove.setBounds(180, 42, 72, 20);

        cmdLAdd.setFont(new java.awt.Font("Dialog", 0, 10));
        cmdLAdd.setText("Add");
        ...
        jPanel6.add(cmdLAdd);
        cmdLAdd.setBounds(417, 42, 53, 20);

        cmdLRemove.setFont(new java.awt.Font("Dialog", 0, 10));
        ...
        cmdLRemove.setBounds(473, 42, 72, 20);

        jLabel3.setText("Header Fields");
        jPanel6.add(jLabel3);
        jLabel3.setBounds(8, 1, 96, 15);

        jLabel7.setText("Line Fields");
        jPanel6.add(jLabel7);
        jLabel7.setBounds(297, 1, 96, 15);
        ...
        lblHierarchyID.setBounds(400, 14, 82, 15);
        ...
        chkRefresh.setBounds(274, 4, 190, 23);
    ...
    private void cmdCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCopyActionPerformed
        ...
        AppletFrame.startApplet("EITLERP.Utils.frmUpdateData","EITL ERP");
    ...
    private void CmdUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmdUpActionPerformed
        ...
        EITLTreeModel aParentObject=(EITLTreeModel) ParentNode.getUserObject();
    ...
    private void GenerateTree() {
        ...
        //Clear existing Tree
        colTree.clear();
        List = ObjHiera.getList(" WHERE COMPANY_ID="+EITLERPGLOBAL.gCompanyID);
        //First create Root Node
        DefaultMutableTreeNode Root=new DefaultMutableTreeNode(new EITLTreeModel("0","Modules"));
        ...
        for(int i=1;i<=List.size();i++) {
            ...
            strCaption=clsModules.getModuleName(EITLERPGLOBAL.gCompanyID,ModuleID);
            ...
            for(int j=1; j<=ObjHiera.colRights.size();j++) {
                ...
                String strUserName= (String) clsUser.getUserName(EITLERPGLOBAL.gCompanyID,UserID);
                ...
                Child=new DefaultMutableTreeNode(new EITLTreeModel(strKey,strUserName));
    ...
    private void Find() {
        Loader ObjLoader=new Loader(this,"EITLERP.frmHierarchyFind",true);
