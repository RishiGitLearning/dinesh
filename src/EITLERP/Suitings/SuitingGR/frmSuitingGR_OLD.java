...
public class frmSuitingGR_OLD extends javax.swing.JApplet {
    ...
    private clsSuitingGR_OLD ObjFeltCreditNote;
...
//    private double RCMAmt = 0;
    ...
    /**
     * Creates new form frmSuitingGR_OLD
     */
    public void init() {
        System.gc();
        setSize(830, 590);
        ...
        ObjFeltCreditNote = new clsSuitingGR_OLD();
        ...
        if (ObjFeltCreditNote.LoadData()) {
            ...
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Error occured while Loading Data. Error is " + ObjFeltCreditNote.LastError, "DATA LOADING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        Tab1.add(jButton1);
        jButton1.setBounds(140, 430, 160, 28);
...
//        }           // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            exp.fillData(Table, new File("/root/Desktop/GoodsReturns.xls"));
            exp.fillData(Table, new File("D://OEM.xls"));
            JOptionPane.showMessageDialog(null, "Data saved at "
                    + "'/root/Desktop/GoodsReturns.xls' successfully in Linux PC or 'D://GoodsReturns.xls' successfully in Windows PC    ", "Message",
    ...
    private void TableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyPressed
        ...
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            if (Table.getSelectedColumn() == 1) {
                ...
                String strSQL = "SELECT CONCAT(PIECE_NO,PARTY_CODE,INVOICE_NO,INVOICE_DATE,QUALITY_NO) AS DATA_KEY,PIECE_NO,PARTY_CODE,INVOICE_NO,INVOICE_DATE FROM DINESHMILLS.D_SAL_INVOICE_DETAIL WHERE PARTY_CODE='" + txtPartyCode.getText() + "' AND INVOICE_DATE>='2010-07-01' ORDER BY PIECE_NO";
    ...
    private void TableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TableKeyReleased
        ...
        double ShortLengthAmount = 0, grossqty = 0, rate = 0, shortlengthper = 0, GRQty = 0, ShotLengthAmt = 0, GRGrossAmt = 0, StockLotAmt = 0, ReverseAmt = 0, NetGRAmt = 0;
         double GRAmt=0,ShotLotPer=0,ShotLotAmt=0,CgstAmt=0,SgstAmt=0,IgstAmt=0,totalAmt=0;
...
//         
    ...
    private void cmdShowRemarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdShowRemarksActionPerformed
        if (TableUpdateHistory.getRowCount() > 0 && TableUpdateHistory.getSelectedRow() >= 0) {
            ...
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Select a row from Document Update History");
        }
    ...
    private void cmdDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(frmSuitingGR_OLD.this, "Are you sure want to delete this record ?", "DELETE RECORD", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            Delete();
        }
    ...
    private void txtPartyCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPartyCodeKeyPressed
        if (evt.getKeyCode() == 112) //F1 Key pressed
        {
            ...
            if (aList.ShowLOV()) {
                ...
                txtPartyName.setText(clsSuitingGR_OLD.getParyName(EITLERPGLOBAL.gCompanyID, aList.ReturnVal));
                txtCity.setText(clsSuitingGR_OLD.getStation(EITLERPGLOBAL.gCompanyID, aList.ReturnVal));
...
//                }
            ...
            for (int i = 1; i <= ObjFeltCreditNote.hmFeltCreditNoteDetails.size(); i++) {
                ...
                rowData[4] = ObjFeltCreditNoteDetails.getAttribute("GR_ALPHA_INVOICE_NO").getString();
                ...
                rowData[30] = ObjFeltCreditNoteDetails.getAttribute("GR_GST_COMPOSITION_PER").getString();
                rowData[31] = ObjFeltCreditNoteDetails.getAttribute("GR_GST_COMPOSITION_AMOUNT").getString();
            ...
            FormatGridHSN_InvoiePst();
             for (int i = 1; i <= ObjFeltCreditNote.hmFeltCreditNoteDetails1.size(); i++) {
                ...
                rowData[6] = ObjFeltCreditNoteDetails1.getAttribute("CGST_AMOUNT").getDouble();
                rowData[7] = ObjFeltCreditNoteDetails1.getAttribute("SGST_AMOUNT").getDouble();
                rowData[8] = ObjFeltCreditNoteDetails1.getAttribute("IGST_AMOUNT").getDouble();
                rowData[9] = ObjFeltCreditNoteDetails1.getAttribute("COMPOSITION_AMOUNT").getDouble();
            ...
            HashMap hmApprovalHistory = clsSuitingGR_OLD.getHistoryList(GRDate, GRID);
            for (int i = 1; i <= hmApprovalHistory.size(); i++) {
                clsSuitingGR_OLD ObjFeltCreditNote = (clsSuitingGR_OLD) hmApprovalHistory.get(Integer.toString(i));
    ...
    private void FormatGrid() {
        try {
            ...
            DataModel.addColumn("Alpha Invoice Date");//4
            DataModel.addColumn("Quality");//5
            DataModel.addColumn("Shade");//6
            DataModel.addColumn("Unit Code ");//7
            DataModel.addColumn("Gross Qty ");//8
            DataModel.addColumn("Flag");//9
            DataModel.addColumn("Net Qty ");//10
            DataModel.addColumn("GR Qty ");//11
            DataModel.addColumn("Rate");//12
            DataModel.addColumn("Invoice Discount %");//13
            DataModel.addColumn("Add Discount %");//14
            DataModel.addColumn("Invoice Amount");//15
            DataModel.addColumn("Shot Length Percentage");//16
            DataModel.addColumn("Shot Length Amount");//17
            DataModel.addColumn("GR Gross Amount");//18
            DataModel.addColumn("Stock Lot Percentage");//19
            DataModel.addColumn("Stock Lot Amount");//20
            DataModel.addColumn("Reverse Amount");//21
            DataModel.addColumn("Net GR Amount");//22
            DataModel.addColumn("HSN No");//23
            DataModel.addColumn("CGST Per");//24
            DataModel.addColumn("CGST Amount");//25
            DataModel.addColumn("SGST Per");//26
            DataModel.addColumn("SGST Amount");//27
            DataModel.addColumn("IGST Per");//28
            DataModel.addColumn("IGST Amount");//29
            DataModel.addColumn("GST Composition Per");//30
            DataModel.addColumn("GST Composition Amount");//31
            DataModel.addColumn("GR Total Amount");//31
...
//                                else{
    ...
    private void Edit() {
        ...
        if (ObjFeltCreditNote.IsEditable(EITLERPGLOBAL.gCompanyID, productionDocumentNo, EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "You cannot edit this record. It is either approved/rejected or waiting approval for other user", "EDITING ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void Delete() {
        if (ObjFeltCreditNote.CanDelete(txtGRID.getText(), txtGRDate.getText(), EITLERPGLOBAL.gNewUserID)) {
            ...
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, ObjFeltCreditNote.LastError, "DELETION ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void Save() {

        String GRId, GRDate, GRDesc, GRPartyCode, GRPartyName, GRCity, GRInwardNo, GRInwardDate;
        ...
        String HSNnoSting="",InvoicenoString="",InvoiceDateString="",GrossString="",TotalamtString="";
        double cgstAmt=0,sgstAmt=0,igstAmt=0,comAmt=0,NetAmt=0,NetGRAmt=0,GrQty=0;
        ...
        try {
            ...
            for (i = 0; i <= Table.getRowCount() - 1; i++) {
                ...
                j++;
                AlphaInvoieNoString = ((String) Table.getValueAt(i, 4)).trim();
                j++;
                ...
                ObjFeltCreditNoteDetails.setAttribute("GR_GST_COMPOSITION_PER", GSTCompositionPerString);//30
                ObjFeltCreditNoteDetails.setAttribute("GR_GST_COMPOSITION_AMOUNT", GSTCompositionAmtString);//31
        ...
        for (i = 0; i <= Table1.getRowCount() - 1; i++) {
                ...
                j++;
                cgstAmt = ((double)Table1.getValueAt(i, 6));
                j++;
                sgstAmt = ((double)Table1.getValueAt(i, 7));
                j++;
                igstAmt = ((double)Table1.getValueAt(i, 8));
                j++;
                comAmt = ((double)Table1.getValueAt(i, 9));
                ...
                ObjFeltCreditNoteDetails1.setAttribute("SGST_AMOUNT", sgstAmt);//6
                ObjFeltCreditNoteDetails1.setAttribute("IGST_AMOUNT", igstAmt);//7
                ObjFeltCreditNoteDetails1.setAttribute("COMPOSITION_AMOUNT", comAmt);//8
        ...
        if (cmbHierarchy.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Select the hierarchy.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((!OpgApprove.isSelected()) && (!OpgReject.isSelected()) && (!OpgFinal.isSelected()) && (!OpgHold.isSelected())) {
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Select the Approval Action.", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (OpgReject.isSelected() && txtToRemarks.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Enter the remarks for rejection", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if ((OpgApprove.isSelected() || OpgReject.isSelected()) && cmbSendTo.getItemCount() <= 0) {
            JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Select the user, to whom rejected document to be send", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (EditMode == EITLERPGLOBAL.ADD) {
            if (ObjFeltCreditNote.Insert()) {
                ...
                JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Error occured while saving. Error is " + ObjFeltCreditNote.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        if (EditMode == EITLERPGLOBAL.EDIT) {
            if (ObjFeltCreditNote.Update()) {
                ...
                JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, "Error occured while saving editing. Error is " + ObjFeltCreditNote.LastError, "SAVING ERROR", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
    ...
    private void Find() {
        ...
        if (ObjFindFeltPacking.Cancelled == false) {
            if (!ObjFeltCreditNote.Filter(ObjFindFeltPacking.stringFindQuery)) {
                JOptionPane.showMessageDialog(frmSuitingGR_OLD.this, " No records found.", "Find Suiting Goods Returns Details", JOptionPane.YES_OPTION);
            }
            MoveLast();
        }
    }
    ...
    private void FormatGridHSN_InvoiePst() {
           Updating = true;
            ...
            DataModelHSNINVOICEPOST.addColumn("Composition Amount");//10
                ...
                for (int i = 0; i < bCnt; i++) {
                    ...
                    for (int j = 0; j < Table.getRowCount(); j++) {
                        ...
                        if (b[i].equals(hsnCode)) {
                            ...
                            CompositionAmt += Double.valueOf(DataModel.getValueAt(j, 31).toString());
                        }
                    }
