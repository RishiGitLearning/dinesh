...
public class clsSuitingGR {
    ...
    public clsSuitingGR() {
        ...
        props.put("GRCN_DATE", new Variant(""));
        props.put("GRCN_NO", new Variant(""));
    ...
    public boolean Insert() {
        ...
        try {
            ...
            resultSet.updateLong("COMPANY_ID",(long)getAttribute("COMPANY_ID").getVal());
            ...
            rsHeader.updateLong("COMPANY_ID",getAttribute("COMPANY_ID").getInt());
            ...
            for(int i=1;i<=hmFeltCreditNoteDetails.size();i++) {
                ...
                resultSetTemp.updateString("GR_RCM_PER",ObjFeltCreditNoteDetails.getAttribute("GR_RCM_PER").getString());
                resultSetTemp.updateString("GR_RCM_AMOUNT",ObjFeltCreditNoteDetails.getAttribute("GR_RCM_AMOUNT").getString());
                ...
                resultSetTemp.updateString("GR_LINK_NO",ObjFeltCreditNoteDetails.getAttribute("GR_LINK_NO").getString());
                ...
                resultSetHistory.updateString("GR_RCM_PER",ObjFeltCreditNoteDetails.getAttribute("GR_RCM_PER").getString());
                resultSetHistory.updateString("GR_RCM_AMOUNT",ObjFeltCreditNoteDetails.getAttribute("GR_RCM_AMOUNT").getString());
                resultSetHistory.updateString("GR_TOTAL_AMT",ObjFeltCreditNoteDetails.getAttribute("GR_TOTAL_AMT").getString());
                resultSetHistory.updateString("GR_LINK_NO",ObjFeltCreditNoteDetails.getAttribute("GR_LINK_NO").getString());
            ...
            for(int i=1;i<=hmFeltCreditNoteDetails1.size();i++) {
                ...
                rsDetail.updateDouble("CGST_PER",(double)ObjFeltCreditNoteDetails1.getAttribute("CGST_PER").getDouble());
                rsDetail.updateDouble("CGST_AMOUNT",(double)ObjFeltCreditNoteDetails1.getAttribute("CGST_AMOUNT").getDouble());
                rsDetail.updateDouble("SGST_PER",(double)ObjFeltCreditNoteDetails1.getAttribute("SGST_PER").getDouble());
                rsDetail.updateDouble("SGST_AMOUNT",(double)ObjFeltCreditNoteDetails1.getAttribute("SGST_AMOUNT").getDouble());
                rsDetail.updateDouble("IGST_PER",(double)ObjFeltCreditNoteDetails1.getAttribute("IGST_PER").getDouble());
                rsDetail.updateDouble("IGST_AMOUNT",(double)ObjFeltCreditNoteDetails1.getAttribute("IGST_AMOUNT").getDouble());
                rsDetail.updateDouble("RCM_PER",(double)ObjFeltCreditNoteDetails1.getAttribute("RCM_PER").getDouble());
                rsDetail.updateDouble("RCM_AMOUNT",(double)ObjFeltCreditNoteDetails1.getAttribute("RCM_AMOUNT").getDouble());
                rsDetail.updateDouble("TOTAL_AMOUNT",(double)ObjFeltCreditNoteDetails1.getAttribute("TOTAL_AMOUNT").getDouble());
                rsDetail.updateString("LINK_NO",ObjFeltCreditNoteDetails1.getAttribute("LINK_NO").getString());
                rsDetail.insertRow();
        ...
        try {
            ...
            try {
                if (ObjFeltProductionApprovalFlow.Status.equals("F")) {
                    ...
                    PostCNHSNGST((int) getAttribute("COMPANY_ID").getVal(), getAttribute("GR_ID").getString(), EITLERPGLOBAL.formatDateDB(getAttribute("GR_DATE").getString()));
                    
                    if (!data.IsRecordExist("SELECT * FROM D_FIN_VOUCHER_DETAIL WHERE GR_NO='"+getAttribute("GR_ID").getString()+"' AND GR_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("GR_DATE").getString())+"'", FinanceGlobal.FinURL)) {
                        data.Execute("UPDATE STGSALES.D_STG_GOODS_RETURNS_HEADER SET APPROVED=0,APPROVED_DATE='0000-00-00',CHANGED=1,CHANGED_DATE=CURDATE() WHERE GR_ID='"+getAttribute("GR_ID").getString()+"' AND GR_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("GR_DATE").getString())+"' ");
                        data.Execute("UPDATE DINESHMILLS.D_COM_DOC_DATA SET STATUS='W' WHERE COMPANY_ID='2' AND MODULE_ID=757 AND STATUS='F' AND DOC_NO='"+getAttribute("GR_ID").getString()+"'");
                    } else {
                        String grcnNo = data.getStringValueFromDB("SELECT VOUCHER_NO FROM D_FIN_VOUCHER_DETAIL WHERE GR_NO='"+getAttribute("GR_ID").getString()+"' AND GR_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("GR_DATE").getString())+"'", FinanceGlobal.FinURL);
                        String grcnDate = data.getStringValueFromDB("SELECT VOUCHER_DATE FROM D_FIN_VOUCHER_HEADER WHERE VOUCHER_NO='"+grcnNo+"' ", FinanceGlobal.FinURL);
                        data.Execute("UPDATE STGSALES.D_STG_GOODS_RETURNS_HEADER SET GRCN_NO='"+grcnNo+"',GRCN_DATE='"+grcnDate+"' WHERE GR_ID='"+getAttribute("GR_ID").getString()+"' AND GR_DATE='"+EITLERPGLOBAL.formatDateDB(getAttribute("GR_DATE").getString())+"' ");
                    }
    ...
    public boolean setData() {
        ...
        try {
            ...
            setAttribute("GR_DATE",resultSet.getString("GR_DATE"));
            ...
            while(resultSetTemp.next()) {
                ...
                ObjFeltCreditNoteDetails.setAttribute("GR_RCM_PER",resultSetTemp.getString("GR_RCM_PER"));
                ObjFeltCreditNoteDetails.setAttribute("GR_RCM_AMOUNT",resultSetTemp.getString("GR_RCM_AMOUNT"));
                ObjFeltCreditNoteDetails.setAttribute("GR_TOTAL_AMT",resultSetTemp.getString("GR_TOTAL_AMT"));
                ObjFeltCreditNoteDetails.setAttribute("GR_LINK_NO",resultSetTemp.getString("GR_LINK_NO"));
...
//                ObjFeltCreditNoteDetails.setAttribute("COMPOSITION_AMOUNT",resultSetTemp.getString("COMPOSITION_AMOUNT"));
            ...
            while(resultSetTemp1.next()) {
                ...
                ObjFeltCreditNoteDetails1.setAttribute("CGST_PER",resultSetTemp1.getDouble("CGST_PER"));
                ObjFeltCreditNoteDetails1.setAttribute("CGST_AMOUNT",resultSetTemp1.getDouble("CGST_AMOUNT"));
                ObjFeltCreditNoteDetails1.setAttribute("SGST_PER",resultSetTemp1.getDouble("SGST_PER"));
                ObjFeltCreditNoteDetails1.setAttribute("SGST_AMOUNT",resultSetTemp1.getDouble("SGST_AMOUNT"));
                ObjFeltCreditNoteDetails1.setAttribute("IGST_PER",resultSetTemp1.getDouble("IGST_PER"));
                ObjFeltCreditNoteDetails1.setAttribute("IGST_AMOUNT",resultSetTemp1.getDouble("IGST_AMOUNT"));
                ObjFeltCreditNoteDetails1.setAttribute("RCM_PER",resultSetTemp1.getDouble("RCM_PER"));
                ObjFeltCreditNoteDetails1.setAttribute("RCM_AMOUNT",resultSetTemp1.getDouble("RCM_AMOUNT"));
                ObjFeltCreditNoteDetails1.setAttribute("TOTAL_AMOUNT",resultSetTemp1.getDouble("TOTAL_AMOUNT"));
                ObjFeltCreditNoteDetails1.setAttribute("LINK_NO",resultSetTemp1.getString("LINK_NO"));
    ...
    public static HashMap getHistoryList(String stringProductionDate, String productionDocumentNo) {
        ...
        try {
            ...
            while(rsTmp.next()) {
                clsSuitingGR ObjFeltCreditNote = new clsSuitingGR();
    ...
    public static HashMap getPendingApprovals(int pUserID,int pOrder) {
        ...
        try {
            ...
            while(rsTmp.next()) {
                ...
                Counter=Counter+1;
                clsSuitingGR ObjDoc=new clsSuitingGR();
    ...
    public String getAlphaInvoiceNo(String pPieceNo,String Party_Code,String Invoice_No, String Invoice_Date) {
      ...
      public String getHsnNo(String pPieceNo,String Party_Code,String Invoice_No, String Invoice_Date) {
        return data.getStringValueFromDB("SELECT HSN_CODE FROM DINESHMILLS.D_SAL_INVOICE_DETAIL WHERE PIECE_NO='"+pPieceNo+"'  AND PARTY_CODE='"+Party_Code+"' AND INVOICE_NO='"+Invoice_No+"' AND INVOICE_DATE='"+Invoice_Date+"'");
     }
      public String getLinkNo(String pPieceNo,String Party_Code,String Invoice_No, String Invoice_Date) {
        System.out.println("SELECT LINK_NO FROM FINANCE.D_FIN_VOUCHER_DETAIL WHERE SUB_ACCOUNT_CODE='"+Party_Code+"' AND INVOICE_NO='"+Invoice_No+"' AND INVOICE_DATE='"+Invoice_Date+"' AND MAIN_ACCOUNT_CODE=210027 AND VOUCHER_NO LIKE 'SJ%'");
          return data.getStringValueFromDB("SELECT LINK_NO FROM FINANCE.D_FIN_VOUCHER_DETAIL WHERE SUB_ACCOUNT_CODE='"+Party_Code+"' AND INVOICE_NO='"+Invoice_No+"' AND INVOICE_DATE='"+Invoice_Date+"' AND MAIN_ACCOUNT_CODE=210027 AND VOUCHER_NO LIKE 'SJ%'");
     }
...
//            objVoucher.setAttribute("VOUCHER_TYPE", FinanceGlobal.TYPE_CREDIT_NOTE);
            ...
            objVoucher.setAttribute("REASON_CODE", "28");
            ...
            String strSQLHSN = "";
            strSQLHSN = "SELECT * FROM STGSALES.D_SAL_HSN_INVOICE_POSTING WHERE GR_ID='" + GRNo + "'";
