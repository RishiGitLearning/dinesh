...
public class frmFindSuitingGR extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Find Suiting Goods Returns Details");
        ...
        jTextFieldPieceNo.setBounds(110, 40, 130, 27);

        jLabel5.setText("GR ID");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(20, 70, 50, 17);
    ...
    private void cmdFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdFindActionPerformed
        ...
        if(!amendDate.equals("")) {
            stringFindQuery=stringFindQuery+" GR_DATE='"+EITLERPGLOBAL.formatDateDB(amendDate)+"' ";
        }
        
        if(!pieceNo.equals("")) {
            stringFindQuery=stringFindQuery+" PARTY_CODE ='"+ pieceNo +"'";
        }
        
        if(!amendID.equals("")) {
            stringFindQuery=stringFindQuery+" GR_ID ='"+ amendID +"'";
        }
        getParent().getParent().getParent().getParent().show(false);
