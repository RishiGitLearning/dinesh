...
public class frmYearlyDiscount extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("YEARLY DISCOUNT PROCESS & PRINTING FORM");
        ...
        jLabel2.setText("Yearly Discount Process");
        ...
        Processcash.setText("1. Process Yearly Discount");
        ...
        jButton1.setText("2. Yearly Dealer Incentive Detail");
        ...
        jButton1.setBounds(10, 380, 270, 25);

        jButton2.setText(" 6.Yearly Dealer Incentive CN  Draft");
        ...
        jButton2.setBounds(10, 440, 270, 25);
        ...
        jButton5.setBounds(640, 380, 200, 25);

        jButton3.setText("3. Yearly Dealer Incentive Summary");
        ...
        jButton3.setBounds(10, 410, 270, 25);
        ...
        jButton4.setBounds(640, 410, 200, 25);

        jButton6.setText("4. Yearly Delear Incentive Group Detail 55/66");
        ...
        jButton6.setBounds(290, 380, 340, 25);

        jButton7.setText("ChargeCD COBOL Report");
        ...
        jButton7.setBounds(640, 470, 200, 25);

        jButton8.setText("Charge Code Wise Report");
        ...
        jButton8.setBounds(640, 440, 200, 25);

        jToggleButton1.setText("5.Yearly Dealer Incentive Group Summary 55/66");
        ...
        jToggleButton1.setBounds(290, 410, 340, 25);

        jButton9.setText("7.Yearly Dealer Incentive Group CN Draft 55/66");
        ...
        jButton9.setBounds(290, 440, 340, 25);

        jLabel5.setText("Draft Date ");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(10, 510, 90, 20);

        txtDraftDate.setText("2017-03-31");
        getContentPane().add(txtDraftDate);
        txtDraftDate.setBounds(90, 510, 120, 19);

        getContentPane().add(txtVoucherNo);
        txtVoucherNo.setBounds(220, 510, 160, 19);

        jButton10.setText("Credit Note Voucher Processing");
        ...
        jButton10.setBounds(10, 470, 270, 25);

        jButton11.setText("Credit note Voucher Processing 55/66");
        ...
        jButton11.setBounds(290, 470, 340, 25);
   ...
   try {
    ...
    //        String draftDate="2014-2015";
      ...
      //     int reasonCode=36;
            ...
            ResultSet rsSchemeHeader =Stmt.executeQuery("SELECT CNH_SUB_ACCOUNT_CODE FROM SALES.D_CREDIT_NOTE_HEADER WHERE  CNH_YEAR_MON_ID =SUBSTRING('" +txtInterval.getText()+"',1,17) AND CNH_TYPE ='YLYINC' AND CNH_FIN_ELIGIBLE ='Y' ORDER BY CNH_SUB_ACCOUNT_CODE");
            ...
            if(rsSchemeHeader.getRow()>0){
                while(!rsSchemeHeader.isAfterLast()){
                   ...
                   // stmt.execute("UPDATE SALES.D_SAL_SCHEME_HEADER  SET SCH_VOUCHER_NO = CONCAT('CN',151500000 +ABS(REPLACE(RIGHT( SCH_DRAFT_CR_NOTE_NO,4),' ',''))),SCH_LEGACY_NO = ABS(REPLACE(RIGHT( SCH_DRAFT_CR_NOTE_NO,4),' ',''))   WHERE SCH_SEASON_ID='"+seasonId+"'  AND SCH_BOOK_CODE ='TR-15'");
                    Stmt.execute("UPDATE SALES.D_CREDIT_NOTE_HEADER  SET CNH_FIN_VOUCHER_NO = CONCAT('CN',191500000 +ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))),CNH_LEGACY_NO = ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))  WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID =SUBSTRING('" +txtInterval.getText()+"',1,17) AND  CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"'");
   ...
   try {
    ...
    //        String draftDate="2014-2015";
      ...
      //     int reasonCode=36;
            ...
            ResultSet rsSchemeHeader =Stmt.executeQuery("SELECT CNH_SUB_ACCOUNT_CODE FROM SALES.D_CREDIT_NOTE_HEADER WHERE  CNH_YEAR_MON_ID =SUBSTRING('" +txtInterval.getText()+"',1,10) AND CNH_TYPE ='YLYINC' AND CNH_FIN_ELIGIBLE ='Y' ORDER BY CNH_SUB_ACCOUNT_CODE");
          //  ResultSet rsSchemeHeader=stmt.executeQuery("SELECT SCH_PARTY_CODE FROM SALES.D_SAL_SCHEME_HEADER WHERE SCH_SCHEME_ID="+schemeId+" AND SCH_SEASON_ID='"+seasonId+"' ORDER BY SCH_PARTY_CODE");
            rsSchemeHeader.first();
            if(rsSchemeHeader.getRow()>0){
                while(!rsSchemeHeader.isAfterLast()){
                    Stmt.executeUpdate("UPDATE SALES.D_CREDIT_NOTE_HEADER SET CNH_DRAFT_CR_NOTE_NO='"+draftNo+(draftSrNo+counter)+"',CNH_LINK_NO='"+(linkSrNo+counter)+linkNo+"',CNH_FIN_VOUCHER_DATE='"+draftDate+"' ,CNH_DRAFT_CR_NOTE_DATE ='"+draftDate+"'  WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID =SUBSTRING('" +txtInterval.getText()+"',1,10) AND  CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"'");
                   // stmt.execute("UPDATE SALES.D_SAL_SCHEME_HEADER  SET SCH_VOUCHER_NO = CONCAT('CN',151500000 +ABS(REPLACE(RIGHT( SCH_DRAFT_CR_NOTE_NO,4),' ',''))),SCH_LEGACY_NO = ABS(REPLACE(RIGHT( SCH_DRAFT_CR_NOTE_NO,4),' ',''))   WHERE SCH_SEASON_ID='"+seasonId+"'  AND SCH_BOOK_CODE ='TR-15'");
                    Stmt.execute("UPDATE SALES.D_CREDIT_NOTE_HEADER  SET CNH_FIN_VOUCHER_NO = CONCAT('CN',191500000 +ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))),CNH_LEGACY_NO = ABS(REPLACE(RIGHT( CNH_DRAFT_CR_NOTE_NO,4),' ',''))  WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID =SUBSTRING('" +txtInterval.getText()+"',1,10) AND  CNH_SUB_ACCOUNT_CODE='"+rsSchemeHeader.getString("CNH_SUB_ACCOUNT_CODE")+"'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try{
            ...
            exp.fillData(Table,new File("/root/Desktop/ylyinc.xls"));
            //exp.fillData(TableI,new File("C://ProductionProcess.xls"));
            exp.fillData(Table,new File("D://ylyinc.xls"));
            JOptionPane.showMessageDialog(null, "Data saved at " +
            //"'C: \\ result.xls' successfully", "Message",
            "'/root/Desktop/ylyinc.xls' successfully in Linux PC or 'D://ylyinc.xls' successfully in Windows PC    ", "Message",
    ...
    private void cmbIntervalComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbIntervalComboActionPerformed
        ...
        formatGrid();
        try{
            ResultSet rs=data.getResult("SELECT *,CONCAT(CNH_PARTY_NAME,',',CNH_CITY) AS CNH_PARTY_NAME_CITY FROM SALES.D_CREDIT_NOTE_HEADER WHERE  CNH_TYPE='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('"+(String)cmbIntervalCombo.getSelectedItem()+"',1,10) ORDER BY CNH_SUB_ACCOUNT_CODE");
            while(!rs.isAfterLast()){
                ...
                rowData[5]=rs.getString("CNH_PERCENT");
                rowData[6]=rs.getString("CNH_CREDIT_AMOUNT");
                rowData[7]=rs.getString("CNH_INTERVAL_CAPTION");
                rowData[8]=rs.getString("CNH_EXT5");
                rowData[9]=rs.getString("CNH_LC_OPENER");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
             ChargeWiseReport();// TODO add your handling code here:
    ...
    private void generateIntervalCombo(){
        ...
        try{
            ...
            ResultSet rs=data.getResult("SELECT DISTINCT CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='YLYINC' ORDER BY CNH_YEAR_MON_ID DESC ");
            while(!rs.isAfterLast()){
    ...
    private void formatGrid(){
        ...
        DataModel.addColumn("Credited Party");
    ...
    private void PartyWiseCreditDetail() {
        try {
            ...
            String strSQL = "SELECT *,CNH_GROSS_AMT FROM SALES.D_CREDIT_NOTE_DETAIL,SALES.D_CREDIT_NOTE_HEADER WHERE CND_NO = CNH_NO AND CND_YEAR_MON_ID = CNH_YEAR_MON_ID AND CNH_SUB_ACCOUNT_CODE=CND_SUB_ACCOUNT_CODE AND CND_TYPE='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) AND CNH_CREDIT_AMOUNT > 0 ORDER BY CND_SUB_ACCOUNT_CODE,CND_INVOICE_NO,CND_INVOICE_DATE";
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptYLYINC_CN_Detail.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void YearlyDraft() {
        try {
            ...
            objReportData.AddColumn("CNH_NET_AMT");
            objReportData.AddColumn("CNH_INVOICE_AM0UNT");
            objReportData.AddColumn("CNH_DRAFT_CR_NOTE_NO");
            ...
            String strSQL = "SELECT * FROM SALES.D_CREDIT_NOTE_HEADER  WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) AND CNH_CREDIT_AMOUNT > 0 AND CNH_FIN_ELIGIBLE ='Y' ORDER BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
     ...
     private void YearlyDraft5566() {
            ...
            String strSQL = "SELECT * FROM SALES.D_CREDIT_NOTE_HEADER  WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,17) AND CNH_CREDIT_AMOUNT > 0 AND CNH_FIN_ELIGIBLE ='Y' ORDER BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
    ...
    private void YealyDiscountSummary() {
        try {
            ...
            String strSQL = "SELECT *,CONCAT(CNH_PARTY_NAME,',',CNH_CITY) AS CNH_PARTY_NAME_CITY FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) ORDER BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptYLYINC_CN_Summary.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        } }
    
    private void YealyDiscountSummary5566() {
        try {
            TReportWriter.SimpleDataProvider.TRow objRow;
            TReportWriter.SimpleDataProvider.TTable objReportData=new TReportWriter.SimpleDataProvider.TTable();
            ...
            //   String strSQL = "SELECT CND_SUB_ACCOUNT_CODE,PARTY_NAME,SUM(CND_NET_AMOUNT) AS INVOICE_AMOUNT, SUM(CND_GROSS_AMT) AS CRN_AMOUNT, SUM(CND_NET_AMOUNT) - SUM(CND_GROSS_AMT) AS TOTAL_AMOUNT,CND_PERCENT,(SUM(CND_CREDIT_AMOUNT)  -SUM(CND_DEBIT_AMOUNT) ) AS DISC_AMOUNT FROM SALES.D_CREDIT_NOTE_DETAIL1 LEFT JOIN DINESHMILLS.D_SAL_PARTY_MASTER ON CND_SUB_ACCOUNT_CODE=PARTY_CODE  WHERE CND_TYPE ='YLYINC'  AND CND_YEAR_MON_ID  ='YLYINC2014'  GROUP BY CND_SUB_ACCOUNT_CODE";
            String strSQL = "SELECT *,CONCAT(CNH_PARTY_NAME,',',CNH_CITY) AS CNH_PARTY_NAME_CITY FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,17) ORDER BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
     ...
     private void Group5566Report() {
        try {
            ...
            objReportData.AddColumn("CND_SUB_ACCOUNT_CODE");
            objReportData.AddColumn("PNAME");
            objReportData.AddColumn("CND_LC_OPENER");
            objReportData.AddColumn("NETAMT");
            objReportData.AddColumn("GRAMT");
            objReportData.AddColumn("CALC_NET");
            objReportData.AddColumn("PERCENT");
            objReportData.AddColumn("CNNET");
            objReportData.AddColumn("CNGR");
            objReportData.AddColumn("CNAMT");
            objReportData.AddColumn("LCNAME");
            objReportData.AddColumn("CND_INTERVAL_CAPTION");
           
            TReportWriter.SimpleDataProvider.TRow objOpeningRow=objReportData.newRow();
            
            objOpeningRow.setValue("CND_SUB_ACCOUNT_CODE","");
            objOpeningRow.setValue("PNAME","");
            objOpeningRow.setValue("CND_LC_OPENER","");
            objOpeningRow.setValue("NETAMT","");
            objOpeningRow.setValue("GRAMT","");
            objOpeningRow.setValue("CALC_NET","");
            objOpeningRow.setValue("PERCENT","");
            objOpeningRow.setValue("CNNET","");
            objOpeningRow.setValue("CNGR","");
            objOpeningRow.setValue("CNAMT","");
            objOpeningRow.setValue("LCNAME","");
            objOpeningRow.setValue("CND_INTERVAL_CAPTION","");
           
            //   String strSQL = "SELECT CND_SUB_ACCOUNT_CODE,PARTY_NAME,SUM(CND_NET_AMOUNT) AS INVOICE_AMOUNT, SUM(CND_GROSS_AMT) AS CRN_AMOUNT, SUM(CND_NET_AMOUNT) - SUM(CND_GROSS_AMT) AS TOTAL_AMOUNT,CND_PERCENT,(SUM(CND_CREDIT_AMOUNT)  -SUM(CND_DEBIT_AMOUNT) ) AS DISC_AMOUNT FROM SALES.D_CREDIT_NOTE_DETAIL1 LEFT JOIN DINESHMILLS.D_SAL_PARTY_MASTER ON CND_SUB_ACCOUNT_CODE=PARTY_CODE  WHERE CND_TYPE ='YLYINC'  AND CND_YEAR_MON_ID  ='YLYINC2014'  GROUP BY CND_SUB_ACCOUNT_CODE";
            String strSQL = "SELECT * FROM (SELECT CND_INTERVAL_CAPTION,CND_SUB_ACCOUNT_CODE,CONCAT(PARTY_NAME,',',CITY_ID) AS PNAME,CND_LC_OPENER,SUM(CND_NET_AMOUNT) AS NETAMT , SUM(CND_GROSS_AMT) AS GRAMT, SUM(CND_NET_AMOUNT) - SUM(CND_GROSS_AMT)  AS CALC_NET,CND_PERCENT AS PERCENT ,SUM(CND_CREDIT_AMOUNT)  AS CNNET ,SUM(CND_DEBIT_AMOUNT) AS CNGR  ,SUM(CND_CREDIT_AMOUNT)  -SUM(CND_DEBIT_AMOUNT)  AS CNAMT FROM SALES.D_CREDIT_NOTE_DETAIL ,DINESHMILLS.D_SAL_PARTY_MASTER WHERE CND_TYPE ='YLYINC' AND CND_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10)  AND SUBSTRING(CND_SUB_ACCOUNT_CODE,3,2) IN (55,66)   AND PARTY_CODE = CND_SUB_ACCOUNT_CODE AND CND_SUB_ACCOUNT_CODE != CND_LC_OPENER  GROUP BY CND_SUB_ACCOUNT_CODE,CND_LC_OPENER) AS A,(SELECT PARTY_CODE,PARTY_NAME AS LCNAME FROM DINESHMILLS.D_SAL_PARTY_MASTER)  AS PM WHERE  PARTY_CODE = CND_LC_OPENER ORDER BY CND_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
            ...
            if(rsTmp.getRow()>0) {
                while(!rsTmp.isAfterLast()) {
                    ...
                    objRow.setValue("CND_SUB_ACCOUNT_CODE",UtilFunctions.getString(rsTmp,"CND_SUB_ACCOUNT_CODE",""));
                    objRow.setValue("PNAME",UtilFunctions.getString(rsTmp,"PNAME",""));
                    objRow.setValue("CND_LC_OPENER",UtilFunctions.getString(rsTmp,"CND_LC_OPENER",""));
                    objRow.setValue("NETAMT",UtilFunctions.getString(rsTmp,"NETAMT",""));
                    objRow.setValue("GRAMT",UtilFunctions.getString(rsTmp,"GRAMT",""));
                    objRow.setValue("CALC_NET",UtilFunctions.getString(rsTmp,"CALC_NET",""));
                    objRow.setValue("PERCENT",UtilFunctions.getString(rsTmp,"PERCENT",""));
                    objRow.setValue("CNNET",UtilFunctions.getString(rsTmp,"CNNET",""));
                    objRow.setValue("CNGR",UtilFunctions.getString(rsTmp,"CNGR",""));
                    objRow.setValue("CNAMT",UtilFunctions.getString(rsTmp,"CNAMT",""));
                    objRow.setValue("LCNAME",UtilFunctions.getString(rsTmp,"LCNAME",""));
                    objRow.setValue("CND_INTERVAL_CAPTION",UtilFunctions.getString(rsTmp,"CND_INTERVAL_CAPTION",""));
                    objReportData.AddRow(objRow);
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptYLYGroupData.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        } }
     private void ChargeWiseReport() {
        try {
            ...
            objReportData.AddColumn("CND_SUB_ACCOUNT_CODE");
            objReportData.AddColumn("AGENTCODE");
            objReportData.AddColumn("CH1");
            objReportData.AddColumn("CH2");
            objReportData.AddColumn("CH3");
            objReportData.AddColumn("CH4");
            objReportData.AddColumn("CH5");
            objReportData.AddColumn("CND_INTERVAL_CAPTION");
            objReportData.AddColumn("CH7");
            objReportData.AddColumn("CH8");
            objReportData.AddColumn("CH9");
            objReportData.AddColumn("CH6");
            objReportData.AddColumn("CHALL");
            objReportData.AddColumn("SRNO");
            
            TReportWriter.SimpleDataProvider.TRow objOpeningRow=objReportData.newRow();
            
            objOpeningRow.setValue("CND_SUB_ACCOUNT_CODE","");
            objOpeningRow.setValue("AGENTCODE","");
            objOpeningRow.setValue("CH1","");
            objOpeningRow.setValue("CH2","");
            objOpeningRow.setValue("CH3","");
            objOpeningRow.setValue("CH4","");
            objOpeningRow.setValue("CH5","");
            objOpeningRow.setValue("CH6","");
            objOpeningRow.setValue("CH7","");
            objOpeningRow.setValue("CH8","");
            objOpeningRow.setValue("CH9","");
            objOpeningRow.setValue("CHALL","");
            objOpeningRow.setValue("CND_INTERVAL_CAPTION","");
            objOpeningRow.setValue("SRNO","");
            
            //   String strSQL = "SELECT CND_SUB_ACCOUNT_CODE,PARTY_NAME,SUM(CND_NET_AMOUNT) AS INVOICE_AMOUNT, SUM(CND_GROSS_AMT) AS CRN_AMOUNT, SUM(CND_NET_AMOUNT) - SUM(CND_GROSS_AMT) AS TOTAL_AMOUNT,CND_PERCENT,(SUM(CND_CREDIT_AMOUNT)  -SUM(CND_DEBIT_AMOUNT) ) AS DISC_AMOUNT FROM SALES.D_CREDIT_NOTE_DETAIL1 LEFT JOIN DINESHMILLS.D_SAL_PARTY_MASTER ON CND_SUB_ACCOUNT_CODE=PARTY_CODE  WHERE CND_TYPE ='YLYINC'  AND CND_YEAR_MON_ID  ='YLYINC2014'  GROUP BY CND_SUB_ACCOUNT_CODE";
           // String strSQL = "SELECT *,CONCAT(CNH_PARTY_NAME,',',CNH_CITY) AS CNH_PARTY_NAME_CITY FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) ORDER BY CNH_SUB_ACCOUNT_CODE";
            String strSQL = "SELECT CND_INTERVAL_CAPTION,SUBSTRING(CND_SUB_ACCOUNT_CODE,1,2)AS AGENTCODE,CND_SUB_ACCOUNT_CODE,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =1 THEN CND_NET_AMOUNT END,0)) AS CH1,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =2 THEN CND_NET_AMOUNT END,0)) AS CH2,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =3 THEN CND_NET_AMOUNT END,0)) AS CH3,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =4 THEN CND_NET_AMOUNT END,0)) AS CH4,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =5 THEN CND_NET_AMOUNT END,0)) AS CH5,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =6 THEN CND_NET_AMOUNT END,0)) AS CH6,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =7 THEN CND_NET_AMOUNT END,0)) AS CH7,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =8 THEN CND_NET_AMOUNT END,0)) AS CH8,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) =9 THEN CND_NET_AMOUNT END,0)) AS CH9,SUM(COALESCE(CASE WHEN SUBSTRING(CND_CHARGE_CODE,1,1) !=0 THEN CND_NET_AMOUNT END,0)) AS CHALL FROM SALES.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE ='YLYINC'  AND CND_YEAR_MON_ID  = SUBSTRING('" +txtInterval.getText()+"',1,10) GROUP BY CND_INTERVAL_CAPTION,SUBSTRING(CND_SUB_ACCOUNT_CODE,1,2),CND_SUB_ACCOUNT_CODE ORDER BY CND_INTERVAL_CAPTION,SUBSTRING(CND_SUB_ACCOUNT_CODE,1,2),CND_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
            ...
            if(rsTmp.getRow()>0) {
                while(!rsTmp.isAfterLast()) {
                    ...
                    objRow.setValue("SRNO",String.valueOf(Counter));
                    objRow.setValue("CND_SUB_ACCOUNT_CODE",UtilFunctions.getString(rsTmp,"CND_SUB_ACCOUNT_CODE",""));
                    objRow.setValue("AGENTCODE",UtilFunctions.getString(rsTmp,"AGENTCODE",""));
                    objRow.setValue("CH1",UtilFunctions.getString(rsTmp,"CH1",""));
                    objRow.setValue("CH2",UtilFunctions.getString(rsTmp,"CH2",""));
                    objRow.setValue("CH3",UtilFunctions.getString(rsTmp,"CH3",""));
                    objRow.setValue("CH4",UtilFunctions.getString(rsTmp,"CH4",""));
                    objRow.setValue("CH5",UtilFunctions.getString(rsTmp,"CH5",""));
                    objRow.setValue("CH6",UtilFunctions.getString(rsTmp,"CH6",""));
                    objRow.setValue("CH7",UtilFunctions.getString(rsTmp,"CH7",""));
                    objRow.setValue("CH8",UtilFunctions.getString(rsTmp,"CH8",""));
                    objRow.setValue("CH9",UtilFunctions.getString(rsTmp,"CH9",""));
                    objRow.setValue("CHALL",UtilFunctions.getString(rsTmp,"CHALL",""));
                    objRow.setValue("CND_INTERVAL_CAPTION",UtilFunctions.getString(rsTmp,"CND_INTERVAL_CAPTION",""));
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptYLYCH.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        } }
    ...
    private void ChargeWiseReportold() {
        try {
            TReportWriter.SimpleDataProvider.TRow objRow;
            TReportWriter.SimpleDataProvider.TTable objReportData=new TReportWriter.SimpleDataProvider.TTable();
    ...
    private void DealerWiseReport() {
        try {
            ...
            String strSQL = "SELECT CND_LC_OPENER,CND_SUB_ACCOUNT_CODE,SUM(CND_GROSS_QTY),SUM(CND_NET_AMOUNT),CND_PERCENT,SUM(CND_CREDIT_AMOUNT),CND_INTERVAL_CAPTION,CNH_PARTY_NAME,CNH_CITY FROM SALES.D_CREDIT_NOTE_DETAIL,SALES.D_CREDIT_NOTE_HEADER WHERE AND CND_YEAR_MON_ID = CNH_YEAR_MON_ID AND CNH_NO = CND_NO AND CND_TYPE='YLYINC' AND  CND_FLAG='LC' AND CND_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) AND CND_EFFECT='C' AND CNH_SUB_ACCOUNT_CODE=CND_LC_OPENER AND CNH_TYPE='YLYINC5566' GROUP BY CND_SUB_ACCOUNT_CODE,CND_LC_OPENER";
            System.out.println(strSQL);
