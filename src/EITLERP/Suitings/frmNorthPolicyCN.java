...
public class frmNorthPolicyCN extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblTitle.setText("NORTH POLICY CREDIT NOTE PROCESS & PRINTING FORM");
        ...
        jLabel2.setText("North Policy Credit Note Process");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(6, 39, 280, 15);
        ...
        jButton1.setLabel("North Policy Credit Note Detail");
        ...
        jButton1.setBounds(20, 380, 240, 25);

        jButton2.setLabel("North Policy Credit Note Draft ");
        ...
        jButton2.setBounds(520, 380, 250, 25);
        ...
        jButton5.setBounds(280, 410, 210, 25);

        jButton3.setLabel("North Policy  Credit Note Summary ");
        ...
        jButton3.setBounds(270, 380, 240, 25);

        jButton6.setLabel("Voucher Creation");
        ...
        jButton6.setBounds(20, 410, 240, 25);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        NorthCNSummary();    // add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        NorthCNDraft();        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed
    
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NorthCNDetail();        // TODO add your handling code here:
    ...
    private void cmbIntervalComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbIntervalComboActionPerformed
        ...
        formatGrid();
        try{
            ResultSet rs=data.getResult("SELECT CNH_SUB_ACCOUNT_CODE,CNH_PARTY_NAME,CNH_INVOICE_AMOUNT,CNH_CREDIT_AMOUNT,CNH_INTERVAL_CAPTION FROM SALES.D_CREDIT_NOTE_HEADER WHERE  CNH_TYPE='NORTH' AND CNH_YEAR_MON_ID = SUBSTRING('"+(String)cmbIntervalCombo.getSelectedItem()+"',1,11) ORDER BY CNH_SUB_ACCOUNT_CODE");
    ...
    private void generateIntervalCombo(){
        ...
        try{
            ...
            ResultSet rs=data.getResult("SELECT DISTINCT CNH_YEAR_MON_ID,CNH_INTERVAL_CAPTION FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='NORTH' ORDER BY CNH_YEAR_MON_ID DESC ");
            while(!rs.isAfterLast()){
    ...
    private void NorthCNDetail() {
        try {
            ...
            String strSQL = "SELECT *,CNH_GROSS_AMT FROM SALES.D_CREDIT_NOTE_DETAIL,SALES.D_CREDIT_NOTE_HEADER WHERE CND_NO = CNH_NO AND CND_YEAR_MON_ID = CNH_YEAR_MON_ID AND CNH_SUB_ACCOUNT_CODE=CND_SUB_ACCOUNT_CODE AND CND_TYPE='NORTH' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,11) ORDER BY CND_SUB_ACCOUNT_CODE,CND_INVOICE_DATE,CND_INVOICE_NO,CND_INVOICE_DATE";
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptNorthDetail.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void NorthCNDraft() {
        try {
            ...
            String strSQL = "SELECT * FROM SALES.D_CREDIT_NOTE_HEADER  WHERE CNH_TYPE ='NORTH' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,11) GROUP BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptNorthCNDraft.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    }
    private void NorthCNSummary() {
        try {
            TReportWriter.SimpleDataProvider.TRow objRow;
            TReportWriter.SimpleDataProvider.TTable objReportData=new TReportWriter.SimpleDataProvider.TTable();
            ...
            String strSQL = "SELECT *,CONCAT(CNH_PARTY_NAME,',',CNH_CITY) AS CNH_PARTY_NAME_CITY FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='NORTH' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,11) ORDER BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
            ...
            objEngine.PreviewReport("http://"+EITLERPGLOBAL.HostIP+"/EITLERP/Reports/sales/rptNorthCNSummary.rpt",Parameters,objReportData);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    private void ChargeWiseReport() {
        try {
            ...
            String strSQL1 = "SELECT DISTINCT CND_SUB_ACCOUNT_CODE FROM SALES.D_CREDIT_NOTE_DETAIL WHERE CND_TYPE ='NORTH' AND CND_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,11)   ";
    ...
    private void DealerWiseReport() {
        try {
            ...
            String strSQL = "SELECT CND_LC_OPENER,CND_SUB_ACCOUNT_CODE,SUM(CND_GROSS_QTY),SUM(CND_NET_AMOUNT),CND_PERCENT,SUM(CND_CREDIT_AMOUNT),CND_INTERVAL_CAPTION,CNH_PARTY_NAME,CNH_CITY FROM SALES.D_CREDIT_NOTE_DETAIL,SALES.D_CREDIT_NOTE_HEADER WHERE AND CND_YEAR_MON_ID = CNH_YEAR_MON_ID AND CNH_NO = CND_NO AND CND_TYPE='NORTH'  AND CND_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,11) AND CNH_SUB_ACCOUNT_CODE=CND_LC_OPENER AND CNH_TYPE='NORTH' GROUP BY CND_SUB_ACCOUNT_CODE,CND_LC_OPENER";
            System.out.println(strSQL);
