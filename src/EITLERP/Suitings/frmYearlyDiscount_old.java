...
public class frmYearlyDiscount_old extends javax.swing.JApplet {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jButton1.setText("2. Yearly Discount Party wise Detail  Draft");
        ...
        jButton2.setText("Yearly Discount Draft");
        ...
        jButton3.setText("3. Yearly Discount Summary");
    ...
    private void cmbIntervalComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbIntervalComboActionPerformed
        ...
        formatGrid();
        try{
            ResultSet rs=data.getResult("SELECT CNH_SUB_ACCOUNT_CODE,CNH_PARTY_NAME,CNH_INVOICE_AMOUNT,CNH_CREDIT_AMOUNT,CNH_INTERVAL_CAPTION FROM SALES.D_CREDIT_NOTE_HEADER WHERE  CNH_TYPE='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('"+(String)cmbIntervalCombo.getSelectedItem()+"',1,10) ORDER BY CNH_SUB_ACCOUNT_CODE");
    ...
    private void PartyWiseCreditDetail() {
        try {
            ...
            String strSQL = "SELECT *,CNH_GROSS_AMT FROM SALES.D_CREDIT_NOTE_DETAIL,SALES.D_CREDIT_NOTE_HEADER WHERE CND_NO = CNH_NO AND CND_YEAR_MON_ID = CNH_YEAR_MON_ID AND CNH_SUB_ACCOUNT_CODE=CND_SUB_ACCOUNT_CODE AND CND_TYPE='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) ORDER BY CND_SUB_ACCOUNT_CODE";
    ...
    private void YearlyDraft() {
        try {
            ...
            String strSQL = "SELECT * FROM SALES.D_CREDIT_NOTE_HEADER  WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) GROUP BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
    ...
    private void YealyDiscountSummary() {
        try {
            ...
            String strSQL = "SELECT * FROM SALES.D_CREDIT_NOTE_HEADER WHERE CNH_TYPE ='YLYINC' AND CNH_YEAR_MON_ID = SUBSTRING('" +txtInterval.getText()+"',1,10) ORDER BY CNH_SUB_ACCOUNT_CODE";
            System.out.println(strSQL);
